---
title: Reenviador
description: El reenviador es el componente en modo kernel del enrutador responsable de reenviar datos de una interfaz de enrutador a los demás.
...
El reenviador es el componente en modo kernel del enrutador responsable de reenviar datos de una interfaz de enrutador a los demás. El reenviador también decide si un paquete está destinado a la entrega local, si está destinado a reenviarse fuera de otra interfaz, o ambos.

Hay dos reenviadores en modo kernel: unidifusión y multidifusión.
