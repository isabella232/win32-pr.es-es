---
title: Obtener y llamar a los métodos exportados de un cliente
description: En el código de ejemplo siguiente se muestra cómo obtener una lista de los métodos que un cliente ha exportado y cómo invocar un método para ese cliente.
...
ms.locfileid: "104486559"
---
# <a name="obtain-and-call-the-exported-methods-for-a-client"></a><span data-ttu-id="60436-103">Obtener y llamar a los métodos exportados de un cliente</span><span class="sxs-lookup"><span data-stu-id="60436-103">Obtain and Call the Exported Methods for a Client</span></span>

<span data-ttu-id="60436-104">En el código de ejemplo siguiente se muestra cómo obtener una lista de los métodos que un cliente ha exportado y cómo invocar un método para ese cliente.</span><span class="sxs-lookup"><span data-stu-id="60436-104">The following sample code shows how to obtain a list of methods a client has exported, and how to invoke a method for that client.</span></span>
