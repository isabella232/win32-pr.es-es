...
<td>Una operación está pendiente.<br/></td>
</tr>
<tr class="even">
...
<td>La información de puerto especificada es incorrecta.<br/></td>
</tr>
<tr class="even">
...
<td>Se detectó un evento que no es válido.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>No había suficientes búferes disponibles.<br/></td>
</tr>
<tr class="even">
...
<td>El puerto o dispositivo especificado ya se está desconectando.<br/></td>
</tr>
<tr class="odd">
...
<td>No se puede abrir el archivo de la libreta de teléfonos especificado.<br/></td>
</tr>
<tr class="odd">
...
<td>No se puede cargar el archivo de la libreta de teléfonos especificado.<br/></td>
</tr>
<tr class="even">
...
<td>No se puede escribir en el archivo de la libreta de teléfonos especificado.<br/></td>
</tr>
<tr class="even">
...
<td>El equipo remoto desconectó el puerto especificado.<br/></td>
</tr>
<tr class="odd">
...
<td>El puerto especificado ya está en uso o no está configurado para el acceso remoto de acceso telefónico.<br/></td>
</tr>
<tr class="odd">
...
<td>No hay ninguna red asincrónica disponible.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>no puede asignar los recursos NetBIOS necesarios para admitir el cliente.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>Error de un adaptador de red en el servidor.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>No recibirá elementos emergentes de mensajes de red.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>No se permite que la cuenta especificada inicie sesión en esta hora del día.<br/></td>
</tr>
<tr class="even">
...
<td>El módem u otro dispositivo de conexión ha notificado un error.<br/></td>
</tr>
<tr class="odd">
...
<td>El dispositivo devolvió una respuesta no reconocida.<br/></td>
</tr>
<tr class="even">
...
<td>La <message> macro no se encontró en el dispositivo . Sección de archivo INF.<br/></td>
</tr>
<tr class="odd">
...
<td>Macro <defaultoff> del dispositivo. La sección del archivo INF contiene una macro no definida.<br/></td>
</tr>
<tr class="even">
...
<td>El archivo de .INI hace referencia a un nombre de dispositivo desconocido.<br/></td>
</tr>
<tr class="odd">
...
<td>Se intentó establecer una macro que no aparece en el dispositivo . Sección de archivo INF.<br/></td>
</tr>
<tr class="even">
...
<td>El archivo de .INI hace referencia a un tipo de dispositivo desconocido.<br/></td>
</tr>
<tr class="odd">
...
<td>No se puede leer el archivo .INI multimedia.<br/></td>
</tr>
<tr class="odd">
...
<td>El parámetro de uso en el archivo .ini multimedia no es válido.<br/></td>
</tr>
<tr class="odd">
...
<td>No se puede leer el nombre de la sección del archivo .INI multimedia.<br/></td>
</tr>
<tr class="even">
...
<td>No se puede leer el tipo de dispositivo del archivo .INI multimedia.<br/></td>
</tr>
<tr class="odd">
...
<td>No se puede detectar una señal de operador.<br/></td>
</tr>
<tr class="odd">
...
<td>Se produjo un error al escribir el nombre de la sección.<br/></td>
</tr>
<tr class="even">
...
<td>Se produjo un error al escribir el tipo de dispositivo.<br/></td>
</tr>
<tr class="odd">
...
<td>Se produjo un error al escribir el nombre del dispositivo.<br/></td>
</tr>
<tr class="even">
...
<td>Se produjo un error al escribir la velocidad de conexión máxima.<br/></td>
</tr>
<tr class="odd">
...
<td>Se produjo un error al escribir la velocidad máxima del operador.<br/></td>
</tr>
<tr class="even">
...
<td>Se produjo un error al escribir el uso.<br/></td>
</tr>
<tr class="odd">
...
<td>El archivo .INI multimedia está vacío.<br/></td>
</tr>
<tr class="even">
...
<td>Se ha producido un error de hardware en el puerto o en el dispositivo conectado<br/></td>
</tr>
<tr class="even">
...
<td>Las máquinas de estado no se inician.<br/></td>
</tr>
<tr class="odd">
...
<td>Las máquinas de estado ya se han iniciado.<br/></td>
</tr>
<tr class="even">
...
<td>La respuesta del dispositivo produjo un desbordamiento del búfer.<br/></td>
</tr>
<tr class="odd">
...
<td>El dispositivo se movió a una velocidad de conexión que no es compatible con el controlador COM.<br/></td>
</tr>
<tr class="odd">
...
<td>Respuesta del dispositivo recibida cuando no se esperaba ninguna.<br/></td>
</tr>
<tr class="even">
...
<td>Se especificó un número de devolución de llamada no bueno.<br/></td>
</tr>
<tr class="even">
...
<td>Error al escribir la velocidad de conexión inicial.<br/>
<blockquote>
[!Note]<br />
...
<td>Error al intentar cambiar la contraseña en el dominio.<br/></td>
</tr>
<tr class="odd">
<td><span id="ERROR_OVERRUN"></span><span id="error_overrun"></span><dl> <dt><strong>ERROR_OVERRUN</strong></dt> <dt>710</dt> </dl></td>
<td>Se detectaron errores de saturación serie al comunicarse con el módem.<br/></td>
</tr>
<tr class="even">
...
<td>El puerto de dos vías se está inicializando. Espere unos segundos y redial.<br/>
<blockquote>
[!Note]<br />
En desuso en Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>No hay líneas ISDN activas disponibles.<br/></td>
</tr>
<tr class="odd">
...
<td>No hay canales ISDN disponibles para realizar la llamada.<br/>
<blockquote>
[!Note]<br />
En desuso en Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>Se produjeron demasiados errores debido a una calidad deficiente de la línea telefónica.<br/>
<blockquote>
[!Note]<br />
En desuso en Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>La configuración de IP de acceso remoto no se puede hacer.<br/></td>
</tr>
<tr class="even">
...
<td>No hay direcciones IP disponibles en el grupo estático de direcciones IP de acceso remoto.<br/></td>
</tr>
<tr class="odd">
...
<td>Se ha producido un tiempo de espera de PPP.<br/></td>
</tr>
<tr class="even">
...
<td>No se configuran protocolos de control PPP.<br/></td>
</tr>
<tr class="even">
...
<td>El par PPP remoto no responde.<br/></td>
</tr>
<tr class="odd">
...
<td>El número de teléfono, incluidos el prefijo y el sufijo, es demasiado largo.<br/></td>
</tr>
<tr class="odd">
...
<td>El protocolo IPX no puede marcarse en el módem (u otro dispositivo de conexión) porque este equipo no está configurado para marcar hacia fuera (es un enrutador IPX).<br/>
<blockquote>
[!Note]<br />
En desuso en Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>El protocolo IPX no puede marcar en el módem (u otro dispositivo de conexión) porque este equipo no está configurado para marcar en (el enrutador IPX no está instalado).<br/>
<blockquote>
[!Note]<br />
En desuso en Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>El protocolo IPX no se puede usar para el acceso telefónico en más de un puerto a la vez.<br/></td>
</tr>
<tr class="even">
...
<td>No se puede acceder TCPCFG.DLL.<br/>
<blockquote>
[!Note]<br />
En desuso en Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>No se encuentra un adaptador ip enlazado al acceso remoto.<br/></td>
</tr>
<tr class="even">
...
<td>SLIP no se puede usar a menos que esté instalado el protocolo IP.<br/></td>
</tr>
<tr class="odd">
...
<td>El registro del equipo no está completo.<br/>
<blockquote>
[!Note]<br />
En desuso en Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>La negociación de PPP no está convergiendo.<br/></td>
</tr>
<tr class="even">
...
<td>El protocolo de control PPP para el protocolo de red especificado no está disponible en el servidor.<br/></td>
</tr>
<tr class="odd">
...
<td>Se finalizó el protocolo de control de vínculos PPP.<br/></td>
</tr>
<tr class="even">
...
<td>El equipo remoto finalizó el protocolo de control.<br/></td>
</tr>
<tr class="even">
...
<td>Se detectó un bucle de retorno.<br/></td>
</tr>
<tr class="odd">
...
<td>El sistema no puede usar el número de red IPX asignado por el equipo remoto. Se proporciona información adicional en el registro de eventos.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>El módulo de administración de sesiones (SMM) no es válido.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>SMM no está inicializado.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>Se ha producido un tiempo de espera de SMM.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>Se especificó un número de teléfono no bueno.<br/></td>
</tr>
<tr class="odd">
...
<td>Se especificó un SMM incorrecto.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>El número de devolución de llamada contiene un carácter que no es válido. Solo se permiten los siguientes 18 caracteres: 0 a 9, T, P, W, (, ), -, @y space.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>No se pudo desconectar la conexión porque la creó el enrutador de varios protocolos.<br/></td>
</tr>
<tr class="odd">
...
<td>El sistema no puede realizar la marcación automatizada porque esta conexión tiene un marcador personalizado especificado.<br/></td>
</tr>
<tr class="odd">
...
<td>Ras no se pudo iniciar automáticamente. Se proporciona información adicional en el registro de eventos.<br/></td>
</tr>
<tr class="odd">
...
<td>El uso compartido de conexiones a Internet (ICS) ya está habilitado en la conexión.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>Se produjo un error mientras se cambiaba la configuración existente de uso compartido de conexiones a Internet.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>Se produjo un error mientras se habilitaba el uso compartido de conexiones a Internet para la conexión.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>Se produjo un error mientras la red local se configuraba para el uso compartido.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>No se puede habilitar el uso compartido de conexiones a Internet. Hay más de una conexión LAN que no sea la conexión que se va a compartir.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>No se puede habilitar el uso compartido de conexiones a Internet. Una conexión LAN ya está configurada con la dirección IP necesaria para el direccionamiento IP automático. <br/></td>
</tr>
<tr class="odd">
...
<td>No se encontró un certificado. Las conexiones que usan el protocolo L2TP a través de IPSec requieren la instalación de un certificado de equipo, también conocido como certificado de equipo. <br/></td>
</tr>
<tr class="even">
...
<td>No se puede habilitar el uso compartido de conexiones a Internet. La conexión LAN seleccionada como red privada tiene más de una dirección IP configurada. Vuelva a configurar la conexión LAN con una única dirección IP antes de habilitar el uso compartido de conexiones a Internet. <br/></td>
</tr>
<tr class="odd">
...
<td>Error en el intento de conexión debido a un error al cifrar los datos. <br/></td>
</tr>
<tr class="even">
...
<td>No se puede acceder al destino especificado. <br/></td>
</tr>
<tr class="odd">
...
<td>No se pudo conectar la llamada porque el equipo remoto ha invocado la característica No alterar. <br/></td>
</tr>
<tr class="even">
...
<td>No era posible comprobar la identidad del servidor. <br/></td>
</tr>
<tr class="even">
...
<td>Para marcar con esta conexión, debe usar una tarjeta inteligente.<br/>
<blockquote>
[!Note]<br />
En desuso Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>El uso compartido de conexiones (NAT) está instalado actualmente como protocolo de enrutamiento y debe quitarse antes de habilitar el uso compartido de conexiones a Internet.<br/></td>
</tr>
<tr class="even">
...
<td>No se puede habilitar el uso compartido de conexiones a Internet. La conexión LAN seleccionada como red privada no está presente o está desconectada de la red. Asegúrese de que el adaptador laN está conectado antes de habilitar el uso compartido de conexiones a Internet. <br/></td>
</tr>
<tr class="odd">
...
<td>Error en el intento de conexión L2TP porque la capa de seguridad no pudo autenticar el equipo remoto. <br/></td>
</tr>
<tr class="odd">
...
<td>Error en el intento de conexión L2TP porque la capa de seguridad no pudo negociar parámetros compatibles con el equipo remoto. <br/></td>
</tr>
<tr class="even">
...
<td>Error en el intento de conexión L2TP porque la capa de seguridad encontró un error de procesamiento durante las negociaciones iniciales con el equipo remoto. <br/></td>
</tr>
<tr class="odd">
...
<td>Error en el intento de conexión L2TP porque no se pudo validar el certificado en el equipo remoto. <br/></td>
</tr>
<tr class="even">
...
<td>Error en el intento de conexión L2TP porque se produjo un error al negociar la seguridad. <br/></td>
</tr>
<tr class="odd">
...
<td>El atributo RADIUS del protocolo enmarcado para este usuario no es PPP. <br/></td>
</tr>
<tr class="even">
...
<td>El atributo RADIUS de tipo de servicio para este usuario no está enmarcado ni enmarcado de devolución de llamada. <br/></td>
</tr>
<tr class="even">
...
<blockquote>
[!Note]<br />
Windows 7 y versiones posteriores: el host debe configurarse para usar <strong>192.168.137.1</strong>
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<td>No se puede establecer la conexión VPN. Es posible que el servidor VPN no sea accesible o que los parámetros de seguridad no estén configurados correctamente para esta conexión. <br/>
<blockquote>
[!Note]<br />
Compatible con Windows XP y versiones posteriores de Windows.
</blockquote>
...
<td>Esta conexión está configurada para validar la identidad del servidor de acceso, Windows no puede comprobar el certificado digital enviado por el servidor.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows XP y versiones posteriores de Windows.
</blockquote>
...
<td>La configuración peap almacenada en la cookie de sesión no coincide con la configuración de sesión actual.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows XP con SP1 y versiones posteriores de Windows.
</blockquote>
...
<td>No se puede marcar mediante esta conexión en el momento del inicio de sesión porque está configurado para usar las credenciales del usuario que ha iniciado sesión actualmente.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows XP con SP1 y versiones posteriores de Windows.
</blockquote>
...
<td>Se interrumpió la conexión de red entre el equipo y el servidor VPN. Esto puede deberse a un problema en la transmisión de VPN y normalmente es el resultado de la latencia de Internet o simplemente de que el servidor VPN ha alcanzado la capacidad. Intente volver a conectarse al servidor VPN.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>Se inició una conexión de red entre el equipo y el servidor VPN, pero no se completó la conexión VPN. Esto suele deberse al uso de un certificado incorrecto o expirado para la autenticación entre el cliente y el servidor.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows Vista y versiones posteriores de Windows
</blockquote>
...
<td>No se pudo establecer la conexión de red entre el equipo y el servidor VPN porque el servidor remoto no responde. Esto suele deberse a un problema de clave previamente compartida entre el cliente y el servidor. Se usa una clave previamente compartida para garantizar que es quien dice que está en un ciclo de comunicación de seguridad IP (IPSec).<br/>
<blockquote>
[!Note]<br />
Compatible con Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>Ha intentado establecer una segunda conexión de banda ancha mientras ya se ha establecido una conexión de banda ancha anterior con el mismo dispositivo o puerto.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>No se pudo establecer la conexión de red de banda ancha en el equipo porque el servidor remoto no responde. Esto podría deberse a un valor que no es válido para el campo "Nombre del servicio" para esta conexión.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>Una característica o configuración que ha intentado habilitar ya no es compatible con el servicio de acceso remoto.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>El Crypto-Binding type-length-value (TLV) recibido no es válido.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>Crypto-Binding no se recibió TLV.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>El protocolo de tunelización de punto a punto (PPTP) no es compatible con IPv6. Cambie el tipo de red privada virtual a Protocolo de tunelización de nivel dos (L2TP).<br/>
<blockquote>
[!Note]<br />
Compatible con Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>Error en la validación de EAPTLS de las credenciales almacenadas en caché. Descarte las credenciales almacenadas en caché.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>La conexión se finalizó debido al tiempo de espera de inactividad.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>La conexión se finalizó porque el usuario ha cerrado la sesión.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>La conexión se finalizó debido a la hibernación.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>Error en el intento de conexión L2TP porque la capa de seguridad no pudo autenticar el equipo remoto. Esto podría deberse a que uno o varios campos del certificado presentados por el servidor remoto no se pudieron validar como pertenecientes al destino.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows Vista y versiones posteriores de Windows.
</blockquote>
...
<td>Hay otra solicitud de conexión de actualización en curso. RAS solo permite una solicitud de conexión de actualización a la vez.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows 7 y versiones posteriores de Windows.
</blockquote>
...
<td>La negociación mediante el protocolo configurado está deshabilitada. Edite las propiedades de conexión y seleccione otro protocolo para la negociación e inténtelo de nuevo.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows 7 y versiones posteriores de Windows.
</blockquote>
...
<td>Error en la negociación interna de direcciones.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows 7 y versiones posteriores de Windows.
</blockquote>
...
<td>Error en la negociación de selectores de tráfico.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows 7 y versiones posteriores de Windows.
</blockquote>
...
<td>La conexión VPN se sigue conectando o se vuelve a autenticar debido al cambio de estado de cuarentena. Inicie la actualización móvil solo cuando el estado de la conexión sea "Conectado".<br/>
<blockquote>
[!Note]<br />
Compatible con Windows 7 y versiones posteriores de Windows.
</blockquote>
...
<td>El servidor rechazó la autenticación de cliente debido a un TLV inesperado o a una falta de coincidencia de valores para un TLV.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows 7 y versiones posteriores de Windows.
</blockquote>
...
<td>El usuario no selecciona la preferencia de destino de VPN o ya no es válida.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows 7 y versiones posteriores de Windows.
</blockquote>
...
<td>Las credenciales de tarjeta inteligente almacenadas en caché no son válidas.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows 7 y versiones posteriores de Windows.
</blockquote>
...
<td>Los atributos del método interno PEAP almacenados en la cookie no son válidos.<br/></td>
</tr>
<tr class="odd">
...
<td>El tipo protocolo de autenticación extensible configurado en la conexión de acceso remoto no admite el inicio de sesión único.<br/></td>
</tr>
<tr class="odd">
...
<td>Se completó la conexión de acceso remoto, pero no se pudo realizar la autenticación porque el certificado que autentica el cliente en el servidor no es válido. Asegúrese de que el certificado usado para la autenticación es válido.<br/></td>
</tr>
<tr class="odd">
...
<td>Se completó la conexión de acceso remoto, pero se ha producido un error en la autenticación porque se revoca el certificado que autentica el cliente en el servidor. Use un certificado que no se haya revocado.<br/></td>
</tr>
<tr class="odd">
...
<td>Se completó la conexión de acceso remoto, pero no se pudo realizar la autenticación debido a un error en el certificado que autentica el cliente en el servidor.<br/></td>
</tr>
<tr class="even">
...
<td>Se completó la conexión de acceso remoto, pero no se pudo realizar la autenticación porque el certificado que el cliente usa para autenticar el servidor no es válido.<br/></td>
</tr>
<tr class="odd">
...
<td>La conexión de acceso remoto se completó, pero la autenticación no se pudo realizar porque el certificado que el cliente usa para autenticar el servidor ha expirado.<br/></td>
</tr>
<tr class="even">
...
<td>Se completó la conexión de acceso remoto, pero se ha producido un error en la autenticación porque se revoca el certificado que el cliente usa para autenticar el servidor.<br/></td>
</tr>
<tr class="odd">
...
<td>Se completó la conexión de acceso remoto, pero se produjo un error en la autenticación debido a un error en el certificado que el cliente usa para autenticar el servidor.<br/></td>
</tr>
<tr class="even">
...
<td>Se completó la conexión de acceso remoto, pero no se pudo realizar la autenticación porque no se encontró un certificado raíz de confianza que valide el certificado de usuario en entidades de certificación raíz de confianza almacén de certificados.<br/></td>
</tr>
<tr class="odd">
...
<td>La conexión de acceso remoto se completó, pero la autenticación no se pudo realizar porque el certificado del almacén de certificados entidades de certificación raíz de confianza que autentica el certificado de usuario ha expirado. Renueve el certificado.<br/></td>
</tr>
<tr class="odd">
...
<td>Se completó la conexión de acceso remoto, pero no se pudo realizar la autenticación porque no se encontró un certificado que valide el certificado de servidor en entidades de certificación raíz de confianza almacén de certificados.<br/></td>
</tr>
<tr class="even">
...
<td>Se completó la conexión de acceso remoto, pero no se pudo realizar la autenticación porque el certificado del almacén de certificados entidades de certificación raíz de confianza que valida el certificado de servidor no es válido.<br/></td>
</tr>
<tr class="odd">
...
<td>Se completó la conexión de acceso remoto, pero se ha producido un error en la autenticación porque el certificado del equipo servidor no tiene un nombre de servidor especificado.<br/></td>
</tr>
<tr class="even">
...
<td>La identidad externa peap no es la misma que la identidad interna cuando la privacidad de la identidad está desactivada.<br/></td>
</tr>
<tr class="odd">
...
<td>No se realizó la conexión remota porque el nombre del servidor de acceso remoto no se resolvió.<br/></td>
</tr>
<tr class="even">
...
<td>No se pudo habilitar la interfaz porque se ha creado más de una interfaz con el mismo destino con el método de autenticación de clave previamente compartida. Cambie el método de destino o autenticación y habilite la interfaz .<br/></td>
</tr>
</tbody>
</table>
...
<td>El enrutador no conoce el identificador de protocolo especificado.<br/></td>
</tr>
<tr class="even">
...
<td>El Administrador de interfaces de marcado a petición (DDM) no se está ejecutando.<br/></td>
</tr>
<tr class="odd">
...
<td>Una interfaz con este nombre ya está registrada con el enrutador.<br/></td>
</tr>
<tr class="even">
...
<td>El protocolo especificado se está deteniendo.<br/></td>
</tr>
<tr class="odd">
...
<td>No se han establecido las credenciales de interfaz.<br/></td>
</tr>
<tr class="odd">
...
<td>Ya está en curso una actualización de la información de enrutamiento en esta interfaz.<br/></td>
</tr>
<tr class="odd">
...
<td>La configuración de la interfaz no es válida. Ya hay otra interfaz que está conectada a la misma interfaz en el enrutador remoto.<br/></td>
</tr>
<tr class="even">
...
<td>El par remoto rechazó el protocolo de autenticación.<br/></td>
</tr>
<tr class="odd">
...
<td>No se pudo establecer la conexión porque el protocolo de autenticación utilizado por el servidor RAS/VPN para comprobar el nombre de usuario y la contraseña no pudo coincidir con la configuración del perfil de conexión.<br/></td>
</tr>
<tr class="odd">
...
<td>No se permite que la cuenta remota inicie sesión en esta hora del día.<br/></td>
</tr>
<tr class="odd">
...
<td>Se denegó el acceso al mismo nivel remoto porque el nombre de usuario, la contraseña o ambos no son válidos en el dominio.<br/></td>
</tr>
<tr class="even">
...
<td>No hay puertos habilitados para enrutamiento disponibles para su uso en esta interfaz de marcado a petición.<br/></td>
</tr>
<tr class="odd">
...
<td>La interfaz no es accesible en este momento.<br/></td>
</tr>
<tr class="odd">
...
<td>El servicio De marcado a petición está en estado en pausa.<br/></td>
</tr>
<tr class="even">
...
<td>El servidor de autenticación no respondió a las solicitudes de autenticación de forma oportuna.<br/></td>
</tr>
<tr class="even">
...
<td>Se ha alcanzado el número máximo de puertos permitidos para su uso en la conexión de varios vínculos.<br/></td>
</tr>
<tr class="odd">
...
<td>Se ha alcanzado el límite máximo en el número de interfaces LAN admitidas.<br/></td>
</tr>
<tr class="odd">
...
<td>Se ha alcanzado el límite máximo en el número de interfaces de marcado a petición admitidas.<br/></td>
</tr>
<tr class="even">
...
<td>Se ha alcanzado el límite máximo en el número de clientes de acceso remoto admitidos.<br/></td>
</tr>
<tr class="odd">
...
<td>Dado que hay otra conexión de su tipo en uso, la conexión entrante no puede aceptar la solicitud de conexión.<br/></td>
</tr>
<tr class="odd">
...
<td>No se encontraban servidores RADIUS en la red.<br/></td>
</tr>
<tr class="even">
...
<td>La respuesta recibida del servidor de autenticación RADIUS no era válida. Asegúrese de que la contraseña secreta que distingue mayúsculas de minúsculas para el servidor RADIUS esté establecida correctamente.<br/></td>
</tr>
<tr class="odd">
...
<td>No tiene permiso para conectarse mediante el tipo de dispositivo actual.<br/></td>
</tr>
<tr class="odd">
...
<td>La interfaz no puede conectarse en este momento.<br/></td>
</tr>
<tr class="even">
...
<td>Acceso remoto ha detectado cuentas de usuario de formato anterior que no se migrarán automáticamente.<br/></td>
</tr>
<tr class="even">
...
<td>La longitud o el identificador recibidos en un paquete del servidor RADIUS no es válido.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows XP y versiones posteriores de Windows.
</blockquote>
...
<td>El paquete recibido del servidor RADIUS en no es válido.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows XP y versiones posteriores de Windows.
</blockquote>
...
<td>Authenticator no coincide en paquetes del servidor RADIUS.<br/>
<blockquote>
[!Note]<br />
Compatible con Windows XP y versiones posteriores de Windows.
</blockquote>
