...
---
# <a name="access-the-opaque-pointer-in-a-destination"></a><span data-ttu-id="02831-103">Acceder al puntero opaco en un destino</span><span class="sxs-lookup"><span data-stu-id="02831-103">Access the Opaque Pointer in a Destination</span></span>

<span data-ttu-id="02831-104">En el código de ejemplo siguiente se muestra cómo obtener acceso al puntero opaco en un destino.</span><span class="sxs-lookup"><span data-stu-id="02831-104">The following sample code shows how to access the opaque pointer in a destination.</span></span>
