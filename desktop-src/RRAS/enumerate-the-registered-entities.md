...
---
# <a name="enumerate-the-registered-entities"></a><span data-ttu-id="db752-103">Enumerar las entidades registradas</span><span class="sxs-lookup"><span data-stu-id="db752-103">Enumerate the Registered Entities</span></span>

<span data-ttu-id="db752-104">En el código de ejemplo siguiente se muestra cómo crear una enumeración de clientes registrados y cómo obtener la información de cliente del administrador de tablas de enrutamiento.</span><span class="sxs-lookup"><span data-stu-id="db752-104">The following sample code shows how to create an enumeration of registered clients and obtain the client information from the routing table manager.</span></span>
