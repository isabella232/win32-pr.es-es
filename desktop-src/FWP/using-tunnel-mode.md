---
title: Usar el modo de túnel
description: En el código de ejemplo siguiente se muestra cómo configurar un túnel IPsec de punto a punto mediante la API de la plataforma de filtrado de Windows (WFP).
...
ms.locfileid: "104075223"
---
# <a name="using-tunnel-mode"></a><span data-ttu-id="a635b-103">Usar el modo de túnel</span><span class="sxs-lookup"><span data-stu-id="a635b-103">Using Tunnel Mode</span></span>

<span data-ttu-id="a635b-104">En el código de ejemplo siguiente se muestra cómo configurar un túnel IPsec de punto a punto mediante la API de la plataforma de filtrado de Windows (WFP).</span><span class="sxs-lookup"><span data-stu-id="a635b-104">The following sample code demonstrates how to configure a point-to-point IPsec tunnel using the Windows Filtering Platform (WFP) API.</span></span>
