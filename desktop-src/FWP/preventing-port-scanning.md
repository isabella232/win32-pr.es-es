...
---
# <a name="preventing-port-scanning"></a><span data-ttu-id="11d34-103">Impedir el análisis de puertos</span><span class="sxs-lookup"><span data-stu-id="11d34-103">Preventing Port Scanning</span></span>

<span data-ttu-id="11d34-104">En el código de ejemplo siguiente se muestra cómo evitar el análisis de puertos mediante descartaciones ocultas y caídas silenciosas.</span><span class="sxs-lookup"><span data-stu-id="11d34-104">The following sample code demonstrates how to prevent port scanning using stealth discards and silent drops.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="11d34-105">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="11d34-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="11d34-106">**Condiciones de filtrado disponibles en cada nivel de filtrado**</span><span class="sxs-lookup"><span data-stu-id="11d34-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
