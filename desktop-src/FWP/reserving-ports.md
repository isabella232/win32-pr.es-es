...
---
# <a name="reserving-ports"></a><span data-ttu-id="9b9d1-103">Reservar puertos</span><span class="sxs-lookup"><span data-stu-id="9b9d1-103">Reserving Ports</span></span>

<span data-ttu-id="9b9d1-104">En el código de ejemplo siguiente se muestra cómo usar las capas de asignación de recursos para reservar un intervalo de puertos para los administradores.</span><span class="sxs-lookup"><span data-stu-id="9b9d1-104">The following sample code demonstrates how to use the resource assignment layers to reserve a range of ports for administrators.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="9b9d1-105">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="9b9d1-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="9b9d1-106">**Condiciones de filtrado disponibles en cada nivel de filtrado**</span><span class="sxs-lookup"><span data-stu-id="9b9d1-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
