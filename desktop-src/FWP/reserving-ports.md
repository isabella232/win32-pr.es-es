...
En el código de ejemplo siguiente se muestra cómo usar las capas de asignación de recursos para reservar un intervalo de puertos para los administradores.
