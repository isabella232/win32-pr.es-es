...
---
# <a name="populating-filter-conditions"></a><span data-ttu-id="258f3-103">Rellenar condiciones de filtro</span><span class="sxs-lookup"><span data-stu-id="258f3-103">Populating Filter Conditions</span></span>

<span data-ttu-id="258f3-104">En el código de ejemplo siguiente se muestra cómo rellenar las condiciones de filtro utilizadas por una aplicación de servidor para buscar filtros y eventos que lo afecten.</span><span class="sxs-lookup"><span data-stu-id="258f3-104">The following sample code demonstrates how to populate filter conditions used by a server application to find filters and events that affect it.</span></span>

> [!Note]  
> <span data-ttu-id="258f3-105">Estas condiciones son las mismas que las que admite la API de nivel inferior **IsPortAllowed** .</span><span class="sxs-lookup"><span data-stu-id="258f3-105">These conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
