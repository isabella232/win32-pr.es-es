---
title: Impedir la eliminación de filtros
description: En el código de ejemplo siguiente se muestra cómo dificultar la eliminación de un filtro mediante la configuración de una DACL.
...
ms.locfileid: "104357345"
---
# <a name="hindering-filter-deletion"></a><span data-ttu-id="f6cd4-103">Impedir la eliminación de filtros</span><span class="sxs-lookup"><span data-stu-id="f6cd4-103">Hindering Filter Deletion</span></span>

<span data-ttu-id="f6cd4-104">En el ejemplo de código siguiente se muestra cómo dificultar la eliminación de un filtro mediante la configuración de una DACL.</span><span class="sxs-lookup"><span data-stu-id="f6cd4-104">The following example code demonstrates how to make a filter difficult to delete by setting a DACL.</span></span>
