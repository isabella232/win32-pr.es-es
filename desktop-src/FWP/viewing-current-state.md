...
---
# <a name="viewing-current-state"></a>Ver el estado actual

En el código de ejemplo siguiente se muestra cómo buscar todos los filtros que pueden afectar a una aplicación de servidor.
