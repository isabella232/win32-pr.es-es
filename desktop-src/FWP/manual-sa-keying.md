...
---
# <a name="manual-sa-keying"></a><span data-ttu-id="78cbd-103">Creación manual de claves SA</span><span class="sxs-lookup"><span data-stu-id="78cbd-103">Manual SA Keying</span></span>

<span data-ttu-id="78cbd-104">En el código de ejemplo siguiente se muestra cómo crear asociaciones de seguridad (SA) mediante la plataforma de filtrado de Windows.</span><span class="sxs-lookup"><span data-stu-id="78cbd-104">The following sample code demonstrates how to create Security Associations (SA) using Windows Filtering Platform.</span></span>
