...
---
# <a name="permitting-and-blocking-applications-and-users"></a><span data-ttu-id="ad65a-103">Permitir y bloquear aplicaciones y usuarios</span><span class="sxs-lookup"><span data-stu-id="ad65a-103">Permitting and Blocking Applications and Users</span></span>

<span data-ttu-id="ad65a-104">En el código de ejemplo siguiente se muestra cómo agregar un filtro que se evalúa según el identificador de usuario o de aplicación.</span><span class="sxs-lookup"><span data-stu-id="ad65a-104">The following sample code demonstrates how to add a filter that evaluates by user or application ID.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="ad65a-105">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="ad65a-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="ad65a-106">**Condiciones de filtrado disponibles en cada nivel de filtrado**</span><span class="sxs-lookup"><span data-stu-id="ad65a-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
