...
description: El código de ejemplo siguiente muestra el proceso necesario para quitar una instalación del proveedor.
...
ms.locfileid: "119755175"
---
# <a name="uninstalling-a-provider"></a>Desinstalación de un proveedor

El código de ejemplo siguiente muestra el proceso necesario para quitar una instalación del proveedor.
