...
---
# <a name="uninstalling-a-provider"></a>Desinstalación de un proveedor

En el ejemplo de código siguiente se muestra el proceso necesario para quitar una instalación del proveedor.
