---
title: Desinstalación de un proveedor
description: En el código de ejemplo siguiente se muestra el proceso necesario para quitar una instalación del proveedor.
...
ms.locfileid: "103778510"
---
# <a name="uninstalling-a-provider"></a><span data-ttu-id="a2b64-103">Desinstalación de un proveedor</span><span class="sxs-lookup"><span data-stu-id="a2b64-103">Uninstalling a Provider</span></span>

<span data-ttu-id="a2b64-104">En el ejemplo de código siguiente se muestra el proceso necesario para quitar una instalación del proveedor.</span><span class="sxs-lookup"><span data-stu-id="a2b64-104">The following sample code demonstrates the process required to remove a provider installation.</span></span>
