...
---
# <a name="displaying-net-events"></a><span data-ttu-id="d4af6-103">Mostrar eventos net</span><span class="sxs-lookup"><span data-stu-id="d4af6-103">Displaying Net Events</span></span>

<span data-ttu-id="d4af6-104">En el código de ejemplo siguiente se muestra cómo una aplicación de servidor puede localizar eventos de red recientes que podrían haber sido afectados.</span><span class="sxs-lookup"><span data-stu-id="d4af6-104">The following sample code demonstrates how a server application could locate recent net events that might have affected it.</span></span>

> [!Note]  
> <span data-ttu-id="d4af6-105">Las condiciones de filtro son las mismas que las que admite la API de nivel inferior **IsPortAllowed** .</span><span class="sxs-lookup"><span data-stu-id="d4af6-105">The filter conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
