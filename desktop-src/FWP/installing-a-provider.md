---
title: Instalación de un proveedor
description: En el código de ejemplo siguiente se muestra la operación de instalación del proveedor de la plataforma de filtrado de Windows.
...
ms.locfileid: "103903327"
---
# <a name="installing-a-provider"></a><span data-ttu-id="f3576-103">Instalación de un proveedor</span><span class="sxs-lookup"><span data-stu-id="f3576-103">Installing a Provider</span></span>

<span data-ttu-id="f3576-104">En el código de ejemplo siguiente se muestra la operación de instalación del proveedor de la plataforma de filtrado de Windows.</span><span class="sxs-lookup"><span data-stu-id="f3576-104">The following sample code demonstrates the provider installation operation of the Windows Filtering Platform.</span></span>
