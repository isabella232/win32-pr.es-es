...
description: El código de ejemplo siguiente muestra la operación de instalación del proveedor de Windows de filtrado.
...
ms.locfileid: "119069005"
---
# <a name="installing-a-provider"></a>Instalación de un proveedor

En el código de ejemplo siguiente se muestra la operación de instalación del proveedor de Windows de filtrado.
