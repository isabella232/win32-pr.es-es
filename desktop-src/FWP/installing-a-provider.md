...
---
# <a name="installing-a-provider"></a>Instalación de un proveedor

En el código de ejemplo siguiente se muestra la operación de instalación del proveedor de la plataforma de filtrado de Windows.
