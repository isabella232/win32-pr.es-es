...
| [Windows Referencia de API del sistema de archivos proyectado](projfs-reference.md)                                          | Información de referencia de la interfaz de programación ProjFS.
