...
description: WOW64 usa excepciones nativas x64, ia64 o ARM64 como transporte para excepciones x86. Por lo tanto, en una aplicación de 32 bits que se ejecuta en WOW64, las excepciones no detectadas se comportan como excepciones nativas de 64 bits.
...
WOW64 usa excepciones nativas x64, ia64 o ARM64 como transporte para excepciones x86. Por lo tanto, en una aplicación de 32 bits que se ejecuta en WOW64, las excepciones no detectadas se comportan como excepciones nativas de 64 bits.
