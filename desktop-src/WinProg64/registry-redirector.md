...
keywords:
- Guía de programación de 64 Windows de programación de 64 bits Windows programación , redirector del Registro
- Programación de Windows de 64 bits Windows del registro
...
**Windows 10 arm:** Además de la vista lógica de 32 bits para aplicaciones x86, Windows 10 en ARM incluye una vista lógica independiente para aplicaciones arm de 32 bits.
...
-   [Acceso remoto al Registro en aplicaciones de 64 bits Windows](remote-registry-access-in-64-bit-windows.md)
