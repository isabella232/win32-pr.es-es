...
[Error irreales 1022](#fatal-error-1022)

[Error irresal 1023](#fatal-error-1023)

[Error irresal 1024](#fatal-error-1024)

[Error irreales 1025](#fatal-error-1025)
...
[Error irreales 1029](#fatal-error-1029)

[Error irreales 1030](#fatal-error-1030)

## <a name="fatal-error-1021"></a>Error irresal 1021
...
**Invocación de macro TRAP-TYPE,** error semántico de módulo específico de SNMPv1. Cada elemento de la lista de variables usadas en la cláusula VARIABLES de una invocación de macro **TRAP-TYPE** debe resolverse como el nombre de una instancia escalar object-TYPE.
...
## <a name="fatal-error-1025"></a>Error irreales 1025
...
## <a name="fatal-error-1028"></a>Error irreales 1028
...
## <a name="fatal-error-1029"></a>Error irreales 1029
