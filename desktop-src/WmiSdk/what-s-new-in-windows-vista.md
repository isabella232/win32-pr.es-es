---
description: A partir Windows Vista, WMI contiene muchas características nuevas basadas en las solicitudes de los usuarios wmi.
...
A partir Windows Vista, WMI contiene muchas características nuevas basadas en las solicitudes de los usuarios wmi.
...
El servicio WMI ya no usa la mayoría de los [archivos de registro wmi.](wmi-log-files.md) En su lugar, usa [seguimiento de](/windows/desktop/ETW/event-tracing-portal) eventos  (ETW) y los eventos están disponibles a través de la interfaz de usuario Visor de eventos o la herramienta de línea de comandos Wevtutil. Para obtener más información, vea [Seguimiento de la actividad WMI.](tracing-wmi-activity.md)
...
<span id="New_display_monitor_classes"></span><span id="new_display_monitor_classes"></span><span id="NEW_DISPLAY_MONITOR_CLASSES"></span>Nuevas clases de monitor de visualización
</dt> <dd>
