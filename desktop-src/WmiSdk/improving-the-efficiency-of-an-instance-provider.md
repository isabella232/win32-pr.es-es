---
description: Un proveedor wmi de alto rendimiento aumenta considerablemente la velocidad a la que un cliente WMI puede obtener información de un proveedor de instancias wmi.
...
Un proveedor wmi de alto rendimiento aumenta considerablemente la velocidad a la que un cliente WMI puede obtener información de un proveedor de instancias wmi. El cambio principal es que un proveedor de alto rendimiento se ejecuta como un servidor en proceso para la aplicación cliente o para WMI. Al colocar el proveedor dentro del proceso de cliente, puede acelerar la interacción entre los dos.
