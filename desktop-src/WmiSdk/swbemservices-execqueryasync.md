---
description: 'Método SWbemServices.ExecQueryAsync: ejecuta una consulta para recuperar objetos.'
ms.assetid: 50c7f62b-dd83-4117-b10e-acee1690ce8c
ms.tgt_platform: multiple
title: Método SWbemServices.ExecQueryAsync (Wbemdisp.h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "126973724"
---
# <a name="swbemservicesexecqueryasync-method"></a>Método SWbemServices.ExecQueryAsync
...
Se usa para un prototipo. Impide que la consulta se haga y, en su lugar, devuelve un objeto que parece un objeto de resultado típico.
