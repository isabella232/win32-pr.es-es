...
ms.locfileid: "127465494"
---
# <a name="swbemrefresherrefresh-method"></a>Método SWbemRefresher.Refresh

El **método SWbemRefresher.Refresh** actualiza todos los elementos contenidos en el [**objeto SWbemRefresher.**](swbemrefresher.md)
...
Las marcas deben establecerse en 0 (cero).
