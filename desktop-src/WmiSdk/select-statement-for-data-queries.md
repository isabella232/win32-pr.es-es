...
En el ejemplo siguiente se devuelve una instancia de **MainClass**, suponiendo que existe una instancia de **MainClass** que contiene el objeto incrustado **EmbedObj** con una propiedad **P \_ Uint32** igual a "70011".
