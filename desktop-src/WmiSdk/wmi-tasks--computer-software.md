---
description: Las tareas WMI para el software informático obtienen información como qué software instala Microsoft Windows Installer (MSI) y las versiones de software. Para ver otros ejemplos, consulte ScriptCenter de TechNet en https://www.microsoft.com/technet .
ms.assetid: 65a61be3-7870-4178-9e96-78b82898271f
ms.tgt_platform: multiple
title: 'Tareas wmi: software de equipo'
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
ms.locfileid: "122625511"
---
# <a name="wmi-tasks-computer-software"></a>Tareas wmi: software de equipo

Las tareas WMI para el software informático obtienen información como qué software instala Microsoft Windows Installer (MSI) y las versiones de software. Para ver otros ejemplos, consulte ScriptCenter de TechNet en [https://www.microsoft.com/technet](https://technet.microsoft.com/default.aspx) .
...
> [!Note]  
> La ejecución de una consulta "Select \* from Win32 Product" (Seleccionar del producto Win32) puede dar lugar a \_ un comportamiento inesperado. Esto se debe a que el proveedor que admite el producto Win32 \_ no está optimizado para consultas. Para más información, consulte el artículo [de KB 974524](https://support.microsoft.com/kb/974524).
...
<td>Si el software se instaló mediante Microsoft Windows Installer (MSI), use la clase WMI <a href="/previous-versions/windows/desktop/legacy/aa394378(v=vs.85)"><strong>Win32_Product</strong></a> y el <a href="/previous-versions/windows/desktop/msiprov/uninstall-method-in-class-win32-product"><strong>método Uninstall.</strong></a><br/> <span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
<col  />
</colgroup>
...
<tr class="even">
<td>... inventariar todo el software instalado en un equipo con un script?</td>
...
<tr class="odd">
<td>... determinar qué versión de Microsoft Office está instalado?</td>
<td><p>Use la <a href="/previous-versions/windows/desktop/legacy/aa394378(v=vs.85)"><strong>Win32_Product</strong></a> clase y compruebe el valor de la <strong>propiedad</strong> Version.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
El ejemplo de código de PowerShell script de información de EQUIPO remoto de [PowerShell](https://Gallery.TechNet.Microsoft.Com/2a8a008c-ee30-4b50-a81a-1b7545ef3436) usa una serie de clases de hardware y software, incluido Win32Product, para encontrar información sobre un equipo remoto mediante WMI y el registro remoto.
