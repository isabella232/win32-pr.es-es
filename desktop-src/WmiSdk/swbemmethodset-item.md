...
---
# <a name="swbemmethodsetitem-method"></a>SWbemMethodSet. Item (método)
...
Obligatorio. Nombre del método que se va a recuperar.
...
Si se realiza correctamente, el objeto [**SWbemMethod**](swbemmethod.md) solicitado devuelve.

## <a name="error-codes"></a>Códigos de error

Al completarse el método **Item** , el objeto **Err** puede contener uno de los códigos de error de la lista siguiente.
