...
La **clase WBEMTime** facilita las conversiones entre varios formatos Windows y ANSI C en tiempo de ejecución. Para obtener más información, vea también [**WBEMTimeSpan (Métodos de clase).**](/windows/desktop/api/WbemTime/nl-wbemtime-wbemtimespan)
...
| [**GetStructtm**](/windows/desktop/api/WbemTime/nf-wbemtime-wbemtime-getstructtm)                      | Obtiene la hora como una estructura tm en tiempo de ejecución **de** ANSI C.<br/>                                                                |
...
| [**Gettime \_ t**](/windows/desktop/api/WbemTime/nf-wbemtime-wbemtime-gettime_t)                         | Obtiene la hora como una variable t en tiempo de ejecución de ANSI \_ C.<br/>                                                                       |
| [**IsOk**](/windows/desktop/api/WbemTime/nf-wbemtime-wbemtime-isok)                                    | Indica si el **objeto WBEMTime** representa una hora válida.<br/>                                                          |
| [**SetDMTF**](/windows/desktop/api/WbemTime/nf-wbemtime-wbemtime-setdmtf)                              | Establece la hora del objeto **WBEMTime** en formato datetime cim.<br/>                                                            |
...
| [**operador :**](/previous-versions/windows/desktop/legacy/aa394051(v=vs.85))                                                                                                                                                                                                                                                                                                                                                                                                                       | *El operador* subtraction disminuye el tiempo de un objeto en el tiempo de otro objeto. El resultado se devuelve en un **nuevo objeto WBEMTime.** |
