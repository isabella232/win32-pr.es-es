---
description: 'Más información sobre: Método CimMofDeserializer.DeserializeClasses (Byte[], UInt32, IEnumerable <CimClass> , OnClassNeeded, GetIncludedFileContent)'
...
Deserializa clases CIM basadas en datos serializados, una colección de clases CIM primarias y devoluciones de llamada.
