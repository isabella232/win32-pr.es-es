---
description: El control WMI es un complemento MMC ubicado en la Panel de control y se usa para establecer la seguridad del espacio de nombres WMI manualmente en un equipo local. También puede establecer el espacio de nombres predeterminado para scripting.
...
El control WMI es un complemento MMC ubicado en el Panel de control y se usa para establecer la seguridad del espacio de nombres WMI manualmente en un equipo local.  También puede establecer el espacio de nombres predeterminado para scripting.
...
Si un script no se conecta explícitamente a un espacio de nombres al conectarse a WMI, WMI usa el espacio de nombres predeterminado especificado en este control. El valor predeterminado también se encuentra en la entrada del Registro de la siguiente manera:
...
1.  En la **ventana Propiedades del control WMI,** elija la **pestaña** Opciones avanzadas.
