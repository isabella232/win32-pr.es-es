...
Debe poder crear instancias de la clase de consumidor de eventos permanente para describir una o varias formas de enviar eventos al consumidor físico. Para obtener más información, vea [crear un consumidor lógico](creating-a-logical-consumer.md).
