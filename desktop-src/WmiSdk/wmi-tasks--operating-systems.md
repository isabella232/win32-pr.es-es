...
Las tareas de WMI para los sistemas operativos obtienen información sobre el sistema operativo, como la versión, si está activada o qué revisiones están instaladas.
...
<td>Use la clase <a href="/windows/desktop/CIMWin32Prov/win32-operatingsystem"><strong>Win32_OperatingSystem</strong></a> y compruebe el valor de las propiedades <strong>ServicePackMajorVersion</strong> y <strong>ServicePackMinorVersion</strong> .<br/> <span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
<col style="width: 100%" />
</colgroup>
...
<td><p>Use la clase <a href="/windows/desktop/CIMWin32Prov/win32-operatingsystem"><strong>Win32_OperatingSystem</strong></a> y la propiedad <strong>InstallDate</strong> .</p>
<div class="code">
...
<tr class="odd">
<td>... ¿determinar qué versión del sistema operativo Windows está instalada en un equipo?</td>
<td><p>Use la clase <a href="/windows/desktop/CIMWin32Prov/win32-operatingsystem"><strong>Win32_OperatingSystem</strong></a> y recupere las propiedades <strong>nombre</strong> y <strong>versión</strong> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>... determinar qué carpeta es la carpeta de Windows (% WINDIR%) en un equipo?</td>
<td><p>Use la clase <a href="/windows/desktop/CIMWin32Prov/win32-operatingsystem"><strong>Win32_OperatingSystem</strong></a> y compruebe el valor de la propiedad <strong>WindowsDirectory</strong> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<td><p>Utilice la clase <a href="/windows/desktop/CIMWin32Prov/win32-quickfixengineering"><strong>Win32_QuickFixEngineering</strong></a> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>... ¿determinar si es necesario activar el sistema operativo en un equipo?</td>
<td><p>Use la clase <a href="/previous-versions/windows/desktop/legacy/aa394520(v=vs.85)"><strong>Win32_WindowsProductActivation</strong></a> y compruebe el valor de la propiedad <strong>ActivationRequired</strong> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
