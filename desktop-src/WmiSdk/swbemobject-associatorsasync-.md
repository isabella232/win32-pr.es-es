...
---
# <a name="swbemobjectassociatorsasync_-method"></a>SWbemObject. AssociatorsAsync, \_ método

El **método \_ AssociatorsAsync** de [**SWbemObject**](swbemobject.md) obtiene objetos (clases o instancias) que están asociados al objeto actual. Estos objetos se denominan puntos de conexión. Este método realiza la misma función que realizan los asociados de la consulta WQL.
...
Obligatorio. Receptor de objeto que recibe los objetos de forma asincrónica como una devolución de llamada.
...
Después de completar el **método \_ AssociatorsAsync** , el objeto [Err](/previous-versions//sbf5ze0e(v=vs.85)) puede contener uno de los códigos de error de la lista siguiente.
...
Para obtener más información sobre los asociados de consultas WQL asociadas, instancias de origen y extremos, vea [ASSOCIATORS OF Statement](associators-of-statement.md).
