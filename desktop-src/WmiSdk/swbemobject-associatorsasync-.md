---
description: El método AssociatorsAsync de SWbemObject obtiene objetos (clases o \_ instancias) asociados al objeto actual. Estos objetos se denominan puntos de conexión. Este método realiza la misma función que realiza la consulta ASSOCIATORS OF WQL.
...
ms.locfileid: "126967075"
---
# <a name="swbemobjectassociatorsasync_-method"></a>Método SWbemObject.AssociatorsAsync \_

El **método AssociatorsAsync \_** de [**SWbemObject**](swbemobject.md) obtiene objetos (clases o instancias) asociados al objeto actual. Estos objetos se denominan puntos de conexión. Este método realiza la misma función que realiza la consulta ASSOCIATORS OF WQL.
...
Hace que WMI devuelva las descripciones de propiedad y clase localizadas. Para obtener más información, vea [Localización de información de clase WMI](localizing-wmi-class-information.md).
...
Para obtener más información sobre las consultas, instancias de origen y puntos de conexión asociados de ASSOCIATORS OF, vea [INSTRUCCIÓN ASSOCIATORS OF](associators-of-statement.md).
