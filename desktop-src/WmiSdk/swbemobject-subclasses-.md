...
Entero que determina la información detallada que enumera la llamada. Este parámetro puede aceptar los valores siguientes.
...
Hace que esta llamada se bloquee hasta que se complete la llamada.
...
Después de completar el método de **subclases \_** , el objeto **Err** puede contener uno de los códigos de error de la lista siguiente.
...
No es un error que la colección devuelta tenga cero elementos si no hay ninguna subclase del objeto actual. El método **subclases \_** solo funciona con objetos de clase.
