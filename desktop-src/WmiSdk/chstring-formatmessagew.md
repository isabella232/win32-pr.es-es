...
---
# <a name="chstringformatmessagew-methods"></a>CHString:: FormatMessageW (métodos)
...
El método sobrecargado **FormatMessageW** da formato a una cadena de mensaje.
...
| Método                                                              | Descripción                                                                                     |
|:--------------------------------------------------------------------|:------------------------------------------------------------------------------------------------|
| [**FormatMessageW (UINT)**](/previous-versions/windows/desktop/legacy/aa385519(v=vs.85))       | Da formato a este mensaje de acuerdo con el identificador de recursos especificado por **uint**.<br/> |
| [**FormatMessageW (LPCWSTR)**](/windows/win32/api/chstring/nf-chstring-chstring-formatmessagew(lpcwstr_---)) | Da formato a esta cadena de mensaje según el formato especificado por **LPCWSTR**.<br/>    |
