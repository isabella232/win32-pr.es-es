...
---
# <a name="swbemobjectinstances_-method"></a>SWbemObject. Instances ( \_ método)
...
El **método \_ instances** solo funciona con objetos de clase. No es un error que la colección devuelta tenga cero elementos. El comportamiento predeterminado de este método es [*semisincrónico*](gloss-s.md) debido al valor predeterminado de *IFlags* **wbemFlagReturnImmediately**.
