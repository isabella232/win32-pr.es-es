...
Puede configurar el rendimiento de todas las instancias de **ActiveScriptEventConsumer** en un sistema estableciendo los valores de la propiedad [**Timeout**](scriptingstandardconsumersetting.md) o **MaximumScripts** en la instancia única de **ScriptingStandardConsumerSetting**.
...
Número, en segundos, que el script puede ejecutarse. Si es 0 (cero), que es el valor predeterminado, el script no finaliza.
