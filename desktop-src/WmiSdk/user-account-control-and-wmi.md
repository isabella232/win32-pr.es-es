...
-   [Cuenta necesaria para ejecutar wmi Command-Line herramientas](#account-needed-to-run-wmi-command-line-tools)
...
1.  Abra una ventana del símbolo del sistema haciendo clic con el botón derecho en símbolo del sistema en la menú Inicio, a continuación, haga clic **en Ejecutar como administrador.**
...
## <a name="account-needed-to-run-wmi-command-line-tools"></a>Cuenta necesaria para ejecutar wmi Command-Line herramientas
...
Si usa una cuenta local, ya sea porque se encuentra en un grupo de trabajo o es una cuenta de equipo local, es posible que se le fue forzada a dar tareas específicas a un usuario local. Por ejemplo, puede conceder al usuario el derecho de detener o iniciar un servicio específico mediante el comando SC.exe, los métodos [**GetSecurityDescriptor**](/windows/desktop/CIMWin32Prov/getsecuritydescriptor-method-in-class-win32-service) y [**SetSecurityDescriptor**](/windows/desktop/CIMWin32Prov/setsecuritydescriptor-method-in-class-win32-service) del servicio [**Win32 \_**](/windows/desktop/CIMWin32Prov/win32-service)o a través de directiva de grupo mediante Gpedit.msc. Algunos objetos protegibles pueden no permitir que un usuario estándar realice tareas y no ofrezca ningún medio para modificar la seguridad predeterminada. En este caso, es posible que tenga que deshabilitar UAC para que la cuenta de usuario local no se filtre y, en su lugar, se convierta en un administrador completo. Tenga en cuenta que, por motivos de seguridad, deshabilitar UAC debe ser el último recurso.
...
-   [**DeviceMemoryAddress de Win32 \_**](/windows/desktop/CIMWin32Prov/win32-devicememoryaddress)
...
-   [**Placa base Win32 \_**](/windows/desktop/CIMWin32Prov/win32-baseboard)
...
-   [**Placa base \_ Win32Dispositivo**](/windows/desktop/CIMWin32Prov/win32-motherboarddevice)
...
-   [**Disco lógico de Win32 \_**](/windows/desktop/CIMWin32Prov/win32-logicaldisk)
