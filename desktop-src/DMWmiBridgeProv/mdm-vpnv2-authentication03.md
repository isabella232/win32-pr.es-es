...
description: La clase MDM \_ VPNv2 \_ Authentication03 contiene información de autenticación para el perfil vpn nativo.
...
ms.locfileid: "119874985"
---
# <a name="mdm_vpnv2_authentication03-class"></a>Clase \_ MDM VPNv2 \_ Authentication03

\[Parte de la información está relacionada con el producto publicado previamente que puede modificarse considerablemente antes de su lanzamiento comercial. Microsoft no otorga ninguna garantía, explícita o implícita, con respecto a la información proporcionada aquí.\]

La [**clase MDM \_ VPNv2 \_ Authentication03**](mdm-vpnv2-01.md) contiene información de autenticación para el perfil vpn nativo.
...
La **clase \_ MDM VPNv2 \_ Authentication03** tiene estos tipos de miembros:

-   [Propiedades](#properties)

### <a name="properties"></a>Propiedades

La **clase \_ MDM VPNv2 \_ Authentication03** tiene estas propiedades.
