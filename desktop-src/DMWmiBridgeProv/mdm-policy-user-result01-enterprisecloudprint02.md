...
description: La clase Mdm \_ Policy \_ User \_ Result01 \_ EnterpriseCloudPrint02 representa las directivas de impresión en la nube disponibles.
...
ms.locfileid: "119874995"
---
# <a name="mdm_policy_user_result01_enterprisecloudprint02-class"></a>Clase Mdm \_ Policy \_ User \_ Result01 \_ EnterpriseCloudPrint02

\[Parte de la información está relacionada con el producto publicado previamente que se puede modificar considerablemente antes de su lanzamiento comercial. Microsoft no otorga ninguna garantía, explícita o implícita, con respecto a la información proporcionada aquí.\]

La clase Mdm \_ Policy \_ User \_ Result01 \_ EnterpriseCloudPrint02 representa las directivas de impresión en la nube disponibles.
...
La **clase Mdm Policy User \_ \_ \_ Result01 \_ EnterpriseCloudPrint02** tiene estos tipos de miembros:

-   [Propiedades](#properties)

### <a name="properties"></a>Propiedades

La **clase Mdm Policy User \_ \_ \_ Result01 \_ EnterpriseCloudPrint02** tiene estas propiedades.
...
[DiscoverriaDiscoveryResourceId](/windows/client-management/mdm/policy-csp-enterprisecloudprint#enterprisecloudprint-mopriadiscoveryresourceid)
</dt> <dd> <dl> <dt>
