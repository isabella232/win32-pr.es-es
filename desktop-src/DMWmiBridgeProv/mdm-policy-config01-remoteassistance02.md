...
description: La clase Mdm \_ Policy \_ Config01 \_ RemoteAssistance02 configura las directivas de asistencia remota.
...
ms.locfileid: "119017903"
---
# <a name="mdm_policy_config01_remoteassistance02-class"></a>Clase Mdm \_ Policy \_ Config01 \_ RemoteAssistance02

\[Parte de la información está relacionada con el producto publicado previamente que puede modificarse considerablemente antes de su lanzamiento comercial. Microsoft no otorga ninguna garantía, explícita o implícita, con respecto a la información proporcionada aquí.\]

La clase Mdm \_ Policy \_ Config01 \_ RemoteAssistance02 configura las directivas de asistencia remota.
...
La **clase Mdm Policy \_ \_ Config01 \_ RemoteAssistance02** tiene estos tipos de miembros:

-   [Propiedades](#properties)

### <a name="properties"></a>Propiedades

La **clase Mdm Policy \_ \_ Config01 \_ RemoteAssistance02** tiene estas propiedades.
...
[Registro de sesión](/windows/client-management/mdm/policy-csp-remoteassistance#remoteassistance-sessionlogging)
</dt> <dd> <dl> <dt>
