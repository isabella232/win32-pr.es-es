...
description: La clase Mdm \_ Policy \_ Config01 \_ DeviceLock02 representa las directivas de bloqueo de dispositivo disponibles.
...
ms.locfileid: "119967525"
---
# <a name="mdm_policy_config01_devicelock02-class"></a>Clase Mdm \_ Policy \_ Config01 \_ DeviceLock02

\[Parte de la información está relacionada con el producto publicado previamente que se puede modificar considerablemente antes de su lanzamiento comercial. Microsoft no otorga ninguna garantía, explícita o implícita, con respecto a la información proporcionada aquí.\]

La **clase Mdm Policy \_ \_ Config01 \_ DeviceLock02** representa las directivas de bloqueo de dispositivo disponibles.
...
La **clase \_ \_ \_ DeviceLock02 de la directiva MDM Config01** tiene estos tipos de miembros:

-   [Propiedades](#properties)

### <a name="properties"></a>Propiedades

La **clase Mdm Policy \_ \_ Config01 \_ DeviceLock02** tiene estas propiedades.
...
DevicePasswordEnabled no debe establecerse en Habilitado (0) cuando WMI se usa para establecer las directivas DeviceLock de EAS, dado que está habilitado de forma predeterminada en CSP de directiva para compatibilidad de back con Windows 8.x. Si DevicePasswordEnabled está establecido en Enabled(0), policy CSP devolverá un error que indica que DevicePasswordEnabled ya existe. Windows 8.x no admite la directiva DevicePassword. Al deshabilitar DevicePasswordEnabled (1), esta debe ser la única directiva establecida del grupo de directivas DeviceLock siguiente. Las directivas se enumeran a continuación: > - DevicePasswordEnabled es la directiva primaria de lo siguiente:

-   DevicePasswordEnabled es la directiva primaria de lo siguiente:
    -   AllowSimpleDevicePassword
    -   MinDevicePasswordLength
    -   AlphanumericDevicePasswordRequired es la directiva primaria de:
...
Identifica el nombre del nodo primario. Para esta clase, la cadena es "DeviceLock".
