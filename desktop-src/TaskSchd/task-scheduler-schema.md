...
---
# <a name="task-scheduler-schema"></a><span data-ttu-id="240b9-105">Esquema de Programador de tareas</span><span class="sxs-lookup"><span data-stu-id="240b9-105">Task Scheduler Schema</span></span>

<span data-ttu-id="240b9-106">El esquema Programador de tareas define XML válido que se usa para registrar tareas con el servicio Programador de tareas.</span><span class="sxs-lookup"><span data-stu-id="240b9-106">The Task Scheduler schema defines valid XML used to register tasks with the Task Scheduler service.</span></span> <span data-ttu-id="240b9-107">Los desarrolladores pueden crear su propio XML, validarlo con respecto a este esquema y registrar tareas mediante el método [**ITaskFolder:: RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) .</span><span class="sxs-lookup"><span data-stu-id="240b9-107">Developers can create their own XML, validate it against this schema, and register tasks using the [**ITaskFolder::RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) method.</span></span>

<span data-ttu-id="240b9-108">Los tipos y elementos del esquema de Programador de tareas se documentan individualmente en las secciones siguientes.</span><span class="sxs-lookup"><span data-stu-id="240b9-108">The types and elements of the Task Scheduler schema are individually documented in the following sections.</span></span>

-   [<span data-ttu-id="240b9-109">Programador de tareas elementos de esquema</span><span class="sxs-lookup"><span data-stu-id="240b9-109">Task Scheduler Schema Elements</span></span>](task-scheduler-schema-elements.md)
-   [<span data-ttu-id="240b9-110">Tipos simples de esquema de Programador de tareas</span><span class="sxs-lookup"><span data-stu-id="240b9-110">Task Scheduler Schema Simple Types</span></span>](task-scheduler-schema-simple-types.md)
-   [<span data-ttu-id="240b9-111">Tipos complejos de esquema Programador de tareas</span><span class="sxs-lookup"><span data-stu-id="240b9-111">Task Scheduler Schema Complex Types</span></span>](task-scheduler-schema-complex-types.md)
-   [<span data-ttu-id="240b9-112">Programador de tareas grupos de esquemas</span><span class="sxs-lookup"><span data-stu-id="240b9-112">Task Scheduler Schema Groups</span></span>](task-scheduler-schema-groups.md)

<span data-ttu-id="240b9-113">El esquema de Programador de tareas completo se define mediante el siguiente archivo XSD.</span><span class="sxs-lookup"><span data-stu-id="240b9-113">The entire Task Scheduler schema is defined by the following XSD file.</span></span>
