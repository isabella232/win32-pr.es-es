...
| <span id="TASK_TRIGGER_DAILY"></span><span id="task_trigger_daily"></span><dl> <dt>**TASK \_ DESENCADENADOR \_ DIARIO**</dt> <dt>2</dt> </dl>                                                 | Desencadena la tarea según una programación diaria. Por ejemplo, la tarea se inicia a una hora específica cada día, cada dos días, cada tercer día, y así sucesivamente.<br/>                |
...
| <span id="TASK_TRIGGER_IDLE"></span><span id="task_trigger_idle"></span><dl> <dt>**TASK \_ TRIGGER \_ IDLE**</dt> <dt>6</dt> </dl>                                                    | Desencadena la tarea cuando el equipo entra en un estado inactivo.<br/>                                                                                                  |
