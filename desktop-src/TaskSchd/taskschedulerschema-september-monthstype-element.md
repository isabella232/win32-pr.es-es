...
keywords:
- Elemento de septiembre Programador de tareas
topic_type:
- apiref
api_name:
- September
...
El **elemento de** septiembre se define mediante el tipo complejo [**monthsType.**](taskschedulerschema-monthstype-complextype.md)
...
El código XML siguiente define un calendario de meses que ejecuta la tarea en septiembre.
