...
Al leer o escribir XML para una tarea, el tipo de inicio de sesión se especifica en el [**<LogonType>**](taskschedulerschema-logontype-principaltype-element.md) elemento del esquema Programador de tareas datos.
