...
---
# <a name="cc-code-example-setting-application-name"></a>Ejemplo de código de C/C++: establecer el nombre de la aplicación

En este ejemplo se establece el nombre de la aplicación asociada a una tarea conocida. En este ejemplo se da por supuesto que la tarea "test Task" ya existe en el equipo local y que el servicio Programador de tareas se está ejecutando.
