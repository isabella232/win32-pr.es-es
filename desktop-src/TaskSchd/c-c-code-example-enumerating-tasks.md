...
---
# <a name="cc-code-example-enumerating-tasks"></a>Ejemplo de código de C/C++: enumerar tareas

En este ejemplo se enumeran todas las tareas de la carpeta tareas programadas del equipo local y se imprime el nombre de cada tarea en la pantalla.
