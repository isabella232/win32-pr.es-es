...
Los ejemplos de código que aparecen en la parte inferior de la página muestran cómo recuperar las propiedades que son únicas para los objetos de tarea. Para ver [*otras propiedades de elementos*](w.md) de trabajo que también se aplican a las tareas, vea [Recuperar ejemplos de elementos de trabajo.](retrieving-work-item-property-examples.md)
...
| Recuperación de la cantidad máxima de tiempo que la tarea puede ejecutar y mostrar ese número en la pantalla                                                 | [Ejemplo de código de C/C++: recuperación de la tarea MaxRunTime](c-c-code-example-retrieving-the-task-maxruntime.md)               |
