...
| [**WorkingDirectory**](taskschedulerschema-workingdirectory-exectype-element.md) | [**pathType**](taskschedulerschema-pathtype-simpletype.md) | Especifica el directorio donde existe el ejecutable o los archivos utilizados por el ejecutable.<br/> |
