...
---
# <a name="taskfolderregistertask-method"></a>TaskFolder. RegisterTask, método
...
-   [Ejemplo de desencadenador de eventos (XML)](/previous-versions//aa446889(v=vs.85))
-   [Ejemplo de desencadenador diario (XML)](daily-trigger-example--xml-.md)
