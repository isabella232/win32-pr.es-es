...
Objeto de scripting que representa un desencadenador que inicia una tarea cuando la tarea se registra o se actualiza.
...
Al crear su propio XML para una tarea, se especifica un desencadenador de registro mediante el elemento [**RegistrationTrigger**](taskschedulerschema-registrationtrigger-triggergroup-element.md) del esquema de programador de tareas.
