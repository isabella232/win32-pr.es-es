...
---
# <a name="cc-code-example-terminating-a-task"></a>Ejemplo de código de C/C++: finalizar una tarea

En este ejemplo se comprueba el estado de una tarea conocida y finaliza la tarea si se está ejecutando.
