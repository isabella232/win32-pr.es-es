...
---
# <a name="journal-reader-schema-definition"></a><span data-ttu-id="44837-103">Definición de esquema del lector de Journal</span><span class="sxs-lookup"><span data-stu-id="44837-103">Journal Reader Schema Definition</span></span>

<span data-ttu-id="44837-104">Este tema contiene la definición del esquema del lector del diario.</span><span class="sxs-lookup"><span data-stu-id="44837-104">This topic contains the definition of the Journal Reader schema.</span></span>

## <a name="schema"></a><span data-ttu-id="44837-105">Schema</span><span class="sxs-lookup"><span data-stu-id="44837-105">Schema</span></span>
