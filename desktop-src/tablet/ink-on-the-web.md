---
description: El kit de desarrollo de software de Windows Vista y el kit de desarrollo de Windows XP Tablet PC Edition permiten crear aplicaciones web habilitadas para lápiz para los usuarios de Tablet PC que deben acceder a aplicaciones remotas.
...
Los temas siguientes contienen notas sobre las distintas formas de crear aplicaciones web habilitadas para lápiz.

-   [Implementación sin toque](no-touch-deployment.md)
-   [Controles web](web-controls.md)
-   [Aplicaciones web habilitadas para lápiz](ink-enabled-web-applications.md)
-   [Seguridad y confianza](security-and-trust.md)
