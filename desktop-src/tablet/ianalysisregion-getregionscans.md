...
Si *pRegionScans* se pasa como **null**, el método **GetRegionScans** devuelve **S \_ correcto** y el número de rectángulos se devuelve en *pulCount*.
...
En el ejemplo siguiente se muestra cómo obtener los rectángulos que definen el área de [**IAnalysisRegion**](ianalysisregion.md) `region` y cómo obtener solo el número de rectángulos.
