---
description: Describe la creación de instancias del Panel de entrada del lápiz.
ms.assetid: 185dbed4-8e2c-49a5-a1c8-23a9787ae2f0
title: Creación de instancias de la clase PenInputPanel
ms.topic: article
ms.date: 05/31/2018
...
-   [Crear un objeto PenInputPanel](creating-a-peninputpanel-object.md)
-   [Uso de PenInputPanel con cuadros combinados](using-the-peninputpanel-with-combo-boxes.md)
-   [Mostrar el panel de entrada](displaying-the-input-panel.md)
