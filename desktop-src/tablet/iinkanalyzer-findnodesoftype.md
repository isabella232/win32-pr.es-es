...
Puntero a [**IContextNodes**](icontextnodes.md) que contiene todos los nodos de tipo *pNodeType.*
...
La *propiedad pNodeType* debe contener un GUID de las constantes [Tipos de nodo de](context-node-types.md) contexto.
