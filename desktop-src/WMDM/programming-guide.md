...
ms.locfileid: "103904320"
---
# <a name="wmdm-programming-guide"></a>Guía de programación de WMDM

En esta sección se describen las acciones que debe realizar una aplicación o un proveedor de servicios basados en Windows Media Administrador de dispositivos.

-   [Tareas comunes a las aplicaciones y proveedores de servicios](tasks-common-to-applications-and-service-providers.md) describe las tareas que realizarán las aplicaciones y los proveedores de servicios, como el registro, el cifrado y el descifrado, y la autenticación.
-   [Crear una aplicación de Windows Media administrador de dispositivos](creating-a-windows-media-device-manager-application.md) describe todas las acciones que normalmente debe realizar una aplicación.
-   La [creación de un proveedor de servicios](creating-a-service-provider.md) describe todas las acciones que normalmente debe realizar un proveedor de servicios.
