---
title: Compilar el proveedor de servicios de ejemplo mediante Visual Studio
...
---
# <a name="compiling-the-sample-service-provider-using-visual-studio"></a><span data-ttu-id="1967b-110">Compilar el proveedor de servicios de ejemplo mediante Visual Studio</span><span class="sxs-lookup"><span data-stu-id="1967b-110">Compiling the Sample Service Provider Using Visual Studio</span></span>

<span data-ttu-id="1967b-111">El SDK de Windows Media Format no incluye un archivo de solución de Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="1967b-111">The Windows Media Format SDK does not include a Visual Studio solution file.</span></span> <span data-ttu-id="1967b-112">Sin embargo, en este documento se incluyen dos archivos que le permiten usar Visual Studio para crear y depurar el proveedor de servicios de ejemplo.</span><span class="sxs-lookup"><span data-stu-id="1967b-112">However, this document includes two files that enable you to use Visual Studio to build and debug the sample service provider.</span></span> <span data-ttu-id="1967b-113">Ambos archivos se proporcionan para Visual Studio .NET 2003.</span><span class="sxs-lookup"><span data-stu-id="1967b-113">Both the files provided are for Visual Studio .NET 2003.</span></span>

-   <span data-ttu-id="1967b-114">Guarde el código siguiente como un archivo de texto denominado mshdsp. vcproj en la carpeta <*ruta de instalación del SDK* > \\ WMFSDK \\ WMFSDK95 \\ WMDM \\ mdsp \\ mshdsp.</span><span class="sxs-lookup"><span data-stu-id="1967b-114">Save the following code as a text file named mshdsp.vcproj in the folder <*SDK installation path*>\\WMFSDK\\WMFSDK95\\WMDM\\mdsp\\mshdsp.</span></span>
...
-   <span data-ttu-id="1967b-115">Guarde el código siguiente como un archivo de texto denominado mshdsp. sln en la misma carpeta donde guardó mshdsp. vcproj.</span><span class="sxs-lookup"><span data-stu-id="1967b-115">Save the following code as a text file named mshdsp.sln in the same folder where you saved mshdsp.vcproj.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="1967b-116">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="1967b-116">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="1967b-117">**Proveedor de servicios de ejemplo**</span><span class="sxs-lookup"><span data-stu-id="1967b-117">**Sample Service Provider**</span></span>](sample-service-provider.md)
</dt> </dl>
