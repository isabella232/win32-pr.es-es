...
Describe la hoja de pancarta que se va a mostrar para un documento determinado. La hoja de pancarta se debe mostrar en el valor predeterminado de PageMediaSize, con el valor predeterminado PageMediaType. La hoja de pancarta también debe aislarse del resto del documento. Esto significa que las opciones de finalización de documentos o de procesamiento (como DocumentDuplex, DocumentStaple o DocumentBinding) no deben incluir la hoja de pancarta. La hoja de pancarta puede estar aislada o no del resto del trabajo. Esto significa que las opciones de finalización de trabajo o procesamiento pueden incluir la hoja de pancarta del documento. La hoja de pancarta debe aparecer como la primera hoja del documento.
