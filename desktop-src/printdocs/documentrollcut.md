...
Describe el método de corte para rollo de papel. Cada documento se administra por separado. Las opciones especificadas describen los distintos métodos para el corte del rollo.
