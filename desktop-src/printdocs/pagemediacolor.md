...
Describe las opciones color multimedia y las características de cada opción.
...
| \_MediaColorsRGBValue\_<br/> | string<br/> | sRGB Color<br/> | \#AARRGGBB donde A, R, G, B representan dígitos hexadecimales.<br/>                                                                                                                  | Define el color sRGB de la hoja de medios físicos. <br/>             |
