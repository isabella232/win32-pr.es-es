---
description: Obtenga información sobre el elemento configurable por el usuario PageOrientation. Este tema no está al día. Para obtener la información más reciente, vea Especificación del esquema de impresión.
...
| Opción                       | Definición                                                                                              |
|------------------------------|---------------------------------------------------------------------------------------------------------|
| Horizontal <br/>        | ¿El contenido gira en la página 90?? grados CCW con respecto a la orientación estándar (vertical).<br/>  |
