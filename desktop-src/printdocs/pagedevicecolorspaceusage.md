---
description: Revise el elemento PageDeviceColorSpaceUsage configurable por el usuario. Este tema no es actual. Para obtener la información más reciente, vea La especificación del esquema de impresión.
