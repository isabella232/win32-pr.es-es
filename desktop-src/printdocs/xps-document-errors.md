...
<td>La interfaz ya tiene un propietario.<br/></td>
</tr>
<tr class="even">
...
<td>Las dimensiones del cuadro de purga no son compatibles con las dimensiones de página.<br/> El valor del ancho del cuadro de purga debe ser mayor o igual que el ancho de página más el valor absoluto de la coordenada x del origen del cuadro de purga. El valor de alto del cuadro de purga debe ser mayor o igual que el alto de la página más el valor absoluto de la coordenada y del origen del cuadro de purga. <br/></td>
</tr>
<tr class="odd">
...
<td>Un <strong>elemento PathGeometry</strong> contiene un conjunto de figuras de ruta de acceso que se especifican con el atributo <strong>Figures</strong> o con un <strong>elemento PathFigure</strong> secundario. Las figuras de ruta de acceso de una geometría no pueden tener el atributo <strong>Figures</strong> ni un <strong>elemento PathFigure</strong> secundario. <br/></td>
</tr>
<tr class="even">
...
<td>Un <strong>elemento ResourceDictionary</strong> que especifica un diccionario de recursos remoto en su <strong>atributo Source</strong> NO DEBE contener ningún elemento secundario de definición de recursos.<br/></td>
</tr>
<tr class="odd">
...
<td>Un valor de ubicación del centro de atención no está en orden. Los valores de ubicación deben ordenarse en orden ascendente. <br/></td>
</tr>
<tr class="even">
...
<td>Se especificaron det stops para una cadena vacía; o bien, el índice de salto de símbolos ha superado la longitud de la cadena Unicode. <br/></td>
</tr>
<tr class="odd">
...
<td>Un objeto visual de un diccionario de recursos tiene el atributo <strong>Name,</strong> que no se puede especificar en ningún elemento secundario de <strong>un elemento ResourceDictionary.</strong><br/></td>
</tr>
<tr class="odd">
...
<td>Ya existe un objeto con este nombre en el diccionario.<br/></td>
</tr>
<tr class="even">
...
<td>Ya existe un objeto con este nombre de clave en el diccionario.<br/></td>
</tr>
<tr class="odd">
...
<td>El rectángulo del cuadro de sangría contiene uno o varios valores que no son válidos. Consulte la descripción del parámetro para ver los valores válidos. <br/></td>
</tr>
<tr class="odd">
...
<td>El rectángulo del cuadro de contenido contiene uno o varios valores que no son válidos. Consulte la descripción del parámetro para ver los valores válidos. <br/></td>
</tr>
<tr class="even">
...
<td>La cadena de tipo de contenido no es válida.<br/></td>
</tr>
<tr class="odd">
...
<td>Un <strong>valor FLOAT</strong> no es válido. Es un número infinito o no un número (NAN).<br/></td>
</tr>
<tr class="even">
...
<td>El URI de fuente no es válido, posiblemente porque contiene un fragmento vacío o caracteres que no son válidos.<br/></td>
</tr>
<tr class="odd">
...
<td>El idioma especificado no es válido o no tiene el formato correcto.<br/></td>
</tr>
<tr class="even">
...
<td>El nombre de clave de búsqueda hace referencia a un objeto que no es el tipo correcto para la llamada; por ejemplo, si el método devuelve un pincel pero el nombre de la clave de búsqueda hace referencia a un objeto geometry.<br/></td>
</tr>
<tr class="odd">
...
<td>El marcado que se lee contiene un elemento o un atributo que no se ajusta al <a href="https://www.ecma-international.org/activities/XML%20Paper%20Specification/XPS%20Standard%20WD%201.6.pdf">XML Paper Specification</a>.<br/>
<blockquote>
[!Note]<br />
Para representar valores de punto flotante, XPS OM usa el tipo de datos <strong>FLOAT</strong> en lugar de <strong>DOUBLE.</strong> Si un documento XPS tiene un elemento con datos de punto flotante que no caben en un valor <strong>FLOAT,</strong> este error se devolverá cuando se encuentre ese valor durante la deserialización.
</blockquote>
<br/> <br/></td>
</tr>
<tr class="even">
...
<td>La cadena que se pasó no es un nombre válido, según el XML Paper Specification. <br/></td>
</tr>
<tr class="odd">
...
<td>Las dimensiones de página contienen un valor de tamaño de página que no es válido. <br/></td>
</tr>
<tr class="odd">
...
<td>Según el <a href="https://www.ecma-international.org/activities/XML%20Paper%20Specification/XPS%20Standard%20WD%201.6.pdf">XML Paper Specification</a>, la cadena de clave de búsqueda no es válida.<br/></td>
</tr>
<tr class="even">
...
<td>No se admite el tipo de imagen en miniatura.<br/></td>
</tr>
<tr class="odd">
...
<td>Se encontró un marcado XML incorrecto o con formato incorrecto.<br/></td>
</tr>
<tr class="even">
...
<td>En una o varias <a href="/windows/win32/api/xpsobjectmodel/ns-xpsobjectmodel-xps_glyph_mapping"><strong>estructuras XPS_GLYPH_MAPPING,</strong></a> un elemento está fuera de la secuencia. <br/></td>
</tr>
<tr class="odd">
...
<td>Las asignaciones de glifos superan el número de índices de glifo.<br/></td>
</tr>
<tr class="even">
...
<td>Error en las asignaciones de glifos.<br/> Si la cadena Unicode está vacía, este error significa que también se definió una asignación de glifos. No se deben definir asignaciones de glifos si la cadena Unicode está vacía.<br/> Si la cadena Unicode no está vacía, este error significa que se definió una asignación de glifos para glifos fuera de la cadena Unicode. No se pueden definir asignaciones de glifos para glifos que se encuentran fuera de la longitud de la cadena Unicode.<br/></td>
</tr>
<tr class="odd">
...
<td>El parámetro de perfil de color <strong>es NULL,</strong>pero se espera un perfil de color. Se requiere un perfil de color cuando el tipo de color se XPS_COLOR_TYPE_CONTEXT. <br/></td>
</tr>
<tr class="even">
...
<td>Una página hace referencia a recursos descartables, pero no especifica un nombre de elemento DiscardControl.<br/></td>
</tr>
<tr class="odd">
...
<td>El paquete no contiene fixeddocumentsequence.<br/></td>
</tr>
<tr class="odd">
...
<td>La <a href="/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomglyphs"><strong>interfaz IXpsOMGlyphs</strong></a> requiere un URI de fuente, pero no se especifica uno.<br/></td>
</tr>
<tr class="even">
...
<td>La <a href="/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomglyphs"><strong>interfaz IXpsOMGlyphs</strong></a> sin una cadena Unicode no especifica ningún índice de glifo. Una <strong>interfaz IXpsOMGlyphs</strong> debe especificar una cadena Unicode o una matriz de índices de glifo.<br/></td>
</tr>
<tr class="odd">
...
<td>No se pudo encontrar un recurso de imagen para el pincel de imagen.<br/></td>
</tr>
<tr class="even">
...
<td>El recurso remoto tiene un objeto inesperado.<br/></td>
</tr>
<tr class="odd">
...
<td>No se ha llamado a la página; el estado de destino del hipervínculo solo se puede establecer si la página tiene un nombre.<br/></td>
</tr>
<tr class="even">
...
<td>FixedDocument no contiene ningún elemento FixedPage. Un documento XPS debe contener al menos un elemento FixedPage.<br/></td>
</tr>
<tr class="odd">
...
<td>La referencia de página no tiene una página correspondiente.<br/></td>
</tr>
<tr class="even">
...
<td>No se hubo referencia a un elemento de destino necesario.<br/></td>
</tr>
<tr class="odd">
...
<td>No se especificó una secuencia para el recurso.<br/></td>
</tr>
<tr class="even">
...
<td>No se encontró la parte FixedDocument a la que hace referencia FixedDocumentSequence. Un documento XPS debe contener al menos un FixedDocument.<br/></td>
</tr>
<tr class="odd">
...
<td>No se encontró la parte FixedPage a la que hace referencia FixedDocument. Un documento XPS debe contener al menos un elemento FixedPage.<br/></td>
</tr>
<tr class="even">
...
<td>La parte de destino de la relación no está presente en la relación de paquete.<br/></td>
</tr>
<tr class="odd">
...
<td>No se especificó ningún atributo <strong>x:Key</strong> para el recurso.<br/></td>
</tr>
<tr class="even">
...
<td>El recurso al que hace referencia la página o el contenido del diccionario remoto no existe como una relación de página.<br/></td>
</tr>
<tr class="odd">
...
<td>La fuente restringida a la que se hace referencia no se especificó en la llamada a <a href="/windows/desktop/api/xpsobjectmodel/nf-xpsobjectmodel-ixpsompackagewriter-startnewdocument"><strong>IXpsOMPackageWriter::StartNewDocument</strong></a>.<br/></td>
</tr>
<tr class="even">
...
<td>La matriz de datos de segmento tiene menos entradas que la matriz de tipos de segmento. <br/></td>
</tr>
<tr class="odd">
...
<td>Se intentó agregar una clase FixedDocumentSequence a un paquete que ya tiene uno. Un documento XPS debe contener uno y solo un elemento FixedDocumentSequence.<br/></td>
</tr>
<tr class="even">
...
<td>Se intentó agregar un vale de impresión de nivel de documento a un elemento FixedDocument que ya tiene uno. Un elemento FixedDocument en un documento XPS solo puede contener un vale de impresión de nivel de documento.<br/></td>
</tr>
<tr class="odd">
...
<td>Se intentó agregar un vale de impresión de nivel de trabajo a un elemento FixedDocumentSequence que ya tiene uno. FixedDocumentSequence en un documento XPS solo puede contener un vale de impresión de nivel de trabajo.<br/></td>
</tr>
<tr class="even">
...
<td>Se intentó agregar un vale de impresión de nivel de página a una clase FixedPage que ya tiene una. Un elemento FixedPage en un documento XPS solo puede contener un vale de impresión de nivel de página.<br/></td>
</tr>
<tr class="odd">
...
<td>La colección de fuentes restringidas contenía una entrada de fuente restringida que se repitió. Cada entrada de fuente puede producirse en la colección solo una vez.<br/></td>
</tr>
<tr class="even">
...
<td>Ya existe un recurso con ese nombre de elemento.<br/></td>
</tr>
<tr class="odd">
...
<td>Se intentó agregar una imagen en miniatura a un paquete que ya tiene una. Un documento XPS solo puede contener una imagen en miniatura de nivel de paquete.<br/></td>
</tr>
<tr class="even">
...
<td>Se intentó agregar una imagen en miniatura de nivel de página a una fixedpage que ya tiene una. Un elemento FixedPage en un documento XPS solo puede contener una imagen en miniatura de nivel de página.<br/></td>
</tr>
<tr class="odd">
...
<td>Una entrada contiene un valor negativo, pero debe contener un valor no negativo. <br/></td>
</tr>
<tr class="even">
...
<td>Se intentó agregar una referencia de diccionario remoto a un diccionario remoto. Un diccionario remoto no puede hacer referencia a otro diccionario remoto.<br/></td>
</tr>
<tr class="odd">
...
<td>Un puntero de interfaz no apunta a una implementación de interfaz reconocida. No se admite la implementación personalizada de interfaces de DOCUMENT API de XPS.<br/></td>
</tr>
<tr class="even">
...
<td>La colección de detenciones de degradado tiene menos de dos paradas. Una colección de detenciones de degradado debe tener al menos dos delimitadores de degradado.<br/></td>
</tr>
<tr class="odd">
...
<td>La cadena de texto se especificó como orientada lateralmente y de derecha a izquierda. Si el texto está orientado lateralmente, no puede tener un nivel de bidi que sea un valor impar (de derecha a izquierda). Del mismo modo, si el nivel de bidi es un valor impar, el texto no se puede orientar lateralmente.<br/></td>
</tr>
<tr class="even">
...
<td>Las asignaciones de glifos no coinciden con el contenido de la cadena Unicode.<br/></td>
</tr>
<tr class="odd">
...
<td>El escritor de paquetes no se cerró antes de su lanzamiento.<br/></td>
</tr>
<tr class="even">
...
<td>Una relación hace referencia a un elemento que está fuera del documento XPS. Todo el contenido que se va a representar en un documento XPS debe estar incluido en el documento XPS.<br/></td>
</tr>
<tr class="odd">
...
<td>Se <strong>size_t</strong> desbordamiento durante un intento de copiar una cadena en un nuevo búfer.<br/></td>
</tr>
<tr class="even">
...
<td>Había más índices de glifo que puntos de código Unicode. Si no hay asignaciones de glifos, el número de índices de glifo debe ser menor o igual que el número de puntos de código Unicode.<br/></td>
</tr>
<tr class="odd">
...
<td>Se produjo un error grave y el contenido de XPS OM podría ser irrecuperable. Es posible que algunos componentes de XPS OM todavía se puedan usar, pero deben comprobarse antes de su uso. Dado que el estado de XPS OM no se puede predecir después de que se devuelva este error, todos los componentes de XPS OM deben liberarse y descartarse.<br/></td>
</tr>
<tr class="even">
...
<td>Un perfil de color estaba presente cuando no se esperaba uno. Solo se permite un perfil de color cuando el tipo de <a href="/windows/win32/api/xpsobjectmodel/ns-xpsobjectmodel-xps_color"><strong>color XPS_COLOR_TYPE_CONTEXT</strong></a>. <br/></td>
</tr>
<tr class="odd">
...
<td>El destino de una relación no es el tipo esperado por el contexto de la relación. <br/></td>
</tr>
<tr class="even">
...
<td>No se ha reconocido el tipo de relación.<br/></td>
</tr>
<tr class="odd">
...
<td>La colección de fuentes restringidas contiene una fuente sin restricciones.<br/></td>
</tr>
<tr class="even">
...
<td>Una geometría de ruta de acceso que no está en un diccionario de recursos tiene un <strong>atributo x:Key</strong> especificado. Las geometrías de ruta de acceso que no están en un diccionario de recursos no pueden tener <strong>un atributo x:Key.</strong><br/></td>
</tr>
</tbody>
</table>
...
Algunos métodos de API de documentos XPS hacen llamadas a [Packaging](/previous-versions/windows/desktop/opc/packaging) API. Para obtener información sobre los valores devueltos de Packaging API, vea [Errores de empaquetado.](/previous-versions/windows/desktop/opc/packaging-errors)
