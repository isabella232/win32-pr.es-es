...
Especifica una referencia de URI relativa a un perfil de ICC incluido en un documento XPS. El procesamiento de esta opción depende del valor de la característica PageDeviceColorSpaceUsage. Se supone que todos los elementos que usan ese perfil ya están en el espacio de colores del dispositivo adecuado y no se administrarán en color en el controlador o dispositivo.
