---
description: Obtenga información sobre el elemento configurable por el usuario PagePoster. Este tema no está actual. Para obtener la información más reciente, vea Especificación del esquema de impresión.
