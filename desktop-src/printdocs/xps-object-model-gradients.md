...
---
# <a name="xps-om-gradients"></a><span data-ttu-id="db89e-103">Degradados de XPS OM</span><span class="sxs-lookup"><span data-stu-id="db89e-103">XPS OM Gradients</span></span>

<span data-ttu-id="db89e-104">En este tema se proporciona un ejemplo del uso de degradados en un OM XPS.</span><span class="sxs-lookup"><span data-stu-id="db89e-104">This topic provides an example of using gradients in an XPS OM.</span></span>

## <a name="add-a-new-stop-to-an-existing-gradient"></a><span data-ttu-id="db89e-105">Agregar una nueva detención a un degradado existente</span><span class="sxs-lookup"><span data-stu-id="db89e-105">Add a new stop to an existing gradient</span></span>

<span data-ttu-id="db89e-106">En el ejemplo de código siguiente se agrega una nueva parada al degradado de un pincel de degradado lineal.</span><span class="sxs-lookup"><span data-stu-id="db89e-106">The following code example adds a new stop to the gradient of a linear-gradient brush.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="db89e-107">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="db89e-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="db89e-108">**Interfaz IXpsOMGradientStop**</span><span class="sxs-lookup"><span data-stu-id="db89e-108">**IXpsOMGradientStop Interface**</span></span>](/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomgradientstop)
</dt> <dt>

[<span data-ttu-id="db89e-109">**Interfaz IXpsOMGradientStopCollection**</span><span class="sxs-lookup"><span data-stu-id="db89e-109">**IXpsOMGradientStopCollection Interface**</span></span>](/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomgradientstopcollection)
</dt> </dl>
