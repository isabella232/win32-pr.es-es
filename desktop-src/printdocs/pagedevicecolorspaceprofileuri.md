...
Especifica un IDENTIFICADOR URI relativo a la raíz del paquete en un perfil DE CEDIDO contenido en un documento XPS. El procesamiento de esta opción depende de la configuración de la característica PageDeviceColorSpaceUsage. Se supone que todos los elementos que usan ese perfil ya están en el espacio de color del dispositivo adecuado y no se administrarán por colores en el controlador o dispositivo.
