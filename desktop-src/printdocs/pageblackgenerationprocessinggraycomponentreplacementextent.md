...
Describe la extensión más allá de las neutras (en colores cromáticos) que GCR aplica. 0% = reemplazo uniforme de componentes, 100% = reemplazo del componente gris.
