...
Describe el método de enlace. Cada documento se enlaza por separado. DocumentBinding y JobBindAllDocuments se excluyen mutuamente. Es el controlador el que determina el control de restricciones entre las palabras clave.
...
| \_BindingGutterValue\_<br/>  | Entero<br/> | microns<br/>    | Mayor o igual que 0.<br/>                                                                                                                                                | Define el margen de enlace mínimo para el enlace de finalización especificado. El medianil se mide en micras en relación con el borde de la dimensión de medios físicos.<br/> |
