...
4.  Establezca el método de resumen. Las constantes de cadena de URI del método de resumen se definen en cryptxml.h. Para obtener información sobre los valores de método de resumen [**válidos, vea IXpsSigningOptions::SetDigestMethod**](/windows/desktop/api/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssigningoptions-setdigestmethod).
