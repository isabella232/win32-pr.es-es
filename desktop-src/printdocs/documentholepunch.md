...
Describe las características de perforación de agujeros de la salida. Cada documento se perfora por separado. Las palabras clave JobHolePunch y DocumentHolePunch se excluyen mutuamente. Ambos no se deben especificar simultáneamente en un documento de capacidades de impresión o PrintTicket.
