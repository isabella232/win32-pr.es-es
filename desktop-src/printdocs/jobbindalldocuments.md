...
Describe el método de enlace. Todos los documentos del trabajo se enlazan juntos. JobBindAllDocuments y DocumentBinding son mutuamente excluyentes. Es el controlador quien determina el control de restricciones entre estas palabras clave.
...
| \_BindingGutterValue\_<br/>  | integer<br/> | Micras<br/>    | Mayor que 0.<br/>                                                                                                                                                            | Define el median de enlace mínimo para el enlace final especificado. El medianía se mide en micrones en relación con el borde de la dimensión multimedia física.<br/> |
