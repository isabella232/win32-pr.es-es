---
description: Los proveedores de PrintCapabilities deben admitir un conjunto mínimo de funcionalidades, que están implícitas en la interfaz de proveedor PrintTicket/PrintCapabilities.
...
Los proveedores de PrintCapabilities deben admitir un conjunto mínimo de funcionalidades, que están implícitas en la interfaz de proveedor PrintTicket/PrintCapabilities. Esta funcionalidad se incluye a continuación.
...
-   Deben ser capaces de determinar si esa configuración contiene conflictos de restricciones.
