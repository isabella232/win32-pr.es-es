---
description: Obtenga información sobre el elemento PageBorderless configurable por el usuario. Este tema no está al día. Para obtener la información más reciente, vea Especificación del esquema de impresión.
...
ms.locfileid: "127466299"
---
# <a name="pageborderless"></a>PageBorderless

Este tema no es actual. Para obtener la información más reciente, vea [La especificación de esquema de impresión](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Describe cuándo se debe imprimir el contenido de la imagen en los bordes físicos del medio.
