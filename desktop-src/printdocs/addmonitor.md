...
---
# <a name="addmonitor-function"></a>AddMonitor función)
...
Puntero a una cadena terminada en null que especifica el nombre del servidor en el que debe instalarse el monitor. En el caso de los sistemas que solo admiten la instalación local de monitores, esta cadena debe ser **null**.
...
Puntero a una estructura de supervisión de la [**\_ información \_ 2**](monitor-info-2.md) . Si el miembro **pEnvironment** de la estructura *pMonitors* es **null**, se usa el entorno actual del llamador (cliente), no del destino (servidor).
