---
description: Obtenga información sobre el elemento PageForceFrontSide configurable por el usuario. Este tema no está actual. Para obtener la información más reciente, vea Especificación del esquema de impresión.
...
ms.locfileid: "117868200"
---
# <a name="pageforcefrontside"></a>PageForceFrontSide

Este tema no es actual. Para obtener la información más reciente, vea [La especificación de esquema de impresión](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Obliga a que la salida aparezca en la parte frontal de una hoja de medios. Relevante para las hojas de medios con diferentes superficies en cada lado. En los casos en los que esta característica interfiere con las opciones de procesamiento (como DocumentDuplex), PageForceFrontSide tiene prioridad para la página específica a la que se aplica la característica.
