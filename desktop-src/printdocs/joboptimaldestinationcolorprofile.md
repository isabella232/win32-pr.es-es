...
Especifica el perfil de color óptimo según la configuración actual del dispositivo.
...
|---------------------------------|-------------------|----------------|---------------------------|------------------------------------------------|
| \_ProfileValue\_<br/>     | string<br/> | N/D<br/> | RGB, ICC, CMYK<br/> | Especifica el perfil de color.<br/>        |
