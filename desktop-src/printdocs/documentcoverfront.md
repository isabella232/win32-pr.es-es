...
Describe la portada delantera (a partir de). Cada documento tendrá una hoja independiente. La portada debe imprimirse en los PageMediaSize y PageMediaType usados para la primera página del documento. La portada debe integrarse en las opciones de procesamiento (como DocumentDuplex, DocumentNUp) tal y como se indica en la opción especificada.
