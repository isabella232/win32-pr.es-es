...
Describe las características de grapado de la salida. Cada documento se grapa por separado. Las palabras clave JobStapleAllDocuments y DocumentStaple se excluyen mutuamente. Es el controlador el que determina el control de restricciones entre estas palabras clave.
...
| \_AngleValue\_<br/>          | integer<br/> | grados<br/>         | Mayor que 0.<br/>                                                                                                                                                            | Especifica el ángulo de grapado, relativo a la dirección X de PageImageableSize. El ángulo de grapa se mide en sentido contrario a las agujas del reloj.<br/> |
