...
---
# <a name="job_info_2-structure"></a>Estructura de información de trabajo \_ \_ 2

La estructura **Job \_ info \_ 2** describe un conjunto completo de valores asociados a un trabajo.
...
El estado del trabajo. Este miembro puede ser uno o varios de los valores siguientes.
...
| Nombres Unicode y ANSI<br/>   | **\_ Información del trabajo \_ \_ 2W** (Unicode) y la **\_ información del trabajo \_ \_ 2A** (ANSI)<br/>                                   |
