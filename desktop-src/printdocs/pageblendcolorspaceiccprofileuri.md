...
Especifica una referencia de URI relativa a un perfil de ICC que define el espacio de colores que se debe usar para la combinación. <Uri>Es un nombre de parte absoluta \_ relativo a la raíz del paquete.
...
| Notas <br/>          | Esto se aplica a los documentos XPS únicamente y no se debe usar en elementos PrintTicket arbitrarios. Vinculado al elemento PageBlendColorSpace.<br/> |
