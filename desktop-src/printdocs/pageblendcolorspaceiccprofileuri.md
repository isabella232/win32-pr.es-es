...
Especifica una referencia de URI relativa a un perfil DE CIA que define el espacio de color que se debe usar para la combinación. es <Uri> un nombre de elemento absoluto relativo a la raíz del \_ paquete.
