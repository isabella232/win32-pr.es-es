...
| Elementos secundarios<br/>  | El sistema no asigna ninguna importancia a la ordenación de los elementos. Si los clientes deciden atribuir cierta importancia en el orden de los elementos, pueden hacerlo libremente. <br/> *Valor* de propiedad (uno o *más)* (cero o más)<br/> or <br/> *Valor* de propiedad (cero o *más)* (uno o más)<br/> |
