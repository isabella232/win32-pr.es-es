...
Para cumplir con el marco de esquema de impresión, que requiere que un elemento Value o subelementos esté presente en los elementos que admiten valores, se debe representar un valor ausente o no definido mediante la presentación del elemento Value como un elemento vacío; es decir, como &lt; Valor &gt; &lt; /Valor &gt; .
