...
---
# <a name="process_v2-class"></a>Process \_ V2 (clase)
...
| Valor del tipo de evento, 32                                            | Evento de contadores de rendimiento. La clase de MOF [**Process \_ V2 \_ TypeGroup2**](process-v2-typegroup2.md) define los datos de evento para este evento.                                                                                          |
| Valor del tipo de evento, 33                                            | Detención de los contadores de rendimiento en el inicio de la sesión. La clase de MOF [**Process \_ V2 \_ TypeGroup2**](process-v2-typegroup2.md) define los datos de evento para este evento.                                                     |
| Valor del tipo de evento, 39                                            | Evento de proceso inactivo. La clase de MOF [**Process \_ TypeGroup1**](process-typegroup1.md) define los datos de evento para este evento.                                                                                                      |
