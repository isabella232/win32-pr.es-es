---
description: En el ejemplo siguiente se muestra cómo consumir datos de eventos mediante la función TdhGetProperty.
ms.assetid: 16b36718-087f-4be9-9ca2-fc083358017b
title: Usar TdhGetProperty para consumir datos de eventos
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103810927"
---
# <a name="using-tdhgetproperty-to-consume-event-data"></a><span data-ttu-id="fb0d0-103">Usar TdhGetProperty para consumir datos de eventos</span><span class="sxs-lookup"><span data-stu-id="fb0d0-103">Using TdhGetProperty to Consume Event Data</span></span>

<span data-ttu-id="fb0d0-104">En el ejemplo siguiente se muestra cómo consumir datos de eventos mediante la función [**TdhGetProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) .</span><span class="sxs-lookup"><span data-stu-id="fb0d0-104">The following example shows how to consume event data using the [**TdhGetProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) function.</span></span>
