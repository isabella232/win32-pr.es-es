...
---
# <a name="udpip_typegroup1-class"></a>UdpIp \_ TypeGroup1 (clase)

Esta clase es la clase de tipo de evento para los eventos de envío y recepción de IPv4 de UDP/IP.
