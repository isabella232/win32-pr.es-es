...
---
# <a name="example-that-creates-a-session-and-enables-a-manifest-based-or-classic-provider"></a><span data-ttu-id="260d7-103">Ejemplo que crea una sesión y habilita un proveedor clásico o basado en manifiestos</span><span class="sxs-lookup"><span data-stu-id="260d7-103">Example that Creates a Session and Enables a Manifest-based or Classic Provider</span></span>

<span data-ttu-id="260d7-104">En el ejemplo siguiente se muestra cómo iniciar una sesión de seguimiento, se habilita un proveedor clásico o basado en manifiesto, se deshabilita el proveedor y, a continuación, se detiene la sesión.</span><span class="sxs-lookup"><span data-stu-id="260d7-104">The following example shows how to start a trace session, enables a manifest-based or classic provider, disables the provider and then stops the session.</span></span>
