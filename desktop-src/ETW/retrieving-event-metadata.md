---
description: En el ejemplo siguiente se muestra cómo utilizar las funciones auxiliares de datos de seguimiento para recuperar los metadatos de cada evento.
ms.assetid: 599e0405-b125-4742-b134-964e25413f59
title: Recuperar metadatos de eventos
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103907997"
---
# <a name="retrieving-event-metadata"></a><span data-ttu-id="2d328-103">Recuperar metadatos de eventos</span><span class="sxs-lookup"><span data-stu-id="2d328-103">Retrieving Event Metadata</span></span>

<span data-ttu-id="2d328-104">En el ejemplo siguiente se muestra cómo utilizar las funciones auxiliares de datos de seguimiento para recuperar los metadatos de cada evento.</span><span class="sxs-lookup"><span data-stu-id="2d328-104">The following example shows how to use the trace data helper functions to retrieve metadata for each event.</span></span> <span data-ttu-id="2d328-105">Vea también los ejemplos incluidos con las funciones [**TdhQueryProviderFieldInformation**](/windows/desktop/api/Tdh/nf-tdh-tdhqueryproviderfieldinformation) y [**TdhEnumerateProviderFieldInformation**](/windows/desktop/api/Tdh/nf-tdh-tdhenumerateproviderfieldinformation) .</span><span class="sxs-lookup"><span data-stu-id="2d328-105">Also see the examples included with the [**TdhQueryProviderFieldInformation**](/windows/desktop/api/Tdh/nf-tdh-tdhqueryproviderfieldinformation) and [**TdhEnumerateProviderFieldInformation**](/windows/desktop/api/Tdh/nf-tdh-tdhenumerateproviderfieldinformation) functions.</span></span>
