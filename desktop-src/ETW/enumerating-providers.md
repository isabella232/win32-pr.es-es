...
Para recuperar una lista de proveedores que han instalado el manifiesto o las clases MOF en el equipo, llame a la función [**TdhEnumerateProviders**](/windows/desktop/api/Tdh/nf-tdh-tdhenumerateproviders) .

En el ejemplo siguiente se muestra cómo enumerar los proveedores.
