---
description: Este programa de ejemplo funciona con el programa de servidor de mediante SSPI con un servidor de Windows Sockets.
ms.assetid: 7ec15770-d3bd-4488-abe8-058115fec071
title: Usar SSPI con un cliente de Windows Sockets
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104546334"
---
# <a name="using-sspi-with-a-windows-sockets-client"></a><span data-ttu-id="1d8b0-103">Usar SSPI con un cliente de Windows Sockets</span><span class="sxs-lookup"><span data-stu-id="1d8b0-103">Using SSPI with a Windows Sockets Client</span></span>

<span data-ttu-id="1d8b0-104">Este programa de ejemplo funciona con el programa de servidor de [mediante SSPI con un servidor de Windows Sockets](using-sspi-with-a-windows-sockets-server.md).</span><span class="sxs-lookup"><span data-stu-id="1d8b0-104">This sample program works with the server program [Using SSPI with a Windows Sockets Server](using-sspi-with-a-windows-sockets-server.md).</span></span> <span data-ttu-id="1d8b0-105">Los programas de ejemplo de cliente y servidor están diseñados para funcionar juntos.</span><span class="sxs-lookup"><span data-stu-id="1d8b0-105">The client and server sample programs are designed to work together.</span></span> <span data-ttu-id="1d8b0-106">Ambos programas usan el archivo de encabezado SspiExample. h, que se puede encontrar en el [archivo de encabezado para los ejemplos de cliente y servidor de SSPI](header-file-for-sspi-client-and-server.md).</span><span class="sxs-lookup"><span data-stu-id="1d8b0-106">Both programs use the header file SspiExample.h, which can be found in [Header File for SSPI Client and Server Samples](header-file-for-sspi-client-and-server.md).</span></span> <span data-ttu-id="1d8b0-107">Este programa incluye llamadas a funciones en SECUR32. lib y Ws2 \_ 32. lib, que deben incluirse entre las bibliotecas de vínculos.</span><span class="sxs-lookup"><span data-stu-id="1d8b0-107">This program includes calls to functions in Secur32.lib and Ws2\_32.lib, which must be included among the link libraries.</span></span>

<span data-ttu-id="1d8b0-108">Este programa muestra lo siguiente:</span><span class="sxs-lookup"><span data-stu-id="1d8b0-108">This program demonstrates the following:</span></span>

-   <span data-ttu-id="1d8b0-109">Establecer una conexión de Windows Sockets con un servidor.</span><span class="sxs-lookup"><span data-stu-id="1d8b0-109">Establishing a Windows Sockets connection with a server.</span></span>
-   <span data-ttu-id="1d8b0-110">Inicializar una sesión SSPI autenticada con el SSP Negotiate.</span><span class="sxs-lookup"><span data-stu-id="1d8b0-110">Initializing an authenticated SSPI session with the Negotiate SSP.</span></span>
-   <span data-ttu-id="1d8b0-111">Conectar con un servidor y establecer una sesión de comunicación segura.</span><span class="sxs-lookup"><span data-stu-id="1d8b0-111">Connecting with a server and establishing a secure communication session.</span></span>
-   <span data-ttu-id="1d8b0-112">Recibir y descifrar un mensaje desde el servidor dentro de la sesión segura.</span><span class="sxs-lookup"><span data-stu-id="1d8b0-112">Receiving and decrypt a message from the server within the secure session.</span></span>

<span data-ttu-id="1d8b0-113">Este programa de ejemplo usa un control de errores limitado.</span><span class="sxs-lookup"><span data-stu-id="1d8b0-113">This sample program uses limited error handling.</span></span>
