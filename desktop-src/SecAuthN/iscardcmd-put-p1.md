---
description: Establece el primer byte de parámetro (P1) de la unidad de datos del protocolo de aplicación (APDU).
...
El **método put \_ P1** establece el primer byte de parámetro (P1) de la unidad [*de datos del protocolo de aplicación*](../secgloss/a-gly.md) (APDU).
...
Para establecer el valor P2 de la APDU, llame a [**get \_ P2**](iscardcmd-get-p2.md).
...
En el ejemplo siguiente se muestra cómo establecer el primer byte de parámetro (P1) de la unidad de [*datos del protocolo de aplicación*](../secgloss/a-gly.md) (APDU). En el ejemplo se supone que pISCardCmd es un puntero válido a una instancia de la [**interfaz ISCardCmd.**](iscardcmd.md)
