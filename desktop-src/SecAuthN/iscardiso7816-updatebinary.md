---
description: El método UpdateBinary construye un comando de unidad de datos de protocolo de aplicación (APDU) que actualiza los bits presentes en un archivo básico con los bits dados en el comando APDU.
...
El **método UpdateBinary** construye un comando de unidad de datos de protocolo de aplicación (APDU) que actualiza los bits presentes en un archivo básico con los bits dados en el comando APDU. [](../secgloss/a-gly.md)
...
El comando encapsulado solo se puede realizar si el estado de seguridad de la tarjeta inteligente satisface los atributos de seguridad del archivo básico que se está procesando.
