...
| <span id="LOGON32_PROVIDER_WINNT50"></span><span id="logon32_provider_winnt50"></span><dl> <dt>**PROVEEDOR LOGON32 \_ \_ WINNT50**</dt> </dl> | Use el proveedor de inicio de sesión negotiate. <br/>                                                                                                                                                         |
...
Si este parámetro no es **NULL,** el autor de la llamada de esta función debe tener el privilegio **SE privilegio \_ TCB \_ privilege** concedido y habilitado.
...
Puntero a una variable de identificador que recibe un identificador para un token que representa al usuario especificado.
...
Cuando ya no necesite este identificador, cierre el control mediante una llamada a la [**función CloseHandle.**](/windows/win32/api/handleapi/nf-handleapi-closehandle)
...
Puntero a un puntero a un SID que recibe el SID del usuario que inició sesión.
...
[Cliente o servidor Access Control](../secauthz/client-server-access-control.md)
</dt> <dt>
