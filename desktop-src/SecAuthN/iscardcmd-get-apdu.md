...
El **método get \_ Apdu** recupera la unidad de datos del [*protocolo de aplicación*](../secgloss/a-gly.md) (APDU) sin procesar.
...
En el ejemplo siguiente se muestra cómo recuperar la unidad de datos del [*protocolo de aplicación*](../secgloss/a-gly.md) (APDU) sin procesar. En el ejemplo se supone que pISCardCmd es un puntero válido a la interfaz [**ISCardCmd**](iscardcmd.md) y que pIByteApdu es un puntero válido a una instancia de la [**interfaz IByteBuffer.**](ibytebuffer.md)
