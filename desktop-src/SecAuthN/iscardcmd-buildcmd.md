...
El **método BuildCmd** construye una unidad de datos de protocolo de [*aplicación*](../secgloss/a-gly.md) de comandos (APDU) válida para la transmisión a una [*tarjeta inteligente.*](../secgloss/s-gly.md)
