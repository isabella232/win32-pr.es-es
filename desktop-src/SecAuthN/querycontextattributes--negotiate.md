...
La **función QueryContextAttributes (Negotiate)** permite a una aplicación de transporte consultar el [*paquete*](../secgloss/s-gly.md) de seguridad Negotiate para determinados [*atributos*](../secgloss/a-gly.md#_security_attribute_gly) de un contexto [*de seguridad*](../secgloss/s-gly.md).
