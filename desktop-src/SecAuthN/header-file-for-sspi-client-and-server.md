...
---
# <a name="header-file-for-sspi-client-and-server"></a>Archivo de encabezado para el cliente y el servidor SSPI

El siguiente archivo de encabezado debe incluirse con los ejemplos de SSPI Client y Server como SspiExample. h. Declara las funciones que controlan la comunicación con el paquete de seguridad.
