...
En Windows 10, versión 1607 y Windows Server 2016, los siguientes conjuntos de cifrado están habilitados y en este orden de prioridad de forma predeterminada con el proveedor de Microsoft Schannel:
...
A partir de Windows 10, versión 1607 y Windows Server 2016, se habilitan los siguientes conjuntos de cifrado de PSK y en este orden de prioridad de forma predeterminada con el proveedor de Microsoft Schannel:
