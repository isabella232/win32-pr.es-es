...
<span data-ttu-id="53b3f-115">Este programa de ejemplo usa un control de errores limitado.</span><span class="sxs-lookup"><span data-stu-id="53b3f-115">This sample program uses limited error handling.</span></span>
