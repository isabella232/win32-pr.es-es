---
description: Permite que una aplicación de transporte consulte el [*paquete de seguridad*](../secgloss/s-gly.md) de NTLM para determinados atributos de un [contexto de seguridad](../secgloss/s-gly.md).
...
ms.locfileid: "104154142"
---
# <a name="querycontextattributes-ntlm-function"></a>Función QueryContextAttributes (NTLM)

La función **QueryContextAttributes (NTLM)** permite que una aplicación de transporte consulte el [*paquete de seguridad*](../secgloss/s-gly.md) NTLM para determinados [*atributos*](../secgloss/a-gly.md#_security_attribute_gly) de un [contexto de seguridad](../secgloss/s-gly.md).
