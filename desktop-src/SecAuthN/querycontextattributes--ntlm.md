...
ms.locfileid: "118920103"
---
# <a name="querycontextattributes-ntlm-function"></a>Función QueryContextAttributes (NTLM)

La **función QueryContextAttributes (NTLM)** permite a una aplicación de transporte consultar el paquete de [*seguridad*](../secgloss/s-gly.md) NTLM para determinados [*atributos*](../secgloss/a-gly.md#_security_attribute_gly) de un contexto [de seguridad](../secgloss/s-gly.md).
...
| <span id="SECPKG_ATTR_ROOT_STORE"></span><span id="secpkg_attr_root_store"></span><dl> <dt>**SECPKG \_ Almacén raíz \_ \_ de ATTR**</dt> <dt>0x55</dt> </dl>                                           | El *parámetro pBuffer* contiene un puntero a **HCERTCONTEXT.** <br/> Busca un contexto de certificado que contiene un certificado proporcionado por el almacén raíz.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
