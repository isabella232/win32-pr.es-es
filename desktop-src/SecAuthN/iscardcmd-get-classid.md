...
El **método get \_ ClassId** recupera el identificador de clase de la unidad [*de datos del protocolo de aplicación*](../secgloss/a-gly.md) (APDU).
