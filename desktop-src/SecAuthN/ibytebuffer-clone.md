...
Este método crea un nuevo objeto de secuencia para tener acceso a los mismos bytes pero mediante un puntero de búsqueda independiente. El nuevo objeto de secuencia ve los mismos datos que el objeto de flujo de origen. Los cambios escritos en un objeto son visibles inmediatamente en el otro. El bloqueo de intervalo se comparte entre los objetos de secuencia.
