---
description: El método GetChallenge construye un comando de unidad de datos de protocolo de aplicación (APDU) que emite un desafío (por ejemplo, un número aleatorio) para su uso en un procedimiento relacionado con la seguridad.
...
El **método GetChallenge** construye un comando de unidad de datos de protocolo de aplicación (APDU) que emite un desafío (por ejemplo, un número aleatorio) para su uso en un procedimiento relacionado con la seguridad. [](../secgloss/a-gly.md)
...
El desafío es válido al menos para el comando siguiente.
