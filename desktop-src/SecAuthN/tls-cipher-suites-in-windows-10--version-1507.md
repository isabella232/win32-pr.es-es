...
-   Se permite cuando la aplicación pasa SCH \_ usar \_ \_ Criptografía segura: el proveedor de Microsoft Schannel filtrará los conjuntos de cifrado débil conocidos cuando la aplicación use la \_ marca de \_ \_ cifrado Strong usar. En Windows 10, versión 1507, se filtran los conjuntos de cifrado RC4.
...
En Windows 10, versión 1507, los siguientes conjuntos de cifrado están habilitados y en este orden de prioridad de forma predeterminada, mediante el proveedor de Microsoft Schannel:
...
| TLS \_ RSA \_ con \_ valores NULL \_ MD5 solo se usa cuando la aplicación solicita explícitamente.<br/> | Sí<br/>                      | TLS 1,2, TLS 1,1, TLS 1,0, SSL 3,0<br/> |
