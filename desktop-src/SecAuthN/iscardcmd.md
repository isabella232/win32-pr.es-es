...
| [**Borrar**](iscardcmd-clear.md)             | Borra los búferes de mensajes apdu y apdu de respuesta.<br/>                                             |
| [**Encapsular**](iscardcmd-encapsulate.md) | Encapsula el comando determinado APDU en otro comando APDU para su transmisión a una tarjeta inteligente.<br/> |
...
|:----------------------------------------------------------------------|:----------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AlternateClassId**](iscardcmd-get-alternateclassid.md)<br/> | Lectura/escritura<br/> | Valor actual del identificador de clase alternativa.<br/>                                                                                                                        |
| [**Apdu**](iscardcmd-get-apdu.md)<br/>                         | Lectura/escritura<br/> | Unidad [*de datos del protocolo de aplicación*](../secgloss/a-gly.md) (APDU) sin procesar.<br/> |
| [**ApduLength**](iscardcmd-get-apdulength.md)<br/>             | Solo lectura<br/>  | Longitud de la APDU.<br/>                                                                                                                                      |
| [**ApduReply**](iscardcmd-get-apdureply.md)<br/>               | Lectura/escritura<br/> | [*Responder a APDU*](../secgloss/r-gly.md).<br/>                                                                        |
| [**ApduReplyLength**](iscardcmd-get-apdureplylength.md)<br/>   | Lectura/escritura<br/> | Longitud de la APDU de respuesta.<br/>                                                                                                                                |
| [**Classid**](iscardcmd-get-classid.md)<br/>                   | Lectura/escritura<br/> | Identificador de clase de la APDU.<br/>                                                                                                                                    |
| [**Datos**](iscardcmd-get-data.md)<br/>                         | Solo lectura<br/>  | Campo de datos de la APDU.<br/>                                                                                                                                  |
| [**InstructionId**](iscardcmd-get-instructionid.md)<br/>       | Lectura/escritura<br/> | Byte de id. de instrucción de apdu.<br/>                                                                                                                       |
| [**LeField**](iscardcmd-get-lefield.md)<br/>                   | Solo lectura<br/>  | Campo Le de la APDU.<br/>                                                                                                                                    |
| [**Nad**](iscardcmd-put-nad.md)<br/>                           | Lectura/escritura<br/> | Dirección del nodo.<br/>                                                                                                                                            |
| [**P1**](iscardcmd-get-p1.md)<br/>                             | Lectura/escritura<br/> | Primer byte de parámetro de la APDU.<br/>                                                                                                                        |
| [**P2**](iscardcmd-get-p2.md)<br/>                             | Lectura/escritura<br/> | Segundo byte de parámetro de la APDU.<br/>                                                                                                                       |
| [**P3**](iscardcmd-get-p3.md)<br/>                             | Solo lectura<br/>  | Tercer byte de parámetro de la APDU.<br/>                                                                                                                        |
| [**ReplyNad**](iscardcmd-get-replynad.md)<br/>                 | Lectura/escritura<br/> | Dirección de nodo utilizada por la tarjeta en el mensaje de respuesta.<br/>                                                                                                      |
| [**ReplyStatus**](iscardcmd-get-replystatus.md)<br/>           | Lectura/escritura<br/> | [*Palabra de estado del mensaje de APDU*](../secgloss/r-gly.md) de respuesta.<br/>                                                    |
