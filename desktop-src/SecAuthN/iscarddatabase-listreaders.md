...
---
# <a name="iscarddatabaselistreaders-method"></a>ISCardDatabase:: ListReaders (método)
...
El método **ListReaders** recupera los nombres de los [*lectores*](../secgloss/r-gly.md) de tarjetas inteligentes registrados en la [*base de datos de tarjetas inteligentes*](../secgloss/s-gly.md).
...
Puntero a un SAFEARRAY de BSTR que contiene los nombres de los lectores de tarjetas inteligentes si se realiza correctamente; **Null** si se produjo un error en la operación.
...
| <dl> <dt>**\_puntero E**</dt> </dl>     | Se pasó un puntero no válido en *ppReaders*.<br/> |
...
Para recuperar todos los [*grupos de lectores*](../secgloss/r-gly.md)o [*tarjetas inteligentes*](../secgloss/s-gly.md) conocidos, llame a [**ListCards**](iscarddatabase-listcards.md) o [**ListReaderGroups**](iscarddatabase-listreadergroups.md) , respectivamente.
