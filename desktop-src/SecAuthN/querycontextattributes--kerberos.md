---
description: Permite que una aplicación de transporte consulte el paquete de [*seguridad de*](../secgloss/s-gly.md) Kerberos para determinados atributos de un contexto [*de seguridad*](../secgloss/s-gly.md).
...
La **función QueryContextAttributes (Kerberos)** permite que una aplicación de transporte consulte el paquete de seguridad [*de*](../secgloss/s-gly.md) Kerberos para determinados [*atributos*](../secgloss/a-gly.md#_security_attribute_gly) de un contexto [*de seguridad*](../secgloss/s-gly.md).
