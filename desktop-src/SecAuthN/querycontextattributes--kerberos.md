...
La función **QueryContextAttributes (Kerberos)** permite que una aplicación de transporte consulte el [*paquete de seguridad*](../secgloss/s-gly.md) de Kerberos para determinados [*atributos*](../secgloss/a-gly.md#_security_attribute_gly) de un [*contexto de seguridad*](../secgloss/s-gly.md).
