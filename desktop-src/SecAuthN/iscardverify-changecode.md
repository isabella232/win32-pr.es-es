...
---
# <a name="iscardverifychangecode-method"></a>ISCardVerify:: ChangeCode (método)
...
El método **ChangeCode** reemplaza el código CHV actual (verificación del titular de la tarjeta) con el nuevo código CHV.
...
Indica si el código es global o local, y si el código debe estar habilitado o deshabilitado.
