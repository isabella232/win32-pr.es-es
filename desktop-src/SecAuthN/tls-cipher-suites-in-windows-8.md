...
Windows actualización de Windows actualiza Windows 8 7, Windows 8 y Windows Server 2012 la actualización de 3042058 que cambia el orden de prioridad. Consulte [Aviso de seguridad de Microsoft 3042058](/security-updates/SecurityAdvisories/2015/3042058) para obtener más información. Los siguientes conjuntos de cifrado están habilitados y en este orden de prioridad de forma predeterminada por el proveedor Schannel de Microsoft:
