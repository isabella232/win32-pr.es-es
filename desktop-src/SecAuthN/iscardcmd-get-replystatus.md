...
El **método get \_ ReplyStatus** recupera la palabra de estado del mensaje [*de la APDU*](../secgloss/r-gly.md) de respuesta.
...
Para establecer la palabra de estado del mensaje de la APDU de respuesta, llame a [**\_ put ReplyStatus**](iscardcmd-put-replystatus.md).
