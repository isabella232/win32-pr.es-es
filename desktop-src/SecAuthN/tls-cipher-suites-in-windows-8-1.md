...
-   Se permite cuando la aplicación pasa SCH \_ usar \_ \_ Criptografía segura: el proveedor de Microsoft Schannel filtrará los conjuntos de cifrado débil conocidos cuando la aplicación use la \_ marca de \_ \_ cifrado Strong usar. En Windows 8.1, se filtran los conjuntos de cifrado RC4.
...
Windows 8.1 y Windows Server 2012 R2 se actualizan mediante la Windows Update de la [actualización 2919355](https://support.microsoft.com/kb/2919355) aplicada que agrega los nuevos conjuntos de cifrado y cambia el orden de prioridad. Los siguientes conjuntos de cifrado están habilitados y en este orden de prioridad de forma predeterminada por el proveedor de Microsoft Schannel:
