---
description: Direct3D es una API de bajo nivel para dibujar primitivas con la canalización de representación o para realizar operaciones paralelas con el sombreador de proceso.
...
ms.locfileid: "118541276"
---
# <a name="direct3d"></a>Direct3D

Direct3D es una API de bajo nivel para dibujar primitivas con la canalización de representación o para realizar operaciones paralelas con el sombreador de proceso. Consulte el contenido siguiente para obtener más información.

Para obtener información sobre cómo obtener e instalar Direct3D, vea Configuración del entorno de programación de [Direct3D 12.](./direct3d12/directx-12-programming-environment-set-up.md)
