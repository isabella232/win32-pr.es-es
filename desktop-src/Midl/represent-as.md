...
description: El atributo \ represent as\ ACF asocia un tipo local con nombre en el tipo repr-type del idioma de destino a un tipo de transferencia denominado-type que se transfiere entre el cliente \_ y el servidor.
...
ms.locfileid: "127159397"
---
# <a name="represent_as-attribute"></a>representar \_ como atributo

El **\[ atributo represent \_ as \]** ACF asocia un tipo local con nombre en el *repr-type* del idioma de destino a un tipo de transferencia *denominado-type* que se transfiere entre el cliente y el servidor.
...
| *tipo \_ con nombre: \_ local \_ gratis** | Libera la memoria asignada para los datos a los que hacen referencia los punteros en el tipo local. RPC libera memoria para el propio tipo.                                                                                             |
