...
description: Los programas pueden usar estos atributos en funciones individuales dentro de la interfaz y afectar solo a esa función.
ms.assetid: c54dbcd9-46c9-4755-b4a8-0f78068920b7
keywords:
- IDL MIDL, atributos, llamada de función
ms.topic: article
ms.date: 05/31/2018
...
Los programas pueden usar estos atributos en funciones individuales dentro de la interfaz y afectar solo a esa función.
...
| [**idempotent**](idempotent.md) | La llamada no cambia de estado y devuelve la misma información cada vez que se llama con los mismos parámetros de entrada.                                                                                                                                     |
...
| [**llamar \_ a como**](call-as.md)      | Mapas una función no actualizable a una llamada a procedimiento remoto.                                                                                                                                                                                                   |
