...
keywords:
- Clase MsRdpClient9NotSafeForScripting Servicios de Escritorio remoto
- Clase MsRdpClient9NotSafeForScripting Servicios de Escritorio remoto , descrito
topic_type:
- apiref
api_name:
...
ms.locfileid: "122480661"
---
# <a name="msrdpclient9notsafeforscripting-class"></a>Clase MsRdpClient9NotSafeForScripting

Control de cliente RDP de Microsoft: versión 10
...
**MsRdpClient9NotSafeForScripting** tiene estos tipos de miembros:
...
La **clase MsRdpClient9NotSafeForScripting** tiene estos métodos.
...
| [**Conexión**](imstscax-connect.md)                                                         | Inicia una conexión mediante las propiedades establecidas actualmente en el control .<br/>                                                                                                                                                                                                          |
...
| [**OnIdleTimeoutNotification**](imstscaxevents-onidletimeoutnotification.md)               | Se llama cuando el usuario no ha realizado ninguna entrada con el mouse o el teclado durante el período de tiempo establecido por el método [**IMsRdpClientAdvancedSettings::p ut \_ MinutesToIdleTimeout.**](imsrdpclientadvancedsettings-minutestoidletimeout.md)<br/>                                                |
...
La **clase MsRdpClient9NotSafeForScripting** tiene estas propiedades.
...
| <a href="imsrdpclient8-advancedsettings9.md"><strong>AdvancedSettings9</strong></a><br /> | Solo lectura<br /> | Interfaz <a href="imsrdpclientadvancedsettings8.md"><strong>IMsRdpClientAdvancedSettings8</strong></a> que representa el objeto de configuración.<br /> | 
| <a href="imsrdpclientnonscriptable4-allowcredentialsaving.md"><strong>AllowCredentialSaving</strong></a><br /> | Lectura/escritura<br /> | Especifica si el cuadro de diálogo credenciales muestra una casilla para habilitar el guardado de credenciales.<br /> | 
| <a href="imsrdpclientnonscriptable5-allowpromptingforcredentials.md"><strong>AllowPromptingForCredentials</strong></a><br /> | Lectura/escritura<br /> | Especifica si el control Escritorio remoto ActiveX puede solicitar credenciales al usuario.<br /> | 
...
| <a href="imsrdpclientnonscriptable5-disableremoteappcapscheck.md"><strong>DisableRemoteAppCapsCheck</strong></a><br /> | Lectura/escritura<br /> | Especifica si el control Escritorio remoto ActiveX no debe comprobar las funcionalidades de RemoteApp del servidor.<br /> | 
...
| <a href="imsrdpclientnonscriptable4-markrdpsettingssecure.md"><strong>MarkRdpSettingsSecure</strong></a><br /> | Lectura/escritura<br /> | Especifica si la configuración de RDP está marcada como segura.<br /> | 
...
| <a href="imsrdpclientnonscriptable4-redirectionwarningtype.md"><strong>RedirectionWarningType</strong></a><br /> | Lectura/escritura<br /> | Controla la presencia y la apariencia del cuadro de diálogo de redireccionamiento.<br /> | 
...
| <a href="imsrdpclient-securedsettings2.md"><strong>SecuredSettings2</strong></a><br /> | Solo lectura<br /> | Puntero a la <a href="imsrdpclientsecuredsettings-interface.md"><strong>interfaz IMsRdpClientSecuredSettings,</strong></a> que se usa para establecer la configuración segura para el control de cliente.<br /> | 
...
| <a href="imsrdpclient6-transportsettings2.md"><strong>TransportSettings2</strong></a><br /> | Solo lectura<br /> | Interfaz a <a href="imsrdpclienttransportsettings2.md"><strong>IMsRdpClientTransportSettings2.</strong></a><br /> | 
...
| <a href="imsrdpclient9-transportsettings4.md"><strong>TransportSettings4</strong></a><br /> | Solo lectura<br /> | Objeto que admite la <a href="imsrdpclienttransportsettings4.md"><strong>interfaz IMsRdpClientTransportSettings4.</strong></a><br /> | 
| <a href="imsrdpclientnonscriptable4-trustedzonesite.md"><strong>TrustedZoneSite</strong></a><br /> | Lectura/escritura<br /> | Especifica si el sitio web desde el que el usuario inició la conexión se encuentra en la lista de sitios de confianza del equipo cliente.<br /> | 
...
| <a href="imsrdppreferredredirectioninfo-useredirectionservername.md"><strong>UseRedirectionServerName</strong></a><br /> | Lectura/escritura<br /> | Si se va a usar el nombre del servidor de redireccionamiento.<br /> | 
...
| CLSID<br/>                    | CLSID \_ MsRdpClient9NotSafeForScripting se define como 8B918B82-7985-4C24-89DF-C33AD2BBFBCD<br/> |
