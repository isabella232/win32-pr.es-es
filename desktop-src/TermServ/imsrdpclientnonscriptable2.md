...
---
# <a name="imsrdpclientnonscriptable2-interface"></a>Interfaz IMsRdpClientNonScriptable2

Proporciona acceso a las propiedades noscriptables de la sesión remota de un cliente en el control Escritorio remoto ActiveX cliente. Deriva de la [**interfaz IMsRdpClientNonScriptable.**](imsrdpclientnonscriptable-interface.md) Solo se puede acceder a los métodos de esta interfaz a través de vtable; no están disponibles para su uso en clientes que pueden incluir scripts.
