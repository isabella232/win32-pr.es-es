...
keywords:
- Clase MsRdpClient3a Servicios de Escritorio remoto
- Clase MsRdpClient3a Servicios de Escritorio remoto , descrito
topic_type:
- apiref
api_name:
- MsRdpClient3a
...
ms.locfileid: "119058643"
---
# <a name="msrdpclient3a-class"></a>Clase MsRdpClient3a

Control de cliente RDP de Microsoft (redistribuible): versión 4a
...
**MsRdpClient3a** tiene estos tipos de miembros:
...
La **clase MsRdpClient3a** tiene estos métodos.
...
La **clase MsRdpClient3a** tiene estas propiedades.
...
| CLSID<br/>                    | CLSID \_ MsRdpClient3a se define como 6A6F4B83-45C5-4CA9-BDD9-0D81C12295E4<br/>     |
