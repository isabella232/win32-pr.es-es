...
keywords:
- Clase MsRdpClient9 Servicios de Escritorio remoto
- Clase MsRdpClient9 Servicios de Escritorio remoto , descrito
topic_type:
- apiref
api_name:
- MsRdpClient9
...
ms.locfileid: "126968024"
---
# <a name="msrdpclient9-class"></a>Clase MsRdpClient9

Control de cliente RDP de Microsoft (redistribuible): versión 10
...
**MsRdpClient9** tiene estos tipos de miembros:
...
La **clase MsRdpClient9** tiene estos métodos.
...
| [**NotifyRedirectDeviceChange**](imsrdpclientnonscriptable-notifyredirectdevicechange.md)  | Notifica al módulo de redireccionamiento de dispositivos Escritorio remoto ActiveX control que se ha producido un cambio de dispositivo en el sistema. Este método pasa [**notificaciones \_ DE WM DEVICECHANGE**](/windows/desktop/DevIO/wm-devicechange) al control .<br/>                                                        |
...
La **clase MsRdpClient9** tiene estas propiedades.
...
| <a href="imsrdpclientnonscriptable5-allowpromptingforcredentials.md"><strong>AllowPromptingForCredentials</strong></a><br /> | Lectura y escritura<br /> | Especifica si el control Escritorio remoto ActiveX puede solicitar al usuario las credenciales.<br /> | 
...
| <a href="imstscnonscriptable-cleartextpassword.md"><strong>ClearTextPassword</strong></a><br /> | Solo escritura<br /> | El Escritorio remoto ActiveX contraseña de control, en formato de texto no cifrado.<br /> | 
...
| <a href="imsrdpclientnonscriptable5-disableremoteappcapscheck.md"><strong>DisableRemoteAppCapsCheck</strong></a><br /> | Lectura y escritura<br /> | Especifica si el control Escritorio remoto ActiveX no debe comprobar las funcionalidades de RemoteApp del servidor.<br /> | 
...
| <a href="imsrdpclientnonscriptable4-markrdpsettingssecure.md"><strong>MarkRdpSettingsSecure</strong></a><br /> | Lectura y escritura<br /> | Especifica si la configuración de RDP está marcada como segura.<br /> | 
...
| <a href="imsrdpclientnonscriptable4-redirectionwarningtype.md"><strong>RedirectionWarningType</strong></a><br /> | Lectura y escritura<br /> | Controla la presencia y la apariencia del cuadro de diálogo de redireccionamiento.<br /> | 
...
| <a href="imsrdpclientnonscriptable5-usemultimon.md"><strong>UseMultimon</strong></a><br /> | Lectura y escritura<br /> | Especifica si el control Escritorio remoto ActiveX debe usar varios monitores.<br /> | 
| <a href="imsrdppreferredredirectioninfo-useredirectionservername.md"><strong>UseRedirectionServerName</strong></a><br /> | Lectura y escritura<br /> | Si se va a usar el nombre del servidor de redirección.<br /> | 
...
| <a href="imsrdpclientnonscriptable5-warnaboutdirectxredirection.md"><strong>WarnAboutDirectXRedirection</strong></a><br /> | Lectura y escritura<br /> | No se usa esta propiedad.<br /> | 
...
| CLSID<br/>                    | CLSID MsRdpClient9 se define como \_ 301B94BA-5D25-4A12-BFFE-3B6E7A616585<br/>      |
