...
| <a href="imsrdppreferredredirectioninfo-useredirectionservername.md"><strong>Propiedad</strong></a><br /> | Lectura y escritura<br /> | Contiene una propiedad con nombre.<br /> | 
...
| <a href="imsrdpclientnonscriptable4-trustedzonesite.md"><strong>TrustedZoneSite</strong></a><br /> | Lectura y escritura<br /> | Especifica si el sitio web desde el que el usuario inició la conexión se encuentra en la lista de sitios de confianza del equipo cliente.<br /> | 
...
| <a href="imsrdppreferredredirectioninfo-useredirectionservername.md"><strong>UseRedirectionServerName</strong></a><br /> | Lectura y escritura<br /> | Si se va a usar el nombre del servidor de redireccionamiento.<br /> | 
