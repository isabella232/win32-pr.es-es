...
description: Representa la asociación entre un terminal y sus opciones de configuración.
ms.assetid: c92d79ec-eca5-4a73-a89a-dfc55474d88b
ms.tgt_platform: multiple
keywords:
- Win32_TerminalTerminalSetting clase Servicios de Escritorio remoto
- Win32_TerminalTerminalSetting clase Servicios de Escritorio remoto , descrita
topic_type:
- apiref
api_name:
...
ms.locfileid: "127270468"
---
# <a name="win32_terminalterminalsetting-class"></a>Clase \_ TerminalTerminalSetting de Win32

La clase WMI **\_ TerminalTerminalSetting de Win32** representa la asociación entre un terminal y sus opciones de configuración.
...
Tipo de datos: **\_ Terminal Win32**
</dt> <dt>
...
Representa el terminal que se puede configurar mediante la **propiedad Setting.**
...
Tipo de datos: **\_ TerminalSetting de Win32**
</dt> <dt>
