...
---
# <a name="imstscaxeventsonservicemessagereceived-method"></a>IMsTscAxEvents:: OnServiceMessageReceived (método)
...
Para obtener más información sobre los mensajes del sistema, consulte [configuración de la mensajería para un servidor de puerta de enlace de escritorio remoto](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/dd834700(v=ws.11)).
