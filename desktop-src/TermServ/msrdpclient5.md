...
keywords:
- Clase MsRdpClient5 Servicios de Escritorio remoto
- Clase MsRdpClient5 Servicios de Escritorio remoto , descrito
topic_type:
- apiref
api_name:
- MsRdpClient5
...
ms.locfileid: "118350237"
---
# <a name="msrdpclient5-class"></a>Clase MsRdpClient5

Control de cliente RDP de Microsoft (redistribuible): versión 6
...
**MsRdpClient5** tiene estos tipos de miembros:
...
La **clase MsRdpClient5** tiene estos métodos.
...
La **clase MsRdpClient5** tiene estas propiedades.
...
| CLSID<br/>                    | CLSID MsRdpClient5 se define como \_ 4EB89FF4-7F78-4A0F-8B8D-2BF02E94E4B2<br/>      |
