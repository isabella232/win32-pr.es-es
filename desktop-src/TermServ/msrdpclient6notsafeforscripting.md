...
description: 'Control de cliente RDP de Microsoft: versión 7.'
ms.assetid: D34BDA07-986C-4BA7-B454-3E9DC1A7BA1E
ms.tgt_platform: multiple
keywords:
- Clase MsRdpClient6NotSafeForScripting Servicios de Escritorio remoto
- Clase MsRdpClient6NotSafeForScripting Servicios de Escritorio remoto , descrito
topic_type:
- apiref
api_name:
...
ms.locfileid: "126968047"
---
# <a name="msrdpclient6notsafeforscripting-class"></a>Clase MsRdpClient6NotSafeForScripting

Control de cliente RDP de Microsoft: versión 7
...
**MsRdpClient6NotSafeForScripting** tiene estos tipos de miembros:
...
La **clase MsRdpClient6NotSafeForScripting** tiene estos métodos.
...
La **clase MsRdpClient6NotSafeForScripting** tiene estas propiedades.
...
| CLSID<br/>                    | CLSID \_ MsRdpClient6NotSafeForScripting se define como D2EA46A7-C2BF-426B-AF24-E19C44456399<br/> |
