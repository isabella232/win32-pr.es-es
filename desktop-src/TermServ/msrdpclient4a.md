...
keywords:
- Clase MsRdpClient4a Servicios de Escritorio remoto
- Clase MsRdpClient4a Servicios de Escritorio remoto , descrito
topic_type:
- apiref
api_name:
- MsRdpClient4a
...
ms.locfileid: "126968060"
---
# <a name="msrdpclient4a-class"></a>Clase MsRdpClient4a

Control de cliente RDP de Microsoft (redistribuible): versión 5a
...
**MsRdpClient4a** tiene estos tipos de miembros:
...
La **clase MsRdpClient4a** tiene estos métodos.
...
La **clase MsRdpClient4a** tiene estas propiedades.
...
| [**ExtendedDisconnectReason**](imsrdpclient-extendeddisconnectreason.md)<br/>       | Solo lectura<br/>  | Información extendida sobre el motivo de desconexión del control de cliente.<br/>                                                                                                                         |
...
| [**SecuredSettings2**](imsrdpclient-securedsettings2.md)<br/>                       | Solo lectura<br/>  | Puntero a la [**interfaz IMsRdpClientSecuredSettings,**](imsrdpclientsecuredsettings-interface.md) que se usa para establecer la configuración protegida para el control de cliente.<br/>                                       |
...
| [**UIParentWindowHandle**](imsrdpclientnonscriptable2-uiparentwindowhandle.md)<br/> | Lectura y escritura<br/> | Identificador de ventana que va a ser la ventana primaria del control. Esto permite que las ventanas mostradas por el control sean modales correctamente con respecto a las ventanas mostradas por la aplicación primaria.<br/> |
...
| CLSID<br/>                    | CLSID \_ MsRdpClient4a se define como 54CE37E0-9834-41AE-9896-4DAB69DC022B<br/>     |
