...
-   La configuración de directiva de grupo "grupo de seguridad del servidor de licencias" Escritorio remoto servidor de licencias.
...
Nombre del servidor de Escritorio remoto licencia.
...
Si el servidor host de sesión de Escritorio remoto puede solicitar cal de RDS al servidor de licencias.
