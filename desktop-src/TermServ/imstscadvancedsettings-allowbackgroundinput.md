...
Establezca este parámetro en 0 para deshabilitar el modo de entrada en segundo plano o un valor distinto de cero para habilitar el modo de entrada en segundo plano.
