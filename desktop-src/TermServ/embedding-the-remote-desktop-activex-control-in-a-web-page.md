...
---
# <a name="embedding-the-remote-desktop-activex-control-in-a-webpage"></a><span data-ttu-id="26b3d-103">Incrustar el control ActiveX Escritorio remoto en una página web</span><span class="sxs-lookup"><span data-stu-id="26b3d-103">Embedding the Remote Desktop ActiveX control in a webpage</span></span>

<span data-ttu-id="26b3d-104">Puede incrustar el Escritorio remoto control ActiveX en una página web mediante código similar al siguiente.</span><span class="sxs-lookup"><span data-stu-id="26b3d-104">You can embed the Remote Desktop ActiveX control in a web page by using code that is similar to the following.</span></span>
...
<span data-ttu-id="26b3d-105">El CLSID es para el control ActiveX que se hospeda en Conexión a Escritorio remoto (RDP) 6,0.</span><span class="sxs-lookup"><span data-stu-id="26b3d-105">The CLSID is for the ActiveX control that is hosted by Remote Desktop Connection (RDP) 6.0.</span></span> <span data-ttu-id="26b3d-106">Este control ActiveX implementa [**IMsRdpClient**](imsrdpclient-interface.md).</span><span class="sxs-lookup"><span data-stu-id="26b3d-106">This ActiveX control implements [**IMsRdpClient**](imsrdpclient-interface.md).</span></span>

## <a name="related-topics"></a><span data-ttu-id="26b3d-107">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="26b3d-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="26b3d-108">Usar el control ActiveX Escritorio remoto</span><span class="sxs-lookup"><span data-stu-id="26b3d-108">Using the Remote Desktop ActiveX control</span></span>](using-remote-desktop-web-connection.md)
</dt> </dl>
