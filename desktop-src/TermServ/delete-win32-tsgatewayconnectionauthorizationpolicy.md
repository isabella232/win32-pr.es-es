...
- Método Delete Servicios de Escritorio remoto , Win32_TSGatewayConnectionAuthorizationPolicy clase
...
Elimina la directiva de autorización de Escritorio remoto de conexión (CAP de Escritorio remoto) actual.
