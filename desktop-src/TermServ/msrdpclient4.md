---
title: Clase MsRdpClient4
description: 'Control de cliente RDP de Microsoft (redistribuible): versión 5.'
ms.assetid: 3F238C63-E860-4F27-B3D6-29F03B22E49E
ms.tgt_platform: multiple
keywords:
- Clase MsRdpClient4 Servicios de Escritorio remoto
- Clase MsRdpClient4 Servicios de Escritorio remoto , descrito
topic_type:
- apiref
api_name:
- MsRdpClient4
...
ms.locfileid: "118350247"
---
# <a name="msrdpclient4-class"></a>Clase MsRdpClient4

Control de cliente RDP de Microsoft (redistribuible): versión 5
...
**MsRdpClient4** tiene estos tipos de miembros:
...
La **clase MsRdpClient4** tiene estos métodos.
...
La **clase MsRdpClient4** tiene estas propiedades.
...
| CLSID<br/>                    | CLSID MsRdpClient4 se define como \_ 4EDCB26C-D24C-4E72-AF07-B576699AC0DE<br/>      |
