---
title: Clase MsRdpClient
description: Control de cliente RDP de Microsoft (redistribuible)-versión 2.
ms.assetid: 58A779AF-4946-4D3B-B640-5675092A641D
ms.tgt_platform: multiple
keywords:
- Servicios de Escritorio remoto de la clase MsRdpClient
- Servicios de Escritorio remoto de la clase MsRdpClient, descrito
topic_type:
- apiref
api_name:
- MsRdpClient
...
**MsRdpClient** tiene estos tipos de miembros:
...
La clase **MsRdpClient** tiene estos métodos.
...
La clase **MsRdpClient** tiene estas propiedades.
...
| CLSID<br/>                    | CLSID \_ MsRdpClient se define como 791fa017-2de3-492e-acc5-53c67a2b94d0<br/>       |
