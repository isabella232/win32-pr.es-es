...
---
# <a name="win32_tsdeploymentlicensing-class"></a>\_Clase Win32 TSDeploymentLicensing

Configuración de licencias para la implementación de Escritorio remoto Virtualization (RDV).
...
**Todavía no se ha configurado** (5)
...
Especifica si se va a usar la configuración de licencias en todo el nivel de implementación. **True** para usar esta configuración para todos los servidores de esta implementación. **false** para establecerlos por servidor. Si se establece en **false**, se omiten todas las demás opciones de configuración de licencias.
