...
Las interfaces siguientes han ampliado la interfaz **IMsRdpClient4,** donde cada nueva interfaz hereda todos los métodos y propiedades de las interfaces anteriores:
