...
description: 'Control de cliente RDP de Microsoft: versión 9.'
ms.assetid: BCC5872C-88AA-4BBB-A098-036B3E719F4F
ms.tgt_platform: multiple
keywords:
- Clase MsRdpClient8NotSafeForScripting Servicios de Escritorio remoto
- Clase MsRdpClient8NotSafeForScripting Servicios de Escritorio remoto , descrito
topic_type:
- apiref
api_name:
