...
---
# <a name="wsdl-interface-for-custom-vdi-solutions"></a><span data-ttu-id="29fde-104">Interfaz WSDL para soluciones VDI personalizadas</span><span class="sxs-lookup"><span data-stu-id="29fde-104">WSDL Interface for Custom VDI Solutions</span></span>

<span data-ttu-id="29fde-105">Los desarrolladores pueden crear servicios web personalizados que administren soluciones de infraestructura de escritorio virtual (VDI).</span><span class="sxs-lookup"><span data-stu-id="29fde-105">Developers can create custom web services that manage virtual desktop infrastructure (VDI) solutions.</span></span>

<span data-ttu-id="29fde-106">A partir de Windows Server 2008 R2, los equipos cliente pueden comunicarse con los servicios web que realizan la administración de máquinas virtuales mediante el complemento de filtro de VMMWebServerClient.dll.</span><span class="sxs-lookup"><span data-stu-id="29fde-106">Beginning with Windows Server 2008 R2, client computers can communicate with web services that perform virtual machine management by using the VMMWebServerClient.dll filter plug-in.</span></span> <span data-ttu-id="29fde-107">Puede implementar un servicio web personalizado que funcione con este complemento de filtro.</span><span class="sxs-lookup"><span data-stu-id="29fde-107">You can implement a custom web service that works with this filter plug-in.</span></span> <span data-ttu-id="29fde-108">Para comunicarse con el complemento de filtro, el servicio Web debe implementar los métodos definidos en el siguiente archivo WSDL (lenguaje de definición de servicios web).</span><span class="sxs-lookup"><span data-stu-id="29fde-108">To communicate with the filter plug-in, your web service must implement the methods defined in the following WSDL (Web Services Definition Language) file.</span></span>
...
<span data-ttu-id="29fde-109">Este archivo WSDL define los siguientes métodos:</span><span class="sxs-lookup"><span data-stu-id="29fde-109">This WSDL file defines the following methods:</span></span>

-   [<span data-ttu-id="29fde-110">GetVM</span><span class="sxs-lookup"><span data-stu-id="29fde-110">GetVM</span></span>](#getvm)
-   [<span data-ttu-id="29fde-111">JobUpdated</span><span class="sxs-lookup"><span data-stu-id="29fde-111">JobUpdated</span></span>](#jobupdated)
-   [<span data-ttu-id="29fde-112">PlaceVM</span><span class="sxs-lookup"><span data-stu-id="29fde-112">PlaceVM</span></span>](#placevm)
-   [<span data-ttu-id="29fde-113">SetLocale</span><span class="sxs-lookup"><span data-stu-id="29fde-113">SetLocale</span></span>](#setlocale)
-   [<span data-ttu-id="29fde-114">StartVM</span><span class="sxs-lookup"><span data-stu-id="29fde-114">StartVM</span></span>](#startvm)

## <a name="getvm"></a><span data-ttu-id="29fde-115">GetVM</span><span class="sxs-lookup"><span data-stu-id="29fde-115">GetVM</span></span>

<span data-ttu-id="29fde-116">El complemento de filtro llama a este método para obtener información sobre una máquina virtual especificada.</span><span class="sxs-lookup"><span data-stu-id="29fde-116">The filter plug-in calls this method to obtain information about a specified virtual machine.</span></span> <span data-ttu-id="29fde-117">Debe devolver el estado de la máquina virtual, el nombre de host, el tipo de host y el GUID.</span><span class="sxs-lookup"><span data-stu-id="29fde-117">It should return the virtual machine's state, host name, host type and GUID.</span></span>

<span data-ttu-id="29fde-118">El complemento de filtro pasa el siguiente elemento al método.</span><span class="sxs-lookup"><span data-stu-id="29fde-118">The filter plug-in passes the following element to the method.</span></span>
...
<span data-ttu-id="29fde-119">El servicio Web debe devolver el elemento siguiente al complemento de filtro.</span><span class="sxs-lookup"><span data-stu-id="29fde-119">The web service must return the following element to the filter plug-in.</span></span>
...
## <a name="jobupdated"></a><span data-ttu-id="29fde-120">JobUpdated</span><span class="sxs-lookup"><span data-stu-id="29fde-120">JobUpdated</span></span>

<span data-ttu-id="29fde-121">El servicio Web llama a este método para notificar al complemento de filtro que se realizaron cambios en un trabajo existente.</span><span class="sxs-lookup"><span data-stu-id="29fde-121">The web service calls this method to notify the filter plug-in that changes were made to an existing job.</span></span> <span data-ttu-id="29fde-122">Cuando implemente este método, devuelva el valor **\_ correcto** si la función se ejecuta correctamente.</span><span class="sxs-lookup"><span data-stu-id="29fde-122">When you are implementing this method, return **S\_OK** if the function succeeds.</span></span> <span data-ttu-id="29fde-123">Si se produce un error, devuelve un valor **HRESULT** que indica el error.</span><span class="sxs-lookup"><span data-stu-id="29fde-123">If it fails, return an **HRESULT** value that indicates the error.</span></span> <span data-ttu-id="29fde-124">Para obtener una lista de los códigos de error comunes, vea [Valores HRESULT comunes](/windows/desktop/SecCrypto/common-hresult-values) .</span><span class="sxs-lookup"><span data-stu-id="29fde-124">For a list of common error codes, see [Common HRESULT Values](/windows/desktop/SecCrypto/common-hresult-values)</span></span>

<span data-ttu-id="29fde-125">El servicio Web pasa el siguiente elemento al complemento de filtro.</span><span class="sxs-lookup"><span data-stu-id="29fde-125">The web service passes the following element to the filter plug-in.</span></span>
...
## <a name="placevm"></a><span data-ttu-id="29fde-126">PlaceVM</span><span class="sxs-lookup"><span data-stu-id="29fde-126">PlaceVM</span></span>

<span data-ttu-id="29fde-127">El complemento de filtro llama a este método para migrar una máquina virtual de una biblioteca a un equipo host.</span><span class="sxs-lookup"><span data-stu-id="29fde-127">The filter plug-in calls this method to migrate a virtual machine from a library to a host computer.</span></span> <span data-ttu-id="29fde-128">El método debe generar un trabajo y devolver un identificador de trabajo único al complemento de filtro con fines de seguimiento.</span><span class="sxs-lookup"><span data-stu-id="29fde-128">The method should spawn a job and return a unique job identifier to the filter plug-in for tracking purposes.</span></span> <span data-ttu-id="29fde-129">Una vez completado el procesamiento, el servicio Web debe llamar a JobUpdated.</span><span class="sxs-lookup"><span data-stu-id="29fde-129">When processing is complete, the web service should call JobUpdated.</span></span>

<span data-ttu-id="29fde-130">El complemento de filtro pasa el siguiente elemento al método.</span><span class="sxs-lookup"><span data-stu-id="29fde-130">The filter plug-in passes the following element to the method.</span></span>
...
<span data-ttu-id="29fde-131">El servicio Web debe devolver el elemento siguiente al complemento de filtro.</span><span class="sxs-lookup"><span data-stu-id="29fde-131">The web service must return the following element to the filter plug-in.</span></span>
...
## <a name="setlocale"></a><span data-ttu-id="29fde-132">SetLocale</span><span class="sxs-lookup"><span data-stu-id="29fde-132">SetLocale</span></span>

<span data-ttu-id="29fde-133">El complemento de filtro llama a este método para especificar la configuración regional que se va a usar para las cadenas de error.</span><span class="sxs-lookup"><span data-stu-id="29fde-133">The filter plug-in calls this method to specify the locale to be used for error strings.</span></span>

<span data-ttu-id="29fde-134">El complemento de filtro pasa el siguiente elemento al método.</span><span class="sxs-lookup"><span data-stu-id="29fde-134">The filter plug-in passes the following element to the method.</span></span>
...
<span data-ttu-id="29fde-135">El servicio Web debe devolver el elemento siguiente al complemento de filtro.</span><span class="sxs-lookup"><span data-stu-id="29fde-135">The web service must return the following element to the filter plug-in.</span></span>
...
## <a name="startvm"></a><span data-ttu-id="29fde-136">StartVM</span><span class="sxs-lookup"><span data-stu-id="29fde-136">StartVM</span></span>

<span data-ttu-id="29fde-137">El complemento de filtro llama a este método para iniciar la máquina virtual en el equipo host actual.</span><span class="sxs-lookup"><span data-stu-id="29fde-137">The filter plug-in calls this method to start the virtual machine on the current host computer.</span></span> <span data-ttu-id="29fde-138">Si no se puede iniciar la máquina virtual en el equipo host actual, este método debe migrar la máquina virtual al mejor host posible y, a continuación, iniciarla.</span><span class="sxs-lookup"><span data-stu-id="29fde-138">If the virtual machine cannot be started on the current host computer, this method should migrate the virtual machine to the best possible host and then start it.</span></span> <span data-ttu-id="29fde-139">El método debe generar un trabajo y devolver un identificador de trabajo único al complemento de filtro con fines de seguimiento.</span><span class="sxs-lookup"><span data-stu-id="29fde-139">The method should spawn a job and return a unique job identifier to the filter plug-in for tracking purposes.</span></span> <span data-ttu-id="29fde-140">Una vez completado el procesamiento, el servicio Web debe llamar a JobUpdated.</span><span class="sxs-lookup"><span data-stu-id="29fde-140">When processing is complete, the web service should call JobUpdated.</span></span>

<span data-ttu-id="29fde-141">El complemento de filtro pasa el siguiente elemento al método.</span><span class="sxs-lookup"><span data-stu-id="29fde-141">The filter plug-in passes the following element to the method.</span></span>
...
<span data-ttu-id="29fde-142">El servicio Web debe devolver el elemento siguiente al complemento de filtro.</span><span class="sxs-lookup"><span data-stu-id="29fde-142">The web service must return the following element to the filter plug-in.</span></span>
