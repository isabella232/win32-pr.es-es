---
title: Ejemplo de módulo de servidor DVC
description: Ejemplo de código de C++ que muestra cómo crear el módulo de canal virtual dinámico (DVC) del lado servidor.
...
ms.locfileid: "118609415"
---
# <a name="dvc-server-module-example"></a>Ejemplo de módulo de servidor DVC

El siguiente ejemplo de código de C++ proporciona un ejemplo de cómo crear el módulo de canal virtual dinámico (DVC) del lado servidor.
