---
title: Ejemplo del módulo de servidor DVC
description: Código de ejemplo de C++ que muestra cómo crear el módulo de canal virtual dinámico (DVC) del lado servidor.
...
ms.locfileid: "104268672"
---
# <a name="dvc-server-module-example"></a><span data-ttu-id="6177a-103">Ejemplo del módulo de servidor DVC</span><span class="sxs-lookup"><span data-stu-id="6177a-103">DVC Server Module Example</span></span>

<span data-ttu-id="6177a-104">El siguiente ejemplo de código C++ proporciona un ejemplo de cómo crear el módulo de canal virtual dinámico (DVC) del lado servidor.</span><span class="sxs-lookup"><span data-stu-id="6177a-104">The following C++ code sample provides an example of how to create the server-side dynamic virtual channel (DVC) module.</span></span>
