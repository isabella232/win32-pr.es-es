...
---
# <a name="dvc-server-module-example"></a>Ejemplo del módulo de servidor DVC

El siguiente ejemplo de código C++ proporciona un ejemplo de cómo crear el módulo de canal virtual dinámico (DVC) del lado servidor.
