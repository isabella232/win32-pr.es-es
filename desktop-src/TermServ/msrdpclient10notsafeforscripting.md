...
description: 'Control de cliente RDP de Microsoft: versión 11.'
ms.assetid: AAC3DA65-222D-498F-B9C3-A8CBCB722D9D
ms.tgt_platform: multiple
keywords:
- Clase MsRdpClient10NotSafeForScripting Servicios de Escritorio remoto
- Clase MsRdpClient10NotSafeForScripting Servicios de Escritorio remoto , descrito
topic_type:
- apiref
api_name:
...
ms.locfileid: "122475341"
---
# <a name="msrdpclient10notsafeforscripting-class"></a>Clase MsRdpClient10NotSafeForScripting

Control de cliente RDP de Microsoft: versión 11
...
**MsRdpClient10NotSafeForScripting** tiene estos tipos de miembros:
...
La **clase MsRdpClient10NotSafeForScripting** tiene estos métodos.
...
La **clase MsRdpClient10NotSafeForScripting** tiene estas propiedades.
...
| <a href="imsrdpclient10-remoteprogram3.md"><strong>RemoteProgram3</strong></a><br /> | Solo lectura<br /> | Objeto que admite la <a href="itsremoteprogram3.md"><strong>interfaz ITSRemoteProgram3.</strong></a><br /> | 
...
| CLSID<br/>                    | CLSID \_ MsRdpClient10NotSafeForScripting se define como A0C63C30-F08D-4AB4-907C-34905D770C7D<br/> |
