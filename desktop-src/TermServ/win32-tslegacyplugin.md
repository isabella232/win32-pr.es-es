...
- Win32_TSLegacyPlugin clase Servicios de Escritorio remoto , descrita
topic_type:
- apiref
api_name:
...
Esta clase está en desuso a partir de Windows Server 2012.
...
La **clase \_ TSLegacyPlugin de Win32** tiene estos tipos de miembros:

-   [Propiedades](#properties)

### <a name="properties"></a>Propiedades

La **clase \_ TSLegacyPlugin de Win32** tiene estas propiedades.
...
Tipo del servidor Servicios de Escritorio remoto servidor.
...
Servidor Escritorio remoto para una granja de máquinas virtuales.
