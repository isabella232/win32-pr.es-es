---
title: Clase MsTscAx
description: Microsoft Terminal Services Client control (Redistributable), versión 1.
ms.assetid: 8B8FEF40-89A5-47C0-94EE-4F4B2B5738AB
ms.tgt_platform: multiple
keywords:
- Servicios de Escritorio remoto de la clase MsTscAx
- Servicios de Escritorio remoto de la clase MsTscAx, descrito
topic_type:
- apiref
api_name:
- MsTscAx
