...
description: Define los valores de configuración de control remoto para la clase \_ Terminal Win32.
ms.assetid: 2e23915e-ee1c-4e53-8d0d-4d3fc2fefce6
ms.tgt_platform: multiple
keywords:
- Win32_TSRemoteControlSetting clase Servicios de Escritorio remoto
- Win32_TSRemoteControlSetting clase Servicios de Escritorio remoto , descrita
topic_type:
- apiref
api_name:
...
ms.locfileid: "127243423"
---
# <a name="win32_tsremotecontrolsetting-class"></a>Clase \_ TSRemoteControlSetting de Win32

La clase WMI **\_ TSRemoteControlSetting de Win32** define las opciones de configuración de control remoto para la [**clase \_ Terminal Win32.**](win32-terminal.md)
...
La **clase \_ TSRemoteControlSetting de Win32** tiene estos tipos de miembros:
...
La **clase \_ TSRemoteControlSetting de Win32** tiene estos métodos.



| Método                                                              | Descripción                                                    |
|:--------------------------------------------------------------------|:---------------------------------------------------------------|
| [**Remotecontrol**](win32-tsremotecontrolsetting-remotecontrol.md) | Establece la **propiedad LevelOfControl** de esta clase.<br/> |
...
La **clase \_ TSRemoteControlSetting de Win32** tiene estas propiedades.
...
Nivel de control para la sesión, que especifica si el usuario remoto solo verá la sesión, o si se verá y controlará mediante un teclado y un mouse. Para obtener más información, vea la sección Comentarios del [**método RemoteControl.**](win32-tsremotecontrolsetting-remotecontrol.md) Se admiten los valores siguientes.
...
Indica si la propiedad **LevelOfControl** está configurada por el servidor, la directiva de grupo o de forma predeterminada.
...
Directiva que usa el servidor para recuperar la configuración de control remoto.
...
La configuración de control remoto del usuario está en vigor.
...
El servidor reemplaza la configuración de control remoto del usuario.
