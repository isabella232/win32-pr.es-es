---
title: Ejemplo de complemento de cliente de DVC
description: Código de ejemplo de C++ que muestra cómo crear un complemento de canal virtual dinámico (DVC) del cliente Conexión a Escritorio remoto (RDC).
...
ms.locfileid: "103994093"
---
# <a name="dvc-client-plug-in-example"></a><span data-ttu-id="02bcc-103">Ejemplo de complemento de cliente de DVC</span><span class="sxs-lookup"><span data-stu-id="02bcc-103">DVC Client Plug-in Example</span></span>

<span data-ttu-id="02bcc-104">El siguiente ejemplo de código de C++ proporciona un ejemplo de cómo crear un complemento de canal virtual dinámico (DVC) del cliente Conexión a Escritorio remoto (RDC).</span><span class="sxs-lookup"><span data-stu-id="02bcc-104">The following C++ code sample provides an example of how to create a Remote Desktop Connection (RDC) client dynamic virtual channel (DVC) plug-in.</span></span>
