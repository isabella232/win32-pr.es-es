...
) Puede usar el [**Windows. Clase UI::Xaml::Controls::SwapChainPanel**](/uwp/api/Windows.UI.Xaml.Controls.SwapChainPanel?view=winrt-19041) para crear aplicaciones DirectX de alto rendimiento con una superposición de interfaz de usuario XAML. Para obtener más información sobre cómo combinar XAML y DirectX en una Windows, consulta [Interoperabilidad de DirectX y XAML.](/previous-versions/windows/apps/hh825871(v=win.10))

Para obtener información sobre cómo crear un controlador de visualización para Windows 8, consulte Mapa de ruta para Windows modelo de controlador de [pantalla (WDDM).](/windows-hardware/drivers/display/roadmap-for-developing-drivers-for-the-windows-vista-display-driver-mo)
