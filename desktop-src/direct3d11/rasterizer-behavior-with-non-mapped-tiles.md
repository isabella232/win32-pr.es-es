...
El comportamiento de las lecturas y escrituras de la vista de destino de representación (RTV) depende del nivel de compatibilidad con hardware. Para ver un desglose de los requisitos, consulte el comportamiento general de lectura y escritura de los niveles [de características de recursos en mosaico.](tiled-resources-features-tiers.md)
