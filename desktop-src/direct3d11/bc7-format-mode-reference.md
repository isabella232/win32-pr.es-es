...
description: Esta documentación contiene una lista de los ocho modos de bloque y asignaciones de bits para los bloques de formato de compresión de textura BC7.
...
ms.locfileid: "119126170"
---
# <a name="bc7-format-mode-reference"></a>Referencia del modo de formato BC7

Esta documentación contiene una lista de los ocho modos de bloque y asignaciones de bits para los bloques de formato de compresión de textura BC7.
...
-   Selector de índice de 1 bit (independientemente de si se usan los índices de 2 o 3 bits)
