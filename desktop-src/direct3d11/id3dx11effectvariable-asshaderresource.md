...
AsShaderResource devuelve una versión de la variable de efecto especializada en una variable de recurso de sombreador. De forma similar a una conversión, esta especialización devolverá un objeto no válido si la variable de efecto no contiene datos de recursos de sombreador.
