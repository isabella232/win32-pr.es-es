...
<td>Cómo interpreta la canalización los datos de vértice enlazados a la fase del ensamblador de entrada. Estos valores de topología primitivos determinan cómo se representan los datos del vértice en la pantalla.<br/></td>
</tr>
<tr>
