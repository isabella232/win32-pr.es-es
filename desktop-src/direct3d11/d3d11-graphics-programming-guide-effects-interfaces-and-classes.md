...
## <a name="uniform-interface-parameters"></a>Parámetros de interfaz uniforme
...
1.  Los sombreadores con un destino de 4 x pueden usar parámetros de interfaz si estos parámetros son uniformes y se asignan a instancias de clase global (por lo que no se usa \_ ninguna vinculación dinámica).
...
Los parámetros de interfaz no uniformes crean dependencias de interfaz para los sombreadores. Al aplicar un sombreador con parámetros de interfaz, estos parámetros se deben asignar en con la llamada a BindInterfaces. Las instancias de interfaz global y las instancias de clase global se pueden especificar en la llamada a BindInterfaces.
