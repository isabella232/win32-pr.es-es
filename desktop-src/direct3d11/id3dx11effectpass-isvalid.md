---
title: Método ID3DX11EffectPass IsValid (D3dx11effect.h)
...
- Método IsValid Direct3D 11, interfaz ID3DX11EffectPass
- Interfaz ID3DX11EffectPass Direct3D 11 , método IsValid
topic_type:
- apiref
api_name:
...
ms.locfileid: "118534951"
---
# <a name="id3dx11effectpassisvalid-method"></a>Método ID3DX11EffectPass::IsValid

Pruebe un paso para ver si contiene una sintaxis válida.
