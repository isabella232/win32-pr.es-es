...
---
# <a name="id3dx11effectvariableasrasterizer-method"></a>ID3DX11EffectVariable:: asrasterizador (método)
...
Puntero a una variable de rasterizador. Vea [**ID3DX11EffectRasterizerVariable**](id3dx11effectrasterizervariable.md).

## <a name="remarks"></a>Observaciones

Asrasterizador devuelve una versión de la variable de efecto que se ha especializado en una variable de rasterizador. De forma similar a una conversión, esta especialización devolverá un objeto no válido si la variable de efecto no contiene datos de rasterizador.
