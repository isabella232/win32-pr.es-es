...
---
# <a name="id3dx11effectrendertargetviewvariablesetrendertargetarray-method"></a>ID3DX11EffectRenderTargetViewVariable:: SetRenderTargetArray (método)
...
Establezca una matriz de interfaces de representación-destino-vista. Vea [**ID3D11RenderTargetView**](/windows/desktop/api/D3D11/nn-d3d11-id3d11rendertargetview).
...
Índice de base cero de la matriz que se va a almacenar en la primera interfaz.
