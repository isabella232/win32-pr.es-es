...
---
# <a name="d3dx11createtexturefrommemory-function"></a>D3DX11CreateTextureFromMemory función)
...
Cree un recurso de textura a partir de un archivo que reside en la memoria del sistema.
...
Dirección de un puntero al recurso creado. Vea [**ID3D11Resource**](/windows/desktop/api/D3D11/nn-d3d11-id3d11resource).
