...
description: Nota La biblioteca de utilidades D3DX (D3DX 9, D3DX 10 y D3DX 11) está en desuso para Windows 8 y no es compatible con las aplicaciones de Windows Store. Vea la sección Comentarios. Cree un procesador de datos que se usará con una bomba de subprocesos. | Función D3DX11CreateAsyncTextureProcessor (D3DX11tex.h)
