...
---
# <a name="id3dx11effectsamplervariablegetbackingstore-method"></a>ID3DX11EffectSamplerVariable:: GetBackingStore (método)

Obtiene un puntero a una variable que contiene el estado de muestra.
...
Índice en una matriz de descripciones de muestra. Si solo hay una variable de muestrario en el efecto, use 0.
...
Tipo: **[ **D3D11 \_ muestra \_ DESC**](/windows/desktop/api/D3D11/ns-d3d11-d3d11_sampler_desc)\***

Un puntero a una descripción de muestra (vea [**D3D11 \_ muestra \_ DESC**](/windows/desktop/api/D3D11/ns-d3d11-d3d11_sampler_desc)).
