...
---
# <a name="id3dx11effectconstantbufferundosetconstantbuffer-method"></a>ID3DX11EffectConstantBuffer:: UndoSetConstantBuffer (método)

Revierte un búfer de constantes previamente establecido.
