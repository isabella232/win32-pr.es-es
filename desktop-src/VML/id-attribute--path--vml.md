...
---
# <a name="id-attribute-pathvml"></a>ID (atributo, Path) (VML)
...
Use el **identificador** para hacer referencia a una ruta de acceso específica. Una vez que haya creado una ruta de acceso y dado un identificador, puede utilizar el nombre de identificador cuando desee manipular la ruta de acceso.
