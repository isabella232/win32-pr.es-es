...
| [Ángulo](angle-attribute--fill--vml.md)                            | Define el ángulo de un relleno de degradado.                  |
| [Aspecto](msdn-online-vml-aspect-attribute.md)                     | Especifica cómo se conservará el aspecto de la imagen de relleno. |
| [Color](color-attribute--fill--vml.md)                            | Define el color de un relleno.                           |
| [Color2](color2-attribute--fill--vml.md)                          | Define el segundo color para un relleno.                   |
...
| [Opacidad2](msdn-online-vml-opacity2-attribute.md)                 | Define la transparencia del segundo color de relleno.     |
...
| [Fuente](src-attribute--fill--vml.md)                                | Define la imagen que se cargará para un relleno.                  |
