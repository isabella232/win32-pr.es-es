...
ms.locfileid: "119802375"
---
# <a name="ndf-diagnostics-example"></a>Ejemplo de diagnóstico de NDF

En el ejemplo siguiente se muestra cómo iniciar la interfaz de usuario de NDF y diagnosticar la conectividad al sitio web https://www.microsoft.com .
...
La interfaz de usuario de NDF se puede iniciar como una ventana modal. Para ello, cambie el segundo parámetro de [**NdfExecuteDiagdiagdiag de**](/windows/desktop/api/Ndfapi/nf-ndfapi-ndfexecutediagnosis) **NULL** al identificador (HWND) de la ventana primaria.

Este ejemplo se puede modificar para diagnosticar otras áreas de redes. Para ello, reemplace la llamada [**a NdfCreateWebIncident**](/windows/desktop/api/Ndfapi/nf-ndfapi-ndfcreatewebincident) por una de las otras funciones de creación de incidentes, como [**NdfCreateDNSIncident**](/windows/desktop/api/Ndfapi/nf-ndfapi-ndfcreatednsincident) o [**NdfCreateWinSockIncident.**](/windows/desktop/api/Ndfapi/nf-ndfapi-ndfcreatewinsockincident)
