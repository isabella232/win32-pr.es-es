---
description: Representa las funcionalidades y la administración del controlador serie.
...
Representa las funcionalidades y la administración del controlador serie. Los controladores serie son dispositivos lógicos que siempre están presentes en una máquina virtual y, por tanto, no se asignan a través de un grupo de recursos. Una instancia de controlador serie siempre está presente en una máquina virtual. Los controladores serie tienen un número fijo de instancias de puerto. Esta implementación admite dos puertos por controlador.

> [!Note]  
> Los controladores serie son opcionales en [máquinas virtuales de generación 2.](virtualization-glossary.md)
...
La **clase \_ SerialController de Msvm** tiene estos tipos de miembros:
...
La **clase \_ SerialController de Msvm** tiene estos métodos.
...
La **clase \_ SerialController de Msvm** tiene estas propiedades.
...
El almacenamiento en búfer y otras funcionalidades del controlador serie que podrían ser inherentes al hardware del chip. Esta propiedad se hereda de [**CIM \_ SerialController.**](/windows/desktop/CIMWin32Prov/cim-serialcontroller)
...
Matriz de cadenas de forma libre que proporciona explicaciones más detalladas de cualquiera de las características del controlador serie que se indican en la matriz **Capabilities.** Esta propiedad se hereda de [**CIM \_ SerialController.**](/windows/desktop/CIMWin32Prov/cim-serialcontroller)
...
Seguridad operativa del controlador. Esta propiedad se hereda de [**CIM \_ SerialController.**](/windows/desktop/CIMWin32Prov/cim-serialcontroller)
...
La última vez que se encendera el controlador. Esta propiedad se hereda del [**controlador CIM. \_**](/windows/desktop/CIMWin32Prov/cim-controller)
...
El acceso a **la clase \_ SerialController de Msvm** podría estar restringido por el filtrado de UAC. Para obtener más información, vea [Control de cuentas de usuario y WMI.](/windows/desktop/WmiSdk/user-account-control-and-wmi)
