...
---
# <a name="renamecollection-method-of-the-msvm_collectionmanagementservice-class"></a>Método RenameCollection de la \_ clase CollectionManagementService de MSVM

Actualiza el nombre de elemento para el objeto [**CIM \_ CollectionOfMSEs**](cim-collectionofmses.md) especificado.
...
Colección a la que se va a cambiar el nombre.
