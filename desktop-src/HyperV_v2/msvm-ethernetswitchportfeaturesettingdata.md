...
---
# <a name="msvm_ethernetswitchportfeaturesettingdata-class"></a>MSVM \_ EthernetSwitchPortFeatureSettingData (clase)

Clase base abstracta para las clases que representan la configuración de una característica de puerto de conmutador Ethernet.
...
La clase **MSVM \_ EthernetSwitchPortFeatureSettingData** tiene estos tipos de miembros:

-   [Propiedades](#properties)

### <a name="properties"></a>Propiedades

La clase **MSVM \_ EthernetSwitchPortFeatureSettingData** tiene estas propiedades.
