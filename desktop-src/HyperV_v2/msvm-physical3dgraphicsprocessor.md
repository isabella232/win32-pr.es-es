---
description: Describe la unidad física de procesamiento de gráficos 3D (GPU).
...
ms.locfileid: "119520884"
---
# <a name="msvm_physical3dgraphicsprocessor-class"></a>Clase Msvm \_ Physical3dGraphicsProcessor

Describe la unidad física de procesamiento de gráficos 3D (GPU).
...
La **clase Msvm \_ Physical3dGraphicsProcessor** tiene estos tipos de miembros:
...
La **clase Msvm \_ Physical3dGraphicsProcessor** tiene estos métodos.
...
La **clase Msvm \_ Physical3dGraphicsProcessor** tiene estas propiedades.
...
Especifica el identificador de índice del adaptador asignado a este dispositivo.
...
Especifica la cantidad de memoria de vídeo, en bytes, que está disponible para la GPU.
...
**true** si es compatible con la virtualización; de lo contrario, **false**.
...
Especifica la cantidad de memoria del sistema, en bytes, dedicada a la GPU.
...
Especifica la cantidad de memoria de vídeo, en bytes, dedicada a la GPU.
...
Especifica el verison de DirectX que es compatible con la GPU.
...
Especifica la fecha de compilación del controlador.
...
Especifica la fecha y hora en que se instaló el controlador.
...
Especifica la versión del modelo de controlador.
...
Especifica el nombre del proveedor de controladores.
...
Especifica la versión del controlador.
...
Especifica si el adaptador se ha habilitado para su uso con RemoteFX.
...
Contiene el identificador de GPU para el adaptador.
...
Especifica la verison del sombreador de píxeles que admite la GPU.
...
Especifica la clasificación de RemoteFX GPU para este dispositivo. Esta propiedad no se usa actualmente.
...
Especifica la cantidad de memoria compartida del sistema, en bytes, que está disponible para la GPU.
...
Especifica la cantidad total de memoria de vídeo, en bytes, presente en la GPU.
