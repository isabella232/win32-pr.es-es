...
---
# <a name="msvm_physical3dgraphicsprocessor-class"></a>MSVM \_ Physical3dGraphicsProcessor (clase)

Describe la unidad de procesamiento de gráficos (GPU) física 3D.
...
Especifica el identificador del índice de adaptador asignado a este dispositivo.
...
**true si es** compatible con la virtualización; en caso contrario, **false**.
...
Especifica el versión de DirectX compatible con la GPU.
...
Especifica la fecha y la hora en que se instaló el controlador.
...
Especifica el nombre del proveedor del controlador.
...
Contiene el identificador de la GPU para el adaptador.
...
Especifica el versión del sombreador de píxeles Compatible con la GPU.
...
Especifica la clasificación de la GPU RemoteFX para este dispositivo. Esta propiedad no se usa actualmente.
...
Especifica la cantidad de memoria del sistema compartida, en bytes, que está disponible para la GPU.
...
Especifica la cantidad total de memoria de vídeo, en bytes, que se encuentra en la GPU.
