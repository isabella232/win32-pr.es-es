...
---
# <a name="msvm_syntheticfcport-class"></a>MSVM \_ SyntheticFcPort (clase)
...
Representa un puerto de Canal de fibra sintético.
...
| [**Reset**](msvm-syntheticfcport-reset.md)                           | Restablece el dispositivo virtual.<br/>    |
