---
description: Algunos ejemplos de virtualización de C# usan las siguientes utilidades.
ms.assetid: EB0F305D-806D-4ACB-8024-3A6FB125629D
title: Utilidades comunes para los ejemplos de virtualización (V2)
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103911034"
---
# <a name="common-utilities-for-the-virtualization-samples-v2"></a><span data-ttu-id="2adfa-103">Utilidades comunes para los ejemplos de virtualización (V2)</span><span class="sxs-lookup"><span data-stu-id="2adfa-103">Common utilities for the virtualization samples (V2)</span></span>

<span data-ttu-id="2adfa-104">Algunos ejemplos de virtualización de C# usan las siguientes utilidades.</span><span class="sxs-lookup"><span data-stu-id="2adfa-104">The following utilities are used by some of the C# virtualization samples.</span></span>
