---
description: Representa un controlador SCSI sintético.
...
ms.locfileid: "118147264"
---
# <a name="msvm_scsiprotocolcontroller-class"></a>Clase Msvm \_ SCSIProtocolController

Representa un controlador SCSI sintético. Un controlador SCSI sintético puede admitir hasta 256 unidades.
...
| [**Restablecer**](msvm-scsiprotocolcontroller-reset.md)                           | Restablece el dispositivo virtual.<br/>    |
...
Número máximo de unidades a las que se puede controlar o acceder a través de este controlador de protocolo. Esta propiedad se hereda de [**CIM \_ ProtocolController.**](/previous-versions/windows/desktop/iscsitarg/cim-protocolcontroller)
...
Identifica cómo se selecciona el nombre del controlador de protocolo SCSI. Esta propiedad se hereda de [**CIM \_ SCSIProtocolController.**](/previous-versions/windows/desktop/iscsitarg/cim-protocolcontroller)
...
Cadena que describe cómo se identifica el controlador de protocolo cuando **NameFormat** es 1 (Otro). Esta propiedad se hereda de [**CIM \_ SCSIProtocolController.**](/previous-versions/windows/desktop/iscsitarg/cim-protocolcontroller)
...
El acceso a **la clase \_ SCSIProtocolController de Msvm** puede estar restringido por el filtrado de UAC. Para obtener más información, vea [Control de cuentas de usuario y WMI.](/windows/desktop/WmiSdk/user-account-control-and-wmi)
