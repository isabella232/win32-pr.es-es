...
---
# <a name="getting-the-virtual-machine-dns-name"></a><span data-ttu-id="36cfa-103">Obtención del nombre DNS de una máquina virtual</span><span class="sxs-lookup"><span data-stu-id="36cfa-103">Getting the virtual machine DNS name</span></span>

<span data-ttu-id="36cfa-104">Los siguientes ejemplos de C# y Visual Basic Scripting Edition (VBScript) recuperan el nombre DNS de la máquina virtual.</span><span class="sxs-lookup"><span data-stu-id="36cfa-104">The following C# and Visual Basic Scripting Edition (VBScript) samples retrieve the DNS name of the virtual machine.</span></span>

<span data-ttu-id="36cfa-105">Para ejecutar este código de ejemplo, debe instalar los servicios de integración de cliente y el sistema operativo cliente debe estar en ejecución.</span><span class="sxs-lookup"><span data-stu-id="36cfa-105">To run this sample code, you must install the client integration services and the client operating system must be running.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="36cfa-106">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="36cfa-106">Related topics</span></span>

[<span data-ttu-id="36cfa-107">Utilidades comunes para los ejemplos de virtualización (V2)</span><span class="sxs-lookup"><span data-stu-id="36cfa-107">Common utilities for the virtualization samples (V2)</span></span>](common-utilities-for-the-virtualization-samples-v2.md)

[<span data-ttu-id="36cfa-108">**MSVM \_ ComputerSystem**</span><span class="sxs-lookup"><span data-stu-id="36cfa-108">**Msvm\_ComputerSystem**</span></span>](msvm-computersystem.md)

[<span data-ttu-id="36cfa-109">**MSVM \_ KvpExchangeComponent**</span><span class="sxs-lookup"><span data-stu-id="36cfa-109">**Msvm\_KvpExchangeComponent**</span></span>](msvm-kvpexchangecomponent.md)
