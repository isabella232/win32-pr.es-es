...
---
# <a name="exporting-the-configuration-of-a-virtual-machine"></a><span data-ttu-id="2817b-103">Exportación de la configuración de una máquina virtual</span><span class="sxs-lookup"><span data-stu-id="2817b-103">Exporting the configuration of a virtual machine</span></span>

<span data-ttu-id="2817b-104">En los siguientes ejemplos de C# y Visual Basic Scripting Edition (VBScript) se muestra la exportación de la configuración de una máquina virtual.</span><span class="sxs-lookup"><span data-stu-id="2817b-104">The following C# and Visual Basic Scripting Edition (VBScript) samples demonstrate exporting the configuration of a virtual machine.</span></span> <span data-ttu-id="2817b-105">Los ejemplos que muestran la exportación de una máquina virtual se encuentran en los temas [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) y [exportación de una instantánea de una máquina virtual](exporting-virtual-machines.md) .</span><span class="sxs-lookup"><span data-stu-id="2817b-105">Samples that show exporting a virtual machine can be found on the [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) and [Exporting a snapshot of a virtual machine](exporting-virtual-machines.md) topics.</span></span>

<span data-ttu-id="2817b-106">Las utilidades de C# a las que se hace referencia se pueden encontrar en [utilidades comunes para los ejemplos de virtualización (V2)](common-utilities-for-the-virtualization-samples-v2.md).</span><span class="sxs-lookup"><span data-stu-id="2817b-106">The referenced C# utilities can be found in [Common utilities for the virtualization samples (V2)](common-utilities-for-the-virtualization-samples-v2.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="2817b-107">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="2817b-107">Related topics</span></span>

[<span data-ttu-id="2817b-108">Exportación de una instantánea de una máquina virtual</span><span class="sxs-lookup"><span data-stu-id="2817b-108">Exporting a snapshot of a virtual machine</span></span>](exporting-virtual-machines.md)

[<span data-ttu-id="2817b-109">**ExportSystemDefinition**</span><span class="sxs-lookup"><span data-stu-id="2817b-109">**ExportSystemDefinition**</span></span>](exportsystemdefinition-msvm-virtualsystemmanagementservice.md)
