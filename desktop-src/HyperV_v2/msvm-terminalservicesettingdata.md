---
description: Representa la configuración de los servicios de terminal del equipo virtual en un host.
...
ms.locfileid: "118146704"
---
# <a name="msvm_terminalservicesettingdata-class"></a>Clase \_ TerminalServiceSettingData de Msvm

Representa la configuración de los servicios de terminal del equipo virtual en un host. Las propiedades de esta clase no se pueden modificar directamente. El cliente debe llamar al [**método \_ TerminalService.ModifyServiceSettings de Msvm**](modifyservicesettings-msvm-terminalservice.md) para modificar cualquiera de estas propiedades.
...
La **clase \_ TerminalServiceSettingData de Msvm** tiene estos tipos de miembros:

-   [Propiedades](#properties)

### <a name="properties"></a>Propiedades

La **clase \_ TerminalServiceSettingData de Msvm** tiene estas propiedades.
...
Lista de algoritmos hash aceptados para comprobar la firma de tokens de autenticación federados.
...
Hash del certificado que se usará para la autenticación remota.
...
Puerto de red en el que se realizará la conexión de sesión remota inicial.
...
Lista de hashes de certificado de emisor de confianza para comprobar la firma de tokens de autenticación federados.
