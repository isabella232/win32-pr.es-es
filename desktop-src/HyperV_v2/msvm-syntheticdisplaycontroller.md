---
description: Representa el estado del controlador de pantalla sintética que está presente en cada configuración de máquina virtual.
...
ms.locfileid: "118949894"
---
# <a name="msvm_syntheticdisplaycontroller-class"></a>Clase Msvm \_ SyntheticDisplayController

Representa el estado del controlador de pantalla sintética que está presente en cada configuración de máquina virtual. Solo un controlador de pantalla puede estar activo en una máquina virtual en cualquier momento y el controlador sintético solo se puede activar cuando el sistema operativo invitado ha cargado los servicios de aceleración de vídeo necesarios.
...
| [**Restablecer**](msvm-syntheticdisplaycontroller-reset.md)                           | Restablece el dispositivo virtual.<br/>    |
...
Los gráficos y las funcionalidades 3D del controlador de pantalla. Esta propiedad se hereda de [**CIM \_ DisplayController**](/previous-versions//cc136810(v=vs.85))y siempre se establece en 2 (Acelerador de gráficos).
...
Matriz de cadenas de forma libre que proporcionan explicaciones más detalladas de cualquiera de las características del acelerador de vídeo indicadas en la matriz de propiedades **AcceleratorCapabilities.** Cada entrada de esta matriz está relacionada con la entrada de la matriz de propiedades **AcceleratorCapabilities** que se encuentra en el mismo índice. Esta propiedad se hereda de [**CIM \_ DisplayController**](/previous-versions//cc136810(v=vs.85))y siempre se establece en "Acelerador de gráficos".
...
Breve descripción del objeto. Esta propiedad se hereda de [**\_ ManagedElement de CIM**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)y siempre se establece en "Controlador de visualización".
...
Nombre de la clase o subclase utilizada en la creación de una instancia de . Esta propiedad se hereda de [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)y siempre se establece en "Msvm \_ SyntheticDisplayController".
...
Descripción del objeto. Esta propiedad se hereda de [**\_ ManagedElement de CIM**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)y siempre se establece en "Microsoft Synthetic Display Controller".
...
Nombre para mostrar del objeto. Esta propiedad se hereda de [**\_ MANAGEDElement de CIM**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)y siempre se establece en "Controlador de visualización" de forma predeterminada.
...
Cantidad máxima de memoria admitida, en bytes. Esta propiedad se hereda de [**CIM \_ DisplayController**](/previous-versions//cc136810(v=vs.85))y siempre se establece en 4 194 304 (0x400000).
...
Número de páginas de vídeo admitidas dadas las resoluciones actuales y la memoria disponible. Esta propiedad se hereda de [**CIM \_ DisplayController**](/previous-versions//cc136810(v=vs.85))y siempre se establece en 1024.
...
Tipo de memoria de vídeo cuando la propiedad **VideoMemoryType** de la instancia es 1 (Otros). Esta propiedad se hereda de [**CIM \_ DisplayController**](/previous-versions//cc136810(v=vs.85))y siempre se establece en **Null.**
...
Cadena que proporciona más información relacionada con el protocolo admitido por el controlador. Esta propiedad se hereda del [**controlador CIM \_**](/windows/desktop/CIMWin32Prov/cim-controller)y siempre se establece en "Vídeo".
...
Protocolo utilizado por el controlador para acceder a dispositivos controlados. Esta propiedad se hereda del [**controlador CIM \_**](/windows/desktop/CIMWin32Prov/cim-controller)y siempre se establece en 1 (Otros).
...
Tipo de memoria de vídeo. Esta propiedad se hereda de [**CIM \_ DisplayController**](/previous-versions//cc136810(v=vs.85))y siempre se establece en 2 (VRAM).
...
Cadena que describe el procesador o controlador de vídeo. Esta propiedad se hereda de [**CIM \_ DisplayController**](/previous-versions//cc136810(v=vs.85))y siempre se establece en "Synthetic Video Processor".

</dd> </dl>

## <a name="remarks"></a>Comentarios

El acceso a **la clase \_ Msvm SyntheticDisplayController** podría estar restringido por el filtrado de UAC. Para obtener más información, vea [Control de cuentas de usuario y WMI.](/windows/desktop/WmiSdk/user-account-control-and-wmi)
