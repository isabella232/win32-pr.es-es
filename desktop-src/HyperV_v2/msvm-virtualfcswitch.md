...
---
# <a name="msvm_virtualfcswitch-class"></a>MSVM \_ VirtualFcSwitch (clase)

Representa un modificador de Canal de fibra virtual. Cada modificador está asociado a un puerto físico Canal de fibra al que se pueden conectar muchos puertos de Canal de fibra sintéticos. El propio conmutador no es muy configurable y actúa principalmente como un marcador de posición.
...
La clase **MSVM \_ VirtualFcSwitch** tiene estos tipos de miembros:
...
La clase **MSVM \_ VirtualFcSwitch** tiene estos métodos.



| Método                                                                | Descripción                              |
|:----------------------------------------------------------------------|:-----------------------------------------|
| [**RequestStateChange**](msvm-virtualfcswitch-requeststatechange.md) | Solicita un cambio de estado.<br/>      |
...
La clase **MSVM \_ VirtualFcSwitch** tiene estas propiedades.
...
Nombre de la clase o subclase que se usa en la creación de una instancia de. Esta propiedad se hereda del [**\_ Sistema CIM**](/windows/desktop/CIMWin32Prov/cim-system).
...
Etiqueta por la que se conoce el objeto. Esta propiedad se hereda del [**\_ Sistema CIM**](/windows/desktop/CIMWin32Prov/cim-system).
...
Esta propiedad se hereda de [**un \_ ComputerSystem de CIM**](/windows/desktop/CIMWin32Prov/cim-computersystem).
