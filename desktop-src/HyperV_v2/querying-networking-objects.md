...
---
# <a name="querying-networking-objects"></a><span data-ttu-id="89fa1-103">Consultar objetos de red</span><span class="sxs-lookup"><span data-stu-id="89fa1-103">Querying networking objects</span></span>

<span data-ttu-id="89fa1-104">En el siguiente ejemplo de C# se recupera y se muestra información de red física y virtual para el conmutador especificado.</span><span class="sxs-lookup"><span data-stu-id="89fa1-104">The following C# sample retrieves and displays physical and virtual network information for the specified switch.</span></span> <span data-ttu-id="89fa1-105">Este código se toma del [ejemplo de red de Hyper-V](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Hyper-V/Networking).</span><span class="sxs-lookup"><span data-stu-id="89fa1-105">This code is taken from the [Hyper-V networking sample](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Hyper-V/Networking).</span></span>

<span data-ttu-id="89fa1-106">La sintaxis de línea de comandos para ejecutar este ejemplo es la siguiente:</span><span class="sxs-lookup"><span data-stu-id="89fa1-106">The command-line syntax to run this sample is:</span></span>

<span data-ttu-id="89fa1-107">**NetworkingSamples.exe EnumerateSwitch** *SwitchName*</span><span class="sxs-lookup"><span data-stu-id="89fa1-107">**NetworkingSamples.exe EnumerateSwitch** *SwitchName*</span></span>

<span data-ttu-id="89fa1-108">donde *SwitchName* es el nombre del modificador para el que se va a mostrar información.</span><span class="sxs-lookup"><span data-stu-id="89fa1-108">where *SwitchName* is the name of the switch to display the information for.</span></span> <span data-ttu-id="89fa1-109">El nombre del modificador está contenido en la propiedad [**MSVM \_ VirtualEthernetSwitch. ElementName**](msvm-virtualethernetswitch.md) .</span><span class="sxs-lookup"><span data-stu-id="89fa1-109">The switch name is contained in the [**Msvm\_VirtualEthernetSwitch.ElementName**](msvm-virtualethernetswitch.md) property.</span></span>
