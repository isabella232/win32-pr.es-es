...
ms.locfileid: "118950614"
---
# <a name="msvm_serialport-class"></a>Clase SerialPort de Msvm \_
...
La **clase \_ SerialPort de Msvm** tiene estos tipos de miembros:
...
La **clase \_ SerialPort de Msvm** tiene estos métodos.
...
| [**Restablecer**](msvm-serialport-reset.md)                           | Restablece el dispositivo virtual.<br/>    |
...
La **clase \_ SerialPort de Msvm** tiene estas propiedades.
...
Esta propiedad se hereda de [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)y se establece en "Microsoft:*GUID* \\ *device-specific-data",* donde *device-specific-data* es opcional.
...
Estado habilitado del elemento. También puede indicar las transiciones entre estos estados solicitados. Esta propiedad se hereda de [**CIM \_ EnabledLogicalElement.**](/previous-versions//cc136818(v=vs.85))
...
Tipo de módulo, cuando **PortType** se establece en 1 (Otros). Esta propiedad se hereda de [**CIM \_ LogicalPort**](/previous-versions//cc136869(v=vs.85)).
...
Ancho de banda solicitado del puerto, en bits por segundo. Esta propiedad se hereda de [**CIM \_ LogicalPort**](/previous-versions//cc136869(v=vs.85)).
...
El acceso a **la clase \_ SerialPort de Msvm** puede estar restringido por el filtrado de UAC. Para obtener más información, vea [Control de cuentas de usuario y WMI.](/windows/desktop/WmiSdk/user-account-control-and-wmi)
