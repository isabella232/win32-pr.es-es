...
---
# <a name="msvm_diskmergesettingdata-class"></a>MSVM \_ DiskMergeSettingData (clase)

Representa el estado de configuración de la combinación de discos para una máquina virtual.
...
Breve descripción del objeto. Esta propiedad se hereda de la clase de [**\_ ManagedElement de CIM**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement) y siempre se establece en "datos de configuración de combinación de discos".
...
Descripción del objeto. Esta propiedad se hereda de [**la \_ ManagedElement de CIM**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)y siempre se establece en "datos de configuración de combinación de discos de Microsoft".
...
Especifica el estado habilitado de la funcionalidad de combinación de discos.
