...
---
# <a name="msvm_terminalservice-class"></a>MSVM \_ TerminalService (clase)

Administra todas las conexiones remotas de terminal a un host determinado. El servicio usa un puerto configurable para iniciar todas las conexiones de terminal.
...
La clase **MSVM \_ TerminalService** tiene estos tipos de miembros:
...
La clase **MSVM \_ TerminalService** tiene estos métodos.
...
| [**GrantInteractiveSessionAccess**](grantinteractivesessionaccess-msvm-terminalservice.md)   | Concede acceso a la sesión interactiva de la máquina virtual a la lista de confianzas especificada.<br/>    |
| [**ModifyServiceSettings**](modifyservicesettings-msvm-terminalservice.md)                   | Modifica los datos de configuración para el servicio.<br/>                                                            |
| [**RequestStateChange**](msvm-terminalservice-requeststatechange.md)                         | Solicita un cambio de estado.<br/>                                                                              |
| [**RevokeInteractiveSessionAccess**](revokeinteractivesessionaccess-msvm-terminalservice.md) | Revoca el acceso a la sesión interactiva de la máquina virtual a partir de la lista de confianzas especificada.<br/> |
...
La clase **MSVM \_ TerminalService** tiene estas propiedades.
...
El acceso a la clase **MSVM \_ TerminalService** puede estar restringido por el filtrado de UAC. Para obtener más información, vea [control de cuentas de usuario y WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
