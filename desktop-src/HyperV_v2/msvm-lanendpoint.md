...
ms.locfileid: "119521935"
---
# <a name="msvm_lanendpoint-class"></a>Clase Msvm \_ LANEndpoint

Representa el punto de conexión lógico para un adaptador de red. Cuando el punto de conexión DE LAN está conectado a un puerto de conmutador, el adaptador de red conectado al punto de conexión DE LAN tiene conectividad de red.
...
La **clase Msvm \_ LANEndpoint** tiene estos tipos de miembros:
...
La **clase Msvm \_ LANEndpoint** tiene estos métodos.



| Método                                                            | Descripción                         |
|:------------------------------------------------------------------|:------------------------------------|
| [**RequestStateChange**](msvm-lanendpoint-requeststatechange.md) | Solicita un cambio de estado.<br/> |
...
La **clase Msvm \_ LANEndpoint** tiene estas propiedades.
...
Otras direcciones de unidifusión que se pueden usar para comunicarse con el punto de conexión de LAN. Esta propiedad se hereda de [**CIM \_ LANEndpoint.**](/previous-versions//cc136865(v=vs.85))
...
Breve descripción del objeto. Esta propiedad se hereda de [**\_ ManagedElement de CIM**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)y siempre se establece en "Punto de conexión LAN".
...
Esta propiedad se establece en **True si** el punto de conexión de LAN está conectado a un puerto de conmutador.
...
Nombre de la clase o subclase utilizada en la creación de una instancia de . Esta propiedad se hereda de [**CIM \_ ServiceAccessPoint**](/windows/desktop/CIMWin32Prov/cim-serviceaccesspoint)y siempre se establece en "Msvm \_ LANEndpoint".
...
Descripción del objeto. Esta propiedad se hereda de [**\_ ManagedElement de CIM**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)y siempre se establece en "Punto de conexión de Microsoft Virtual LAN".
...
Direcciones de multidifusión en las que escucha el punto de conexión de LAN. Esta propiedad se hereda de [**CIM \_ LANEndpoint**](/previous-versions//cc136865(v=vs.85)).
...
Etiqueta o identificador del segmento LAN al que está conectado el punto de conexión. Si el punto de conexión no está activo o conectado actualmente o no se conoce esta información, esta propiedad será **Null.** Esta propiedad se hereda de [**CIM \_ LANEndpoint**](/previous-versions//cc136865(v=vs.85)).
...
Esta propiedad está en desuso en lugar de **la propiedad ProtocolType.** Esta propiedad se hereda de [**CIM \_ LANEndpoint**](/previous-versions//cc136865(v=vs.85)).
...
Calificadores: **MaxLen** ( 12 )
</dt> </dl>

La dirección MAC usada en la comunicación con el punto de conexión de LAN. La dirección MAC tiene el formato de doce dígitos hexadecimales (por ejemplo, "010203040506"), y cada par representa uno de los seis octetos de la dirección MAC en orden de bits canónico según RFC 2469. Esta propiedad se hereda de [**CIM \_ LANEndpoint**](/previous-versions//cc136865(v=vs.85)).
...
El mayor tamaño, en número de bits, del campo de información que el punto de conexión de LAN puede enviar o recibir. Esta propiedad se hereda de [**CIM \_ LANEndpoint**](/previous-versions//cc136865(v=vs.85)).
...
Contiene la heurística de nomenclatura seleccionada para asegurarse de que el valor de la **propiedad Name** es único. Esta propiedad se hereda de [**CIM \_ ProtocolEndpoint**](/previous-versions/windows/desktop/iscsitarg/cim-protocolendpoint)y se establece en "Identificador de dispositivo virtual de Microsoft".
...
Esta propiedad está en desuso en lugar de **la propiedad OtherTypeDescription.** Esta propiedad se hereda de [**CIM \_ LANEndpoint**](/previous-versions//cc136865(v=vs.85)).
...
Cadena que describe el tipo de punto de conexión de protocolo cuando la propiedad **ProtocolIFType** de esta clase (o cualquiera de sus subclases) se establece en 1 (Otros). Esta propiedad debe establecerse en **Null cuando** la **propiedad ProtocolIFType** sea cualquier valor distinto de 1. Esta propiedad se hereda de [**CIM \_ ProtocolEndpoint**](/previous-versions/windows/desktop/iscsitarg/cim-protocolendpoint).
...
La propiedad se usa para clasificar y clasificar instancias de esta clase. Si **ProtocolIFType se** establece en 1 (Other), la información de tipo debe proporcionarse en la **propiedad OtherTypeDescription.** Esta propiedad se hereda del [**\_ protocolo CIMEndpoint**](/previous-versions/windows/desktop/iscsitarg/cim-protocolendpoint).

> [!Note]  
> **ProtocolIFType es** una enumeración que se sincroniza con [IANA ifType MIB](https://www.iana.org/assignments/ianaiftype-mib). También se incluyen valores adicionales definidos por dmtf.
...
<span id="Proprietary_Virtual_Internal"></span><span id="proprietary_virtual_internal"></span><span id="PROPRIETARY_VIRTUAL_INTERNAL"></span>**Propiedad virtual/interna** (53)
</dt> <dt>
...
<span id="ATM_Emulated_LAN_for_802.5"></span><span id="atm_emulated_lan_for_802.5"></span><span id="ATM_EMULATED_LAN_FOR_802.5"></span>**LAN emulada por ATM para 802.5** (60)
</dt> <dt>
...
<span id="ISDN_U_Interface"></span><span id="isdn_u_interface"></span><span id="ISDN_U_INTERFACE"></span>**Interfaz U de ISDN** (76)
</dt> <dt>
...
<span id="Remote_Source_Route_Bridging"></span><span id="remote_source_route_bridging"></span><span id="REMOTE_SOURCE_ROUTE_BRIDGING"></span>**Puente de ruta de origen remoto** (79)
</dt> <dt>
...
<span id="DS0_Bundle"></span><span id="ds0_bundle"></span><span id="DS0_BUNDLE"></span>**Paquete DS0** (82)
</dt> <dt>
...
<span id="ITU_X.29_Host_PAD"></span><span id="itu_x.29_host_pad"></span><span id="ITU_X.29_HOST_PAD"></span>**PANEL de host ITU X.29** (90)
</dt> <dt>
...
<span id="DVB-RCC_MAC_Layer"></span><span id="dvb-rcc_mac_layer"></span><span id="DVB-RCC_MAC_LAYER"></span>**Capa DE MAC DE RCC DE GRS** (146)
</dt> <dt>

<span id="DVB-RCC_Downstream"></span><span id="dvb-rcc_downstream"></span><span id="DVB-RCC_DOWNSTREAM"></span>**DT-RCC de bajada** (147)
</dt> <dt>
...
<span id="Proprietary_P2P_Wireless"></span><span id="proprietary_p2p_wireless"></span><span id="PROPRIETARY_P2P_WIRELESS"></span>**P2P Wireless** propietario (157)
</dt> <dt>

<span id="Frame_Forward"></span><span id="frame_forward"></span><span id="FRAME_FORWARD"></span>**Avance de** marco (158)
</dt> <dt>
...
<span id="DVB-ASI_Input"></span><span id="dvb-asi_input"></span><span id="DVB-ASI_INPUT"></span>**Entrada DE SI-ASI** (172)
</dt> <dt>

<span id="DVB-ASI_Output"></span><span id="dvb-asi_output"></span><span id="DVB-ASI_OUTPUT"></span>**Salida de DVB-ASI** (173)
</dt> <dt>
...
<span id="Proprietary_Wireless_MAC_Layer"></span><span id="proprietary_wireless_mac_layer"></span><span id="PROPRIETARY_WIRELESS_MAC_LAYER"></span>**Capa mac inalámbrica propietaria** (180)
</dt> <dt>
...
<span id="Frame_Relay_DLCI_Endpoint"></span><span id="frame_relay_dlci_endpoint"></span><span id="FRAME_RELAY_DLCI_ENDPOINT"></span>**Punto de conexión de DLCI de Frame Relay** (193)
</dt> <dt>

<span id="ATM_VCI_Endpoint"></span><span id="atm_vci_endpoint"></span><span id="ATM_VCI_ENDPOINT"></span>**Punto de conexión de VCI de ATM** (194)
</dt> <dt>
...
<span id="Proprietary_ATM"></span><span id="proprietary_atm"></span><span id="PROPRIETARY_ATM"></span>**Cajero automático propietario** (197)
</dt> <dt>
...
<span id="CATV_Upstream_Channel"></span><span id="catv_upstream_channel"></span><span id="CATV_UPSTREAM_CHANNEL"></span>**Canal ascendente de CATV** (205)
</dt> <dt>

<span id="Econet"></span><span id="econet"></span><span id="ECONET"></span>**Econet** (206)
</dt> <dt>

<span id="FSAN_155Mb_PON"></span><span id="fsan_155mb_pon"></span><span id="FSAN_155MB_PON"></span>**PONN de 155 Mb** (207)
</dt> <dt>

<span id="FSAN_622Mb_PON"></span><span id="fsan_622mb_pon"></span><span id="FSAN_622MB_PON"></span>**PONN de 622 Mb** (208)
</dt> <dt>
...
<span id="Paradyne_EtherLoop_1"></span><span id="paradyne_etherloop_1"></span><span id="PARADYNE_ETHERLOOP_1"></span>**Parad etherLoop 1** (217)
</dt> <dt>

<span id="Paradyne_EtherLoop_2"></span><span id="paradyne_etherloop_2"></span><span id="PARADYNE_ETHERLOOP_2"></span>**Parad etherLoop 2** (218)
</dt> <dt>
...
<span id="VINES"></span><span id="vines"></span>**SARS** (4104)
</dt> <dt>

<span id="XNS"></span><span id="xns"></span>**XNS** (4105)
</dt> <dt>

<span id="ISDN_B_Channel_Endpoint"></span><span id="isdn_b_channel_endpoint"></span><span id="ISDN_B_CHANNEL_ENDPOINT"></span>**Punto de conexión de canal B de ISDN** (4106)
</dt> <dt>
...
Esta propiedad está en desuso en lugar de la **propiedad ProtocolIFType.** Esta propiedad se hereda de [**CIM \_ ProtocolEndpoint**](/previous-versions/windows/desktop/iscsitarg/cim-protocolendpoint).
