...
---
# <a name="removebootsourcesettings-method-of-the-msvm_virtualsystemmanagementservice-class"></a>Método RemoveBootSourceSettings de la \_ clase VirtualSystemManagementService de MSVM
...
Referencia a una matriz de [**un \_ SettingData de CIM**](cim-settingdata.md) que describe la configuración de origen de arranque que se va a quitar.
