...
---
# <a name="msvm_ps2mouse-class"></a>MSVM \_ Ps2Mouse (clase)

Representa un dispositivo de mouse PS2. Las instancias de esta clase son dispositivos lógicos que siempre están presentes en una máquina virtual y, por tanto, no se asignan a través de un grupo de recursos. Siempre hay una instancia en una máquina virtual.
...
La clase **MSVM \_ Ps2Mouse** tiene estos tipos de miembros:
...
La clase **MSVM \_ Ps2Mouse** tiene estos métodos.



| Método                                                           | Descripción                                                                                           |
|:-----------------------------------------------------------------|:------------------------------------------------------------------------------------------------------|
| [**ClickButton**](clickbutton-msvm-ps2mouse.md)                 | Simula un clic de botón, una secuencia descendente, en el botón de dispositivo especificado.<br/>              |
| **EnableDevice**                                                 | No se admite este método.<br/>                                                              |
| [**GetButtonState**](getbuttonstate-msvm-ps2mouse.md)           | Recupera el estado actual del botón del dispositivo especificado.<br/>                                |
...
| [**Reset**](msvm-ps2mouse-reset.md)                             | Restablece el dispositivo.<br/>                                                                         |
| **RestoreProperties**                                            | No se admite este método.<br/>                                                              |
| **SaveProperties**                                               | No se admite este método.<br/>                                                              |
| [**SetButtonState**](setbuttonstate-msvm-ps2mouse.md)           | Establece el estado actual del botón del dispositivo especificado.<br/>                                     |
| **SetPowerState**                                                | No se admite este método.<br/>                                                              |
| [**SetRelativePosition**](setrelativeposition-msvm-ps2mouse.md) | Desplaza la posición del puntero del mouse según las diferencias horizontales y verticales especificadas.<br/> |
| [**SetScrollPosition**](setscrollposition-msvm-ps2mouse.md)     | Ajusta la coordenada z del control de rueda del dispositivo señalador.<br/>                      |
...
La clase **MSVM \_ Ps2Mouse** tiene estas propiedades.
...
Estado habilitado o deshabilitado del elemento cuando la propiedad [**EnabledState**](msvm-keyboard.md) está establecida en 1 (otro). Esta propiedad debe establecerse en **null** cuando **EnabledState** es cualquier valor distinto de 1. Esta propiedad se hereda de [**\_ EnabledLogicalElement CIM**](/previous-versions//cc136818(v=vs.85)).
...
Tipo del dispositivo señalador. Esta propiedad se hereda de [**\_ PointingDevice CIM**](/windows/desktop/CIMWin32Prov/cim-pointingdevice).
...
Cadenas que describen los distintos valores de la matriz [**OperationalStatus**](msvm-bioselement.md) . Esta propiedad se hereda del [**\_ ManagedSystemElement de CIM**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement) y siempre está establecida en "OK".
...
El acceso a la clase **MSVM \_ Ps2Mouse** puede estar restringido por el filtrado de UAC. Para obtener más información, vea [control de cuentas de usuario y WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
