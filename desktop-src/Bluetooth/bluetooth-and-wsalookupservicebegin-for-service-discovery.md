...
| <strong>LUP_RETURN_ADDR</strong> | Devuelve una dirección en el miembro <strong>lpcsaBuffer que</strong> se usará con las llamadas a la <a href="/windows/desktop/api/winsock2/nf-winsock2-connect"><strong>función connect.</strong></a> La dirección devuelta contiene el número de puerto. | 
...
| <strong>LUP_RETURN_COMMENT</strong> | Devuelve la descripción del servicio en el miembro <strong>lpszComment</strong> de la estructura <a href="/windows/desktop/api/winsock2/ns-winsock2-wsaquerysetw"><strong>WSAQUERYSET</strong></a> para cada llamada a la <a href="/windows/desktop/api/winsock2/nf-winsock2-wsalookupservicenexta"><strong>función WSALookupServiceNext.</strong></a> | 
...
Para realizar una consulta avanzada de los servicios, los Bluetooth deben especificar las restricciones siguientes en la estructura [**WSAQUERYSET**](/windows/desktop/api/winsock2/ns-winsock2-wsaquerysetw) que se pasa al parámetro *lpqsRestrictions.*
