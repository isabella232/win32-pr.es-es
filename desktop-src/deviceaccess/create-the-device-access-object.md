---
title: Implementar el objeto device access
description: En este tema se explica cómo crear instancias del objeto de acceso del dispositivo y usarlo para acceder a un dispositivo.
