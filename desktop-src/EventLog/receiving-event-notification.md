---
description: Recibir notificación de eventos
ms.assetid: 3200d666-d927-4198-b1f6-1636971f5f07
title: Recibir notificación de eventos
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103812884"
---
# <a name="receiving-event-notification"></a><span data-ttu-id="63f02-103">Recibir notificación de eventos</span><span class="sxs-lookup"><span data-stu-id="63f02-103">Receiving Event Notification</span></span>

<span data-ttu-id="63f02-104">En el ejemplo siguiente se muestra cómo usar la función [**NotifyChangeEventLog**](/windows/desktop/api/Winbase/nf-winbase-notifychangeeventlog) para recibir una notificación cuando se registra un evento.</span><span class="sxs-lookup"><span data-stu-id="63f02-104">The following example shows how to use the [**NotifyChangeEventLog**](/windows/desktop/api/Winbase/nf-winbase-notifychangeeventlog) function to receive notification when an event is logged.</span></span> <span data-ttu-id="63f02-105">En este ejemplo se filtran los eventos escritos por el ejemplo en la [notificación de un evento](reporting-an-event.md).</span><span class="sxs-lookup"><span data-stu-id="63f02-105">This example filters for the events written by the example in [Reporting an Event](reporting-an-event.md).</span></span>
