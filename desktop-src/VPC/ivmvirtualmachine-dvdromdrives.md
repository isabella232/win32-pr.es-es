...
keywords:
- DVDROMDrives, propiedad Virtual PC
- Propiedad DVDROMDrives Pc virtual, interfaz IVMVirtualMachine
- IVMVirtualMachine interface Virtual PC , PROPIEDAD DVDROMDrives
topic_type:
- apiref
api_name:
