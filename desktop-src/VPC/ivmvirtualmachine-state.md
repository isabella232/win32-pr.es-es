---
title: Propiedad IVMVirtualMachine State (VPCCOMInterfaces.h)
...
- Propiedad de estado Virtual PC , IVMVirtualMachine (interfaz)
- Interfaz IVMVirtualMachine Pc virtual, propiedad State
topic_type:
- apiref
api_name:
...
ms.locfileid: "117752166"
---
# <a name="ivmvirtualmachinestate-property"></a>Propiedad IVMVirtualMachine::State
