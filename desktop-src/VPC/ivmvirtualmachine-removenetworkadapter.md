...
---
# <a name="ivmvirtualmachineremovenetworkadapter-method"></a>IVMVirtualMachine:: RemoveNetworkAdapter (método)

\[Windows Virtual PC ya no está disponible para su uso a partir de Windows 8. En su lugar, use el [proveedor de WMI de Hyper-V (V2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Quita una interfaz de red de la máquina virtual.
...
Un objeto [**IVMNetworkAdapter**](ivmnetworkadapter.md) que representa el adaptador de red que se va a quitar.
...
Solo puede quitar una interfaz de red existente de una máquina virtual que esté detenida.
