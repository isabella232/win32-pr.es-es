...
- MaximumNumberOfIDEBuses, propiedad Virtual PC, interfaz IVMVirtualPC
- IVMVirtualPC interface Virtual PC , MaximumNumberOfIDEBuses, propiedad
topic_type:
- apiref
api_name:
