...
---
# <a name="extendedpropertyvalue-property"></a>ExtendedProperty. Value (propiedad)
...
La propiedad **Value** establece o recupera los datos de la propiedad extendida.
...
Los datos de la propiedad extendida, en el formato especificado por *EncodingType*.
