...
---
# <a name="rsa-server-code-for-creating-the-master-key"></a>Código de servidor RSA para crear la clave maestra

En el ejemplo siguiente se muestra el código de servidor RSA/Schannel típico para crear una [*clave maestra*](../secgloss/m-gly.md).
