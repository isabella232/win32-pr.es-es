---
description: Recupera el valor de la restricción de longitud de ruta de acceso.
ms.assetid: 77a12fdf-e9ed-4c79-aa2c-bd476ab3ff90
title: BasicConstraints.PathLenConstraint, propiedad
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "127374915"
---
# <a name="basicconstraintspathlenconstraint-property"></a>BasicConstraints.PathLenConstraint, propiedad
...
La **propiedad PathLenConstraint** recupera el valor de la restricción de longitud de ruta de acceso.
...
Valor de la restricción de longitud de ruta de acceso.
