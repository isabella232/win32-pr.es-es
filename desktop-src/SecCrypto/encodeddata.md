...
Varias propiedades de objeto de CAPICOM devuelven el objeto **EncodedData** . Cuando se devuelve, este objeto se usa para realizar las siguientes tareas:

-   Obtener una representación de cadena de los datos codificados.
-   Obtiene el objeto descodificador, si existe, que está asociado a los datos codificados.
...
| [**Aplique**](encodeddata-format.md)   | Devuelve una representación de cadena de los datos codificados.<br/> |
