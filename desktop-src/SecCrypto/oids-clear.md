---
description: Borra todos los objetos OID de la colección.
ms.assetid: 13c9ecf4-c3fc-4dae-a395-04e5247b3b1f
title: OID. Clear (método)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "105690069"
---
# <a name="oidsclear-method"></a>OID. Clear (método)
...
El método **Clear** borra todos los objetos [**OID**](oid.md) de la colección.
