...
5.  Con el algoritmo hash contenido en el mensaje, [*aplica un algoritmo hash*](../secgloss/h-gly.md) a los datos contenidos en el mensaje, lo que produce un nuevo resumen.
