---
description: Muestra cómo codificar y descodificar un mensaje con contrafirma. En este ejemplo se usa la función de ejemplo MyHandleError. El código de la función MyHandleError y otras funciones auxiliares también se enumeran en funciones de De uso general.
ms.assetid: 12930d4d-2ea5-4d95-b9cf-4f0dd351ce05
title: 'Programa C de ejemplo: codificar y descodificar un mensaje con signo'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105688194"
---
# <a name="example-c-program-encoding-and-decoding-a-countersigned-message"></a><span data-ttu-id="5fa1f-105">Programa C de ejemplo: codificar y descodificar un mensaje con signo</span><span class="sxs-lookup"><span data-stu-id="5fa1f-105">Example C Program: Encoding and Decoding a Countersigned Message</span></span>

<span data-ttu-id="5fa1f-106">En el ejemplo siguiente se muestra cómo codificar y descodificar un mensaje con contrafirma.</span><span class="sxs-lookup"><span data-stu-id="5fa1f-106">The following example shows how to encode and decode a countersigned message.</span></span> <span data-ttu-id="5fa1f-107">En este ejemplo se usa la función de ejemplo [**MyHandleError**](myhandleerror.md) .</span><span class="sxs-lookup"><span data-stu-id="5fa1f-107">This example uses the [**MyHandleError**](myhandleerror.md) example function.</span></span> <span data-ttu-id="5fa1f-108">El código de la función **MyHandleError** y otras funciones auxiliares también se enumeran en [funciones de de uso general](general-purpose-functions.md).</span><span class="sxs-lookup"><span data-stu-id="5fa1f-108">Code for the **MyHandleError** function and other auxiliary functions is also listed under [General Purpose Functions](general-purpose-functions.md).</span></span>
