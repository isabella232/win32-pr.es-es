...
---
# <a name="bytetostr"></a><span data-ttu-id="3b460-103">ByteToStr</span><span class="sxs-lookup"><span data-stu-id="3b460-103">ByteToStr</span></span>

<span data-ttu-id="3b460-104">La función **ByteToStr** convierte una matriz de valores de **byte** en una cadena de caracteres hexadecimales.</span><span class="sxs-lookup"><span data-stu-id="3b460-104">The **ByteToStr** function converts an array of **BYTE** values to a hexadecimal character string.</span></span>
