---
description: El proveedor de servicios criptográficos mejorado de Microsoft admite los algoritmos siguientes.
...
El [proveedor de servicios criptográficos mejorado](microsoft-enhanced-cryptographic-provider.md) de Microsoft admite los algoritmos siguientes.
...
| CALG \_ MD5          | Algoritmo de hash MD5.                                                                                                                                          | Para obtener más información, vea [*Md5 algorithm*](../secgloss/m-gly.md).                                       |
