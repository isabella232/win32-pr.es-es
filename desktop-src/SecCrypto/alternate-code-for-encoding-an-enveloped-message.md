---
description: En el ejemplo siguiente se muestra un proceso alternativo para codificar un mensaje firmado, utilizando ese mensaje firmado como el contenido interno de un mensaje con doble cifrado. Como preparación para la descodificación, el contenido interno se prueba para determinar su tipo de contenido interno.
ms.assetid: ba174e3c-bc2f-48bd-a1bf-fec491dc0ce3
title: Código alternativo para codificar un mensaje con doble cifrado
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105667915"
---
# <a name="alternate-code-for-encoding-an-enveloped-message"></a><span data-ttu-id="75847-104">Código alternativo para codificar un mensaje con doble cifrado</span><span class="sxs-lookup"><span data-stu-id="75847-104">Alternate Code for Encoding an Enveloped Message</span></span>

<span data-ttu-id="75847-105">En el ejemplo siguiente se muestra un proceso alternativo para codificar un mensaje firmado, utilizando ese mensaje firmado como el [*contenido interno*](../secgloss/i-gly.md) de un mensaje con doble cifrado.</span><span class="sxs-lookup"><span data-stu-id="75847-105">The following example demonstrates an alternate process of encoding a signed message, using that signed message as the [*inner content*](../secgloss/i-gly.md) for an enveloped message.</span></span> <span data-ttu-id="75847-106">Como preparación para la descodificación, el contenido interno se prueba para determinar su tipo de contenido interno.</span><span class="sxs-lookup"><span data-stu-id="75847-106">In preparation for decoding, the inner content is tested to determine its inner-content type.</span></span>

<span data-ttu-id="75847-107">En este ejemplo se muestran las siguientes funciones de CryptoAPI:</span><span class="sxs-lookup"><span data-stu-id="75847-107">This example illustrates the following CryptoAPI functions:</span></span>

-   [<span data-ttu-id="75847-108">**CryptAcquireContext**</span><span class="sxs-lookup"><span data-stu-id="75847-108">**CryptAcquireContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecontexta)
-   [<span data-ttu-id="75847-109">**CertOpenSystemStore**</span><span class="sxs-lookup"><span data-stu-id="75847-109">**CertOpenSystemStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certopensystemstorea)
-   [<span data-ttu-id="75847-110">**CryptMsgCalculateEncodedLength**</span><span class="sxs-lookup"><span data-stu-id="75847-110">**CryptMsgCalculateEncodedLength**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgcalculateencodedlength)
-   [<span data-ttu-id="75847-111">**CryptMsgOpenToEncode**</span><span class="sxs-lookup"><span data-stu-id="75847-111">**CryptMsgOpenToEncode**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentoencode)
-   [<span data-ttu-id="75847-112">**CryptMsgUpdate**</span><span class="sxs-lookup"><span data-stu-id="75847-112">**CryptMsgUpdate**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgupdate)
-   [<span data-ttu-id="75847-113">**CryptMsgGetParam**</span><span class="sxs-lookup"><span data-stu-id="75847-113">**CryptMsgGetParam**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam)
-   [<span data-ttu-id="75847-114">**CryptMsgOpenToDecode**</span><span class="sxs-lookup"><span data-stu-id="75847-114">**CryptMsgOpenToDecode**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentodecode)
-   [<span data-ttu-id="75847-115">**CertFindCertificateInStore**</span><span class="sxs-lookup"><span data-stu-id="75847-115">**CertFindCertificateInStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certfindcertificateinstore)
-   [<span data-ttu-id="75847-116">**CryptMsgClose**</span><span class="sxs-lookup"><span data-stu-id="75847-116">**CryptMsgClose**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgclose)
-   [<span data-ttu-id="75847-117">**CertCloseStore**</span><span class="sxs-lookup"><span data-stu-id="75847-117">**CertCloseStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore)
-   [<span data-ttu-id="75847-118">**CryptReleaseContext**</span><span class="sxs-lookup"><span data-stu-id="75847-118">**CryptReleaseContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptreleasecontext)

<span data-ttu-id="75847-119">En este ejemplo también se usan las funciones [**MyHandleError**](myhandleerror.md) y [**GetSignerCert**](getsignercert.md).</span><span class="sxs-lookup"><span data-stu-id="75847-119">This example also uses the functions [**MyHandleError**](myhandleerror.md) and [**GetSignerCert**](getsignercert.md).</span></span> <span data-ttu-id="75847-120">El código C de estas funciones se incluye con el ejemplo.</span><span class="sxs-lookup"><span data-stu-id="75847-120">C code for these functions is included with the example.</span></span> <span data-ttu-id="75847-121">Para ver el código que muestra estas y otras funciones auxiliares, consulte [funciones de de uso general](general-purpose-functions.md).</span><span class="sxs-lookup"><span data-stu-id="75847-121">For code that demonstrates these and other auxiliary functions, see [General Purpose Functions](general-purpose-functions.md).</span></span>
