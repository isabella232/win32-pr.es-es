...
---
# <a name="storeclose-method"></a>Store. Close (método)
...
El método **Close** cierra un almacén de [*certificados*](../secgloss/c-gly.md)abierto.
...
Después de llamar al método **Close** , se destruye el objeto [**Store**](store.md) .
