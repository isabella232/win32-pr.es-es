...
ms.locfileid: "119876565"
---
# <a name="creating-signing-and-storing-a-ctl"></a>Crear, firmar y almacenar una CTL

Los procedimientos siguientes crean una lista [*de confianza de certificados*](../secgloss/c-gly.md) firmados (CTL) y la guarda en un almacén de [*certificados.*](../secgloss/c-gly.md)
...
2.  Inicialice una [**estructura \_ CTL INFO**](/windows/desktop/api/Wincrypt/ns-wincrypt-ctl_info) que incluya la matriz de elementos que acaba de crear.
