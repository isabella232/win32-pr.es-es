...
La **enumeración CAPICOM \_ PROPID** define los identificadores de propiedad CAPICOM.
...
| **CAPICOM \_ PROPID \_ CTL \_ USAGE**                        | Uso [*de una lista de confianza*](../secgloss/c-gly.md) de certificados (CTL).<br/>                                                                                                                                             | 9          |
...
| **NOMBRE DESCRIPTIVO DE CAPICOM \_ PROPID \_ \_**                    | Nombre legible.<br/>                                                                                                                                                                                                                                                          | 11         |
| **ARCHIVO CAPICOM \_ PROPID \_ \_ PVK**                         | Archivo que contiene una clave privada.<br/>                                                                                                                                                                                                                                             | 12         |
| **CAPICOM \_ PROPID \_ DESCRIPTION**                       | Descripción legible.<br/>                                                                                                                                                                                                                                                   | 13         |
...
| **INSCRIPCIÓN AUTOMÁTICA DE CAPICOM \_ PROPID \_ \_**                      | Información de inscripción automática de un certificado.<br/>                                                                                                                                                                                                                                  | 21         |
| **CAPICOM \_ PROPID \_ PUBKEY \_ ALG \_ PARA**                 | Parámetros para un algoritmo de clave pública.<br/>                                                                                                                                                                                                                                          | 22         |
| **PUNTOS DE DISTRIBUCIÓN DE \_ CERTIFICADOS \_ \_ CRUZADOS \_ DE CAPICOM PROPID \_**         | Información utilizada para actualizar certificados cruzados dinámicos.<br/>                                                                                                                                                                                                                          | 23         |
| **\_ \_ \_ HASH \_ \_ MD5 \_ DE CLAVE PÚBLICA DEL EMISOR DE CAPICOM PROPID**    | Hash MD5 de la clave pública del emisor.<br/>                                                                                                                                                                                                                                        | 24         |
