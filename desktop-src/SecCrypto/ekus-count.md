...
---
# <a name="ekuscount-property"></a>EKU. Count (propiedad)
...
La propiedad **Count** se puede usar para especificar el último objeto [**EKU**](eku.md) de una colección al recuperar un objeto **EKU** específico mediante la propiedad [**EKU. Item**](ekus-item.md) .
