...
---
# <a name="example-c-code-for-opening-certificate-stores"></a><span data-ttu-id="31331-104">Código C de ejemplo para abrir almacenes de certificados</span><span class="sxs-lookup"><span data-stu-id="31331-104">Example C Code for Opening Certificate Stores</span></span>

<span data-ttu-id="31331-105">En los siguientes ejemplos se proporciona código para abrir varios almacenes de certificados comunes.</span><span class="sxs-lookup"><span data-stu-id="31331-105">The following examples provide code to open a variety of common certificate stores.</span></span> <span data-ttu-id="31331-106">Estos ejemplos son una serie de fragmentos de código y no son programas independientes.</span><span class="sxs-lookup"><span data-stu-id="31331-106">These examples are a series of code fragments and are not stand-alone programs.</span></span>

<span data-ttu-id="31331-107">En el ejemplo siguiente se abre mi almacén del sistema.</span><span class="sxs-lookup"><span data-stu-id="31331-107">The following example opens the My system store.</span></span>
...
<span data-ttu-id="31331-108">En el ejemplo siguiente se abre un almacén de memoria.</span><span class="sxs-lookup"><span data-stu-id="31331-108">The following example opens a memory store.</span></span>
...
<span data-ttu-id="31331-109">En el ejemplo siguiente se abre un almacén desde el disco.</span><span class="sxs-lookup"><span data-stu-id="31331-109">The following example opens a store from disk.</span></span> <span data-ttu-id="31331-110">En el ejemplo se usa la función **CreateMyDACL** , que se define en el tema [crear una DACL](../secbp/creating-a-dacl.md) , para asegurarse de que el archivo abierto se crea con una DACL adecuada.</span><span class="sxs-lookup"><span data-stu-id="31331-110">The example uses the **CreateMyDACL** function, defined in the [Creating a DACL](../secbp/creating-a-dacl.md) topic, to ensure the open file is created with a proper DACL.</span></span>
...
<span data-ttu-id="31331-111">En el ejemplo siguiente se abre un almacén basado en archivos mediante el \_ nombre de archivo Prov del almacén de certificados \_ \_ .</span><span class="sxs-lookup"><span data-stu-id="31331-111">The following example opens a file-based store using CERT\_STORE\_PROV\_FILENAME.</span></span>
...
<span data-ttu-id="31331-112">En el ejemplo siguiente se abre un almacén de recopilación.</span><span class="sxs-lookup"><span data-stu-id="31331-112">The following example opens a collection store.</span></span>
...
<span data-ttu-id="31331-113">En el ejemplo siguiente se abre un almacén de registros.</span><span class="sxs-lookup"><span data-stu-id="31331-113">The following example opens a register store.</span></span>
...
<span data-ttu-id="31331-114">En el ejemplo siguiente se abre un almacén de certificados basado en un \# mensaje PKCS 7.</span><span class="sxs-lookup"><span data-stu-id="31331-114">The following example opens a certificate store based on a PKCS \#7 message.</span></span>
