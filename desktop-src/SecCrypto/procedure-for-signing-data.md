...
ms.locfileid: "117977559"
---
# <a name="procedure-for-signing-data"></a>Procedimiento para firmar datos

Una sola función, [**CryptSignMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsignmessage), realiza todas las tareas enumeradas en [Creating a Signed Message](creating-a-signed-message.md). Sin embargo, la inicialización de estructuras y otros datos sigue siendo necesaria. En la ilustración siguiente se muestra la relación entre los parámetros de función que apuntan a estructuras o matrices y sus datos inicializados. En la ilustración solo se muestran los parámetros de función y los miembros de estructura que se derivan de otras estructuras o funciones. El resto de los parámetros son inicializaciones sencillas.
...
8.  Inicialice [**la estructura CRYPT ALGORITHM \_ \_ IDENTIFIER,**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_algorithm_identifier) inicializando el miembro **pszObjId** en el algoritmo hash deseado y los demás miembros según corresponda.
