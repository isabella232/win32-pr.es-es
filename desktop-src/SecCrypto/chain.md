...
El **objeto Chain** se usa para realizar las tareas siguientes:

-   Cree una cadena de confianza de certificado.
-   Obtenga los IDENTIFICADORES de todas las directivas de certificado y aplicación válidas para la cadena.
...
| [**Build**](chain-build.md)                             | Compila una cadena de comprobación de certificados de un certificado final al certificado raíz de confianza [*y*](../secgloss/r-gly.md)devuelve un valor booleano que indica la validez general de la cadena.<br/> (Se hereda de **ChainIChain2IChain**) |
...
| [**Estado**](chain-status.md)<br/>             | Solo lectura<br/> | Recupera el estado de validez de la cadena o de un certificado específico de la cadena.<br/> (Se hereda de **ChainIChain2IChain**)                                                       |
