...
---
# <a name="diffie-hellman-server-code-for-creating-the-master-key"></a><span data-ttu-id="54fd3-103">Diffie-Hellman código de servidor para crear la clave maestra</span><span class="sxs-lookup"><span data-stu-id="54fd3-103">Diffie-Hellman Server Code for Creating the Master Key</span></span>

<span data-ttu-id="54fd3-104">En el ejemplo siguiente se muestra el código del lado servidor/Schannel de [*Diffie-Hellman*](../secgloss/d-gly.md)típico para crear una [*clave maestra*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="54fd3-104">The following example shows typical [*Diffie-Hellman*](../secgloss/d-gly.md)/Schannel server-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
