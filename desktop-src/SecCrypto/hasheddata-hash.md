...
---
# <a name="hasheddatahash-method"></a>HashedData. hash (método)
...
Cadena que contiene el valor al que se va a aplicar un algoritmo hash.
...
Para crear el hash de una gran cantidad de datos, llame al método **hash** para cada fragmento de datos. El hash de cada fragmento de datos se concatena a la propiedad [**Value**](hasheddata-value.md) hasta que se lee la propiedad. El contenido de la propiedad **Value** se restablece cuando se lee la propiedad.
