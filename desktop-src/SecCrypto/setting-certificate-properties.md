---
description: Use el método ICertServerPolicy::SetCertificateProperty para establecer las propiedades de sujeto de un certificado.
ms.assetid: 93e4b05d-0230-4562-8052-4e118fd92057
title: Establecimiento de propiedades de certificado
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "127160742"
---
# <a name="setting-certificate-properties"></a>Establecimiento de propiedades de certificado

Use el [**método ICertServerPolicy::SetCertificateProperty**](/windows/desktop/api/Certif/nf-certif-icertserverpolicy-setcertificateproperty) para establecer las propiedades de sujeto de un certificado. Las propiedades de sujeto son propiedades relacionadas con el propietario del certificado o con la persona que solicitó el certificado. Para obtener una lista de propiedades de asunto, vea [Propiedades de nombre](name-properties.md).
