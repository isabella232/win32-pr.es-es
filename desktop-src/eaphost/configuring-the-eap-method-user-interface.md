...
4.  Llamar [**a EapHostPeerInvokeConfigUI**](/previous-versions/windows/desktop/api/eaphostpeerconfigapis/nf-eaphostpeerconfigapis-eaphostpeerinvokeconfigui) invoca la propia interfaz de usuario de configuración de un método EAP. Al devolver desde **EapHostPeerInvokeConfigUI,** la función devolverá un BLOB de configuración del método EAP como parámetro externo.
