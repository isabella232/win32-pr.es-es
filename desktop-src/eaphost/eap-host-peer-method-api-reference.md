---
title: Referencia de API del método del mismo nivel de EAPHost
description: Vea la documentación de referencia de LA API del método del mismo nivel de EAPHost, como las funciones de configuración del método del mismo nivel de EAPHost.
...
Tenga en cuenta que el autor del método del mismo nivel de EAP debe implementar estos elementos en un archivo DLL compatible. EAPHost del lado cliente carga y llama al archivo DLL con la implementación de estos elementos de API.
