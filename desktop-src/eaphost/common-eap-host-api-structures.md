...
| [**DATOS DE \_ CAMPO DE ENTRADA DE CONFIGURACIÓN \_ \_ DE \_ EAP**](/windows/desktop/api/eaptypes/ns-eaptypes-eap_config_input_field_data)   | Contiene los datos asociados a un único campo de entrada en un cuadro de diálogo de configuración de inicio de sesión único (SSO) de EAP.                                                                                                              |
