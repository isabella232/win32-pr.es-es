...
description: Obtenga información sobre las propiedades de usuario de EAP-TLS. Vea un ejemplo que es una instancia del esquema heredado eaptlsuserpropertiesv1.
