---
title: Método CreateInstanceFromPropertyData de la MicrosoftDNS_CNAMEType clase
...
- Método DNS CreateInstanceFromPropertyData , MicrosoftDNS_CNAMEType clase
- MicrosoftDNS_CNAMEType clase DNS , método CreateInstanceFromPropertyData
topic_type:
- apiref
api_name:
...
ms.locfileid: "119825235"
---
# <a name="createinstancefrompropertydata-method-of-the-microsoftdns_cnametype-class"></a>Método CreateInstanceFromPropertyData de la clase CNAMEType de MicrosoftDNS \_

El **método CreateInstanceFromPropertyData** crea una instancia de un registro de recursos de nombre canónico (CNAME).
...
Nombre principal del RR de CNAME.
