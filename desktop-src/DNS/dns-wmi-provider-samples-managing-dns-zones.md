...
---
# <a name="dns-wmi-provider-samplesmanaging-dns-zones"></a><span data-ttu-id="186bd-104">Ejemplos del proveedor WMI de DNS: administrar Zonas DNS</span><span class="sxs-lookup"><span data-stu-id="186bd-104">DNS WMI Provider Samples—Managing DNS Zones</span></span>

<span data-ttu-id="186bd-105">En esta sección se muestran las tareas de scripting asociadas a la administración de zonas DNS.</span><span class="sxs-lookup"><span data-stu-id="186bd-105">This section demonstrates scripting tasks associated with managing DNS zones.</span></span> <span data-ttu-id="186bd-106">Los vínculos siguientes vinculan a las subrutinas del archivo de script.</span><span class="sxs-lookup"><span data-stu-id="186bd-106">The following links link to subroutines in the script file.</span></span>

-   [<span data-ttu-id="186bd-107">Creación de una zona DNS</span><span class="sxs-lookup"><span data-stu-id="186bd-107">Create a DNS zone</span></span>](#create-a-dns-zone)
-   [<span data-ttu-id="186bd-108">Modificar una zona DNS</span><span class="sxs-lookup"><span data-stu-id="186bd-108">Modify a DNS zone</span></span>](#modify-a-dns-zone)
-   [<span data-ttu-id="186bd-109">Eliminar una zona DNS</span><span class="sxs-lookup"><span data-stu-id="186bd-109">Delete a DNS zone</span></span>](#delete-a-dns-zone)
-   [<span data-ttu-id="186bd-110">Agregar una dirección IP de zona</span><span class="sxs-lookup"><span data-stu-id="186bd-110">Add a zone IP address</span></span>](#add-a-zone-ip-address)
-   [<span data-ttu-id="186bd-111">Eliminación de una dirección IP de zona</span><span class="sxs-lookup"><span data-stu-id="186bd-111">Delete a zone IP address</span></span>](#delete-a-zone-ip-address)
-   [<span data-ttu-id="186bd-112">Pausar una zona</span><span class="sxs-lookup"><span data-stu-id="186bd-112">Pause a zone</span></span>](#pause-a-zone)
-   [<span data-ttu-id="186bd-113">Reanudación de una zona</span><span class="sxs-lookup"><span data-stu-id="186bd-113">Resume a zone</span></span>](#resume-a-zone)
-   [<span data-ttu-id="186bd-114">Actualizar una zona</span><span class="sxs-lookup"><span data-stu-id="186bd-114">Update a zone</span></span>](#update-a-zone)
-   [<span data-ttu-id="186bd-115">Recarga de una zona</span><span class="sxs-lookup"><span data-stu-id="186bd-115">Reload a zone</span></span>](#reload-a-zone)
-   [<span data-ttu-id="186bd-116">Actualizar una zona</span><span class="sxs-lookup"><span data-stu-id="186bd-116">Refresh a zone</span></span>](#refresh-a-zone)
...
## <a name="create-a-dns-zone"></a><span data-ttu-id="186bd-117">Creación de un alias DNS</span><span class="sxs-lookup"><span data-stu-id="186bd-117">Create a DNS Zone</span></span>
...
## <a name="modify-a-dns-zone"></a><span data-ttu-id="186bd-118">Modificar una zona DNS</span><span class="sxs-lookup"><span data-stu-id="186bd-118">Modify a DNS Zone</span></span>
...
## <a name="delete-a-dns-zone"></a><span data-ttu-id="186bd-119">Eliminación de una zona DNS</span><span class="sxs-lookup"><span data-stu-id="186bd-119">Delete a DNS Zone</span></span>
...
## <a name="add-a-zone-ip-address"></a><span data-ttu-id="186bd-120">Agregar una dirección IP de zona</span><span class="sxs-lookup"><span data-stu-id="186bd-120">Add a Zone IP Address</span></span>
...
## <a name="delete-a-zone-ip-address"></a><span data-ttu-id="186bd-121">Eliminación de una dirección IP de zona</span><span class="sxs-lookup"><span data-stu-id="186bd-121">Delete a Zone IP Address</span></span>
...
## <a name="pause-a-zone"></a><span data-ttu-id="186bd-122">Poner una zona en pausa</span><span class="sxs-lookup"><span data-stu-id="186bd-122">Pause a Zone</span></span>
...
## <a name="resume-a-zone"></a><span data-ttu-id="186bd-123">Reanudar una zona</span><span class="sxs-lookup"><span data-stu-id="186bd-123">Resume a Zone</span></span>
...
## <a name="update-a-zone"></a><span data-ttu-id="186bd-124">Actualizar una zona</span><span class="sxs-lookup"><span data-stu-id="186bd-124">Update a Zone</span></span>
...
## <a name="reload-a-zone"></a><span data-ttu-id="186bd-125">Recargar una zona</span><span class="sxs-lookup"><span data-stu-id="186bd-125">Reload a Zone</span></span>
...
## <a name="refresh-a-zone"></a><span data-ttu-id="186bd-126">Actualizar una zona</span><span class="sxs-lookup"><span data-stu-id="186bd-126">Refresh a Zone</span></span>
