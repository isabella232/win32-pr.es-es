...
## <a name="add-a-zone-ip-address"></a>Agregar una dirección IP de zona
...
## <a name="delete-a-zone-ip-address"></a>Eliminación de una dirección IP de zona
...
## <a name="pause-a-zone"></a>Poner una zona en pausa
...
## <a name="resume-a-zone"></a>Reanudar una zona
...
## <a name="update-a-zone"></a>Actualizar una zona
...
## <a name="reload-a-zone"></a>Recargar una zona
...
## <a name="refresh-a-zone"></a>Actualizar una zona
