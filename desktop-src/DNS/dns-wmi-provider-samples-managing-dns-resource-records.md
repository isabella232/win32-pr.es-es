...
---
# <a name="dns-wmi-provider-samplesmanaging-dns-resource-records"></a><span data-ttu-id="56c68-103">Ejemplos del proveedor WMI de DNS: administración de registros de recursos DNS</span><span class="sxs-lookup"><span data-stu-id="56c68-103">DNS WMI Provider Samples—Managing DNS Resource Records</span></span>

<span data-ttu-id="56c68-104">En esta sección se muestran las tareas de scripting asociadas a la administración de registros de recursos DNS.</span><span class="sxs-lookup"><span data-stu-id="56c68-104">This section demonstrates scripting tasks associated with managing DNS resource records.</span></span> <span data-ttu-id="56c68-105">Los vínculos siguientes saltan a las subrutinas del archivo de script.</span><span class="sxs-lookup"><span data-stu-id="56c68-105">The links below jump to subroutines in the script file.</span></span>

-   [<span data-ttu-id="56c68-106">Enumerar registros de recursos</span><span class="sxs-lookup"><span data-stu-id="56c68-106">List resource records</span></span>](#list-resource-records)
-   [<span data-ttu-id="56c68-107">Agregar un registro de recursos</span><span class="sxs-lookup"><span data-stu-id="56c68-107">Add a resource record</span></span>](#add-a-resource-record)
-   [<span data-ttu-id="56c68-108">Eliminar un registro de recursos</span><span class="sxs-lookup"><span data-stu-id="56c68-108">Delete a resource record</span></span>](#delete-a-resource-record)
-   [<span data-ttu-id="56c68-109">Modificar un registro de recursos</span><span class="sxs-lookup"><span data-stu-id="56c68-109">Modify a resource record</span></span>](#modify-a-resource-record)
-   [<span data-ttu-id="56c68-110">Conectar con el proveedor WMI de DNS</span><span class="sxs-lookup"><span data-stu-id="56c68-110">Connect to the DNS WMI Provider</span></span>](#connect-to-the-dns-wmi-provider)

<span data-ttu-id="56c68-111">La implementación general del script es la siguiente:</span><span class="sxs-lookup"><span data-stu-id="56c68-111">The general implementation of the script is as follows:</span></span>

1.  <span data-ttu-id="56c68-112">Se crea una clase para cada tipo de registro de recursos.</span><span class="sxs-lookup"><span data-stu-id="56c68-112">A class is created for each resource record type.</span></span>
2.  <span data-ttu-id="56c68-113">Los datos de registro de recursos se proporcionan a través de entradas de línea de comandos del usuario e información del proveedor WMI de DNS para cada clase de tipo de registro.</span><span class="sxs-lookup"><span data-stu-id="56c68-113">Resource record data is provided through user command-line inputs and DNS WMI Provider information for each record type class.</span></span>
3.  <span data-ttu-id="56c68-114">Se crean funciones comunes, como List, delete y Modify, y se pueden usar en clases de tipo de registro de recursos individuales.</span><span class="sxs-lookup"><span data-stu-id="56c68-114">Common functions such as list, delete, and modify are created and can be used on individual resource record type classes.</span></span>

<span data-ttu-id="56c68-115">En este ejemplo de código se muestran las tareas asociadas a la administración de registros de recursos DNS.</span><span class="sxs-lookup"><span data-stu-id="56c68-115">This code example shows tasks associated with Managing DNS resource records.</span></span>
...
## <a name="list-resource-records"></a><span data-ttu-id="56c68-116">Enumerar registros de recursos</span><span class="sxs-lookup"><span data-stu-id="56c68-116">List Resource Records</span></span>

<span data-ttu-id="56c68-117">En este ejemplo de código se muestran las tareas asociadas con la enumeración de registros de recursos.</span><span class="sxs-lookup"><span data-stu-id="56c68-117">This code example shows tasks associated with listing resource records.</span></span>
...
## <a name="add-a-resource-record"></a><span data-ttu-id="56c68-118">Agregar un registro de recursos</span><span class="sxs-lookup"><span data-stu-id="56c68-118">Add a Resource Record</span></span>

<span data-ttu-id="56c68-119">En este ejemplo de código se muestran las tareas asociadas con la adición de registros de recursos.</span><span class="sxs-lookup"><span data-stu-id="56c68-119">This code example shows tasks associated with adding resource records.</span></span>
...
## <a name="delete-a-resource-record"></a><span data-ttu-id="56c68-120">Eliminar un registro de recursos</span><span class="sxs-lookup"><span data-stu-id="56c68-120">Delete a Resource Record</span></span>

<span data-ttu-id="56c68-121">En este ejemplo de código se muestran las tareas asociadas a la eliminación de registros de recursos.</span><span class="sxs-lookup"><span data-stu-id="56c68-121">This code example shows tasks associated with deleting resource records.</span></span>
...
## <a name="modify-a-resource-record"></a><span data-ttu-id="56c68-122">Modificar un registro de recursos</span><span class="sxs-lookup"><span data-stu-id="56c68-122">Modify a Resource Record</span></span>

<span data-ttu-id="56c68-123">En este ejemplo de código se muestran las tareas asociadas al cambio de registros de recursos.</span><span class="sxs-lookup"><span data-stu-id="56c68-123">This code example shows tasks associated with changing resource records.</span></span>
...
## <a name="connect-to-the-dns-wmi-provider"></a><span data-ttu-id="56c68-124">Conectar con el proveedor WMI de DNS</span><span class="sxs-lookup"><span data-stu-id="56c68-124">Connect to the DNS WMI Provider</span></span>

<span data-ttu-id="56c68-125">En este ejemplo de código se muestran las tareas asociadas a la conexión a un proveedor WMI de DNS.</span><span class="sxs-lookup"><span data-stu-id="56c68-125">This code example shows tasks associated with connecting to a DNS WMI Provider.</span></span>
