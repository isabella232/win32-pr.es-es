---
title: Método CreateInstanceFromPropertyData de la MicrosoftDNS_NXTType clase
description: El método CreateInstanceFromPropertyData crea una instancia de un registro de recursos Next (NXT).
ms.assetid: d0e4f3bf-f835-4341-a614-539975e6be11
keywords:
- Dns del método CreateInstanceFromPropertyData
- Método DNS CreateInstanceFromPropertyData , MicrosoftDNS_NXTType clase
- MicrosoftDNS_NXTType clase DNS , método CreateInstanceFromPropertyData
topic_type:
- apiref
api_name:
...
ms.locfileid: "119815675"
---
# <a name="createinstancefrompropertydata-method-of-the-microsoftdns_nxttype-class"></a>Método CreateInstanceFromPropertyData de la clase NXTType de MicrosoftDNS \_

El **método CreateInstanceFromPropertyData** crea una instancia de un registro de recursos Next (NXT).
