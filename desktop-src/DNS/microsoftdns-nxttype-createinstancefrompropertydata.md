...
---
# <a name="createinstancefrompropertydata-method-of-the-microsoftdns_nxttype-class"></a>Método CreateInstanceFromPropertyData de la \_ clase MicrosoftDNS NXTType

El método **CreateInstanceFromPropertyData** crea una instancia de un siguiente registro de recursos (NXT).
