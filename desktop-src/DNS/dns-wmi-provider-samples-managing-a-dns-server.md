...
## <a name="stop-start-or-restart-a-dns-server"></a>Detener, iniciar o reiniciar un servidor DNS
...
## <a name="modify-dns-server-properties"></a>Modificar las propiedades del servidor DNS
...
## <a name="delete-an-ip-address"></a>Eliminación de una dirección IP
...
## <a name="list-zones"></a>Enumerar zonas
