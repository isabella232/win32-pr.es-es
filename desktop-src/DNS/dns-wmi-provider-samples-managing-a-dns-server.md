...
---
# <a name="dns-wmi-provider-samplesmanaging-a-dns-server"></a><span data-ttu-id="4b881-103">Ejemplos del proveedor WMI de DNS: administración de un servidor DNS</span><span class="sxs-lookup"><span data-stu-id="4b881-103">DNS WMI Provider Samples—Managing a DNS Server</span></span>

> [!NOTE]
> <span data-ttu-id="4b881-104">Este artículo contiene referencias al término esclavo, un término que Microsoft ya no usa.</span><span class="sxs-lookup"><span data-stu-id="4b881-104">This article contains references to the term slave, a term that Microsoft no longer uses.</span></span> <span data-ttu-id="4b881-105">Cuando se quite el término del software, se quitará también del artículo.</span><span class="sxs-lookup"><span data-stu-id="4b881-105">When the term is removed from the software, we’ll remove it from this article.</span></span>

<span data-ttu-id="4b881-106">En esta sección se muestran las tareas de scripting asociadas a la administración de un servidor DNS.</span><span class="sxs-lookup"><span data-stu-id="4b881-106">This section demonstrates scripting tasks associated with managing a DNS Server.</span></span> <span data-ttu-id="4b881-107">Los vínculos siguientes saltan a las subrutinas del archivo de script:</span><span class="sxs-lookup"><span data-stu-id="4b881-107">The links below jump to subroutines in the script file:</span></span>

-   [<span data-ttu-id="4b881-108">Enumerar las propiedades del servidor DNS</span><span class="sxs-lookup"><span data-stu-id="4b881-108">List DNS Server properties</span></span>](#list-dns-server-properties)
-   [<span data-ttu-id="4b881-109">Detener, iniciar o reiniciar un servidor DNS</span><span class="sxs-lookup"><span data-stu-id="4b881-109">Stop, start, or restart a DNS Server</span></span>](#stop-start-or-restart-a-dns-server)
-   [<span data-ttu-id="4b881-110">Modificar las propiedades del servidor DNS</span><span class="sxs-lookup"><span data-stu-id="4b881-110">Modify DNS Server properties</span></span>](#modify-dns-server-properties)
-   [<span data-ttu-id="4b881-111">Agregar una dirección IP</span><span class="sxs-lookup"><span data-stu-id="4b881-111">Add an IP address</span></span>](#add-an-ip-address)
-   [<span data-ttu-id="4b881-112">Eliminación de una dirección IP</span><span class="sxs-lookup"><span data-stu-id="4b881-112">Delete an IP address</span></span>](#delete-an-ip-address)
-   [<span data-ttu-id="4b881-113">Enumerar zonas</span><span class="sxs-lookup"><span data-stu-id="4b881-113">List Zones</span></span>](#list-zones)
...
## <a name="list-dns-server-properties"></a><span data-ttu-id="4b881-114">Enumerar las propiedades del servidor DNS</span><span class="sxs-lookup"><span data-stu-id="4b881-114">List DNS Server properties</span></span>
...
## <a name="stop-start-or-restart-a-dns-server"></a><span data-ttu-id="4b881-115">Detener, iniciar o reiniciar un servidor DNS</span><span class="sxs-lookup"><span data-stu-id="4b881-115">Stop, Start, or Restart a DNS Server</span></span>
...
## <a name="modify-dns-server-properties"></a><span data-ttu-id="4b881-116">Modificar las propiedades del servidor DNS</span><span class="sxs-lookup"><span data-stu-id="4b881-116">Modify DNS Server Properties</span></span>
...
## <a name="add-an-ip-address"></a><span data-ttu-id="4b881-117">Agregar una dirección IP</span><span class="sxs-lookup"><span data-stu-id="4b881-117">Add an IP Address</span></span>
...
## <a name="delete-an-ip-address"></a><span data-ttu-id="4b881-118">Eliminación de una dirección IP</span><span class="sxs-lookup"><span data-stu-id="4b881-118">Delete an IP Address</span></span>
...
## <a name="list-zones"></a><span data-ttu-id="4b881-119">Enumerar zonas</span><span class="sxs-lookup"><span data-stu-id="4b881-119">List Zones</span></span>
