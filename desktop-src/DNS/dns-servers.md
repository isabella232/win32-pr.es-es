...
Durante la preparación de la preparación para devolver los datos de resolución solicitados, los servidores DNS pueden consultar otros servidores DNS, pero más allá de eso, los servidores DNS no realizan ninguna otra operación.
