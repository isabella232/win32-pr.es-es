...
---
# <a name="modify-method-of-the-microsoftdns_nstype-class"></a>Método Modify de la \_ clase MicrosoftDNS NSType

El método **Modify** actualiza un registro de recursos de servidor de nombres (NS).
