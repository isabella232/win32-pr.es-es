---
title: Método Modify de la MicrosoftDNS_NSType clase
description: El método Modify actualiza un registro de recursos del servidor de nombres (NS).
...
- MicrosoftDNS_NSType clase DNS , Método Modify
topic_type:
- apiref
api_name:
...
ms.locfileid: "119573785"
---
# <a name="modify-method-of-the-microsoftdns_nstype-class"></a>Método Modify de la clase NSType de MicrosoftDNS \_

El **método Modify** actualiza un registro de recursos del servidor de nombres (NS).
