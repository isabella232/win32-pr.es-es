---
title: Método CreateInstanceFromPropertyData de la MicrosoftDNS_TXTType clase
description: El método CreateInstanceFromPropertyData crea una instancia de un registro de recursos text (TXT).
ms.assetid: f518bb07-e64f-4240-a7b8-9363374b83d6
keywords:
- Dns del método CreateInstanceFromPropertyData
- Método DNS CreateInstanceFromPropertyData , MicrosoftDNS_TXTType clase
- MicrosoftDNS_TXTType clase DNS , método CreateInstanceFromPropertyData
topic_type:
- apiref
api_name:
...
ms.locfileid: "119655305"
---
# <a name="createinstancefrompropertydata-method-of-the-microsoftdns_txttype-class"></a>Método CreateInstanceFromPropertyData de la clase TXTType de MicrosoftDNS \_

El **método CreateInstanceFromPropertyData** crea una instancia de un registro de recursos text (TXT).
...
[**Método Modify de la clase TXTType de MicrosoftDNS \_**](microsoftdns-txttype-modify.md)
</dt> <dt>
