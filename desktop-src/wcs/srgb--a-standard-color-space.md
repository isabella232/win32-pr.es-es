...
Como resultado de las consideraciones sobre el ancho de banda de Internet, Hewlett-Packard y Microsoft han propuesto la adopción de un espacio de [colores](c.md) predefinido estándar conocido como *sRGB* (IEC 61966-2-1), para permitir una asignación de [colores](c.md) precisa con muy poca sobrecarga de datos.
...
1.  Cree un contexto de dispositivo (DC) en el dispositivo para mostrar.
...
A partir de la versión 2.0 de ICM, las aplicaciones que usan WCS pueden insertar perfiles en imágenes. Los perfiles insertados ayudan a las aplicaciones de los usuarios a mantener una apariencia de color coherente, incluso si las imágenes se transmiten a través de Internet.
