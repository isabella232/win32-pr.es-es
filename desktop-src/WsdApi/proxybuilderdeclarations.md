...
---
# <a name="proxybuilderdeclarations-element"></a>elemento proxyBuilderDeclarations

Genera declaraciones para las funciones que crean servidores proxy con tipo.
