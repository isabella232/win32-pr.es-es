...
---
# <a name="using-the-compression-api-in-buffer-mode"></a>Uso de la API de compresión en modo de búfer

Los ejemplos siguientes muestran cómo usar la API de compresión en modo de búfer. El modo de búfer se desarrolló para facilitar su uso y divide automáticamente el búfer de entrada en bloques de un tamaño adecuado para el algoritmo de compresión seleccionado. El modo de búfer aplica formato y almacena automáticamente el tamaño de búfer sin comprimir en el búfer comprimido en el que está disponible para el descompresor. El tamaño del búfer comprimido no se guarda automáticamente y la aplicación tiene que guardarlo para la descompresión. No incluya la marca **compress \_ raw** al llamar a [**CreateCompressor**](/windows/desktop/api/compressapi/nf-compressapi-createcompressor) o [**CreateDecompressor**](/windows/desktop/api/compressapi/nf-compressapi-createdecompressor) si quiere usar la API de compresión en modo de búfer.

En la mayoría de los casos, se recomienda el modo de búfer. Para obtener más información sobre cómo usar el modo de bloqueo, consulte [uso de la API de compresión en modo de bloqueo](using-the-compression-api-in-block-mode.md) .

Las aplicaciones que usan el modo de búfer o de bloque tienen la opción de especificar una rutina de asignación de memoria personalizada al llamar a [**CreateCompressor**](/windows/desktop/api/compressapi/nf-compressapi-createcompressor) o [**CreateDecompressor**](/windows/desktop/api/compressapi/nf-compressapi-createdecompressor). Consulte la sección [uso de la API de compresión en modo de bloqueo](using-the-compression-api-in-block-mode.md) para ver un ejemplo de una rutina de asignación personalizada simple.
...
El siguiente fragmento de código muestra la descompresión de archivos mediante la API de compresión en modo de búfer.
