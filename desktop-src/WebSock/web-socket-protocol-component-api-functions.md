...
| [**WebSocketBeginServerHandshake**](/windows/desktop/api/Websocket/nf-websocket-websocketbeginserverhandshake)<br/> | inicia el protocolo de enlace del lado servidor.<br/>                                                                                                                                                                |
...
| [**WebSocketSend**](/windows/desktop/api/Websocket/nf-websocket-websocketsend)<br/>                                 | agrega una operación de envío a la cola de operaciones de componente de protocolo.<br/>                                                                                                                                 |
