...
---
# <a name="wm_devicechange-message"></a>Mensaje \_ DEVICECHANGE de WM
...
Identificador **DE \_ WM DEVICECHANGE.**
...
| **[DBT \_ DEFINIDO POR EL USUARIO](dbt-userdefined.md)**</br>0xFFFF | El significado de este mensaje es definido por el usuario. |
