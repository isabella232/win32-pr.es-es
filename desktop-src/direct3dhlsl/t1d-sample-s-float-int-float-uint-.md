---
title: Función Texture1D::Sample(S,float,int,float,uint)
description: Muestrea una textura con un valor opcional para fijar los valores de nivel de detalle (LOD) de la muestra a y devuelve el estado de la operación. | Función Texture1D::Sample(S,float,int,float,uint)
...
ms.locfileid: "126966531"
---
# <a name="texture1dsamplesfloatintfloatuint-function"></a>Función Texture1D::Sample(S,float,int,float,uint)

Muestrea una textura con un valor opcional para fijar los valores de nivel de detalle (LOD) de la muestra a y devuelve el estado de la operación.
