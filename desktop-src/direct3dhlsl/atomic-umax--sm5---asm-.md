...
description: Número entero sin signo atómico máximo en memoria.
...
ms.locfileid: "118794863"
---
# <a name="atomic_umax-sm5---asm"></a>atomic \_ umax (sm5 - asm)

Número entero sin signo atómico máximo en memoria.



| atomic \_ umax dst, dstAddress \[ .swzzle, \] src0 \[ .select \_ component\] |
|----------------------------------------------------------------------|
...
Esta instrucción realiza un único componente de 32 bits sin signo máximo de *src0* de operando en *dst* a 32 bits por dirección de componente *dstAddress,* realizado de forma atómica.
