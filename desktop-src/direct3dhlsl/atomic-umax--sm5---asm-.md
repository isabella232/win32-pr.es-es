...
---
# <a name="atomic_umax-sm5---asm"></a>\_Umax atómico (SM5-ASM)

Entero atómico sin signo máximo en la memoria.



| Atomic \_ Umax DST, dstAddress \[ . swizzle \] , src0 \[ . Select ( \_ componente)\] |
|----------------------------------------------------------------------|
...
Esta instrucción realiza un único componente de 32 bits sin signo como máximo de operando *src0* en *DST* a 32 bits por cada dirección de componente *dstAddress*, realizada de forma atómica.
