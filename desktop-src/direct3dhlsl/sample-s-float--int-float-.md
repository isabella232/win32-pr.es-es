...
---
# <a name="samplesfloatintfloat-function-hlsl-reference"></a>Función (S, Float, int, float) de ejemplo (referencia de HLSL)

Muestrea un [**Texture2D**](sm5-object-texture2d.md) con un valor opcional para Clamp valores de nivel de detalle (LOD) de ejemplo en.
...
Use un desplazamiento solo en un entero miplevel; de lo contrario, puede obtener resultados que no se traduzcan bien al hardware.
