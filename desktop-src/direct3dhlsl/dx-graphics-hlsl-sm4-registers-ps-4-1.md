...
description: Esta sección contiene información de referencia para los registros de entrada y salida implementados por la versión 4 1 del sombreador de \_ píxeles.
...
ms.locfileid: "119276545"
---
# <a name="registers---ps_4_1"></a>Registros: ps \_ 4 \_ 1

Esta sección contiene información de referencia para los registros de entrada y salida implementados por la versión 4 1 del sombreador de \_ píxeles.
