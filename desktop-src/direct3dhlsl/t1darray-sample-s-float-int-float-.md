---
title: Función Texture1DArray::Sample(S,float,int,float)
description: Muestrea una textura con un valor opcional para fijar los valores de nivel de detalle (LOD) de la muestra. | Función Texture1DArray::Sample(S,float,int,float)
...
ms.locfileid: "126966492"
---
# <a name="texture1darraysamplesfloatintfloat-function"></a>Función Texture1DArray::Sample(S,float,int,float)
