---
title: Función Texture1D::Sample(S,float,int,float)
description: Muestrea una textura con un valor opcional para fijar los valores de nivel de detalle (LOD) de la muestra. | Función Texture1D::Sample(S,float,int,float)
...
ms.locfileid: "126966532"
---
# <a name="texture1dsamplesfloatintfloat-function"></a>Función Texture1D::Sample(S,float,int,float)
