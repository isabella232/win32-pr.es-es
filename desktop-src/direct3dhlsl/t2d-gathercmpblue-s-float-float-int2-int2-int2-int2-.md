---
title: Función Texture2D::GatherCmpBlue(S,float,float,int2,int2,int2,int2)
description: Para cuatro valores de texel que se usarían en una operación de filtrado bi lineal, devuelve una comparación de su componente azul con un valor de comparación. | Función Texture2D::GatherCmpBlue(S,float,float,int2,int2,int2,int2)
...
ms.locfileid: "118285025"
---
# <a name="texture2dgathercmpbluesfloatfloatint2int2int2int2-function"></a>Función Texture2D::GatherCmpBlue(S,float,float,int2,int2,int2,int2)
