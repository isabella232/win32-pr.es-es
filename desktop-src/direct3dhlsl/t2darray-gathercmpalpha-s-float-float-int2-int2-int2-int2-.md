---
title: Función Texture2DArray::GatherCmpAlpha(S,float,float,int2,int2,int2,int2)
description: Para cuatro valores de texel que se usarían en una operación de filtrado bi lineal, devuelve una comparación de su componente alfa con un valor de comparación. | Función Texture2DArray::GatherCmpAlpha(S,float,float,int2,int2,int2,int2)
...
ms.locfileid: "118284868"
---
# <a name="texture2darraygathercmpalphasfloatfloatint2int2int2int2-function"></a>Función Texture2DArray::GatherCmpAlpha(S,float,float,int2,int2,int2,int2)
