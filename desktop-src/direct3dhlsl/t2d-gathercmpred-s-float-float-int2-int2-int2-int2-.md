---
title: Función Texture2D::GatherCmpRed(S,float,float,int2,int2,int2,int2)
description: Para cuatro valores de texel que se usarían en una operación de filtrado bi linear, devuelve una comparación de su componente rojo con un valor de comparación. | Función Texture2D::GatherCmpRed(S,float,float,int2,int2,int2,int2)
...
ms.locfileid: "118507612"
---
# <a name="texture2dgathercmpredsfloatfloatint2int2int2int2-function"></a>Función Texture2D::GatherCmpRed(S,float,float,int2,int2,int2,int2)
