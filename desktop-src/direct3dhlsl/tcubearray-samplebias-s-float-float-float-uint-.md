...
---
# <a name="samplebiassamplebiassfloatfloatfloatuint-function-for-texturecubearray"></a>Función SampleBias:: SampleBias (S, Float, Float, Float, uint) para TextureCubeArray
