...
description: Obtenga información sobre cómo esta función muestrea un objeto Texture2D mediante un valor de comparación para rechazar muestras, con un valor opcional para fijar los valores de nivel de detalle (LOD) de la muestra. Devuelve el estado de la operación.
...
Muestrea [**un objeto Texture2D**](sm5-object-texture2d.md), con un valor de comparación para rechazar muestras, con un valor opcional para fijar los valores de nivel de detalle (LOD) de la muestra. Devuelve el estado de la operación.
