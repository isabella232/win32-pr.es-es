---
title: Función Texture2DArray::GatherRed(S,float,int,uint)
description: Devuelve los componentes rojos de los cuatro valores de texel que se usarían en una operación de filtrado bi lineal, junto con el estado de asignación de mosaicos. | Función Texture2DArray::GatherRed(S,float,int,uint)
...
ms.locfileid: "119276445"
---
# <a name="texture2darraygatherredsfloatintuint-function"></a>Función Texture2DArray::GatherRed(S,float,int,uint)
