...
description: Mínimo atómico inmediato sin signo en la memoria. Devuelve el valor en memoria antes de la operación máxima.
...
ms.locfileid: "127072699"
---
# <a name="imm_atomic_umin-sm5---asm"></a>imm \_ atomic \_ umin (sm5 - asm)

Mínimo atómico inmediato sin signo en la memoria. Devuelve el valor en memoria antes de la operación máxima.



| imm \_ atomic \_ umin dst0 \[ .single component mask , \_ \_ \] dst1, dstAddress \[ .swzzle \] , src0 \[ .select \_ component\] |
|--------------------------------------------------------------------------------------------------------------|
...
Esta instrucción realiza un único componente de 32 bits sin signo mínimo de *operando src0* con *dst1* a 32 bits por dirección de componente *dstAddress*.
