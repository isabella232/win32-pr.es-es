...
Unsigned Atomic inmediata sin signo en la memoria. Devuelve el valor en memoria antes de la operación Max.



| IMM \_ Atomic \_ umin dst0 \[ . \_ \_ máscara de componente único \] , dst1, dstAddress \[ . swizzle \] , src0 \[ . Select ( \_ componente)\] |
|--------------------------------------------------------------------------------------------------------------|
...
Esta instrucción realiza un único componente de 32 bits sin signo mínimo de operando *src0* con *dst1* en 32 bits por dirección de componente *dstAddress*.
...
El valor de *dst1* Memory Before min se devuelve a *dst0*.
