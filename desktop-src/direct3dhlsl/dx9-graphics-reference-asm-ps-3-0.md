...
-   [ps \_ 3 \_ 0 Registros](dx9-graphics-reference-asm-ps-registers-ps-3-0.md) enumera los distintos tipos de registros usados por el sombreador de píxeles ALU.
...
El dispositivo admite el control de flujo dinámico ([if bool - ps](if-bool---ps.md), break - [ps](break---ps.md)y break comp [- \_ ps](break-comp---ps.md)). La profundidad del anidamiento oscila entre 0 y 24.
...
La [llamada pred - ps](call---ps.md) / [callnz](callnz-bool---ps.md)se puede  / anidar a una profundidad máxima de[ \_ ](callnz-pred---ps.md) 4. De forma independiente, [las instrucciones loop - ps](loop---ps.md)rep - / [ps](rep---ps.md) se pueden anidar a una profundidad máxima de 4.

## <a name="arbitrary-swizzle"></a>Swzzle arbitrario

Se admite swzzle arbitrario. Vea [Source Register Swlingling (Swling del registro de origen).](dx9-graphics-reference-asm-ps-registers-modifiers-source-register-swizzling.md)
...
Cada sombreador de píxeles se permite desde 512 hasta el número de ranuras en MaxPixelShader30InstructionSlots (no más de 32768). El número de instrucciones ejecutadas puede ser mucho mayor debido a la compatibilidad con bucles. MaxPShaderInstructionsExecuted debe ser al menos 2^16.
...
Si se admite ps \_ \_ 3 0, se admiten los siguientes límites en hardware (como mínimo):



| Tapa                                                                                                          | Valor                                                                                                                                                                                                                                                                                                 |
|--------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| MaxTextureWidth, MaxTextureHeight                                                                            | 4 000 cada una                                                                                                                                                                                                                                                                                               |
...
| Se establecen los siguientes límites de trama:                                                                           | D3DPRASTERCAPS \_ MIPMAPLODBIAS, D3DPRASTERCAPS \_ ANISOTROPY, D3DPRASTERCAPS \_ COLORPERSPECTIVE, D3DPRASTERCAPS LOTEST en \_ D3DCAPS9                                                                                                                                                                  |
...
| Se admiten todos los límites del sombreador de píxeles.                                                                     | DynamicFlowControlDepth = 24, NumTemps = 32, StaticFlowControlDepth = 4, NumInstructionSlots = 512. Se admiten las siguientes características: predicados, deslizarlos arbitrarios e instrucciones de degradado. No hay ningún límite de lectura dependiente ni límite en la combinación de instrucciones matemáticas y de textura. |
| Se admiten todas las operaciones de galería de símbolos. Esto incluye la galería de símbolos de dos lados.                                   | Consulte [ **D3DSTENCISTONE.**](/windows/desktop/direct3d9/d3dstencilop)                                                                                                                                                                                                                                                        |
| Tamaño de punto de compatibilidad del dispositivo por vértice                                                                         | D3DFVFCAPS \_ PSIZE en D3DCAPS9                                                                                                                                                                                                                                                                         |
...
| Si el dispositivo admite varios elementos rendertarget, se admiten los siguientes límites:                             | D3DPMISCCAPS \_ INDEPENDENTWRITEMASKS, D3DPMISCCAPS \_ MRTPOSTPIXELSHADERBLENDING                                                                                                                                                                                                                         |
| Si se \_ admite vs \_ 3 0                                                                                     | MaxUserClipPlanes en D3DCAPS9 es 6                                                                                                                                                                                                                                                                    |
