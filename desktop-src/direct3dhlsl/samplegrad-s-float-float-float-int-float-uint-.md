...
description: Muestrea un objeto Texture2D con un degradado para influir en la forma en que se calcula la ubicación de la muestra, con un valor opcional para fijar los valores de nivel de detalle (LOD) de la muestra.
...
ms.locfileid: "127573712"
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloatuint-function-for-texture2d"></a>Función SampleGrad::SampleGrad(S,float,float,float,int,float,uint) para Texture2D

Muestrea [**un objeto Texture2D**](sm5-object-texture2d.md), usando un degradado para influir en la forma en que se calcula la ubicación de la muestra, con un valor opcional para fijar los valores de nivel de detalle (LOD) de la muestra. Devuelve el estado de la operación.
