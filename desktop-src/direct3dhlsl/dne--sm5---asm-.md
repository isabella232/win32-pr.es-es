...
Comparación de igualdad de precisión de doble precisión de componentes.
...
Esta instrucción realiza la comparación de punto flotante de precisión doble (*src0* ! = *SRC1*) de cada componente y escribe el resultado en *dest*.
