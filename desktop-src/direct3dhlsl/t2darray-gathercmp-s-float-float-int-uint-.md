---
title: Función Texture2DArray::GatherCmp(S,float,float,int,uint)
description: Para cuatro valores de texel que se usarían en una operación de filtrado bi linear, devuelve su comparación con un valor de comparación junto con el estado de asignación de mosaicos. | Función Texture2DArray::GatherCmp(S,float,float,int,uint)
...
ms.locfileid: "117723860"
---
# <a name="texture2darraygathercmpsfloatfloatintuint-function"></a>Función Texture2DArray::GatherCmp(S,float,float,int,uint)
