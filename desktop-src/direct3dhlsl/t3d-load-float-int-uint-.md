...
---
# <a name="texture3dloadintintuint-function"></a>Texture3D:: Load (int, int, uint) (función)
...
El tipo de valor devuelto coincide con el tipo en la declaración del objeto [**Texture3D**](sm5-object-texture3d.md) .

## <a name="see-also"></a>Vea también

<dl> <dt>

[Cargar métodos](texture3d-load.md)
</dt> <dt>
