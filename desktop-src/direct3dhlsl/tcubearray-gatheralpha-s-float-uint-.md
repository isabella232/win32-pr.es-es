...
description: Devuelve los componentes alfa de los cuatro valores de texel que se usarían en una operación de filtrado bi lineal, junto con el estado de asignación de mosaicos. | Función TextureCubeArray::GatherAlpha(S,float,uint)
