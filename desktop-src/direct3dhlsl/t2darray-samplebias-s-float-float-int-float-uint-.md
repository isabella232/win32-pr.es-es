...
description: La función SampleBias::SampleBias(S,float,float,int,float,uint) para Texture2DArray muestrea una textura después de aplicar el valor de sesgo al nivel mipmap.
...
ms.locfileid: "127270156"
---
# <a name="samplebiassamplebiassfloatfloatintfloatuint-function-for-texture2darray"></a>Función SampleBias::SampleBias(S,float,float,int,float,uint) para Texture2DArray
