---
title: Función Texture2DArray::GatherBlue(S,float,int2,int2,int2,int2,uint)
description: Devuelve los componentes azules de los cuatro valores de texel que se usarían en una operación de filtrado bi lineal, junto con el estado de asignación de mosaicos. | Función Texture2DArray::GatherBlue(S,float,int2,int2,int2,int2,uint)
...
ms.locfileid: "119485945"
---
# <a name="texture2darraygatherbluesfloatint2int2int2int2uint-function"></a>Función Texture2DArray::GatherBlue(S,float,int2,int2,int2,int2,uint)
