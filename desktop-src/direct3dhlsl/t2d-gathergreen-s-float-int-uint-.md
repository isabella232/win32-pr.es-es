---
title: Función Texture2D::GatherGreen(S,float,int,uint)
description: Devuelve los componentes verdes de los cuatro valores de texel que se usarían en una operación de filtrado bi linear, junto con el estado de asignación de mosaicos. | Función Texture2D::GatherGreen(S,float,int,uint)
...
ms.locfileid: "126970504"
---
# <a name="texture2dgathergreensfloatintuint-function"></a>Función Texture2D::GatherGreen(S,float,int,uint)
