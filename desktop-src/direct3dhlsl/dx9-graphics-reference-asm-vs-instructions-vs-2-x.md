...
| [break- vs](break---vs.md)                                                   | Interrupción de un [bucle: frente](loop---vs.md)a ... [endloop- vs](endloop---vs.md) o [rep](rep---vs.md)... [endrep block](endrep---vs.md)                                  | 1                 |       |            | x            | x   |
...
| [breakp- vs](breakp---vs.md)                                                 | Interrupción de un [bucle: frente](loop---vs.md)a ... [endloop- vs](endloop---vs.md) o [rep](rep---vs.md)... [bloque endrep,](endrep---vs.md) basado en un predicado            | 3                 |       |            | x            | x   |
...
| [dcl \_ usage input (sm1, sm2, sm3 - vs asm)](dcl-usage-input-register---vs.md) | Declarar registros de vértices de entrada [(consulte Registros - frente \_ a 2 \_ x](dx9-graphics-reference-asm-vs-registers-vs-2-x.md))                                                        | 0                 | x     |            |              |     |
