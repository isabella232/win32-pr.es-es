...
Max (máx.) de memoria firmada inmediata. Devuelve el valor en memoria antes de la operación Max.



| IMM \_ Atomic \_ IMAX dst0 \[ . \_ \_ máscara de componente único \] , dst1, dstAddress \[ . swizzle \] , src0 \[ . Select ( \_ componente)\] |
|--------------------------------------------------------------------------------------------------------------|
...
Esta instrucción realiza un único componente de 32 bits con signo como máximo de operandos *src0* con *dst1* en 32 bits por dirección de componente *dstAddress*.
