...
description: Muestrea una textura después de aplicar el valor de sesgo al nivel de mapa mip, con un valor opcional para fijar los valores de nivel de detalle (LOD) de la muestra. | Función SampleBias::SampleBias(S,float,float,int,float,uint) para Texture1DArray
