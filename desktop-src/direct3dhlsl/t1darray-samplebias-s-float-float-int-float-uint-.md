...
---
# <a name="samplebiassamplebiassfloatfloatintfloatuint-function-for-texture1darray"></a>Función SampleBias:: SampleBias (S, Float, Float, int, Float, uint) para Texture1DArray
