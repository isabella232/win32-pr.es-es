...
Esta función calcula el derivado parcial con respecto a la coordenada x del espacio de pantalla. Para calcular el derivado parcial con respecto a la coordenada y del espacio de pantalla, utilice la función [**DDY**](dx-graphics-hlsl-ddy.md) .
