...
Redondea el valor especificado al entero más próximo. Los casos de medio ciclo se redondean a los pares más cercanos.
...
Parámetro *x* , redondeado al entero más próximo dentro de un tipo de punto flotante.
