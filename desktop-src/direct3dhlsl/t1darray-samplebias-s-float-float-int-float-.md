...
---
# <a name="samplebiassamplebiassfloatfloatintfloat-function-for-texture1darray"></a>Función SampleBias:: SampleBias (S, Float, Float, int, float) para Texture1DArray
