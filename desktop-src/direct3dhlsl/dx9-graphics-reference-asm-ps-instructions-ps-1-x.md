...
| [texm3x3spec - ps](texm3x3spec---ps.md)   | Multiplicación de fila final de una matriz de tres filas multiplicada                             | 1                 | x    | x    | x    |      |
| [texm3x3tex - ps](texm3x3tex---ps.md)     | Buscar textura mediante una matriz 3x3 multiplicada                                   | 1                 | x    | x    | x    |      |
| [texm3x3vspec - ps](texm3x3vspec---ps.md) | Búsqueda de textura mediante una matriz de 3x3 multiplicada, con vector de rayo ocular no constante | 1                 | x    | x    | x    |      |
| [texreg2ar - ps](texreg2ar---ps.md)       | Muestrear una textura mediante los componentes alfa y rojo                           | 1                 | x    | x    | x    |      |
| [gbpreg2gb - ps](texreg2gb---ps.md)       | Muestrear una textura mediante los componentes verde y azul                          | 1                 | x    | x    | x    |      |
| [gbpreg2rgb - ps](texreg2rgb---ps.md)     | Muestrear una textura mediante los componentes rojo, verde y azul                     | 1                 |      | x    | x    |      |
