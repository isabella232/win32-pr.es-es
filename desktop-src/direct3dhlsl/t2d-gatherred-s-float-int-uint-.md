---
title: Función Texture2D::GatherRed(S,float,int,uint)
description: Devuelve los componentes rojos de los cuatro valores de texel que se usarían en una operación de filtrado bi lineal, junto con el estado de asignación de mosaicos. | Función Texture2D::GatherRed(S,float,int,uint)
...
ms.locfileid: "117723948"
---
# <a name="texture2dgatherredsfloatintuint-function"></a>Función Texture2D::GatherRed(S,float,int,uint)
