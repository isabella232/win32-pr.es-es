...
| [dcl \_ samplerType (sm2, sm3 - ps asm)](dcl-samplertype---ps.md) | Declaración de la dimensión de textura para un muestreador                                                      | 0                 | x     |            |         | x   |
...
| [ld- ps \_ 2 \_ 0 y up](texld---ps-2-0.md)                    | Muestrear una textura                                                                                 | 1                 |       |            | x       | x   |
| [texldb - ps](texldb---ps.md)                                   | Muestreo de textura con sesgo de nivel de detalle de w-component                                      | 1                 |       |            | x       | x   |
| [texldp- ps](texldp---ps.md)                                   | Muestreo de textura con división projective por w-component                                           | 1                 |       |            | x       | x   |
