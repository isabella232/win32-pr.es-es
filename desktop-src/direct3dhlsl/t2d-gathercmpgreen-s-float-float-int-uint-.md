---
title: Función Texture2D::GatherCmpGreen(S,float,float,int,uint)
description: Para cuatro valores de texel que se usarían en una operación de filtrado bi linear, devuelve una comparación de su componente verde con un valor de comparación junto con el estado de asignación de mosaicos. | Función Texture2D::GatherCmpGreen(S,float,float,int,uint)
...
ms.locfileid: "119743475"
---
# <a name="texture2dgathercmpgreensfloatfloatintuint-function"></a>Función Texture2D::GatherCmpGreen(S,float,float,int,uint)
