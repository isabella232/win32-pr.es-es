...
description: Esta función muestrea una textura después de aplicar el valor de sesgo al nivel mipmap y tiene un valor opcional para fijar los valores de nivel de detalle (LOD) de la muestra.
