...
description: Obtenga información sobre cómo esta función muestrea una textura solo en el nivel 0 del mapa mip y compara el resultado con un valor de comparación. Para Texture1DArray.
