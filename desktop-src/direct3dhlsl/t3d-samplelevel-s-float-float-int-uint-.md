...
description: Muestrea una textura en el nivel de mapa mip especificado y devuelve el estado de la operación. Para Texture3D. | Función SampleLevel::SampleLevel(S,float,float,int,uint)
...
ms.locfileid: "119043463"
---
# <a name="samplelevelsamplelevelsfloatfloatintuint-function-for-texture3d"></a>Función SampleLevel::SampleLevel(S,float,float,int,uint) para Texture3D
