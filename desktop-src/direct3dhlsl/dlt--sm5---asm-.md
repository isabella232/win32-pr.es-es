...
Comparación de tipo "menor que" de precisión doble para componentes.
...
Las máscaras de *destino* válidas son uno o dos componentes. Es decir:. x,. y,. z,. w,. XY,. XZ,. XW,. YZ,. YW,. ZW el primer componente *dest* de la máscara recibe el resultado de 32 bits para la primera comparación Double. El segundo componente de la máscara (si existe) recibe el resultado de 32 bits para la segunda comparación Double.
