...
description: Muestrea un objeto Texture2D en el nivel de mapa mip especificado y devuelve el estado de la operación.
...
ms.locfileid: "127573693"
---
# <a name="samplelevelsamplelevelsfloatfloatintuint-function-for-texture2d"></a>Función SampleLevel::SampleLevel(S,float,float,int,uint) para Texture2D

Muestrea [**un objeto Texture2D**](sm5-object-texture2d.md) en el nivel de mapa mip especificado y devuelve el estado de la operación.
...
[Métodos SampleLevel](texture2d-samplelevel.md)
</dt> </dl>
