...
Mínimo de memoria con firma atómica. Devuelve el valor en memoria antes de la operación Max.



| IMM \_ Atomic \_ Imin dst0 \[ . \_ \_ máscara de componente único \] , dst1, dstAddress \[ . swizzle \] , src0 \[ . Select ( \_ componente)\] |
|--------------------------------------------------------------------------------------------------------------|
...
Esta instruccióni realiza un único componente de 32 bits con signo como mínimo del operando *src0* con *dst1* en 32 bits por dirección de componente *dstAddress*.
