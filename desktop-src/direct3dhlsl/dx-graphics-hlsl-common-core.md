...
-   **Texturas:** las texturas se pueden filtrar mediante muestreadores o leerse por texel directamente con la [función intrínseca](dx-graphics-hlsl-to-load.md) de carga.
-   **Búferes:** los búferes nunca se filtran, pero se pueden leer de la memoria por elemento directamente con la [función intrínseca](dx-graphics-hlsl-to-load.md) de carga. Se pueden enlazar hasta 128 recursos de textura y búfer (combinados) a un sombreador simultáneamente.
...
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Diferencias entre Direct3D 9 y Direct3D 10:<br/> En Direct3D 9, las entradas de flujo marcadas como enteros en HLSL se interpretaron como de punto flotante. En Direct3D 10, las entradas de secuencia marcadas como enteros se interpretan como un entero de 32 bits.<br/> Además, los valores booleanos ahora son todos los bits establecidos o todos los bits sin establecer. Los datos convertidos a **bool** se interpretarán como true si el valor no es igual a 0,0f (se permite que los ceros positivos y negativos sean false) y false en caso contrario.<br/> |
