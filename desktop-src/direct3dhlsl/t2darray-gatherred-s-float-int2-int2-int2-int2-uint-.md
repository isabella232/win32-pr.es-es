---
title: Función Texture2DArray::GatherRed(S,float,int2,int2,int2,int2,uint)
description: Devuelve los componentes rojos de los cuatro valores de texel que se usarían en una operación de filtrado bi lineal, junto con el estado de asignación de mosaicos. | Función Texture2DArray::GatherRed(S,float,int2,int2,int2,int2,uint)
...
ms.locfileid: "118788453"
---
# <a name="texture2darraygatherredsfloatint2int2int2int2uint-function"></a>Función Texture2DArray::GatherRed(S,float,int2,int2,int2,int2,uint)
