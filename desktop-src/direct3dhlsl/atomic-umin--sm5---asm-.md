...
Entero sin signo atómico mínimo a la memoria.



| Atomic \_ umin DST, dstAddress \[ . swizzle \] , src0 \[ . Select ( \_ componente)\] |
|----------------------------------------------------------------------|
...
Esta instrucción realiza un único componente de 32 bits sin signo, como mínimo, de operando *src0* en *DST* a 32 bits por cada dirección de componente *dstAddress*, realizada de forma atómica.
