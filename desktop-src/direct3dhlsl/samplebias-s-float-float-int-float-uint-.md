...
---
# <a name="samplebiassamplebiassfloatfloatintfloatuint-function-for-texture2d"></a>Función SampleBias:: SampleBias (S, Float, Float, int, Float, uint) para Texture2D

Muestrea un [**Texture2D**](sm5-object-texture2d.md), después de aplicar el valor de diferencia al nivel de mipmap, con un valor opcional para Clamp valores de nivel de detalle (LOD) de ejemplo en. Devuelve el estado de la operación.
