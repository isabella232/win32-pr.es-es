...
description: Muestrea solo una textura en el nivel 0 de mapa mip, compara el resultado con un valor de comparación y, a continuación, devuelve el estado de la operación. Para Texture2DArray.
