...
description: XOR bit a bit inmediato a la memoria. Devuelve el valor en memoria antes del XOR.
ms.assetid: 310037F6-F048-4DE1-9A5C-76C919D9E68B
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: c2fde3259cbcda704018c8f1f9dcb7313f57026f5dbbda542984caa61a5a40e1
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 08/11/2021
ms.locfileid: "117907172"
---
# <a name="imm_atomic_xor-sm5---asm"></a>imm \_ atomic \_ xor (sm5 - asm)

XOR bit a bit inmediato a la memoria. Devuelve el valor en memoria antes del XOR.
...
El direccionamiento fuera de límites en u hace que no se escriba nada en la memoria, excepto si la u está estructurada y el desplazamiento de bytes en la estructura (segundo componente de la dirección) está causando el acceso fuera de límites, todo el contenido del UAV se queda sin \# \# definir.
