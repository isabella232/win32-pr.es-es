...
description: Muestrea una textura mediante un degradado para influir en la forma en que se calcula la ubicación de la muestra, con un valor opcional para fijar los valores de nivel de detalle (LOD) de la muestra. Para Texture1DArray.
...
ms.locfileid: "126966467"
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloat-function-for-texture1darray"></a>Función SampleGrad::SampleGrad(S,float,float,float,int,float) para Texture1DArray
...
[Métodos SampleGrad](texture1darray-samplegrad.md)
</dt> </dl>
