...
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/>                                                | \[en \] El valor que se escribe en *dst1* en *dstAddress*.<br/>                                                                   |
...
Esta instrucción realiza una escritura de valor de 32 bits de un solo componente de *operando src0* en *dst1* a 32 bits por dirección de componente *dstAddress*.
