...
description: Obtenga información sobre cómo esta función muestrea una textura mediante un degradado para influir en la forma en que se calcula la ubicación de la muestra. Para TextureCubeArray.
