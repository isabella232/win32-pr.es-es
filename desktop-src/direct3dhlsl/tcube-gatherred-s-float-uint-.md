---
title: Función TextureCube::GatherRed(S,float,uint)
description: Devuelve los componentes rojos de los cuatro valores de texel que se usarían en una operación de filtrado bi lineal, junto con el estado de asignación de mosaicos. | Función TextureCube::GatherRed(S,float,uint)
...
ms.locfileid: "117723428"
---
# <a name="texturecubegatherredsfloatuint-function"></a>Función TextureCube::GatherRed(S,float,uint)
...
[Métodos GatherRed](texturecube-gatherred.md)
</dt> <dt>
