---
title: ne (sm4 - asm)
description: Comparación de punto flotante vectorial por componente no igual.
...
Comparación de punto flotante vectorial por componente no igual.



| ne dest \[ .mask \] , \[ - \] src0 \[ \_ abs \] \[ .swzzle \] , \[ - \] src1 abs \[ \_ \] \[ .sw swzzle\] |
|----------------------------------------------------------------------------------|
