...
De los doce registros de salida, diez (no necesariamente de o0 a o9) tienen cuatro componentes (xyzw), otro debe declararse como posición (y también debe incluir los cuatro componentes) y, opcionalmente, uno más puede ser un tamaño de punto escalar.
...
-   La semántica de dcl \_ puede usar el mismo conjunto de semántica que para la declaración de entrada. Los nombres semánticos proceden de [**D3DDECLUSAGE**](/windows/desktop/direct3d9/d3ddeclusage) (y se emparejan con un índice, como position3). Siempre debe haber un registro de salida con la semántica positiont0 cuando no se usa para procesar vértices. La semántica positiont0 y la semántica pointsize0 son las únicas que tienen significado más allá de simplemente permitir la vinculación de los sombreadores de vértices a píxeles. En el caso de los sombreadores con control de flujo, se supone que se declara la peor salida en el caso. No hay valores predeterminados si un sombreador no genera realmente lo que declara que debe (debido al control de flujo).
