---
title: Función Texture3D::Sample(S,float,int,float)
description: Muestrea una textura con un valor opcional para fijar los valores de nivel de detalle (LOD) de la muestra. | Función Texture3D::Sample(S,float,int,float)
