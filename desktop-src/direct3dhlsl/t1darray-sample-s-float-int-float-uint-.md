---
title: Función Texture1DArray::Sample(S,float,int,float,uint)
description: Muestrea una textura con un valor opcional para fijar los valores de nivel de detalle (LOD) de la muestra y devuelve el estado de la operación. | Función Texture1DArray::Sample(S,float,int,float,uint)
...
ms.locfileid: "117724093"
---
# <a name="texture1darraysamplesfloatintfloatuint-function"></a>Función Texture1DArray::Sample(S,float,int,float,uint)
