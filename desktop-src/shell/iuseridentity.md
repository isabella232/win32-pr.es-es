...
| Método                                                         | Descripción                                                                                      |
|:---------------------------------------------------------------|:-------------------------------------------------------------------------------------------------|
| [**GetCookie**](iuseridentity-getcookie.md)                   | En desuso. Obtiene la cookie utilizada para identificar de forma única esta identidad de usuario.<br/>             |
...
Esta interfaz proporciona información que corresponde a una identidad de usuario específica presente en el sistema. Puede acceder a la carpeta de identidad de esta identidad de usuario, su clave del Registro y su cookie de identificación, así como recuperar el nombre asociado a la identidad del usuario.
