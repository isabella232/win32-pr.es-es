---
description: Muestra el cuadro de diálogo Ejecutar al usuario.
...
Este método se implementa y se accede a través del [**método Shell.FileRun.**](shell-filerun.md)
