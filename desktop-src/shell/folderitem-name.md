...
---
# <a name="folderitemname-property"></a>Propiedad FolderItem.Name
...
En el ejemplo siguiente se usa **Name** para recuperar el nombre del archivo de Autoexec.bat y, a continuación, restablecer el nombre a Test.bat. Se muestra el uso correcto de JScript, VBScript y Visual Basic.
