...
En el ejemplo siguiente se **usa Item** para recuperar los primeros verbos de la colección disponibles para la carpeta Panel de control y muestra su nombre. Se muestra el uso adecuado para JScript, VBScript y Visual Basic.
