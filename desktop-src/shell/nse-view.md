...
Las extensiones se implementan de la misma manera para las vistas con raíz que para las vistas normales. La única diferencia está en la forma en que el contenido de la extensión se muestra en Windows Explorer. Incluso es posible tener vistas normales y con raíz de la misma extensión.
