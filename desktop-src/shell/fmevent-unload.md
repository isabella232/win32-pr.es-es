...
Los *valores hwnd* **y hMenu** pasados con los mensajes [**\_ FMEVENT LOAD**](fmevent-load.md) y [**FMEVENT \_ INITMENU**](fmevent-initmenu.md) pueden no ser válidos en el momento en que se envía este mensaje.
