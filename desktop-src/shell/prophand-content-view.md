...
title: Vista de contenido por tipo o tipo de archivo
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "117858718"
---
# <a name="content-view-by-file-type-or-kind"></a>Vista de contenido por tipo o tipo de archivo
...
En Windows 7 y versiones posteriores, la vista Contenido usa una lógica de tamaño que quita las propiedades cuando disminuye el tamaño de la ventana, para asegurarse de que las propiedades más críticas todavía tienen espacio para ser claramente legibles. En la siguiente captura de pantalla se muestra la vista Contenido de los resultados de búsqueda que contienen música, imágenes y documentos.
