...
---
# <a name="folderitemverbscount-property"></a>FolderItemVerbs. Count (propiedad)
...
**Entero** que recibe la propiedad de **recuento** .

## <a name="examples"></a>Ejemplos

En el ejemplo siguiente se usa **Count** para recuperar el recuento de verbos disponibles para la carpeta del panel de control. Se muestra el uso correcto de JScript, VBScript y Visual Basic.
