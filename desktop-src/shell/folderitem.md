...
| [**IsBrowsable**](folderitem-isbrowsable.md)<br/>   | Solo lectura<br/>  | Indica si el elemento se puede hospedar dentro de un explorador o Explorador de Windows marco.<br/>                                                                                                                         |
