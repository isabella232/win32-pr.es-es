...
---
# <a name="ishelldispatchsettime-method"></a>IShellDispatch. SetTime, método
...
Este método se implementa y se obtiene acceso a él a través del método [**Shell. setTime**](shell-settime.md) .

## <a name="examples"></a>Ejemplos

En los siguientes ejemplos se muestra el uso de **setTime** en JScript, VBScript y Visual Basic.
