---
description: Cuando shell detecta la inserción de nuevos medios o los datos adjuntos de un dispositivo de conexión en caliente, se determina el contenido del dispositivo o del medio. La reproducción automática, en función de su configuración actual, realiza una de las siguientes acciones.
...
ms.locfileid: "122481491"
---
# <a name="using-and-configuring-autoplay"></a>Uso y configuración de la reproducción automática

Cuando shell detecta la inserción de nuevos medios o los datos adjuntos de un dispositivo de conexión en caliente, se determina el contenido del dispositivo o del medio. La reproducción automática, en función de su configuración actual, realiza una de las siguientes acciones.
...
-   [Preparar hardware y software para su uso con reproducción automática](#preparing-hardware-and-software-for-use-with-autoplay)
-   [Cómo la reproducción automática busca en medios](#how-autoplay-searches-media)
...
-   [Reproducción automática de interfaces de usuario](#autoplay-user-interfaces)
    -   [Tipo de contenido único (cuadro de diálogo)](#single-content-type-dialog-box)
    -   [Cuadro de diálogo Medios mixtos](#mixed-media-dialog-box)
    -   [Página de propiedades](#property-page)

## <a name="preparing-hardware-and-software-for-use-with-autoplay"></a>Preparar hardware y software para su uso con reproducción automática
...
-   [Cómo especificar un icono, etiqueta o controlador de dispositivos para un dispositivo mediante una clase de dispositivo](how-to-specify-an-icon--label--or-device-handler-for-a-device-using-a-device-class.md)
...
## <a name="how-autoplay-searches-media"></a>Cómo la reproducción automática busca en medios

Reproducción automática busca medios cuatro niveles de directorio por debajo del directorio raíz para buscar tipos de archivo conocidos. Usa el valor PerceivedType asociado a una extensión de nombre de archivo en el Registro para determinar la categoría de archivo, ya sea una imagen, un archivo de audio o un archivo de vídeo. Con esta información, Reproducción automática inicia el controlador adecuado para ese tipo de dispositivo y archivo. Para obtener más información, vea [Tipos percibidos y Registro de aplicaciones.](fa-perceivedtypes.md)
...
1.  El usuario adjunta un dispositivo de lector SanDisk CompactFlash USB que ya tiene un medio insertado que contiene el tipo de contenido de imagen 100 por cien en forma de archivos .jpg archivos.
2.  La notificación muestra **Found New Hardware - SanDisk ImageMate**.
3.  Reproducción automática inicia la aplicación de imagen adecuada.

Del mismo modo, cuando el usuario inserta ese mismo medio CompactFlash en el lector cuando el lector ya está conectado al sistema, el evento de inserción multimedia también hace que La reproducción automática inicie la aplicación de presentación de diapositivas de imagen. El usuario tiene la opción de ir a la página Propiedades del dispositivo multimedia SanDisk para cambiar el valor predeterminado a otra aplicación de Reproducción automática registrada, como el Asistente para escáner y cámara o Imagen.
...
1.  El usuario adjunta un reproductor USB Diamond Rio MP3.
...
Para que AutoPlay lo ofreca como opción de controlador, las aplicaciones recién instaladas deben registrarse en el registro. Para obtener más información, vea Preparing Hardware and Software for Use with AutoPlay (Preparar [hardware y software para su uso con Reproducción automática).](#preparing-hardware-and-software-for-use-with-autoplay)

Los usuarios siempre pueden cambiar el controlador de reproducción automática predeterminado para cualquier tipo de contenido o dispositivo de almacenamiento. Se puede acceder a la página de propiedades Reproducción automática para su cambio en la hoja de propiedades del dispositivo de almacenamiento **Mi PC**.
