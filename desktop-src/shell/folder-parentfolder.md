...
Contiene el objeto de [**carpeta**](folder.md) principal.
...
Una referencia de objeto al objeto ParentFolder.
...
En el ejemplo siguiente se muestra el uso correcto de **ParentFolder** para JScript, VBScript y Visual Basic.
