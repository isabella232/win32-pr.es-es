...
ms.locfileid: "117857047"
---
# <a name="user-environment-variables"></a>Variables de entorno de usuario

Las variables de entorno especifican rutas de búsqueda para archivos, directorios para archivos temporales, opciones específicas de la aplicación y otra información similar. El sistema mantiene un bloque de entorno para cada usuario y uno para el equipo. El bloque de entorno del sistema representa variables de entorno para todos los usuarios del equipo en particular. El bloque de entorno de un usuario representa las variables de entorno que el sistema mantiene para ese usuario concreto, incluido el conjunto de variables de entorno del sistema.
