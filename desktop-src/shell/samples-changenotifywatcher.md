---
description: Muestra cómo escuchar las notificaciones de cambio de Shell en una carpeta o elemento del espacio de nombres Windows Explorer.
...
ms.locfileid: "118049038"
---
# <a name="change-notify-watcher-sample"></a>Ejemplo de cambio del monitor de notificaciones

Muestra cómo escuchar las notificaciones de cambio de Shell en una carpeta o elemento del espacio de nombres Windows Explorer.
...
3.  Para mostrar el efecto, los id. de modelo de usuario de la aplicación (AppUserModelIDs) seleccionan una carpeta para verla haciendo clic en **"Seleccionar..."** o mediante el uso de arrastrar y colocar en una carpeta desde una ventana del Explorador de Windows en la vista de lista del ejemplo.
