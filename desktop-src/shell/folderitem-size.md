...
En el ejemplo siguiente se **usa Size** para recuperar el tamaño del archivo Bloc de notas ejecutable. Se muestra el uso adecuado para JScript, VBScript y Visual Basic.
