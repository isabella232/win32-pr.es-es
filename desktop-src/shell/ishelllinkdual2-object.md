...
El **objeto IShellLinkDual2** tiene estas propiedades.



| Propiedad.                                            | Tipo de acceso          | Descripción                                   |
|:----------------------------------------------------|:---------------------|:----------------------------------------------|
| [**Destino**](ishelllinkdual2-target.md)<br/> | Solo lectura<br/> | Contiene el destino del objeto de vínculo.<br/> |
