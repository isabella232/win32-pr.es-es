...
---
# <a name="wds-transport-management-interfaces"></a>Interfaces de administración de transporte de WDS

La administración de transporte de servicios de implementación de Windows (WDS) utiliza las siguientes interfaces:
...
Los siguientes están disponibles a partir de Windows 8 y Windows Server 2012.
