...
keywords:
- STN_ENABLE de notificación Windows controles
topic_type:
- apiref
api_name:
- STN_ENABLE
...
ms.locfileid: "127166978"
---
# <a name="stn_enable-notification-code"></a>Código de notificación DE STN \_ ENABLE

El código de notificación ENABLE de STN \_ se envía cuando se habilita un control estático. El control estático debe tener el [**estilo \_ NOTIFY de SS**](static-control-styles.md) para recibir este código de notificación. La ventana primaria del control recibe este código de notificación a través del [**mensaje \_ WM COMMAND.**](/windows/desktop/menurc/wm-command)
