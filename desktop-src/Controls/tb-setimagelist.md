...
[Versión 5.80.](common-control-versions.md) Índice de la lista. Si usa solo una lista de imágenes o una versión anterior de los controles comunes, establezca *wParam* en cero. Consulte Comentarios para obtener más información sobre el uso de varias listas de imágenes.
...
Devuelve el identificador de la lista de imágenes usada anteriormente para mostrar los botones en su estado predeterminado, o **NULL** si no se estableció previamente ninguna lista de imágenes.
...
El **mensaje \_ SETIMAGELIST de TB** no se puede combinar con TB [**\_ ADDBITMAP.**](tb-addbitmap.md) Tampoco se puede usar con barras de herramientas creadas [**con CreateToolbarEx**](/windows/desktop/api/Commctrl/nf-commctrl-createtoolbarex), que llama **internamente a \_ TB ADDBITMAP.** Al crear una barra de herramientas **con CreateToolbarEx** o usar **TB \_ ADDBITMAP para** agregar imágenes, la barra de herramientas administra internamente la lista de imágenes. Intentar modificarlo con **TB \_ SETIMAGELIST** tiene consecuencias imprevisibles.
...
1.  Habilite varias listas de imágenes mediante el envío del control de la barra de herramientas un mensaje [**\_ SETVERSION**](ccm-setversion.md) de CCM con *wParam* (el número de versión) establecido en 5.
...
Por último, los botones se agregan al control de barra de herramientas con un [**\_ mensaje ADDBUTTONS de TB.**](tb-addbuttons.md)
