...
---
# <a name="pgm_getbkcolor-message"></a>\_Mensaje GETBKCOLOR PGM

Recupera el color de fondo actual del control de paginación. Puede enviar este mensaje explícitamente o utilizar la macro [**\_ GetBkColor de buscapersonas**](/windows/desktop/api/Commctrl/nf-commctrl-pager_getbkcolor) .
...
Devuelve un valor de **COLORREF** que contiene el color de fondo actual.
