...
La siguiente captura de pantalla muestra un control de edición enriquecido con barras de desplazamiento verticales y horizontales, como pueden aparecer en Windows Vista. La barra de desplazamiento vertical está actualmente "activa" porque el puntero del mouse estaba sobre ella cuando se tomó la captura de pantalla.
