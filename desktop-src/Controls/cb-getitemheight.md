...
description: Determina el alto de los elementos de lista o el campo de selección de un cuadro combinado.
...
ms.locfileid: "120089195"
---
# <a name="cb_getitemheight-message"></a>Mensaje \_ GETITEMHEIGHT de CB

Determina el alto de los elementos de lista o el campo de selección de un cuadro combinado.
