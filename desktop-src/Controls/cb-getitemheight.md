...
---
# <a name="cb_getitemheight-message"></a>\_Mensaje GETITEMHEIGHT CB
...
El valor devuelto es el alto, en píxeles, de los elementos de lista de un cuadro combinado. Si el cuadro combinado tiene el estilo [**CBS \_ OWNERDRAWVARIABLE**](combo-box-styles.md) , es el alto del elemento especificado por el parámetro *wParam* . Si *wParam* es-1, el valor devuelto es el alto de la parte del control de edición (o texto estático) del cuadro combinado. Si se produce un error, el valor devuelto es CB \_ error.
