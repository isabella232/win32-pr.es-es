...
En las ilustraciones se muestran las partes siguientes:
...
| Content                | Texto adicional.                                                                                                                                                                                                                                                                                                                                                                          | **pszContent**                                             |
...
| Casilla de verificación | Casilla de verificación, acompañada de texto definido por la aplicación, para opciones sencillas como "No volver a mostrar este cuadro de diálogo".                                                                                                                                                                                                                                                                     | **pszVerificationText**                                    |
