...
---
# <a name="bn_unhilite-notification-code"></a>Código de notificación de UNHILITE de BN \_
...
BN \_ UNHILITE es el mismo que el código de notificación [BN \_ uninserted](bn-unpushed.md) .
