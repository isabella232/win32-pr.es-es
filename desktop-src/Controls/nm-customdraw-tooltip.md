...
---
# <a name="nm_customdraw-tooltip-notification-code"></a>Código de notificación de NM \_ CUSTOMDRAW (ToolTip)

Lo envía un control ToolTip para notificar a su ventana primaria sobre las operaciones de dibujo. Este código de notificación se envía en forma de mensaje [**de \_ notificación de WM**](wm-notify.md) .
