...
---
# <a name="psn_wiznext-notification-code"></a>Código de notificación de WIZNEXT de PSN \_

Notifica a una página que el usuario ha haga clic en el botón **siguiente** en un asistente. Este código de notificación se envía en forma de mensaje [**de \_ notificación de WM**](wm-notify.md) .
