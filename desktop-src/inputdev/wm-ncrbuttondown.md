---
title: WM_NCRBUTTONDOWN mensaje (Winuser.h)
description: Se publica cuando el usuario presiona el botón derecho del mouse mientras el cursor está dentro del área no cliente de una ventana. Este mensaje se publica en la ventana que contiene el cursor. Si una ventana ha capturado el mouse, este mensaje no se publica.
ms.assetid: e75e6a65-afca-42c3-ac8b-f665c7534f2d
keywords:
- WM_NCRBUTTONDOWN entrada de teclado y mouse
topic_type:
- apiref
api_name:
- WM_NCRBUTTONDOWN
