...
---
# <a name="wm_lbuttonup-message"></a>Mensaje de LBUTTONUP de WM \_

Se envía cuando el usuario suelta el botón primario del mouse mientras el cursor está en el área de cliente de una ventana. Si no se captura el mouse, el mensaje se envía a la ventana debajo del cursor. De lo contrario, el mensaje se envía a la ventana que ha capturado el mouse.
