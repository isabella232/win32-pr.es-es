---
title: WM_MBUTTONDBLCLK mensaje (Winuser.h)
description: Se publica cuando el usuario hace doble clic en el botón central del mouse mientras el cursor está en el área cliente de una ventana.
ms.assetid: 97167941-93bc-4b83-adff-8ca7a3b2591e
keywords:
- WM_MBUTTONDBLCLK entrada de teclado y mouse
topic_type:
- apiref
api_name:
- WM_MBUTTONDBLCLK
...
ms.locfileid: "119451685"
---
# <a name="wm_mbuttondblclk-message"></a>Mensaje \_ MBUTTONDBLCLK de WM

Se publica cuando el usuario hace doble clic en el botón central del mouse mientras el cursor está en el área cliente de una ventana. Si no se captura el mouse, el mensaje se publica en la ventana debajo del cursor. De lo contrario, el mensaje se publica en la ventana que ha capturado el mouse.
...
Solo las ventanas que tienen el estilo **\_ DBLCLKS** de CS pueden recibir mensajes **WM \_ MBUTTONDBLCLK,** que el sistema genera cuando el usuario presiona, suelta y vuelve a presionar el botón central del mouse dentro del límite de tiempo de doble clic del sistema. Al hacer doble clic en el botón central del mouse, se generan cuatro mensajes: [**WM \_ MBUTTONDOWN,**](wm-mbuttondown.md) [**WM \_ MBUTTONUP,**](wm-mbuttonup.md) **WM \_ MBUTTONDBLCLK** y **WM \_ MBUTTONUP** de nuevo.
