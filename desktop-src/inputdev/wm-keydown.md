...
description: Se publica en la ventana con el foco del teclado cuando se presiona una tecla no del sistema. Una clave no del sistema es una tecla que se presiona cuando no se presiona la tecla ALT.
