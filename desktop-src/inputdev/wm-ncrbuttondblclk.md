---
title: WM_NCRBUTTONDBLCLK mensaje (Winuser.h)
description: Se publica cuando el usuario hace doble clic en el botón derecho del mouse mientras el cursor está dentro del área no cliente de una ventana. Este mensaje se publica en la ventana que contiene el cursor. Si una ventana ha capturado el mouse, este mensaje no se publica.
ms.assetid: 20d62b05-07de-49da-b160-29fa1f5067fa
keywords:
- WM_NCRBUTTONDBLCLK entrada de teclado y mouse
topic_type:
- apiref
api_name:
- WM_NCRBUTTONDBLCLK
...
Se publica cuando el usuario hace doble clic en el botón derecho del mouse mientras el cursor está dentro del área no cliente de una ventana. Este mensaje se publica en la ventana que contiene el cursor. Si una ventana ha capturado el mouse, este mensaje no se publica.
...
El sistema genera un mensaje **\_ WM NCRBUTTONDBLCLK** cuando el usuario presiona, suelta y vuelve a presionar el botón derecho del mouse dentro del límite de tiempo de doble clic del sistema. Al hacer doble clic en el botón derecho del mouse, se generan cuatro mensajes: [**WM \_ NCRBUTTONDOWN,**](wm-ncrbuttondown.md) [**WM \_ NCRBUTTONUP,**](wm-ncrbuttonup.md) **WM \_ NCRBUTTONDBLCLK y** WM **\_ NCRBUTTONUP** de nuevo.
