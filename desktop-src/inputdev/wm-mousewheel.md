...
ms.locfileid: "127361208"
---
# <a name="wm_mousewheel-message"></a>Mensaje \_ DE WM MOUSEWHEEL
...
La palabra de orden alto indica la distancia a la que gira la rueda, expresada en múltiplos o divisiones de **WHEEL \_ DELTA,** que es 120. Un valor positivo indica que la rueda se ha girado hacia delante, lejos del usuario; Un valor negativo indica que la rueda se ha girado hacia atrás, hacia el usuario.
