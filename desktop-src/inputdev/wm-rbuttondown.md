...
---
# <a name="wm_rbuttondown-message"></a>Mensaje de RBUTTONDOWN de WM \_

Se envía cuando el usuario presiona el botón secundario del mouse mientras el cursor está en el área de cliente de una ventana. Si no se captura el mouse, el mensaje se envía a la ventana debajo del cursor. De lo contrario, el mensaje se envía a la ventana que ha capturado el mouse.
