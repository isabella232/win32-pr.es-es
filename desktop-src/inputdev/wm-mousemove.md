...
---
# <a name="wm_mousemove-message"></a>Mensaje de la MOUSEMOVE de WM \_

Se envía a una ventana cuando el cursor se mueve. Si no se captura el mouse, el mensaje se envía a la ventana que contiene el cursor. De lo contrario, el mensaje se envía a la ventana que ha capturado el mouse.
