...
Las siguientes funciones se usan con las canalizaciones con nombre.



| Función                                                                 | Descripción                                                                                                                                                                                                                         |
|--------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**CallNamedPipe**](/windows/desktop/api/Winbase/nf-winbase-callnamedpipea)                                   | Se conecta a una canalización de tipo de mensaje, escribe en y Lee de la canalización y, a continuación, cierra la canalización.                                                                                                                                       |
...
| [**GetNamedPipeClientSessionId**](/windows/desktop/api/Winbase/nf-winbase-getnamedpipeclientsessionid)       | Recupera el identificador de la sesión de cliente para la canalización con nombre especificada.                                                                                                                                                               |
...
| [**GetNamedPipeServerSessionId**](/windows/desktop/api/Winbase/nf-winbase-getnamedpipeserversessionid)       | Recupera el identificador de la sesión de servidor para la canalización con nombre especificada.                                                                                                                                                               |
...
| [**PeekNamedPipe**](/windows/win32/api/namedpipeapi/nf-namedpipeapi-peeknamedpipe)                                   | Copia datos de una canalización anónima o con nombre en un búfer sin quitarlo de la canalización.                                                                                                                                         |
...
| [**WaitNamedPipe**](/windows/desktop/api/Winbase/nf-winbase-waitnamedpipea)                                   | Espera hasta que transcurre un intervalo de tiempo de espera o cuando una instancia de la canalización con nombre especificada está disponible para una conexión.                                                                                                            |
