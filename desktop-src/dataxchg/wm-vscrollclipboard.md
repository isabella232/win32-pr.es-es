...
description: Se envía al propietario del Portapapeles mediante una ventana del visor del Portapapeles cuando el portapapeles contiene datos en el formato CF OWNERDISPLAY y se produce un evento en la barra de desplazamiento vertical del visor \_ del Portapapeles.
ms.assetid: 17bd32c4-1b07-42b7-b269-f517e3ec13f3
keywords:
- WM_VSCROLLCLIPBOARD mensaje Datos Exchange
topic_type:
- apiref
api_name:
- WM_VSCROLLCLIPBOARD
...
| <span id="SB_TOP"></span><span id="sb_top"></span><dl> <dt>**SB \_ TOP**</dt> <dt>6</dt> </dl>                               | Desplácese hacia arriba a la izquierda.<br/>                                                                  |
