---
description: En esta sección se especifican los formatos ([**DXGI_FORMAT_** _](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) valores) que se admiten en el hardware de nivel de característica de Direct3D 12,1.
...
En esta sección se especifican los formatos ([_* DXGI_FORMAT_* * _](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) valores) que se admiten en el hardware de nivel de característica de Direct3D 12,1.
...
| Sample_c del sombreador (filtro de comparación) | \- |
| Ejemplo de sombreador (1_bit_filter mono) | \- |
| Sombreador gather4 | \- |
| Gather4_c del sombreador | \- |
| Mapa | \- |
...
| UAV Atomic con signo mín./máx. | \- |
| UAV Atomic sin signo mín./máx. | \- |
...
| Recurso compartido | \- |
| Conversión de búferes de reserva totalmente tipado | \- |
| Recurso en mosaico | ![requerido](images/letter-r.jpg) |

## <a name="dxgi_format_r32g32b32a32_typelesssuppcssup-1"></a><sup>Equipos</sup> DXGI_FORMAT_R32G32B32A32_TYPELESS (1)
| Destino | Soporte técnico |
| - | - |
...
| UAV almacén de tipos | ![requerido](images/letter-r.jpg) |
...
| RenderTarget | ![requerido](images/letter-r.jpg) |
| RenderTarget combinable | \- |
| Operación de lógica de fusión de salida | ![requerido](images/letter-r.jpg) |
| Destino de estarcido o profundidad | \- |
| UAV y SRV sin formato | \- |
| UAV estructurado y SRV | \- |
| UAV con tipo | ![requerido](images/letter-r.jpg) |
...
## <a name="dxgi_format_r32g32b32_typelesssuppcssup-5"></a><sup>Equipos</sup> DXGI_FORMAT_R32G32B32_TYPELESS (5)
| Destino | Soporte técnico |
| - | - |
...
| Sample_c del sombreador (filtro de comparación) | \- |
| Ejemplo de sombreador (1_bit_filter mono) | \- |
| Sombreador gather4 | ![opcional](images/letter-o.jpg) |
| Gather4_c del sombreador | \- |
| Mapa | ![requerido](images/letter-r.jpg) |
...
## <a name="dxgi_format_r16g16b16a16_typelesssuppcssup-9"></a><sup>Equipos</sup> DXGI_FORMAT_R16G16B16A16_TYPELESS (9)
| Destino | Soporte técnico |
| - | - |
...
## <a name="dxgi_format_r32g32_typelesssuppcssup-15"></a><sup>Equipos</sup> DXGI_FORMAT_R32G32_TYPELESS (15)
| Destino | Soporte técnico |
| - | - |
| Bits por elemento (BPE) | 64 |
| Compatibilidad con formato | ![requerido](images/letter-r.jpg) |
...
| Sombreador LD | ![requerido](images/letter-r.jpg) |
| Ejemplo de sombreador (cualquier filtro) | ![requerido](images/letter-r.jpg) |
| Sample_c del sombreador (filtro de comparación) | ![requerido](images/letter-r.jpg) |
| Ejemplo de sombreador (1_bit_filter mono) | \- |
| Sombreador gather4 | ![requerido](images/letter-r.jpg) |
| Gather4_c del sombreador | ![requerido](images/letter-r.jpg) |
| Mapa | ![requerido](images/letter-r.jpg) |
| Generación automática de mipmap | \- |
| RenderTarget | \- |
| RenderTarget combinable | \- |
...
## <a name="dxgi_format_r10g10b10a2_typelesssuppcssup-23"></a><sup>Equipos</sup> DXGI_FORMAT_R10G10B10A2_TYPELESS (23)
| Destino | Soporte técnico |
| - | - |
...
| Salida del procesador de vídeo | ![requerido](images/letter-r.jpg) |
| Recurso compartido | ![requerido](images/letter-r.jpg) |
| Conversión de búferes de reserva totalmente tipado | ![requerido](images/letter-r.jpg) |
| Recurso en mosaico | ![requerido](images/letter-r.jpg) |
...
## <a name="dxgi_format_r8g8b8a8_typelesssuppcssup-27"></a><sup>Equipos</sup> DXGI_FORMAT_R8G8B8A8_TYPELESS (27)
| Destino | Soporte técnico |
| - | - |
| Bits por elemento (BPE) | 32 |
| Compatibilidad con formato | ![requerido](images/letter-r.jpg) |
...
## <a name="dxgi_format_r16g16_typelesssuppcssup-33"></a><sup>Equipos</sup> DXGI_FORMAT_R16G16_TYPELESS (33)
| Destino | Soporte técnico |
| - | - |
| Bits por elemento (BPE) | 32 |
| Compatibilidad con formato | ![requerido](images/letter-r.jpg) |
...
## <a name="dxgi_format_r32_typelesssuppcssup-39"></a><sup>Equipos</sup> DXGI_FORMAT_R32_TYPELESS (39)
| Destino | Soporte técnico |
| - | - |
| Bits por elemento (BPE) | 32 |
| Compatibilidad con formato | ![requerido](images/letter-r.jpg) |
...
| Operación de lógica de fusión de salida | \- |
| Destino de estarcido o profundidad | \- |
| UAV y SRV sin formato | ![requerido](images/letter-r.jpg) |
| UAV estructurado y SRV | \- |
| UAV con tipo | \- |
| UAV almacén de tipos | \- |
| Carga con tipo UAV | \- |
...
| Operaciones bit a bit atómicas UAV | \- |
| UAV Atomic CMP&Store/CMP&Exch | \- |
| Intercambio atómico UAV | ![requerido](images/letter-r.jpg) |
| UAV Atomic con signo mín./máx. | \- |
| UAV Atomic sin signo mín./máx. | \- |
| CPU bloqueada | ![requerido](images/letter-r.jpg) |
| RenderTarget de muestreo Multimuestra 4x | ![requerido](images/letter-r.jpg) |
...
| Operaciones bit a bit atómicas UAV | ![requerido](images/letter-r.jpg) |
| UAV Atomic CMP&Store/CMP&Exch | ![requerido](images/letter-r.jpg) |
| Intercambio atómico UAV | ![requerido](images/letter-r.jpg) |
| UAV Atomic con signo mín./máx. | ![requerido](images/letter-r.jpg) |
| UAV Atomic sin signo mín./máx. | ![requerido](images/letter-r.jpg) |
| CPU bloqueada | ![requerido](images/letter-r.jpg) |
| RenderTarget de muestreo Multimuestra 4x | ![requerido](images/letter-r.jpg) |
| RenderTarget de muestreo Multimuestra | ![requerido](images/letter-r.jpg) |
| Otro número de muestras Multimuestra RT | ![opcional](images/letter-o.jpg) |
...
## <a name="dxgi_format_r8g8_typelesssuppcssup-48"></a><sup>Equipos</sup> DXGI_FORMAT_R8G8_TYPELESS (48)
| Destino | Soporte técnico |
| - | - |
...
## <a name="dxgi_format_r16_typelesssuppcssup-53"></a><sup>Equipos</sup> DXGI_FORMAT_R16_TYPELESS (53)
| Destino | Soporte técnico |
| - | - |
| Bits por elemento (BPE) | 16 |
| Compatibilidad con formato | ![requerido](images/letter-r.jpg) |
...
## <a name="dxgi_format_r8_typelesssuppcssup-60"></a><sup>Equipos</sup> DXGI_FORMAT_R8_TYPELESS (60)
| Destino | Soporte técnico |
| - | - |
...
| UAV almacén de tipos | ![opcional](images/letter-o.jpg) |
| Carga con tipo UAV | ![opcional](images/letter-o.jpg) |
| UAV Atomic Add | \- |
| Operaciones bit a bit atómicas UAV | \- |
| UAV Atomic CMP&Store/CMP&Exch | \- |
...
## <a name="dxgi_format_b8g8r8a8_typelesssuppcssup-90"></a><sup>Equipos</sup> DXGI_FORMAT_B8G8R8A8_TYPELESS (90)
| Destino | Soporte técnico |
| - | - |
| Bits por elemento (BPE) | 32 |
| Compatibilidad con formato | ![requerido](images/letter-r.jpg) |
...
## <a name="dxgi_format_b8g8r8x8_typelesssuppcssup-92"></a><sup>Equipos</sup> DXGI_FORMAT_B8G8R8X8_TYPELESS (92)
| Destino | Soporte técnico |
| - | - |
| Bits por elemento (BPE) | 32 |
| Compatibilidad con formato | ![requerido](images/letter-r.jpg) |
...
## <a name="dxgi_format_related-topics"></a>Temas de DXGI_FORMAT_Related
