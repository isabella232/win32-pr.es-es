---
description: En esta sección se especifican los formatos ([**DXGI_FORMAT_** _](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) valores) que se admiten en el hardware de nivel de característica de Direct3D 12,0.
...
En esta sección se especifican los formatos ([_* DXGI_FORMAT_* * _](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) valores) que se admiten en el hardware de nivel de característica de Direct3D 12,0.
...
| Ejemplo de sombreador (filtro de 1 \_ bit mono \_ ) | \- |
| Sombreador gather4 | \- |
...
## <a name="dxgi_format_r32g8x24_typeless-19"></a>DXGI_FORMAT_R32G8X24 \_ sin tipo (19)
| Destino | Soporte técnico |
| - | - |
| Bits por elemento (BPE) | 64 |
| Compatibilidad con formato | ![requerido](images/letter-r.jpg) |
...
## <a name="dxgi_format_r32_float_x8x24_typeless-21"></a>DXGI_FORMAT_R32 \_ float \_ X8X24 \_ typeless (21)
| Destino | Soporte técnico |
| - | - |
| Bits por elemento (BPE) | 64 |
| Compatibilidad con formato | ![requerido](images/letter-r.jpg) |
...
| Ejemplo de sombreador (filtro de 1 \_ bit mono \_ ) | \- |
| Sombreador gather4 | ![requerido](images/letter-r.jpg) |
| Sombreador gather4 \_ c | ![requerido](images/letter-r.jpg) |
| Mapa | ![requerido](images/letter-r.jpg) |
| Generación automática de mipmap | \- |
| RenderTarget | \- |
| RenderTarget combinable | \- |
...
## <a name="dxgi_format_x32_typeless_g8x24_uint-22"></a>DXGI_FORMAT_X32 \_ uint sin tipo \_ G8X24 \_ (22)
| Destino | Soporte técnico |
| - | - |
| Bits por elemento (BPE) | 64 |
| Compatibilidad con formato | ![requerido](images/letter-r.jpg) |
...
## <a name="dxgi_format_x24_typeless_g8_uint-47"></a>DXGI_FORMAT_X24 \_ uint de \_ G8 sin tipo \_ (47)
| Destino | Soporte técnico |
| - | - |
| Bits por elemento (BPE) | 32 |
| Compatibilidad con formato | ![requerido](images/letter-r.jpg) |
