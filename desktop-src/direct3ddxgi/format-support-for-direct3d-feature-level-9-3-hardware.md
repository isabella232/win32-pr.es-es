---
description: En esta sección se especifican los formatos[ * (DXGI_FORMAT_)](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) que se admiten en el hardware de Direct3D Feature 10Level9 9.3.
...
En esta sección se especifican los formatos[ * (DXGI_FORMAT_)](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) que se admiten en el hardware de Direct3D Feature 10Level9 9.3.
...
## <a name="dxgi_format_d24_unorm_s8_uintsupfnssup-45"></a>DXGI_FORMAT_D24 \_ \_ \_ <sup>FNS</sup> UINT de UNORM S8 (45)
| Destino | Soporte técnico |
| - | - |
| Bits por elemento (BPE) | 32 |
| Compatibilidad con formatos | ![requerido](images/letter-r.jpg) |
...
## <a name="dxgi_format_r8_snormsupfnssup-63"></a>DXGI_FORMAT_R8 \_ <sup>FNS</sup> de SNORM (63)
| Destino | Soporte técnico |
| - | - |
| Bits por elemento (BPE) | 8 |
| Compatibilidad con formato | \- |
