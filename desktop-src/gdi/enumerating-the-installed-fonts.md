...
La [**función EnumFontFamilies**](/windows/win32/api/wingdi/nf-wingdi-enumfontfamiliesa) es similar a la función [**EnumFonts,**](/windows/win32/api/wingdi/nf-wingdi-enumfontsa) pero incluye alguna funcionalidad adicional. **EnumFontFamilies permite** que una aplicación aproveche los estilos disponibles con fuentes TrueType. Las aplicaciones nuevas y actualizadas deben **usar EnumFontFamilies en** lugar **de EnumFonts.**

Las fuentes TrueType se organizan en torno a un nombre de tipo de letra (por ejemplo, Courier New) y nombres de estilo (por ejemplo, cursiva, negrita y negrita adicional). La [**función EnumFontFamilies**](/windows/win32/api/wingdi/nf-wingdi-enumfontfamiliesa) enumera todos los estilos asociados a un nombre de familia especificado, no solo los atributos negrita y cursiva. Por ejemplo, cuando el sistema incluye una fuente TrueType denominada Courier New Extra-Bold, **EnumFontFamilies** la muestra con las otras fuentes Courier New. Las funcionalidades **de EnumFontFamilies** son útiles para las fuentes con muchos estilos o inusuales y para las fuentes que cruzan las fronteras internacionales.

Si una aplicación no proporciona un nombre de tipo de letra, las funciones [EnumFonts](/windows/desktop/api/Wingdi/nf-wingdi-enumfontsa) y [EnumFontFamilies](/windows/desktop/api/Wingdi/nf-wingdi-enumfontfamiliesa) suministran información sobre una fuente de cada familia disponible. Para enumerar todas las fuentes de un contexto de dispositivo, la aplicación puede especificar **NULL** para el nombre del tipo de letra, compilar una lista de los tipos de letra disponibles y, a continuación, enumerar cada fuente de cada tipo de letra.

En el ejemplo siguiente se usa la función [**EnumFontFamilies**](/windows/win32/api/wingdi/nf-wingdi-enumfontfamiliesa) para recuperar el número de familias de fuentes de tipo raster, vector y TrueType disponibles.
