...
---
# <a name="using-pens"></a>Usar lápices

Esta sección contiene código de ejemplo que muestra el aspecto de las líneas dibujadas con varios estilos y atributos de lápiz.
