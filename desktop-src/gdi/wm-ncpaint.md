...
---
# <a name="wm_ncpaint-message"></a>Mensaje de NCPAINT de WM \_

El mensaje de **\_ NCPAINT de WM** se envía a una ventana cuando se debe pintar su marco.
...
La función [**DefWindowProc**](/windows/desktop/api/winuser/nf-winuser-defwindowproca) pinta el marco de la ventana.

Una aplicación puede interceptar el mensaje de **\_ NCPAINT de WM** y pintar su propio marco de ventana personalizado. La región de recorte de una ventana siempre es rectangular, incluso si se modifica la forma del marco.

El valor de *wParam* se puede pasar a [**GetDCEx**](/windows/desktop/api/Winuser/nf-winuser-getdcex) como en el ejemplo siguiente.
