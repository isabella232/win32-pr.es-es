...
| [**FlattenPath**](/windows/desktop/api/Wingdi/nf-wingdi-flattenpath)             | Transforma las curvas de la ruta de acceso que se seleccionan en el contexto del dispositivo (DC) actual, convirtiendo cada curva en una secuencia de líneas.                            |
| [**GetMiterLimit**](/windows/desktop/api/Wingdi/nf-wingdi-getmiterlimit)         | Recupera el límite de miter para el contexto de dispositivo especificado.                                                                                                      |
...
| [**SetMiterLimit**](/windows/desktop/api/Wingdi/nf-wingdi-setmiterlimit)         | Establece el límite de la longitud de las combinaciones de miter para el contexto de dispositivo especificado.                                                                                   |
| [**StrokeAndFillPath**](/windows/desktop/api/Wingdi/nf-wingdi-strokeandfillpath) | Cierra cualquier figura abierta en un trazado, trazo el contorno del trazado mediante el lápiz actual y rellena su interior mediante el pincel actual.                  |
...
| [**WidenPath**](/windows/desktop/api/Wingdi/nf-wingdi-widenpath)                 | Redefine la ruta de acceso actual como el área que se pintaría si la ruta de acceso se acariciase con el lápiz seleccionado actualmente en el contexto del dispositivo especificado.            |
