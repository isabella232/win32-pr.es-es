...
---
# <a name="using-rectangles-windows-gdi"></a>Usar rectángulos (Windows GDI)

En el ejemplo de esta sección se muestra cómo usar las funciones de rectángulo. Consta del procedimiento de ventana principal de una aplicación que permite al usuario desplace y ajuste el tamaño de un mapa de bits.

Cuando se inicia la aplicación, se dibuja un mapa de bits de 32 píxeles de 32 píxeles en la esquina superior izquierda de la pantalla. El usuario puede mover el mapa de bits arrastrándolo. Para ajustar el tamaño del mapa de bits, el usuario crea un rectángulo de destino arrastrando el mouse y, a continuación, arrastra el mapa de bits y lo coloca en el rectángulo de destino. La aplicación responde copiando el mapa de bits en el rectángulo de destino.

En el ejemplo siguiente se proporciona el procedimiento de ventana que permite al usuario trasladar y ajustar el tamaño del mapa de bits.
