...
Para desarrollar un juego en DirectX Windows, debe tener algunas aptitudes básicas. En concreto, debe poder:

-   Lea y escriba código C++ moderno (C++11 ayuda más) y familiarícese con los principios y patrones básicos de diseño de C++, como las plantillas y el modelo de fábrica. También debe estar familiarizado con las bibliotecas comunes de C++, como la biblioteca de plantillas estándar, y específicamente con los operadores de conversión, los tipos de puntero y las estructuras de datos de la biblioteca de plantillas estándar (como std::vector).
...
-   Comprenda el concepto de bucle de mensajes, ya que va a implementar un bucle que escucha el Windows operativo.

## <a name="and-were-off"></a>Y estamos apagados.

¿Estás listo para empezar? Vamos a revisarlo antes de empezar. Ha:
