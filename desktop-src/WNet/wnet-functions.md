...
| [**WNetAddConnection**](/windows/win32/api/winnetwk/nf-winnetwk-wnetaddconnectiona)                               | Conecta un dispositivo local a un recurso de red. (Se proporciona para la compatibilidad con versiones de 16 bits de Windows).                                                                                                                   |
...
| [**WNetCancelConnection**](/windows/win32/api/winnetwk/nf-winnetwk-wnetcancelconnectiona)                         | Cancela una conexión de red. (Se proporciona para la compatibilidad con versiones de 16 bits de Windows).                                                                                                                                    |
...
| [**WNetConnectionDialog**](/windows/win32/api/winnetwk/nf-winnetwk-wnetconnectiondialog)                         | Inicia un cuadro de diálogo de exploración general para conectarse a recursos de red.                                                                                                                                                      |
