...
description: Cuando un servidor LDAP genera un error y lo pasa al cliente, el cliente LDAP convierte el error en una cadena.
...
ms.locfileid: "120005515"
---
# <a name="ldap-error-codes-for-adsi"></a>Códigos de error LDAP para ADSI

Cuando un servidor LDAP genera un error y lo pasa al cliente, el cliente LDAP convierte el error en una cadena.
...
1.  Quitar el 8007 del código de error win32. En el ejemplo, el valor hexadecimal restante es 2020.
