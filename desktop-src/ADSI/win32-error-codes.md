...
|------------------|----------------------------------------|---------------------------------------------|--------------------------------------------------|
| 0L               | **LDAP \_ SUCCESS**                      | **NO \_ ERROR**                               | Operación realizada correctamente.                             |
| 0x80070005L      | **DERECHOS \_ INSUFICIENTES DE LDAP \_**         | **ERROR \_ DE ACCESO \_ DENEGADO**                   | El usuario no tiene derechos de acceso suficientes.             |
| 0x80070008L      | **LDAP \_ NO \_ MEMORY**                   | **ERROR \_ NO HAY SUFICIENTE \_ \_ MEMORIA**              | El sistema está sin memoria.                         |
| 0x8007001fL      | **LDAP \_ OTHER**                        | **ERROR \_ DE GEN \_**                     | Error desconocido.                                   |
| 0x800700eaL      | **RESULTADOS \_ PARCIALES LDAP \_**             | **ERROR \_ MÁS \_ DATOS**                       | Resultados parciales y referencias recibidas.          |
...
| 0x800704c9L      | **ERROR \_ DE CONEXIÓN \_ LDAP**               | **ERROR \_ DE CONEXIÓN \_ RECHAZADA**              | No se puede establecer la conexión.                 |
| 0x8007052eL      | **CREDENCIALES \_ NO VÁLIDAS DE LDAP \_**         | **ERROR AL \_ INICIAR SESIÓN \_**                   | La credencial proporcionada no es válida.                |
...
| 0x8007200aL      | **LDAP \_ NO ES UN ATRIBUTO DE ESTE \_ \_ TIPO**          | **ERROR \_ DS \_ SIN ATRIBUTO NI \_ \_ \_ VALOR**     | El atributo solicitado no existe.              |
| 0x8007200bL      | **SINTAXIS \_ LDAP NO \_ VÁLIDA**              | **ERROR \_ DS \_ SINTAXIS DE \_ ATRIBUTO NO \_ VÁLIDO**   | La sintaxis no es válida.                             |
| 0x8007200cL      | **TIPO \_ LDAP \_ UNDEFINED**              | **ERROR \_ DS \_ ATTRIBUTE \_ TYPE \_ UNDEFINED**   | Tipo no definido.                                |
| 0x8007200dL      | **EL \_ ATRIBUTO O VALOR LDAP \_ \_ \_ EXISTE** | **ERROR \_ DS \_ ATTRIBUTE \_ OR \_ VALUE \_ EXISTS** | El atributo existe o se ha asignado el valor. |
...
| 0x80072014L      | **INFRACCIÓN \_ DE CLASE DE OBJETO \_ \_ LDAP**     | **ERROR \_ DS \_ OBJ \_ CLASS \_ VIOLATION**        | Infracción de clase de objeto.                          |
| 0x80072015L      | **LDAP \_ NO PERMITIDO EN \_ \_ \_ NONLEAF**    | **ERROR \_ DS \_ CANT \_ ON \_ NON \_ LEAF**          | No se permite la operación en un objeto que no sea hoja.  |
| 0x80072016L      | **LDAP \_ NO PERMITIDO EN \_ \_ \_ RDN**        | **ERROR \_ DS \_ CANT \_ ON \_ RDN**                | No se permite la operación en un RDN.              |
| 0x80072017L      | **LDAP \_ NO \_ OBJECT \_ CLASS \_ MODS**      | **ERROR \_ DS \_ CANT \_ MOD \_ OBJ \_ (CLASE)**        | No se puede modificar la clase de objeto.                      |
| 0x80072020L      | **ERROR \_ DE OPERACIONES LDAP \_**            | **ERROR \_ DS \_ OPERATIONS \_ ERROR**            | Error de operación.                        |
| 0x80072021L      | **ERROR \_ DE PROTOCOLO \_ LDAP**              | **ERROR \_ DS \_ PROTOCOL \_ ERROR**              | Error de protocolo.                         |
| 0x80072022L      | **LDAP \_ TIMELIMIT \_ EXCEEDED**          | **ERROR \_ DS \_ TIMELIMIT \_ EXCEEDED**          | Se ha superado el límite de tiempo.                             |
| 0x80072023L      | **LDAP \_ SIZELIMIT \_ EXCEEDED**          | **ERROR \_ DS \_ SIZELIMIT \_ EXCEEDED**          | Se ha superado el límite de tamaño.                             |
| 0x80072024L      | **SE \_ SUPERÓ \_ EL LÍMITE DE \_ ADMINISTRACIÓN DE LDAP**       | **ERROR \_ DS \_ ADMIN \_ LIMIT \_ EXCEEDED**       | Se superó el límite de administración en el servidor.     |
| 0x80072025L      | **LDAP \_ COMPARE \_ FALSE**               | **ERROR \_ DS \_ COMPARE \_ FALSE**               | Compare yielded **FALSE**.                       |
| 0x80072026L      | **LDAP \_ COMPARE \_ TRUE**                | **ERROR \_ DS \_ COMPARE \_ TRUE**                | Compare el valor true que se **ha dado.**                        |
| 0x80072027L      | **MÉTODO \_ DE AUTENTICACIÓN \_ LDAP NO \_ \_ COMPATIBLE** | **ERROR \_ NO SE ADMITE EL MÉTODO DE \_ \_ AUTENTICACIÓN \_ DS \_** | No se admite el método de autenticación.      |
...
| 0x80072029L      | **AUTENTICACIÓN \_ \_ INAPROPIADA DE LDAP**          | **ERROR \_ DS \_ \_ AUTH INADECUADO**          | La autenticación no es adecuada.                 |
...
| 0x80072030L      | **LDAP \_ NO \_ SUCH \_ OBJECT**             | **ERROR \_ DS \_ NO \_ SUCH \_ OBJECT**             | El objeto no existe.                           |
| 0x80072031L      | **PROBLEMA \_ DE ALIAS \_ LDAP**               | **ERROR \_ DS \_ ALIAS \_ PROBLEM**               | El alias no es válido.                              |
| 0x80072032L      | **SINTAXIS \_ \_ DE DN NO VÁLIDA DE LDAP \_**          | **ERROR \_ DS \_ SINTAXIS \_ DN \_ NO VÁLIDA**          | El nombre distintivo tiene una sintaxis que no es válida. |
| 0x80072033L      | **LDAP \_ ES \_ HOJA**                     | **ERROR \_ DS \_ IS \_ LEAF**                     | El objeto es una hoja.                            |
| 0x80072034L      | **PROBLEMA \_ DE DEREF DE ALIAS \_ \_ LDAP**        | **ERROR \_ DS \_ ALIAS \_ DEREF \_ PROBLEM**        | No se puede desreferenciar el alias.                    |
...
| 0x80072038L      | **RESULTADOS \_ LDAP \_ DEMASIADO \_ GRANDES**          | **RESULTADOS \_ DEL OBJETO DS \_ DE ERROR DEMASIADO \_ \_ \_ GRANDES**  | El conjunto de resultados es demasiado grande.                        |
