---
title: Código de ejemplo para agregar una ACE a un archivo
description: En el ejemplo de código siguiente se muestra cómo utilizar la interfaz IADsSecurityUtility para agregar una ACE a un archivo.
ms.assetid: d47d3ebe-cc14-412d-be27-841e25b43c3a
ms.tgt_platform: multiple
keywords:
- Código de ejemplo para agregar una ACE a un archivo ADSI
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105656181"
---
# <a name="example-code-for-adding-an-ace-to-a-file"></a><span data-ttu-id="92d89-104">Código de ejemplo para agregar una ACE a un archivo</span><span class="sxs-lookup"><span data-stu-id="92d89-104">Example Code for Adding an ACE to a File</span></span>

<span data-ttu-id="92d89-105">En el ejemplo de código siguiente se muestra cómo utilizar la interfaz [**IADsSecurityUtility**](/windows/desktop/api/Iads/nn-iads-iadssecurityutility) para agregar una ACE a un archivo.</span><span class="sxs-lookup"><span data-stu-id="92d89-105">The following code example shows how to use the [**IADsSecurityUtility**](/windows/desktop/api/Iads/nn-iads-iadssecurityutility) interface to add an ACE to a file.</span></span>
