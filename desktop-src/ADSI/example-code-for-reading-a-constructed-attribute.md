...
---
# <a name="example-code-for-reading-a-constructed-attribute"></a><span data-ttu-id="b5050-104">Código de ejemplo para leer un atributo construido</span><span class="sxs-lookup"><span data-stu-id="b5050-104">Example Code for Reading a Constructed Attribute</span></span>

<span data-ttu-id="b5050-105">En el ejemplo de código siguiente se muestra un método que se puede utilizar para recuperar un valor de atributo que funcionará con todos los tipos de atributos.</span><span class="sxs-lookup"><span data-stu-id="b5050-105">The following code example shows a method that can be used to retrieve an attribute value that will work with all attributes types.</span></span>
...
<span data-ttu-id="b5050-106">En el ejemplo de código siguiente se muestra un método que se puede utilizar para recuperar un valor de atributo que funcionará con todos los tipos de atributos.</span><span class="sxs-lookup"><span data-stu-id="b5050-106">The following code example shows a method that can be used to retrieve an attribute value that will work with all attributes types.</span></span>
