...
description: En este tema se enumeran las interfaces ADSI que crean objetos persistentes en el directorio.
ms.assetid: cbd70e89-c8cc-48b2-af00-3df613b0908e
ms.tgt_platform: multiple
keywords:
- interfaces de objeto persistentes ADSI
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104149035"
---
# <a name="persistent-object-interfaces-adsi"></a>Interfaces de objeto persistentes (ADSI)

En esta sección se describen las siguientes interfaces de objeto persistentes:
