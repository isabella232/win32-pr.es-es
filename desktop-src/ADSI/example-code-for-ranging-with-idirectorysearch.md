...
---
# <a name="example-code-for-ranging-with-idirectorysearch"></a><span data-ttu-id="6203f-105">Código de ejemplo para el intervalo con IDirectorySearch</span><span class="sxs-lookup"><span data-stu-id="6203f-105">Example Code for Ranging with IDirectorySearch</span></span>

<span data-ttu-id="6203f-106">En el ejemplo de código siguiente se usa el intervalo para recuperar los miembros de un grupo mediante la interfaz [**IDirectorySearch**](/windows/desktop/api/Iads/nn-iads-idirectorysearch) .</span><span class="sxs-lookup"><span data-stu-id="6203f-106">The following code example uses ranging to retrieve the members of a group using the [**IDirectorySearch**](/windows/desktop/api/Iads/nn-iads-idirectorysearch) interface.</span></span>
