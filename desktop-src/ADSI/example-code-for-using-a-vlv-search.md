...
---
# <a name="example-code-for-using-a-vlv-search"></a><span data-ttu-id="932ac-104">Código de ejemplo para usar una búsqueda VLV</span><span class="sxs-lookup"><span data-stu-id="932ac-104">Example Code for Using a VLV Search</span></span>

<span data-ttu-id="932ac-105">En los ejemplos de código siguientes se usan las búsquedas VLV para obtener los resultados de la búsqueda.</span><span class="sxs-lookup"><span data-stu-id="932ac-105">The following code examples use VLV searches to obtain search results.</span></span>

-   <span data-ttu-id="932ac-106">**GetVLVItemCount**</span><span class="sxs-lookup"><span data-stu-id="932ac-106">**GetVLVItemCount**</span></span>
-   <span data-ttu-id="932ac-107">**GetVLVItemText**</span><span class="sxs-lookup"><span data-stu-id="932ac-107">**GetVLVItemText**</span></span>
-   <span data-ttu-id="932ac-108">**GetVLVItemsByString**</span><span class="sxs-lookup"><span data-stu-id="932ac-108">**GetVLVItemsByString**</span></span>

## <a name="utility-functions"></a><span data-ttu-id="932ac-109">Funciones de la utilidad</span><span class="sxs-lookup"><span data-stu-id="932ac-109">Utility Functions</span></span>

<span data-ttu-id="932ac-110">Los ejemplos de código siguientes se usan en las funciones de ejemplo de este tema.</span><span class="sxs-lookup"><span data-stu-id="932ac-110">The following code examples are used by the example functions in this topic.</span></span>
...
## <a name="getvlvitemcount-example-function"></a><span data-ttu-id="932ac-111">Función de ejemplo GetVLVItemCount</span><span class="sxs-lookup"><span data-stu-id="932ac-111">GetVLVItemCount Example Function</span></span>

<span data-ttu-id="932ac-112">En el ejemplo de código siguiente se muestra cómo usar una búsqueda VLV para obtener una estimación del número de elementos que resultarían de la búsqueda.</span><span class="sxs-lookup"><span data-stu-id="932ac-112">The following code example shows how to use a VLV search to obtain an estimate of the number of items that would result from the search.</span></span>
...
## <a name="getvlvitemtext-example-function"></a><span data-ttu-id="932ac-113">Función de ejemplo GetVLVItemText</span><span class="sxs-lookup"><span data-stu-id="932ac-113">GetVLVItemText Example Function</span></span>

<span data-ttu-id="932ac-114">En el ejemplo de código siguiente se muestra cómo utilizar una búsqueda VLV para obtener el texto de un elemento único basado en un índice.</span><span class="sxs-lookup"><span data-stu-id="932ac-114">The following code example shows how to use a VLV search to obtain the text for a single item based on an index.</span></span>
...
## <a name="getvlvitemsbystring-example-function"></a><span data-ttu-id="932ac-115">Función de ejemplo GetVLVItemsByString</span><span class="sxs-lookup"><span data-stu-id="932ac-115">GetVLVItemsByString Example Function</span></span>

<span data-ttu-id="932ac-116">En el ejemplo de código siguiente se muestra cómo utilizar una búsqueda VLV para obtener el texto de un número especificado de elementos basándose en una cadena.</span><span class="sxs-lookup"><span data-stu-id="932ac-116">The following code example shows how to use a VLV search to obtain the text for a specified number of items based on a string.</span></span> <span data-ttu-id="932ac-117">En este ejemplo se agregarán los ordenaciones recuperados a un cuadro de lista.</span><span class="sxs-lookup"><span data-stu-id="932ac-117">This example will add the sortings retrieved to a list box.</span></span>
