...
---
# <a name="code-example-for-working-with-adsi-error-messages"></a><span data-ttu-id="40c7c-104">Ejemplo de código para trabajar con mensajes de error ADSI</span><span class="sxs-lookup"><span data-stu-id="40c7c-104">Code Example for Working with ADSI Error Messages</span></span>

<span data-ttu-id="40c7c-105">En el ejemplo de código siguiente se muestra cómo recuperar un mensaje de error de ADSI.</span><span class="sxs-lookup"><span data-stu-id="40c7c-105">The following code example shows how to retrieve an ADSI error message.</span></span>
