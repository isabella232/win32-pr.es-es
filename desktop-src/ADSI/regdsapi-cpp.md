...
| **SampleDSGetPropertyInfo**        | Dado un identificador en el objeto de clase de esquema y un nombre de propiedad, recupere la información de propiedad, como la sintaxis, y así sucesivamente.                                                                      |
| **FreeList**                       | Libera la memoria usada por LPWSTR \_ LIST.                                                                                                                                                        |
