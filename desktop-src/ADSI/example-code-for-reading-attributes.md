---
title: Código de ejemplo para leer atributos
description: En el ejemplo de código siguiente se enumeran las propiedades del usuario especificado en el dominio actual; para ello, se busca el usuario y, a continuación, se usa IADsPropertyList para enumerar sus propiedades.
ms.assetid: f5541e9b-e149-4d22-9ff6-a32bd8239f57
ms.tgt_platform: multiple
keywords:
- Código de ejemplo para leer atributos ADSI
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104531846"
---
# <a name="example-code-for-reading-attributes"></a><span data-ttu-id="783e4-104">Código de ejemplo para leer atributos</span><span class="sxs-lookup"><span data-stu-id="783e4-104">Example Code for Reading Attributes</span></span>

<span data-ttu-id="783e4-105">En el ejemplo de código siguiente se enumeran las propiedades del usuario especificado en el dominio actual; para ello, se busca el usuario y, a continuación, se usa [**IADsPropertyList**](/windows/desktop/api/Iads/nn-iads-iadspropertylist) para enumerar sus propiedades.</span><span class="sxs-lookup"><span data-stu-id="783e4-105">The following code example enumerates the properties of the specified user in the current domain, by searching for the user and then using [**IADsPropertyList**](/windows/desktop/api/Iads/nn-iads-iadspropertylist) to enumerate its properties.</span></span> <span data-ttu-id="783e4-106">Tenga en cuenta que los valores de fecha y hora, como enteros grandes, se controlan y cómo se controlan las cadenas de octetos para **objectSid** y **objectGUID** .</span><span class="sxs-lookup"><span data-stu-id="783e4-106">Be aware that time and date values, as large integers, are handled and how octet strings for **objectSID** and **objectGUID** are handled.</span></span>
...
<span data-ttu-id="783e4-107">En el siguiente ejemplo de código de Visual Basic se muestra cómo obtener las propiedades de un objeto de usuario.</span><span class="sxs-lookup"><span data-stu-id="783e4-107">The following Visual Basic code example shows how to get the properties of a user object.</span></span> <span data-ttu-id="783e4-108">Para usar este ejemplo de código, cree una referencia a la biblioteca de tipos Active DS y la biblioteca de Microsoft Objetos de datos ActiveX en el proyecto de Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="783e4-108">To use this code example, create a reference to the Active DS Type Library and the Microsoft ActiveX Data Objects Library in your Visual Basic project.</span></span>
