...
description: La **interfaz IDXCoreAdapterList** implementa métodos para recuperar elementos de adaptador de una lista generada, así como detalles sobre la lista.
