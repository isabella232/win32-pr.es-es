---
description: 'Más información sobre: JET_TABLECREATE.rgcolumncreate'
title: JET_TABLECREATE.rgcolumncreate, propiedad
...
Obtiene o establece una matriz de información de creación de columnas, de tipo [JET_COLUMNCREATE](./jet-columncreate-class.md).
