---
description: 'Más información sobre: métodos JET_BKINFO'
title: Métodos JET_BKINFO
...
ms.locfileid: "104278677"
---
# <a name="jet_bkinfo-methods"></a>Métodos JET_BKINFO

Incluir miembros protegidos  
Incluir miembros heredados  

El tipo de [JET_BKINFO](./jet-bkinfo-structure2.md) expone los siguientes miembros.
...
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Método público" alt="Public method" /></td>
<td><a href="hh578140(v=exchg.10).md">Es igual a (JET_BKINFO)</a></td>
