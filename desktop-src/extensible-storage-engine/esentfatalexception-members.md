---
description: 'Más información acerca de: miembros de EsentFatalException'
title: Miembros de EsentFatalException
...
ms.locfileid: "104279235"
---
# <a name="esentfatalexception-members"></a>Miembros de EsentFatalException

Incluir miembros protegidos  
Incluir miembros heredados  

Clase base para las excepciones irrecuperables.

El tipo [EsentFatalException](./esentfatalexception-class.md) expone los siguientes miembros.
...
<td>Inicializa una nueva instancia de la clase EsentFatalException. Este constructor se utiliza para deserializar una excepción serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn274274(v=exchg.10).md">EsentFatalException (cadena, JET_err)</a></td>
<td>Inicializa una nueva instancia de la clase EsentFatalException.</td>
</tr>
</tbody>
</table>
