...
---
# <a name="apijetgetindexinfo-method-jet_sesid-jet_dbid-string-string-jet_indexid-jet_idxinfo"></a>Método API. JetGetIndexInfo (JET_SESID, JET_DBID, cadena, cadena, JET_INDEXID, JET_IdxInfo)
