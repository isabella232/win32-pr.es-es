...
| <p><strong>Unicode</strong></p> | <p>Se implementa como <strong>JetOpenFileInstanceW</strong> (Unicode) y <strong>JetOpenFileInstanceA</strong> (ANSI).</p> | 
