---
description: 'Más información sobre: JET_DBID miembros'
title: JET_DBID miembros
...
ms.locfileid: "127465411"
---
# <a name="jet_dbid-members"></a>JET_DBID miembros

Incluir miembros protegidos  
Incluir miembros heredados  

Un JET_DBID contiene el identificador de la base de datos. Se usa un identificador de base de datos para administrar el esquema de una base de datos. También se puede usar para administrar las tablas dentro de esa base de datos.
...
<td><a href="hh558630(v=exchg.10).md">Nula</a></td>
<td>Obtiene un valor null JET_DBID.</td>
</tr>
</tbody>
</table>
...
<td><a href="hh564853(v=exchg.10).md">Igualdad</a></td>
<td>Determina si dos instancias especificadas de JET_DBID son iguales.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Operador público" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Miembro estático" alt="Static member" /></td>
<td><a href="hh577940(v=exchg.10).md">Desigualdad</a></td>
<td>Determina si dos instancias especificadas de JET_DBID no son iguales.</td>
</tr>
</tbody>
</table>
