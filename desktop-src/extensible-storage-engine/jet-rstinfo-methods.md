---
description: 'Más información acerca de: JET_RSTINFO métodos'
...
El [JET_RSTINFO](./jet-rstinfo-class.md) muestra los miembros siguientes.
...
<td>Devuelve un <a href="/dotnet/api/system.string">objeto String</a> que representa el objeto <a href="dn335235(v=exchg.10).md">JET_RSTINFO</a>. (Invalida <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object.ToString()</a>).</td>
</tr>
</tbody>
</table>
