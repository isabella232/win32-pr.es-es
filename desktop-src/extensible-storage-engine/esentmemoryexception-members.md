---
description: 'Más información sobre: Miembros de EsentMemoryException'
...
El [tipo EsentMemoryException](./esentmemoryexception-class.md) expone los miembros siguientes.
...
<td>Inicializa una nueva instancia de la clase EsentMemoryException. Este constructor se usa para deserializar una excepción serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
