---
description: 'Más información acerca de: miembros de EsentMemoryException'
title: Miembros de EsentMemoryException
...
ms.locfileid: "104544595"
---
# <a name="esentmemoryexception-members"></a>Miembros de EsentMemoryException
...
El tipo [EsentMemoryException](./esentmemoryexception-class.md) expone los siguientes miembros.
...
<td>Inicializa una nueva instancia de la clase EsentMemoryException. Este constructor se utiliza para deserializar una excepción serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn334638(v=exchg.10).md">EsentMemoryException (cadena, JET_err)</a></td>
<td>Inicializa una nueva instancia de la clase EsentMemoryException.</td>
</tr>
</tbody>
</table>
...
[Clase EsentMemoryException](./esentmemoryexception-class.md)
