---
description: 'Más información sobre: Miembros de EsentBadBookmarkException'
...
Clase base para JET_err. Excepciones de BadBookmark.

El [tipo EsentBadBookmarkException](./esentbadbookmarkexception-class.md) expone los miembros siguientes.
