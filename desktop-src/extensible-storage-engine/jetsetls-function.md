...
|--------------|----------------|
| <p>JET_bitLSCursor</p> | <p>Esta opción indica que el identificador de contexto debe asociarse al cursor especificado.</p><p>Si no JET_bitLSCursor ni JET_bitLSTable se especifica , JET_bitLSCursor se supone que JET_bitLSCursor.</p><p>No es posible usar esta opción con JET_bitLSTable. Se producirá un error en la operación JET_errInvalidgrbit si se intenta.</p> | 
