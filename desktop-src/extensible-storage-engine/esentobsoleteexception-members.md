---
description: 'Más información acerca de: miembros de EsentObsoleteException'
title: Miembros de EsentObsoleteException
...
ms.locfileid: "103813141"
---
# <a name="esentobsoleteexception-members"></a>Miembros de EsentObsoleteException
...
El tipo [EsentObsoleteException](./esentobsoleteexception-class.md) expone los siguientes miembros.
...
<td>Inicializa una nueva instancia de la clase EsentObsoleteException. Este constructor se utiliza para deserializar una excepción serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn319673(v=exchg.10).md">EsentObsoleteException (cadena, JET_err)</a></td>
<td>Inicializa una nueva instancia de la clase EsentObsoleteException.</td>
</tr>
</tbody>
</table>
