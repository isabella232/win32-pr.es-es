...
| <p><strong>Unicode</strong></p> | <p>Se implementa como <strong>JetDetachDatabaseW</strong> (Unicode) y <strong>JetDetachDatabaseA</strong> (ANSI).</p> | 
