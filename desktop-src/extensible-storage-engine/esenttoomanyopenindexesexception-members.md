---
description: 'Más información sobre: Miembros de EsentTooManyOpenIndexesException'
...
El [tipo EsentTooManyOpenIndexesException](./esenttoomanyopenindexesexception-class.md) expone los miembros siguientes.
