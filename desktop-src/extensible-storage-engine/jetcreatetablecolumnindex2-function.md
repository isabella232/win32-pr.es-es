...
| <p>JET_errInvalidLanguageId</p> | <p>Se pasó un identificador de configuración regional (LCID) no válido (ya sea a través del miembro <strong>lcid</strong> de la estructura <a href="gg294097(v=exchg.10).md">JET_UNICODEINDEX al</a> que apunta el miembro <strong>pidxunicode</strong> en la estructura <a href="gg269186(v=exchg.10).md">JET_INDEXCREATE</a> o a través del <strong>campo lcid</strong> de la <a href="gg269186(v=exchg.10).md">estructura JET_INDEXCREATE).</a></p> | 
