---
description: 'Más información sobre: Miembros de EsentRecordDeletedException'
...
Clase base para JET_err. RecordDeleted exceptions( Excepciones de RecordDeleted).
