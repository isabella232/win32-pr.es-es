...
---
# <a name="server2003param-fields"></a>Campos de Server2003Param

Incluir miembros protegidos  
Incluir miembros heredados  

El tipo [Server2003Param](./server2003param-class.md) expone los siguientes miembros.
...
<td>La ruta de acceso completa a cada base de datos se conserva en los registros de transacciones en tiempo de ejecución. Normalmente, estas bases de datos deben permanecer en la ubicación original para que la reproducción de transacciones funcione correctamente. Este parámetro se puede usar para forzar la recuperación tras bloqueo o una operación de restauración para buscar las bases de datos a las que se hace referencia en el registro de transacciones en la carpeta especificada.</td>
</tr>
</tbody>
</table>
