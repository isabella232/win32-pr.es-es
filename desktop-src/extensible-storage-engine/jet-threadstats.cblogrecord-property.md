---
description: 'Más información sobre: JET_THREADSTATS.cbLogRecord'
...
ms.locfileid: "126962795"
---
# <a name="jet_threadstatscblogrecord-property"></a>JET_THREADSTATS.cbLogRecord, propiedad

Obtiene el tamaño total, en bytes, de los registros de transacciones generados por el motor de base de datos en el subproceso actual.
