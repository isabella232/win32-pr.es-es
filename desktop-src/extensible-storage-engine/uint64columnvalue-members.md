---
description: 'Más información sobre: Miembros UInt64ColumnValue'
title: Miembros UInt64ColumnValue
...
ms.locfileid: "120093385"
---
# <a name="uint64columnvalue-members"></a>Miembros UInt64ColumnValue

Incluir miembros protegidos  
Incluir miembros heredados  

Valor [de columna UInt64.](/dotnet/api/system.uint64)

El [tipo UInt64ColumnValue](./uint64columnvalue-class.md) expone los miembros siguientes.
