...
El orden de presentación se usa para ordenar las filas de la tabla temporal. El orden de presentación es [un](./jet-coltyp.md)JET_coltypLong . Si el nivel de información especificado no era un nivel compacto, también se marca como JET_bitColumnTTKey.
...
El tipo de columna es un valor [JET_coltypLong](./jet-coltyp.md).

**columnidCountry**

Identificador de columna del código de país.

El código de país es [un](./jet-coltyp.md)JET_coltypShort .
...
La página de códigos es [un](./jet-coltyp.md)JET_coltypShort .
...
Identificador de columna de *los bits grbits* de la columna. El *campo grbit* es un valor [fijo JET_coltypLong](./jet-coltyp.md). Para obtener más información sobre estos bits, [vea JET_COLUMNDEF](./jet-columndef-structure.md).

Los siguientes son los valores posibles **para columnidgrbit**:
...
El valor predeterminado es [JET_coltypLongBinary](./jet-coltyp.md).

**columnidBaseTableName**

Identificador de columna del nombre de la tabla de la que se derivó la tabla.
...
El nombre de columna [es](./jet-coltyp.md)JET_coltypText .

**columnidDefinitionName**

Identificador de columna del nombre de la definición de columna.

El nombre de la definición de columna es [JET_coltypText](./jet-coltyp.md).
...
La llamada a [JetGetColumnInfo](./jetgetcolumninfo-function.md) o [JetGetTableColumnInfo](./jetgettablecolumninfo-function.md) podría especificar una forma compacta de resultados. Si alguna columna se ha heredado de una tabla de plantilla, los resultados compactos no las almacenarán.
