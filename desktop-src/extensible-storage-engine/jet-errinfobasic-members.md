...
<td>Obtiene o establece la categoría del error.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propiedad pública" alt="Public property" /></td>
<td><a href="dn335344(v=exchg.10).md">errValue</a></td>
<td>Obtiene o establece el valor de error para el nivel de información solicitado.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propiedad pública" alt="Public property" /></td>
...
<td>Obtiene o establece la jerarquía de errores. La posición 0 es el nivel más alto de la jerarquía y el resto se JET_errcatUnknown.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propiedad pública" alt="Public property" /></td>
