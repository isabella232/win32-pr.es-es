...
| <p>JET_errCannotMaterializeForwardOnlySort</p> | <p><strong>Error de JetOpenTempTable3</strong> porque JET_bitTTForwardOnly se especificó y la tabla temporal especificada no se pudo crear mediante la optimización de solo avance. Este error solo lo devolverán Windows Server 2003 y versiones posteriores.</p> | 
