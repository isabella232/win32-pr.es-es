...
<td><p>No se pudo realizar la operación de copia de seguridad porque se llamó fuera de la secuencia. <strong>JetGetLogInfo</strong> devolverá este error si hay identificadores de archivo pendientes creados con <a href="gg269249(v=exchg.10).md">JetOpenFile</a> para la instancia.</p></td>
</tr>
<tr class="even">
...
<td><p>Se implementa como <strong>JetGetLogInfoW</strong> (Unicode) y <strong>JetGetLogInfoA</strong> (ANSI).</p></td>
</tr>
</tbody>
</table>
