...
---
# <a name="doublecolumnvalue-properties"></a>Propiedades de DoubleColumnValue

Incluir miembros protegidos  
Incluir miembros heredados  

El tipo [DoubleColumnValue](./doublecolumnvalue-class.md) expone los siguientes miembros.
...
<td><a href="dn273977(v=exchg.10).md">Tamaño</a></td>
