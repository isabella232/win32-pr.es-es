...
| <p>JET_errInvalidGrbit</p> | <p>Una de las opciones solicitadas no era válida o no se implementó. La función <strong>JetGetRecordSize2</strong> devolverá este error cuando se especifique <em>un grbit</em> no seguro.</p> | 
