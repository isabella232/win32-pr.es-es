...
**Nota** Esta API actuará de todas las maneras como se llama a [JetBeginSession](./jetbeginsession-function.md) en la instancia de la sesión pasada. No se recomienda esta función, [se prefiere JetBeginSession.](./jetbeginsession-function.md)
...
Sesión que se usará como origen para duplicar o comenzar la sesión.
