...
<td><p>La transacción no modificará la base de datos. Si se intenta realizar una actualización, se producirá un error en la operación con JET_errTransReadOnly. Se omite esta opción a menos que se solicite cuando la sesión especificada no está ya en una transacción. Esta opción solo está disponible a partir de Windows XP.</p></td>
</tr>
</tbody>
</table>
