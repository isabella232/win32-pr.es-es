...
---
# <a name="uint16columnvalue-members"></a>Miembros de UInt16ColumnValue

Incluir miembros protegidos  
Incluir miembros heredados  

Valor de columna [UInt16](/dotnet/api/system.uint16) .

El tipo [UInt16ColumnValue](./uint16columnvalue-class.md) expone los siguientes miembros.
...
<td><a href="dn351182(v=exchg.10).md">Tamaño</a></td>
