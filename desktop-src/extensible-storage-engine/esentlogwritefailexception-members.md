---
description: 'Más información sobre: Miembros de EsentLogWriteFailException'
...
El [tipo EsentLogWriteFailException](./esentlogwritefailexception-class.md) expone los miembros siguientes.
