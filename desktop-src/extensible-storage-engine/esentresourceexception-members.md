---
description: 'Más información acerca de: miembros de EsentResourceException'
title: Miembros de EsentResourceException
...
ms.locfileid: "104569866"
---
# <a name="esentresourceexception-members"></a>Miembros de EsentResourceException
...
El tipo [EsentResourceException](./esentresourceexception-class.md) expone los siguientes miembros.
...
<td>Inicializa una nueva instancia de la clase EsentResourceException. Este constructor se utiliza para deserializar una excepción serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn350558(v=exchg.10).md">EsentResourceException (cadena, JET_err)</a></td>
<td>Inicializa una nueva instancia de la clase EsentResourceException.</td>
</tr>
</tbody>
</table>
