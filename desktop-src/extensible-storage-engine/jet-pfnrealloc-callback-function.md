...
La JET_PFNREALLOC es una devolución de llamada compatible con [reasignación](/cpp/c-runtime-library/reference/realloc?view=vs-2019) que [usa JetEnumerateColumns](./jetenumeratecolumns-function.md) para asignar memoria para sus búferes de salida.
