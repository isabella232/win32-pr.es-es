...
---
# <a name="jet_threadstatscpagedirtied-property"></a>Propiedad JET_THREADSTATS. cPageDirtied

Obtiene el número total de páginas de base de datos, sin cambios no escritos, modificados por el motor de base de datos en el subproceso actual.
