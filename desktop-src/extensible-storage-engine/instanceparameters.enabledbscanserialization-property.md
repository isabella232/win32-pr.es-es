...
ms.locfileid: "126969196"
---
# <a name="instanceparametersenabledbscanserialization-property"></a>Propiedad InstanceParameters.EnableDBScanSerialization

Obtiene o establece un valor que indica si la serialización de mantenimiento de base de datos está habilitada para las bases de datos que comparten el mismo disco.
