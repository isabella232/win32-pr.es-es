...
La función **JetEndExternalBackupInstance** finaliza una sesión de copia de seguridad externa. Esta API es la última API en una serie de API a las que se debe llamar para ejecutar una copia de seguridad en línea (no basada en VSS) correcta.

**Windows XP: JetEndExternalBackupInstance** se presentó en Windows XP.
...
<p>El autor de la llamada finalizó una copia de seguridad en medio de la secuencia de copia de seguridad sin señalar la intención con <a href="gg294067(v=exchg.10).md">JetStopBackup</a>. Este error es el resultado de un error en el cliente de copia de seguridad en Windows Server 2003 y versiones posteriores. En Windows XP, este error se devuelve para una terminación intencionada de la secuencia de copia de seguridad externa.</p></td>
</tr>
<tr class="odd">
