---
description: 'Más información sobre: Miembros de EsentDbTimeTooNewException'
...
Clase base para JET_err. DbTimeTooNew exceptions.

El [tipo EsentDbTimeTooNewException](./esentdbtimetoonewexception-class.md) expone los miembros siguientes.
