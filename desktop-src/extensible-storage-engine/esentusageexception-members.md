---
description: 'Más información acerca de: miembros de EsentUsageException'
title: Miembros de EsentUsageException
...
ms.locfileid: "104003188"
---
# <a name="esentusageexception-members"></a>Miembros de EsentUsageException
...
El tipo [EsentUsageException](./esentusageexception-class.md) expone los siguientes miembros.
...
<td>Inicializa una nueva instancia de la clase EsentUsageException. Este constructor se utiliza para deserializar una excepción serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn350872(v=exchg.10).md">EsentUsageException (cadena, JET_err)</a></td>
<td>Inicializa una nueva instancia de la clase EsentUsageException.</td>
</tr>
</tbody>
</table>
