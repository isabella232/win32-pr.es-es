...
En algunos casos, los identificadores de columna son el único medio para identificar columnas. Cuando se crea una tabla temporal, sus columnas no tienen nombres, pero la función create devuelve una matriz de id. de columna.
