---
description: 'Más información sobre: Miembros de EsentColumnInUseException'
...
Clase base para JET_err. ColumnInUse excepciones.

El [tipo EsentColumnInUseException](./esentcolumninuseexception-class.md) expone los miembros siguientes.
