...
Recupera un valor de columna de bytes del registro actual. El registro es ese registro asociado a la entrada de índice en la posición actual del cursor.
...
Los datos recuperados de la columna como un byte. Null si la columna es NULL.  
