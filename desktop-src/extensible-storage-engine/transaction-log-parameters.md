...
| Etiqueta | Value |
|--------|-------|
| <p>Valor predeterminado:</p> | <p>"edb"</p> | 
| <p>Escriba:</p> | <p>String</p> | 
...
| <p>Escriba:</p> | <p>JET_GRBIT (entero)</p> | 
| <p>Intervalo válido:</p> | <p>Una opción válida para JetCommitTransaction</p> | 
| <p>Ámbito:</p> | <p>Instancia o sesión</p> | 
| <p>Establezca después <a href="gg269354(v=exchg.10).md">de JetCreateInstance</a>:</p> | <p>Sí</p> | 
...
| Etiqueta | Value |
|--------|-------|
| <p>Valor predeterminado:</p> | <p><strong>Windows 2000:</strong>  Falso</p><p><strong>Windows XP:</strong>  Verdad</p> | 
| <p>Escriba:</p> | <p>Boolean</p> | 
| <p>Intervalo válido:</p> | <p>False, True</p> | 
| <p>Ámbito:</p> | <p>Instancia</p> | 
| <p>Establezca después <a href="gg269354(v=exchg.10).md">de JetCreateInstance</a>:</p> | <p>Sí</p> | 
...
| Etiqueta | Value |
|--------|-------|
| <p>Valor predeterminado:</p> | <p>JET_bitESE98FileNames</p> | 
| <p>Escriba:</p> | <p>JET_GRBIT (entero)</p> | 
...
| Etiqueta | Value |
|--------|-------|
| <p>Valor predeterminado:</p> | <p><strong>Windows 2000, Windows XP y Windows Server 2003:</strong> 80</p><p><strong>Windows Vista:</strong> 126</p> | 
| <p>Escriba:</p> | <p>Entero</p> | 
| <p>Intervalo válido:</p> | <p><strong>Windows 2000, Windows XP y Windows Server 2003:</strong> 80 – 2147483647</p><p><strong>Windows Vista:</strong> 1 – 2147483647</p> | 
| <p>Ámbito:</p> | <p>Instancia</p> | 
| <p>Establezca después <a href="gg269354(v=exchg.10).md">de JetCreateInstance</a>:</p> | <p>Sí</p> | 
| <p>Establezca después <a href="gg294068(v=exchg.10).md">de JetInit</a>:</p> | <p>No</p> | 
| <p>Afecta al diseño físico:</p> | <p>No</p> | 
...
| Etiqueta | Value |
|--------|-------|
| <p>Valor predeterminado:</p> | <p>1024</p> | 
| <p>Escriba:</p> | <p>Entero</p> | 
...
Cuando este parámetro se establece en true, el motor de base de datos creará el siguiente archivo de registro de transacciones a medida que se consuma el archivo de registro de transacciones actual. La intención es minimizar el tiempo dedicado a cambiar de un archivo de registro de transacciones al siguiente bajo una carga de actualización intensa.
...
Las propiedades del volumen host de los archivos de registro de transacciones y su ubicación con respecto a los otros archivos usados por el motor de base de datos pueden afectar considerablemente al rendimiento.
...
| <p>Escriba:</p> | <p>Ruta de acceso de carpeta (cadena)</p> | 
...
Este parámetro es el conmutador maestro que controla la recuperación de bloqueos de una instancia. Si este parámetro se establece en "On", se usará la recuperación de estilo ARIES para poner todas las bases de datos de la instancia en un estado coherente en caso de bloqueo de un proceso o equipo. Si este parámetro se establece en "Desactivado", todas las bases de datos de la instancia se administrarán sin la ventaja de la recuperación de bloqueos. Es decir, si la instancia no se apaga correctamente mediante [JetTerm](./jetterm-function.md) antes de que el proceso salga o se apague la máquina, el contenido de todas las bases de datos de esa instancia se dañará.
...
| Etiqueta | Value |
|--------|-------|
| <p>Valor predeterminado:</p> | <p>"On"</p> | 
| <p>Escriba:</p> | <p>String</p> | 
| <p>Intervalo válido:</p> | <p>De 0 a 259 caracteres</p> | 
| <p>Ámbito:</p> | <p>Instancia</p> | 
| <p>Establezca después <a href="gg269354(v=exchg.10).md">de JetCreateInstance</a>:</p> | <p>Sí</p> | 
| <p>Establezca después <a href="gg294068(v=exchg.10).md">de JetInit</a>:</p> | <p>No</p> | 
| <p>Afecta al diseño físico:</p> | <p>Sí</p> | 
...
Este parámetro indica la ruta de acceso del sistema de archivos relativa o absoluta de la carpeta que contendrá el archivo de punto de comprobación de la instancia. La ruta de acceso debe terminar con un carácter de barra diagonal inversa, lo que indica que la ruta de acceso de destino es una carpeta. El archivo de punto de comprobación es un archivo simple que se mantiene por instancia y que recuerda el archivo de registro de transacciones más antiguo que se debe reproducir para que todas las bases de datos de esa instancia se mantengan en un estado coherente después de un bloqueo. El archivo de punto de comprobación se denomina normalmente EDB. CHK.
