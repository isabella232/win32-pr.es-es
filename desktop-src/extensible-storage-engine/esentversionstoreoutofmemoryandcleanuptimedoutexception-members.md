...
---
# <a name="esentversionstoreoutofmemoryandcleanuptimedoutexception-members"></a>Miembros de EsentVersionStoreOutOfMemoryAndCleanupTimedOutException

Incluir miembros protegidos  
Incluir miembros heredados  

Clase base para JET_err. Excepciones VersionStoreOutOfMemoryAndCleanupTimedOut.

El tipo [EsentVersionStoreOutOfMemoryAndCleanupTimedOutException](./esentversionstoreoutofmemoryandcleanuptimedoutexception-class.md) expone los siguientes miembros.
...
<td>Inicializa una nueva instancia de la clase EsentVersionStoreOutOfMemoryAndCleanupTimedOutException.</td>
</tr>
</tbody>
</table>
...
<td>Obtiene el error de esent subyacente para esta excepción. (Se hereda de <a href="dn274314(v=exchg.10).md">EsentErrorException</a>).</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propiedad pública" alt="Public property" /></td>
...
[Clase EsentVersionStoreOutOfMemoryAndCleanupTimedOutException](./esentversionstoreoutofmemoryandcleanuptimedoutexception-class.md)
