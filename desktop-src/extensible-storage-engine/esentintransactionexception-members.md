...
Clase base para JET_err. Excepciones InTransaction.

El [tipo EsentInTransactionException](./esentintransactionexception-class.md) expone los miembros siguientes.
