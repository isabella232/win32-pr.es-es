---
description: 'Más información sobre: Miembros de EsentTooManyActiveUsersException'
...
El [tipo EsentTooManyActiveUsersException](./esenttoomanyactiveusersexception-class.md) expone los miembros siguientes.
