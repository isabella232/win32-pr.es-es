...
La **JET_COLUMNCREATE** estructura describe una columna para crear en una base de datos.
...
Nombre de la columna que se creará. El nombre debe cumplir los siguientes criterios:
...
Si se ejecuta correctamente, el identificador de columna de la columna recién creada se volverá a pasar en este campo. En caso de error, el valor es indefinido.

**Err**

El **campo err** contendrá el estado de creación de esta columna. Consulte [JetAddColumn para](./jetaddcolumn-function.md) obtener una lista de los valores devueltos probables.
