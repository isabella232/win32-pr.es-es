---
description: 'Más información sobre: Miembros de EsentDatabaseLockedException'
...
Clase base para JET_err. DatabaseLocked exceptions.

El [tipo EsentDatabaseLockedException](./esentdatabaselockedexception-class.md) expone los miembros siguientes.
