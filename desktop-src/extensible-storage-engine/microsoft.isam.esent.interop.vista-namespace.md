...
<td>Niveles de información de columna que se han agregado a la versión vista de ESENT.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292085.pubclass(EXCHG.10).gif" title="Clase pública" alt="Public class" /></td>
<td><a href="dn351274(v=exchg.10).md">VistaColtyp</a></td>
<td>Tipos de columna que se han agregado a la versión vista de ESENT.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292085.pubclass(EXCHG.10).gif" title="Clase pública" alt="Public class" /></td>
<td><a href="dn335350(v=exchg.10).md">VistaGrbits</a></td>
<td>Grbits que se han agregado a la versión vista de ESENT.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292085.pubclass(EXCHG.10).gif" title="Clase pública" alt="Public class" /></td>
<td><a href="dn335284(v=exchg.10).md">VistaParam</a></td>
<td>Parámetros del sistema que se han agregado a la versión vista de ESENT.</td>
</tr>
</tbody>
</table>
...
<td>Contiene estadísticas acumulativas sobre el trabajo realizado por el motor de base de datos en el subproceso actual. Esta información se devuelve a través de JetGetThreadStats.</td>
</tr>
</tbody>
</table>
...
<td>Niveles de información <a href="dn351258(v=exchg.10).md">para JetGetInstanceMiscInfo(JET_INSTANCE, JET_SIGNATURE, JET_InstanceMiscInfo).</a></td>
</tr>
<tr class="even">
<td><img src="../images/hh596136.pubenumeration(exchg.10).gif" title="Enumeración pública" alt="Public enumeration" /></td>
...
<td>Opciones de <a href="dn335341(v=exchg.10).md">JetOSSnapshotPrepareInstance(JET_OSSNAPID, JET_INSTANCE, SnapshotPrepareInstanceGrbit).</a></td>
</tr>
<tr class="even">
<td><img src="../images/hh596136.pubenumeration(exchg.10).gif" title="Enumeración pública" alt="Public enumeration" /></td>
