...
Si se ejecuta correctamente, el cursor se cambia al estado preparado para la actualización deseada o, en el caso de JET_prepCancel, el cursor se revierte al estado no preparado y se descartan los cambios.
