---
description: 'Más información sobre: operadores JET_INSTANCE datos'
title: JET_INSTANCE operadores
...
<td><a href="hh564998(v=exchg.10).md">Igualdad</a></td>
<td>Determina si dos instancias especificadas de JET_INSTANCE son iguales.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Operador público" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Miembro estático" alt="Static member" /></td>
<td><a href="hh557678(v=exchg.10).md">Desigualdad</a></td>
<td>Determina si dos instancias especificadas de JET_INSTANCE no son iguales.</td>
</tr>
</tbody>
</table>
