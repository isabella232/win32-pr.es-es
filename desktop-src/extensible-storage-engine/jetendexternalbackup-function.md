...
La función **JetEndExternalBackup** finaliza una sesión de copia de seguridad externa. Esta función es el último elemento de la API en una serie de elementos de la API a los que se debe llamar para ejecutar una copia de seguridad en línea (no basada en VSS) correcta.
...
<td><p>No se puede completar la operación porque la instancia de que está asociada a la sesión aún no se ha inicializado.</p></td>
</tr>
<tr class="odd">
...
<p>No se puede completar la operación porque la instancia asociada a la sesión encontró un error irrecuperable que requiere el acceso a todos los datos que se revocan para proteger la integridad de los datos.</p></td>
</tr>
<tr class="odd">
...
Si la secuencia de copia de seguridad no se completa en orden y con una llamada correcta a **JetEndExternalBackup**, las copias de seguridad incrementales subsiguientes podrían contener más datos de los esperados por la aplicación.
