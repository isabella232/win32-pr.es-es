---
description: Más información sobre el método Transaction.Rollback
...
ms.locfileid: "118978345"
---
# <a name="transactionrollback-method"></a>Método Transaction.Rollback

Reversión de una transacción. Este objeto debe estar en una transacción.
