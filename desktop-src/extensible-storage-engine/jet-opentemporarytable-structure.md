...
**Windows Vista:** La **JET_OPENTEMPORARYTABLE** se introduce en Windows Vista.
...
Identificador de configuración regional y marcas de normalización que se usarán para comparar los datos de columna de clave Unicode de la tabla temporal.
...
Si este parámetro se establece en 0 o JET_cbKeyMostMin (255), el tamaño máximo de clave y su semántica seguirán siendo idénticos al tamaño máximo de clave admitido por Windows Server 2003 y versiones anteriores. Este parámetro también se puede establecer en un valor mayor como una función del tamaño de página de la base de datos para la instancia (JET_paramDatabasePageSize). Consulte JET_paramKeyMost para obtener más información.
