---
description: 'Más información sobre: Métodos ColumnValueOfStruct <T>'
title: Métodos ColumnValueOfStruct(T)
...
ms.locfileid: "118982555"
---
# <a name="columnvalueofstructt-methods"></a>Métodos \<T\> ColumnValueOfStruct
...
<td>Asegúrese de que los datos recuperados son exactamente el tamaño necesario para la estructura. Se produce una excepción si hay una discrepancia.</td>
</tr>
<tr class="even">
