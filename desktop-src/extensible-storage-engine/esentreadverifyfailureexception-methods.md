---
description: 'Más información sobre: Métodos de EsentReadVerifyFailureException'
...
El [tipo EsentReadVerifyFailureException](./esentreadverifyfailureexception-class.md) expone los miembros siguientes.
