---
description: 'Más información sobre: JET_BKLOGTIME miembros'
title: JET_BKLOGTIME miembros
...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 829defd5af06b3d5c6e06085b9fb3fb48aed8517
ms.sourcegitcommit: d75fc10b9f0825bbe5ce5045c90d4045e3c53243
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 09/13/2021
ms.locfileid: "126887609"
---
# <a name="jet_bklogtime-members"></a>JET_BKLOGTIME miembros

Incluir miembros protegidos  
Incluir miembros heredados  

Describe una fecha y hora en que se produjo una copia de seguridad.

El [JET_BKLOGTIME](./jet-bklogtime-structure2.md) muestra los miembros siguientes.
...
<td>Obtiene un valor que indica si el JET_BKLOGTIME tiene un valor NULL.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propiedad pública" alt="Public property" /></td>
<td><a href="hh596158(v=exchg.10).md">IsSnapshot</a></td>
<td>Obtiene un valor que indica si el JET_BKLOGTIME es para una copia de seguridad de instantáneas.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propiedad pública" alt="Public property" /></td>
<td><a href="hh564416(v=exchg.10).md">IsUtc</a></td>
<td>Obtiene un valor que indica si el JET_BKLOGTIME está en UTC.</td>
</tr>
</tbody>
</table>
...
<td>Genere una representación DateTime de este JET_BKLOGTIME.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Método público" alt="Public method" /></td>
