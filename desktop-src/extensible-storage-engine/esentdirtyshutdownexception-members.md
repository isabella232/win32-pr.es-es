---
description: 'Más información sobre: Miembros de EsentDirtyShutdownException'
...
Clase base para JET_err. Excepciones de DirtyShutdown.

El [tipo EsentDirtyShutdownException](./esentdirtyshutdownexception-class.md) expone los miembros siguientes.
