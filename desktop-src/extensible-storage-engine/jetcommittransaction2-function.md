...
| <p>JET_errInvalidgrbit</p> | <p>Una de las opciones solicitadas no era válida o no se implementó. La función <strong>JetCommitTransaction2</strong> devolverá este error cuando se produzca lo siguiente:</p><ul><li><p>Se especifica <em>un grbit</em> no es así.</p></li><li><p>JET_bitWaitLastLevel0Commit se especificó en combinación con otro <em>grbit</em>.</p></li><li><p>JET_bitWaitAllLevel0Commit se especificó en combinación con otro <em>grbit</em>.</p></li></ul> | 
