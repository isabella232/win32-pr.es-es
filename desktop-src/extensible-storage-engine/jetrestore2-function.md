...
| <p>JET_errRunningInMultiInstanceMode</p> | <p>Error en la operación porque los parámetros implican el modo de instancia única (Windows modo de compatibilidad 2000) y el motor ya está en modo de instancias múltiples.</p> | 
