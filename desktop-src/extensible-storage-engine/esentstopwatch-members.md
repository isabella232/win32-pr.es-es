---
description: 'Más información sobre: Miembros de EsentStopwatch'
...
El [tipo EsentStopwatch](./esentstopwatch-class.md) expone los miembros siguientes.
...
<td>Obtiene un valor que indica si se está ejecutando el temporizador EsentStopwatch.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propiedad pública" alt="Public property" /></td>
<td><a href="dn334930(v=exchg.10).md">ThreadStats</a></td>
<td>Obtiene las estadísticas de trabajo de ESENT totales medidas por la instancia actual.</td>
</tr>
</tbody>
</table>
...
<td>Comienza a medir el trabajo de ESENT.</td>
</tr>
<tr class="even">
...
<td>Detiene la medición del trabajo de ESENT.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Método público" alt="Public method" /></td>
<td><a href="dn334873(v=exchg.10).md">ToString</a></td>
<td>Devuelve una <a href="/dotnet/api/system.string">cadena</a> que representa el <a href="/dotnet/api/system.diagnostics.stopwatch">cronómetro actual.</a> (Invalida <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object.ToString()</a>).</td>
</tr>
</tbody>
</table>
