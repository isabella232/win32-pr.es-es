---
description: 'Más información sobre: métodos JET_HANDLE'
title: Métodos JET_HANDLE
...
ms.locfileid: "104558329"
---
# <a name="jet_handle-methods"></a>Métodos JET_HANDLE

Incluir miembros protegidos  
Incluir miembros heredados  

El tipo de [JET_HANDLE](./jet-handle-structure.md) expone los siguientes miembros.
...
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Método público" alt="Public method" /></td>
<td><a href="hh596213(v=exchg.10).md">Es igual a (JET_HANDLE)</a></td>
