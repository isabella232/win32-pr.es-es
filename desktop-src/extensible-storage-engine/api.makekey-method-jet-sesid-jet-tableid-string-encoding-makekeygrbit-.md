...
---
# <a name="apimakekey-method-jet_sesid-jet_tableid-string-encoding-makekeygrbit"></a>Método API. MakeKey (JET_SESID, JET_TABLEID, cadena, codificación, MakeKeyGrbit)
