...
**Windows Vista: JetGetInstanceMiscInfo** se introdujo en Windows Vista.
...
<td><p><em>pvResult</em> se interpreta como una estructura <a href="gg269340(v=exchg.10).md">JET_SIGNATURE</a> de la secuencia del registro de transacciones asociada a esta instancia.</p></td>
</tr>
</tbody>
</table>
...
<td><p>Se especificó <a href="gg294048(v=exchg.10).md">un JET_INSTANCE</a> no válido o <em>infoLevel</em> no válido.</p></td>
</tr>
</tbody>
</table>
