...
La estructura **JET_DBINFOMISC3** contiene información diversa sobre una base de datos. Esta es la información contenida en el encabezado de la base de datos.
...
Representa la generación de registro mínima necesaria para reproducir los registros. Normalmente, es lo mismo que la generación de puntos de control.
...
Generación del registro actual. Puede ser menor que genMaxRequired si JET_paramWaypointLatency es distinto de cero.
