---
description: 'Más información sobre: JET_RSTMAP miembros'
title: JET_RSTMAP miembros
...
ms.locfileid: "127168390"
---
# <a name="jet_rstmap-members"></a>JET_RSTMAP miembros
...
<td>Obtiene o establece el nombre o la ruta de acceso antiguos de la base de datos. Puede ser NULL si no ha cambiado.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propiedad pública" alt="Public property" /></td>
<td><a href="dn335254(v=exchg.10).md">szNewDatabaseName</a></td>
<td>Obtiene o establece el nombre o la ruta de acceso actuales de la base de datos. No debe ser null.</td>
</tr>
</tbody>
</table>
...
<td>Devuelve un <a href="/dotnet/api/system.string">objeto String</a> que representa el objeto <a href="dn351048(v=exchg.10).md">JET_RSTMAP</a>. (Invalida <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object.ToString()</a>).</td>
</tr>
</tbody>
</table>
