---
description: 'Más información sobre: Función JetEndExternalBackupInstance2'
...
**Windows XP: JetEndExternalBackupInstance2** se introdujo en Windows XP.
...
| <p>JET_bitBackupEndNormal<br />0x0001</p> | <p>La aplicación cliente finalizó la copia de seguridad por completo y finaliza con normalidad.</p> | 
| <p>JET_bitBackupTruncateDone<br />0x0100</p> | <p><strong>Windows Vista:</strong> JET_bitBackupTruncateDone se introdujo en Windows Vista.</p><p>El motor puede marcar los encabezados de base de datos según corresponda (por ejemplo, una copia de seguridad completa completada), aunque no se haya completado la llamada para truncar.</p> | 
...
| <p>JET_errBackupAbortByCaller</p> | <p><strong>Windows XP:</strong> Este valor devuelto se introduce en Windows XP.</p><p>El autor de la llamada finalizó una copia de seguridad en medio de la secuencia de copia de seguridad sin señalar la intención <a href="gg294067(v=exchg.10).md">con JetStopBackup</a>. Este error es el resultado de un error en el cliente de copia de seguridad Windows Server 2003 y versiones posteriores. En Windows XP, este error se devuelve para una terminación intencionada de la secuencia de copia de seguridad externa.</p> | 
