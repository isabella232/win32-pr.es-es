---
description: Más información sobre el método Api.JetCreateIndex2
...
Crea índices sobre datos en una base de datos ese.
...
<!-- end list -->
  ...
  - indexcreates  
    ...
    Matriz de objetos que describen los índices que se crearán.
