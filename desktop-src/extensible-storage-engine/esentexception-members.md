---
description: 'Más información sobre: Miembros de EsentException'
title: Miembros de EsentException (Microsoft.Isam.Esent)
...
ms.locfileid: "127474382"
---
# <a name="esentexception-members"></a>Miembros de EsentException
...
El [tipo EsentException](./esentexception-class.md) expone los miembros siguientes.
...
<td>Inicializa una nueva instancia de la clase EsentException.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn292119(v=exchg.10).md">EsentException(String)</a></td>
<td>Inicializa una nueva instancia de la clase EsentException con un mensaje de error especificado.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn292125(v=exchg.10).md">EsentException(SerializationInfo, StreamingContext)</a></td>
<td>Inicializa una nueva instancia de la clase EsentException. Este constructor se usa para deserializar una excepción serializada.</td>
</tr>
</tbody>
</table>
