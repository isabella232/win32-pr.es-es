---
description: 'Más información sobre: Miembros de EsentIndexDuplicateException'
...
Clase base para JET_err. IndexDuplicar excepciones.

El [tipo EsentIndexDuplicateException](./esentindexduplicateexception-class.md) expone los miembros siguientes.
