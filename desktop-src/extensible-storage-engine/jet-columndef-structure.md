...
|--------------|----------------|
| <p>JET_bitColumnFixed</p> | <p>La columna se fijará. Siempre usará la misma cantidad de espacio en una fila, independientemente de la cantidad de datos que se almacenen en la columna. JET_bitColumnFixed se puede usar con JET_bitColumnTagged. Este bit no se puede usar con valores largos (es <strong>decir, JET_coltypLongText</strong> y <strong>JET_coltypLongBinary</strong>).</p> | 
