---
description: 'Más información sobre: JET_DBINFOMISC.lgposConsistent'
title: JET_DBINFOMISC.lgposConsistent, propiedad
...
Obtiene el lgpos cuando la base de datos se ha hecho coherente. Este valor es null si la base de datos es incoherente.
