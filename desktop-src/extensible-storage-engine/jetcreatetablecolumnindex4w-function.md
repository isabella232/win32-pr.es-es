...
| <p>JET_errUnicodeTranslationFail</p> | <p>Se produjo un error cuando se intentó normalizar una columna Unicode. Esto puede deberse a que se están quedando sin recursos del sistema.</p> | 
