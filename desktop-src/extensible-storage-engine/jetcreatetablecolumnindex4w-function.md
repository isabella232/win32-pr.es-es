...
Puntero a una [JET_TABLECREATE3](./jet-tablecreate3-structure.md) estructura que define la tabla que se va a crear. Consulte [JET_TABLECREATE3](./jet-tablecreate3-structure.md) para obtener más detalles.
...
| <p>JET_errIndexTuplesOneColumnOnly</p> | <p>Se aplica a las versiones de Windows a partir de Windows XP. Un índice de tupla solo puede estar sobre una sola columna (es decir, si el miembro <strong>grbit</strong> de la estructura <a href="gg294082(v=exchg.10).md">JET_INDEXCREATE2</a> JET_bitIndexTuples tiene un valor establecido y el <strong>miembro szKey</strong> de la estructura <a href="gg294082(v=exchg.10).md">JET_INDEXCREATE2</a> especifica más de una columna).</p> | 
