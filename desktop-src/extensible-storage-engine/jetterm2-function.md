...
| <p>JET_bitTermStopBackup</p> | <p>Solicita que se cierre la instancia incluso si actualmente hay una copia de seguridad en curso. Normalmente, una copia de seguridad pendiente provocaría que <a href="gg269298(v=exchg.10).md">JetTerm</a> generara un error JET_errBackupInProgress. Cuando este parámetro no está presente, se supone que su valor JET_bitTermAbrupt.</p> | 
