...
---
# <a name="esentmemoryexception-constructor-string-jet_err"></a>Constructor EsentMemoryException (String, JET_err)

Inicializa una nueva instancia de la clase EsentMemoryException.
