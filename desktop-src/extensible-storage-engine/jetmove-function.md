...
|--------------|----------------|
| <p>JET_MoveFirst</p> | <p>Mueve el cursor a la primera entrada de índice del índice (si existe).</p><p><strong>Nota</strong>   El valor literal de -2147483648 se usa para denotar esta opción. No use este valor como desplazamiento normal o puede producirse un comportamiento no deseado.</p> | 
| <p>JET_MoveLast</p> | <p>Mueve el cursor a la última entrada de índice del índice (si existe).</p><p><strong>Nota</strong>   El valor literal de 2147483647 se usa para indicar esta opción. No use este valor como desplazamiento normal o puede producirse un comportamiento no deseado.</p> | 
...
| <p>JET_errNoCurrentRecord</p> | <p>El cursor no está situado actualmente en una entrada de índice. Para <strong>JetMove</strong>, esto significa que no se encontró una entrada de índice en la ubicación o desplazamiento solicitados en el índice actual.</p> | 
...
Si esta función se realiza correctamente, el cursor se colocará en una entrada de índice que coincida con la ubicación o el desplazamiento solicitados. Si se ha preparado un registro para la actualización, esa actualización se cancelará. Si un intervalo de índice está en vigor y JET_MoveFirst o JET_MoveLast se ha especificado, ese intervalo de índice se cancelará. No se producirá ningún cambio en el estado de la base de datos.

Si se produce un error en esta función, la posición del cursor permanecerá sin cambios a menos que JET_errNoCurrentRecord se devuelva. En ese caso, el cursor se colocará donde se habría situado la entrada de índice que coincide con la ubicación o el desplazamiento solicitados. El cursor se puede mover con respecto a esa posición, pero todavía no está en una entrada de índice válida. Si se ha preparado un registro para la actualización, esa actualización se cancelará. Si un intervalo de índice está en vigor y JET_MoveFirst o JET_MoveLast se ha especificado, ese intervalo de índice se cancelará. No se producirá ningún cambio en el estado de la base de datos.
