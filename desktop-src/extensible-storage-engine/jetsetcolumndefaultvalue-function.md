...
| <p>JET_errTableInUse</p> | <p>Esta tabla especificada está en uso por otra sesión.</p><p><strong>JetSetColumnDefaultValue</strong> requiere acceso exclusivo a una tabla para cambiar el valor predeterminado de la columna para las versiones anteriores a Windows Server 2003.</p> | 
...
El motor de base de datos truncará silenciosamente el valor predeterminado de una columna en 255 bytes para columnas de texto largo y binarias largas.
