...
La JET_SIGNATURE contiene información que identifica de forma única una base de datos o una secuencia de archivo de registro.
...
<td><a href="hh565133(v=exchg.10).md">Igualdad</a></td>
<td>Determina si dos instancias especificadas de JET_SIGNATURE son iguales.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Operador público" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Miembro estático" alt="Static member" /></td>
<td><a href="hh596753(v=exchg.10).md">Desigualdad</a></td>
<td>Determina si dos instancias especificadas de JET_SIGNATURE no son iguales.</td>
</tr>
</tbody>
</table>
