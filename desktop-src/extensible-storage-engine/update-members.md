---
description: 'Más información sobre: Actualización de miembros'
...
Clase que encapsula una actualización en un JET_TABLEID.
...
<td>Devuelve una <a href="/dotnet/api/system.string">cadena</a> que representa la actualización <a href="dn351191(v=exchg.10).md">actual.</a> (Invalida <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object.ToString()</a>).</td>
</tr>
</tbody>
</table>
