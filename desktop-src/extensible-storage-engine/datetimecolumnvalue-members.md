...
---
# <a name="datetimecolumnvalue-members"></a>Miembros de DateTimeColumnValue

Incluir miembros protegidos  
Incluir miembros heredados  

Un valor de columna [GUID](/dotnet/api/system.guid) .

El tipo [DateTimeColumnValue](./datetimecolumnvalue-class.md) expone los siguientes miembros.
...
<td><a href="dn334243(v=exchg.10).md">Tamaño</a></td>
