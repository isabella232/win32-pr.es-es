...
**Windows XP:****JetOSSnapshotPrepare** se introdujo en Windows XP.  
...
| <p>JET_bitContinueAfterThaw</p> | <p>La sesión de instantánea se produce después <a href="gg269229(v=exchg.10).md">de JetOSSnapshotThaw</a> y requerirá una llamada de <a href="gg294136(v=exchg.10).md">función JetOSSnapshotEnd.</a></p> | 
...
| <p>JET_errInvalidParameter</p> | <p>El puntero de identificador de instantánea es NULL o el <em>parámetro grbit</em> no es válido.</p> | 
| <p>JET_errOSSnapshotInvalidSequence</p> | <p>Una sesión de instantánea ya está en curso y no se permite que la operación tenga más de una sesión de instantánea en un momento dado.</p> | 
