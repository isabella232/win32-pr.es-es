...
---
# <a name="esentlogtornwriteduringhardrestoreexception-members"></a>Miembros de EsentLogTornWriteDuringHardRestoreException

Incluir miembros protegidos  
Incluir miembros heredados  

Clase base para JET_err. Excepciones LogTornWriteDuringHardRestore.

El tipo [EsentLogTornWriteDuringHardRestoreException](./esentlogtornwriteduringhardrestoreexception-class.md) expone los siguientes miembros.
...
<td>Inicializa una nueva instancia de la clase EsentLogTornWriteDuringHardRestoreException.</td>
</tr>
</tbody>
</table>
...
<td><a href="/dotnet/api/system.exception.hresult#System_Exception_HResult">Valor</a></td>
<td>(Se hereda de <a href="/dotnet/api/system.exception">Exception</a>).</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propiedad pública" alt="Public property" /></td>
...
[Clase EsentLogTornWriteDuringHardRestoreException](./esentlogtornwriteduringhardrestoreexception-class.md)
