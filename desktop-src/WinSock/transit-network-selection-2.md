...
---
# <a name="transit-network-selection"></a><span data-ttu-id="cebef-103">Selección de red de tránsito</span><span class="sxs-lookup"><span data-stu-id="cebef-103">Transit Network Selection</span></span>

<span data-ttu-id="cebef-104">En esta sección se enumeran los valores usados para la selección de red de tránsito.</span><span class="sxs-lookup"><span data-stu-id="cebef-104">This section lists values used for the transit network selection.</span></span>
