...
---
# <a name="ipv6-enabled-server-code"></a><span data-ttu-id="9ef37-103">Código de IPv6-Enabled Server</span><span class="sxs-lookup"><span data-stu-id="9ef37-103">IPv6-Enabled Server Code</span></span>

<span data-ttu-id="9ef37-104">El código siguiente es el archivo Server. c independiente de IP, que es una versión habilitada para IPv6 del archivo simple. c.</span><span class="sxs-lookup"><span data-stu-id="9ef37-104">The following code is the IP-agnostic Server.c file, which is an IPv6-enabled version of the Simples.c file.</span></span>
