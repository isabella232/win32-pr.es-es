...
---
# <a name="broadband-bearer-capability"></a><span data-ttu-id="91b4a-103">Capacidad de portador de banda ancha</span><span class="sxs-lookup"><span data-stu-id="91b4a-103">Broadband Bearer Capability</span></span>

<span data-ttu-id="91b4a-104">En esta sección se enumeran los valores usados para la capacidad de portador de banda ancha.</span><span class="sxs-lookup"><span data-stu-id="91b4a-104">This section lists the values used for the broadband bearer capability.</span></span>
