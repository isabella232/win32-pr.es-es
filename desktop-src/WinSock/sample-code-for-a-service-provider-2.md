...
---
# <a name="sample-code-for-a-service-provider"></a><span data-ttu-id="2b512-103">Código de ejemplo para un proveedor de servicios</span><span class="sxs-lookup"><span data-stu-id="2b512-103">Sample Code for a Service Provider</span></span>

<span data-ttu-id="2b512-104">Esta sección contiene un ejemplo de código fuente que muestra cómo implementar las funciones de **GetXbyY** con las nuevas funciones de RNR independientes del protocolo.</span><span class="sxs-lookup"><span data-stu-id="2b512-104">This section contains a source code sample that demonstrates how to implement the **GetXbyY** functions using the new, protocol-independent RNR functions.</span></span> <span data-ttu-id="2b512-105">Un desarrollador debe implementar estas funciones como punto de partida.</span><span class="sxs-lookup"><span data-stu-id="2b512-105">A developer should implement these functions as a starting point.</span></span> <span data-ttu-id="2b512-106">Para cumplir con la especificación de Windows Sockets, se necesitan muchas más funciones.</span><span class="sxs-lookup"><span data-stu-id="2b512-106">To comply with the Windows Sockets specification, many more functions are needed.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="2b512-107">No se garantiza que el código siguiente se compile.</span><span class="sxs-lookup"><span data-stu-id="2b512-107">The following code is not guaranteed to compile.</span></span>
