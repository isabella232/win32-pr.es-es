...
-   La máquina host que Internet Explorer debe tener IPv6 instalado y habilitado.
    ...
    -   Al conectarse a la dirección de bucle recuperación IPv6 (::1) o a un destino local de vínculo, no se requiere una dirección IPv6 enrutable.
