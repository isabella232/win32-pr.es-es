...
| [Conexiones directas](direct-connections.md)                                                                 | Identifica cómo trabajar con conexiones directas entre los pares y entre ellos desde las API de agrupación y gráficos del mismo nivel. |
...
| [Liberar datos del mismo nivel](freeing-peer-data.md)                                                                   | Identifica cómo liberar datos llamadas comunes de función de infraestructura del mismo nivel devueltas.                                      |
| [Infraestructura de eventos](peer-events-infrastructure.md)                                                      | Identifica cómo trabajar con los eventos del mismo nivel e interpreta los eventos que definen las API de gráficos y gráficos del mismo nivel.  |
