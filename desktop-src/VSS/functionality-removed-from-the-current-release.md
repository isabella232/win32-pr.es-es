...
-   Ya no se admite el montaje de una instantánea expuesta como un volumen grabable. El **método IVssBackupComponents::RemountReadWrite** ya no está disponible.
