---
description: La participación de un escritor en una operación de copia de seguridad o restauración, y cuál de sus datos se guardan, depende de cuál de sus componentes se incluya explícitamente como parte del documento componentes de copia de seguridad de un solicitante y la relación entre esos componentes y la ruta de acceso lógica de otros componentes dentro del documento de metadatos del escritor.
...
La participación de un escritor en una operación de copia de seguridad o [](vssgloss-e.md) restauración, y cuál de sus datos se guardan, depende de cuál de sus componentes se incluya explícitamente como parte del documento componentes de copia de seguridad de un solicitante y la relación entre esos componentes y la ruta de acceso lógica de otros componentes dentro del documento de metadatos del escritor.
...
Sin embargo, la libertad del solicitante para incluir o excluir un componente determinado en una copia de seguridad o restauración se rige por lo siguiente:
...
Puede encontrar más información sobre estos problemas en los temas siguientes:
...
-   [Trabajar con selectability for restore y subcomponentes](working-with-selectability-for-restore-and-subcomponents.md)
-   [Capacidad de selección y trabajo con propiedades de componente](selectability-and-working-with-component-properties.md)
-   [Dependencias entre componentes administrados por distintos escritores](dependencies-between-components-managed-by-different-writers.md)
