...
> [!Note]  
> Las instantáneas transportables en un clúster no se admiten antes Windows Server 2003 con Service Pack 1 (SP1). Esto solo se admite con LUN compatibles, que tienen al menos una página SCSI Vital Product Data (VPD) 0x83 STORAGE IDENTIFIER de tipo 1,2 o 8, y asociación 0, y los LUN deben mantener un disco básico con \_ particiones de MBR.
