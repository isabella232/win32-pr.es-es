...
## <a name="id2d1dcrendertargets-gdi-transforms-and-right-to-left-language-builds-of-windows"></a>ID2D1DCRenderTargets, transformaciones de GDI y compilaciones de lenguaje de derecha a izquierda de Windows
