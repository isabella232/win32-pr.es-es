---
title: Formato DXGI D1130 no permitido por límites
...
Para las operaciones de Direct2D que se ejecutan en hardware y usan un formato de superficie, el formato de superficie debe ser compatible con el nivel de característica del hardware. Por ejemplo, si el hardware es de nivel de característica 9, es posible que no admita formatos de 16bpp o formatos SRGB, como DXGI \_ FORMAT \_ B8G8R8A8 \_ UNORM \_ SRGB.
