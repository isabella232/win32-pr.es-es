...
Use el efecto brillo para controlar el brillo de la imagen.
...
|-----------------------------------------------------------------------|-----------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| WhitePoint<br/> \_ \_ \_ Punto blanco de la luminosidad de D2D1 \_<br/> | \_Vector D2D1 \_ 2F<br/> {1.0 f, 1.0 f}<br/> | Parte superior de la curva de transferencia de brillo. El punto blanco ajusta la apariencia de las partes más brillantes de la imagen. Esta propiedad es para el valor x y el valor y, en ese orden. Cada uno de los valores de esta propiedad está entre 0 y 1, ambos incluidos. |
| BlackPoint<br/> \_ \_ \_ Punto negro de la luminosidad de D2D1 \_<br/> | \_Vector D2D1 \_ 2F<br/> {0.0 f, 0.0 f}<br/> | Parte inferior de la curva de transferencia de brillo. El punto negro ajusta la apariencia de las partes más oscuras de la imagen. Esta propiedad es para el valor x y el valor y, en ese orden. Cada uno de los valores de esta propiedad está entre 0 y 1, ambos incluidos.   |



 

Este efecto usa los puntos blanco y negro especificados para generar una función de transferencia que se usa para ajustar el mapa de bits. La siguiente ecuación describe la función de transferencia. Las intensidades de entrada se definen entre 0 y 1.

![algoritmo de brillo](images/brightness-formula1.png)

El algoritmo de efecto implementa una ecuación que crea la función de transferencia. Usamos esta función para ajustar los píxeles de la imagen. Los valores x e y del punto negro y el punto blanco son las coordenadas de dos dimensiones que están conectadas para formar la transformación. Cada una de las partes de la ecuación de salida final:

1.  Convierte los datos de imagen del espacio lineal al espacio no lineal usando esta ecuación:![función auxiliar 1](images/brightness-formula2.png)

2.  Ajusta la imagen según estos valores:
    -   la *entrada* es los valores de intensidad de píxeles de la imagen de entrada de 0 a 1.

    -   *PT blanco (x, y)* ubicación de la curva de transformación para intensidades de píxeles más brillantes.

    -   El punto *negro (x, y)* es la ubicación de la curva de transformación para la intensidad de los píxeles atenuados.

3.  Vuelve a convertir los datos de la imagen en el espacio lineal mediante esta ecuación: ![función auxiliar 2](images/brightness-formula3.png)
