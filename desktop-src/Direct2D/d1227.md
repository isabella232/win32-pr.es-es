...
Este mensaje se emite desde la impresión de Direct2D. Indica que una de las siguientes operaciones provocó la necesidad de rasterización:

-   Uso de una capa D2D1 \_ LAYER \_ OPTIONS1 \_ INITIALIZE FROM \_ \_ BACKGROUND.
-   Uso del modo de combinación primitivo SOURCE COPY o cualquier modo de mezcla distinto de SOURCE OVER.
