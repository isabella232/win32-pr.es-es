...
**Nota**   Este método no se admite en Windows Phone y producirá un error cuando se llame a en un dispositivo con código de error 0x8899000b ( No hay ningún dispositivo de representación de hardware disponible para esta operación ). Dado que Windows Phone Emulator la representación de WARP, este método producirá un error cuando se llame en el emulador con un código de error diferente, 0x88982f80 (wincodec \_ err \_ unsupportedpixelformat).
