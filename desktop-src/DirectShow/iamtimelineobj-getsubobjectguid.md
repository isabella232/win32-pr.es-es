...
---
# <a name="iamtimelineobjgetsubobjectguid-method"></a>IAMTimelineObj:: GetSubObjectGUID (método)
...
El `GetSubObjectGUID` método recupera el GUID del subobjeto asociado a este objeto Timeline.
...
Recibe el GUID del subobjeto o GUID \_ null si el objeto no tiene un subobjeto.
