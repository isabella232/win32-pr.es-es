...
El filtro Smart Tee se usa en gráficos de captura de vídeo para dividir la secuencia de vídeo en una secuencia de vista previa y una secuencia de captura. Esto se hace sin copiar datos adicionales. Las clavijas de salida admiten cualquier tipo de medio que se admita en la conexión de nivel inferior.
