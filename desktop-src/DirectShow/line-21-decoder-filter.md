...
El filtro de la versión 1 se usa en microsoft® Windows® 95/98/Me y Windows plataformas 2000. El filtro de la versión 2 está disponible en Microsoft Windows XP y versiones posteriores, y se usa siempre que el representador de mezcla de vídeo está en el gráfico.
