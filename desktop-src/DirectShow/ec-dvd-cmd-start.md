...
---
# <a name="ec_dvd_cmd_start"></a>\_Inicio de \_ cmd de DVD de EC \_

Indica que ha empezado un comando de [navegador de DVD](dvd-navigator-filter.md) .
...
Este evento solo se desencadena si la aplicación establece la marca SendEvents de la **\_ marca de CMD \_ \_ de DVD** en un método [**IDvdControl2**](/windows/desktop/api/Strmif/nn-strmif-idvdcontrol2) que toma una marca de [**marcas de \_ cmd \_ de DVD**](/windows/win32/api/strmif/ne-strmif-dvd_cmd_flags) .
