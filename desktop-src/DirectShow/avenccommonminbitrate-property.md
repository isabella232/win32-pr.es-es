...
Especifica la velocidad de bits mínima, en bits por segundo. Esta propiedad solo se aplica a los modos de codificación de velocidad de bits constante (CBR) y de velocidad de bits variable (VBR).
...
El codificador aplica la velocidad de bits mínima al aumentar la calidad de la codificación según sea necesario.
