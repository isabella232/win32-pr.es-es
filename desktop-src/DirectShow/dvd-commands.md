...
|-------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|
| Reproducción de \_ título                                                                               | Reproducir un título.                                                                | [**PlayTitle**](/windows/desktop/api/Strmif/nf-strmif-idvdcontrol2-playtitle)                                                   |
...
| Búsqueda de \_ tiempo                                                                              | Reproducir en un momento especificado dentro del título actual.                           | [**PlayAtTime**](/windows/desktop/api/Strmif/nf-strmif-idvdcontrol2-playattime)                                                 |
...
| PrevPG \_ Search                                                                            | Vaya al principio del capítulo anterior y reanude la reproducción.                 | [**PlayPrevChapter**](/windows/desktop/api/Strmif/nf-strmif-idvdcontrol2-playprevchapter)                                       |
...
| Búsqueda \_ de NextPG                                                                            | Vaya al inicio del capítulo siguiente y reanude la reproducción.                     | [**PlayNextChapter**](/windows/desktop/api/Strmif/nf-strmif-idvdcontrol2-playnextchapter)                                       |
| Examen \_ hacia delante                                                                             | Reproducir hacia delante a una velocidad de reproducción especificada. La velocidad de reproducción predeterminada es 1,0. | [**PlayForwards**](/windows/desktop/api/Strmif/nf-strmif-idvdcontrol2-playforwards)                                             |
...
| Selección \_ de botón \_ superior, selección de botón \_ \_ inferior, selección del botón \_ \_ izquierdo, selección del botón \_ \_ derecho | Seleccione un botón cuya posición sea relativa al botón seleccionado actualmente. | [**SelectButton**](/windows/desktop/api/Strmif/nf-strmif-idvdcontrol2-selectbutton)                                             |
| Activación de \_ botón                                                                          | Active el botón seleccionado.                                                | [**ActivateButton**](/windows/desktop/api/Strmif/nf-strmif-idvdcontrol2-activatebutton)                                         |
...
| Cambio \_ de secuencia de \_ audio                                                                     | Establezca la secuencia de audio.                                                        | [**SelectAudioStream**](/windows/desktop/api/Strmif/nf-strmif-idvdcontrol2-selectaudiostream)                                   |
| Suba picture \_ Stream \_ Change                                                               | Establezca la secuencia de subaspección; habilitar o deshabilitar la presentación de subaspección.             | [**SeleccioneSubpictureStream.**](/windows/desktop/api/Strmif/nf-strmif-idvdcontrol2-selectsubpicturestream)                         |
...
| Cambio \_ del modo de presentación de audio de Audio de \_ \_ \_ Audio                                                | Establezca el modo de mezcla de audio para el modo de mezcla de audio.                                       | [**SelectKaraokeAudioPresentationMode**](/windows/desktop/api/Strmif/nf-strmif-idvdcontrol2-selectkaraokeaudiopresentationmode) |
