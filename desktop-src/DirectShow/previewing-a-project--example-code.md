...
---
# <a name="previewing-a-project-example-code"></a>Obtener una vista previa de un proyecto: código de ejemplo

\[Esta API no se admite y puede modificarse o no estar disponible en el futuro.\]

En el ejemplo de código siguiente se muestra cómo cargar y obtener una vista previa de un proyecto de [servicios de edición de DirectShow](directshow-editing-services.md) . La comprobación de errores se omite para mayor claridad.
