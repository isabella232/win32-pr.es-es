...
Este evento solo se desencadena si la aplicación establece la marca DVD CMD FLAG SendEvents en un método \_ \_ \_ [**IDvdControl2**](/windows/desktop/api/Strmif/nn-strmif-idvdcontrol2) que toma una marca [**\_ CMD \_ FLAGS de DVD.**](/windows/win32/api/strmif/ne-strmif-dvd_cmd_flags)
