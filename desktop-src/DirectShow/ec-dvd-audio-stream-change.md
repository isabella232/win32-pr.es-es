...
**Valor DWORD** que indica el nuevo número de secuencia de audio del usuario. Los números de secuencia de audio van de 0 a 7. Stream 0xFFFFFFFF indica que no hay ninguna secuencia seleccionada.
