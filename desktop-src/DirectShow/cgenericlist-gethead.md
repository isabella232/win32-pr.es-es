---
description: El método GetHead recupera el elemento en la parte principal de la lista.
...
ms.locfileid: "127062493"
---
# <a name="cgenericlistgethead-method"></a>CGenericList.GetHead (método)

El `GetHead` método recupera el elemento en la parte principal de la lista.
