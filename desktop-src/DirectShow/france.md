...
Los índices de frecuencia de las tablas de Francia no son adecuados para su uso como números de canal.

-   [Windows 7 y versiones posteriores](#windows-7-and-later)
    -   [Asignaciones de difusión de Francia](#france-broadcast-assignments)
    -   [Asignaciones de cable de Francia](#france-cable-assignments)
...
### <a name="france-broadcast-assignments"></a>Asignaciones de difusión de Francia
...
### <a name="france-cable-assignments"></a>Asignaciones de cable de Francia
