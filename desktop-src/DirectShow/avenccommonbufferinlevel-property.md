...
En el caso del vídeo MPEG, esta propiedad define la integridad inicial del comprobador de búfer de vídeo (VBV). Admite la concatenación de secuencias durante la codificación.
