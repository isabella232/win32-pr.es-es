...
-   Antes de que el motor de representación conecte el pin de salida del filtro, llama a [**IResize::p ut \_ MediaType**](iresize-put-mediatype.md) para establecer el tipo de salida. También puede llamar a [**IResize::p ut \_ Size**](iresize-put-size.md) para ajustar el tamaño de salida. Puede llamar a estos dos métodos en cualquier orden, cualquier número de veces, antes de conectar el pin de salida.
