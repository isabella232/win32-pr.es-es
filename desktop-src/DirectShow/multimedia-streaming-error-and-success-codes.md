---
description: Códigos de error y aciertos de streaming multimedia
ms.assetid: 3b7a11d2-55b9-4505-8eb2-46be423c662b
title: Códigos de error y aciertos de streaming multimedia
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118952204"
---
# <a name="multimedia-streaming-error-and-success-codes"></a>Códigos de error y aciertos de streaming multimedia
...
La lista siguiente contiene mensajes de error y notificaciones de éxito para las aplicaciones que usan las interfaces de streaming multimedia. Esta lista no contiene todos los errores posibles; los errores que se muestran se aplican específicamente a la implementación ® DirectShow® Microsoft de las interfaces de streaming multimedia.
...
| MS \_ E \_ NOSEEKING            | 0x80040404       | No se admite la búsqueda para [**este objeto IMultiMediaStream.**](/previous-versions/windows/desktop/api/mmstream/nn-mmstream-imultimediastream)                                                                                                      |
...
| MS \_ E \_ NOTINIT              | 0x80040407       | El objeto no puede aceptar la llamada porque no se ha llamado a su función de inicialización o equivalente.                                                                                        |
