...
El `get_CurrentStream` método recupera el número de secuencia utilizado actualmente por el detector de medios.
...
Recibe el número de secuencia actual.
