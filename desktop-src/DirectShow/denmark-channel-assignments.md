...
---
# <a name="denmark-channel-assignments"></a>Asignaciones de canal de Dinamarca

En este tema se enumeran las tablas de frecuencia usadas para la optimización de TV analógica para Dinamarca.
