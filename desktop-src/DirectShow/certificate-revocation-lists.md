...
1.  Llame **a WMCreateReader para** crear el Windows lector del SDK de formato multimedia.
...
Una vez comprobada la CRL, la aplicación puede almacenarla. También se debe comprobar el número de versión de CRL antes de almacenar para que la aplicación siempre almacene la versión más reciente.
...
| Sección            | Contenido                                                             |
|--------------------|----------------------------------------------------------------------|
| Header             | Número de entradas de 32 bits de CRL versión 32 bits                           |
...
| Firma          | Tipo de firma de 8 bits Longitud de firma de 16 bits Signatura de longitud variable |
...
Cada entrada de revocación es el resumen de 160 bits de un certificado revocado. Compare este resumen con el elemento DigestValue del certificado.
