...
6.  Use el algoritmo hash SHA-1 para hash cada byte del elemento Data del certificado. Cada byte desde el primer carácter de la etiqueta hasta <Data> el último carácter de </Data> la etiqueta de cierre se debe hash. El valor hash se usa para comprobar el certificado en la lista de revocación de certificados (CRL), como se describe en [Listas de revocación de certificados.](certificate-revocation-lists.md)
...
-   *M* es todos los bytes del elemento Data, incluidas las <Data> etiquetas y</Data> que incluyen el elemento .
