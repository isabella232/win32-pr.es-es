...
| DEX_IDS_CLIPTOOSHORT | Los tiempos de medios del clip no son válidos o la secuencia de mapa de bits independiente del dispositivo (DIB) es demasiado corta.<blockquote>[!Note]<br />Si se producen otros errores de representación, este error puede producirse aunque los tiempos de los medios sean válidos.</blockquote><br /> | Ninguno | No aplicable | 
...
| DEX_IDS_BROKEN_DXT | Este efecto no es el tipo correcto o está roto. | CLSID | <strong>BSTR</strong> | 
...
| DEX_IDS_DISK_WRITE_ERROR | Error al escribir el archivo XML en el disco. | Ninguno | No aplicable | 
