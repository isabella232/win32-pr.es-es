...
En Windows XP y versiones posteriores, el representador de mezcla de vídeo 7 (VMR-7) es el representador de vídeo predeterminado. Se denomina VMR-7 porque internamente usa DirectDraw 7. En DirectX 9, hay disponible un filtro similar pero independiente, VMR-9, para su redistribución en sistemas que no son XP. VMR-9 usa Direct3D 9.
...
| Filtrar CLSID | Hay dos CLSID asociados a este filtro:<ul><li>CLSID_VideoMixingRenderer: crea vmr-7. Si no hay suficientes recursos del sistema para crear vmr-7, se produce un error en la <strong>llamada a CoCreateInstance.</strong></li><li>CLSID_VideoRendererDefault: crea vmr-7 si hay recursos del sistema disponibles, o bien se crea el filtro <a href="video-renderer-filter.md">de representador de</a> vídeo antiguo.</li></ul>Use CLSID_VideoMixingRenderer si necesita las funcionalidades específicas de VMR-7. De lo contrario, CLSID_VideoRendererDefault, que es casi seguro que no se producirá un error, ya que vuelve al filtro de representador de vídeo antiguo.<br /> | 
| CLSID de la página de propiedades | No aplicable. | 
