...
3.  Llame **a IUnknown::QueryInterface** para una interfaz específica del tipo de medio de la secuencia. Si quiere representar una secuencia de vídeo, por ejemplo, recupere su [**interfaz IDirectDrawMediaStream.**](/previous-versions/windows/desktop/api/ddstream/nn-ddstream-idirectdrawmediastream) Las interfaces específicas del medio definen métodos adicionales necesarios para aprovechar al máximo las funcionalidades de un formato.
