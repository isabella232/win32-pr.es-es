...
Si el **atributo src** especifica una imagen fija, DES intenta cargar una serie de imágenes fijas para crear una animación. Por ejemplo, si el **atributo src** IMAGE001.BMP, DES busca IMAGE002.BMP, IMAGE003.BMP, IMAGE004.BMP, y así sucesivamente. Suponiendo que existen, se muestran en orden numérico secuencial, a la velocidad especificada por el atributo **de velocidad de** fotogramas.
