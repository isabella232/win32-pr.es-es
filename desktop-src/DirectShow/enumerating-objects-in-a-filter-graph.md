...
Los enumeradores que se de abordan en esta sección siguen el formato estándar que usan las interfaces de enumeración COM. Para obtener más información, vea el tema "IEnumXXXX" en Platform SDK. Para obtener información sobre la enumeración de filtros registrados en el equipo del usuario, pero que aún no están en el gráfico de filtros, vea Enumerar dispositivos [y filtros.](enumerating-devices-and-filters.md)
