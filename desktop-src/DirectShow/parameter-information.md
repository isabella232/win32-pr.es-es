...
-   El **miembro de lugarCaps** indica qué curvas admite este parámetro. Si el tipo de datos es booleano o de enumeración, la única curva que el parámetro puede admitir es "Jump".
