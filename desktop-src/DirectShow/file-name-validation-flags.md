...
| <span id="SFN_VALIDATEF_IGNOREMUTED"></span><span id="sfn_validatef_ignoremuted"></span><dl> <dt>**SFN \_ VALIDATEF \_ IGNOREMUTED**</dt> <dt>0x40</dt> </dl> | Omitir objetos de origen mutados. (Solo es válido en el [**método IAMTimeline::ValidateSourceNames).**](iamtimeline-validatesourcenames.md)<br/>                                                                                |
