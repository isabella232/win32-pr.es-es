---
description: Los siguientes subtipos de vídeo análogos ahora están obsoletos. En su lugar, use la enumeración AnalogVideoStandard.
ms.assetid: 67db7ee1-88ec-4e4f-be5e-8b4a7a652bca
title: Subtipos de vídeo analógico (Dshow.h)
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "117824731"
---
# <a name="analog-video-subtypes"></a>Subtipos de vídeo analógico

Los siguientes subtipos de vídeo análogos ahora están obsoletos. En su [**lugar, use la enumeración AnalogVideoStandard.**](/windows/win32/api/strmif/ne-strmif-analogvideostandard)



| GUID                                                                                                                                                                                                                                                                            | Descripción           |
|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------|
| <span id="MEDIASUBTYPE_AnalogVideo_NTSC_M"></span><span id="mediasubtype_analogvideo_ntsc_m"></span><span id="MEDIASUBTYPE_ANALOGVIDEO_NTSC_M"></span><dl> <dt>**MEDIASUBTYPE \_ AnalogVideo \_ HOLO \_ M**</dt> </dl>         | (M) ESTO<br/>   |
