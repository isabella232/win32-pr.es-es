...
title: Subtipos de vídeo análogo (Dshow.h)
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "127162274"
---
# <a name="analog-video-subtypes"></a>Subtipos de vídeo análogo
...
| GUID                                                                                                                                                                                                                                                                            | Descripción           |
|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------|
| <span id="MEDIASUBTYPE_AnalogVideo_NTSC_M"></span><span id="mediasubtype_analogvideo_ntsc_m"></span><span id="MEDIASUBTYPE_ANALOGVIDEO_NTSC_M"></span><dl> <dt>**MEDIASUBTYPE \_ AnalogVideo \_ HOLO \_ M**</dt> </dl>         | (M) HAN<br/>   |
