...
---
# <a name="idxtjpegget_bordercolor-method"></a>IDxtJpeg:: get \_ BorderColor (método)
...
El `get_BorderColor` método recupera el color del borde alrededor de los bordes del patrón de barrido.
