...
> [!Note]  
> Por razones de brevedad, el código de ejemplo no realiza ninguna comprobación de errores. En una aplicación real, debe comprobar los valores devueltos de las llamadas de método para asegurarse de que no se ha podido realizar ninguna.
