...
El primer parámetro especifica qué flujo se va a controlar, como GUID de categoría de pin. El segundo parámetro proporciona el tipo de medio. El tercer parámetro es un puntero al filtro de captura. Para controlar todas las secuencias de captura del gráfico, establezca el segundo y el tercer parámetro en **NULL.**
...
Comentarios sobre el control stream
