---
description: Especifica el tipo de conversión de análogo a digital (A/D) para una secuencia de audio Dolby Digital. Esta propiedad se aplica a los codificadores de audio Dolby Digital.
...
El valor de esta propiedad es un miembro de la [**enumeración eAVEncDAtoDConverterType.**](/windows/win32/api/codecapi/ne-codecapi-eavencddatodconvertertype)
