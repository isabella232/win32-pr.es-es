---
description: 'Método IAMTimeline::GetInsertMode: no compatible.'
...
ms.locfileid: "108098703"
---
# <a name="iamtimelinegetinsertmode-method"></a>IamTimeline::GetInsertMode (método)
