---
description: 'Método IAMTimelineGroup::IsRecompressFormatDirty: no compatible.'
...
ms.locfileid: "108098623"
---
# <a name="iamtimelinegroupisrecompressformatdirty-method"></a>IamTimelineGroup::IsRecompressFormatDirty (método)
