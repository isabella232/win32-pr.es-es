...
ms.locfileid: "119965025"
---
# <a name="setting-properties-on-sources"></a>Establecer propiedades en orígenes

\[Esta API no se admite y puede modificarse o no estar disponible en el futuro.\]

Al crear un nuevo objeto de origen, hay algunas propiedades que debe establecer y otras que puede establecer opcionalmente. Debe establecer las siguientes propiedades.

-   Las horas de inicio y de detenerse, con respecto al resto de la escala de tiempo. Llame al [**método IAMTimelineObj::SetStartStop.**](iamtimelineobj-setstartstop.md) No establezca horas superpuestas en objetos de origen dentro de la misma pista o provocará un comportamiento indefinido.
-   Archivo multimedia que se usará como clip de origen. Llame a [**IAMTimelineSrc::SetMediaName**](iamtimelinesrc-setmedianame.md).
-   Las horas de inicio y de detenerse del medio, en relación con el archivo de código fuente original. Llame al [**método IAMTimelineSrc::SetMediaTimes.**](iamtimelinesrc-setmediatimes.md) Excepción: si el origen es una imagen fija, no especifique las horas de medios. Para obtener más información sobre los tiempos multimedia, vea [Time in DirectShow Editing Services](time-in-directshow-editing-services.md).
