...
Cuando se define REGISTER PROXY DLL, Rpcproxy.h proporciona control de compilación condicional adicional con \_ \_ PROXY \_ CLSID=*guid*, PROXY \_ CLSID IS= valor explícito \_ de *guid* \_ y CADENA de prefijo ENTRY PREFIX=. Estas definiciones de macro se describen con más detalle en [C-Compiler Definitions for Proxy/Stubs](/windows/desktop/Midl/c-compiler-definitions-for-proxy-stubs) (Definiciones del compilador de C para proxy/stubs) en la Guía del programador de MIDL.
