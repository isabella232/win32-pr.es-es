...
Los programadores suelen crear monikers de clase mediante [**la función CreateClassMoniker**](/windows/desktop/api/Objbase/nf-objbase-createclassmoniker) o [**mediante MkParseDisplayName**](/windows/desktop/api/Objbase/nf-objbase-mkparsedisplayname). (Consulte [**IMoniker::P arseDisplayName para**](/windows/desktop/api/ObjIdl/nf-objidl-imoniker-parsedisplayname) obtener más información).
