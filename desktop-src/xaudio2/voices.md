...
<span id="XAudio2_Voices"></span><span id="xaudio2_voices"></span><span id="XAUDIO2_VOICES"></span>[Voces XAudio2](xaudio2-voices.md)
</dt> <dd>

Presenta voces XAudio2.

</dd> <dt>

<span id="How_to__Use_Submix_Voices"></span><span id="how_to__use_submix_voices"></span><span id="HOW_TO__USE_SUBMIX_VOICES"></span>[Cómo: Usar voces de submezcla](how-to--use-submix-voices.md)
</dt> <dd>

Describe cómo usar voces de submezcla XAudio2.
...
<span id="XAudio2_Volume_and_Pitch_Control"></span><span id="xaudio2_volume_and_pitch_control"></span><span id="XAUDIO2_VOLUME_AND_PITCH_CONTROL"></span>[Control de volumen y tono de XAudio2](xaudio2-volume-and-pitch-control.md)
</dt> <dd>

Describe los métodos disponibles para controlar el volumen y el tono en XAudio2.
