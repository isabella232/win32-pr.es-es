...
El código de error devuelto por XAudio 2.9 cuando no se puede recuperar automáticamente de un cambio en el punto de conexión de audio es [XAUDIO2 \_ E \_ DEVICE \_ INVALIDATED](xaudio2-error-codes.md). Sin embargo, se recomienda que las aplicaciones no codigo de forma hard-code una dependencia en el código de error que tiene un valor específico.
...
Es posible que la aplicación opte por no usar el punto de conexión de audio virtual pasando la marca [**XAUDIO2 \_ NO VIRTUAL AUDIO \_ \_ \_ CLIENT**](xaudio2-boundary-values-and-flags.md) a [**IXAudio2::CreateMasteringVoice**](/windows/win32/api/xaudio2/nf-xaudio2-ixaudio2-createmasteringvoice).
...
### <a name="duration-of-audio-processing-quantum"></a>Duración del procesamiento de audio cuántico
