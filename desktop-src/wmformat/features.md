...
| [Características de códec](codec-features.md)                                         | Describe las características de los códecs Windows Media compatibles directamente con los objetos del SDK Windows Media Format                                    |
...
| [Características de metadatos](metadata-features.md)                                   | Describe las características que admiten metadatos, que es información sobre el archivo y su contenido.                                                               |
