---
title: Introducción a Windows DRM multimedia
description: Introducción a Windows DRM multimedia
...
ms.locfileid: "117846420"
---
# <a name="overview-of-windows-media-drm"></a>Introducción a Windows DRM multimedia

Windows Media Digital Rights Management (DRM) es un sistema para proteger el contenido de Windows Media para que los usuarios no autorizados no puedan acceder a él. Hay tres fases para el ciclo de DRM básico: empaquetado, licencias y lectura.

## <a name="packaging-windows-media-files"></a>Empaquetado de Windows multimedia

Windows DRM multimedia está diseñado para funcionar con archivos Windows multimedia. Un Windows Multimedia es un archivo que se ajusta a la especificación del formato de sistemas avanzados (ASF) y solo contiene audio y vídeo comprimidos mediante los códecs de audio y vídeo multimedia Windows.

Cuando se empaqueta un archivo ASF, se agrega una sección específica de DRM al encabezado. El encabezado DRM contiene un identificador de clave, que identifica el contenido para fines de licencia, y una dirección URL de adquisición de licencias, que es la dirección de una página web que puede emitir licencias para leer el contenido protegido. Hay mucha más información que se puede colocar en el encabezado DRM, pero es opcional. El encabezado DRM está firmado para que se pueda comprobar el empaquetador.
...
[**Acerca de Windows API extendidas del cliente DRM multimedia**](about-the-windows-media-drm-client-extended-apis.md)
</dt> </dl>
