---
title: Identificadores de tipo multimedia para Windows SDK de formato multimedia
description: Obtenga información sobre los identificadores de tipo de medio que se usan para definir el formato de medios que se usa con Windows SDK de formato multimedia.
ms.assetid: 5d903953-cd6b-4fba-b877-8c7ad3aeb87d
keywords:
- Windows SDK de formato multimedia, identificadores de tipo multimedia
- Formato de sistemas avanzados (ASF), identificadores de tipo multimedia
- ASF (formato de sistemas avanzados), identificadores de tipo multimedia
...
ms.locfileid: "119084692"
---
# <a name="media-type-identifiers-for-the-windows-media-format-sdk"></a>Identificadores de tipo multimedia para el SDK Windows Media Format

Debe usar tipos de medios para definir el formato de medios que se usa con Windows SDK de formato multimedia. Para obtener descripciones de los distintos tipos de medios, vea [Tipos de medios](media-types.md).

En la tabla siguiente se enumeran los identificadores globales de todos los tipos de medios admitidos y sus valores GUID correspondientes.



| Identificador de tipo de medio global      | GUID                                 |
|-----------------------------------|--------------------------------------|
...
| WMFORMAT \_ MPEG2Video              | e06d80e3-db46-11cf-b4d1-00805f6cjunto |
...
| WMMEDIASUBTYPE \_ MPEG2 \_ VIDEO      | e06d8026-db46-11cf-b4d1-00805f6cjunto |
...
| Imagen \_ WMMEDIATYPE                | 34A50FD8-8AA5-4386-81FE-A0EFE0488E31 |
| WMMEDIATYPE \_ Script               | 73636d64-0000-0010-8000-00AA00389B71 |
| Texto \_ WMMEDIATYPE                 | 9BBA1EA7-5AB2-4829-BA57-0940209BCF3E |
| Vídeo \_ WMMEDIATYPE                | 73646976-0000-0010-8000-00AA00389B71 |
