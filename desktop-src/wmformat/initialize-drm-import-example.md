...
---
# <a name="initialize-drm-import-example"></a><span data-ttu-id="a5b00-123">Ejemplo de inicialización de importación de DRM</span><span class="sxs-lookup"><span data-stu-id="a5b00-123">Initialize DRM Import Example</span></span>

<span data-ttu-id="a5b00-124">En el ejemplo de código siguiente se muestra cómo inicializar un objeto de escritor DRM para la importación de DRM:</span><span class="sxs-lookup"><span data-stu-id="a5b00-124">The following code example illustrates how to initialize a DRM writer object for DRM Import:</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="a5b00-125">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="a5b00-125">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="a5b00-126">**Ejemplo de creación de una clave de contenido**</span><span class="sxs-lookup"><span data-stu-id="a5b00-126">**Create Content Key Example**</span></span>](create-content-key-example.md)
</dt> <dt>

[<span data-ttu-id="a5b00-127">**Ejemplo de creación de una clave de sesión**</span><span class="sxs-lookup"><span data-stu-id="a5b00-127">**Create Session Key Example**</span></span>](create-session-key-example.md)
</dt> <dt>

[<span data-ttu-id="a5b00-128">**Ejemplos de importación de DRM**</span><span class="sxs-lookup"><span data-stu-id="a5b00-128">**DRM Import Examples**</span></span>](drm-import-examples.md)
</dt> </dl>
