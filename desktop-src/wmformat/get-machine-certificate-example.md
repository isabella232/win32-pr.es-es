...
---
# <a name="get-machine-certificate-example"></a><span data-ttu-id="05d30-124">Obtener ejemplo de certificado de equipo</span><span class="sxs-lookup"><span data-stu-id="05d30-124">Get Machine Certificate Example</span></span>

<span data-ttu-id="05d30-125">En el ejemplo siguiente se muestra cómo recuperar la colección de certificados de equipo:</span><span class="sxs-lookup"><span data-stu-id="05d30-125">The following example shows how to retrieve the machine certificate collection:</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="05d30-126">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="05d30-126">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="05d30-127">**Ejemplos de importación de DRM**</span><span class="sxs-lookup"><span data-stu-id="05d30-127">**DRM Import Examples**</span></span>](drm-import-examples.md)
</dt> </dl>
