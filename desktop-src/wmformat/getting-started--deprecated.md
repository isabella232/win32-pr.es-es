...
---
# <a name="getting-started"></a><span data-ttu-id="3baff-105">Introducción</span><span class="sxs-lookup"><span data-stu-id="3baff-105">Getting Started</span></span>

<span data-ttu-id="3baff-106">Para obtener la documentación actual sobre los códecs de Windows Media y los procesadores de señal digital, consulte [Windows Media Audio y vídeo códec y API de DSP.](/previous-versions//dd464626(v=vs.85))</span><span class="sxs-lookup"><span data-stu-id="3baff-106">For current documentation on Windows Media codecs and digital signal processors, see [Windows Media Audio and Video Codec and DSP APIs.](/previous-versions//dd464626(v=vs.85))</span></span>
