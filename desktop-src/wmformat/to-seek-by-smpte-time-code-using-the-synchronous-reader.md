...
- lectores sincrónicos, buscando por códigos de tiempo de SMPTE
- lectores sincrónicos, códigos de tiempo de SMPTE
...
Para buscar datos en un archivo ASF mediante código de hora SMPTE mediante el lector sincrónico, realice los pasos siguientes.
