...
| [Reproducción de listas de reproducción](playlist-burning.md)                                                           | Describe la característica de reproducción de reproducción de DRM y cómo se admite en Windows SDK de formato multimedia.                               |
