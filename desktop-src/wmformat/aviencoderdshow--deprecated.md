...
description: Para obtener la documentación actual sobre los códecs de Windows Media y los procesadores de señal digital, consulte Windows Media Audio y vídeo códec y API de DSP. | AVIEncoderDShow
ms.assetid: 0e76b042-ee5f-40b0-9cde-735f0e79367e
keywords:
- AVIEncoderDShow formato de Windows Media
topic_type:
- apiref
api_name:
- AVIEncoderDShow
