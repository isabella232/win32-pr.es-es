...
description: Para obtener la documentación actual sobre los códecs de Windows Media y los procesadores de señal digital, consulte Windows Media Audio y vídeo códec y API de DSP. | GetValueAndName
ms.assetid: 8f685fd7-95ac-4e20-b050-b080006d7954
keywords:
- GetValueAndName formato de Windows Media
topic_type:
- apiref
api_name:
- GetValueAndName
