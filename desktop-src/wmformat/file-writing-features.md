...
El escritor admite varias características avanzadas, que se deban tratar en las secciones siguientes.
...
-   [Formatos de entrada, Configuración y extensiones de unidad de datos](input-formats-input-settings-and-data-unit-extensions.md)
