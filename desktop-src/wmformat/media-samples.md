...
---
# <a name="media-samples-windows-media-format-11-sdk"></a>Ejemplos de medios (Windows Media Format SDK 11)
...
[**Entradas, flujos y salidas**](inputs-streams-and-outputs.md)
</dt> </dl>
