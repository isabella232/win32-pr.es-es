...
---
# <a name="create-session-key-example"></a><span data-ttu-id="46910-125">Ejemplo de creación de una clave de sesión</span><span class="sxs-lookup"><span data-stu-id="46910-125">Create Session Key Example</span></span>

<span data-ttu-id="46910-126">La clave de sesión se usa para proteger la clave de contenido.</span><span class="sxs-lookup"><span data-stu-id="46910-126">The session key is used to protect the content key.</span></span> <span data-ttu-id="46910-127">El código siguiente muestra cómo crear una clave de sesión, pero deja los detalles de la generación de claves aleatorias.</span><span class="sxs-lookup"><span data-stu-id="46910-127">The following code demonstrates how to create a session key, but leaves out the details of random key generation.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="46910-128">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="46910-128">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="46910-129">**Ejemplos de importación de DRM**</span><span class="sxs-lookup"><span data-stu-id="46910-129">**DRM Import Examples**</span></span>](drm-import-examples.md)
</dt> </dl>
