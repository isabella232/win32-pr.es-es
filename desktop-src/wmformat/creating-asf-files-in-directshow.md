...
---
# <a name="creating-asf-files-in-directshow-windows-media-format-11-sdk"></a>Creación de archivos ASF en DirectShow (Windows Media Format SDK 11)
...
| [Creación de gráficos de filtro para escribir archivos ASF (QASF)](building-filter-graphs-to-write-asf-files--qasf.md)           | Describe cómo crear gráficos de captura y transcodificación de archivos.                           |
