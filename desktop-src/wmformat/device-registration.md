...
ms.locfileid: "119027933"
---
# <a name="device-registration"></a>Registro de dispositivos

El SDK Windows Media Format proporciona acceso a la base de datos de registro de dispositivos. Esta base de datos está protegida en el equipo cliente y se usa para registrar dispositivos que admiten Windows DRM multimedia 10 para dispositivos de red.
