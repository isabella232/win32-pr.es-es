...
Las ubicaciones predeterminadas que usan los cuadros de diálogo de archivos comunes (por ejemplo, Abrir y Guardar) se han cambiado de la carpeta de documentos a la biblioteca de documentos. El Interfaz de usuario sin cambios, pero el usuario ahora podrá ver, examinar y buscar en la biblioteca mediante varias vistas de organización. Los archivos se guardarán en la ubicación de guardado predeterminada de la biblioteca, a menos que el usuario cambie la ubicación de guardado predeterminada o elija otra carpeta.
