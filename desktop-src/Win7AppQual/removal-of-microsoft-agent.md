...
-   Microsoft no actualizará los componentes de Microsoft Agent, incluidos:
    -   El runtime y las bibliotecas msagent.exe "msagent.exe"
    -   Los caracteres Byte, Genie, Bytedy y Byteo
...
-   [Componentes principales de Microsoft Agent (solo para su uso en Microsoft Windows 95, Windows 98 y Windows NT 4.0)](https://www.microsoft.com/downloads/details.aspx?familyid=E11BF712-7862-45BA-826D-44AE3A11836F)
...
-   [Archivo de caracteres desatrabado](https://www.microsoft.com/downloads/details.aspx?FamilyID=fa36d1d5-d828-494a-ad0a-7b571db5bd2e)
