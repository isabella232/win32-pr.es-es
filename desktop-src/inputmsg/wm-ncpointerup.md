...
ms.locfileid: "127569081"
---
# <a name="wm_ncpointerup-message"></a>WM_NCPOINTERUP mensaje

Se publica cuando un puntero que hizo contacto sobre el área no cliente de una ventana interrumpe el contacto. El mensaje tiene como destino la ventana en la que el puntero realiza el contacto y el puntero se captura implícitamente en la ventana para que la ventana siga recibiendo la entrada del puntero hasta que se interrumpe el contacto, incluida la notificación **de** WM_NCPOINTERUP.
