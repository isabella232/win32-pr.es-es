...
---
# <a name="drop-down-lists--combo-boxes"></a>Lista desplegable Enumera & cuadros combinados
...
-   **No use el cambio de una lista desplegable** o un cuadro combinado a :
    ...
    -   Mostrar dinámicamente otros controles relacionados con el control seleccionado (los[lectores de](inter-accessibility.md) pantalla no pueden detectar tales eventos).
...
-   **Incluya las meta-opciones entre paréntesis.**
    ...
    En este ejemplo, "(None)" es una meta-opción porque no es un valor válido para la opción, sino que describe que no se está utilizando la propia opción.
...
-   **No use iconos innecesarios y poco útiles en las vistas previas.**
...
-   **Seleccione la opción más segura (para evitar la pérdida de datos o el acceso al sistema) y la opción más segura de forma predeterminada.** Si la seguridad y la seguridad no son factores, seleccione la opción más probable o conveniente.
...
-   Escriba la etiqueta como una palabra o frase, no como una frase, y conséctela con dos puntos. **Excepciones:**
    ...
    -   Si una lista desplegable o un cuadro combinado están subordinados a un botón de radio o una casilla y su etiqueta termina con dos puntos, no coloque una etiqueta adicional en el control.
...
-   Use el texto exacto de la etiqueta, incluida su inclusión en mayúsculas, pero no incluya el carácter de subrayado ni los dos puntos de la clave de acceso. incluir lista o cuadro, lo que sea más claro.
...
-   Use el texto exacto de la etiqueta, incluida su inclusión en mayúsculas, pero no incluya el carácter de subrayado ni los dos puntos de la clave de acceso. incluya el cuadro de palabras.
