...
-   Para la redacción del mensaje en el cuadro Buscar, conséctela como una instrucción (por ejemplo, Escriba para buscar) o indique el ámbito de la búsqueda (por ejemplo, Buscar imágenes).
