...
-   Use [el uso de mayúsculas y mayúsculas de estilo oración.](glossary.md) Esto es más adecuado para el tono [de](text-style-tone.md)[Windows](https://msdn.microsoft.com/library/windows/desktop/aa974175.aspx) y el uso de frases cortas para los botones de comando.
...
| **Preferencias**<br/>  | No lo use. Use Opciones en su lugar.<br/>                                                                   | No es aplicable.<br/>  |
| **Propiedades**<br/>   | Muestra los atributos y la configuración de un objeto.<br/>                                                | 'P' o primera 'r'<br/> |
...
| **Configuración**<br/>     | No lo use. Use Opciones en su lugar.<br/>                                                                   | No es aplicable.<br/>  |
