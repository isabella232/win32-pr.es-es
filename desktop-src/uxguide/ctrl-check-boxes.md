...
-   **Considere la posibilidad de usar la opción No volver a mostrar esta opción para permitir a los usuarios suprimir un cuadro de diálogo periódico solo si no <item> hay una alternativa mejor.** Intente determinar con antelación si los usuarios realmente necesitan el cuadro de diálogo. Si lo hacen, muestre siempre el diálogo y, si no lo hace, elimine el diálogo.
...
-   Coloque los controles subordinados a la derecha de o debajo (con sangría, vacíe con la etiqueta de casilla) la casilla y su etiqueta. Finalice la etiqueta de casilla con dos puntos.
...
-   Use expresiones positivas. No frasee una etiqueta para que la selección de una casilla signifique no realizar una acción.
    ...
    -   **Excepción: no vuelva a mostrar las <item> casillas.**
...
-   Describa solo la opción con la etiqueta . Mantenga las etiquetas breves para que sea fácil hacer referencia a ellas en mensajes y documentación. Si la opción requiere una explicación adicional, proporcione la explicación en un [control](./glossary.md) de texto estático mediante oraciones completas y signos de puntuación finales.
    ...
    En este ejemplo, una etiqueta de casilla tiene debajo texto explicativo adicional.
