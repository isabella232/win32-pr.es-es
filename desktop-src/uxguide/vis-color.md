...
Los espacios de color HSL/HSV constan de tres componentes: matiz, saturación y luminosidad o valor. Estos espacios de color se suelen usar en lugar de RGB porque coinciden mejor con la forma en que las personas perciben el color.
...
-   **Hue:** Color básico en la rueda de colores, que va de 0 a 360 grados, donde 0 y 360 grados son rojos.
    ...
    La rueda de color, donde el rojo es 0 grados, el amarillo es de 60 grados, el verde es de 120 grados, el de 180 grados, el azul es de 240 grados y el decoloro es de 300 grados.

-   **Saturación:** Qué puro es el color (frente al desmesado), que va de 0 a 100, donde 100 está totalmente saturado y 0 es gris.
...
El uso eficaz del color puede hacer que la interfaz de usuario (UI) del programa sea más eficaz. El color puede ayudar a los usuarios a comprender ciertos significados de un vistazo. El color también puede hacer que el producto parezca más atractivo y perfeccionado de forma científica.
...
-   **Significado.** El significado de un mensaje se puede resumir a través del color. Por ejemplo, el color se usa a menudo para comunicar el estado en el que el rojo es un problema o error, el amarillo es precaución o advertencia y el verde es bueno.
-   **Estado.** El estado de un objeto se puede indicar a través del color. Por ejemplo, Windows usa color para indicar los estados de selección y de puntero. Los vínculos de las páginas web usan el azul para los elementos novistidos y púrpura para los que se visitan.
...
-   **Énfasis.** El color se puede usar para llamar la atención de los usuarios. Por ejemplo, Windows usa instrucciones principales [azules](text-ui.md) para ayudarles a destacarse del otro texto.

Por supuesto, el color se suele usar en gráficos por motivos puramente éticos. Aunque la decoración es importante, debe elegir los colores de los elementos de la interfaz de usuario principalmente en función de lo que significan, no de su aspecto.
...
Dicho esto, **la interpretación de rojo, amarillo y verde para el estado es coherente globalmente.** Esto se debe a la Convención de tránsito de LA HAYA sobre señales y señales de [carretera,](https://www.unece.org/trans/conventn/signalse.pdf)que define la convención mundial para los semáforos (donde rojo significa detenerse, verde significa continuar y el amarillo significa continuar con precaución). Puede usar estos colores de estado sin preocuparse por las interpretaciones dependientes de la cultura.

Más allá de los colores de estado, Windows asigna significados a los colores en función de la convención, como se muestra en la sección Directrices de este artículo. Asegúrese de que el uso de color del programa sea compatible con estas convenciones de color.
...
![ilustración que muestra los colores principales como se ve normalmente ](images/vis-color-image6.png)

Los colores principales, como se ve con la visión de color normal.

![ilustración en la que se muestran los mismos colores que se ven con la profetía ](images/vis-color-image7.png)
...
Los colores principales, como se ve con Tripia (1 % de la población de hombres).
...
-   **Ubicación.** También se puede usar la ubicación relativa, pero este enfoque es más débil que las alternativas. Para que sea eficaz, la ubicación debe ser estándar y conocida, como con los semáforos.
...
Aunque hay muchos factores complejos en el uso eficaz del color, en la interfaz de usuario de Windows, elegir el color a menudo se reduce a simplemente elegir el color de [tema](glossary.md) adecuado o el [color](glossary.md) del sistema según algunas reglas sencillas. A continuación, los usuarios pueden seleccionar y personalizar estas esquemas de color a medida que lo elijan.

Al hacerlo, no solo se adapta a las preferencias de color de todos los usuarios, sino que se elimina la carga de elegir la combinación de colores perfecta que funciona para todos los tipos, estilos y culturas (lo que, por supuesto, es imposible).

**Si solo hace una cosa...**

Elija los colores seleccionando el color de tema o el color del sistema adecuados. Nunca use el color como método principal de comunicación, sino como método secundario para reforzar el significado visualmente. Diseño mediante wireframes o monocromáticas para ayudar a garantizar que el color es secundario.

### <a name="use-theme-or-system-colors-correctly"></a>Usar los colores del tema o del sistema correctamente

Suponga que los usuarios eligen colores del tema o del sistema en función de sus necesidades personales y que los colores del tema o del sistema se construyen correctamente. En función de esta suposición, si siempre elige colores del tema o del sistema en función de su propósito previsto y empareja los primeros planos con sus fondos asociados, se garantiza que los colores son legibles y respetan los deseo de los usuarios en todos los modos de vídeo, incluido el modo de contraste alto [.](glossary.md) Por ejemplo, se garantiza que el color del sistema de texto de la ventana es legible en el color del sistema de fondo de la ventana.

En concreto, siempre:

-   **Elija colores en función de su propósito.** No elija colores en función de su apariencia actual, ya que el usuario o las versiones futuras de Windows pueden cambiar esa apariencia.
...
-   **No mezcle tipos de color.** Es decir, siempre haga coincidir los colores del tema con sus colores de tema asociados, los colores del sistema con los colores del sistema asociados y los colores de los cables duros con otros colores de cableado. Por ejemplo, no se garantiza que un color de texto del tema sea legible en un fondo cableado.
...
Para determinar si el uso del color del programa es accesible y no se usa como método principal de comunicación, se recomienda usar Las utilidades [De ColorDoctor](https://www.fujitsu.com/global/about/businesspolicy/tech/design/) o [Vischeck](https://www.vischeck.com/) para comprobar:

-   Dependencia general del color mediante el filtro de escala de grises.
-   Problemas específicos de confusión de color mediante los filtros Propiopia, Deuteranopia y Tripia.

Para determinar si el uso del color del programa está programado correctamente, pruebe el programa en los modos siguientes:

-   Temas habilitados mediante el tema predeterminado de Windows.
-   Temas habilitados mediante un tema no predeterminado.
-   Temas deshabilitados ("Estilo clásico de Windows" en la configuración del tema en el elemento Personalization Panel de control).
-   contraste alto negro (texto blanco sobre un fondo negro).
-   contraste alto blanco (texto negro sobre un fondo blanco).

Todos los elementos de pantalla deben ser legibles y aparecer según lo previsto, incluso inmediatamente después de que cambie el modo.
...
-   **Coincide con los colores de primer plano con los colores de fondo asociados.** Se garantiza que los colores de primer plano son legibles solo con respecto a los colores de fondo asociados. No mezcle ni haga coincidir los colores de primer plano con otros colores de fondo, o peor aún, otros colores de primer plano.
-   **No mezcle tipos de color.** Es decir, siempre haga coincidir los colores del tema con sus colores de tema asociados, los colores del sistema con los colores del sistema asociados y los colores de los cables duros con otros colores de cableado. Por ejemplo, no se garantiza que un color de texto del tema sea legible en un fondo cableado.
-   **Si debe usar un color que no sea un tema o color del sistema:**
    -   **Prefiere derivar el color de un tema o color del sistema en lugar de la combinación de su valor.** Use el proceso descrito anteriormente en este artículo, en Uso de otros colores.
    -   **Controle el modo de contraste alto como un caso especial.**
-   **Controle los cambios de tema.** Las ventanas con marcos de ventana estándar y controles comunes controlan automáticamente los cambios de tema. Las ventanas con marcos de ventana personalizados, controles personalizados o de dibujo del propietario, y otro uso de color deben controlar los cambios de tema explícitamente.
    -   **Desarrolladores:** Puede responder a eventos de cambio de tema controlando el mensaje \_ THEMECHANGED de WM.

### <a name="color-meaning"></a>Significado del color

-   Aunque debe usar colores del tema y del sistema (o colores derivados) siempre que pueda, asegúrese de que cualquier otro uso de color sea compatible con el siguiente uso de color en Windows.



| Matiz | Significado | Uso en Windows  |
|--------------------------------------|-------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| azul/verde<br/>                | Marca de Windows<br/>                                                      | Fondo: personal de marca de Windows.<br/>                                                                                                                        |
...
| rojo<br/>                       | error, detenerse, vulnerable, crítico, atención inmediata, restringido<br/> | Fondo: estado, progreso detenido (barras de progreso).<br/> Iconos: error, detenerse, cerrar ventana, eliminar, entrada necesaria, falta, no disponible.<br/>     |
...
| purple<br/>                    | Visitado<br/>                                                            | Primer plano: vínculos visitados (para vínculos dentro de documentos Internet Explorer Windows).<br/>                                                                |



 

-   **Para evitar la comunicación de los significados anteriores, elija los colores que tengan una saturación de media a baja alta y una luminosidad alta o baja.** Los usuarios asocian los significados anteriores a los colores que tienen saturación completa o alta y luminosidad de nivel medio, por lo que puede evitar estas asociaciones eligiendo diferentes colores.
...
-   **Asigne colores de forma predeterminada que sean fáciles de distinguir.** Por lo general, los colores son fáciles de distinguir si están separados entre sí en los espacios de colores HSL/HSV, al tiempo que mantienen un contraste alto con su fondo:
    -   Al elegir colores, se prefieren las oraciones de tríada o los matiz complementarios, pero no los matiz adyacentes.

        ![ilustración que muestra cómo elegir colores de contraste ](images/vis-color-image14.png)

        En este ejemplo, si la primera asignación de color es de color rojo, el color siguiente debe ser azul, verde o cian, pero no debe ser rojo, púrpura, naranja o amarillo.
    ...
    -   Los colores tienen un contraste alto si hay una gran diferencia en su matiz, saturación o luminosidad.
        ...
        En este ejemplo, el color base azul claro contrasta con los fondos con grandes diferencias en matiz, saturación o luminosidad.

    -   El uso de un fondo blanco o muy claro facilita la distinción de los colores de primer plano de contraste.
...
-   **Permitir a los usuarios personalizar estas asignaciones de** color porque la elección de color es subjetiva y una preferencia personal. Si hay muchos colores coordinados, permita a los usuarios cambiarlos como un grupo mediante esquemas de color.
...
![captura de pantalla del mensaje que contiene "barra de oro" ](images/vis-color-image18.png)

En el ejemplo incorrecto, el mensaje hace referencia a la barra de información de Internet Explorer Windows por su color en lugar de por su nombre.
