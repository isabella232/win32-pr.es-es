...
| [**StorageAdapterPipelineCleanup**](/windows/desktop/api/Winbio_adapter/nc-winbio_adapter-pibio_storage_pipeline_cleanup_fn)<br/>             | Ofrece al adaptador Storage la posibilidad de realizar cualquier limpieza como preparación para cerrar la base de datos de plantilla.<br/>                |
