...
description: Funciones, estructuras y otros tipos que puede usar para compilar aplicaciones cliente que interactúan con Windows Biometric Framework.
ms.assetid: 3a4e1aec-b92e-445e-b597-886b01a1b267
keywords:
- Windows API de Plataforma biométrica Windows API de Biometric Framework, referencia de aplicación cliente
ms.topic: article
ms.date: 05/31/2018
...
| Tema                                                                                         | Descripción                                                                                                |
|-----------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|
| [Funciones de aplicación cliente](client-application-functions.md)<br/>                   | Funciones admitidas para el desarrollo de aplicaciones cliente por Windows Biometric Framework API.<br/>  |
...
| [Uniones de aplicaciones cliente](client-application-unions.md)<br/>                         | Uniones admitidas por la API Windows Biometric Framework.<br/>                               |
