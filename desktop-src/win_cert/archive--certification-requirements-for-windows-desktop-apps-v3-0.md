...
description: Versión del documento 3.0Documento fecha 29 de junio de 2012Este documento contiene los requisitos técnicos y los requisitos de idoneidad que debe cumplir una aplicación de escritorio para participar en el Programa de certificación de aplicaciones de escritorio de Windows 8.
...
Este documento contiene los requisitos técnicos y las aptitudes de idoneidad que debe cumplir una aplicación de escritorio para participar en el programa de certificación de Windows 8 aplicaciones de escritorio. Para Windows 7, este programa se conocía como el Windows de logotipos de software.
