---
title: Requisitos de certificación de Windows Desktop Apps v1.1
description: Versión del documento 1.1Documento fecha 26 de enero de 2012Este documento contiene los requisitos técnicos y los requisitos de idoneidad que debe cumplir una aplicación de escritorio para participar en el Programa de certificación de aplicaciones de escritorio de Windows 8.
...
Este documento contiene los requisitos técnicos y los requisitos de idoneidad que debe cumplir una aplicación de escritorio para participar en el Programa de certificación de aplicaciones de escritorio Windows 8 escritorio. Para Windows 7, este programa se conocía como el Windows de logotipos de software.
...
El Windows App Certification Kit se usa para validar el cumplimiento de estos requisitos y reemplaza el WSLK usado para la validación en el programa Windows 7 Software Logo. El Windows App Certification Kit es uno de los componentes incluidos en el kit de desarrollo de Windows software (SDK).
...
1.3 La aplicación no debe cargar archivos DLL arbitrarios para interceptar llamadas API win32 mediante archivos DLL de Microsoft \\ \\ Windows NT Current \\ \\ Windows Version y AppInit \\ de HKLM \_ Software.  
</dl>
