---
title: Requisitos de certificación de archivo Windows Desktop Apps v1.1
...
ms.locfileid: "119592385"
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v11"></a>Archivo: Requisitos de certificación para Windows Desktop Apps v1.1
...
El kit Windows App Certification Kit se usa para validar el cumplimiento de estos requisitos y reemplaza el WSLK usado para la validación en el programa Windows 7 Software Logo. El kit Windows app certification kit es uno de los componentes incluidos en Windows Software Development Kit (SDK).
