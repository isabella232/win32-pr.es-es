...
Este documento contiene los requisitos técnicos y las aptitudes de idoneidad que debe cumplir una aplicación de escritorio para participar en el Programa de certificación de aplicaciones de escritorio de Windows 8 escritorio. Para Windows 7, este programa se conocía como el programa Windows logotipo de software.
...
El Windows App Certification Kit se usa para validar el cumplimiento de estos requisitos y reemplaza el WSLK usado para la validación en el programa Windows 7 Software Logo. El Windows App Certification Kit es uno de los componentes incluidos en Windows Software Development Kit (SDK).
