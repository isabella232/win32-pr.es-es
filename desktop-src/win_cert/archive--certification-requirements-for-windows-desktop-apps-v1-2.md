---
title: Requisitos de certificación de archivo para aplicaciones de escritorio de Windows v 1.2
description: Versión del documento 1.2 fecha del documento 31 de mayo, documento 2012This contiene los requisitos técnicos y las calificaciones de elegibilidad que una aplicación de escritorio debe cumplir para poder participar en el programa de certificación de aplicaciones de escritorio de Windows 8.
...
ms.locfileid: "104359309"
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v12"></a>Archivo: requisitos de certificación para aplicaciones de escritorio de Windows v 1.2
...
|                                                                         |                           |
|-------------------------------------------------------------------------|---------------------------|
| **Nombre de la prueba**                                                           | **Posibles resultados de la prueba** |
| Adhiere a los mensajes del administrador de reinicio del sistema                               | Pass/Fail               |
| Instalación reversible limpia                                                | Pass/Fail/Warning     |
| Prueba de compatibilidad & resistencia                                         | Pass/Fail/Warning     |
| Prueba de archivos firmados digitalmente                                              | Pass/Fail/Warning     |
| Instalar en la prueba de carpetas correcta                                     | Advertencia                   |
| Prueba de sesión multiusuario                                                  | Advertencia                   |
| Prueba de comprobación de la versión del SO                                                | Pass/Fail               |
| Prueba de modo seguro                                                          | Pass/Fail               |
| Compatibilidad con la prueba de Windows x64                                                | Pass/Fail               |
| Prueba de los cambios en las características de seguridad de Windows (analizador de superficie de ataques) | Pass/Fail/Warning     |
| Probar los cambios en las características de seguridad de Windows (analizador binario de BinScope) | Advertencia                   |
...
| 31 de mayo de 2012 | 1.2     | Resultados de la prueba de Resumen agregados<br/> Documento final<br/> | 1.2                                                                          |
