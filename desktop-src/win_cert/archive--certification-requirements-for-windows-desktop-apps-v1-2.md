---
title: Requisitos de certificación de Windows Desktop Apps v1.2
...
ms.locfileid: "127359585"
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v12"></a>Archivo: Requisitos de certificación para Windows Desktop Apps v1.2
...
| Prueba de resistencia & compatibilidad                                         | Pass/Fail/Warning     |
| Prueba de archivos firmados digitalmente                                              | Pass/Fail/Warning     |
| Instalación en la prueba de carpetas correcta                                     | Advertencia                   |
| Prueba de sesión multiusuario                                                  | Advertencia                   |
| Prueba de comprobación de versiones del sistema operativo                                                | Pass/Fail               |
| Caja fuerte de modo de recuperación                                                          | Pass/Fail               |
| Compatibilidad con la prueba Windows x64                                                | Pass/Fail               |
| Prueba de cambios en las características Windows seguridad (Analizador de superficie de ataque) | Pass/Fail/Warning     |
| Prueba de cambios en las características Windows seguridad (BinScope Binary Analyzer) | Advertencia                   |
