...
description: Versión del documento 1.2Documento fecha 31 de mayo de 2012Este documento contiene los requisitos técnicos y los requisitos de idoneidad que debe cumplir una aplicación de escritorio para participar en el Programa de certificación de aplicaciones de escritorio de Windows 8.
...
Este documento contiene los requisitos técnicos y las aptitudes de idoneidad que debe cumplir una aplicación de escritorio para participar en el programa de certificación de Windows 8 aplicaciones de escritorio. Para Windows 7, este programa se conocía como el programa Windows logotipo de software.
...
El Windows App Certification Kit se usa para validar el cumplimiento de estos requisitos y reemplaza el WSLK usado para la validación en el programa Windows 7 Software Logo. El Windows App Certification Kit es uno de los componentes incluidos en el kit de desarrollo de software (SDK) de Windows.
...
1.3 La aplicación no debe cargar archivos DLL arbitrarios para interceptar llamadas API win32 mediante archivos DLL de Microsoft Windows NT CurrentVersion de HKLM \\ Software \\ Windows \\ \\ \\ \_ AppInit.  
</dl>
...
| Caja fuerte modo de recuperación                                                          | Pass/Fail               |
