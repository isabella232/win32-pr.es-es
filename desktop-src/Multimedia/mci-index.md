...
---
# <a name="mci_index-command"></a>\_Comando MCI index

El \_ comando MCI index activa o desactiva la presentación en pantalla. Los dispositivos VCR reconocen este comando.
...
La información que se presenta en la pantalla se controla mediante la marca de \_ Índice del conjunto de VCR \_ de MCI \_ en el comando [MCI \_ set](mci-set.md) .
...
Desactiva la presentación en pantalla.
...
Activa la presentación en pantalla.
