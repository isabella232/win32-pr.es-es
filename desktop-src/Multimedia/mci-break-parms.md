...
Valida el **miembro hwndBreak que** especifica la ventana que debe tener el foco para habilitar la detección de interrupción.

CLAVE DE \_ INTERRUPCIÓN DE MCI \_

Valida el **miembro nVirtKey** que especifica el código de clave virtual que se usará para la clave de interrupción.
