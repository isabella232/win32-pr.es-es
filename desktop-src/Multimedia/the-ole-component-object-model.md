...
ms.locfileid: "119805025"
---
# <a name="the-ole-component-object-model"></a>El modelo de objetos de componente OLE

Los objetos utilizados por la biblioteca AVIFile forman parte del modelo de objetos de componente OLE. Principalmente, esto significa que comparten determinados métodos que facilitan su trabajo, y los valores que devuelven son comunes a la mayoría de los métodos de interfaz OLE.
