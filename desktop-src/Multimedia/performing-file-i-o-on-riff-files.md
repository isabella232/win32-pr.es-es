...
---
# <a name="performing-file-io-on-riff-files"></a><span data-ttu-id="f95a2-112">Realizar e/s de archivos en archivos RIFF</span><span class="sxs-lookup"><span data-stu-id="f95a2-112">Performing File I/O on RIFF Files</span></span>

<span data-ttu-id="f95a2-113">En el ejemplo siguiente se muestra cómo abrir un archivo RIFF para la e/s almacenada en búfer, así como cómo descender, Ascend y leer fragmentos "RIFF".</span><span class="sxs-lookup"><span data-stu-id="f95a2-113">The following example shows how to open a RIFF file for buffered I/O, as well as how to descend, ascend, and read "RIFF" chunks.</span></span>
