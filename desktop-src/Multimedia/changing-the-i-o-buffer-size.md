...
---
# <a name="changing-the-io-buffer-size"></a><span data-ttu-id="89cbf-111">Cambiar el tamaño del búfer de e/s</span><span class="sxs-lookup"><span data-stu-id="89cbf-111">Changing the I/O Buffer Size</span></span>

<span data-ttu-id="89cbf-112">En el ejemplo siguiente se abre un archivo denominado SAMPLE.TXT para la e/s no almacenada en búfer y, a continuación, se habilita la e/s del búfer con un búfer interno de 16 KB mediante la función [**mmioSetBuffer**](/windows/win32/api/mmiscapi/nf-mmiscapi-mmiosetbuffer) .</span><span class="sxs-lookup"><span data-stu-id="89cbf-112">The following example opens a file named SAMPLE.TXT for unbuffered I/O, and then enables buffered I/O with an internal 16K buffer using the [**mmioSetBuffer**](/windows/win32/api/mmiscapi/nf-mmiscapi-mmiosetbuffer) function.</span></span>
