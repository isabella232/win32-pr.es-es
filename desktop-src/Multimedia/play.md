...
| lento            | Se reproduce lentamente. Para determinar la velocidad exacta en un reproductor de videodisc, use la marca "speed" del [comando status.](status.md) Para especificar la velocidad de forma más precisa, use la marca "speed" de este comando. En el caso de los vídeosdiscos, "lento" solo se aplica al formato JPEG.                                                                                                                                                                                            |
