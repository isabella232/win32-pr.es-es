...
-   La [**función acmStreamUnprepareHeader**](/windows/desktop/api/Msacm/nf-msacm-acmstreamunprepareheader) limpia los búferes de origen y destino preparados por **acmStreamPrepareHeader.** Debe llamar a esta función antes de liberar los búferes de origen y de destino.
