...
---
# <a name="incrementing-the-handler-reference-count"></a>Incrementar el recuento de referencias del controlador

El método **AddRef** incrementa el recuento de referencias de controlador de archivo o de secuencia.
