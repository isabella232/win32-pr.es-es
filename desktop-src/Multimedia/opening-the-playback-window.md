...
---
# <a name="opening-the-playback-window"></a><span data-ttu-id="b3df0-104">Abrir la ventana de reproducción</span><span class="sxs-lookup"><span data-stu-id="b3df0-104">Opening the Playback Window</span></span>

<span data-ttu-id="b3df0-105">En el ejemplo siguiente se muestra cómo usar el comando [**MCI \_ Open**](mci-open.md) para establecer una ventana primaria y crear un elemento secundario de esa ventana.</span><span class="sxs-lookup"><span data-stu-id="b3df0-105">The following example shows how to use the [**MCI\_OPEN**](mci-open.md) command to set a parent window and create a child of that window.</span></span>
