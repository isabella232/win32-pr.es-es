...
---
# <a name="retrieving-information-about-a-movie"></a><span data-ttu-id="ac1f1-104">Recuperar información sobre una película</span><span class="sxs-lookup"><span data-stu-id="ac1f1-104">Retrieving Information About a Movie</span></span>

<span data-ttu-id="ac1f1-105">En el ejemplo siguiente se establece el formato de hora en los fotogramas y se obtiene la posición actual si el dispositivo se está reproduciendo con la función [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) .</span><span class="sxs-lookup"><span data-stu-id="ac1f1-105">The following example sets the time format to frames and obtains the current position if the device is playing using the [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) function.</span></span>
