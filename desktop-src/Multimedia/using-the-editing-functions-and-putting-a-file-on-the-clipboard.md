...
---
# <a name="using-the-editing-functions-and-putting-a-file-on-the-clipboard"></a><span data-ttu-id="b5001-106">Usar las funciones de edición y colocar un archivo en el portapapeles</span><span class="sxs-lookup"><span data-stu-id="b5001-106">Using the Editing Functions and Putting a File on the Clipboard</span></span>

<span data-ttu-id="b5001-107">En el ejemplo siguiente se recortan, copian o eliminan segmentos de una matriz de secuencias.</span><span class="sxs-lookup"><span data-stu-id="b5001-107">The following example cuts, copies, or deletes segments from an array of streams.</span></span> <span data-ttu-id="b5001-108">Los flujos de corte y copiados se combinan en un archivo nuevo y se colocan en el portapapeles.</span><span class="sxs-lookup"><span data-stu-id="b5001-108">The cut and copied streams are merged into a new file and placed on the clipboard.</span></span> <span data-ttu-id="b5001-109">Entre las funciones que se usan se incluyen [**EditStreamClone**](/windows/desktop/api/Vfw/nf-vfw-editstreamclone), [**EditStreamCopy**](/windows/desktop/api/Vfw/nf-vfw-editstreamcopy)y [**EditStreamCut**](/windows/desktop/api/Vfw/nf-vfw-editstreamcut).</span><span class="sxs-lookup"><span data-stu-id="b5001-109">The functions used include [**EditStreamClone**](/windows/desktop/api/Vfw/nf-vfw-editstreamclone), [**EditStreamCopy**](/windows/desktop/api/Vfw/nf-vfw-editstreamcopy), and [**EditStreamCut**](/windows/desktop/api/Vfw/nf-vfw-editstreamcut).</span></span>
