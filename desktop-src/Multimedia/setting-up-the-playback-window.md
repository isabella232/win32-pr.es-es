...
En el ejemplo siguiente se buscan las dimensiones necesarias para reproducir un archivo AVI, se crea una ventana correspondiente a ese tamaño y se reproduce el archivo en la ventana con el controlador MCIAVI. Usa la función [**mciSendCommand**](/previous-versions//dd757160(v=vs.85))
