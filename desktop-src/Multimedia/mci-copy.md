...
Puntero a una [**estructura \_ MCI DGV \_ COPY \_ PARMS.**](/windows/desktop/api/Digitalv/ns-digitalv-mci_dgv_copy_parms)
...
Se incluye un número de secuencia de vídeo en el **miembro dwVideoStream** de la estructura identificada *por lpCopy*. Si usa esta marca y también desea copiar audio, también debe usar la marca COPY AUDIO STREAM de MCI \_ \_ \_ \_ DGV. (Si no se especifica ninguna marca, se copian los datos de todas las secuencias de audio y vídeo).
