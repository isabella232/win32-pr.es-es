---
title: Aplicación de ejemplo asincrónica
description: En el ejemplo siguiente se muestra cómo enviar una solicitud de forma asincrónica.
...
---
# <a name="asynchronous-example-application"></a><span data-ttu-id="f2854-103">Aplicación de ejemplo asincrónica</span><span class="sxs-lookup"><span data-stu-id="f2854-103">Asynchronous Example Application</span></span>

<span data-ttu-id="f2854-104">En el ejemplo siguiente se muestra cómo enviar una solicitud de forma asincrónica.</span><span class="sxs-lookup"><span data-stu-id="f2854-104">The following example demonstrated sending a request asynchronously.</span></span>
