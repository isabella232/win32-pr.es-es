---
title: Encabezado de ejemplo asincrónico
description: A continuación se encuentra el archivo de encabezado para la aplicación de ejemplo asincrónica.
...
ms.locfileid: "104268515"
---
# <a name="asynchronous-example-header"></a><span data-ttu-id="7786c-103">Encabezado de ejemplo asincrónico</span><span class="sxs-lookup"><span data-stu-id="7786c-103">Asynchronous Example Header</span></span>

<span data-ttu-id="7786c-104">A continuación se encuentra el archivo de encabezado para la [aplicación de ejemplo asincrónica](asynchronous-example-application.md).</span><span class="sxs-lookup"><span data-stu-id="7786c-104">The following is the header file for the [asynchronous example application](asynchronous-example-application.md).</span></span>
