...
---
# <a name="checking-for-supported-sensor-data-fields"></a>Comprobando los campos de datos del sensor admitidos
...
En el código de ejemplo siguiente se crea una función auxiliar que prueba si el sensor puede proporcionar los tres campos de datos de ejemplo. La función toma un puntero a un sensor como entrada y devuelve un valor booleano, donde **true** indica que el sensor puede proporcionar todos los campos de datos necesarios.
