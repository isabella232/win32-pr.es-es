...
---
# <a name="wpd_functional_category_storage"></a>\_almacenamiento de \_ categoría \_ funcional de WPD

Un \_ \_ \_ objeto funcional de almacenamiento de categoría funcional de WPD encapsula el almacenamiento de archivos físico en el dispositivo.
...
| [\_tipo de almacenamiento de WPD \_](storage-properties.md)                                                         | Obligatorio.                                                                                                                                              |
| [\_tipo de \_ sistema de archivos de almacenamiento de WPD \_ \_](storage-properties.md)                               | Opcional.                                                                                                                                              |
| [\_capacidad de almacenamiento de WPD \_](storage-properties.md)                                                 | Obligatorio.                                                                                                                                              |
| [\_ \_ espacio libre en el almacenamiento \_ de WPD \_ en \_ bytes](storage-properties.md)                        | Opcional.                                                                                                                                              |
| [\_ \_ espacio libre en el almacenamiento \_ de WPD \_ en \_ objetos](storage-properties.md)                    | Opcional.                                                                                                                                              |
| [\_Descripción del almacenamiento de WPD \_](storage-properties.md)                                           | Opcional.                                                                                                                                              |
| [\_número de \_ serie de almacenamiento de WPD \_](storage-properties.md)                                      | Opcional.                                                                                                                                              |
...
|--------------------------------------------------|----------------------|----------------------------------------------------|
| [**\_icono de recurso de WPD \_**](wpd-resource-icon.md) | Opcional.            | Contiene la representación de icono para este almacenamiento. |
