...
---
# <a name="issuing-the-getnumobjects-command"></a><span data-ttu-id="45ab5-103">Emisión del comando GetNumObjects</span><span class="sxs-lookup"><span data-stu-id="45ab5-103">Issuing the GetNumObjects Command</span></span>

<span data-ttu-id="45ab5-104">En el ejemplo de esta sección se invoca el comando MTP de **GetNumObjects** .</span><span class="sxs-lookup"><span data-stu-id="45ab5-104">The example in this section invokes the **GetNumObjects** MTP command.</span></span> <span data-ttu-id="45ab5-105">(Para obtener una descripción completa de este comando y sus parámetros, consulte la [especificación de MTP](https://www.usb.org/sites/default/files/MTPv1_1.zip)).</span><span class="sxs-lookup"><span data-stu-id="45ab5-105">(For a complete description of this command and its parameters, see the [MTP specification](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span></span>

<span data-ttu-id="45ab5-106">Antes de invocar este comando, primero debe configurar los parámetros del comando.</span><span class="sxs-lookup"><span data-stu-id="45ab5-106">Before you invoke this command, you must first set up the command parameters.</span></span>
...
<span data-ttu-id="45ab5-107">Una vez configurados los parámetros, la aplicación invoca el comando.</span><span class="sxs-lookup"><span data-stu-id="45ab5-107">After the parameters are set up, the application invokes the command.</span></span>
...
<span data-ttu-id="45ab5-108">Una vez que la aplicación invoca el comando, procesa la respuesta del controlador MTP.</span><span class="sxs-lookup"><span data-stu-id="45ab5-108">After the application invokes the command, it processes the response from the MTP driver.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="45ab5-109">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="45ab5-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="45ab5-110">Compatibilidad con extensiones MTP</span><span class="sxs-lookup"><span data-stu-id="45ab5-110">Supporting MTP Extensions</span></span>](supporting-mtp-extensions.md)
</dt> </dl>
