...
El método **SetIPortableDeviceKeyCollectionValue** agrega un nuevo valor de **SETIPORTABLEDEVICEKEYCOLLECTIONVALUE** (tipo VT \_ desconocido) o sobrescribe uno existente.
