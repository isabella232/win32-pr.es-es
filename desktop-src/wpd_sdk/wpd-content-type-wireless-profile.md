...
---
# <a name="wpd_content_type_wireless_profile"></a>\_ \_ perfil inalámbrico de tipo de contenido de \_ WPD \_

Objeto que describe su tipo como el tipo de contenido de WPD el \_ \_ \_ \_ perfil inalámbrico representa la información que se usa para tener acceso a una red inalámbrica.
...
|--------------------------------------------------------|-------------------------------------------------------|---------------------------|
| [**\_valor predeterminado del recurso WPD \_**](wpd-resource-default.md) | Obligatorio si el objeto se representa mediante datos binarios. | Contiene los datos binarios. |
