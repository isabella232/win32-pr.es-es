---
description: MENSAJE GENÉRICO \_ DE TIPO DE CONTENIDO \_ \_ \_ WPD
...
ms.locfileid: "119546125"
---
# <a name="wpd_content_type_generic_message"></a>MENSAJE GENÉRICO \_ DE TIPO DE CONTENIDO \_ \_ \_ WPD

Un objeto que describe su tipo como WPD CONTENT TYPE GENERIC MESSAGE representa un mensaje, por \_ \_ ejemplo, SMS, correo \_ \_ electrónico, y así sucesivamente.
...
|--------------------------------------------------------|-------------------------------------------------------|--------------------|
| [**WPD \_ RESOURCE \_ DEFAULT**](wpd-resource-default.md) | Obligatorio si el objeto se admite con datos binarios. | Contiene los datos. |
