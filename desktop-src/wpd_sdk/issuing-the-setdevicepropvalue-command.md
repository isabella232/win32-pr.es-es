...
En el ejemplo de código siguiente se muestra cómo una aplicación WPD transmite los datos después de haber iniciado el comando.
...
En el ejemplo de código siguiente se muestra cómo una aplicación recupera un código de respuesta del dispositivo.
