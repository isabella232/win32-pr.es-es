...
---
# <a name="wpd_content_type_document"></a>\_documento de \_ tipo de contenido de WPD \_

Objeto que describe su tipo como documento de \_ tipo de contenido de WPD \_ \_ representa un documento. Entre los ejemplos se incluye Microsoft Office archivos de Word, Microsoft Office archivos de Excel, archivos de texto sin formato y otros formatos de documentos de propiedad.
...
| [\_URL de \_ origen de medios de WPD \_](object-properties.md)                                                                      | Opcional.                                                                      |
| [\_URL de \_ destino de medios de WPD \_](object-properties.md)                                                                 | Opcional.                                                                      |
| [\_Descripción de medios de WPD \_](object-properties.md)                                                                      | Opcional.                                                                      |
| [\_género multimedia de WPD \_](object-properties.md)                                                                            | Opcional.                                                                      |
| [\_marcador de \_ bytes multimedia de WPD \_](object-properties.md)                                                                   | Opcional.                                                                      |
| [\_GUID de medios de WPD \_](object-properties.md)                                                                             | Opcional.                                                                      |
| [subdescripción de los medios de WPD \_ \_ \_](object-properties.md)                                                                 | Opcional.                                                                      |
| [\_información común de WPD \_](object-properties.md)                                                                     | Se recomienda su uso.                                                                   |
...
|--------------------------------------------------------|----------------------|---------------------------------|
| [**\_valor predeterminado del recurso WPD \_**](wpd-resource-default.md) | Obligatorio             | Contiene el documento físico. |
