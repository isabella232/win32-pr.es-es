...
---
# <a name="wpd_content_type_audio_album"></a>tipo de contenido de WPD \_ \_ \_ álbum de audio \_

Objeto que describe su tipo como tipo de contenido de WPD el \_ \_ \_ \_ álbum de audio representa una colección de archivos de audio. Un álbum de audio es funcionalmente equivalente a una lista de reproducción de archivos de audio, pero se usa para representar un álbum físico para el usuario.
