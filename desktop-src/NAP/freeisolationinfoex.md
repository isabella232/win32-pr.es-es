...
keywords:
- Función NAP de FreeIsolationInfoEx
topic_type:
- apiref
api_name:
- FreeIsolationInfoEx
...
ms.locfileid: "127473833"
---
# <a name="freeisolationinfoex-function"></a>Función FreeIsolationInfoEx
...
Puntero a la estructura [**de datos IsolationInfoEx**](/windows/win32/api/naptypes/ns-naptypes-isolationinfoex) que se liberará.
