---
description: Especifica si el modo alfa para los tipos de vídeo multimedia de color es premultiplicado o directo.
...
---
# <a name="mf_mt_alpha_mode-attribute"></a>Atributo \_ MF MT ALPHA \_ \_ MODE
