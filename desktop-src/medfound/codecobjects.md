...
| <a href="windowsmediaaudiodecoder.md"><strong>Windows Descodificador de audio multimedia</strong></a> | Descodificador que descodifica secuencias codificadas por el codificador Windows media audio. | 
...
| <a href="windowsmediaaudiovoicedecoder.md"><strong>Windows Descodificador de voz de audio multimedia</strong></a> | Descodificador que descodifica secuencias codificadas por el codificador de voz Windows media audio. | 
