---
description: Microsoft Media Foundation se introdujo en Windows Vista como reemplazo de DirectShow. Por supuesto, DirectShow todavía se admite en Windows 7, pero se recomienda a los desarrolladores que usen Media Foundation en sus nuevas aplicaciones multimedia digitales.
...
ms.locfileid: "120012065"
---
# <a name="whats-new-for-media-foundation"></a>Novedades de Media Foundation

Microsoft Media Foundation se introdujo en Windows Vista como reemplazo de DirectShow. Por supuesto, DirectShow todavía se admite en Windows 7, pero se recomienda a los desarrolladores que usen Media Foundation en sus nuevas aplicaciones multimedia digitales.
...
## <a name="better-format-support"></a>Compatibilidad con mejor formato

La canalización de audio y vídeo Media Foundation se implementó en Windows Vista, pero era compatible con un conjunto limitado de formatos y contenedores de archivos, lo que significaba que algunas aplicaciones necesitaban volver a usar tecnologías anteriores, como DirectShow. En Windows 7, Media Foundation los siguientes códecs nuevos, orígenes multimedia y receptores multimedia:
...
| [Escritor de receptores](sink-writer.md)     | El escritor de receptores permite crear archivos multimedia pasando datos sin comprimir o codificados. Por ejemplo, puede usarlo para volver a codificar un archivo de vídeo o para capturar vídeo en directo desde una cámara web a un archivo.                                                                                                         |
...
-   Un nuevo mecanismo para enumerar los orígenes y descodificadores, que incluye valores de mezcciones y una lista preferida o bloqueada. Esta característica mejora la confiabilidad general del sistema. Para obtener más información, vea los temas siguientes:
...
-   Cambios en dll y .lib: [cambios de biblioteca en Windows 7](media-foundation-headers-and-libraries.md)
...
-   [Direct3D 11 Video API es](direct3d-11-video-apis.md) una novedad para Windows 8. Windows 8 Las aplicaciones de escritorio todavía pueden usar Video API de [Direct3D 9,](direct3d-video-apis.md)pero Windows Store debe usar la nueva API de vídeo de Direct3D 11. Para obtener más información sobre Microsoft Direct3D 11 Video, vea [Supporting Direct3D 11 Video Decoding in Media Foundation](supporting-direct3d-11-video-decoding-in-media-foundation.md).
-   Se han realizado actualizaciones y mejoras en las Media Foundation de trabajo. Consulte [Mejoras de cola de trabajo y subprocesos](media-foundation-work-queue-and-threading-improvements.md) para obtener más información.
...
-   Media Foundation no se incluye con las ediciones N y KN de Windows 8. Para obtener más información, vea [Microsoft Windows Media Feature Pack para N y VERSIONES DE DE TODAS las Windows 8 ediciones](https://support.microsoft.com/kb/2703761).
