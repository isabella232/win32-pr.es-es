...
---
# <a name="evrconfig_forcescaling-attribute"></a>\_Atributo ForceScaling de EVRConfig
...
Establecer este atributo tiene el mismo efecto que establecer la marca **MFVideoRenderPrefs \_ FORCESCALING** en EVR. Consulte [**MFVideoRenderPrefs**](/windows/desktop/api/evr/ne-evr-mfvideorenderprefs) para obtener una descripción de esta marca.
