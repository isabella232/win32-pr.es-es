...
![diagrama en el que se muestran cuadros etiquetados de a a c y un códec de hardware: un punto a b y el códec, el códec apunta a b y b apunta a c](images/proxy-mft.png)
