...
---
# <a name="mf_pd_asf_fileproperties_packets-attribute"></a>MF \_ PD \_ ASF \_ \_ atributo de paquetes FILEPROPERTIES

Especifica el número de paquetes en la sección de datos de un archivo de formato de sistema avanzado (ASF).
