---
description: Especifica la cantidad de tiempo, en milisegundos, que se almacenarán en búfer los datos antes de reproducir un archivo de formato de sistemas avanzados (ASF).
