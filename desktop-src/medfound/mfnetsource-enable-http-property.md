...
---
# <a name="mfnetsource_enable_http-property"></a>MFNETSOURCE \_ habilitar \_ propiedad http
...
La constante **MFNETSOURCE \_ enable \_ http** define el GUID para esta clave de propiedad. El identificador de propiedad (PID) es cero.
