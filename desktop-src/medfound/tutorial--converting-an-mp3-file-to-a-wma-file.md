...
En este tutorial se reutiliza la mayor parte del código del tutorial Codificación de un archivo [MP4,](tutorial--encoding-an-mp4-file-.md)por lo que primero debe leer ese tutorial. El único código que difiere es la función `CreateTranscodeProfile` , que crea el perfil de transcodificación.

## <a name="create-the-transcode-profile"></a>Creación del perfil de transcodificación

Un *perfil de transcodificación* describe los parámetros de codificación y el contenedor de archivos. Para WMA, el contenedor de archivos es un archivo de formato de streaming avanzado (ASF). El archivo ASF contiene una secuencia de audio, que se codifica mediante Windows [**Codificador de audio multimedia**](windowsmediaaudioencoder.md).
...
2.  Llame a [**MFTranscodeGetAudioOutputAvailableTypes**](/windows/desktop/api/mfidl/nf-mfidl-mftranscodegetaudiooutputavailabletypes) para obtener una lista de tipos de medios de audio del codificador. Esta función devuelve un puntero [**DE TIPO IMFCollection**](/windows/desktop/api/mfobjects/nn-mfobjects-imfcollection) que representa una colección de punteros [**DE TIPOMEMEDIAMEDIA.**](/windows/desktop/api/mfobjects/nn-mfobjects-imfmediatype)
3.  Elija el tipo de medio de audio que coincida con los requisitos de transcodificación y copie los atributos en un almacén de atributos. En este tutorial, se usa el primer tipo de medio de la lista.
    ...
    -   Consulte el tipo de medio para obtener un puntero a la [**interfazATTRIBUTEAttributes**](/windows/desktop/api/mfobjects/nn-mfobjects-imfattributes) del almacén de atributos del tipo de medio.
    -   Llame [**aATTRIBUTEAttributes::GetCount**](/windows/desktop/api/mfobjects/nf-mfobjects-imfattributes-getcount) para obtener el número de atributos contenidos en el tipo de medio.
    ...
    -   Llame [**aATTRIBUTEAttributes::CopyAllItems**](/windows/desktop/api/mfobjects/nf-mfobjects-imfattributes-copyallitems) para copiar los atributos del tipo de medio en el nuevo almacén de atributos.
