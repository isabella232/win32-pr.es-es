...
---
# <a name="mf_pd_asf_fileproperties_min_packet_size-attribute"></a>MF \_ PD \_ ASF \_ FILEPROPERTIES \_ de \_ tamaño de paquete mín \_ .

Especifica el tamaño mínimo de paquete, en bytes, para un archivo de formato de sistema avanzado (ASF).
