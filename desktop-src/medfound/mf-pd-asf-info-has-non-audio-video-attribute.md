...
---
# <a name="mf_pd_asf_info_has_non_audio_video-attribute"></a>MF \_ PD \_ ASF \_ info \_ tiene \_ un \_ atributo de vídeo que no es audio \_

Especifica si un archivo de formato de sistema avanzado (ASF) contiene secuencias que no son de audio o de vídeo.
...
Este atributo se aplica a los descriptores de presentación para el contenido ASF. Si el valor es **true**, el archivo tiene al menos un flujo que no es de audio o de vídeo. Entre los ejemplos se incluyen secuencias de imágenes, comandos de script y datos arbitrarios personalizados.
