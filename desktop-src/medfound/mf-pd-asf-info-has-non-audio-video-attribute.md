---
description: Especifica si un archivo de formato de sistemas avanzados (ASF) contiene secuencias que no son de audio o vídeo.
...
ms.locfileid: "127269095"
---
# <a name="mf_pd_asf_info_has_non_audio_video-attribute"></a>MF \_ PD \_ ASF INFO HAS NON \_ AUDIO VIDEO \_ \_ \_ \_ attribute
...
Este atributo se aplica a los descriptores de presentación para el contenido de ASF. Si el valor es **TRUE,** el archivo tiene al menos una secuencia que no es audio o vídeo. Entre los ejemplos se incluyen secuencias de imágenes, comandos de script y datos arbitrarios personalizados.
