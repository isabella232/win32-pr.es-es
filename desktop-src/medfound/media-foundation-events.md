...
| [MEAudioSessionFormatChanged](meaudiosessionformatchanged.md)                               | Ha cambiado el formato de audio predeterminado para el dispositivo de audio.                                                                                                   |
| [MEAudioSessionGroupingParamChanged](meaudiosessiongroupingparamchanged.md)                 | Los parámetros de agrupación cambiaron para la sesión de audio.                                                                                                   |
| [MEAudioSessionIconChanged](meaudiosessioniconchanged.md)                                   | Se ha cambiado el icono de sesión de audio.                                                                                                                          |
| [MEAudioSessionNameChanged](meaudiosessionnamechanged.md)                                   | El nombre para mostrar de la sesión de audio ha cambiado.                                                                                                                  |
| [MEAudioSessionServerShutdown](meaudiosessionservershutdown.md)                             | Se Windows sistema de servidor de audio.                                                                                                           |
...
| [MEBufferingStarted](mebufferingstarted.md)                                                 | Un origen multimedia empezó a almacenar en búfer los datos.                                                                                                                   |
...
| [MEEndOfStream](meendofstream.md)                                                           | Lo genera una secuencia multimedia cuando finaliza la secuencia.                                                                                                           |
| [MEError](meerror.md)                                                                       | Indica un error grave.                                                                                                                                 |
| [MEExtendedType](meextendedtype.md)                                                         | Tipo de evento personalizado.                                                                                                                                       |
| [MEIndividualizationCompleted](meindividualizationcompleted.md)                             | La individualización se ha completado.                                                                                                                           |
...
| [MENewPresentation](menewpresentation.md)                                                   | Una nueva presentación está lista para generarse por un origen multimedia.                                                                                                    |
...
| [MEPolicyChanged](mepolicychanged.md)                                                       | Se ha cambiado la directiva de salida de una secuencia.                                                                                                                  |
...
| [MESequencerSourceTopologyUpdated](mesequencersourcetopologyupdated.md)                     | Lo genera el origen del secuenciador cuando el [**método IMFSequencerSource::UpdateTopology**](/windows/desktop/api/mfidl/nf-mfidl-imfsequencersource-updatetopology) se completa de forma asincrónica. |
...
| [MEStreamPaused](mestreampaused.md)                                                         | Lo genera una secuencia multimedia cuando el [**método :P ause**](/windows/desktop/api/mfidl/nf-mfidl-imfmediasource-pause) finaliza de forma asincrónica.                                 |
...
| [METransformDrainComplete](metransformdraincomplete.md)                                     | Enviado por una transformación de Media Foundation (MFT) asincrónica cuando se completa una operación de purga.                                                             |
