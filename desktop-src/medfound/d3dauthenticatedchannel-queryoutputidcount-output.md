...
---
# <a name="d3dauthenticatedchannel_queryoutputidcount_output-structure"></a>Estructura de salida de D3DAUTHENTICATEDCHANNEL \_ QUERYOUTPUTIDCOUNT \_

Contiene la respuesta a una consulta de [**D3DAUTHENTICATEDQUERY \_ OUTPUTIDCOUNT**](d3dauthenticatedquery-outputidcount.md) .
...
El número de identificadores de salida asociados al dispositivo y a la sesión de cifrado especificados.
