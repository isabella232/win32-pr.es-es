...
---
# <a name="d3dauthenticatedchannel_querycryptosession_input-structure"></a>D3DAUTHENTICATEDCHANNEL \_ \_ estructura de entrada QUERYCRYPTOSESSION

Contiene datos de entrada para una consulta de [**D3DAUTHENTICATEDQUERY \_ CRYPTOSESSION**](d3dauthenticatedquery-cryptosession.md) .
