---
description: Puede usar el código siguiente para ver el contenido de un tipo de medio durante la depuración.
...
---
# <a name="media-type-debugging-code"></a><span data-ttu-id="daf34-103">Código de depuración de tipo de medio</span><span class="sxs-lookup"><span data-stu-id="daf34-103">Media Type Debugging Code</span></span>

<span data-ttu-id="daf34-104">Puede usar el código siguiente para ver el contenido de un tipo de medio durante la depuración.</span><span class="sxs-lookup"><span data-stu-id="daf34-104">You can use the following code to view the contents of a media type while debugging.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="daf34-105">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="daf34-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="daf34-106">Atributos de tipo de medio</span><span class="sxs-lookup"><span data-stu-id="daf34-106">Media Type Attributes</span></span>](media-type-attributes.md)
</dt> <dt>

[<span data-ttu-id="daf34-107">Tipos de medios</span><span class="sxs-lookup"><span data-stu-id="daf34-107">Media Types</span></span>](media-types.md)
</dt> <dt>

[<span data-ttu-id="daf34-108">**IMFMediaType**</span><span class="sxs-lookup"><span data-stu-id="daf34-108">**IMFMediaType**</span></span>](/windows/desktop/api/mfobjects/nn-mfobjects-imfmediatype)
</dt> </dl>
