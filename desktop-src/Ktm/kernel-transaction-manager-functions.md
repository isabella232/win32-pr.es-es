...
Las funciones siguientes se usan con las inscciones.
...
| [**PrePrepareComplete**](/windows/desktop/api/Ktmw32/nf-ktmw32-prepreparecomplete)                                   | Indica que este rm ha completado su trabajo de preparación, por lo que otros HSM ahora pueden comenzar sus operaciones de preparación.                                                |
...
| [**RollforwardTransactionManager**](/windows/desktop/api/KtmW32/nf-ktmw32-rollforwardtransactionmanager)              | Recupera el estado de TM de su archivo de registro en el valor de reloj virtual especificado. |
