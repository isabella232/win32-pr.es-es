...
Crea un objeto de enumerador y devuelve un puntero a su interfaz [**IEnumWiaItem2**](-wia-ienumwiaitem2.md) para carpetas con elementos en el árbol [**IWiaItem2**](-wia-iwiaitem2.md) de un dispositivo de adquisición de imágenes de Windows (WIA) 2,0.
...
Especifica un puntero a una categoría para la que se enumeran los nodos secundarios. Si _ * NULL * *, se enumeran todos los nodos secundarios.

</dd> <dt>

*ppIEnumWiaItem2* \[ enuncia\]
</dt> <dd>
