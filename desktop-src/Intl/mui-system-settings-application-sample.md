...
---
# <a name="mui-system-settings-application-sample"></a><span data-ttu-id="a3c31-103">MUI: ejemplo de la aplicación de configuración del sistema</span><span class="sxs-lookup"><span data-stu-id="a3c31-103">MUI: System Settings Application Sample</span></span>

<span data-ttu-id="a3c31-104">La aplicación de ejemplo que se describe en este tema es una sencilla aplicación Hello MUI que admite la configuración del sistema para sus idiomas de interfaz de usuario.</span><span class="sxs-lookup"><span data-stu-id="a3c31-104">The sample application described in this topic is a simple Hello MUI application that supports system settings for its user interface languages.</span></span>
