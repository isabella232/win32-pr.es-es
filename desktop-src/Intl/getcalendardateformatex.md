...
ms.locfileid: "119068225"
---
# <a name="getcalendardateformatex-function"></a>Función GetCalendarDateFormatEx

En desuso. Recupera una cadena de fecha con el formato correcto para la configuración regional especificada utilizando la fecha y el calendario especificados. El usuario puede especificar el formato de fecha corta, el formato de fecha larga, el formato de mes del año o un patrón de formato personalizado.
...
Marcas que especifican las opciones de formato de fecha. Si *lpFormat* no se establece en **NULL,** este parámetro debe establecerse en 0. Si *lpFormat* se establece en **NULL,** la aplicación puede especificar una combinación de los valores siguientes y [LOCALE \_ NOUSEROVERRIDE](locale-nouseroverride.md).
...
Puntero a una cadena de imagen de formato que se usa para formar la cadena de fecha. Los valores posibles de la cadena de imagen de formato se definen en Imágenes de formato [de día, mes, año y era.](day--month--year--and-era-format-pictures.md)
...
[Imágenes de formato de día, mes, año y era](day--month--year--and-era-format-pictures.md)
</dt> <dt>
