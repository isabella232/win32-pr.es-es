...
En Windows Vista y Windows 7, el archivo Dlg del shell de MS se asigna a la interfaz de usuario de MS Deserción si el idioma predeterminado de la interfaz de usuario de la máquina está establecido en japonés (independientemente del idioma de instalación). Dlg de MS Shell se asigna a Microsoft Sans Serif si el idioma predeterminado de la interfaz de usuario de la máquina está establecido en un idioma distinto del japonés.
...
En Windows Me/98/95, dlg de Shell de MS no está pensado para su uso con una aplicación de interfaz de usuario estática y no inglesa que se ejecuta cuando el usuario ha elegido una configuración regional con un juego de caracteres base Windows diferente. En este caso, es posible que el lenguaje de interfaz de usuario de la aplicación no sea compatible con la fuente que se sustituye por dlg de Shell de MS.
