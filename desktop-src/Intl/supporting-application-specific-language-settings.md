...
title: Compatibilidad con Application-Specific idioma Configuración
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "127171889"
---
# <a name="supporting-application-specific-language-settings"></a>Compatibilidad con Application-Specific idioma Configuración
...
En Windows Vista y versiones posteriores, el lenguaje de la aplicación se establece en el nivel de subproceso mediante una llamada a la [**función SetThreadPreferredUILanguages.**](/windows/desktop/api/Winnls/nf-winnls-setthreadpreferreduilanguages)
