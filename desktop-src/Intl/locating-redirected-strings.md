...
En Windows Vista y versiones posteriores, la aplicación DEA usa un valor del Registro neutral del idioma para permitir el acceso a cadenas específicas del idioma almacenadas en una tabla de recursos de cadena. Para obtener más información, vea Crear un recurso de Language-Neutral en [Uso del redireccionamiento de cadenas del Registro.](using-registry-string-redirection.md)
...
Si la aplicación DEA usa un Windows servicio, debe mostrar el nombre para mostrar y la descripción del servicio. Los recursos asociados se de abordan en "Crear recursos de cadena para un servicio Windows" en Uso del redireccionamiento de [cadenas del Registro.](using-registry-string-redirection.md)
