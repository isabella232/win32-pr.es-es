...
La aplicación de ejemplo descrita en este tema es otra aplicación Hello IAM que admite la configuración específica de la aplicación para sus lenguajes de interfaz de usuario y se ejecuta en Windows Vista y versiones posteriores.
