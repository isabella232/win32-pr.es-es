---
description: En el tema se presenta el descodificador de mapa de bits, un componente de códec Windows Imaging Component (WIC) básico que se usa para descodificar archivos de imagen de una secuencia.
...
ms.locfileid: "118711411"
---
# <a name="decoding-overview"></a>Información general sobre lacoding

En el tema se presenta el descodificador de mapa de bits, un componente de códec Windows Imaging Component (WIC) básico que se usa para descodificar archivos de imagen de una secuencia.
