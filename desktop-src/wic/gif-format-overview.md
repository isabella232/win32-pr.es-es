...
En este tema se proporciona información sobre el códec GIF nativo disponible a través Windows Imaging Component (WIC).
...
En la tabla siguiente se enumeran los GUID que se usan para identificar los componentes de códec GIF nativos.
