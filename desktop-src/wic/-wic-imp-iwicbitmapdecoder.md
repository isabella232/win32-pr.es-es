...
Si el formato de imagen contiene una versión preliminar JPEG incrustada, se recomienda encarecidamente que, en lugar de escribir un descodificador JPEG para descodificarlo, delegue al descodificador JPEG que se incluye con la plataforma WIC para descodificar vistas previas y miniaturas. Para ello, busque al principio de los datos de la imagen de vista previa en la secuencia e invoque el [**método CreateDecoderFromStream**](/windows/desktop/api/Wincodec/nf-wincodec-iwicimagingfactory-createdecoderfromstream) en [**IWICImagingFactory**](/windows/desktop/api/Wincodec/nn-wincodec-iwicimagingfactory).
