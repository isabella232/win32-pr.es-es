...
Debe implementar esta interfaz en la clase decoding de nivel de marco. También es posible que tenga que implementarlo en la clase de descodificador de nivel de contenedor si el formato de imagen expone metadatos globales fuera de los fotogramas de imagen individuales.
...
[**GetContainerFormat**](/windows/desktop/api/Wincodecsdk/nf-wincodecsdk-iwicmetadatablockreader-getcontainerformat) es el mismo que el [método GetContainerFormat](-wic-imp-iwicbitmapdecoder.md) de [Implementing IWICBitmapDecoder](-wic-imp-iwicbitmapdecoder.md).
