---
description: Este documento contiene una lista de los códigos de error Windows Imaging Component (WIC) definidos.
...
ms.locfileid: "118207264"
---
# <a name="codec-error-codes"></a>Códigos de error de códec

Este documento contiene una lista de los códigos de error Windows Imaging Component (WIC) definidos.
...
En la tabla siguiente se muestra una lista de los códigos de error usados por los WICAPIs ordenados alfabéticamente. 
...
| ERROR DE WINCODEC \_ \_ ALREADYLOCKED                    | 0x88982f0D                       |
...
| CODECPRESENT DE \_ ERROR DE WINCODEC \_                     | 0x88982f43                       |
| \_ \_ CÓDECTOOMANYSCANLINES DE ERROR DE WINCODEC            | 0x88982f46                       |
| COMPONENTE ERR \_ DE WINCODECINITIALIZEFAILURE \_       | 0x88982f8B                       |
| COMPONENTE ERR \_ DE WINCODECNOTFOUND \_                | 0x88982f50                       |
| ERROR DE WINCODEC \_ \_ DUPLICATEMETADATAPRESENT         | 0x88982f8D                       |
| ERROR \_ \_ FRAMEMISSING DE WINCODEC                     | 0x88982f62                       |
...
| ERROR \_ INSUFFICIENTBUFFER de WINCODEC \_               | 0x88982f8C                       |
...
| ERROR INESPERADO \_ DE WINCODECMETADATATYPE \_           | 0x88982f91                       |
| ERROR DE WINCODEC \_ \_ UNEXPECTEDSIZE                   | 0x88982f8F                       |
| ERROR DE WINCODEC \_ \_ UNSUPPORTEDOPERATION             | 0x88982f81                       |
| ERROR DE WINCODEC \_ \_ NO COMPATIBLEPIXELFORMAT           | 0x88982f80                       |
...
| ERROR \_ WRONGSTATE de WINCODEC \_                       | 0x88982f04                       |
...
En la tabla siguiente se muestra una lista de los códigos de error usados por los WICAPIs ordenados en orden numérico. 
...
| 0x88982f73                       | SECUENCIA DE \_ ERROR DE WINCODECNOTAVAILABLE \_               |
...
| 0x88982f91                       | ERROR INESPERADO DE \_ WINCODECMETADATATYPE \_           |
