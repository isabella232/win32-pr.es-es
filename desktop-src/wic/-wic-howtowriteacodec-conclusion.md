---
description: La creación del códec en la plataforma Windows Imaging Component (WIC) permite que todas las aplicaciones creadas en WIC obtengan la misma compatibilidad de plataforma con el formato de imagen que obtienen para los formatos de imagen comunes incluidos con la plataforma.
