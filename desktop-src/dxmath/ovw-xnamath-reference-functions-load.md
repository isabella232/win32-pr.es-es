...
Muestra el conjunto de funciones para cargar los valores obtenidos de los registros de hardware proporcionados como parte de la biblioteca de DirectXMath.

La lista siguiente incluye las funciones de carga que actualmente forman parte de la biblioteca de DirectXMath y están disponibles a través de `DirectXMath.h` .
...
| [**XMLoadFloat3PK**](/windows/win32/api/directxpackedvector/nf-directxpackedvector-xmloadfloat3pk) | Carga un [**XMFLOAT3PK**](/windows/win32/api/directxpackedvector/ns-directxpackedvector-xmfloat3pk) en un [**XMVECTOR**](xmvector-data-type.md). |
...
| [**XMLoadFloat3x3**](/windows/win32/api/directxmath/nf-directxmath-xmloadfloat3x3) | Carga un [**XMFLOAT3X3**](/windows/win32/api/directxmath/ns-directxmath-xmfloat3x3) en un [**XMMATRIX**](/windows/win32/api/directxmath/ns-directxmath-xmmatrix). |
| [**XMLoadFloat3x4**](/windows/win32/api/directxmath/nf-directxmath-xmloadfloat3x4) | Carga un [**XMFLOAT3X4**](/windows/win32/api/directxmath/ns-directxmath-xmfloat3x4) en un [**XMMATRIX**](/windows/win32/api/directxmath/ns-directxmath-xmmatrix). |
| [**XMLoadFloat3x4A**](/windows/win32/api/directxmath/nf-directxmath-xmloadfloat3x4a) | Carga un [**XMFLOAT3X4A**](/windows/win32/api/directxmath/ns-directxmath-xmfloat3x4a) en un [**XMMATRIX**](/windows/win32/api/directxmath/ns-directxmath-xmmatrix). |
...
| [**XMLoadFloat4x3**](/windows/win32/api/directxmath/nf-directxmath-xmloadfloat4x3) | Carga un [**XMFLOAT4X3**](/windows/win32/api/directxmath/ns-directxmath-xmfloat4x3) en un [**XMMATRIX**](/windows/win32/api/directxmath/ns-directxmath-xmmatrix). |
...
| [**XMLoadFloat4x4**](/windows/win32/api/directxmath/nf-directxmath-xmloadfloat4x4) | Carga un [**XMFLOAT4X4**](/windows/win32/api/directxmath/ns-directxmath-xmfloat4x4) en un [**XMMATRIX**](/windows/win32/api/directxmath/ns-directxmath-xmmatrix). |
...
| [**XMLoadInt3**](/windows/win32/api/directxmath/nf-directxmath-xmloadint3) | Carga los datos en los componentes x, y y z de un [**XMVECTOR**](xmvector-data-type.md), sin comprobación de tipos. |
...
| [**XMLoadSInt3**](/windows/win32/api/directxmath/nf-directxmath-xmloadsint3) | Carga los datos enteros con signo en los componentes x, y y z de un [**XMVECTOR**](xmvector-data-type.md). |
| [**XMLoadSInt4**](/windows/win32/api/directxmath/nf-directxmath-xmloadsint4) | Carga los datos enteros con signo en un [**XMVECTOR**](xmvector-data-type.md). |
...
| [**XMLoadUDecN4 \_ XR**](/windows/win32/api/directxpackedvector/nf-directxpackedvector-xmloadudecn4_xr) | Carga un [**XMUDECN4**](/windows/win32/api/directxpackedvector/ns-directxpackedvector-xmudecn4) de intervalo extendido en un [**XMVECTOR**](xmvector-data-type.md). |
| [**XMLoadUInt2**](/windows/win32/api/directxmath/nf-directxmath-xmloaduint2) | Carga los datos enteros sin signo en los componentes x e y de un [**XMVECTOR**](xmvector-data-type.md). |
| [**XMLoadUInt3**](/windows/win32/api/directxmath/nf-directxmath-xmloaduint3) | Carga los datos enteros sin signo en los componentes x, y y z de un [**XMVECTOR**](xmvector-data-type.md), sin comprobación de tipos. |
| [**XMLoadUInt4**](/windows/win32/api/directxmath/nf-directxmath-xmloaduint4) | Carga los datos enteros sin signo en un [**XMVECTOR**](xmvector-data-type.md). |
