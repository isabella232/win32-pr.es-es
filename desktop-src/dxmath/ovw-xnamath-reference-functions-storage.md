...
En la lista siguiente se incluyen las funciones de almacenamiento que forman parte actualmente de la biblioteca DirectXMath y que están disponibles a través de `DirectXMath.h` .
...
| [**XMStoreDec4**](/windows/win32/api/directxpackedvector/nf-directxpackedvector-xmstoredec4) | Almacena un [**XMVECTOR**](xmvector-data-type.md) en [**xmdec4.**](/windows/win32/api/directxpackedvector/ns-directxpackedvector-xmdec4) |
...
| [**XMStoreFloat**](/windows/win32/api/directxmath/nf-directxmath-xmstorefloat) | Almacena un [**XMVECTOR**](xmvector-data-type.md) en un **objeto float.** |
| [**XMStoreFloat2**](/windows/win32/api/directxmath/nf-directxmath-xmstorefloat2) | Almacena un [**XMVECTOR**](xmvector-data-type.md) en [**un XMFLOAT2**](/windows/win32/api/directxmath/ns-directxmath-xmfloat2). |
| [**XMStoreFloat2A**](/windows/win32/api/directxmath/nf-directxmath-xmstorefloat2a) | Almacena un [**XMVECTOR**](xmvector-data-type.md) en un [**XMFLOAT2A**](/previous-versions/windows/desktop/legacy/ee419469(v=vs.85)). |
| [**XMStoreFloat3**](/windows/win32/api/directxmath/nf-directxmath-xmstorefloat3) | Almacena un [**XMVECTOR**](xmvector-data-type.md) en [**un XMFLOAT3**](/windows/win32/api/directxmath/ns-directxmath-xmfloat3). |
| [**XMStoreFloat3A**](/windows/win32/api/directxmath/nf-directxmath-xmstorefloat3a) | Almacena un [**XMVECTOR**](xmvector-data-type.md) en un [**XMFLOAT3A**](/windows/win32/api/directxmath/ns-directxmath-xmfloat3a). |
...
| [**XMStoreFloat3SE**](/windows/win32/api/directxpackedvector/nf-directxpackedvector-xmstorefloat3se) | Almacena un [**XMVECTOR**](xmvector-data-type.md) en [**un XMFLOAT3SE**](/windows/win32/api/directxpackedvector/ns-directxpackedvector-xmfloat3se). |
...
| [**XMStoreFloat3x4A**](/windows/win32/api/directxmath/nf-directxmath-xmstorefloat3x4a) | Almacena un [**XMMATRIX**](/windows/win32/api/directxmath/ns-directxmath-xmmatrix) en [**un XMFLOAT3X4A**](/windows/win32/api/directxmath/ns-directxmath-xmfloat3x4a). |
...
| [**XMStoreFloat4A**](/windows/win32/api/directxmath/nf-directxmath-xmstorefloat4a) | Almacena un [**XMVECTOR**](xmvector-data-type.md) en [**un XMFLOAT4A**](/windows/win32/api/directxmath/ns-directxmath-xmfloat4a). |
| [**XMStoreFloat4x3**](/windows/win32/api/directxmath/nf-directxmath-xmstorefloat4x3) | Almacena un [**XMMATRIX**](/windows/win32/api/directxmath/ns-directxmath-xmmatrix) en [**un XMFLOAT4X3**](/windows/win32/api/directxmath/ns-directxmath-xmfloat4x3). |
| [**XMStoreFloat4x3A**](/windows/win32/api/directxmath/nf-directxmath-xmstorefloat4x3a) | Almacena un [**XMVECTOR**](xmvector-data-type.md) en [**un XMFLOAT4X3A**](/windows/win32/api/directxmath/ns-directxmath-xmfloat4x3a). |
| [**XMStoreFloat4x4**](/windows/win32/api/directxmath/nf-directxmath-xmstorefloat4x4) | Almacena una [**XMMATRIX**](/windows/win32/api/directxmath/ns-directxmath-xmmatrix) en [**un XMFLOAT4X4**](/windows/win32/api/directxmath/ns-directxmath-xmfloat4x4). |
| [**XMStoreFloat4x4A**](/windows/win32/api/directxmath/nf-directxmath-xmstorefloat4x4a) | Almacena un [**XMVECTOR**](xmvector-data-type.md) en un [**XMFLOAT4X4A**](/previous-versions/windows/desktop/legacy/ee419623(v=vs.85)). |
...
| [**XMStoreInt2**](/windows/win32/api/directxmath/nf-directxmath-xmstoreint2) | Almacena un [**XMVECTOR**](xmvector-data-type.md) en una matriz **uint32 \_ t de 2** elementos. |
| [**XMStoreInt2A**](/windows/win32/api/directxmath/nf-directxmath-xmstoreint2a) | Almacena un [**XMVECTOR en**](xmvector-data-type.md) una matriz de 2 elementos alineados de 16 bytes **uint32 \_ t.** |
| [**XMStoreInt3**](/windows/win32/api/directxmath/nf-directxmath-xmstoreint3) | Almacena un [**XMVECTOR**](xmvector-data-type.md) en una matriz **uint32 \_ t de 3** elementos. |
| [**XMStoreInt3A**](/windows/win32/api/directxmath/nf-directxmath-xmstoreint3a) | Almacena un [**XMVECTOR en**](xmvector-data-type.md) una matriz de 3 elementos alineados de 16 bytes **uint32 \_ t.** |
| [**XMStoreInt4**](/windows/win32/api/directxmath/nf-directxmath-xmstoreint4) | Almacena un [**XMVECTOR**](xmvector-data-type.md) en una matriz **uint32 \_ t** de 4 elementos. |
| [**XMStoreInt4A**](/windows/win32/api/directxmath/nf-directxmath-xmstoreint4a) | Almacena un [**XMVECTOR en**](xmvector-data-type.md) una matriz de 4 elementos alineados de 16 bytes **uint32 \_ t.** |
