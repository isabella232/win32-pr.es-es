---
description: Constructores expuestos por XMUSHORT2.
ms.assetid: 881a3b1b-5f1d-4fe7-ad29-5a62651ba62c
title: Constructores XMUSHORT2
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119978715"
---
# <a name="xmushort2-constructors"></a>Constructores XMUSHORT2

Constructores expuestos por `XMUSHORT2` .

Construye instancias de la [**estructura XMUSHORT2.**](/windows/desktop/api/DirectXPackedVector/ns-directxpackedvector-xmushort2)
...
<td style="text-align: left;">Constructor predeterminado para <code>XMUSHORT2</code> .<br/> Constructor predeterminado para <a href="/windows/desktop/api/DirectXPackedVector/ns-directxpackedvector-xmushort2"><strong>XMUSHORT2.</strong></a><br/>
<blockquote>
[!Note]<br />
...
<td style="text-align: left;">Inicializa una nueva instancia de a <code>XMUSHORT2</code> partir de una matriz de <code>uint16_t</code> argumentos.<br/> Este constructor inicializa una nueva instancia de a <code>XMUSHORT2</code> partir de una matriz de <code>uint16_t</code> argumentos.<br/>
<blockquote>
[!Note]<br />
Este constructor solo está disponible en C++.
</blockquote>
...
[Extensiones XMUSHORT2](ovw-xmushort2-extensions.md)
</dt> <dt>
