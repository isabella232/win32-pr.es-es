---
description: Enumera las funciones vectoriales por componente.
...
Enumera las funciones vectoriales por componente.
...
| Tema                                                             | Descripción                                                                                                                              |
|-------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|
| [**XMVectorInsert**](/windows/win32/api/directxmath/nf-directxmath-xmvectorinsert)<br/>               | Gira un vector a la izquierda por un número determinado de componentes de 32 bits e inserta los elementos seleccionados de ese resultado en otro vector.<br/> |
| [**XMVectorMergeXY**](/windows/win32/api/directxmath/nf-directxmath-xmvectormergexy)<br/>             | Crea un nuevo vector combinando los componentes x e y de dos vectores.<br/>                                                      |
...
| [**XMVectorSplatZ**](/windows/win32/api/directxmath/nf-directxmath-xmvectorsplatz)<br/>               | Replica el componente z de un vector en todos los componentes.<br/>                                                              |
| [**XMVectorSwzzle**](/windows/win32/api/directxmath/nf-directxmath-xmvectorswizzle)<br/>             | Desliza un vector.<br/>                                                                                                            |
