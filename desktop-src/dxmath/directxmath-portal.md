...
| [Referencia de programación de DirectXMath](ovw-xnamath-reference.md)<br/> | Esta sección contiene material de referencia para la biblioteca DirectXMath.<br/> |
...
La biblioteca DirectXMath está diseñada para desarrolladores de C++ que trabajan en juegos y gráficos DirectX en aplicaciones de la Tienda Windows, juegos de Xbox y aplicaciones de escritorio tradicionales para Windows.
