...
---
# <a name="publisher-configuration-file-schema"></a><span data-ttu-id="49e9d-103">Esquema del archivo de configuración del publicador</span><span class="sxs-lookup"><span data-stu-id="49e9d-103">Publisher Configuration File Schema</span></span>

<span data-ttu-id="49e9d-104">A continuación se muestra la lista completa del esquema del archivo de configuración del publicador.</span><span class="sxs-lookup"><span data-stu-id="49e9d-104">The following is the complete listing of the publisher configuration file schema.</span></span>
