---
description: Al crear sus propios ensamblados en paralelo, siga las directrices para crear ensamblados en paralelo y cree cualquier archivo DLL que se incluya en el ensamblado según las directrices de Creación de un archivo DLL para un ensamblado en paralelo.
...
Cumpla las siguientes directrices para el almacenamiento del estado:
...
-   Lo ideal es adoptar un modelo de persistencia en el que la aplicación conserve el estado y no modifique el registro. Una aplicación no debe tener que tocar directamente las entradas del Registro del componente. En su lugar, el ensamblado debe ofrecer funciones de API que guarden o restaur la configuración que sean compatibles en paralelo.
