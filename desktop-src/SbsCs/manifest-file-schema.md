---
description: A continuación se muestra la lista completa del esquema del archivo de manifiesto.
ms.assetid: 5a4040a4-66ed-44ea-a07f-6410f88d1446
title: Esquema del archivo de manifiesto
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105653263"
---
# <a name="manifest-file-schema"></a><span data-ttu-id="ac08c-103">Esquema del archivo de manifiesto</span><span class="sxs-lookup"><span data-stu-id="ac08c-103">Manifest File Schema</span></span>

<span data-ttu-id="ac08c-104">A continuación se muestra la lista completa del esquema del archivo de manifiesto.</span><span class="sxs-lookup"><span data-stu-id="ac08c-104">The following is the complete listing of the manifest file schema.</span></span>
