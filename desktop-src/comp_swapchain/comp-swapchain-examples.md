...
## <a name="example-15mdashstaggered-buffer-resize-operation-for-improved-performance"></a>Ejemplo 15 &mdash; Operación de cambio de tamaño de búfer escalonado para mejorar el rendimiento
