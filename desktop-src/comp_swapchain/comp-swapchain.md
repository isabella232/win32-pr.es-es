...
ms.topic: article
ms.date: 09/10/2021
ms.openlocfilehash: 6be86d00fa409fd1c5a626481a10ff80e613aa9b
ms.sourcegitcommit: b1f058e2360e54c07cb988a3204ec33f47889122
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 10/05/2021
ms.locfileid: "129454621"
---
...
## <a name="presentation-modesmdashcomposition-multiplane-overlay-and-iflip"></a>Composición de modos &mdash; de presentación, superposición multiplano e iflip
...
Definimos una *superficie de presentación para* que sea una forma de contenido de presentación a la que se presenta un solo búfer a la vez. Una superficie de presentación se puede establecer como contenido en un árbol visual y puede mostrar un único búfer de presentación en la pantalla a la vez. Los presentaciones del Administrador de presentación actualizarán el búfer que muestra una o varias superficies de presentación de forma atómica.
...
Tenga en cuenta que el administrador de presentación puede presentar cualquier búfer de presentación a cualquier número de superficies de presentación que desee. No hay restricciones. Sin embargo, la aplicación debe realizar un seguimiento de qué búferes ha emitido y dónde, para asegurarse de que no intente emitir nuevo dibujo en ese búfer mientras se sigue mostrando mediante una superficie de presentación.
