...
---
# <a name="varfileinfo-block-statement"></a>VarFileInfo BLOCK (instrucción)

Define un bloque de información variable.
...
Uno de los identificadores de juegos de caracteres especificados en la sección Comentarios.
