...
5.  Use la [**función UpdateResource**](/windows/desktop/api/Winbase/nf-winbase-updateresourcea) para copiar el recurso de cuadro de diálogo Hand.exe a Foot.exe.
