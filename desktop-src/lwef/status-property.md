...
| 1     | No se admite la salida de audio; por ejemplo, porque no hay ninguna tarjeta de sonido.                                |
| 2     | No se puede abrir el canal de salida de audio (está ocupado); por ejemplo, porque otra aplicación está reproduciendo audio. |
