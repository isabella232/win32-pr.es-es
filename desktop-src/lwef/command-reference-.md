...
Muestra el cuadro de diálogo Guardar como, lo que le permite escribir un nuevo nombre para el archivo de definición de caracteres.

</dd> <dt>

<span id="Print"></span><span id="print"></span><span id="PRINT"></span>**Impresión**
</dt> <dd>

Muestra el cuadro de diálogo Imprimir, lo que le permite elegir una opción de impresión e imprimir el archivo de definición de caracteres.
...
<span id="New_Frame"></span><span id="new_frame"></span><span id="NEW_FRAME"></span>**Nuevo marco**
</dt> <dd>
...
<span id="Open_Frame_Window"></span><span id="open_frame_window"></span><span id="OPEN_FRAME_WINDOW"></span>**Abrir ventana marco**
</dt> <dd>

Muestra el marco actual y sus imágenes en una ventana independiente sin escalar las imágenes cargadas en el marco.
...
Muestra el cuadro de diálogo Temas de Ayuda, lo que le permite seleccionar un tema de ayuda del Editor.

</dd> <dt>

<span id="About_Microsoft_Agent_Character_Editor"></span><span id="about_microsoft_agent_character_editor"></span><span id="ABOUT_MICROSOFT_AGENT_CHARACTER_EDITOR"></span>**Acerca del Editor de caracteres de Microsoft Agent**
</dt> <dd>

Muestra un cuadro de diálogo con información de copyright y versión para el Editor.
