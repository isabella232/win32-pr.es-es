...
> [!Note]  
> Se puede producir un error al establecer **TTSModeID** si Speech.dll no está instalado y el motor especificado no coincide con la configuración del modo TTS compilado del carácter.
...
[**Propiedad LanguageID**](languageid-property.md)
