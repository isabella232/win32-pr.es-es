...
| <a href="element-homeprovidername.md">HomeProviderName</a> | <p>Nombre del proveedor principal para la SIM o el dispositivo especificados. Para obtener más información, vea la documentación del elemento <a href="../mbn/schema-homeprovidername-mbnprofile-element.md"><strong>HomeProviderName</strong></a> v1.</p> | 
