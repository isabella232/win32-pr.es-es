...
Especifica que este perfil solo está activo cuando se conecta a una red de IWLAN. De lo contrario, el perfil no es aplicable y no se puede usar para activar un contexto del Protocolo de datos de paquetes (PDP). El valor de este elemento debe ser un valor [**iwlanApplicabilityType**](simpletype-iwlanapplicabilitytype.md) válido.
