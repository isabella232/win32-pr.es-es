---
description: Esquema de Perfil de banda ancha móvil v1.
...
ms.locfileid: "103810106"
---
# <a name="mobile-broadband-profile-schema-v1"></a><span data-ttu-id="40997-103">Esquema de Perfil de banda ancha móvil v1</span><span class="sxs-lookup"><span data-stu-id="40997-103">Mobile Broadband Profile Schema v1</span></span>

<span data-ttu-id="40997-104">El esquema de Perfil de banda ancha de Windows 7Mobile V1 está disponible en el espacio de nombres `https://www.microsoft.com/networking/WWAN/profile/v1` .</span><span class="sxs-lookup"><span data-stu-id="40997-104">The Windows 7Mobile Broadband Profile Schema v1 is available in the namespace `https://www.microsoft.com/networking/WWAN/profile/v1`.</span></span>

-   [<span data-ttu-id="40997-105">Elementos del esquema de Perfil de banda ancha móvil v1</span><span class="sxs-lookup"><span data-stu-id="40997-105">Mobile Broadband Profile Schema v1 Elements</span></span>](schema-elements.md)
-   [<span data-ttu-id="40997-106">Tipos simples del esquema de Perfil de banda ancha móvil v1</span><span class="sxs-lookup"><span data-stu-id="40997-106">Mobile Broadband Profile Schema v1 Simple Types</span></span>](schema-simple-types.md)
-   [<span data-ttu-id="40997-107">Esquema de Perfil de banda ancha móvil v1 tipos complejos</span><span class="sxs-lookup"><span data-stu-id="40997-107">Mobile Broadband Profile Schema v1 Complex Types</span></span>](schema-complex-types.md)
