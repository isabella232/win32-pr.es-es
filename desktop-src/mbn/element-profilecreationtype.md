...
Para obtener más información sobre este elemento, consulte la documentación del elemento [**ProfileCreationType**](./schema-profilecreationtype-mbnprofile-element.md) v1.
