...
---
# <a name="mobile-broadband-profile-schema-v1-elements"></a>Elementos del esquema de Perfil de banda ancha móvil v1

Un perfil de banda ancha móvil v1 consta de los siguientes elementos. Todos los elementos con nombre se encuentran en el espacio de nombres `https://www.microsoft.com/networking/WWAN/profile/v1` .
...
-   [**MBNProfile**](schema-mbnprofile-element.md)
    ...
    -   [**Contexto (MBNProfile)**](schema-context-mbnprofile-element.md)
        ...
        -   [**Compresión (contextType)**](schema-compression-contexttype-element.md)
        -   [**UserLogonCred (contextType)**](schema-userlogoncred-contexttype-element.md)
            ...
            -   [**Contraseña (UserLogonCred)**](schema-password-userlogoncred-element.md)
            -   [**Nombre de usuario (UserLogonCred)**](schema-username-userlogoncred-element.md)
    ...
    -   [**Descripción (MBNProfile)**](schema-description-mbnprofile-element.md)
    ...
    -   [**Nombre (MBNProfile)**](schema-name-mbnprofile-element.md)
