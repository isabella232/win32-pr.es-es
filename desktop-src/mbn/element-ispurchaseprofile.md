...
El **elemento IsPurchaseProfile** contiene un **valor booleano** que es **true** si se trata de un perfil comprado y **false,** en caso contrario. El valor predeterminado es **false**.
