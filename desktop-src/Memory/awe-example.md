---
description: El programa de ejemplo siguiente muestra las extensiones de ventana de dirección.
ms.assetid: 1a67bd2f-afc0-48f4-91f2-34fd2b94910d
title: Ejemplo de AWE
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105652431"
---
# <a name="awe-example"></a><span data-ttu-id="922df-103">Ejemplo de AWE</span><span class="sxs-lookup"><span data-stu-id="922df-103">AWE Example</span></span>

<span data-ttu-id="922df-104">El programa de ejemplo siguiente muestra las [**extensiones de ventana de dirección**](address-windowing-extensions.md).</span><span class="sxs-lookup"><span data-stu-id="922df-104">The following sample program illustrates the [**Address Windowing Extensions**](address-windowing-extensions.md).</span></span>
