...
El tamaño del objeto de asignación de archivos que seleccione controla hasta qué punto se puede "ver" con la asignación de memoria. Si crea un objeto de asignación de archivos de 500 Kb de tamaño, solo tendrá acceso a los primeros 500 Kb del archivo, independientemente del tamaño del archivo. Puesto que no le cuesta ningún recurso del sistema crear un objeto de asignación de archivos mayor, cree un objeto de asignación de archivos que sea el tamaño del archivo (establezca los parámetros *dwMaximumSizeHigh* y *dwMaximumSizeLow* de [**CreateFileMapping**](/windows/desktop/api/WinBase/nf-winbase-createfilemappinga) en cero), incluso si no espera ver todo el archivo. El costo de los recursos del sistema se produce en la creación de las vistas y el acceso a ellas.
