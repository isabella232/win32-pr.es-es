...
Puntero a un [**D3DXVECTOR3**](d3d10-d3dxvector3.md), que define uno de los puntos usados para construir el plano.
...
Puntero a la estructura D3DXPLANE construida a partir de los puntos especificados.
