...
---
# <a name="d3dx10createeffectfrommemory-function"></a>D3DX10CreateEffectFromMemory función)
...
Nombre del archivo de efectos en la memoria.
...
Opciones de compilación de efectos (vea [ \_ constantes Effect D3D10](d3d10-effect.md)).
