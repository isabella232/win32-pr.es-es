...
El texto no se representará en el dispositivo; Todavía se debe llamar a ID3DX10Font::D rawText para representar el texto. Sin embargo, al cargar previamente texto en la memoria de vídeo, ID3DX10Font::D rawText usará muchos menos recursos de CPU.
