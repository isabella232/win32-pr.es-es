...
---
# <a name="d3dx10createtexturefrommemory-function"></a>D3DX10CreateTextureFromMemory función)
...
Dirección de un puntero al recurso creado. Consulte la [**interfaz ID3D10Resource**](/windows/desktop/api/D3D10/nn-d3d10-id3d10resource).
