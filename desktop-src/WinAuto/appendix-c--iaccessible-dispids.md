...
---
# <a name="appendix-c-iaccessible-dispids"></a><span data-ttu-id="c0db7-103">Apéndice C: desspid de IAccessible</span><span class="sxs-lookup"><span data-stu-id="c0db7-103">Appendix C: IAccessible DISPIDs</span></span>

<span data-ttu-id="c0db7-104">Un DISPID permite a la implementación de [**IDispatch**](idispatch-interface.md) buscar los distintos métodos y propiedades de una interfaz dual.</span><span class="sxs-lookup"><span data-stu-id="c0db7-104">A DISPID allows the implementation of the [**IDispatch**](idispatch-interface.md) to look up the various methods and properties of a dual interface.</span></span>
