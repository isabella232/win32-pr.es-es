...
|------------------------------------------------------------|-------------|-------|
| [**darse cuenta de**](/windows/desktop/api/UIAutomationCore/nf-uiautomationcore-ivirtualizeditemprovider-realize) | Método      | Ninguno  |
