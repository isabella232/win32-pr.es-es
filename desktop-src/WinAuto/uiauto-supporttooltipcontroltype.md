---
title: Tipo de control Información sobre herramientas
...
keywords:
- Automatización de la interfaz de usuario, compatibilidad con el tipo de control Información sobre herramientas
...
- Automatización de la interfaz de usuario, patrones de control para el tipo de control Información sobre herramientas
- Automatización de la interfaz de usuario,events para el tipo de control ToolTip
- estructuras de árbol, tipo de control ToolTip
- properties,Tipo de control ToolTip
- patrones de control, tipo de control ToolTip
- events,Tipo de control ToolTip
- Compatibilidad con el tipo de control Información sobre herramientas
...
ms.locfileid: "127172605"
---
# <a name="tooltip-control-type"></a>Tipo de control Información sobre herramientas
...
| [**IsControlElementPropertyId de UIA \_**](uiauto-automation-element-propids.md)         | True        | El control de información sobre herramientas siempre se incluye en la vista de control del Automatización de la interfaz de usuario control.                                                                                                                                                                                                                                                                          |
...
En la tabla siguiente se enumeran los Automatización de la interfaz de usuario de control que deben ser compatibles con los controles de información sobre herramientas. Para más información sobre los patrones de control, vea [UI Automation Control Patterns Overview](uiauto-controlpatternsoverview.md).
...
| [**IWindowProvider**](/windows/desktop/api/UIAutomationCore/nn-uiautomationcore-iwindowprovider) | Depende | La información sobre herramientas que se puede cerrar haciendo clic en un elemento de interfaz de usuario debe admitir el patrón de control [Ventana](uiauto-implementingwindow.md) para que se pueda cerrar automáticamente.                                                                                                                 |
...
En la tabla siguiente se enumeran los Automatización de la interfaz de usuario eventos que los controles de información sobre herramientas son necesarios para admitir. Para más información sobre los eventos, vea [UI Automation Events Overview](uiauto-eventsoverview.md).
