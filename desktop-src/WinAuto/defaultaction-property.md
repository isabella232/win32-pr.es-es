...
No todos los objetos tienen acciones predeterminadas y algunos tienen una acción predeterminada que está relacionada con su propiedad [**Value,**](value-property.md) como en los ejemplos siguientes:
...
-   Un control de texto estático o un control de edición que muestra "Impresora" no tiene ninguna acción predeterminada, pero tiene un valor de "Impresora".
