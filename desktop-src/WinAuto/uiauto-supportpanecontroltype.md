...
- Automatización de la interfaz de usuario, tipo de control Panel
...
- patrones de control, tipo de control Panel
- events,Tipo de control Pane
- compatibilidad con el tipo de control Panel
- Pane (tipo de control)
- tipos de control, estructura de árbol para el tipo de control Panel
...
En la tabla siguiente se muestra un control típico y una vista de contenido del árbol de Automatización de la interfaz de usuario que pertenece a los controles de panel y se describe lo que puede incluirse en cada vista. Para obtener más información sobre el Automatización de la interfaz de usuario, vea [información general Automatización de la interfaz de usuario árbol de datos.](uiauto-treeoverview.md)
...
|---------------------------------------------------------------------------------------------------------------------|------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AccessKeyPropertyId de UIA \_**](uiauto-automation-element-propids.md)                       | Vea las notas. | Si una combinación de claves concreta da el foco al panel, esa información debe exponerse a través de esta propiedad.                                                                                                                                                                                                      |
...
| [**UIA \_ HelpTextPropertyId**](uiauto-automation-element-propids.md)                         | Vea las notas. | El texto de ayuda de los controles de panel debe explicar el propósito del marco y cómo se relaciona con otros marcos. Se necesita una descripción si el propósito y la relación de los marcos no están claros del valor de la propiedad [**\_ NamePropertyId de UIA.**](uiauto-automation-element-propids.md) |
| [**IsContentElementPropertyId de UIA \_**](uiauto-automation-element-propids.md)         | TRUE       | El control de panel siempre se incluye en la vista de contenido del Automatización de la interfaz de usuario contenido.                                                                                                                                                                                                                                    |
...
| [**UIA \_ LocalizedControlTypePropertyId**](uiauto-automation-element-propids.md) | Vea las notas. | Cadena localizada correspondiente al tipo **de** control Panel. El valor predeterminado es "panel" para en-US o inglés (Estados Unidos).                                                                                                                                                                                        |
...
<thead>
<tr class="header">
<th>Automatización de la interfaz de usuario árbol de control: Vista de control</th>
...
<li>Panel
<ul>
<li>Editar (patrón de desplazamiento)</li>
</ul></li>
</ul></td>
<td><ul>
<li>Panel
