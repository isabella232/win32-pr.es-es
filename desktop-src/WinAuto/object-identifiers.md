...
description: En este tema se describen Microsoft Active Accessibility identificadores de objeto, valores de 32 bits que identifican categorías de objetos accesibles dentro de una ventana.
...
| <span id="OBJID_SIZEGRIP"></span><span id="objid_sizegrip"></span><dl> <dt>**OBJID \_ SIZEOBJP**</dt> </dl>                            | Control de tamaño de la ventana: un componente de marco opcional ubicado en la esquina inferior derecha del marco de la ventana.<br/>                                                                                                                                                                                                                                  |
