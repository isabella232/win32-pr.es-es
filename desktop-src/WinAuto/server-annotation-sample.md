---
title: Ejemplo de anotación de servidor
description: Ejemplo de anotación de servidor
...
---
# <a name="server-annotation-sample"></a><span data-ttu-id="b0d61-103">Ejemplo de anotación de servidor</span><span class="sxs-lookup"><span data-stu-id="b0d61-103">Server Annotation Sample</span></span>

<span data-ttu-id="b0d61-104">El siguiente es un ejemplo de la anotación del servidor.</span><span class="sxs-lookup"><span data-stu-id="b0d61-104">The following is an example of server annotation.</span></span> <span data-ttu-id="b0d61-105">Siga las instrucciones de los comentarios marcados con/ \* todo \* /.</span><span class="sxs-lookup"><span data-stu-id="b0d61-105">Follow instructions in comments marked with /\* TODO \*/.</span></span>
