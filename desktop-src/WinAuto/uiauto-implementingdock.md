...
- IDockProvider
- implementar patrones Automatización de la interfaz de usuario de control de acoplamiento
...
ms.locfileid: "118115109"
---
# <a name="dock-control-pattern"></a>Patrón de control dock
...
![captura de pantalla que muestra el contenedor de acoplamiento con dos hijos acoplados](images/dockxmpl.jpg)
...
-   [**IDockProvider**](/windows/desktop/api/UIAutomationCore/nn-uiautomationcore-idockprovider) no expone ninguna propiedad del contenedor de acoplamiento ni ninguna propiedad de los controles acoplados adyacentes al control actual dentro del contenedor de acoplamiento.
...
|-----------------------------------------------------------------|-------------|-------|
| [**DockPosition**](/windows/desktop/api/UIAutomationCore/nf-uiautomationcore-idockprovider-get_dockposition)       | Propiedad    | Ninguno  |
| [**SetDockPosition**](/windows/desktop/api/UIAutomationCore/nf-uiautomationcore-idockprovider-setdockposition) | Método      | Ninguno  |
