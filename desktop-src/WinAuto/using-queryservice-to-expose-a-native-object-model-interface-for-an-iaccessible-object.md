...
Para poder usarse en todos los procesos, es posible que los servidores deban registrar la interfaz devuelta con el Modelo de objetos componentes (COM).

Microsoft usa esta técnica Internet Explorer 4.0 y versiones posteriores. Permite a los clientes obtener un puntero de interfaz **IHTMLElement2** que corresponde a un [**objeto IAccessible.**](/windows/desktop/api/oleacc/nn-oleacc-iaccessible)
