...
- Automatización de la interfaz de usuario,tree structure for Calendar control type
...
En la tabla siguiente se muestra un control típico y una vista de contenido del árbol Automatización de la interfaz de usuario que pertenece a los controles de calendario y se describe lo que se puede incluir en cada vista. Para obtener más información sobre el Automatización de la interfaz de usuario, vea [información general Automatización de la interfaz de usuario árbol de datos.](uiauto-treeoverview.md)
...
| [**IsContentElementPropertyId de UIA \_**](uiauto-automation-element-propids.md)         | TRUE         | El control de calendario siempre se incluye en la vista de contenido del Automatización de la interfaz de usuario contenido.                                                                                                               |
...
|---------------------------------------------------------|---------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**IGridProvider**](/windows/desktop/api/UIAutomationCore/nn-uiautomationcore-igridprovider)           | Requerido      | El control de calendario siempre admite el [patrón de](uiauto-implementinggrid.md) control Grid porque los días de un mes son elementos que se pueden navegar espacialmente.                                                                                                                                                        |
...
| [**ITableProvider**](/windows/desktop/api/UIAutomationCore/nn-uiautomationcore-itableprovider)         | Requerido      | Dado que el control de calendario siempre tiene un encabezado dentro de su subárbol para los días de la semana, debe ser compatible con el patrón [de](uiauto-implementingtable.md) control Tabla.                                                                                                                                                     |
| [**IValueProvider**](/windows/desktop/api/UIAutomationCore/nn-uiautomationcore-ivalueprovider)         | No            | El [patrón de](uiauto-implementingvalue.md) control Valor no es necesario para los controles de calendario porque el elemento no puede establecer el valor directamente en el control . Si hay una fecha específica asociada al control , el patrón de control [Selection](uiauto-implementingselection.md) debe proporcionar la información. |
...
En la tabla siguiente se enumeran Automatización de la interfaz de usuario eventos que los controles de calendario son necesarios para admitir. Para más información sobre los eventos, vea [UI Automation Events Overview](uiauto-eventsoverview.md).
