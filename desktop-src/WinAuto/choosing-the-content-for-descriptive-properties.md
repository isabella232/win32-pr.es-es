...
description: Aunque el contenido de algunas propiedades es específico, el contenido de otras propiedades consta de texto descriptivo que el desarrollador del servidor debe proporcionar.
...
ms.locfileid: "120071855"
---
# <a name="choosing-the-content-for-descriptive-properties"></a>Elección del contenido para propiedades descriptivas

Aunque el contenido de algunas propiedades es específico, el contenido de otras propiedades consta de texto descriptivo que el desarrollador del servidor debe proporcionar. Además, el tipo de información de cada propiedad varía en función del objeto . En la tabla siguiente se proporcionan sugerencias para elegir el contenido de estas propiedades descriptivas.
...
| [**DefaultAction**](defaultaction-property.md) | Interacción predeterminada con el objeto . La cadena devuelta por esta propiedad es un verbo único, como "Press" para un botón de barra de herramientas, o una frase corta que comienza con un verbo.                                                                               |
...
| [**Ayuda**](help-property.md)                   | Información sobre herramientas o estilo globo que se usa para describir lo que hace el objeto o cómo usarlo.                                                                                                                                                                   |
...
El contenido de las propiedades de los controles personalizados debe coincidir con el contenido de las propiedades de los controles proporcionados por el sistema que emulan los controles personalizados. Para obtener información sobre las propiedades admitidas por los controles proporcionados por el sistema, vea Apéndice A: Referencia de [elementos Interfaz de usuario admitidos.](appendix-a--supported-user-interface-elements-reference.md)
