...
| Microsoft Windows NT 4.0 | 2.0                                    | La compatibilidad completa con la versión 1.3 está integrada en el sistema operativo a partir de Service Pack 6. use la [Active Accessibility RDK 2.0 para](https://www.microsoft.com/downloads/details.aspx?familyid=9b14f6e1-888a-4f1d-b1a1-da08ee4077df&displaylang=en) actualizar Microsoft Active Accessibility versiones anteriores de Windows NT. |
