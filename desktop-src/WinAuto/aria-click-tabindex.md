...
Para corregir este error, establezca el [**atributo tabindex**](https://developer.mozilla.org/docs/Web/HTML/Global_attributes/tabindex) en un valor igual o mayor que 0. No es necesario establecer explícitamente el atributo **tabindex** para las etiquetas que están en el orden de tabulación de forma predeterminada, como [**un**](https://developer.mozilla.org/docs/Web/HTML/Element/a) (con atributo [**href),**](https://developer.mozilla.org/docs/Web/HTML/Attributes) el botón [**,**](https://developer.mozilla.org/docs/Web/HTML/Element/button)la entrada [**(excepto**](https://developer.mozilla.org/docs/Web/HTML/Element/input) "hidden"), [**seleccionar**](https://developer.mozilla.org/docs/Web/HTML/Element/select), [**textarea**](https://developer.mozilla.org/docs/Web/HTML/Element/textarea)y el área [**(como**](https://developer.mozilla.org/docs/Web/HTML/Element/area) parte del mapa de imágenes).
