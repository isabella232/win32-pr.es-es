...
Una barra de aplicación es un elemento de la interfaz de usuario que presenta al usuario navegación, comandos y herramientas. Para Windows store, las barras de aplicaciones de las aplicaciones se pueden mostrar presionando Windows + Z.
...
| [**UIA \_ LocalizedControlTypePropertyId**](uiauto-automation-element-propids.md) | Vea las notas. | Cadena localizada correspondiente al tipo de control **AppBar.** El valor predeterminado es "barra de aplicación" para en-US o inglés (Estados Unidos).                                                                                         |
