...
En el fragmento de código siguiente se usa la función [**SystemParametersInfo**](/windows/desktop/api/winuser/nf-winuser-systemparametersinfoa) para habilitar la característica FilterKeys:
