...
En la tabla siguiente se enumeran los Automatización de la interfaz de usuario eventos de lista que se requieren para admitir los controles de elemento de lista. Para más información sobre los eventos, vea [UI Automation Events Overview](uiauto-eventsoverview.md).
