...
| [**get \_ accKeyboardShortcut**](/windows/desktop/api/Oleacc/nf-oleacc-iaccessible-get_acckeyboardshortcut) | La **propiedad KeyboardShortcut** es la clave de acceso del botón, que es un carácter subrayado en el texto del texto de la ventana del botón. Por ejemplo, "Alt+o" es la **propiedad KeyboardShortcut** para un **botón Aceptar.**                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| [**get \_ accName**](/windows/desktop/api/Oleacc/nf-oleacc-iaccessible-get_accname)                         | La **propiedad** Name se obtiene del texto de la ventana (o título) del control, que se muestra en el botón de inserción. Por ejemplo, "Aceptar" es la **propiedad Nombre** de un **botón** Aceptar.                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
