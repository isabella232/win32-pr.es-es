...
> [!Note]  
> Otra generalización de controles para los botones en los que solo se puede seleccionar uno de un grupo es el contenido de un botón de alternancia. Algunos marcos de interfaz de usuario consideran que un botón de radio es un botón de alternancia especializado.
