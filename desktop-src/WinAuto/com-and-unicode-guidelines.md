...
description: Dado que Microsoft Active Accessibility se basa en el modelo de objetos componentes (COM), los desarrolladores necesitan un nivel moderado de comprensión sobre los objetos COM y las interfaces y deben saber cómo realizar tareas básicas (por ejemplo, cómo inicializar la biblioteca COM).
...
ms.locfileid: "119133908"
---
# <a name="com-and-unicode-guidelines"></a>Instrucciones COM y Unicode

Dado que Microsoft Active Accessibility se basa en el modelo de objetos componentes (COM), los desarrolladores necesitan un nivel moderado de comprensión sobre los objetos COM y las interfaces y deben saber cómo realizar tareas básicas (por ejemplo, cómo inicializar la biblioteca COM). Los desarrolladores de servidores deben comprender cómo diseñar clases que implementan la [**interfaz IAccessible**](/windows/desktop/api/oleacc/nn-oleacc-iaccessible) y cómo crear objetos accesibles.

También necesita un nivel moderado de comprensión sobre Unicode para usar muchas de las funciones Microsoft Active Accessibility que devuelven cadenas.
