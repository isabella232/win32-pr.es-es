...
## <a name="handling-general-ui-automation-events"></a>Control de eventos de Automatización de la interfaz de usuario generales

El ejemplo de código siguiente es una aplicación de consola de Microsoft Windows que implementa un controlador de eventos Automatización de la interfaz de usuario para eventos Automatización de la interfaz de usuario general. En este ejemplo se administran los eventos de creación y destrucción de información sobre herramientas y otras ventanas.
