...
description: Declaración de privacidad Windows 8 licencia para desarrolladores de Microsoft
...
ms.locfileid: "119990325"
---
# <a name="microsoft-windows-8-developer-license-privacy-statement"></a>Declaración de privacidad Windows 8 licencia para desarrolladores de Microsoft
...
Microsoft y sus subsidiarias y filiales controladas usarán la información que se recopile de usted para habilitar las características que esté usando y prestar servicios o llevar a cabo las transacciones que haya solicitado o autorizado. Microsoft almacena la información recopilada durante la adquisición de licencias de desarrollador para su posterior análisis. Es posible que usemos esta información para ayudar a comprender los patrones y tendencias de uso, y para detectar y bloquear posibles abusos, como la piratería de aplicaciones. Esta información también se puede usar con el fin de analizar y mejorar los productos y servicios de Microsoft.
...
La información recopilada por o enviada a Microsoft debido a que obtiene o usa una licencia de desarrollador se puede almacenar y procesar en Estados Unidos o en cualquier otro país en el que Microsoft o sus filiales, subsidiarias o proveedores de servicios mantengan instalaciones. Microsoft se atiene al acuerdo de puerto seguro ("Safe Harbor") establecido por el Departamento de Comercio de EE. UU. con respecto a la recopilación, el uso y la conservación de datos procedentes de la Unión Europea, el Espacio Económico Europeo y Suiza.
