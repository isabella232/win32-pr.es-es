...
---
# <a name="cim_copyfileaction-methods"></a>\_Métodos CopyFileAction de CIM

La [**clase \_ CopyFileAction de CIM**](cim-copyfileaction.md) expone los métodos siguientes.
...
-   [**Invoke (método)**](invoke-method-in-class-cim-copyfileaction.md)
