...
La clase **CIM \_ NumericSensor** representa un sensor numérico que devuelve lecturas numéricas y, opcionalmente, admite valores de umbral.
...
La clase **CIM \_ NumericSensor** tiene estos tipos de miembros:
...
La clase **CIM \_ NumericSensor** tiene estos métodos.
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-numericsensor.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ NumericSensor** tiene estas propiedades.
...
Clase o subclase utilizada en la creación de una instancia de. Cuando se usa con otras propiedades de clave de la clase, esta propiedad permite que todas las instancias de la clase y sus subclases se identifiquen de forma única.
...
La clase **CIM \_ NumericSensor** se deriva del [**\_ sensor CIM**](cim-sensor.md).

WMI no implementa esta clase. Para las clases derivadas de **CIM \_ NumericSensor**, vea [clases Win32](win32-provider.md).
