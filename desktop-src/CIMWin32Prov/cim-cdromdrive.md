---
description: La clase CIM \_ CDROMDrive representa una unidad de CD-ROM en el equipo.
ms.assetid: 044c9687-fc25-4a8c-b2ef-bd7ea332af7b
ms.tgt_platform: multiple
title: CIM_CDROMDrive clase (proveedores WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119700975"
---
# <a name="cim_cdromdrive-class-cimwin32-wmi-providers"></a>CIM_CDROMDrive clase (proveedores WMI CIMWin32)

La **clase CIM \_ CDROMDrive** representa una unidad de CD-ROM en el equipo.

> [!Note]  
> El nombre de la unidad no corresponde a la letra de unidad lógica asignada al dispositivo, que es el nombre del dispositivo de almacenamiento lógico que depende de la unidad.
...
La **clase \_ CIM CDROMDrive** tiene estos tipos de miembros:
...
La **clase CIM \_ CDROMDrive** tiene estos métodos.



| Método                                                                | Descripción                                                                                                                              |
|:----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Restablecer**](reset-method-in-class-cim-cdromdrive.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
...
La **clase CIM \_ CDROMDrive** tiene estas propiedades.
...
Número máximo de varios medios individuales que se pueden usar o insertar.
...
La **clase CIM \_ CDROMDrive** se deriva de [**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).

WMI no implementa esta clase. Para obtener más información sobre las clases derivadas de **CIM \_ CDROMDrive,** vea [Clases win32](win32-provider.md).
