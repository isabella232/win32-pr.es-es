...
---
# <a name="create-method-of-the-win32_service-class-cimwin32-wmi-providers"></a>Método Create de la clase Win32_Service (proveedores WMI de CIMWin32)
...
El código de control solicitado no se puede enviar al servicio porque el estado de la propiedad Service (**State** de la clase [**\_ BaseService de Win32**](win32-baseservice.md) ) es igual a 0, 1 o 2.
...
El método **Create** es similar al método [**Change**](change-method-in-class-win32-service.md) . En ambos casos, las propiedades del servicio se pasan como parámetros al método. Al igual que con los parámetros que se usan con el método **Change** , el orden en el que se pasan estos parámetros es muy importante.
