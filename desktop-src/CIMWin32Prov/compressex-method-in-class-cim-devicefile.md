...
---
# <a name="compressex-method-of-the-cim_devicefile-class"></a>Método CompressEx de la \_ clase DeviceFile de CIM

El método **CompressEx** comprime el archivo lógico (o directorio) especificado en la ruta de acceso del objeto. Este método es una versión extendida del método [**compress**](compress-method-in-class-cim-devicefile.md) . Este método se hereda de [**\_ LogicalFile CIM**](cim-logicalfile.md).
