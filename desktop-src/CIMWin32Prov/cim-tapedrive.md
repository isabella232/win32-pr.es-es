...
---
# <a name="cim_tapedrive-class-cimwin32-wmi-providers"></a>CIM_TapeDrive (clase) (proveedores WMI de CIMWin32)

La clase **CIM \_ TapeDrive** representa una unidad de cinta en el sistema. Las unidades de cinta se distinguen principalmente en que solo se puede tener acceso a ellas de forma secuencial.
...
La clase **CIM \_ TapeDrive** tiene estos métodos.
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-tapedrive.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ TapeDrive** se deriva de [**\_ MediaAccessDevice CIM**](cim-mediaaccessdevice.md).

WMI no implementa esta clase. Para las clases WMI derivadas de **CIM \_ TapeDrive**, vea [clases Win32](win32-provider.md).
