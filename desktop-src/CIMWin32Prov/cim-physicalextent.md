...
La clase **CIM \_ PhysicalExtent** tiene estos tipos de miembros:
...
La clase **CIM \_ PhysicalExtent** tiene estos métodos.



| Método                                                                    | Descripción                                                                                                                              |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-physicalextent.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-physicalextent.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ PhysicalExtent** tiene estas propiedades.
...
Calificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("blocksize"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Extensión física de DMTF \| 001,4 ")
</dt> </dl>

Tamaño, en bytes, de los bloques que forman la extensión del almacenamiento. Si el tamaño de bloque es variable, se debe especificar el tamaño máximo de bloque, en bytes. Si el tamaño de bloque es desconocido o si un concepto de bloque no es válido (por ejemplo, para las extensiones de agregado, la memoria o los discos lógicos), escriba 1 (uno).
...
Calificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NumberOfBlocks"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Extensión física de DMTF \| 001,3 ")
</dt> </dl>
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Extensión física \| de DMTF 001,6 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" bytes ")
</dt> </dl>

Número de bytes de datos de usuario que se omiten antes de iniciar la intercalación de datos de comprobación.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Extensión física \| de DMTF 001,7 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" bytes ")
</dt> </dl>

Número de bytes que se van a reservar para comprobar los datos.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Extensión física \| de DMTF 001,8 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" bytes ")
</dt> </dl>

Número de bytes que se van a reservar para los datos de usuario.
...
La clase **CIM \_ PhysicalExtent** se deriva de [**\_ StorageExtent de CIM**](cim-storageextent.md).
