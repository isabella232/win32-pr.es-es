---
description: La clase \_ CIM PhysicalExtent representa una implementación de RAID SCC.
...
La **clase \_ CIM PhysicalExtent** tiene estos tipos de miembros:
...
La **clase \_ CIM PhysicalExtent** tiene estos métodos.



| Método                                                                    | Descripción                                                                                                                              |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Restablecer**](reset-method-in-class-cim-physicalextent.md)                 | Solicita un restablecimiento del dispositivo lógico. Wmi no implementa.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-physicalextent.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. Wmi no implementa.<br/> |
...
La **clase \_ CIM PhysicalExtent** tiene estas propiedades.
...
Calificadores: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("BlockSize"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Extensión física \| DMTF \| 001.4")
</dt> </dl>
...
Calificadores: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NumberOfBlocks"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Extensión física \| DMTF \| 001.3")
</dt> </dl>
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Physical Extent \| 001.6"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("bytes")
</dt> </dl>

Número de bytes de datos de usuario que se omitirán antes de iniciar la intercalación de datos de comprobación.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Physical Extent \| 001.7"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("bytes")
</dt> </dl>

Número de bytes que se reservarán para los datos de comprobación.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Physical Extent \| 001.8"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("bytes")
</dt> </dl>

Número de bytes que se reservarán para los datos de usuario.
...
La **clase \_ CIM PhysicalExtent** se deriva de [**CIM \_ StorageExtent.**](cim-storageextent.md)
