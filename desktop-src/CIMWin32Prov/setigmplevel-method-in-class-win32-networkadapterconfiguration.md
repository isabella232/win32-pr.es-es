---
description: El método estático de la clase WMI SetIGMPLevel se usa para establecer la medida en que el sistema admite la multidifusión IP y participa en el Protocolo de administración de grupos de Internet.
ms.assetid: 38877576-aa23-4841-b3ae-1a02bfdd70d8
ms.tgt_platform: multiple
title: Método SetIGMPLevel de la Win32_NetworkAdapterConfiguration clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
