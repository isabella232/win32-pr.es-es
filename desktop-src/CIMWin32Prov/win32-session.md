---
description: La clase Session de Win32 define información de estado sobre la interacción entre un usuario y un recurso, como un sistema \_ informático o una sesión de terminal.
...
ms.locfileid: "127061484"
---
# <a name="win32_session-class"></a>Clase Session de Win32 \_

La **clase \_ Session de Win32** define información de estado sobre la interacción entre un usuario y un recurso, como un sistema informático o una sesión de terminal.
...
La **clase \_ Session de Win32** tiene estos tipos de miembros:

-   [Propiedades](#properties)

### <a name="properties"></a>Propiedades

La **clase \_ Session de Win32** tiene estas propiedades.
...
La **clase \_ Session de Win32** se deriva de [**CIM \_ LogicalElement**](cim-logicalelement.md).
