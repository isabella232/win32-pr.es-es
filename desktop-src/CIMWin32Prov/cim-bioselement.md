...
Identificador del elemento de software. Está diseñado para usarse junto con otras claves para crear una representación única de este [**\_ elemento SoftwareElement de CIM.**](cim-softwareelement.md)
