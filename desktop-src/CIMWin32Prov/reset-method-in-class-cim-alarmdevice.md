...
---
# <a name="reset-method-of-the-cim_alarmdevice-class"></a>Método Reset de la \_ clase AlarmDevice de CIM

El método **RESET** de la [**clase \_ AlarmDevice de CIM**](cim-alarmdevice.md) solicita un restablecimiento del dispositivo lógico. Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
