---
description: La clase \_ WMI De Win32 TapeDrive representa una unidad de cinta en un sistema informático que ejecuta Windows. Las unidades de cinta se distinguen principalmente por el hecho de que solo se puede acceder a ellas secuencialmente.
...
ms.locfileid: "127061423"
---
# <a name="win32_tapedrive-class"></a>Clase TapeDrive de Win32 \_

La **clase WMI De Win32 \_ TapeDrive** [representa](../wmisdk/retrieving-a-class.md) una unidad de cinta en un sistema informático que ejecuta Windows. Las unidades de cinta se distinguen principalmente por el hecho de que solo se puede acceder a ellas secuencialmente.
...
La **clase \_ TapeDrive de Win32** tiene estos tipos de miembros:
...
La **clase \_ TapeDrive de Win32** tiene estos métodos.



| Método            | Descripción                                                                                                                                                                            |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Sin implementar. Para implementar este método, vea el método [**Reset**](reset-method-in-class-cim-controller.md) en [**CIM \_ TapeDrive.**](cim-tapedrive.md)<br/>                 |
| **SetPowerState** | Sin implementar. Para implementar este método, vea el [**método SetPowerState**](setpowerstate-method-in-class-cim-controller.md) en [**CIM \_ TapeDrive.**](cim-tapedrive.md)<br/> |
...
La **clase \_ TapeDrive de Win32** tiene estas propiedades.
...
Calificadores: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("Indexed"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Storage Devices \| 001.9", "MIF. DMTF \| Storage Devices \| 001.11", "MIF. DMTF \| Storage Devices \| 001.12", "MIF. Discos DMTF \| \| 003.7"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).**CapabilityDescriptions**")
</dt> </dl>

Matriz de funcionalidades del dispositivo de acceso multimedia. Por ejemplo, el dispositivo puede admitir acceso aleatorio, medios extraíbles y limpieza automática. En este caso, los valores 3, 7 y 9 se escribirían en la matriz.
...
Calificadores: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("Indexed"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).**Funcionalidades**")
</dt> </dl>

Matriz de cadenas de forma libre que proporciona explicaciones más detalladas de cualquiera de las características del dispositivo de acceso indicadas en la **matriz Capabilities.** Tenga en cuenta que cada entrada de esta matriz está relacionada con la entrada de la matriz **Capabilities** que se encuentra en el mismo índice.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Compresión de las estructuras de copia de seguridad de cintas de Win32API \| TAPE GET DRIVE \| [**\_ \_ \_ PARAMETERS")**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \|
</dt> </dl>

Si **es TRUE,** la compresión de datos de hardware está habilitada.
...
Calificadores: [**Key**](../wmisdk/key-qualifier.md), [**Override**](../wmisdk/standard-qualifiers.md) ("DeviceId"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API \| File Functions \| CreateFile")
</dt> </dl>

Identificador único de la unidad de cinta con otros dispositivos del sistema.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API \| Tape Backup Structures TAPE GET DRIVE \| [**\_ \_ \_ PARAMETERS**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ECC")
</dt> </dl>

Si **es TRUE,** el dispositivo admite la corrección de errores de hardware.
...
Tamaño de zona para la advertencia del final de la cinta (EOT).

Esta propiedad se hereda de [**CIM \_ TapeDrive.**](cim-tapedrive.md)
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API \| Tape Backup Structures TAPE GET DRIVE \| [**\_ \_ \_ PARAMETERS**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| FeaturesHigh")
</dt> </dl>

Orden superior a 32 bits de la marca de características del dispositivo.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API \| Tape Backup Structures TAPE GET DRIVE \| [**\_ \_ \_ PARAMETERS**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| FeaturesLow")
</dt> </dl>

32 bits de orden bajo de la marca de características del dispositivo.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Funciones de archivo Win32API") \|
</dt> </dl>

Nombre de identificación del fabricante de la unidad Windows CD ROM.

Ejemplo: "PLEXTOR CD-ROM PX-12CS 1.01"
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Sequential Access Devices \| 001.2"), [**Units**](../wmisdk/standard-qualifiers.md) ("kilobytes")
</dt> </dl>
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Unidad de cinta MediaType de Win32 \_ \| TapeDrive") \|
</dt> </dl>

Tipo de medio usado por este dispositivo (o al que accede este dispositivo). En este caso, se establece en "Unidad de cinta".
...
Número máximo de medios individuales que se pueden usar o insertar en el dispositivo de acceso multimedia (cuando se admite).
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API \| Tape Backup Structures TAPE GET DRIVE \| [**\_ \_ \_ PARAMETERS**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ReportSetmarks")
</dt> </dl>

Si **es TRUE,** los informes de marca de conjunto están habilitados. Los informes setmark usan un elemento registrado especializado que no contiene datos de usuario. Este elemento registrado se usa para proporcionar un esquema de segmentación que es jerárquicamente superior a las marcas de archivo. Las marcas de configuración proporcionan un posicionamiento más rápido en cintas de alta capacidad.
...
La **clase \_ TapeDrive de Win32** se deriva de [**CIM \_ TapeDrive.**](cim-tapedrive.md)
