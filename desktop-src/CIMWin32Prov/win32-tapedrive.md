...
---
# <a name="win32_tapedrive-class"></a>Win32 \_ TapeDrive (clase)

La [clase WMI](../wmisdk/retrieving-a-class.md) **\_ TapeDrive de Win32** representa una unidad de cinta en un equipo con Windows. Las unidades de cinta se distinguen principalmente por el hecho de que solo se puede tener acceso a ellas de forma secuencial.
...
La clase **Win32 \_ TapeDrive** tiene estos tipos de miembros:
...
La clase **Win32 \_ TapeDrive** tiene estos métodos.
...
La clase **Win32 \_ TapeDrive** tiene estas propiedades.
...
Matriz de funcionalidades del dispositivo de acceso a medios. Por ejemplo, el dispositivo puede admitir el acceso aleatorio, medios extraíbles y limpieza automática. En este caso, los valores 3, 7 y 9 se escribirían en la matriz.
...
Calificadores: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("indexado"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).**Funcionalidades**")
</dt> </dl>

Matriz de cadenas de forma libre que proporcionan explicaciones más detalladas para cualquiera de las características de dispositivos de acceso indicadas en la matriz de **funcionalidades** . Tenga en cuenta que cada entrada de esta matriz está relacionada con la entrada de la matriz de **capacidades** que se encuentra en el mismo índice.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("inesperados win32api \| Tape backup Structures \| [**Tape \_ Get \_ Drive \_ Parameters**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| compression")
</dt> </dl>
...
Calificadores: [**clave**](../wmisdk/key-qualifier.md), [**invalidación**](../wmisdk/standard-qualifiers.md) ("DeviceId"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("inesperados win32api \| File Functions \| CreateFile")
</dt> </dl>

Identificador único de la unidad de cinta con otros dispositivos en el sistema.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("inesperados win32api \| Tape backup Structures \| [**Tape \_ Get \_ Drive \_ Parameters**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ECC")
</dt> </dl>
...
Tamaño de zona para la advertencia de final de cinta (EOT).
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("inesperados win32api \| Tape backup Structures \| [**Tape \_ Get \_ Drive \_ Parameters**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| FeaturesHigh")
</dt> </dl>

32 bits de orden superior de la marca características del dispositivo.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("inesperados win32api \| Tape backup Structures \| [**Tape \_ Get \_ Drive \_ Parameters**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| FeaturesLow")
</dt> </dl>

32 bits de orden inferior de la marca características del dispositivo.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("inesperados win32api \| File Functions")
</dt> </dl>

Nombre de identificación del fabricante de la unidad de CD-ROM de Windows.
...
Fabricante de la unidad de CD-ROM de Windows.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Dispositivos de acceso secuencial DMTF \| 001,2 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" kilobytes ")
</dt> </dl>
...
Recuento máximo de particiones para la unidad de cinta.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32 \_ TapeDrive \| \| Tape Drive")
</dt> </dl>

Tipo de medio que usa (o al que tiene acceso) este dispositivo. En este caso, se establece en "unidad de cinta".
...
Si **es true**, el dispositivo de acceso a medios necesita limpieza. Si la limpieza manual o automática es posible, se indica en la propiedad **Capabilities** .
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("inesperados win32api \| Tape backup Structures \| [**Tape \_ Get \_ Drive \_ Parameters**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ReportSetmarks")
</dt> </dl>

Si es **true**, setmark Reporting está habilitado. Setmark Reporting hace uso de un elemento grabado especializado que no contiene datos de usuario. Este elemento grabado se utiliza para proporcionar un esquema de segmentación que sea jerárquicamente superior a filemarks. Setmarks proporcionan un posicionamiento más rápido en las cintas de alta capacidad.
...
La clase **Win32 \_ TapeDrive** se deriva de [**CIM \_ TapeDrive**](cim-tapedrive.md).
