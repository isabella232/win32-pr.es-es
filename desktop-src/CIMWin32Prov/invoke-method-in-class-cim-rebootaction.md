...
---
# <a name="invoke-method-of-the-cim_rebootaction-class"></a>Método Invoke de la \_ clase CIM RebootAction

El método **Invoke** de la clase [**CIM \_ RebootAction**](cim-rebootaction.md) toma una acción concreta. Los detalles de cómo realiza la acción el método son específicos de la implementación. Este método se hereda de [**la \_ acción CIM**](cim-action.md).
