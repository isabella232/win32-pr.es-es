...
---
# <a name="cim_multistatesensor-class"></a>\_Clase MultiStateSensor de CIM

La clase **CIM \_ MultiStateSensor** representa un conjunto de varios miembros de sensores binarios donde cada sensor binario informa de un resultado booleano.
...
La clase **CIM \_ MultiStateSensor** tiene estos tipos de miembros:
...
La clase **CIM \_ MultiStateSensor** tiene estos métodos.
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-multistatesensor.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ MultiStateSensor** tiene estas propiedades.
...
La clase **CIM \_ MultiStateSensor** se deriva del [**\_ sensor CIM**](cim-sensor.md).
