---
description: El método SetPowerState de la clase PhysicalExtent de CIM establece el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo \_ en ese estado.
ms.assetid: a763c361-9b1a-49fd-8ed2-c1fcfdfd16db
ms.tgt_platform: multiple
title: Método SetPowerState de la CIM_PhysicalExtent clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
