---
description: La clase CIM \_ Keyboard representa las funciones y la administración del dispositivo lógico de teclado.
...
ms.locfileid: "119438455"
---
# <a name="cim_keyboard-class"></a>Cim \_ Keyboard (clase)

La **clase CIM \_ Keyboard** representa las funciones y la administración del dispositivo lógico de teclado.
...
La **clase \_ CIM Keyboard** tiene estos tipos de miembros:
...
La **clase CIM \_ Keyboard** tiene estos métodos.



| Método                                                              | Descripción                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Restablecer**](reset-method-in-class-cim-keyboard.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-keyboard.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La **clase CIM \_ Keyboard** tiene estas propiedades.
...
Entero que indica si una contraseña de nivel de hardware está habilitada en el teclado para evitar la entrada local.
...
La **clase CIM \_ Keyboard** se deriva de [**CIM \_ UserDevice**](cim-userdevice.md).

WMI no implementa esta clase. Para las clases derivadas del teclado CIM , vea [Clases Win32](win32-provider.md). **\_**
