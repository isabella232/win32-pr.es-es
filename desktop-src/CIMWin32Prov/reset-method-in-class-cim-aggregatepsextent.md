---
description: El método Reset de la clase AggregatePSExtent de CIM \_ solicita un restablecimiento del dispositivo lógico.
ms.assetid: 6669126f-ceab-4e34-81e5-5cfe1abf5b98
ms.tgt_platform: multiple
title: Método reset de la CIM_AggregatePSExtent clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "127062640"
---
# <a name="reset-method-of-the-cim_aggregatepsextent-class"></a>Método Reset de la clase \_ AggregatePSExtent de CIM

El **método Reset** de la clase AggregatePSExtent de CIM solicita un \_ restablecimiento del dispositivo lógico. Este método se hereda de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
