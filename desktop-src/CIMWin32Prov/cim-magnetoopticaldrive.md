---
description: La clase Cim MagnetoOpticalDrive representa las funcionalidades y la administración de una unidad \_ magneto-óptica, un subtipo del dispositivo de acceso multimedia.
...
ms.locfileid: "119923025"
---
# <a name="cim_magnetoopticaldrive-class"></a>Cim \_ MagnetoOpticalDrive (clase)

La **clase \_ Cim MagnetoOpticalDrive representa** las funcionalidades y la administración de una unidad magneto-óptica, un subtipo del dispositivo de acceso multimedia.
...
La **clase \_ Cim MagnetoOpticalDrive** tiene estos tipos de miembros:
...
La **clase \_ Cim MagnetoOpticalDrive tiene** estos métodos.



| Método                                                                         | Descripción                                                                                                                              |
|:-------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Restablecer**](reset-method-in-class-cim-magnetoopticaldrive.md)                 | Solicita un restablecimiento del dispositivo lógico. Wmi no implementa .<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-magnetoopticaldrive.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. Wmi no implementa .<br/> |
...
La **clase \_ Cim MagnetoOpticalDrive tiene** estas propiedades.
...
Distingue un dispositivo que puede tener acceso a ambos lados de los medios de doble cara de un dispositivo que solo lee un solo lado y requiere que el medio se deba volte.
...
> [!Note]  
> Cada entrada de matriz está relacionada con la entrada de la matriz **Capabilities,** ubicada en el mismo índice.
...
Si el dispositivo de acceso multimedia admite varios medios individuales, esta propiedad define el número máximo que se puede usar o insertar.
...
La **clase \_ MagnetoOpticalDrive de CIM** se deriva de CIM [**\_ MediaAccessDevice**](cim-mediaaccessdevice.md).
