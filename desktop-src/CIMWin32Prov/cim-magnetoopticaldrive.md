---
description: La clase Cim MagnetoOpticalDrive representa las funciones y la administración de una unidad \_ magneto-óptica, un subtipo del dispositivo de acceso multimedia.
...
ms.locfileid: "127254744"
---
# <a name="cim_magnetoopticaldrive-class"></a>Cim \_ MagnetoOpticalDrive (clase)

La **clase \_ Cim MagnetoOpticalDrive representa** las funciones y la administración de una unidad magneto-óptica, un subtipo del dispositivo de acceso multimedia.
...
La **clase \_ MagnetoOpticalDrive de CIM** tiene estos tipos de miembros:
...
| Método                                                                         | Descripción                                                                                                                              |
|:-------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-magnetoopticaldrive.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-magnetoopticaldrive.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La **clase \_ MagnetoOpticalDrive de CIM** tiene estas propiedades.
...
Si el dispositivo de acceso multimedia admite varios medios individuales, esta propiedad define el número máximo que se puede admite o se puede insertar.
...
La **clase \_ Cim MagnetoOpticalDrive** se deriva de [**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).
