...
---
# <a name="cim_osversioncheck-class"></a>\_Clase OSVersionCheck de CIM

La clase **CIM \_ OSVersionCheck** especifica las versiones del sistema operativo que pueden admitir un elemento de software. La comprobación se puede ejecutar para un determinado, un mínimo, un máximo o un intervalo de versiones del sistema operativo. Para especificar una versión específica del sistema operativo, las versiones mínima y máxima deben ser iguales. Para especificar la versión mínima, solo se debe especificar la versión mínima. Para especificar una versión máxima, solo es necesario especificar la versión máxima. Para especificar un intervalo, deben especificarse las versiones mínima y máxima.

El tipo de sistema operativo se especifica en la propiedad **TargetOperatingSystem** del elemento de software propietario. Los detalles de las comprobaciones se comparan con los detalles correspondientes que se encuentran en un objeto [**\_ OperatingSystem de CIM**](cim-operatingsystem.md) al que hace referencia una asociación de [**CIM \_ instalado**](cim-installedos.md) para el objeto de [**\_ ComputerSystem de CIM**](cim-computersystem.md) que describe el entorno. Al menos una clase de sistema **\_ operativo CIM** debe cumplir los detalles de la condición para que se cumpla la comprobación. En otras palabras, no todos los sistemas operativos del equipo correspondiente deben satisfacer la condición. Además, la propiedad **OSType** de la clase **CIM \_ OperatingSystem** debe coincidir con el tipo de la propiedad **TargetOperatingSystem** .
...
La clase **CIM \_ OSVersionCheck** tiene estos tipos de miembros:
...
La clase **CIM \_ OSVersionCheck** tiene estos métodos.



| Método                                                      | Descripción                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-osversioncheck.md) | Toma una acción concreta. No implementado por WMI.<br/> |
...
La clase **CIM \_ OSVersionCheck** tiene estas propiedades.
...
Versión máxima del sistema operativo requerido.
...
Versión mínima del sistema operativo requerido.
