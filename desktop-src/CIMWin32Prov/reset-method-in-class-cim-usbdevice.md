...
title: Método Reset de la clase CIM_USBDevice clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118418528"
---
# <a name="reset-method-of-the-cim_usbdevice-class"></a>Método Reset de la clase \_ CIM USBDevice

El **método Reset** de la clase CIM \_ USBDevice solicita un restablecimiento del dispositivo lógico. Este método se hereda de [**\_ CIM LogicalDevice.**](cim-logicaldevice.md)
