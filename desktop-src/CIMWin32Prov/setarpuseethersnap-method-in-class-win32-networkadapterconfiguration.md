...
---
# <a name="setarpuseethersnap-method-of-the-win32_networkadapterconfiguration-class"></a>Método SetArpUseEtherSNAP de la \_ clase NetworkAdapterConfiguration de Win32

El método estático de la [clase WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetArpUseEtherSNAP** se usa para permitir que los paquetes Ethernet usen la codificación de ajuste 802,3.
...
Si **es true** , se habilita TCP/IP para transmitir paquetes Ethernet mediante la codificación de ajuste 802,3.
...
De forma predeterminada, la pila transmite paquetes en formato Ethernet digital, Intel, Xerox (DIX). Siempre recibe ambos formatos.
