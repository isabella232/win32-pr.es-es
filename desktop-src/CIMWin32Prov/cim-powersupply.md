...
---
# <a name="cim_powersupply-class"></a>CIM ( \_ clase)

La clase de energía **CIM \_** representa las capacidades y la administración del dispositivo lógico de fuente de alimentación.
...
La clase de sistema de sistema **CIM \_** tiene estos tipos de miembros:
...
La clase de sistema de sistema **CIM \_** tiene estos métodos.



| Método                                                                 | Descripción                                                                                                                              |
|:-----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-powersupply.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-powersupply.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase de sistema de sistema **CIM \_** tiene estas propiedades.
...
Intervalo de voltaje que está actualmente en uso. Si el suministro no está dibujando la energía actualmente, se puede especificar el valor 6 ("ninguno"). Esta información es necesaria en el caso de una fuente de alimentación ininterrumpida (SAI), una subclase de energía **CIM \_**.
...
Si es **true**, la fuente de alimentación es un suministro de conmutación (frente a lineal).
...
Frecuencia (en hercios) en el extremo superior del intervalo de frecuencia de entrada de la fuente de alimentación 1. Un valor de 0 implica DC.
...
Frecuencia (en hercios) en el extremo inferior del intervalo de frecuencia de entrada de la fuente de alimentación 1. Un valor de 0 implica DC.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Fuente de alimentación DMTF \| 002,8 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milivoltios ")
</dt> </dl>

Alto voltaje del intervalo de voltaje de entrada 1 para la fuente de alimentación, en milivoltios. Un valor de 0 denota "Unknown".
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Fuente de alimentación DMTF \| 002,7 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milivoltios ")
</dt> </dl>

Voltaje bajo del intervalo de voltaje de entrada 1 para la fuente de alimentación, en milivoltios. Un valor de 0 denota "Unknown".
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Fuente de alimentación DMTF \| 002,12 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milivoltios ")
</dt> </dl>

Alto voltaje del intervalo de voltaje de entrada 2 para la fuente de alimentación, en milivoltios. Un valor de 0 denota "Unknown".
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Fuente de alimentación DMTF \| 002,11 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milivoltios ")
</dt> </dl>

Bajo voltaje del intervalo 2 de voltaje de entrada para esta fuente de alimentación, en milivoltios. Un valor de 0 denota "Unknown".
...
Potencia de salida total de la fuente de alimentación, en milivatios. Un valor de 0 denota "Unknown".
...
La clase de sistema de sistema **CIM \_** se deriva del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).

WMI no implementa esta clase. En el caso de las clases de WMI derivadas de la sistema **CIM \_**, vea [clases Win32](win32-provider.md).
