---
description: La clase \_ CIM USBController representa las funcionalidades y la administración de un controlador USB.
...
ms.locfileid: "127174521"
---
# <a name="cim_usbcontroller-class"></a>CIM \_ USBController (clase)

La **clase \_ CIM USBController** representa las funcionalidades y la administración de un controlador USB.
...
| Método                                                                   | Descripción                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-usbcontroller.md)                 | Solicita un restablecimiento del dispositivo lógico. Wmi no implementa .<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbcontroller.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. Wmi no implementa .<br/> |
