---
description: La clase \_ CIM USBController representa las funciones y la administración de un controlador USB.
...
ms.locfileid: "118420983"
---
# <a name="cim_usbcontroller-class"></a>Cim \_ USBController (clase)

La **clase \_ CIM USBController** representa las funciones y la administración de un controlador USB.
...
La **clase \_ CIM USBController** tiene estos tipos de miembros:
...
La **clase \_ CIM USBController** tiene estos métodos.



| Método                                                                   | Descripción                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Restablecer**](reset-method-in-class-cim-usbcontroller.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbcontroller.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La **clase \_ CIM USBController** tiene estas propiedades.
...
Nombre del fabricante del controlador USB.
...
La **clase \_ CIM USBController** se deriva del [**controlador CIM \_**](cim-controller.md).

WMI no implementa esta clase. Para las clases WMI derivadas de **CIM \_ USBController,** vea [Clases Win32](win32-provider.md).
