...
---
# <a name="cim_usbcontroller-class"></a>\_Clase USBController de CIM

La clase **CIM \_ USBController** representa las capacidades y la administración de una controladora USB.
...
La clase **CIM \_ USBController** tiene estos tipos de miembros:
...
La clase **CIM \_ USBController** tiene estos métodos.



| Método                                                                   | Descripción                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-usbcontroller.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbcontroller.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ USBController** tiene estas propiedades.
...
La clase **CIM \_ USBController** se deriva del [**\_ controlador CIM**](cim-controller.md).
