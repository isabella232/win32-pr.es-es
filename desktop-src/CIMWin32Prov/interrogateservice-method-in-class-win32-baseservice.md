...
title: Método InterrogateService de la Win32_BaseService clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119760405"
---
# <a name="interrogateservice-method-of-the-win32_baseservice-class"></a>Método InterrogateService de la clase BaseService Win32 \_

El método de clase [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **InterrogateService** solicita que el servicio actualice su estado al administrador de servicios.
