---
description: La clase StorageExtent de CIM representa las funcionalidades y la administración de los distintos medios que existen para almacenar datos \_ y permitir la recuperación de datos.
ms.assetid: 3895e00e-1a80-4d45-be0a-b159f8f335e8
ms.tgt_platform: multiple
title: CIM_StorageExtent clase (proveedores WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
La **clase \_ StorageExtent de CIM** tiene estos métodos.



| Método                                                                   | Descripción                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-storageextent.md)                 | Solicita un restablecimiento del dispositivo lógico. Wmi no implementa .<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-storageextent.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. Wmi no implementa .<br/> |
...
La **clase \_ StorageExtent de CIM** se deriva de CIM [**\_ LogicalDevice**](cim-logicaldevice.md).

WMI no implementa esta clase. Para las clases WMI derivadas de **CIM \_ StorageExtent,** vea [Clases win32.](win32-provider.md)
