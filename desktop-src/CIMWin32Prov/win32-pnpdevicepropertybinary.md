...
---
# <a name="win32_pnpdevicepropertybinary-class"></a>\_Clase Win32 PnPDevicePropertyBinary

Representa una propiedad de dispositivo PnP binario en forma de una matriz **Uint8** .
...
La **clase \_ PnPDevicePropertyBinary de Win32** tiene estas propiedades.
