...
---
# <a name="compress-method-of-the-cim_directory-class"></a>Método compress de la \_ clase de directorio CIM

El método **compress** comprime el archivo de entrada de directorio lógico (o directorio) especificado en la ruta de acceso del objeto. Este método se hereda de [**\_ LogicalFile CIM**](cim-logicalfile.md).
...
[\_Directorio CIM](compress-method-in-class-cim-directory.md)
</dt> <dt>
