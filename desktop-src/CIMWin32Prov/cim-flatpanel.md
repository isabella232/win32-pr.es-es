...
---
# <a name="cim_flatpanel-class"></a>\_Clase FlatPanel de CIM

La clase **CIM \_ FlatPanel** representa las capacidades y la administración del dispositivo lógico de panel plano.
...
La clase **CIM \_ FlatPanel** tiene estos tipos de miembros:
...
La clase **CIM \_ FlatPanel** tiene estos métodos.
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-flatpanel.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ FlatPanel** tiene estas propiedades.
...
Enumeración que describe el tipo de presentación de paneles planos.
...
<span id="Passive_Matrix_LCD"></span><span id="passive_matrix_lcd"></span><span id="PASSIVE_MATRIX_LCD"></span>**LCD de matriz pasiva** (2)
...
<span id="Active_Matrix_LCD"></span><span id="active_matrix_lcd"></span><span id="ACTIVE_MATRIX_LCD"></span>**LCD de matriz activa** (3)
...
<span id="Field_Emission_Display"></span><span id="field_emission_display"></span><span id="FIELD_EMISSION_DISPLAY"></span>**Presentación** de la emisión de campo (5)
...
<span id="Electro_Luminescent_Display"></span><span id="electro_luminescent_display"></span><span id="ELECTRO_LUMINESCENT_DISPLAY"></span>**Presentación de Luminescent** (6)
...
<span id="Gas_Plasma"></span><span id="gas_plasma"></span><span id="GAS_PLASMA"></span>**Plasma de gas** (7)
...
Calificadores: [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("píxeles")
</dt> </dl>
...
Descripción del tipo de iluminación de la pantalla.
...
Modo de recorrido que indica un recorrido único o doble, por ejemplo.
...
Si **es true**, el panel plano admite la presentación en color.
...
Resolución vertical, en píxeles.

</dd> </dl>

## <a name="remarks"></a>Observaciones

La clase **CIM \_ FlatPanel** se deriva de la [**\_ presentación de CIM**](cim-display.md).
