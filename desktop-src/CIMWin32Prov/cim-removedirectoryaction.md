...
---
# <a name="cim_removedirectoryaction-class"></a>\_Clase RemoveDirectoryAction de CIM
...
La clase **CIM \_ RemoveDirectoryAction** tiene estos tipos de miembros:
...
La clase **CIM \_ RemoveDirectoryAction** tiene estos métodos.



| Método                                                             | Descripción                                                   |
|:-------------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-removedirectoryaction.md) | Toma una acción concreta. No implementado por WMI.<br/> |
...
La clase **CIM \_ RemoveDirectoryAction** tiene estas propiedades.
...
La clase **CIM \_ RemoveDirectoryAction** se deriva de [**\_ DirectoryAction de CIM**](cim-directoryaction.md).
