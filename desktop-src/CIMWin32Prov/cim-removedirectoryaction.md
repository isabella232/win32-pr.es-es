---
description: La clase \_ RemoveDirectoryAction de CIM quita los directorios de los elementos de software.
...
ms.locfileid: "122880111"
---
# <a name="cim_removedirectoryaction-class"></a>Cim \_ RemoveDirectoryAction (clase)

La **clase \_ RemoveDirectoryAction de CIM** quita los directorios de los elementos de software.
...
La **clase \_ RemoveDirectoryAction de CIM** tiene estos tipos de miembros:
...
La **clase \_ RemoveDirectoryAction de CIM** tiene estos métodos.



| Método                                                             | Descripción                                                   |
|:-------------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-removedirectoryaction.md) | Realiza una acción determinada. No implementado por WMI.<br/> |
...
La **clase \_ RemoveDirectoryAction de CIM** tiene estas propiedades.
...
Si **es TRUE,** el directorio debe estar vacío para quitarse.
...
La **clase \_ RemoveDirectoryAction** de CIM se deriva de [**CIM \_ DirectoryAction**](cim-directoryaction.md).
