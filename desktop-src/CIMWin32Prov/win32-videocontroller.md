...
---
# <a name="win32_videocontroller-class"></a>\_Clase de Videocontroller Win32

La [clase WMI](../wmisdk/retrieving-a-class.md) **\_ videocontroller de Win32** representa las capacidades y la capacidad de administración del controlador de vídeo en un equipo que ejecuta Windows.
...
La clase de **\_ videocontroller de Win32** tiene estos tipos de miembros:
...
La clase de **\_ Videocontroller de Win32** tiene estos métodos.
...
| **SetPowerState** | Sin implementar. Para implementar este método, consulte el método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) en [**CIM \_ PCVideoController**](cim-pcvideocontroller.md).<br/> |
...
La clase de **\_ Videocontroller de Win32** tiene estas propiedades.
...
Calificadores: [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**\_ controlador de videojuego CIM**](cim-videocontroller.md).**CapabilityDescriptions**")
</dt> </dl>

Matriz de gráficos y capacidades 3D del controlador de vídeo.

Esta propiedad se hereda del [**\_ controlador de videodispositivo CIM**](cim-videocontroller.md).
...
Conjunto de chips general usado para que este controlador Compare las compatibilidades con el sistema.
...
Calificadores: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("indexado"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**controlador de \_ videojuego CIM**](cim-videocontroller.md).**AcceleratorCapabilities**")
</dt> </dl>

Cadenas de forma libre que proporcionan explicaciones más detalladas para cualquiera de las características del acelerador de vídeo indicadas en la matriz **AcceleratorCapabilities** . Tenga en cuenta que cada entrada de esta matriz está relacionada con la entrada de la matriz **AcceleratorCapabilities** que se encuentra en el mismo índice.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("inesperados win32api \| Device context Functions \| [**GetDeviceCaps**](/windows/win32/api/wingdi/nf-wingdi-getdevicecaps)")
</dt> </dl>

Tamaño de la tabla de colores del sistema. El dispositivo debe tener una profundidad de color de no más de 8 bits por píxel. de lo contrario, no se establece esta propiedad.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vídeo DMTF \| 003,12 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" bits ")
</dt> </dl>
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vídeo DMTF \| 003,11 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" píxeles ")
</dt> </dl>
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vídeo DMTF \| 003,14 ")
</dt> </dl>

Número de columnas de este controlador de vídeo (si está en modo de carácter). En caso contrario, escriba 0 (cero).
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vídeo DMTF \| 003,13 ")
</dt> </dl>

Número de filas para este controlador de vídeo (si está en modo de carácter). En caso contrario, escriba 0 (cero).
...
Calificadores: [**override**](../wmisdk/standard-qualifiers.md) ("CurrentRefreshRate"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HardwareInformation."), [**Units**](../wmisdk/standard-qualifiers.md) ("hercios")
</dt> </dl>

Frecuencia con la que el controlador de vídeo actualiza la imagen para el monitor. Un valor de 0 (cero) indica que se está usando la tasa predeterminada, mientras que 0xFFFFFFFF indica que se está usando la velocidad óptima.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vídeo DMTF \| 003,8 ")
</dt> </dl>
...
<span id="Interlaced"></span><span id="interlaced"></span><span id="INTERLACED"></span>**Entrelazado** (3)
...
<span id="Non_Interlaced"></span><span id="non_interlaced"></span><span id="NON_INTERLACED"></span>**No entrelazado** (4)
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vídeo DMTF \| 003,10 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" píxeles ")
</dt> </dl>
...
Identificador (único en el sistema del equipo) para este controlador de vídeo.
...
Número actual de lápices específicos del dispositivo. Un valor de 0xFFFF significa que el dispositivo no admite lápices.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("inesperados win32api \| Device context Functions \| EnumDisplaySettings")
</dt> </dl>

Tipo de interpolación del controlador de vídeo. La propiedad puede ser uno de los valores predefinidos o un valor definido por el controlador mayor o igual que 256. Si se elige la interpolación de líneas, el controlador usa un método de interpolación que genera bordes bien definidos entre las escalas de color negro, blanco y gris. La interpolación de líneas de arte no es adecuada para las imágenes que incluyen graduaciones continuas de intensidad y matiz como fotografías digitalizadas.
...
**Interpolación con un pincel grueso** (2)
...
**Interpolación con un pincel fino** (3)
...
**Interpolación de líneas lineales** (4)
...
El **dispositivo realiza el ajuste de escala gris** (5)
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Services \\ \\ Class \\ \\ ")
</dt> </dl>

Fecha y hora de la última modificación del controlador de vídeo instalado actualmente.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("inesperados win32api \| File Installation Library Functions \| GetFileVersionInfo")
</dt> </dl>

Número de versión del controlador de vídeo.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("inesperados win32api \| Printing and Print spooler Structures \| DEVMODE \| dmICMIntent")
</dt> </dl>

Valor específico de uno de los tres métodos de coincidencia de color posibles o intenciones que se deben usar de forma predeterminada. Esta propiedad se usa principalmente para aplicaciones no ICM. Las aplicaciones ICM establecen intenciones mediante el uso de las funciones de ICM. Esta propiedad puede ser un valor predefinido o un valor definido por el controlador mayor o igual que 256. La coincidencia de color basada en la saturación es la opción más adecuada para los gráficos de empresa cuando no se desea el tramado. La coincidencia de color basada en el contraste es la opción más adecuada para imágenes digitalizadas o fotográficas cuando se desea el tramado. La coincidencia de color optimizada para coincidir con el color exacto solicitado es la más adecuada para su uso con logotipos comerciales u otras imágenes cuando se desea una coincidencia de color exacta.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("inesperados win32api \| Printing and Print spooler Structures \| DEVMODE \| dmICMMethod")
</dt> </dl>

Método para controlar ICM. En el caso de las aplicaciones no ICM, esta propiedad determina si está habilitado ICM. En el caso de las aplicaciones ICM, el sistema examina esta propiedad para determinar cómo controlar la compatibilidad con ICM. Esta propiedad puede ser un valor predefinido o un valor definido por el controlador mayor o igual que 256. El valor determina qué sistema controla la coincidencia de color de la imagen.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ control \\ \\ Class \\ \\ {4D36E968-E325-11CE-BFC1-08002BE10318} \\ \\ 0000")
</dt> </dl>

Ruta de acceso al archivo. inf del adaptador de vídeo.
...
Del archivo. inf en el que reside la información de vídeo de Windows.
...
Nombre del controlador de dispositivo de pantalla instalado.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vídeo DMTF \| 003,5 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" hercios ")
</dt> </dl>
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vídeo DMTF \| 003,4 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" hercios ")
</dt> </dl>
...
Si es **true**, se usa la escala de grises para mostrar imágenes.
...
Esta propiedad se hereda de [**\_ PCVideoController CIM**](cim-pcvideocontroller.md).
...
Número de entradas reservadas en la paleta del sistema. El sistema operativo puede reservar entradas para admitir los colores estándar de las barras de tareas y otros elementos de visualización del escritorio. Este índice solo es válido si el controlador de dispositivo establece el bit de la **\_ paleta RC** en el índice RASTERCAPS y solo está disponible si el controlador es compatible con Windows de 16 bits. Si el sistema no está utilizando una paleta, **ReservedSystemPaletteEntries** no se establece.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("inesperados win32api \| Printing and Print spooler Structures \| DEVMODE \| dmSpecVersion")
</dt> </dl>

Número de versión de la especificación de datos de inicialización (en la que se basa la estructura).
...
Número actual de entradas de índice de color en la paleta del sistema. Este índice solo es válido si el controlador de dispositivo establece el bit de la **\_ paleta RC** en el índice RASTERCAPS y solo está disponible si el controlador es compatible con Windows de 16 bits. Si el sistema no está utilizando una paleta, **SystemPaletteEntries** no se establece.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vídeo DMTF \| 003,2 ")
</dt> </dl>

Tipo de arquitectura de vídeo.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vídeo DMTF \| 003,6 ")
</dt> </dl>
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vídeo DMTF \| 003,3 ")
</dt> </dl>
...
Configuración actual de la resolución, el color y el modo de exploración del controlador de vídeo.
...
Cadena de forma libre que describe el procesador de vídeo.
...
La clase de **\_ videocontroladora Win32** se deriva de [**CIM \_ PCVideoController**](cim-pcvideocontroller.md).
...
En el ejemplo de la [lista de propiedades del controlador de vídeo](https://Gallery.TechNet.Microsoft.Com/6c1a585c-742f-4f51-bb57-23838e8f011f) de VBScript se enumeran las propiedades del controlador de vídeo.

En el siguiente ejemplo de PowerShell se enumeran las propiedades del controlador de vídeo.
