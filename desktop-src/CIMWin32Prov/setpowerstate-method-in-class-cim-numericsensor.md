---
description: El método SetPowerState de la clase NumericSensor de CIM establece el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo \_ en ese estado.
ms.assetid: 0cb5e1d3-e39a-446c-9a24-63bcd278c329
ms.tgt_platform: multiple
title: Método SetPowerState de la CIM_NumericSensor clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
