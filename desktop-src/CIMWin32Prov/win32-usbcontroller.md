...
---
# <a name="win32_usbcontroller-class"></a>\_Clase Win32 USBController

La [clase WMI](../wmisdk/retrieving-a-class.md) **\_ USBController de Win32** administra las capacidades de un controlador de bus serie universal (USB).
...
Identificador único de la controladora USB.
...
Esta propiedad se hereda de [**\_ USBController CIM**](cim-usbcontroller.md).
...
La **clase \_ USBController de Win32** se deriva de [**\_ USBController de CIM**](cim-usbcontroller.md).

Puede usar la clase de asociación [**\_ USBControllerDevice de Win32**](win32-usbcontrollerdevice.md) para determinar qué dispositivos lógicos están asociados con el controlador.

## <a name="examples"></a>Ejemplos

El ejemplo de lista de PowerShell de [información de controlador USB](https://Gallery.TechNet.Microsoft.Com/fc2d92ce-a241-47bf-a5ea-3395d301559e) devuelve información acerca de todas las controladoras USB que se encuentran en un equipo.

El siguiente ejemplo de VBScript devuelve información acerca de todas las controladoras USB que se encuentran en un equipo.
