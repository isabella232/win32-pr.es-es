...
---
# <a name="cim_managementcontroller-class"></a>\_Clase ManagementController de CIM

La **clase \_ ManagementController de CIM** se relaciona con las capacidades y la administración de un controlador de administración.
...
| Método                                                                          | Descripción                                                                                                                              |
|:--------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-managementcontroller.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-managementcontroller.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ ManagementController** se deriva del [**\_ controlador CIM**](cim-controller.md).
