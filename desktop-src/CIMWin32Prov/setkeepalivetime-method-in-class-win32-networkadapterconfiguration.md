...
---
# <a name="setkeepalivetime-method-of-the-win32_networkadapterconfiguration-class"></a>Método SetKeepAliveTime de la \_ clase NetworkAdapterConfiguration de Win32
...
Intervalo, en milisegundos, TCP espera a comprobar que una conexión inactiva sigue estando disponible.
...
Si el sistema remoto todavía está accesible y funciona, reconocerá la transmisión de mantenimiento de conexión. Los paquetes Keep Alive no se envían de forma predeterminada. Esta característica puede estar habilitada en una conexión por parte de una aplicación.

## <a name="examples"></a>Ejemplos

El ejemplo de la [modificación de la hora de mantenimiento de conexión para todos los adaptadores de red](https://Gallery.TechNet.Microsoft.Com/35c1b0ac-285d-4baa-be6e-d3fb0b461676) de VBScript configura el tiempo de mantenimiento de conexión para todos los adaptadores de red de un equipo en 300.000 milisegundos (5 minutos).
