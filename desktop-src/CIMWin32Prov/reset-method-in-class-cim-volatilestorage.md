---
description: El método Reset de la clase VOLATILEStorage de CIM \_ solicita un restablecimiento del dispositivo lógico.
ms.assetid: 3a0c4bf7-a2c3-4001-9658-8c3a94c2e7f1
ms.tgt_platform: multiple
title: Método Reset de la CIM_VolatileStorage clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "126892596"
---
# <a name="reset-method-of-the-cim_volatilestorage-class"></a>Método Reset de la clase \_ VolatileStorage de CIM

El **método Reset** de la clase VOLATILEStorage de CIM solicita un \_ restablecimiento del dispositivo lógico. Este método se hereda de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
