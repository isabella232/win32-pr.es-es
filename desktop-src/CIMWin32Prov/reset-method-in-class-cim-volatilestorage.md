...
---
# <a name="reset-method-of-the-cim_volatilestorage-class"></a>Método Reset de la \_ clase VolatileStorage de CIM

El método **RESET** de la \_ clase VolatileStorage de CIM solicita un restablecimiento del dispositivo lógico. Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
