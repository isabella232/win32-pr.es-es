...
---
# <a name="reset-method-of-the-cim_battery-class"></a>Método Reset de la \_ clase Battery de CIM

El método **RESET** de la \_ clase de batería CIM solicita un restablecimiento del dispositivo lógico. Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
...
[\_Batería CIM](reset-method-in-class-cim-battery.md)
</dt> <dt>
