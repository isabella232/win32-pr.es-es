...
title: Método Reset de la clase CIM_NetworkAdapter clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "126965395"
---
# <a name="reset-method-of-the-cim_networkadapter-class"></a>Método Reset de la clase \_ NetworkAdapter de CIM

El **método Reset** de la clase NetworkAdapter cim solicita un \_ restablecimiento del dispositivo lógico. Este método se hereda de [**\_ CIM LogicalDevice.**](cim-logicaldevice.md)
