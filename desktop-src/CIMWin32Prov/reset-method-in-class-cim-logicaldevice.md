...
El método **RESET** de la clase de LOGICALDEVICE de CIM \_ solicita un restablecimiento del dispositivo lógico. Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
...
[LogicalDevice de CIM \_](reset-method-in-class-cim-logicaldevice.md)
</dt> <dt>
