---
description: La clase \_ RemoveFileAction de CIM desinstala los archivos.
...
ms.locfileid: "122887211"
---
# <a name="cim_removefileaction-class"></a>Cim \_ RemoveFileAction (clase)
...
La **clase \_ RemoveFileAction de CIM** tiene estos tipos de miembros:
...
La **clase \_ RemoveFileAction de CIM** tiene estos métodos.



| Método                                                        | Descripción                                                   |
|:--------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-removefileaction.md) | Realiza una acción determinada. No implementado por WMI.<br/> |
...
La **clase \_ RemoveFileAction de CIM** tiene estas propiedades.
...
La **clase \_ RemoveFileAction** de CIM se deriva de [**CIM \_ FileAction**](cim-fileaction.md).
