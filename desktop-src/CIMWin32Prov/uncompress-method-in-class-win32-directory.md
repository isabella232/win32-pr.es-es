...
---
# <a name="uncompress-method-of-the-win32_directory-class"></a>Método UNCOMPRESS de la \_ clase de directorio Win32

El método de clase **descomprimir** [WMI](/windows/desktop/WmiSdk/retrieving-a-class) descomprime el archivo de entrada de directorio lógico (o directorio) especificado en la ruta de acceso del objeto.
...
En el siguiente ejemplo de VBScript se descomprime la carpeta c: \\ scripts.
...
[**Comprimir**](compress-method-in-class-win32-directory.md)
</dt> </dl>
