...
---
# <a name="compressex-method-of-the-cim_directory-class"></a>Método CompressEx de la \_ clase de directorio CIM

El método **CompressEx** comprime el archivo lógico (o directorio) especificado en la ruta de acceso del objeto. Este método es una versión extendida del método [**compress**](compress-method-in-class-cim-directory.md) y se hereda de [**CIM \_ LogicalFile**](cim-logicalfile.md).
...
[\_Directorio CIM](compressex-method-in-class-cim-directory.md)
</dt> <dt>
