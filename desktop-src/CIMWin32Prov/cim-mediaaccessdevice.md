...
---
# <a name="cim_mediaaccessdevice-class-cimwin32-wmi-providers"></a>CIM_MediaAccessDevice (clase) (proveedores WMI de CIMWin32)

La clase **CIM \_ MediaAccessDevice** representa la capacidad de obtener acceso a uno o más medios y, a continuación, utilizar los medios para almacenar y recuperar datos.
...
| Método                                                                       | Descripción                                                                                                                              |
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-mediaaccessdevice.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-mediaaccessdevice.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
Capacidades del dispositivo de acceso a medios.
...
Matriz de cadenas de formato libre que proporciona explicaciones detalladas para las características del dispositivo de acceso indicadas en la matriz de **funcionalidades** .

> [!Note]  
> Cada entrada de esta matriz está relacionada con la entrada de la matriz de **funciones** , que se encuentra en el mismo índice.
...
Cadena de forma libre que indica el algoritmo o la herramienta que se usa para comprimir el archivo lógico. Si no es posible describir el esquema de compresión (porque es desconocido), use lo siguiente: si es, use "Unknown". Si es, use "Compressed". , use "no comprimido".
...
Tamaño máximo, en kilobytes, de los medios admitidos por este dispositivo. Los kilobytes se interpretan como el número de bytes multiplicado por 1000 (no por el número de bytes multiplicado por 1024).
...
Número máximo de medios individuales que se pueden admitir o insertar.
...
La **clase \_ MediaAccessDevice de CIM** se deriva del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).

WMI no implementa esta clase. Para las clases derivadas de **CIM \_ MediaAccessDevice**, vea [clases Win32](win32-provider.md).
