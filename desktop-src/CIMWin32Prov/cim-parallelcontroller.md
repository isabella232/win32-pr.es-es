---
description: La \_ asociación de CIM ParallelController se relaciona con las funcionalidades y la administración del dispositivo lógico de puerto paralelo.
...
La **clase \_ CIM ParallelController** tiene estos tipos de miembros:
...
La **clase \_ CIM ParallelController** tiene estos métodos.



| Método                                                                        | Descripción                                                                                                                              |
|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-parallelcontroller.md)                 | Solicita un restablecimiento del dispositivo lógico. Wmi no implementa .<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-parallelcontroller.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. Wmi no implementa .<br/> |
...
La **clase \_ CIM ParallelController** tiene estas propiedades.
...
Calificadores: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Parallel Ports \| 003.8"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ ParallelController**.**CapabilityDescriptions**")
</dt> </dl>
...
La **clase \_ CIM ParallelController** se deriva del [**controlador \_ CIM**](cim-controller.md).
