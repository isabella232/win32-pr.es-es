---
description: La asociación \_ de CIM ParallelController se relaciona con las funcionalidades y la administración del dispositivo lógico de puerto paralelo.
...
ms.locfileid: "118679091"
---
# <a name="cim_parallelcontroller-class"></a>Cim \_ ParallelController (clase)

La **asociación \_ de CIM ParallelController** se relaciona con las funcionalidades y la administración del dispositivo lógico de puerto paralelo.
...
La **clase \_ ParallelController** de CIM tiene estos tipos de miembros:
...
La **clase \_ ParallelController** de CIM tiene estos métodos.



| Método                                                                        | Descripción                                                                                                                              |
|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Restablecer**](reset-method-in-class-cim-parallelcontroller.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-parallelcontroller.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La **clase \_ ParallelController** de CIM tiene estas propiedades.
...
Calificadores: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Puertos paralelos DMTF \| \| 003.8"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ ParallelController**.**CapabilityDescriptions**")
</dt> </dl>

Funcionalidades del controlador paralelo.
...
Calificadores: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ ParallelController**.**Funcionalidades**")
</dt> </dl>

Cadenas de forma libre que proporcionan explicaciones detalladas de las características del controlador paralelo indicadas en la **matriz Capabilities.**
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Puertos paralelos DMTF \| \| 003.7")
</dt> </dl>

Si **es TRUE,** se admite el acceso directo a memoria (DMA).
...
Número máximo de entidades direccionables directamente admitidas por el controlador. Se debe usar un valor de 0 (cero) si el número es desconocido o ilimitado.
...
La **clase \_ ParallelController** de CIM se deriva del [**controlador CIM \_**](cim-controller.md).

WMI no implementa esta clase. Para las clases WMI que se derivan de **CIM \_ ParallelController**, vea [Clases win32](win32-provider.md).
