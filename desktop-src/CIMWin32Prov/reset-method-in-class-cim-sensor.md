---
description: 'Método reset de la CIM_Sensor clase : el método Reset solicita un restablecimiento del dispositivo lógico. Este método se hereda de CIM \_ LogicalDevice.'
