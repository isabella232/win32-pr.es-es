...
ms.locfileid: "119701495"
---
# <a name="reset-method-of-the-cim_pcvideocontroller-class"></a>Método Reset de la \_ clase CIM PCVideoController

El **método Reset** de la clase CIM \_ PCVideoController solicita un restablecimiento del dispositivo lógico. Este método se hereda de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
