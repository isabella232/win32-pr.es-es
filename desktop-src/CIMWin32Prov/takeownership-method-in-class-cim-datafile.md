...
WMI implementa el método **TakeOwnerShip** en el [**archivo de \_ archivos de CIM**](cim-datafile.md) .
...
[\_Archivo de archivos CIM](takeownership-method-in-class-cim-datafile.md)
</dt> <dt>
