---
description: La categoría Sistema operativo agrupa clases que representan objetos relacionados con el sistema operativo.
...
La subcategoría COM agrupa clases que representan la configuración de COM y DCOM, las clases y la configuración de la aplicación cliente.



| Clase                                                                                           | Descripción                                                                                                                                                                          |
|-------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Win32 \_ ClassicCOMApplicationClasses**](win32-classiccomapplicationclasses.md)               | Association (clase)<br/> Relaciona una aplicación DCOM y un componente COM agrupados en ella.<br/>                                                                             |
...
La subcategoría Controladores agrupa clases que representan controladores de dispositivos virtuales y controladores del sistema para servicios base.
...
La subcategoría Sistema de archivos agrupa las clases que representan la forma en que se organiza lógicamente un disco duro. Esto incluye el tipo de sistema de archivos utilizado, la estructura de directorios y la forma en que se particiona el disco.
...
| [**Directorio \_ win32**](win32-directory.md)                                         | Clase de instancia<br/> Representa una entrada de directorio en un sistema informático que ejecuta Windows.<br/>                                                                              |
| [**Directorio de \_ Win32Specification**](/previous-versions/windows/desktop/msiprov/win32-directoryspecification)               | Clase de instancia<br/> Representa el diseño del directorio del producto.<br/>                                                                                                |
...
| [**Win32 \_ DiskPartition**](win32-diskpartition.md)                                 | Clase de instancia<br/> Representa las funcionalidades y la capacidad de administración de un área con particiones de un disco físico en un sistema informático que ejecuta Windows.<br/>              |
...
| [**Disco lógico \_ win32**](win32-logicaldisk.md)                                     | Representa un origen de datos que se resuelve en un dispositivo de almacenamiento local real en un sistema de equipo que ejecuta Windows.<br/>                                                            |
...
| [**Win32 \_ OperatingSystemAutochkSetting**](/previous-versions//aa394240(v=vs.85)) | Association (clase)<br/> Representa la asociación entre una [**instancia \_ managedSystemElement de CIM**](cim-managedsystemelement.md) y la configuración definida para ella.<br/> |
...
| [**Subdirectorio \_ win32**](win32-subdirectory.md)                                   | Association (clase)<br/> Relaciona un directorio (carpeta) y uno de sus subdirectorios (subcarpetas).<br/>                                                                     |
...
| [**Win32 \_ LUID**](/previous-versions/windows/desktop/wmipjobobjprov/win32-luid)                                                   | Clase de instancia<br/> Representa un identificador único local (LUID)<br/>                                                                                                         |
...
| [**Win32 \_ NamedJobObjectActgInfo**](/previous-versions/windows/desktop/wmipjobobjprov/win32-namedjobobjectactginfo)               | Clase de instancia<br/> Representa la información de contabilidad de E/S de un objeto de trabajo.<br/>                                                                                           |
...
| [**\_SIDandAttributes de Win32**](/previous-versions/windows/desktop/wmipjobobjprov/win32-sidandattributes)                           | Clase de instancia<br/> Representa un identificador de seguridad (SID) y sus atributos.<br/>                                                                                            |
...
La subcategoría Memory y Page files agrupa las clases que representan los valores de configuración del archivo de página.
...
| [**Win32 \_ PageFileUsage**](win32-pagefileusage.md)                   | Clase de instancia<br/> Representa el archivo utilizado para controlar el intercambio de archivos de memoria virtual en un sistema de equipo que ejecuta Windows.<br/> |
...
La clase de la subcategoría Multimedia Audio o Visual representa las propiedades del códec de audio o vídeo instalado en el sistema informático.



| Clase                                       | Descripción                                                                                                |
|---------------------------------------------|------------------------------------------------------------------------------------------------------------|
| [**CodecFile de Win32 \_**](win32-codecfile.md) | Clase de instancia<br/> Representa el códec de audio o vídeo instalado en el sistema del equipo.<br/> |
...
La subcategoría Redes agrupa clases que representan las conexiones de red, los clientes de red y la configuración de conexión de red, como el protocolo utilizado.
...
| [**Win32 \_ NetworkClient**](win32-networkclient.md)                              | Clase de instancia<br/> Representa un cliente de red en un sistema de equipo que ejecuta Windows.<br/>                           |
...
| [**Win32 \_ ModuleTrace**](/previous-versions/windows/desktop/krnlprov/win32-moduletrace)                                       | Clase de evento<br/> Evento base para eventos de módulo.<br/>                                                                                                          |
...
| [**ThreadTrace de Win32 \_**](/previous-versions/windows/desktop/krnlprov/win32-threadtrace)                                       | Clase de evento<br/> Clase de eventos base para eventos de subproceso.<br/>                                                                                                    |
...
El sistema operativo Configuración subcategoría agrupa las clases que representan el sistema operativo y su configuración.
...
| [**Equipo \_ Win32System**](win32-computersystem.md)                                       | Clase de instancia<br/> Representa un sistema informático que funciona en un Windows de trabajo.<br/>                                                                              |
| [**ComputerSystemProcessor de Win32 \_**](win32-computersystemprocessor.md)                     | Association (clase)<br/> Relaciona un sistema informático y un procesador que se ejecuta en ese sistema.<br/>                                                                          |
...
| [**\_LoadOrderGroupServiceDependencies de Win32**](win32-loadordergroupservicedependencies.md) | Clase de instancia<br/> Representa una asociación entre un servicio base y un grupo de pedidos de carga del que depende el servicio para empezar a ejecutarse.<br/>                         |
| [**Win32 \_ LoadOrderGroupServiceMembers**](win32-loadordergroupservicemembers.md)           | Association (clase)<br/> Relaciona un grupo de pedidos de carga y un servicio base.<br/>                                                                                             |
...
| [**Win32 \_ QuickFixEngineering**](win32-quickfixengineering.md)                             | Clase de instancia<br/> Representa las actualizaciones de ingeniería Corrección rápida todo el sistema (QFE) o actualizaciones que se han aplicado al sistema operativo actual.<br/>                         |
...
| [**Win32 \_ SystemBootConfiguration**](win32-systembootconfiguration.md)                     | Association (clase)<br/> Relaciona un sistema informático y su configuración de arranque.<br/>                                                                                      |
...
| [**Win32 \_ SystemSetting**](win32-systemsetting.md)                                         | Association (clase)<br/> Relaciona un sistema informático y una configuración general en ese sistema.<br/>                                                                            |
...
| [**Win32 \_ SystemUsers**](win32-systemusers.md)                                             | Association (clase)<br/> Relaciona un sistema informático y una cuenta de usuario en ese sistema.<br/>                                                                               |
...
| Clase                                                 | Descripción                                                                                                     |
|-------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|
| [**Proceso \_ win32**](win32-process.md)               | Clase de instancia<br/> Representa una secuencia de eventos en un sistema de equipo que ejecuta Windows.<br/>      |
...
La subcategoría Trabajos de Scheduler agrupa las clases que representan la configuración del trabajo programado.



| Clase                                                | Descripción                                                                                                                                                                                                                                                           |
|------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**CurrentTime de Win32 \_**](/previous-versions/windows/desktop/wmitimepprov/win32-currenttime) | Clase abstracta<br/> Representa una instancia en el tiempo como segundos del componente, minutos, día de la semana, y así sucesivamente.<br/>                                                                                                                                        |
...
| [**Win32 \_ LocalTime**](/previous-versions/windows/desktop/wmitimepprov/win32-localtime)     | Clase de instancia<br/> Representa un momento dado devuelto como [**objetos \_ LocalTime de Win32**](/previous-versions/windows/desktop/wmitimepprov/win32-localtime) resultantes de una consulta. La **propiedad Hour** se devuelve como la hora local en un reloj de 24 horas.<br/>                                |
| [**Hora UTC de Win32 \_**](/previous-versions/windows/desktop/wmitimepprov/win32-utctime)         | Clase de instancia<br/> Representa un momento dado que se devuelve como [**objetos \_ UTCTime de Win32**](/previous-versions/windows/desktop/wmitimepprov/win32-utctime) resultantes de una consulta. La **propiedad Hour** se devuelve como la hora universal coordinada (UTC) en un reloj de 24 horas.<br/> |
...
La subcategoría Seguridad agrupa clases que representan la configuración de seguridad del sistema.
...
| [**Win32 \_ LogicalFileAuditing**](/previous-versions/windows/desktop/secrcw32prov/win32-logicalfileauditing)                     | Association (clase)<br/> Relaciona la configuración de seguridad de un archivo o directorio de un miembro de su lista de control de acceso del sistema (SACL).<br/>            |
...
| [**Win32 \_ LogicalShareAuditing**](/previous-versions/windows/desktop/secrcw32prov/win32-logicalshareauditing)                   | Association (clase)<br/> Relaciona la configuración de seguridad de un recurso compartido y un miembro de su SACL.<br/>                                                 |
...
| [**SecuritySetting de Win32 \_**](/previous-versions/windows/desktop/secrcw32prov/win32-securitysetting)                             | Clase de instancia<br/> Representa la configuración de seguridad de un elemento administrado.<br/>                                                                     |
| [**Seguridad de \_ Win32SettingAccess**](/previous-versions/windows/desktop/secrcw32prov/win32-securitysettingaccess)                 | Clase de instancia<br/> Representa los derechos concedidos y denegados a un administrador de confianza para un objeto determinado.<br/>                                               |
...
La subcategoría Servicios agrupa clases que representan servicios y servicios base.



| Clase                                           | Descripción                                                                                                                                             |
|-------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**BaseService de Win32 \_**](win32-baseservice.md) | Clase de instancia<br/> Representa los objetos ejecutables que se instalan en una base de datos del Registro mantenida por el Administrador de control de servicios.<br/> |
...
| [**Win32 \_ PrinterShare**](win32-printershare.md)           | Association (clase)<br/> Relaciona una impresora local y el recurso compartido que la representa a medida que se ve a través de una red.<br/>                                                                     |
...
| [**SessionProcess de Win32 \_**](win32-sessionprocess.md)       | Association (clase)<br/> Representa una asociación entre una sesión de inicio de sesión y los procesos asociados a esa sesión.<br/>                                                            |
...
| [**Win32 \_ LogicalProgramGroupDirectory**](win32-logicalprogramgroupdirectory.md)       | Association (clase)<br/> Relaciona los grupos de programas lógicos (agrupaciones en el menú Inicio) y los directorios de archivos en los que se almacenan.<br/>                 |
...
| [**LogicalProgramGroupItemDataFile de Win32 \_**](win32-logicalprogramgroupitemdatafile.md) | Association (clase)<br/> Relaciona los elementos del grupo de programas de menú Inicio y los archivos en los que se almacenan.<br/>                                       |
...
La subcategoría Usuarios agrupa clases que representan información de almacenamiento.
...
| [**ShadowFor de Win32 \_**](/previous-versions/windows/desktop/vsswmi/win32-shadowfor)                             | Association (clase)<br/> Representa una asociación entre una instantánea y el volumen para el que se crea la instantánea.<br/> |
...
La subcategoría Usuarios agrupa las clases que representan información de la cuenta de usuario, como los detalles de pertenencia a grupos.
...
| [**Win32 \_ GroupUser**](win32-groupuser.md)                           | Association (clase)<br/> Relaciona un grupo y una cuenta que es miembro de ese grupo.<br/>                                           |
...
| [**NetworkLoginProfile de Win32 \_**](win32-networkloginprofile.md)       | Clase de instancia<br/> Representa la información de inicio de sesión de red de un usuario específico en un sistema informático que ejecuta Windows.<br/>           |
...
| [**UserInDomain de Win32 \_**](/previous-versions/windows/desktop/cimwin32a/win32-userindomain)                     | Association (clase)<br/> Relaciona una cuenta de usuario y un Windows NT.<br/>                                                          |
...
La subcategoría Windows registro de eventos agrupa las clases que representan eventos, entradas del registro de eventos, valores de configuración del registro de eventos, entre otras.
...
| [**Win32 \_ NTLogEventLog**](/previous-versions/windows/desktop/eventlogprov/win32-ntlogeventlog)           | Association (clase)<br/> Relaciona instancias de las clases [**\_ NTLogEvent**](/previous-versions/windows/desktop/eventlogprov/win32-ntlogevent) y [**Win32 \_ NTEventlogFile de**](/previous-versions/windows/desktop/legacy/aa394225(v=vs.85)) Win32.<br/> |
...
## <a name="windows-product-activation"></a>Windows Activación de productos

Windows La activación de productos (WPA) es una tecnología antisegada para reducir la copia ocasional de software.



| Clase                                                                                                               | Descripción                                                                                                                                                                                       |
|---------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Win32 \_ ComputerSystemWindowsProductActivationSetting**](/previous-versions/windows/desktop/licwmiprov/win32-computersystemwindowsproductactivationsetting) | Association (clase)<br/> Relaciona las instancias de [**Win32 \_ ComputerSystem y**](win32-computersystem.md) [**Win32 \_ WindowsProductActivation**](/previous-versions/windows/desktop/legacy/aa394520(v=vs.85)).<br/> |
