...
La **clase \_ Cim StorageRedundancyGroup** tiene estas propiedades.
...
Hay una menor cantidad de redundancia disponible debido a algunos errores.
...
La redundancia no está disponible debido a un número suficiente de errores. El siguiente error provocará un error general.
...
Algoritmo utilizado para la redundancia y reconstrucción de datos. El valor 0 no es válido en el esquema CIM, ya que representa que no existe redundancia en DMI. En ese caso, no se debe crear una instancia del objeto.
