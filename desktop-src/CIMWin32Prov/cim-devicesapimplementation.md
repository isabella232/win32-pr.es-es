...
La **clase \_ Cim DeviceSAPImplementation** tiene estos tipos de miembros:

-   [Propiedades](#properties)

### <a name="properties"></a>Propiedades

La **clase \_ Cim DeviceSAPImplementation** tiene estas propiedades.
...
La **clase \_ Cim DeviceSAPImplementation** se deriva de la [**dependencia \_ CIM**](cim-dependency.md).
