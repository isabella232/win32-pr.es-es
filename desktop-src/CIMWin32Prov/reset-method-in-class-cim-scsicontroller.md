...
---
# <a name="reset-method-of-the-cim_scsicontroller-class"></a>Método Reset de la \_ clase SCSIController de CIM

El método **RESET** de la \_ clase SCSIController de CIM solicita un restablecimiento del dispositivo lógico. Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
...
[\_SCSICONTROLLER CIM](reset-method-in-class-cim-scsicontroller.md)
</dt> <dt>
