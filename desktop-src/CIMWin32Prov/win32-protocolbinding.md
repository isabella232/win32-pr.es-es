...
---
# <a name="win32_protocolbinding-class"></a>\_Clase Win32 ProtocolBinding

La [clase WMI](../wmisdk/retrieving-a-class.md) **\_ ProtocolBinding** Association de Win32 relaciona un controlador de nivel de sistema, un protocolo de red y un adaptador de red.
...
Referencia a la instancia de que representa el protocolo que se utiliza con el controlador del sistema y en el adaptador de red.
...
Calificadores: [**key**](../wmisdk/key-qualifier.md), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("WMI \| Win32 \_ adaptador de la")
</dt> </dl>
