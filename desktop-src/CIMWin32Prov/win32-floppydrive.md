---
description: La clase \_ WMI Win32 FloppyDrive administra las funciones de una unidad de disquete.
...
\[**Win32 \_ FloppyDrive** ya no está disponible para su uso a Windows 10 y Windows Server 2016.\]

La clase [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ Win32 FloppyDrive** administra las funciones de una unidad de disquete.
...
La **clase Win32 \_ FloppyDrive** tiene estas propiedades.
...
El dispositivo no funciona, pero se puede restaurar rápidamente a plena potencia.
...
Matriz de funcionalidades del dispositivo de acceso multimedia. Por ejemplo, el dispositivo puede admitir el acceso aleatorio, los medios extraíbles y la limpieza automática. En este caso, los valores 3, 7 y 9 se escribirían en la matriz.
...
Cadena de forma libre que indica el algoritmo o la herramienta que usa el dispositivo para admitir la compresión. Si no es posible o no se desea describir el esquema de compresión (quizás porque no se conoce), use "Desconocido" para representar que no se sabe si el dispositivo admite funcionalidades de compresión o no. "Compressed" para representar que el dispositivo admite funcionalidades de compresión, pero su esquema de compresión no se conoce o no se revela. y "No comprimido" para representar que el dispositivo no admite funcionalidades de compresión.
...
Si **es True,** el dispositivo de acceso multimedia requiere limpieza. Si la limpieza manual o automática es posible se indica en la **propiedad Capabilities.**
