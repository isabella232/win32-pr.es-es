...
title: Método Copy de la CIM_LogicalFile clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118419821"
---
# <a name="copy-method-of-the-cim_logicalfile-class"></a>Método Copy de la clase \_ LogicalFile de CIM

El **método Copy** copia el archivo lógico (o directorio) especificado en la ruta de acceso del objeto a la ubicación especificada por el parámetro de entrada.
