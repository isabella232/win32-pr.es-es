...
---
# <a name="copy-method-of-the-cim_logicalfile-class"></a>Método de copia de la \_ clase LogicalFile de CIM

El método de **copia** copia el archivo lógico (o directorio) especificado en la ruta de acceso del objeto en la ubicación especificada por el parámetro de entrada.
