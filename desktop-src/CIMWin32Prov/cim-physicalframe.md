---
description: La clase PhysicalFrame de CIM es una clase primaria de bastidor, chasis y otros gabinetes de marco, tal como se \_ definen en las clases de extensión.
...
ms.locfileid: "118678176"
---
# <a name="cim_physicalframe-class"></a>\_Cim PhysicalFrame (clase)

La **clase \_ PhysicalFrame** de CIM es una clase primaria de bastidor, chasis y otros gabinetes de marco, tal como se definen en las clases de extensión. En esta clase primaria se incluyen propiedades como **VisibleAlarm** **y AudibleAlarm,** y los datos relacionados con las infracciones de seguridad.
...
La **clase \_ PhysicalFrame** de CIM tiene estos tipos de miembros:
...
La **clase \_ PhysicalFrame de CIM** tiene estos métodos.



| Método                                                                 | Descripción                                                                                                                                      |
|:-----------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|
| [**IsCompatible**](iscompatible-method-in-class-cim-physicalframe.md) | Comprueba si el elemento físico al que se hace referencia se puede contener o insertar en el paquete físico. No implementado por WMI.<br/> |
...
La **clase \_ PhysicalFrame** de CIM tiene estas propiedades.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DmTF \| Physical Container Global Table \| 002.12"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ PhysicalFrame**.**BreachDescription**")
</dt> </dl>

Indica si se intentó una infracción física del marco pero no se ha realizado correctamente, o si se intentó y se ha realizado correctamente.
...
Calificadores: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ PhysicalFrame**.**Service Gluosophy**")
</dt> </dl>

Cadenas de forma libre que proporcionan explicaciones detalladas de las entradas de la **matriz ServiceMultidimensionalphy.**
...
Calificadores: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ PhysicalFrame**.**ServiceDescriptions**")
</dt> </dl>
...
La **clase \_ PhysicalFrame** de CIM se deriva de [**CIM \_ PhysicalPackage**](cim-physicalpackage.md).

WMI no implementa esta clase. Para las clases WMI derivadas de **\_ CIM PhysicalFrame,** vea [Clases Win32](win32-provider.md).
