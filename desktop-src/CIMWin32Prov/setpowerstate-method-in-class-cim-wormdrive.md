---
description: El método SetPowerState de la clase CIM WORMDrive establece el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo \_ en ese estado.
ms.assetid: 9d53ed52-740d-4691-9718-29d6fe99180a
ms.tgt_platform: multiple
title: Método SetPowerState de la CIM_WORMDrive clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
