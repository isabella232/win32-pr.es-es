...
---
# <a name="cim_aggregatepextent-class"></a>\_Clase AggregatePExtent de CIM

La clase **CIM \_ AggregatePExtent** proporciona información de resumen sobre los bloques lógicos direccionables, que están en el mismo grupo de redundancia de almacenamiento y se encuentran en el mismo medio físico.

La **clase \_ AggregatePExtent de CIM** es una agrupación alternativa de extensiones físicas cuando solo se necesita información de resumen o cuando se utiliza la configuración automática. La configuración automática puede dar lugar a que se definan miles de extensiones físicas.
...
La clase **CIM \_ AggregatePExtent** tiene estos tipos de miembros:
...
La clase **CIM \_ AggregatePExtent** tiene estos métodos.
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-aggregatepextent.md) | Define el estado de energía deseado para un dispositivo lógico y el momento en que el dispositivo debe ponerse en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ AggregatePExtent** tiene estas propiedades.
...
Calificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NumberOfBlocks"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Extensión física de agregado DMTF \| 001,2 ")
</dt> </dl>

Número total de bloques (incluidos los bloques de datos de comprobación) contenidos en esta extensión física de agregado. El tamaño del bloque (una propiedad heredada) debe establecerse en el mismo valor que para el dispositivo de acceso a medios asociado a esta extensión.
...
La clase **CIM \_ AggregatePExtent** se deriva de [**\_ StorageExtent de CIM**](cim-storageextent.md).
