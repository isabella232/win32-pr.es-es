---
description: La clase AggregatePExtent de CIM proporciona información de resumen sobre los bloques lógicos direccionables, que se encuentran en el mismo grupo de redundancia de almacenamiento y se encuentran en \_ el mismo medio físico.
...
ms.locfileid: "127174122"
---
# <a name="cim_aggregatepextent-class"></a>Cim \_ AggregatePExtent (clase)

La **clase \_ AggregatePExtent** de CIM proporciona información de resumen sobre los bloques lógicos direccionables, que se encuentran en el mismo grupo de redundancia de almacenamiento y se encuentran en el mismo medio físico.

La **clase \_ AggregatePExtent** de CIM es una agrupación alternativa para las extensiones físicas cuando solo se necesita información de resumen o cuando se usa la configuración automática. La configuración automática puede dar lugar a la definición de miles de extensiones físicas.
...
La **clase \_ AggregatePExtent de CIM** tiene estos tipos de miembros:
...
La **clase \_ AggregatePExtent de CIM** tiene estos métodos.



| Método                                                                      | Descripción                                                                                                                                |
|:----------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-aggregatepextent.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                                 |
| [**SetPowerState**](setpowerstate-method-in-class-cim-aggregatepextent.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar el dispositivo en ese estado. No implementado por WMI.<br/> |
...
La **clase \_ AggregatePExtent de CIM** tiene estas propiedades.
...
Calificadores: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NumberOfBlocks"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Extensión física \| agregada DMTF \| 001.2")
</dt> </dl>

Número total de bloques (incluidos los bloques de datos de comprobación) contenidos en esta extensión física agregada. El tamaño del bloque (una propiedad heredada) debe establecerse en el mismo valor que para el dispositivo de acceso multimedia asociado a esta extensión.
...
La **clase \_ AggregatePExtent de CIM** se deriva de CIM [**\_ StorageExtent.**](cim-storageextent.md)
