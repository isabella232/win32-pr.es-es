---
description: La clase WMI PortableBattery de Win32 contiene las propiedades relacionadas con una batería portátil, como una batería \_ de equipo portátil.
...
ms.locfileid: "127255644"
---
# <a name="win32_portablebattery-class"></a>Clase \_ PortableBattery de Win32
...
La **clase \_ PortableBattery de Win32** tiene estos métodos.



| Método            | Descripción                                                                                                                                                                        |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Sin implementar. Para implementar este método, consulte el método [**Reset**](reset-method-in-class-cim-controller.md) en [**CIM \_ Battery**](cim-battery.md).<br/>                 |
| **SetPowerState** | Sin implementar. Para implementar este método, consulte el método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) en [**CIM \_ Battery**](cim-battery.md).<br/> |
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable Battery \| 002.14")
</dt> </dl>

Descripción del estado de carga de la batería. El valor 10 (sin definir) no es válido en el esquema Modelo de información común (CIM) porque en la Interfaz de administración de escritorio (DMI) indica que no hay ninguna batería instalada. En este caso, no se debe crear una instancia de este objeto.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Multiplicador de capacidad de diseño de tipo SMBIOS \| 22") \|
</dt> </dl>

Factor de multiplicación del valor **DesignCapacity** para asegurarse de que el valor de hora de milivatio no se desborda para las implementaciones de especificación inteligente de datos de batería (SBDS).
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable Battery \| 002.7")
</dt> </dl>
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable Battery \| 002.8"), [**unidades**](../wmisdk/standard-qualifiers.md) ("militio-hora")
</dt> </dl>

Diseñe la capacidad de la batería en milivatios-hora. Si no se admite esta propiedad, escriba 0 (cero).
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable Battery \| 002.9"), [**unidades**](../wmisdk/standard-qualifiers.md) ("milivoltios")
</dt> </dl>

Diseñe el voltaje de la batería en milivoltios. Si no se admite este atributo, escriba 0 (cero).
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable Battery \| 002.15"), [**Units**](../wmisdk/standard-qualifiers.md) ("minutes")
</dt> </dl>
...
Duración esperada de la batería en minutos, suponiendo que la batería esté totalmente cargada. Esta propiedad representa la duración total esperada de la batería, no su vida restante actual, lo que se indica mediante **la propiedad EstimatedRunTime.**
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable Battery \| 002.11"), [**unidades**](../wmisdk/standard-qualifiers.md) ("milivatios-hora")
</dt> </dl>

Capacidad de carga completa de la batería en milivatios-hora. La comparación de este valor con la **propiedad DesignCapacity** determina cuándo es necesario reemplazar la batería. El final de una batería suele ser cuando la propiedad **FullChargeCapacity** está por debajo del 80 % de la **propiedad DesignCapacity.** Si no se admite esta propiedad, escriba 0 (cero).
...
Ubicación física de la batería. El fabricante del equipo rellena esta propiedad.

Ejemplo: "Atrás, a la izquierda"
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 22 \| Manufacture Date")
</dt> </dl>

Fecha en que se fabricó la batería.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 22 \| Manufacturer")
</dt> </dl>
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Error máximo de tipo SMBIOS 22 en datos \| de \| batería"), [**unidades**](../wmisdk/standard-qualifiers.md) ("porcentaje")
</dt> </dl>

Diferencia entre la mayor cantidad estimada de energía restante en la batería y la cantidad actual notificada por la batería.
...
Tiempo máximo, en minutos, para cargar completamente la batería. Esta propiedad representa el tiempo para recuperar una batería totalmente agotada, no el tiempo de carga restante actual, que se indica en la **propiedad TimeToFullCharge.**
...
Calificadores: [**MaxLen**](../wmisdk/standard-qualifiers.md) (64), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable Battery \| 002.10")
</dt> </dl>

Número de versión de Especificación de datos de batería inteligente compatible con esta batería. Si la batería no admite esta función, el valor se debe dejar en blanco.
...
Tiempo transcurrido en segundos desde que el UPS del sistema informático cambió por última vez a la energía de la batería, o el tiempo transcurrido desde que se reinició por última vez el sistema o el UPS, lo que sea menor. Si la batería está en línea, se devuelve 0 (cero).
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Portable Battery \| 002.16"), [**unidades**](../wmisdk/standard-qualifiers.md) ("minutos")
</dt> </dl>

Tiempo restante en minutos para cargar la batería por completo según la tasa de carga y el uso actuales.
...
La **clase \_ PortableBattery de Win32** se deriva de [**la batería CIM \_**](cim-battery.md).
