...
---
# <a name="win32_portablebattery-class"></a>\_Clase Win32 PortableBattery

La [clase WMI](../wmisdk/retrieving-a-class.md) **\_ PortableBattery de Win32** contiene las propiedades relacionadas con una batería portátil, como una batería de equipo portátil.
...
La **clase \_ PortableBattery de Win32** tiene estos tipos de miembros:
...
La clase **Win32 \_ PortableBattery** tiene estos métodos.



| Método            | Descripción                                                                                                                                                                        |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Sin implementar. Para implementar este método, consulte el método de [**restablecimiento**](reset-method-in-class-cim-controller.md) de la [**\_ batería de CIM**](cim-battery.md).<br/>                 |
| **SetPowerState** | Sin implementar. Para implementar este método, consulte el método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) en [**la \_ batería de CIM**](cim-battery.md).<br/> |
...
La **clase \_ PortableBattery de Win32** tiene estas propiedades.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Batería portátil DMTF \| 002,14 ")
</dt> </dl>

Descripción del estado de los cargos de la batería. El valor 10 (sin definir) no es válido en el esquema de Modelo de información común (CIM) porque en la interfaz de administración de escritorio (DMI) indica que no hay ninguna batería instalada. En este caso, no se debe crear una instancia de este objeto.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("multiplicador de capacidad de diseño de tipo de SMBIOS \| 22 \| ")
</dt> </dl>

Factor de multiplicación del valor de **designCapacity** para asegurarse de que el valor de hora de milivatios no se desborda en las implementaciones de especificación de datos de batería inteligente (SBDS).
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Batería portátil DMTF \| 002,7 ")
</dt> </dl>
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Batería portátil \| de DMTF 002,8 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" milivatios-horas ")
</dt> </dl>

Diseño de la capacidad de la batería en milivatios-horas. Si no se admite esta propiedad, escriba 0 (cero).
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Unidad DMTF portátil \| 002,9 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" milivoltios ")
</dt> </dl>

Tensión de diseño de la batería en milivoltios. Si no se admite este atributo, escriba 0 (cero).
...
Más información sobre el error registrado en **LastErrorCode** y las acciones correctivas que se pueden realizar.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Batería portátil DMTF \| 002,15 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" minutos ")
</dt> </dl>
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Batería portátil \| de DMTF 002,11 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" milivatios-horas ")
</dt> </dl>

Capacidad de carga completa de la batería en milivatios-horas. La comparación de este valor con la propiedad **designCapacity** determina cuándo es necesario reemplazar la batería. El final de la vida de una batería suele ser cuando la propiedad **FullChargeCapacity** cae por debajo del 80% de la propiedad **designCapacity** . Si no se admite esta propiedad, escriba 0 (cero).
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 22 \| Location")
</dt> </dl>

Ubicación física de la batería. Esta propiedad la rellena el fabricante del equipo.

Ejemplo: "en el fondo, a la izquierda"
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("tipo de SMBIOS \| 22 \| fecha de fabricación")
</dt> </dl>

Fecha en la que se fabricó la batería.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| fabricante de tipo 22 de SMBIOS \| ")
</dt> </dl>
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("el \| tipo de SMBIOS 22 \| error máximo en los datos de la batería"), [**unidades**](../wmisdk/standard-qualifiers.md) ("porcentaje")
</dt> </dl>

Diferencia entre la mayor cantidad de energía estimada que se ha dejado en la batería y la cantidad actual indicada por la batería.
...
Calificadores: [**MaxLen**](../wmisdk/standard-qualifiers.md) (64), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Batería portátil DMTF \| 002,10 ")
</dt> </dl>

Número de versión de especificación de datos de batería inteligente compatible con esta batería. Si la batería no admite esta función, el valor debe dejarse en blanco.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Batería portátil DMTF \| 002,16 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" minutos ")
</dt> </dl>

Tiempo restante en minutos para cargar la batería por completo a la tarifa de cargos actual y uso.
...
La clase **Win32 \_ PortableBattery** se deriva de [**la \_ batería CIM**](cim-battery.md).
