...
---
# <a name="compressex-method-of-the-win32_pagefile-class"></a>Método CompressEx de la clase de archivo de \_ paginación Win32
...
Nombre del archivo o directorio en el que se produjo un error en el método **CompressEx** . Este parámetro es **null** si el método se ejecuta correctamente.
