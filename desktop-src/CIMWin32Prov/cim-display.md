...
---
# <a name="cim_display-class-cimwin32-wmi-providers"></a>CIM_Display (clase) (proveedores WMI de CIMWin32)

La clase de **\_ presentación CIM** es una clase primaria para agrupar dispositivos de pantalla varios.
...
La clase de **\_ presentación CIM** tiene estos tipos de miembros:
...
La clase de **\_ presentación CIM** tiene estos métodos.
...
La clase de **\_ presentación CIM** tiene estas propiedades.
...
Cadena de forma libre que proporciona información sobre el error registrado en las acciones correctivas de la propiedad **LastErrorCode** que se van a realizar.
...
La clase de **\_ presentación CIM** se deriva [**de \_ UserDevice CIM**](cim-userdevice.md).

WMI no implementa esta clase. Para las clases derivadas de la **\_ presentación de CIM**, vea [clases Win32](win32-provider.md).
