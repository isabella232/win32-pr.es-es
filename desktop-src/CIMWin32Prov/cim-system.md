---
description: La clase \_ cim system agrega un conjunto enumerable de elementos del sistema administrados.
ms.assetid: cbfa60d4-36ae-4e0c-a57f-aabf219851d0
ms.tgt_platform: multiple
title: CIM_System clase (proveedores WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
La **clase \_ cim system** agrega un conjunto enumerable de elementos del sistema administrados. La agregación funciona como un conjunto funcional. Dentro de cualquier subclase concreta del sistema, hay una lista bien definida de clases de elementos del sistema administrado cuyas instancias se deben agregar.
...
Identifica cómo se generó el nombre del sistema mediante la subclase heurística.
...
WMI no implementa esta clase. Para las clases WMI derivadas del **sistema CIM, \_** vea [Clases Win32](win32-provider.md).
