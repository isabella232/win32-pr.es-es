...
---
# <a name="cim_diskspacecheck-class"></a>\_Clase DiskSpaceCheck de CIM
...
La clase **CIM \_ DiskSpaceCheck** tiene estos tipos de miembros:
...
La clase **CIM \_ DiskSpaceCheck** tiene estos métodos.



| Método                                                      | Descripción                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-diskspacecheck.md) | Toma una acción concreta. No implementado por WMI.<br/> |
...
La clase **CIM \_ DiskSpaceCheck** tiene estas propiedades.
...
Calificadores: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**\_ sistema de archivos CIM**](cim-filesystem.md).**AvailableSpace** "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" kilobytes ")
</dt> </dl>
