---
description: La clase CIM DiskSpaceCheck comprueba la cantidad de espacio disponible en disco del sistema y la \_ especifica en la propiedad AvailableDiskSpace.
...
La **clase \_ DiskSpaceCheck de CIM** tiene estos tipos de miembros:
...
La **clase \_ DiskSpaceCheck de CIM** tiene estos métodos.



| Método                                                      | Descripción                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-diskspacecheck.md) | Realiza una acción determinada. No implementado por WMI.<br/> |
...
La **clase \_ DiskSpaceCheck de CIM** tiene estas propiedades.
...
Calificadores: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ FileSystem**](cim-filesystem.md).**AvailableSpace** "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("kilobytes")
</dt> </dl>
