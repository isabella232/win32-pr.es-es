...
---
# <a name="reboot-method-of-the-cim_operatingsystem-class"></a>Método de reinicio de la \_ clase CIM OperatingSystem

El método de **reinicio** solicita un reinicio del sistema operativo.
...
Para las clases WMI que se derivan de [**CIM \_ OperatingSystem**](cim-operatingsystem.md), consulte [clases Win32](win32-provider.md).
...
[OperatingSystem de CIM \_](reboot-method-in-class-cim-operatingsystem.md)
</dt> <dt>
