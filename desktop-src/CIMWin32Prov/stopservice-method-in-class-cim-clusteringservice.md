...
---
# <a name="stopservice-method-of-the-cim_clusteringservice-class"></a>Método StopService de la \_ clase ClusteringService de CIM

El método **StopService** detiene el servicio representado por el objeto derivado de [**\_ ClusteringService CIM**](cim-clusteringservice.md). Este método se hereda del [**\_ servicio CIM**](cim-service.md).
