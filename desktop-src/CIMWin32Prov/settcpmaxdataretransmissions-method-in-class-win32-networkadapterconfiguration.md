...
---
# <a name="settcpmaxdataretransmissions-method-of-the-win32_networkadapterconfiguration-class"></a>Método SetTcpMaxDataRetransmissions de la \_ clase NetworkAdapterConfiguration de Win32
...
*TcpMaxDataRetransmissions* \[ de\]
</dt> <dd>

Número de veces que TCP retransmite un segmento de datos individual antes de anular la conexión. Intervalo válido: 0-0xFFFFFFFF.
...
El tiempo de espera de la retransmisión se duplica con cada retransmisión sucesiva en una conexión.

## <a name="examples"></a>Ejemplos

En el ejemplo de VBScript de la opción [modificar el máximo permitido de retransmisiones de datos TCP](https://Gallery.TechNet.Microsoft.Com/8a581692-7950-412e-bd28-74f223b27827) se configura el número de veces que TCP intentará retransmitir un segmento de datos individual antes de abandonar el esfuerzo.
