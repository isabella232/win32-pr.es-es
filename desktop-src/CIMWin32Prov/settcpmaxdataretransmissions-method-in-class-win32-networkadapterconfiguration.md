...
title: Método SetTcpMaxDataRetransmissions de la Win32_NetworkAdapterConfiguration clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
El tiempo de espera de retransmisión se duplica con cada retransmisión sucesiva en una conexión.

## <a name="examples"></a>Ejemplos

El [ejemplo modify the maximum allowed TCP Data Retransmissions](https://Gallery.TechNet.Microsoft.Com/8a581692-7950-412e-bd28-74f223b27827) VBScript (Modificar el número máximo permitido de retransmisiones de datos TCP de VBScript) configura el número de veces que TCP intentará retransmitir un segmento de datos individual antes de abandonar el esfuerzo.
