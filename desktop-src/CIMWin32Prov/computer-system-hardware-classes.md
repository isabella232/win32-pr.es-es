...
| [**Impresora \_ Win32**](win32-printer.md)                           | Representa un dispositivo conectado a un sistema informático que Windows que es capaz de reproducir una imagen visual en un medio.<br/> |
...
| [**PrintJob de Win32 \_**](win32-printjob.md)                         | Representa un trabajo de impresión generado por una Windows basada en datos.<br/>                                                              |
| [**Win32 \_ TCPIPPrinterPort**](win32-tcpipprinterport.md)         | Representa un punto de acceso de servicio TCP/IP.<br/>                                                                                     |
...
La subcategoría Telefonía agrupa clases que representan dispositivos de módem "teléfono antiguo sin formato" y sus conexiones serie asociadas.
...
La subcategoría Video y Monitors agrupa clases que representan monitores, tarjetas de vídeo y su configuración asociada.



| Clase                                                                                 | Descripción                                                                                                                                                                                                                                                                                                                                                                        |
|---------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Win32 \_ DesktopMonitor**](win32-desktopmonitor.md)                                 | Representa el tipo de dispositivo de supervisión o visualización conectado al sistema informático.<br/>                                                                                                                                                                                                                                                                                       |
