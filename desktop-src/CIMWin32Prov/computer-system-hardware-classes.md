...
| Clase                                                     | Descripción                                                                 |
|-----------------------------------------------------------|-----------------------------------------------------------------------------|
| [**Ventilador \_ win32**](win32-fan.md)                           | Representa las propiedades de un dispositivo de ventilador en el sistema informático.           |
| [**Win32 \_ HeatPipe**](win32-heatpipe.md)                 | Representa las propiedades de un dispositivo de refrigeración de canalización térmico.                    |
| [**Refrigeración \_ win32**](win32-refrigeration.md)       | Representa las propiedades de un dispositivo de refrigeración.                        |
...
| [**Win32 \_ PointingDevice**](win32-pointingdevice.md) | Representa un dispositivo de entrada que se usa para señalar y seleccionar regiones en la presentación de un sistema informático que ejecuta Windows. |
...
Las clases de la subcategoría Storage de datos representan dispositivos de almacenamiento, como unidades de disco duro, unidades de CD-ROM y unidades de cinta.



| Clase                                                     | Descripción                                                                                  |
|-----------------------------------------------------------|----------------------------------------------------------------------------------------------|
| [**Win32 \_ AutochkSetting**](win32-autochksetting.md)     | Representa la configuración de la operación de comprobación automática de un disco.                               |
...
La subcategoría Placa base, Controladores y Puertos agrupa clases que representan dispositivos del sistema. Algunos ejemplos son la memoria del sistema, la memoria caché y los controladores.
...
| [**Win32 \_ 1394ControllerDevice**](win32-1394controllerdevice.md)           | Relaciona el controlador de bus serie de alta velocidad (IEEE 1394 Firewire) y la instancia [**\_ logicalDevice**](cim-logicaldevice.md) de CIM conectada a él.<br/>                                                            |
...
| [**Placa base Win32 \_**](win32-baseboard.md)                                 | Representa un placa base (también conocido como placa base o placa del sistema).<br/>                                                                                                                                          |
...
| [**CacheMemory de Win32 \_**](win32-cachememory.md)                             | Representa la memoria caché (interna y externa) en un sistema informático.<br/>                                                                                                                                          |
...
| [**DeviceMemoryAddress de Win32 \_**](win32-devicememoryaddress.md)             | Representa una dirección de memoria de dispositivo en un Windows sistema.<br/>                                                                                                                                                        |
...
| [**Win32 \_ IDEController**](win32-idecontroller.md)                         | Representa las funcionalidades de un dispositivo de controlador de Integrated Drive Electronics (IDE).<br/>                                                                                                                        |
...
| [**Win32 \_ DesarrobaDispositivo**](win32-infrareddevice.md)                       | Representa las funcionalidades y la administración de un dispositivo de insondación.<br/>                                                                                                                                              |
...
| [**Win32 \_ Placa baseDispositivo**](win32-motherboarddevice.md)                 | Representa un dispositivo que contiene los componentes centrales del sistema informático que ejecuta Windows.<br/>                                                                                                               |
| [**Win32 \_ OnBoardDevice**](win32-onboarddevice.md)                         | Representa dispositivos adaptadores comunes integrados en la placa base (placa del sistema).<br/>                                                                                                                                   |
...
| [**Win32 \_ PhysicalMemoryArray**](win32-physicalmemoryarray.md)             | Representa detalles sobre la memoria física del sistema informático.<br/>                                                                                                                                                |
...
| [**Win32 \_ SCSIControllerDevice**](win32-scsicontrollerdevice.md)           | Relaciona un controlador SCSI y el dispositivo lógico (unidad de disco) conectado a él.<br/>                                                                                                                                 |
| [**Win32 \_ SerialPort**](win32-serialport.md)                               | Representa un puerto serie en un sistema de equipo que ejecuta Windows.<br/>                                                                                                                                                 |
...
| [**Win32 \_ SerialPortSetting**](win32-serialportsetting.md)                 | Relaciona un puerto serie y sus opciones de configuración.<br/>                                                                                                                                                          |
...
| [**Win32 \_ SystemDriverPNPEntity**](win32-systemdriverpnpentity.md)         | Relaciona un dispositivo Plug and Play en el Windows equipo y el controlador que admite el Plug and Play dispositivo.<br/>                                                                                           |
...
| [**Win32 \_ SystemSlot**](win32-systemslot.md)                               | Representa puntos de conexión físicos, incluidos puertos, ranuras y periféricos de la placa base y puntos de conexión propietarios.<br/>                                                                                  |
...
| [**Win32 \_ USBControllerDevice**](win32-usbcontrollerdevice.md)             | Relaciona un controlador USB y las instancias [**\_ de LogicalDevice**](cim-logicaldevice.md) de CIM conectadas a él.<br/>                                                                                                    |
...
La subcategoría Dispositivos de red agrupa las clases que representan el controlador de interfaz de red, sus configuraciones y su configuración.
...
| [**NetworkAdapterConfiguration de Win32 \_**](win32-networkadapterconfiguration.md) | Representa los atributos y comportamientos de un adaptador de red. No se garantiza que se admite la clase después de la probación de la especificación de red CIM del Grupo de tareas de administración distribuida (DMTF).<br/> |
...
| [**PrinterController de Win32 \_**](win32-printercontroller.md)       | Relaciona una impresora y el dispositivo local al que está conectada la impresora.<br/>                                                     |
| [**Win32 \_ PrinterDriver**](win32-printerdriver.md)               | Representa los controladores de una [**instancia de Impresora Win32. \_**](win32-printer.md)<br/>                                                |
