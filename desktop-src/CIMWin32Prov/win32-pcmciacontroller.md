---
description: Win32 \_ PCMCIAController &\# 32; La clase WMI administra las funciones de un dispositivo de controlador de adaptador de interfaz de tarjeta de memoria de equipo personal (PCMCIA de un PC Card).
...
ms.locfileid: "117834166"
---
# <a name="win32_pcmciacontroller-class"></a>Clase \_ PCMCIAController de Win32

La clase [WMI](../wmisdk/retrieving-a-class.md) **\_ WIN32 PCMCIAController** administra las funciones de un dispositivo de controlador de adaptador de interfaz de tarjeta de memoria (PCMCIA) de un equipo personal PC Card).
...
La **clase \_ PCMCIAController de Win32** tiene estos tipos de miembros:
...
La **clase \_ PCMCIAController de Win32** tiene estos métodos.



| Método            | Descripción                                                                                                                                                                                          |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Sin implementar. Para implementar este método, vea el método [**Reset**](reset-method-in-class-cim-controller.md) en [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md).<br/>                 |
| **SetPowerState** | Sin implementar. Para implementar este método, vea el [**método SetPowerState**](setpowerstate-method-in-class-cim-controller.md) [**en CIM \_ PCMCIAController**](cim-pcmciacontroller.md).<br/> |
...
La **clase \_ PCMCIAController de Win32** tiene estas propiedades.
...
Calificadores: [**Override**](../wmisdk/standard-qualifiers.md) ("DeviceId"), [**Key**](../wmisdk/key-qualifier.md), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("WMI")
</dt> </dl>

Identificador único de este dispositivo con otros periféricos mediante el BIOS Plug and Play. Esta propiedad se deriva de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
...
Esta propiedad se hereda de [**\_ CIM PCMCIAController.**](cim-pcmciacontroller.md)
...
La **clase \_ PCMCIAController de Win32** se deriva de [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md).
