...
---
# <a name="rename-method-of-the-win32_shortcutfile-class"></a>Cambiar el nombre del método de la \_ clase Win32 ShortcutFile

El método **Rename** [WMI Class](/windows/desktop/WmiSdk/retrieving-a-class) cambia el nombre del archivo de acceso directo (o directorio) especificado en la ruta de acceso del objeto. No se admite el cambio de nombre si el destino está en otra unidad o si se requiere sobrescribir un archivo lógico existente.
