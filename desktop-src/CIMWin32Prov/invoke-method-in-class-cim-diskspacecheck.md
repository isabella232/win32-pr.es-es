...
---
# <a name="invoke-method-of-the-cim_diskspacecheck-class"></a>Método Invoke de la \_ clase CIM DiskSpaceCheck

El método **Invoke** de la clase [**CIM \_ DiskSpaceCheck**](cim-diskspacecheck.md) evalúa una comprobación determinada. Los detalles de cómo evalúa el método una comprobación determinada en un contexto CIM se describen en la subclase de [**\_ comprobación CIM**](cim-check.md) no abstracta.
