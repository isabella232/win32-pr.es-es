---
description: La clase WMI Def32 MotherboardDevice de Win32 representa un dispositivo que contiene los componentes \_ centrales del Windows equipo.
...
ms.locfileid: "127174010"
---
# <a name="win32_motherboarddevice-class"></a>Clase MotherboardDevice de Win32 \_

La clase [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ Win32 MotherboardDevice** representa un dispositivo que contiene los componentes centrales del Windows equipo.
...
La **clase \_ MotherboardDevice de Win32** tiene estos tipos de miembros:
...
La **clase \_ MotherboardDevice de Win32** tiene estos métodos.
...
La **clase \_ MotherboardDevice de Win32** tiene estas propiedades.
...
Identificador único de esta placa base.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ LOCAL MACHINE HARDWARE DESCRIPTION System \_ \\ \\ \\ \\ \\ \\ \\ \\ MultifunctionAdapter \| Identifier")
</dt> </dl>

Tipo de bus principal de la placa base.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ LOCAL MACHINE HARDWARE DESCRIPTION \_ \\ \\ \\ \\ \\ \\ System")
</dt> </dl>

Número de revisión de la placa base.
...
Tipo de bus secundario de la placa base.
...
La **clase \_ MotherboardDevice de Win32** se deriva de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

## <a name="examples"></a>Ejemplos

Los siguientes ejemplos [de código de JavaScript](https://Gallery.TechNet.Microsoft.Com/05bbadf8-1356-43a6-82fc-fcab40233fe5) [y PowerShell](https://Gallery.TechNet.Microsoft.Com/cb520044-836e-425c-8c12-a9586d1c0e6e) recuperan información de la placa base.

El siguiente ejemplo de código VBScript recupera información de la placa base.
