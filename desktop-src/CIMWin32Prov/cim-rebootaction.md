...
---
# <a name="cim_rebootaction-class"></a>\_Clase RebootAction de CIM

La **clase \_ RebootAction de CIM** provoca un reinicio del sistema en el que está instalado el elemento de software.
...
La clase **CIM \_ RebootAction** tiene estos tipos de miembros:
...
La clase **CIM \_ RebootAction** tiene estos métodos.



| Método                                                    | Descripción                                                   |
|:----------------------------------------------------------|:--------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-rebootaction.md) | Toma una acción concreta. No implementado por WMI.<br/> |
...
La clase **CIM \_ RebootAction** tiene estas propiedades.
