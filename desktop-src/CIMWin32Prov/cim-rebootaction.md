---
description: La clase RebootAction de CIM \_ provoca un reinicio del sistema donde está instalado el elemento de software.
...
La **clase \_ RebootAction de CIM** tiene estos métodos.



| Método                                                    | Descripción                                                   |
|:----------------------------------------------------------|:--------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-rebootaction.md) | Realiza una acción determinada. No implementado por WMI.<br/> |
...
La **clase \_ RebootAction de CIM** tiene estas propiedades.
