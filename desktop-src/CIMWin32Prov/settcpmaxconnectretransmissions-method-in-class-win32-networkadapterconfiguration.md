...
---
# <a name="settcpmaxconnectretransmissions-method-of-the-win32_networkadapterconfiguration-class"></a>Método SetTcpMaxConnectRetransmissions de la \_ clase NetworkAdapterConfiguration de Win32

El método estático de la [clase WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetTcpMaxConnectRetransmissions** se usa para establecer el número de intentos que TCP va a retransmitir una solicitud de conexión antes de anular la operación.
...
*TcpMaxConnectRetransmissions* \[ de\]
</dt> <dd>

Número de intentos que TCP retransmitirá una solicitud de conexión antes de anular la operación. El intervalo válido para los valores es 0-0xFFFFFFFF.
...
El tiempo de espera de la retransmisión inicial es de tres segundos y el doble para cada intento sucesivo.

## <a name="examples"></a>Ejemplos

En el ejemplo de VBScript [Modify the retransmisións de conexiones TCP máximas permitidas](https://Gallery.TechNet.Microsoft.Com/e599c6bc-fa37-457d-b7e3-3c003517ed46) se configura el número de veces que TCP retransmitirá un intento de conexión antes de abandonar el esfuerzo.
