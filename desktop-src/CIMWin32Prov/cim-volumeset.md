...
---
# <a name="cim_volumeset-class"></a>\_Clase VolumeSet de CIM

La clase **CIM \_ VolumeSet** representa un intervalo contiguo de bloques lógicos que se presentan al entorno operativo para leer y escribir datos de usuario. Los conjuntos de volúmenes no deben superponerse entre sí y se basan en una o varias extensiones físicas, extensiones de espacio protegido o extensiones de agregado (todo el mismo tipo). Se debe crear una instancia de las asociaciones basadas en o subclases según sea necesario.
...
| Método                                                               | Descripción                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-volumeset.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-volumeset.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ VolumeSet** tiene estas propiedades.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Conjunto de volúmenes de DMTF \| \| 001,5 ")
</dt> </dl>

Número de extensiones de espacio protegido para seccionar como conjunto colectivo. En SCC, este valor se define como el número de franjas que se van a contar antes de continuar con la asignación en el siguiente conjunto contiguo de extensiones, más allá de la franja actual.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Conjunto de volúmenes de DMTF \| \| 001,4 ")
</dt> </dl>

Número de extensiones de espacio protegido contiguas que se han contado antes de volver a la primera extensión de espacio protegido de la franja actual. Es el número de extensiones que forman la franja de datos del usuario.
...
La clase **CIM \_ VolumeSet** se deriva de [**\_ StorageExtent de CIM**](cim-storageextent.md).
