...
---
# <a name="startservice-method-of-the-win32_baseservice-class"></a>Método StartService de la \_ clase BaseService de Win32

El método **StartService** intenta poner el servicio en su estado de inicio.
