---
description: La clase CurrentSensor de CIM \_ existe por compatibilidad con versiones anteriores con las definiciones de esquema CIM anteriores.
...
ms.locfileid: "127160361"
---
# <a name="cim_currentsensor-class"></a>Cim \_ CurrentSensor (clase)

La **clase \_ CurrentSensor de CIM** existe por compatibilidad con versiones anteriores con las definiciones de esquema CIM anteriores.

Las adiciones [**a \_ CIM Sensor**](cim-sensor.md) y CIM [**\_ NumericSensor**](cim-numericsensor.md) en la versión 2.2 hacen que ya no sea necesario. Una **clase \_ CurrentSensor de CIM** se puede definir estableciendo la propiedad **SensorType,** heredada del **\_ sensor CIM,** en 4 ("Current"). Otras propiedades de esta clase están codificadas de forma permanente en valores constantes, que corresponden a las definiciones de la jerarquía del sensor.
...
La **clase \_ CurrentSensor de CIM** tiene estos tipos de miembros:
...
La **clase \_ CurrentSensor de CIM** tiene estos métodos.
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La **clase \_ CurrentSensor de CIM** tiene estas propiedades.
...
Calificadores: [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ("MaxReadable"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.9"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milimperas")
</dt> </dl>
