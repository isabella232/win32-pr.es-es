...
---
# <a name="cim_jobdestination-class"></a>\_Clase JobDestination de CIM
...
La clase **CIM \_ JobDestination** tiene estos tipos de miembros:
...
La clase **CIM \_ JobDestination** se deriva de [**\_ LogicalElement de CIM**](cim-logicalelement.md).
