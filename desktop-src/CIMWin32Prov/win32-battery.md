---
description: Representa una batería conectada al sistema informático.
...
La **clase Battery \_ de Win32** tiene estas propiedades.
...
Calificadores: [**DEPRECATED**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("HKEY \_ LOCAL MACHINE System \_ \\ \\ \\ \\ CurrentControlSet Services \\ \\ \| DeprecateRate"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("minutes")
</dt> </dl>

Tiempo necesario para cargar completamente la batería. Esta propiedad no es compatible. **BatteryRechargeTime** no tiene una propiedad de reemplazo y ahora se considera obsoleto.
...
<span id="Fully_Charged"></span><span id="fully_charged"></span><span id="FULLY_CHARGED"></span>**Totalmente cargado** (3)
...
<span id="Charging_and_High"></span><span id="charging_and_high"></span><span id="CHARGING_AND_HIGH"></span>**Carga y alta** (7)
...
<span id="Charging_and_Low"></span><span id="charging_and_low"></span><span id="CHARGING_AND_LOW"></span>**Carga y baja** (8)
...
<span id="Partially_Charged"></span><span id="partially_charged"></span><span id="PARTIALLY_CHARGED"></span>**Cargos parciales** (11)
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Portable Battery \| 002.7")
</dt> </dl>
...
Calificadores: [**DEPRECATED**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("HKEY \_ LOCAL MACHINE System \_ \\ \\ \\ \\ CurrentControlSet Services \\ \\ \| BatteryLife"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("minutes")
</dt> </dl>

Cantidad de tiempo que se tarda en agotar completamente la batería después de que se ha cargado completamente. Esta propiedad ya no se usa y se considera obsoleta.
...
Tiempo máximo, en minutos, para cargar completamente la batería. La propiedad representa el tiempo para reponer una batería totalmente agotada, no el tiempo de carga restante actual, que se indica en la **propiedad TimeToFullCharge.**
...
Define la etiqueta por la que se conoce el objeto. Cuando se subclasifica, la propiedad se puede invalidar para que sea una propiedad de clave.
...
Calificadores: [**MaxLen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Portable Battery \| 002.10")
</dt> </dl>

Número de versión de especificación de datos compatible con la batería. Si la batería no admite esta función, el valor se debe dejar en blanco.
