...
title: Método reset de la CIM_Processor clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119701215"
---
# <a name="reset-method-of-the-cim_processor-class"></a>Método Reset de la clase Procesador CIM \_

El **método Reset** de la clase Procesador CIM solicita un \_ restablecimiento del dispositivo lógico. Este método se hereda de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
