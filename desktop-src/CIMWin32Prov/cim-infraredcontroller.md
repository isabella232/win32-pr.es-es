...
---
# <a name="cim_infraredcontroller-class"></a>\_Clase InfraredController de CIM

La clase **CIM \_ InfraredController** representa las capacidades y la administración de un controlador de infrarrojos.
...
La clase **CIM \_ InfraredController** tiene estos tipos de miembros:
...
La clase **CIM \_ InfraredController** tiene estos métodos.
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-infraredcontroller.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ InfraredController** tiene estas propiedades.
...
Fecha y hora de la última vez que se restableció el controlador, lo que podría significar que el controlador se apagó o reinicializó.
...
La clase **CIM \_ InfraredController** se deriva del [**\_ controlador CIM**](cim-controller.md).

WMI no implementa esta clase. Para las clases derivadas de **CIM \_ InfraredController**, vea [clases Win32](win32-provider.md).
