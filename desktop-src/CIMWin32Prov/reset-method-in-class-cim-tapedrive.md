...
---
# <a name="reset-method-of-the-cim_tapedrive-class"></a>Método Reset de la \_ clase CIM TapeDrive

El método **RESET** de la \_ clase CIM TapeDrive solicita un restablecimiento del dispositivo lógico. Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
