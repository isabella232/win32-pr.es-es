...
---
# <a name="reset-method-of-the-cim_binarysensor-class"></a>Método Reset de la \_ clase BinarySensor de CIM

El método **RESET** de la \_ clase BinarySensor de CIM solicita un restablecimiento del dispositivo lógico. Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
