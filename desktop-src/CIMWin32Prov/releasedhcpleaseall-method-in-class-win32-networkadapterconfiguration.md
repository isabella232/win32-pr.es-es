...
---
# <a name="releasedhcpleaseall-method-of-the-win32_networkadapterconfiguration-class"></a>Método ReleaseDHCPLeaseAll de la \_ clase NetworkAdapterConfiguration de Win32
...
> [!Note]  
> ADVERTENCIA Si DHCP está habilitado en el sistema del equipo local, la opción terminará todas las conexiones TCP/IP de DHCP.
