---
description: La clase CIM DesktopMonitor representa las funcionalidades y la administración del dispositivo lógico del monitor de \_ escritorio (CRT).
ms.assetid: dc65aa38-5255-4a40-8ffc-f05f9af71dc6
ms.tgt_platform: multiple
title: CIM_DesktopMonitor clase (proveedores WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
WMI no implementa esta clase. Para obtener más información sobre las clases derivadas de **CIM \_ DesktopMonitor**, vea [Clases win32](win32-provider.md).
