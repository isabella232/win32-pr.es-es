...
---
# <a name="win32_parallelport-class"></a>\_Clase Win32 ParallelPort

La [clase WMI](../wmisdk/retrieving-a-class.md) **\_ ParallelPort de Win32** representa las propiedades de un puerto paralelo en un equipo que ejecuta Windows.
...
La **clase \_ ParallelPort de Win32** tiene estos tipos de miembros:
...
La clase **Win32 \_ ParallelPort** tiene estos métodos.



| Método            | Descripción                                                                                                                                                                                              |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Sin implementar. Para implementar este método, consulte el método [**RESET**](reset-method-in-class-cim-controller.md) en [**CIM \_ ParallelController**](cim-parallelcontroller.md).<br/>                 |
| **SetPowerState** | Sin implementar. Para implementar este método, consulte el método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) en [**CIM \_ ParallelController**](cim-parallelcontroller.md).<br/> |
...
La **clase \_ ParallelPort de Win32** tiene estas propiedades.
...
Calificadores: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("indexado"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Puertos paralelos \| de DMTF 003,8 "), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ ParallelController**](cim-parallelcontroller.md).**CapabilityDescriptions**")
</dt> </dl>

Matriz de las capacidades del controlador paralelo.

Esta propiedad se hereda de [**\_ ParallelController CIM**](cim-parallelcontroller.md).
...
Calificadores: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("indexado"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ ParallelController**](cim-parallelcontroller.md).**Funcionalidades**")
</dt> </dl>

Matriz de explicaciones más detalladas para cualquiera de las características del controlador paralelo indicadas en la matriz de **funcionalidades** . Cada entrada de esta matriz está relacionada con la entrada de la matriz de **capacidades** que se encuentra en el mismo índice.
...
Identificador del puerto paralelo.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Puertos paralelos de DMTF \| 003,7 ")
</dt> </dl>

Si **es true**, el puerto paralelo admite DMA.
...
Si es **true**, el error comunicado en **LastErrorCode** se borra.
...
Si **es true**, el sistema operativo detecta automáticamente el puerto paralelo. Si **es false**, el puerto fue detectado por otros medios (por ejemplo, se ha agregado manualmente a través del panel de control).
...
Si **es true**, el dispositivo puede administrarse mediante energía, lo que significa que se puede poner en modo de suspensión, etc. La propiedad no indica que las características de administración de energía están habilitadas actualmente, solo que el dispositivo lógico es capaz de administrar energía.
...
Esta propiedad se hereda del [**\_ controlador CIM**](cim-controller.md). Los valores se muestran en la lista siguiente.
...
Fecha y hora de la última vez que se restableció el controlador. Esto podría significar que el controlador se apagó o reinicializó.
...
La **clase \_ ParallelPort de Win32** se deriva de [**\_ ParallelController de CIM**](cim-parallelcontroller.md).
