---
description: Representa las funcionalidades y la administración de un controlador 1394.
...
La clase [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **Win32 \_ 1394Controller** representa las funciones y la administración de un controlador 1394. IEEE 1394 es una especificación para un bus serie de alta velocidad.
...
La **clase Win32 \_ 1394Controller** tiene estos métodos.
...
La **clase Win32 \_ 1394Controller** tiene estas propiedades.
...
Identificador único de este controlador.
...
El controlador de fecha y hora se restablecó por última vez. Esto podría significar que el controlador se ha apagado o reinicializado.
...
El siguiente ejemplo de código de PowerShell recupera información del controlador.
