---
description: El método SetPowerState de la clase Cim MagnetoOpticalDrive establece el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo \_ en ese estado.
ms.assetid: 78f89dd5-79ce-43cc-b878-9d943386eb74
ms.tgt_platform: multiple
title: Método SetPowerState de la CIM_MagnetoOpticalDrive clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
