...
---
# <a name="win32_memoryarray-class"></a>\_Clase Win32 MemoryArray

La [clase WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ MemoryArray de Win32** representa las propiedades de la matriz de memoria del sistema del equipo y las direcciones asignadas.
...
La **clase \_ MemoryArray de Win32** tiene estos tipos de miembros:
...
La clase **Win32 \_ MemoryArray** tiene estos métodos.



| Método            | Descripción                                                                                                                                                                                                        |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Sin implementar. Para implementar este método, vea el método [**RESET**](reset-method-in-class-cim-controller.md) en [**Win32 \_ SMBIOSMemory**](win32-smbiosmemory.md) para obtener documentación.<br/>                 |
| **SetPowerState** | Sin implementar. Para implementar este método, vea el método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) en [**Win32 \_ SMBIOSMemory**](win32-smbiosmemory.md) para obtener documentación.<br/> |
...
La **clase \_ MemoryArray de Win32** tiene estas propiedades.
...
Identificador único de la matriz de memoria.

Esta propiedad se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).

Ejemplo: "matriz de memoria 1"
...
Este valor procede de la estructura de la **dirección asignada** de la matriz de memoria en la información de la versión de SMBIOS. En el caso de las versiones de SMBIOS 2,1 a 2,6, el valor procede del miembro de la **dirección final** . En el caso de la versión 2.7 de SMBIOS, el valor procede del miembro de la **dirección de finalización extendida** .
...
**4** (nivel de partición de memoria)
...
Tipo de error que se produjo más recientemente. Los valores 12-14, que indican si un error es corregible, no se usan con esta propiedad, pero esta información se encuentra en la propiedad **CorrectableError** .
...
Esta propiedad se hereda de [**\_ StorageExtent CIM**](cim-storageextent.md). Los valores son:

<dl> <dd>Distinta</dd> <dd>Unknown</dd> <dd>"None"</dd> <dd>Parity</dd> <dd>"ECC de un bit"</dd> <dd>"ECC de varios bits"</dd> <dd>CRC</dd> </dl>
...
Este valor procede de la estructura de la **dirección asignada** de la matriz de memoria en la información de la versión de SMBIOS. En el caso de las versiones de SMBIOS 2,1 a 2,6, el valor procede del miembro de la **dirección de inicio** . En el caso de la versión 2.7 de SMBIOS, el valor procede del miembro de la **dirección de inicio extendido** .
...
La **clase \_ MemoryArray de Win32** se deriva de [**\_ SMBIOSMemory de Win32**](win32-smbiosmemory.md).
