...
---
# <a name="cim_bootsap-class"></a>\_Clase BootSAP de CIM
...
La clase **CIM \_ BootSAP** tiene estos tipos de miembros:

-   [Propiedades](#properties)

### <a name="properties"></a>Propiedades

La clase **CIM \_ BootSAP** tiene estas propiedades.
...
La clase **CIM \_ BootSAP** se deriva de [**\_ punto de CIM**](cim-serviceaccesspoint.md).
