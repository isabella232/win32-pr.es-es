---
description: La clase WMI de \_ ventilador Win32 representa las propiedades de un dispositivo de ventilador en el sistema informático. Por ejemplo, el ventilador de refrigeración de CPU.
...
ms.locfileid: "120085805"
---
# <a name="win32_fan-class"></a>Win32 \_ Fan (clase)

La clase WMI de ventilador **Win32 \_** representa las propiedades de un dispositivo de ventilador en el sistema informático. [](/windows/desktop/WmiSdk/retrieving-a-class) Por ejemplo, el ventilador de refrigeración de CPU.
...
La **clase Win32 \_ Fan** tiene estos tipos de miembros:
...
La **clase Win32 \_ Fan** tiene estos métodos.



| Método            | Descripción                                                                                                                                                                                  |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Sin implementar. Para implementar este método, consulte el método [**Reset**](reset-method-in-class-cim-controller.md) en [**CIM Fan \_ para**](cim-fan.md) obtener documentación.<br/>                 |
| **SetPowerState** | Sin implementar. Para implementar este método, consulte el método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) en [**CIM Fan \_ para**](cim-fan.md) obtener documentación.<br/> |
| **SetSpeed**      | Sin implementar.<br/>                                                                                                                                                                  |
...
La **clase \_ Win32 Fan** tiene estas propiedades.
...
Si **es True,** el dispositivo de refrigeración proporciona refrigeración activa (en lugar de pasiva).

Esta propiedad se hereda de [**CIM \_ CoolingDevice.**](cim-coolingdevice.md)
...
Calificadores: [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("revoluciones por minuto")
</dt> </dl>

Velocidad del ventilador solicitada actualmente, definida en revoluciones por minuto, cuando se admite un ventilador de velocidad variable **(VariableSpeed** es **TRUE).** La velocidad actual viene determinada por un sensor [**\_ (Tachometer CIM)**](cim-tachometer.md)que está asociado al ventilador mediante la [**relación \_ AssociatedSensor de CIM.**](cim-associatedsensor.md)

Esta propiedad se hereda del ventilador [**CIM \_**](cim-fan.md).
...
Identifica el dispositivo de ventilador. Esta propiedad se hereda de [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)
...
Si **es True,** el ventilador admite velocidades variables.
...
La **clase \_ Fan de Win32** se deriva del [**\_ ventilador CIM**](cim-fan.md).

## <a name="examples"></a>Ejemplos

El [ejemplo de PowerShell List Computer Fan Information](https://Gallery.TechNet.Microsoft.Com/d1534503-704f-4450-8dab-f3e760bf818c) recupera información sobre los ventiladores de refrigeración instalados en un equipo.

En el ejemplo siguiente se recupera información sobre los ventiladores de refrigeración instalados en un equipo.
