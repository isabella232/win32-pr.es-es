---
description: El método SetPowerState de la clase TemperatureSensor de CIM establece el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo \_ en ese estado.
ms.assetid: 7a46bddd-9dda-4024-bb12-92637e4432e7
ms.tgt_platform: multiple
title: Método SetPowerState de la CIM_TemperatureSensor clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
