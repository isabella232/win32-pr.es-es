...
---
# <a name="cim_diskettedrive-class-cimwin32-wmi-providers"></a>CIM_DisketteDrive (clase) (proveedores WMI de CIMWin32)

La clase **CIM \_ DisketteDrive** representa las capacidades y la administración de una unidad de disquete.
...
La clase **CIM \_ DisketteDrive** tiene estos tipos de miembros:
...
La clase **CIM \_ DisketteDrive** tiene estos métodos.
...
La clase **CIM \_ DisketteDrive** tiene estas propiedades.
...
Matriz de cadenas de formato libre que proporcionan explicaciones detalladas para las características del dispositivo de acceso indicadas en la matriz de **funcionalidades** .
...
La clase **CIM \_ DisketteDrive** se deriva de [**\_ MediaAccessDevice de CIM**](cim-mediaaccessdevice.md).

WMI no implementa esta clase. Para las clases derivadas de **CIM \_ DisketteDrive**, vea [clases Win32](win32-provider.md).
