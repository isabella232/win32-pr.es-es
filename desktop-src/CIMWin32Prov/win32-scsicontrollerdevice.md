---
description: La clase WMI de asociación Win32 SCSIControllerDevice relaciona un pequeño controlador de interfaz del sistema informático (SCSI) y el dispositivo lógico \_ (unidad de disco) conectado a él.
...
ms.locfileid: "127174326"
---
# <a name="win32_scsicontrollerdevice-class"></a>Clase \_ SCSIControllerDevice de Win32

La clase [WMI](../wmisdk/retrieving-a-class.md) de asociación **\_ Win32 SCSIControllerDevice** relaciona un pequeño controlador de interfaz del sistema informático (SCSI) y el dispositivo lógico (unidad de disco) conectado a él.
...
La [**referencia anterior de \_ SCSIController de Win32**](win32-scsicontroller.md) representa el controlador SCSI asociado a este dispositivo.
...
La [**referencia dependiente \_ logicalDevice**](cim-logicaldevice.md) de CIM representa el dispositivo lógico conectado al controlador SCSI.
