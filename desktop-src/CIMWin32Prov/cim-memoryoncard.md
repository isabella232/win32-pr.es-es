---
description: La clase MemoryOnCard de CIM asocia la memoria física ubicada en paneles de \_ hospedaje, tarjetas adaptadoras, entre otras. Esta asociación define explícitamente la relación de memoria con las tarjetas.
...
ms.locfileid: "127254648"
---
# <a name="cim_memoryoncard-class"></a>Cim \_ MemoryOnCard (clase)

La **clase \_ MemoryOnCard de CIM** asocia la memoria física ubicada en paneles de hospedaje, tarjetas adaptadoras, entre otras. Esta asociación define explícitamente la relación de memoria con las tarjetas.
