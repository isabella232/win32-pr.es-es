---
description: El método SetPowerState de la clase TapeDrive de CIM establece el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo \_ en ese estado.
ms.assetid: 73f98d08-49da-4b21-91c4-cbe420c648e4
ms.tgt_platform: multiple
title: Método SetPowerState de la CIM_TapeDrive clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
