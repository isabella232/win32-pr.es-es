...
---
# <a name="cim_logicaldisk-class-cimwin32-wmi-providers"></a>CIM_LogicalDisk (clase) (proveedores WMI de CIMWin32)

La clase de **\_ LogicalDisk de CIM** representa un intervalo contiguo de bloques lógicos que un sistema de archivos identifica mediante el campo de **DeviceID** (clave) del disco. Por ejemplo, en un entorno de Windows, el campo **DeviceID** contiene una letra de unidad; en un entorno de UNIX, contiene la ruta de acceso; y en un entorno de NetWare, contiene el nombre del volumen.
...
La clase de **\_ LogicalDisk de CIM** tiene estos métodos.



| Método                                                                 | Descripción                                                                                                                              |
|:-----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-logicaldisk.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-logicaldisk.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
Describe si el medio es legible, grabable o ambos, por ejemplo. Esta propiedad se hereda de [**\_ StorageExtent CIM**](cim-storageextent.md).
...
Espacio libre disponible, en bytes, en el disco lógico.
...
La clase de **\_ LogicalDisk de CIM** se deriva de [**\_ StorageExtent CIM**](cim-storageextent.md).

WMI no implementa esta clase. Para las clases derivadas de la **\_ DiscoLógico de CIM**, vea [clases Win32](win32-provider.md).
