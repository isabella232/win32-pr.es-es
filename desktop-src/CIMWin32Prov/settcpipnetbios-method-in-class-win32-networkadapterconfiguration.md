---
description: El método SetTcpipNetbios se usa para establecer la operación predeterminada de NetBIOS sobre TCP/IP.
ms.assetid: 2c639595-da13-400d-b4d0-432b39460554
ms.tgt_platform: multiple
title: Método SetTcpipNetbios de la Win32_NetworkAdapterConfiguration clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119439305"
---
# <a name="settcpipnetbios-method-of-the-win32_networkadapterconfiguration-class"></a>Método SetTcpipNetbios de la clase NetworkAdapterConfiguration de Win32 \_

El **método SetTcpipNetbios** se usa para establecer la operación predeterminada de NetBIOS sobre TCP/IP.
...
*TcpipNetbiosOptions* \[ En\]
</dt> <dd>

Valor que especifica la posible configuración relacionada con NetBIOS a través de TCP/IP.
...
Habilitación de Netbios a través de DHCP
...
El [ejemplo Modify NetBIOS Use on a Network Adapter](https://Gallery.TechNet.Microsoft.Com/01d541f7-5c0d-46d3-8619-28aaab154dc0) VBScript (Modificar el uso de NetBIOS en un adaptador de red de VBScript) habilita NetBIOS para un adaptador de red.
