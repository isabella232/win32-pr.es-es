---
description: La clase \_ MemoryMappedIO de CIM representa la E/S asignada a memoria de la arquitectura del equipo. Esta clase direcciona los recursos de E/S de puerto y memoria.
...
La **clase \_ MemoryMappedIO de CIM** tiene estas propiedades.
...
Calificadores: [**Clave CIM \_ ,**](/windows/desktop/WmiSdk/standard-wmi-qualifiers) [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. E/S asignadas a memoria DMTF \| \| 001.1")
</dt> </dl>
