...
---
# <a name="cim_memorymappedio-class"></a>\_Clase MemoryMappedIO de CIM

La clase **CIM \_ MemoryMappedIO** representa la arquitectura de equipo de e/s asignada a la memoria. Esta clase trata los recursos de memoria y de e/s de puerto.
...
La clase **CIM \_ MemoryMappedIO** tiene estos tipos de miembros:

-   [Propiedades](#properties)

### <a name="properties"></a>Propiedades

La clase **CIM \_ MemoryMappedIO** tiene estas propiedades.
...
Propiedad **CreationClassName** del sistema de ámbito del equipo.
...
Propiedad **nombre** del sistema de ámbito del equipo.
...
Calificadores: [**\_ clave CIM**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|E/s asignada de memoria DMTF \| 001,1 ")
</dt> </dl>
...
La clase **CIM \_ MemoryMappedIO** se deriva de [**\_ SystemResource de CIM**](cim-systemresource.md).
