...
---
# <a name="takeownership-method-of-the-cim_directory-class"></a>Método TakeOwnerShip de la \_ clase de directorio CIM
...
El siguiente código de script de Visual Basic llama al método **TakeOwnerShip** para tomar posesión de la \\ carpeta C: Temp.
...
[\_Directorio CIM](takeownership-method-in-class-cim-directory.md)
</dt> <dt>
