...
---
# <a name="setpowerstate-method-of-the-cim_controller-class"></a>Método SetPowerState de la clase \_ de controlador CIM
...
Wmi no implementa actualmente este método. Para usar este método, debe implementarlo en su propio proveedor. Para obtener más información, vea [Creating WMI Providers](/windows/desktop/WmiSdk/creating-wmi-providers).
