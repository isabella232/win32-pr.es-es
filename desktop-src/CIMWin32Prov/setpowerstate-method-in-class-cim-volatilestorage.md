---
description: El método SetPowerState de la clase CIM VolatileStorage establece el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo \_ en ese estado.
ms.assetid: e96a9a99-74c3-48a6-b697-9fcbc14abc27
ms.tgt_platform: multiple
title: Método SetPowerState de la CIM_VolatileStorage clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
