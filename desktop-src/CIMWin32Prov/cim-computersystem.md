---
description: Una clase ComputerSystem de CIM \_ representa una colección especial de instancias de Cim \_ ManagedSystemElement.
ms.assetid: c4fd0598-3cb3-428f-ad39-a14232ef7c17
ms.tgt_platform: multiple
title: CIM_ComputerSystem clase (proveedores WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118958984"
---
# <a name="cim_computersystem-class-cimwin32-wmi-providers"></a>CIM_ComputerSystem clase (proveedores WMI CIMWin32)

Una **clase \_ ComputerSystem de CIM** representa una colección especial de instancias de Cim [**\_ ManagedSystemElement.**](cim-managedsystemelement.md) Esta colección proporciona funcionalidades de equipo y sirve como punto de agregación para asociar uno o varios de los siguientes elementos: sistema de archivos, sistema operativo, procesador y memoria (almacenamiento volátil y no volátil). Esta clase se deriva del [**sistema CIM \_**](cim-system.md).
...
Identifica cómo se genera el nombre del sistema del equipo mediante una heurística. La heurística se describe con detalle en la especificación del modelo común CIM V2. Se supone que las reglas documentadas se recorren en orden para determinar y asignar un nombre. La **lista de valores NameFormat** define el orden de precedencia para asignar el nombre del sistema del equipo. Varias reglas se asignan al mismo valor.

Tenga en cuenta que el **nombre del** objeto se calcula mediante la heurística es el valor de clave del sistema. Se pueden asignar y usar otros nombres para el objeto que mejor se adapte a la empresa, mediante alias.
...
La **clase CIM \_ ComputerSystem** se deriva del [**sistema CIM \_**](cim-system.md).

WMI no implementa esta clase. Para obtener más información sobre las clases derivadas de **CIM \_ ComputerSystem**, vea [Clases Win32](win32-provider.md).
