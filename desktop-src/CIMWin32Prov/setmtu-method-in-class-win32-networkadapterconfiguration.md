...
title: Método SetMTU de la Win32_NetworkAdapterConfiguration clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
El [ejemplo Modify the MTU for all Network Adapters](https://Gallery.TechNet.Microsoft.Com/49c26363-d46c-4288-9c8d-feb0a1982998) VBScript (Modificar la MTU para todos los adaptadores de red de VBScript) configura la unidad de transmisión máxima para todos los adaptadores de red instalados en un equipo.
