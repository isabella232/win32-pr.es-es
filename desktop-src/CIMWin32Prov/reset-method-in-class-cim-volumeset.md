...
---
# <a name="reset-method-of-the-cim_volumeset-class"></a>Método Reset de la \_ clase VolumeSet de CIM

El método **RESET** de la [**clase \_ VolumeSet de CIM**](cim-volumeset.md) solicita un restablecimiento del dispositivo lógico. Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
...
[\_VOLUMESET CIM](reset-method-in-class-cim-volumeset.md)
</dt> <dt>
