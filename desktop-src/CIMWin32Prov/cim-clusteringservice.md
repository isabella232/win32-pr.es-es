...
---
# <a name="cim_clusteringservice-class"></a>\_Clase ClusteringService de CIM
...
La clase **CIM \_ ClusteringService** tiene estos tipos de miembros:
...
La clase **CIM \_ ClusteringService** tiene estos métodos.



| Método                                                                     | Descripción                                                                                                |
|:---------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------|
| [**AddNode**](addnode-method-in-class-cim-clusteringservice.md)           | Método de clase que pone un nuevo sistema de equipo en un clúster. No implementado por WMI.<br/>          |
| [**EvictNode**](evictnode-method-in-class-cim-clusteringservice.md)       | Método de clase que quita un equipo de un clúster. No implementado por WMI.<br/>             |
| [**StartService**](startservice-method-in-class-cim-clusteringservice.md) | Método de clase que intenta poner el servicio en su estado de inicio. No implementado por WMI.<br/> |
| [**StopService**](stopservice-method-in-class-cim-clusteringservice.md)   | Método de clase que coloca el servicio en estado detenido. No implementado por WMI.<br/>              |
...
La clase **CIM \_ ClusteringService** tiene estas propiedades.
...
La clase **CIM \_ ClusteringService** se deriva del [**\_ servicio CIM**](cim-service.md).
