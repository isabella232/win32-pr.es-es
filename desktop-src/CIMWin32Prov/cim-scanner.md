...
---
# <a name="cim_scanner-class"></a>\_Clase de escáner CIM

El **\_ analizador de CIM** representa las capacidades y la administración del dispositivo lógico del escáner.
...
La clase de **\_ escáner CIM** tiene estos tipos de miembros:
...
La clase de **\_ escáner CIM** tiene estos métodos.



| Método                                                             | Descripción                                                                                                                              |
|:-------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-scanner.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-scanner.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase de **\_ escáner CIM** tiene estas propiedades.
...
La clase de **\_ escáner CIM** se deriva del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
