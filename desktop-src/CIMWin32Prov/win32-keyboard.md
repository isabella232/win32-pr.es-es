...
---
# <a name="win32_keyboard-class"></a>\_Clase de teclado Win32

La [clase WMI](/windows/desktop/WmiSdk/retrieving-a-class) de **\_ teclado Win32** representa un teclado instalado en un equipo que ejecuta Windows.
...
La clase de **\_ teclado Win32** tiene estos tipos de miembros:
...
La clase de **\_ teclado Win32** tiene estos métodos.



| Método            | Descripción                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Sin implementar. Para implementar este método, consulte el método [**RESET**](reset-method-in-class-cim-controller.md) en [**el \_ teclado CIM**](cim-keyboard.md) para obtener documentación.<br/>                 |
| **SetPowerState** | Sin implementar. Para implementar este método, consulte el método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) en [**el \_ teclado CIM**](cim-keyboard.md) para obtener documentación.<br/> |
...
La clase de **\_ teclado Win32** tiene estas propiedades.
...
Calificadores: [**invalidación**](/windows/desktop/WmiSdk/standard-qualifiers) ("DeviceId"), [**clave**](/windows/desktop/WmiSdk/key-qualifier)
</dt> </dl>
...
Esta propiedad se hereda del [**\_ teclado CIM**](cim-keyboard.md).
...
Número de teclas de función del teclado.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Seguridad de hardware del sistema DMTF \| 001,2 ")
</dt> </dl>

Estado de la contraseña de nivel de hardware habilitada en el teclado (valor = 4), evitando la entrada local.
...
La clase de **\_ teclado Win32** se deriva [**del \_ teclado CIM**](cim-keyboard.md).
...
En el siguiente ejemplo de VBScript se enumeran las propiedades del teclado.
