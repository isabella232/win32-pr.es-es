...
---
# <a name="reset-method-of-the-cim_usbhub-class"></a>Método Reset de la \_ clase USBHub de CIM

El método **RESET** de la clase de USBHUB de CIM \_ solicita un restablecimiento del dispositivo lógico. Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
...
[USBHub de CIM \_](reset-method-in-class-cim-usbhub.md)
</dt> <dt>
