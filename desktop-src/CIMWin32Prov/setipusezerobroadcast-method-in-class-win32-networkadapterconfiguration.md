---
description: El método estático de la clase WMI SetIPUseZeroBroadcast se usa para establecer el uso de difusión ip cero.
ms.assetid: d20ac6fc-a5d5-4ad9-a2a5-65142b4c7d02
ms.tgt_platform: multiple
title: Método SetIPUseZeroBroadcast de la Win32_NetworkAdapterConfiguration clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
El método estático de la clase [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetIPUseZeroBroadcast** se usa para establecer el uso de difusión ip cero.
...
*IPUseZeroBroadcast* \[ En\]
</dt> <dd>

Si **es true,** se usa la difusión ip cero. El valor predeterminado es **false**.
