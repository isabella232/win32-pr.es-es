...
---
# <a name="iscompatible-method-of-the-cim_rack-class"></a>Método IsCompatible de la \_ clase de bastidor CIM
...
Referencia al elemento físico en el que se ejecuta este método.
...
[**\_Bastidor CIM**](iscompatible-method-in-class-cim-rack.md)
</dt> <dt>
