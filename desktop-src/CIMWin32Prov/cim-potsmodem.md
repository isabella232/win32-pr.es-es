...
La **clase \_ CIM POTSModem** tiene estas propiedades.
...
Configuración actual de respuesta automática o de detección de llamadas para el módem.
...
Países o regiones en los que puede funcionar el módem.
...
Contraseñas definidas actualmente para el módem. Esta matriz se puede dejar en blanco por motivos de seguridad.
...
Número máximo de contraseñas definibles en el propio módem. Si no se admite esta característica, escriba 0 (cero).
...
Esquema de insondización del módem.
...
Si **es TRUE,** el módem admite la de vuelta de llamadas.
...
Si **es TRUE,** se admite la comunicación sincrónica, así como asincrónica.
