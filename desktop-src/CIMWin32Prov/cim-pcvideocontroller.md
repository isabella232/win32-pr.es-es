---
description: CIM PCVideoController representa las funciones y la administración de un controlador de vídeo de equipo \_ personal, un subtipo de un controlador de vídeo.
...
ms.locfileid: "118678649"
---
# <a name="cim_pcvideocontroller-class"></a>CIM \_ PCVideoController (clase)

CIM **\_ PCVideoController representa** las funciones y la administración de un controlador de vídeo de equipo personal, un subtipo de un controlador de vídeo.
...
La **clase \_ PCVideoController** de CIM tiene estos tipos de miembros:
...
La **clase \_ PCVideoController** de CIM tiene estos métodos.



| Método                                                                       | Descripción                                                                                                                              |
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Restablecer**](reset-method-in-class-cim-pcvideocontroller.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcvideocontroller.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La **clase \_ PCVideoController** de CIM tiene estas propiedades.
...
Calificadores: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ VideoController**](cim-videocontroller.md).**CapabilityDescriptions**")
</dt> </dl>

Funcionalidades de gráficos y 3D del controlador de vídeo.
...
Calificadores: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ VideoController**](cim-videocontroller.md).**AcceleratorCapabilities**")
</dt> </dl>

Cadenas de forma libre que proporcionan explicaciones detalladas de las características del acelerador de vídeo indicadas en la **matriz AcceleratorCapabilities.**

> [!Note]  
> Cada entrada de matriz está relacionada con la entrada de la matriz **AcceleratorCapabilities** que se encuentra en el mismo índice.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.12"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("bits")
</dt> </dl>
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.11"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("píxeles")
</dt> </dl>
...
Número de colores admitidos en las resoluciones actuales.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.14")
</dt> </dl>
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.13")
</dt> </dl>

Si está en modo de carácter, número de filas para este controlador de vídeo; En caso contrario, escriba 0.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.15"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("hertz")
</dt> </dl>
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.8")
</dt> </dl>

Modo de examen actual. Esta propiedad se hereda de [**CIM \_ VideoController.**](cim-videocontroller.md)
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.10"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("píxeles")
</dt> </dl>
...
Número máximo de entidades direccionables directamente admitidas por el controlador. Se debe usar un valor de 0 si el número es desconocido o ilimitado.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.5"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("hertz")
</dt> </dl>
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.4"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("hertz")
</dt> </dl>
...
Número actual de planos de color. Si este valor no es aplicable a la configuración de vídeo actual, escriba 0.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Puerto del bus DMTF \| \| 001.2", "MIF. Discos DMTF \| \| 003.3")
</dt> </dl>

Protocolo utilizado por el controlador para acceder a dispositivos "controlados".

Esta propiedad se hereda del [**controlador CIM. \_**](cim-controller.md) Los valores son:
...
Fecha y hora en que se restablecron por última vez este controlador, lo que significa que el controlador se ha apagado o reinicializado.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.2")
</dt> </dl>
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.6")
</dt> </dl>
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.3")
</dt> </dl>
...
Cadena de forma libre que describe el procesador o controlador de vídeo.
...
La **clase \_ CIM PCVideoController** se deriva de [**CIM \_ VideoController**](cim-videocontroller.md).

WMI no implementa esta clase. Para las clases WMI derivadas de [**CIM \_ PCVideoController,**](cim-videocontroller.md)vea [Clases win32](win32-provider.md).
