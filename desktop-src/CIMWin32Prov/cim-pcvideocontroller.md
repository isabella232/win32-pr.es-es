...
---
# <a name="cim_pcvideocontroller-class"></a>\_Clase PCVideoController de CIM

El **\_ PCVideoController CIM** representa las capacidades y la administración de un controlador de vídeo de equipo personal, un subtipo de controlador de vídeo.
...
La clase **CIM \_ PCVideoController** tiene estos tipos de miembros:
...
La clase **CIM \_ PCVideoController** tiene estos métodos.



| Método                                                                       | Descripción                                                                                                                              |
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-pcvideocontroller.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcvideocontroller.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ PCVideoController** tiene estas propiedades.
...
Calificadores: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**\_ controlador de videojuego CIM**](cim-videocontroller.md).**CapabilityDescriptions**")
</dt> </dl>
...
Calificadores: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("indexado"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**controlador de \_ videojuego CIM**](cim-videocontroller.md).**AcceleratorCapabilities**")
</dt> </dl>

Cadenas de forma libre que proporcionan explicaciones detalladas para las características de acelerador de vídeo indicadas en la matriz **AcceleratorCapabilities** .

> [!Note]  
> Cada entrada de la matriz está relacionada con la entrada de la matriz **AcceleratorCapabilities** que se encuentra en el mismo índice.
...
Modo de exploración actual. Esta propiedad se hereda del [**\_ controlador de videodispositivo CIM**](cim-videocontroller.md).
...
Fecha y hora en que se restableció por última vez este controlador, lo que significa que el controlador se apagó o reinicializó.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vídeo DMTF \| 003,2 ")
</dt> </dl>
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vídeo DMTF \| 003,3 ")
</dt> </dl>
...
La **clase \_ PCVideoController de CIM** se deriva [**del \_ videocontrolador CIM**](cim-videocontroller.md).
