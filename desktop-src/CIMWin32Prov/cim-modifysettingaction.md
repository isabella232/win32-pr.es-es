...
---
# <a name="cim_modifysettingaction-class"></a>\_Clase ModifySettingAction de CIM

La clase **CIM \_ ModifySettingAction** representa la información para modificar un archivo de configuración concreto, para una entrada específica, con un valor específico.
...
La clase **CIM \_ ModifySettingAction** tiene estos tipos de miembros:
...
La clase **CIM \_ ModifySettingAction** tiene estos métodos.



| Método                                                           | Descripción                                                 |
|:-----------------------------------------------------------------|:------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-modifysettingaction.md) | Toma una acción específica. No implementado por WMI.<br/> |
...
La clase **CIM \_ ModifySettingAction** tiene estas propiedades.
...
Tipo de acción que se va a realizar en la entrada de configuración especificada. Se supone que las adiciones distinguen mayúsculas de minúsculas; sin embargo, se supone que las eliminaciones no distinguen mayúsculas de minúsculas.

<dt>

<span id="Create"></span><span id="create"></span><span id="CREATE"></span>

<span id="Create"></span><span id="create"></span><span id="CREATE"></span>**Crear** (0)


</dt> <dd>

Crea la entrada especificada.

</dd> <dt>

<span id="Delete"></span><span id="delete"></span><span id="DELETE"></span>

<span id="Delete"></span><span id="delete"></span><span id="DELETE"></span>**Eliminar** (1)
...
Anexa al final de la entrada especificada.

</dd> <dt>

<span id="Remove"></span><span id="remove"></span><span id="REMOVE"></span>

<span id="Remove"></span><span id="remove"></span><span id="REMOVE"></span>**Quitar** (3)


</dt> <dd>

Quita el valor de la entrada especificada.
...
Nombre de la entrada que se va a modificar.
...
Valor que se va a agregar, anexar o para reemplazar la configuración especificada.
...
Nombre de archivo de la entrada del archivo de configuración que se va a modificar.
...
Clave de la sección de la entrada de configuración que se va a modificar.
...
La clase **CIM \_ ModifySettingAction** se deriva de [**la \_ acción CIM**](cim-action.md).
