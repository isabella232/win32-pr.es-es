---
description: La clase CIM ModifySettingAction representa la información para modificar un archivo de configuración específico, para \_ una entrada específica, con un valor específico.
...
La **clase \_ CIM ModifySettingAction** tiene estos métodos.
...
La **clase \_ CIM ModifySettingAction** tiene estas propiedades.
...
Tipo de acción que se realizará en la entrada de configuración especificada. Se supone que las adiciones distinguen mayúsculas de minúsculas; sin embargo, se supone que las eliminaciones no tienen en cuenta las mayúsculas y minúsculas.
...
<span id="Append"></span><span id="append"></span><span id="APPEND"></span>**Anexar** (2)
...
Nombre de la entrada que se modificará.
...
Valor que se agrega, anexa o para reemplazar la configuración especificada.
...
Nombre de archivo de la entrada del archivo de configuración que se modificará.
...
Clave de sección de la entrada de configuración que se modificará.
