---
description: El método SetPowerState de la clase CIM Refrigeration establece el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo \_ en ese estado.
ms.assetid: eaee6e0e-8330-4c4f-b4e1-4029050544a2
ms.tgt_platform: multiple
title: Método SetPowerState de la CIM_Refrigeration clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
[Refrigeración CIM \_](setpowerstate-method-in-class-cim-refrigeration.md)
</dt> <dt>
