---
description: La clase CIM \_ Refrigeration representa las funcionalidades y la administración de un dispositivo de refrigeración de refrigeración.
...
ms.locfileid: "119920655"
---
# <a name="cim_refrigeration-class"></a>Cim \_ Refrigeration (clase)

La **clase CIM \_ Refrigeration** representa las funcionalidades y la administración de un dispositivo de refrigeración de refrigeración.
...
La **clase CIM \_ Refrigeration** tiene estos tipos de miembros:
...
La **clase CIM \_ Refrigeration** tiene estos métodos.



| Método                                                                   | Descripción                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Restablecer**](reset-method-in-class-cim-refrigeration.md)                 | Solicita un restablecimiento del dispositivo lógico. Wmi no implementa .<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-refrigeration.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. Wmi no implementa .<br/> |
...
La **clase CIM \_ Refrigeration** tiene estas propiedades.
...
La **clase CIM \_ Refrigeration** se deriva de [**CIM \_ CoolingDevice**](cim-coolingdevice.md).
