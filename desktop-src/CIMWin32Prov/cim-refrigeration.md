...
---
# <a name="cim_refrigeration-class"></a>\_Clase de refrigeración CIM

La clase de **\_ refrigeración CIM** representa las capacidades y la administración de un dispositivo de enfriamiento de refrigeración.
...
La clase de **\_ refrigeración CIM** tiene estos tipos de miembros:
...
La clase de **\_ refrigeración CIM** tiene estos métodos.



| Método                                                                   | Descripción                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-refrigeration.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-refrigeration.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase de **\_ refrigeración CIM** tiene estas propiedades.
...
La clase de **\_ refrigeración CIM** se deriva de [**\_ CoolingDevice CIM**](cim-coolingdevice.md).
