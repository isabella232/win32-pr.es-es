...
---
# <a name="cim_createdirectoryaction-class"></a>\_Clase CreateDirectoryAction de CIM

La clase **CIM \_ CreateDirectoryAction** crea directorios vacíos para que los elementos de software se instalen de forma local.
...
La clase **CIM \_ CreateDirectoryAction** tiene estos tipos de miembros:
...
La clase **CIM \_ CreateDirectoryAction** tiene estos métodos.



| Método                                                             | Descripción                                                                                                                                  |
|:-------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-createdirectoryaction.md) | Toma una acción concreta. Los detalles de cómo realiza la acción el método son específicos de la implementación. No implementado por WMI.<br/> |
...
La clase **CIM \_ CreateDirectoryAction** tiene estas propiedades.
...
Esta propiedad se hereda de [**\_ DirectoryAction CIM**](cim-directoryaction.md).
...
La clase **CIM \_ CreateDirectoryAction** se deriva de [**\_ DirectoryAction de CIM**](cim-directoryaction.md).

WMI no implementa esta clase. Para las clases derivadas de **CIM \_ CreateDirectoryAction**, vea [clases Win32](win32-provider.md).
