...
La **clase \_ CreateDirectoryAction de CIM** tiene estos tipos de miembros:
...
La **clase \_ CreateDirectoryAction de CIM** tiene estos métodos.
...
La **clase \_ CreateDirectoryAction de CIM** tiene estas propiedades.
