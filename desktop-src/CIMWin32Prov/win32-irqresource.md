...
La **clase \_ IRQResource de Win32** tiene estas propiedades.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| System Structures RESOURCE DESCRIPTOR \| \_ \| InterfaceType")
</dt> </dl>

Si **es TRUE,** la interrupción se basa en hardware o software. Un IRQ de hardware es una conexión física desde el periférico al chip del controlador de interrupción programable (PIC) a través del cual se puede notificar a la CPU los eventos críticos para el tiempo. Algunas líneas IRQ están reservadas para dispositivos estándar, como el teclado, las unidades de disquete y el reloj del sistema. Una interrupción de software permite que las aplicaciones obtengan la atención del procesador.
...
Parte del valor de clave del objeto.
...
Nivel de desencadenador IRQ que indica si la interrupción se desencadena cuando la señal de hardware es alta (4) o baja (3).
...
Tipo de desencadenador IRQ que indica si se producen interrupciones desencadenadas por el borde (4) o desencadenadas por el nivel (3).
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| System Structures CM PARTIAL RESOURCE \| [**\_ \_ \_ DESCRIPTOR**](/windows-hardware/drivers/ddi/content/wdm/ns-wdm-_cm_partial_resource_descriptor) \| Interrupt \| Level")
</dt> </dl>

Vector del recurso Windows IRQ. Un vector contiene la dirección de memoria de la función que se ejecutará una vez que la CPU confirme la solicitud de interrupción.
