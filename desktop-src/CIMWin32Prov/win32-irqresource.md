...
---
# <a name="win32_irqresource-class"></a>\_Clase Win32 IRQResource

La [clase WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ IRQResource de Win32** representa un número de línea de solicitud de interrupción (IRQ) en un equipo que ejecuta Windows.   Una solicitud de interrupción es una señal enviada a la CPU por un dispositivo o programa para eventos críticos en el tiempo. La IRQ puede estar basada en hardware o en software.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|IRQ DMTF \| 001,2 ")
</dt> </dl>

Disponibilidad de la IRQ.

Esta propiedad se hereda de [**la \_ IRQ CIM**](cim-irq.md).
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("inesperados win32api \| System Structures \| \_ descriptor \| InterfaceType")
</dt> </dl>

Si es **true**, la interrupción se basa en hardware o software. Una IRQ de hardware es una conexión física desde el periférico al chip del controlador programable de interrupciones (PIC) a través de la cual se puede notificar a la CPU de eventos críticos en el tiempo. Algunas líneas IRQ están reservadas para dispositivos estándar, como el teclado, las unidades de disquete y el reloj del sistema. Una interrupción de software permite a las aplicaciones obtener la atención del procesador.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|IRQ DMTF \| 001,4 ")
</dt> </dl>

Si **es true**, se puede compartir la IRQ.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Información de IRQ del recurso del sistema DMTF \| 001,3 ")
</dt> </dl>

Nivel de desencadenador de IRQ que indica si la interrupción se desencadena por la señal de hardware que va a ser alta (4) o baja (3).
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| IRQ \| 001,3 "," MIF. \|Información de IRQ del recurso del sistema DMTF \| 001,2 ")
</dt> </dl>

Tipo de desencadenador de IRQ que indica si se producen interrupciones desencadenadas por el borde (4) o por el nivel (3).
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) (" \| nivel de interrupción del \| [**\_ \_ \_ descriptor de recursos parciales**](/windows-hardware/drivers/ddi/content/wdm/ns-wdm-_cm_partial_resource_descriptor)de inesperados win32api de estructuras del sistema \| \| ")
</dt> </dl>

Vector del recurso de IRQ de Windows. Un vector contiene la dirección de memoria de la función que se ejecutará una vez que la CPU confirme la solicitud de interrupción.

</dd> </dl>

## <a name="remarks"></a>Observaciones

La **clase \_ IRQResource de Win32** se deriva de la [**\_ IRQ CIM**](cim-irq.md).
