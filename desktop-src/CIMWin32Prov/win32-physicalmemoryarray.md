...
---
# <a name="win32_physicalmemoryarray-class"></a>\_Clase Win32 PhysicalMemoryArray

La [clase WMI](../wmisdk/retrieving-a-class.md) **\_ PhysicalMemoryArray de Win32** representa los detalles sobre la memoria física del sistema del equipo. Esto incluye el número de dispositivos de memoria, la capacidad de memoria disponible y el tipo de memoria, por ejemplo, memoria de sistema o de vídeo.
...
La clase **Win32 \_ PhysicalMemoryArray** tiene estos métodos.
...
Este valor procede del miembro **Location** de la estructura de la **matriz de memoria física** en la información de SMBIOS.
...
**Placa de sistema o placa base** (3)
...
**Tarjeta complementaria PCMCIA** (8)
...
**Tarjeta complementaria de propiedad** (9)
...
**Tarjeta de complemento de PC-98/C20** (11)
...
**Tarjeta de complemento de PC-98/C24** (12)
...
**Tarjeta de complemento de PC-98/E** (13)
...
**Tarjeta complementaria de bus PC-98/local** (14)
...
Calificadores: [**desusados**](../wmisdk/standard-wmi-qualifiers.md), [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| tipo de SMBIOS 16 de \| capacidad máxima")
</dt> </dl>

En su lugar, use la propiedad **MaxCapacityEx** .

Este valor procede del miembro **capacidad máxima** de la estructura de la **matriz de memoria física** en la información de SMBIOS.

**Windows server 2012 R2, Windows 8.1, Windows server 2012, Windows 8, Windows server 2008 R2, Windows 7, Windows server 2008 y Windows Vista:** Tamaño máximo de memoria (en bytes) que se instala para esta matriz de memoria concreta. Si no se conoce el tamaño, se asigna a la propiedad un valor de 0 (cero).
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("tipo de SMBIOS \| 16 \| de capacidad máxima extendida"), [**unidades**](../wmisdk/standard-qualifiers.md) ("kilobytes")
</dt> </dl>

Tamaño máximo de memoria (en kilobytes) que se instala para esta matriz de memoria concreta. Si no se conoce el tamaño, se asigna a la propiedad un valor de 0 (cero).

Este valor procede del miembro de **capacidad máxima extendida** de la estructura de la **matriz de memoria física** en la información de SMBIOS.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| tipo de SMBIOS 16 \| número de dispositivos de memoria")
</dt> </dl>

Número de ranuras físicas o sockets disponibles en esta matriz de memoria.

Este valor procede del miembro **número de dispositivos de memoria** de la estructura de la **matriz de memoria física** en la información de SMBIOS.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("corrección de errores de memoria de tipo de SMBIOS \| 16 \| ")
</dt> </dl>

Tipo de corrección de errores utilizada por la matriz de memoria.

Este valor procede del miembro de **corrección de errores de memoria** de la estructura de la matriz de **memoria física** en la información de SMBIOS.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| uso del tipo de SMBIOS 16 \| ")
</dt> </dl>

Cómo se utiliza la memoria en el sistema del equipo.

Este valor procede del miembro **use** de la estructura de la **matriz de memoria física** en la información de SMBIOS.
...
La **clase \_ PhysicalMemoryArray de Win32** se deriva de [**\_ PhysicalPackage de CIM**](cim-physicalpackage.md).

## <a name="examples"></a>Ejemplos

En el siguiente ejemplo de PowerShell se recupera el número de ranuras de memoria y la cantidad de memoria instalada en un equipo de destino.
...
El siguiente ejemplo de código de VBScript devuelve información acerca de la memoria física instalada en un equipo.
