...
---
# <a name="reset-method-of-the-cim_fan-class"></a>Método Reset de la \_ clase del ventilador CIM

El método **RESET** de la \_ clase del ventilador CIM solicita un restablecimiento del dispositivo lógico. Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
...
[\_Ventilador CIM](reset-method-in-class-cim-fan.md)
</dt> <dt>
