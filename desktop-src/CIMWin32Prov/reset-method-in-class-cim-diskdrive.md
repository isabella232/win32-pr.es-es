...
ms.locfileid: "127062618"
---
# <a name="reset-method-of-the-cim_diskdrive-class"></a>Método reset de la clase \_ DiskDrive de CIM

El **método Reset** de la clase DiskDrive de CIM solicita un \_ restablecimiento del dispositivo lógico. Este método se hereda de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
