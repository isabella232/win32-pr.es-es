...
---
# <a name="reset-method-of-the-cim_diskdrive-class"></a>Método Reset de la \_ clase DiskDrive de CIM

El método **RESET** de la \_ clase DiskDrive de CIM solicita un restablecimiento del dispositivo lógico. Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
