---
description: La clase MemoryCheck de CIM \_ especifica una condición para la cantidad mínima de memoria que debe estar disponible en un sistema.
...
La **clase \_ MemoryCheck de CIM** tiene estos métodos.



| Método                                                   | Descripción                                                   |
|:---------------------------------------------------------|:--------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-memorycheck.md) | Realiza una acción determinada. No implementado por WMI.<br/> |
...
La **clase \_ MemoryCheck de CIM** tiene estas propiedades.
...
Cantidad de memoria que debe existir en un sistema informático para que un elemento de software se ejecute correctamente.
