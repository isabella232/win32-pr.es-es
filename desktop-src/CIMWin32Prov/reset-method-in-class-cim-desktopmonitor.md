...
---
# <a name="reset-method-of-the-cim_desktopmonitor-class"></a>Método Reset de la \_ clase DesktopMonitor de CIM

El método **RESET** de la \_ clase DesktopMonitor de CIM solicita un restablecimiento del dispositivo lógico. Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
