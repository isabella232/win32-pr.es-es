...
---
# <a name="setpowerstate-method-of-the-cim_cachememory-class"></a>Método SetPowerState de la \_ clase CIM CacheMemory

El método **SetPowerState** establece el estado de energía deseado para un dispositivo lógico y el momento en que el dispositivo debe ponerse en ese estado. En una subclase, especifique el conjunto de códigos de retorno posibles mediante un calificador **ValueMap** en el método. Las cadenas a las que se traduce el contenido **ValueMap** también se deben especificar en la subclase como calificador de matriz **Values** . Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
