---
description: La clase \_ CIM SCSIController representa las funciones y la administración del dispositivo lógico del controlador SCSI.
...
ms.locfileid: "127172061"
---
# <a name="cim_scsicontroller-class"></a>Cim \_ SCSIController (clase)

La **clase \_ CIM SCSIController** representa las funciones y la administración del dispositivo lógico del controlador SCSI.
...
| Método                                                                    | Descripción                                                                                                                              |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-scsicontroller.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-scsicontroller.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La **clase \_ CIM SCSIController** se deriva del [**controlador \_ CIM**](cim-controller.md).
