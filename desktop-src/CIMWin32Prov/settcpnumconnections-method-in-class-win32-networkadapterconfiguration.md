...
---
# <a name="settcpnumconnections-method-of-the-win32_networkadapterconfiguration-class"></a>Método SetTcpNumConnections de la \_ clase NetworkAdapterConfiguration de Win32
...
*TcpNumConnections* \[ de\]
</dt> <dd>

Número máximo de conexiones que TCP puede haber abierto simultáneamente. El intervalo válido de valores es 0-0xFFFFFE.
...
En el ejemplo [modificar el número permitido de conexiones TCP de](https://Gallery.TechNet.Microsoft.Com/016d09f3-28aa-47eb-b439-100b89999bab) VBScript se establece el número máximo permitido de conexiones TCP abiertas simultáneamente en un equipo en 10.
