...
---
# <a name="cim_uninterruptiblepowersupply-class"></a>\_Clase UninterruptiblePowerSupply de CIM

La clase **CIM \_ UninterruptiblePowerSupply** representa las capacidades y la administración de un sistema de alimentación ininterrumpida (SAI). Las propiedades del dispositivo UPS indican cuándo se recorta o aumenta la alimentación entrante y la información agregada de las baterías, los generadores, etc., que componen el dispositivo. Los componentes individuales (por ejemplo, varias baterías) también pueden modelarse de forma independiente y asociarse con el SAI.
...
| Método                                                                                | Descripción                                                                                                                              |
|:--------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-uninterruptiblepowersupply.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-uninterruptiblepowersupply.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Fuente de alimentación DMTF \| 002,15 ")
</dt> </dl>

El intervalo de voltaje de entrada está en uso actualmente. Si el suministro no está dibujando la energía actualmente, se puede especificar el valor 6 ("ninguno"). Esta información es necesaria en el caso de un SAI, una subclase de sistema de alimentación [**CIM \_**](cim-powersupply.md).

Esta propiedad se hereda del sistema de sistema [**CIM \_**](cim-powersupply.md).
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|001,4 de la batería de alimentación DMTF \| "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" porcentaje ")
</dt> </dl>

Estimación porcentual del importe total restante para un UPS que usa la tecnología de batería.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Baterú de la batería \| 001,3 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" minutos ")
</dt> </dl>

Tiempo estimado, en minutos, hasta que la batería, el generador u otra fuente de alimentación se agota bajo las condiciones de carga presentes si la utilidad de energía está apagada o se pierde y permanece desactivada.
...
Calificadores: [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("hercios")
</dt> </dl>

Frecuencia, en hercios, en el extremo superior del intervalo de frecuencia de entrada de la fuente de alimentación 1. Un valor de 0 (cero) implica DC.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Fuente de alimentación DMTF \| 002,17 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" hercios ")
</dt> </dl>

Frecuencia, en hercios, en el extremo inferior del intervalo de frecuencia de entrada de la fuente de alimentación 1. Un valor de 0 (cero) implica DC.
...
Calificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range1InputVoltageHigh"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milivoltios")
</dt> </dl>

Si el voltaje, en milivoltios, supera el valor especificado por la propiedad **Range1InputVoltageHigh** , el SAI se compensará recortando la tensión. Un valor de 0 (cero) indica que se desconoce el voltaje en el que se produce el recorte.
...
Calificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range1InputVoltageLow"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milivoltios")
</dt> </dl>

Si el voltaje, en milivoltios, cae por debajo del valor especificado por la propiedad **Range1InputVoltageLow** , el UPS se compensará aumentando el voltaje usando sus fuentes de alimentación. Un valor de 0 indica que se desconoce el voltaje en el que se produce el aumento.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Fuente de alimentación DMTF \| 002,20 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" hercios ")
</dt> </dl>
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Fuente de alimentación DMTF \| 002,19 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" hercios ")
</dt> </dl>

Frecuencia, en hercios, en el extremo inferior del intervalo de frecuencia de entrada de la fuente de alimentación 2. Un valor de 0 implica DC.
...
Calificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range2InputVoltageHigh"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milivoltios")
</dt> </dl>

Si el voltaje, en milivoltios, supera el valor especificado por la propiedad **Range2InputVoltageHigh** , el SAI se compensará recortando la tensión. Un valor de 0 (cero) indica que se desconoce el voltaje en el que se produce el recorte.
...
Calificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range2InputVoltageLow"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("milivoltios")
</dt> </dl>

Si el voltaje, en milivoltios, cae por debajo del valor especificado por la propiedad **Range2InputVoltageLow** , el UPS se compensará aumentando el voltaje usando sus fuentes de alimentación. Un valor de 0 (cero) indica que se desconoce el voltaje en el que se produce el aumento.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Batería 001,1 de DMTF (SAI \| )
</dt> </dl>

Indicación de la capacidad restante en las baterías, el generador u otro origen del SAI.
...
Los minutos estimados restantes de tiempo de ejecución son mayores que el estado de baja energía definido por el SAI (normalmente, dos minutos).
...
Los minutos estimados restantes de tiempo de ejecución son menores o iguales que el estado de baja energía definido por el SAI.
...
El SAI (UPS) no podrá mantener la carga actual cuando se pierda la alimentación de la utilidad (incluida la posibilidad de que la utilidad de energía esté actualmente ausente).
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|001,2 de la batería de alimentación DMTF \| "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" segundos ")
</dt> </dl>

Tiempo transcurrido, en segundos, desde que el SAI se cambió por última vez a la energía de la batería, el generador u otra fuente de alimentación. O bien, la hora desde la última vez que se reinició el SAI, lo que sea menor. Si el SAI está en línea, se devolverá 0 (cero).
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Fuente de alimentación DMTF \| 002,21 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milivatios ")
</dt> </dl>

Potencia de salida total de la fuente de alimentación, en milivatios. Un valor de 0 (cero) denota Unknown.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Fuente de alimentación DMTF \| 002,16 ")
</dt> </dl>
...
La **clase \_ UninterruptiblePowerSupply de CIM** se deriva del sistema de sistema [**CIM \_**](cim-powersupply.md).
