...
---
# <a name="enableipfiltersec-method-of-the-win32_networkadapterconfiguration-class"></a>Método EnableIPFilterSec de la \_ clase NetworkAdapterConfiguration de Win32

El método estático de la [clase WMI](/windows/desktop/WmiSdk/retrieving-a-class) **EnableIPFilterSec** se usa para habilitar el protocolo de seguridad de Internet (IPSec) globalmente en todos los adaptadores de red enlazados a IP.
...
*IPFilterSecurityEnabled* \[ de\]
</dt> <dd>

Si es **true**, IPSec está habilitado globalmente en todos los adaptadores de red enlazados a IP. Si es **false**, se permite que el tráfico de puertos y protocolos fluya sin filtrar.
