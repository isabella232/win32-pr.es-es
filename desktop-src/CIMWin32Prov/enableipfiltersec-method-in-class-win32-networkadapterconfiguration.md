---
description: El método estático de la clase WMI EnableIPFilterSec se usa para habilitar la seguridad de protocolo de Internet (IPsec) globalmente en todos los adaptadores de red enlazados a IP.
ms.assetid: 565acc18-61e7-473e-b2cc-41f0e8c29193
ms.tgt_platform: multiple
title: Método EnableIPFilterSec de la Win32_NetworkAdapterConfiguration clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
*IPFilterSecurityEnabled* \[ En\]
</dt> <dd>

Si **es true,** IPsec está habilitado globalmente en todos los adaptadores de red enlazados a IP. Si **es false,** todo el tráfico de puerto y protocolo puede fluir sin filtrar.
...
El código siguiente, tomado del ejemplo Habilitar la seguridad [de IPFilter](https://Gallery.TechNet.Microsoft.Com/f8e56021-5a54-4554-b7b6-d76cc40d8d1d) en todos los adaptadores de red de la Galería de TechNet, habilita la seguridad de filtro IP para todos los adaptadores de red instalados en un equipo.
