...
---
# <a name="cim_pointingdevice-class-cimwin32-wmi-providers"></a>CIM_PointingDevice (clase) (proveedores WMI de CIMWin32)

La clase **CIM \_ PointingDevice** representa un dispositivo que apunta a las regiones de la pantalla. Cualquier dispositivo que manipula un puntero, o apunta a regiones de una presentación visual, es un miembro de esta clase. Por ejemplo, un mouse, un lápiz, un teclado táctil o una tableta.
...
La clase **CIM \_ PointingDevice** tiene estos métodos.



| Método                                                                    | Descripción                                                                                                                              |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-pointingdevice.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pointingdevice.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
Configuración del dispositivo señalador para el funcionamiento del lado derecho o izquierdo.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Dispositivo señalador DMTF \| 001,1 ")
</dt> </dl>
...
Calificadores: [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("recuentos por pulgada")
</dt> </dl>
...
La clase **CIM \_ PointingDevice** se deriva de [**\_ UserDevice de CIM**](cim-userdevice.md).

WMI no implementa esta clase. Para las clases WMI derivadas de **CIM \_ PointingDevice**, vea [clases Win32](win32-provider.md).
