---
description: La clase CIM \_ PointingDevice representa un dispositivo que apunta a regiones de la pantalla. Cualquier dispositivo que manipula un puntero o apunta a regiones en una pantalla visual es miembro de esta clase. Por ejemplo, un mouse, un lápiz óptico, un panel táctil o una tableta.
ms.assetid: b093134a-534a-4680-8fce-d96baff26139
ms.tgt_platform: multiple
title: CIM_PointingDevice clase (proveedores WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
api_location:
- CIMWin32.dll
ms.openlocfilehash: cecc5be2e80002b1b7bb4f134b3d0ae43547741ba91712bbbc0a709d38830b19
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 08/11/2021
ms.locfileid: "119820337"
---
# <a name="cim_pointingdevice-class-cimwin32-wmi-providers"></a>CIM_PointingDevice clase (proveedores WMI CIMWin32)

La **clase CIM \_ PointingDevice** representa un dispositivo que apunta a regiones de la pantalla. Cualquier dispositivo que manipula un puntero o apunta a regiones en una pantalla visual es miembro de esta clase. Por ejemplo, un mouse, un lápiz óptico, un panel táctil o una tableta.
...
| Método                                                                    | Descripción                                                                                                                              |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Restablecer**](reset-method-in-class-cim-pointingdevice.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pointingdevice.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. No implementado por WMI.<br/> |
...
Configuración del dispositivo que apunta para la operación a la derecha o a la izquierda.
...
Calificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Pointing Device \| 001.1")
</dt> </dl>
...
La **clase \_ CIM PointingDevice** se deriva de [**CIM \_ UserDevice**](cim-userdevice.md).
