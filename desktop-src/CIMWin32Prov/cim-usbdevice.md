---
description: La clase \_ CIM USBDevice representa las características de administración de un dispositivo USB.
ms.assetid: 0ff39701-826a-434b-a628-0af586600a80
ms.tgt_platform: multiple
title: CIM_USBDevice clase (proveedores WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119918805"
---
# <a name="cim_usbdevice-class-cimwin32-wmi-providers"></a>CIM_USBDevice clase (proveedores WMI CIMWin32)

La **clase \_ CIM USBDevice** representa las características de administración de un dispositivo USB.
...
| Método                                                               | Descripción                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**GetDescriptor**](getdescriptor-method-in-class-cim-usbdevice.md) | Devuelve el descriptor del dispositivo USB. No implementado por WMI.<br/>                                                                    |
| [**Restablecer**](reset-method-in-class-cim-usbdevice.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbdevice.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. No implementado por WMI.<br/> |
...
Configuración seleccionada actualmente para el dispositivo. Si el valor es 0 (cero), el dispositivo no está configurado.
...
Versión USB más reciente compatible con el dispositivo USB. Esta propiedad se expresa como un decimal codificado binario (BCD) donde un separador decimal está implícito entre el segundo y el tercer dígito. Por ejemplo, un valor de 0x201 indica que se admite la versión 2.01.

</dd> </dl>

## <a name="remarks"></a>Comentarios

La **clase \_ CIM USBDevice** se deriva de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

WMI no implementa esta clase. Para las clases WMI que implementan **CIM \_ USBDevice**, vea [Clases Win32](win32-provider.md).
