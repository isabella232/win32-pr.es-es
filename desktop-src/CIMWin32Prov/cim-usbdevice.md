...
---
# <a name="cim_usbdevice-class-cimwin32-wmi-providers"></a>CIM_USBDevice (clase) (proveedores WMI de CIMWin32)

La clase **CIM \_ USBDevice** representa las características de administración de un dispositivo USB.
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbdevice.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La **clase \_ USBDevice de CIM** se deriva del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).

WMI no implementa esta clase. Para las clases WMI que implementan **\_ USBDevice CIM**, vea [clases Win32](win32-provider.md).
