...
---
# <a name="cim_alarmdevice-class"></a>\_Clase AlarmDevice de CIM

La **clase \_ AlarmDevice de CIM** es un dispositivo de alarma que emite indicaciones auditivas o visibles relacionadas con una situación problemática.
...
La clase **CIM \_ AlarmDevice** tiene estos tipos de miembros:
...
La clase **CIM \_ AlarmDevice** tiene estos métodos.



| Método                                                                 | Descripción                                                                                                                             |
|:-----------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-alarmdevice.md)                 | Solicita un restablecimiento de dispositivo lógico. No implementado por WMI.<br/>                                                                     |
| [**SetPowerState**](setpowerstate-method-in-class-cim-alarmdevice.md) | Establece el estado de energía deseado para un dispositivo lógico y el momento en que el dispositivo debe ponerse en ese estado. No implementado por WMI.<br/> |
| [**SetUrgency**](seturgency-method-in-class-cim-alarmdevice.md)       | Establece el nivel de urgencia deseado para la alarma. No implementado por WMI.<br/>                                                        |
...
La clase **CIM \_ AlarmDevice** tiene estas propiedades.
...
Si es **true**, la alarma es audible.
...
Valor enumerado que indica la frecuencia relativa con la que la alarma parpadea, vibra o emite tonos sonoros.
...
<span id="Non-Critical"></span><span id="non-critical"></span><span id="NON-CRITICAL"></span>**No crítico** (4)
...
<span id="Unrecoverable"></span><span id="unrecoverable"></span><span id="UNRECOVERABLE"></span>**Irrecuperable** (6)
...
Si es **true**, la alarma es visible.

</dd> </dl>

## <a name="remarks"></a>Observaciones

La **clase \_ AlarmDevice de CIM** se deriva del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
