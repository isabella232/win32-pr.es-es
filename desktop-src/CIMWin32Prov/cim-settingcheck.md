...
---
# <a name="cim_settingcheck-class"></a>\_Clase SettingCheck de CIM

La clase **CIM \_ SettingCheck** especifica la información necesaria para comprobar un archivo de configuración determinado para una entrada específica que contiene un valor igual al valor especificado. Se supone que todas las comparaciones no distinguen mayúsculas de minúsculas.
...
La clase **CIM \_ SettingCheck** tiene estos tipos de miembros:
...
La clase **CIM \_ SettingCheck** tiene estos métodos.



| Método                                                    | Descripción                                                   |
|:----------------------------------------------------------|:--------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-settingcheck.md) | Toma una acción concreta. No implementado por WMI.<br/> |
...
La clase **CIM \_ SettingCheck** tiene estas propiedades.
...
Identificador que se usa junto con otras claves para identificar de forma única la comprobación. Esta propiedad se hereda de [**la \_ comprobación CIM**](cim-check.md).
...
Si es **true**, se espera que la condición exista en el entorno (por ejemplo, si un archivo está en un sistema, el método [**Invoke**](invoke-method-in-class-cim-settingcheck.md) debe devolver **true**). Si es **false**, la condición no debe existir (por ejemplo, si un archivo no se encuentra en un sistema, el método **Invoke** debe devolver **false**).
...
Modo en el que se debe comparar el valor de configuración.
...
Nombre de la entrada que se va a comprobar
...
Valor asociado a la entrada con nombre que se va a comprobar.
...
Nombre del archivo de configuración que se va a comprobar.
...
Nombre usado para identificar el elemento de software. Esta propiedad se hereda de [**la \_ comprobación CIM**](cim-check.md).
...
Clave de la sección que contiene la configuración que se va a comprobar.
