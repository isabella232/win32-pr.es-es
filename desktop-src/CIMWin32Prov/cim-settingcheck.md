---
description: La clase CIM SettingCheck especifica la información necesaria para comprobar un archivo de configuración determinado para una entrada específica que contiene un valor igual \_ al valor especificado. Se supone que todas las comparaciones no tienen en cuenta mayúsculas de minúsculas.
...
La **clase \_ SettingCheck de CIM** tiene estos métodos.



| Método                                                    | Descripción                                                   |
|:----------------------------------------------------------|:--------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-settingcheck.md) | Realiza una acción determinada. No implementado por WMI.<br/> |
...
La **clase \_ SettingCheck de CIM** tiene estas propiedades.
...
Identificador que se usa junto con otras claves para identificar de forma única la comprobación. Esta propiedad se hereda de [**CIM \_ Check**](cim-check.md).
...
Si **es TRUE**, se espera que la condición exista en el entorno (por ejemplo, si un archivo está en un sistema, el método [**Invoke**](invoke-method-in-class-cim-settingcheck.md) debe devolver **TRUE).** Si **es FALSE**, la condición no debe existir (por ejemplo, si un archivo no está en un sistema, el método **Invoke** debe devolver **FALSE**).
...
Manera en que se debe comparar el valor de configuración.
...
Nombre de archivo del archivo de configuración que se comprobará.
...
Nombre utilizado para identificar el elemento de software. Esta propiedad se hereda de [**CIM \_ Check**](cim-check.md).
...
Clave de la sección que contiene la configuración que se debe comprobar.
