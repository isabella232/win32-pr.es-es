...
Datos que identifican el dispositivo de carga inicial (su clave) o el servicio de arranque que solicitó la última carga del sistema operativo. Además, también se pueden especificar los parámetros de carga (es decir, un nombre de ruta de acceso y parámetros).
