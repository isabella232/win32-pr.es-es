...
---
# <a name="delete-method-of-the-cim_datafile-class"></a>Método Delete de la \_ clase de archivo de archivos CIM

El método **Delete** elimina el archivo lógico (o directorio) especificado en la ruta de acceso del objeto. Este método se hereda de [**\_ LogicalFile CIM**](cim-logicalfile.md).
...
WMI implementa el método **Delete** en el [**archivo de \_ archivos de CIM**](cim-datafile.md) .
...
[\_Archivo de archivos CIM](delete-method-in-class-cim-datafile.md)
</dt> <dt>
