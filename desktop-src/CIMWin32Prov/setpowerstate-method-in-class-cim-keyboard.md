---
description: El método SetPowerState de la clase CIM Keyboard establece el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo \_ en ese estado.
ms.assetid: f51cc589-b103-468c-89a5-2bfff4868ff2
ms.tgt_platform: multiple
title: Método SetPowerState de la CIM_Keyboard clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
[Teclado \_ CIM](setpowerstate-method-in-class-cim-keyboard.md)
</dt> <dt>
