---
description: El método SetPowerState de la clase Cim Memory establece el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo \_ en ese estado.
