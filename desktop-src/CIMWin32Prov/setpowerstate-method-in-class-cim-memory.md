---
description: El método SetPowerState de la clase de memoria CIM establece el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo \_ en ese estado.
ms.assetid: 7e5b0c93-abaf-480e-9fbd-83e68c6b9308
ms.tgt_platform: multiple
title: Método SetPowerState de la CIM_Memory clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
[Memoria \_ CIM](setpowerstate-method-in-class-cim-memory.md)
</dt> <dt>
