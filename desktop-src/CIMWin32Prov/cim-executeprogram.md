...
---
# <a name="cim_executeprogram-class"></a>\_Clase ExecuteProgram de CIM

La clase **CIM \_ ExecuteProgram** representa los archivos que se pueden ejecutar en el sistema donde está instalado el elemento de software.
...
La clase **CIM \_ ExecuteProgram** tiene estos tipos de miembros:
...
La clase **CIM \_ ExecuteProgram** tiene estos métodos.



| Método                                                      | Descripción                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-executeprogram.md) | Toma una acción concreta. No implementado por WMI.<br/> |
...
La clase **CIM \_ ExecuteProgram** tiene estas propiedades.
