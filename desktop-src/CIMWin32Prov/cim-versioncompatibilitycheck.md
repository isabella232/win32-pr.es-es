---
description: La clase CIM VersionCompatibilityCheck especifica si está permitido crear el \_ siguiente estado de un elemento de software.
...
Si **es TRUE,** el elemento de software puede pasar a su siguiente estado independientemente de si ya existe una versión superior o posterior del elemento de software en el entorno.
...
Si **es TRUE,** el elemento de software puede pasar a su siguiente estado independientemente de si ya existe un elemento de software de la misma versión en el entorno.
