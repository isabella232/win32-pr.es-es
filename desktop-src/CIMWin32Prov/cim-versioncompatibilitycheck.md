...
---
# <a name="cim_versioncompatibilitycheck-class"></a>\_Clase VersionCompatibilityCheck de CIM

La clase **CIM \_ VersionCompatibilityCheck** especifica si se permite crear el siguiente estado de un elemento de software.
...
La clase **CIM \_ VersionCompatibilityCheck** tiene estos métodos.



| Método                                                                 | Descripción                                                   |
|:-----------------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invocar**](invoke-method-in-class-cim-versioncompatibilitycheck.md) | Toma una acción concreta. No implementado por WMI.<br/> |
...
La clase **CIM \_ VersionCompatibilityCheck** tiene estas propiedades.
...
Si **es true**, el elemento de software puede pasar a su siguiente estado si ya existe una versión superior o posterior del elemento de software en el entorno.
...
Controla la capacidad de configurar varias versiones de un producto en un sistema.
...
Si **es true**, el elemento de software puede pasar a su siguiente estado si ya existe o no un elemento de software de la misma versión en el entorno.
