...
---
# <a name="win32_pointingdevice-class"></a>\_Clase Win32 PointingDevice

La [clase WMI](../wmisdk/retrieving-a-class.md) **\_ PointingDevice de Win32** representa un dispositivo de entrada que se usa para señalar y seleccionar regiones en la visualización de un equipo que ejecuta Windows. Cualquier dispositivo usado para manipular un puntero o apuntar a la pantalla de un equipo que ejecuta Windows es miembro de esta clase.
...
La clase **Win32 \_ PointingDevice** tiene estos métodos.



| Método            | Descripción                                                                                                                                                                                      |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Sin implementar. Para implementar este método, consulte el método [**RESET**](reset-method-in-class-cim-controller.md) en [**CIM \_ PointingDevice**](cim-pointingdevice.md).<br/>                 |
| **SetPowerState** | Sin implementar. Para implementar este método, consulte el método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) en [**CIM \_ PointingDevice**](cim-pointingdevice.md).<br/> |
...
Identificador único del dispositivo señalador con otros dispositivos en el sistema.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| interfaz de tipo SMBIOS 21 \| ")
</dt> </dl>

Tipo de interfaz que se usa para el dispositivo señalador.
...
**ADB (bus de escritorio de Apple)** (8)
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("inesperados win32api \| System Information Functions \| SystemParametersInfo"), [**Units**](../wmisdk/standard-qualifiers.md) ("Mickeys")
</dt> </dl>

Uno de los dos valores de aceleración. La confidencialidad del dispositivo señalador se duplica (alterna entre el primero y el segundo valor) cuando el dispositivo señalador mueve una distancia mayor que este valor de umbral.
...
Configuración del dispositivo señalador para la operación de la izquierda o la derecha.

Esta propiedad se hereda de [**\_ PointingDevice CIM**](cim-pointingdevice.md).
...
<span id="Right_Handed_Operation"></span><span id="right_handed_operation"></span><span id="RIGHT_HANDED_OPERATION"></span>**Operación de mano derecha** (2)
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HKEY \_ local \_ Machine \\ \\ System \\ \\ ControlSet001 \\ \\ control \\ \\ Class \| DriverDesc")
</dt> </dl>

Tipo de hardware usado para el dispositivo señalador de Windows.

Ejemplo: "MOUSE PS2 de MICROSOFT"
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HKEY \_ local \_ Machine \\ \\ System \\ \\ CurrentControlSet \\ \\ control \\ \\ Class \| InfPath")
</dt> </dl>

Nombre del archivo. inf para el dispositivo señalador de Windows.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HKEY \_ local \_ Machine \\ \\ System \\ \\ CurrentControlSet \\ \\ control \\ \\ Class \| InfSection")
</dt> </dl>

Sección del archivo. inf que contiene información de configuración del dispositivo señalador de Windows.
...
Esta propiedad se hereda de [**\_ UserDevice CIM**](cim-userdevice.md).
...
Número de botones del dispositivo señalador.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Dispositivo señalador DMTF \| 001,1 ")
</dt> </dl>

Tipo de dispositivo señalador.
...
<span id="Track_Ball"></span><span id="track_ball"></span><span id="TRACK_BALL"></span>**Bola de seguimiento** (4)
...
<span id="Glide_Point"></span><span id="glide_point"></span><span id="GLIDE_POINT"></span>**Punto de deslizamiento** (6)
...
<span id="Touch_Pad"></span><span id="touch_pad"></span><span id="TOUCH_PAD"></span>**Teclado táctil** (7)
...
Uno de los dos valores de umbral de aceleración. El sistema duplica la velocidad del movimiento del puntero cuando el dispositivo de puntero mueve una distancia mayor que este valor. Dado que este aumento de velocidad se produce una vez que se ha alcanzado el valor de **DoubleSpeedThreshold** , el puntero se mueve realmente cuatro veces a la velocidad original.
...
Calificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| SampleRate"), [**unidades**](../wmisdk/standard-qualifiers.md) ("hercios")
</dt> </dl>

Velocidad a la que se sondea el dispositivo señalador en busca de información de entrada.
...
Período de tiempo después del cual se supone que la siguiente interrupción indica el inicio de un nuevo paquete de dispositivo (los paquetes parciales se descartan). En caso de que se pierda una interrupción, esto permite que el controlador del dispositivo señalador Sincronice su representación interna del estado del paquete con el estado del hardware.
...
La **clase \_ PointingDevice de Win32** se deriva de [**\_ PointingDevice de CIM**](cim-pointingdevice.md).
