---
description: La clase sensor CIM representa un dispositivo de hardware capaz de medir las características de una propiedad física (por ejemplo, las características de temperatura o voltaje de un sistema \_ informático unitario).
...
ms.locfileid: "119919945"
---
# <a name="cim_sensor-class"></a>Cim \_ Sensor (clase)

La **clase \_ sensor CIM** representa un dispositivo de hardware capaz de medir las características de una propiedad física (por ejemplo, las características de temperatura o voltaje de un sistema informático unitario).
...
La **clase \_ sensor CIM** tiene estos tipos de miembros:
...
La **clase \_ sensor CIM** tiene estos métodos.



| Método                                                            | Descripción                                                                                                                              |
|:------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Restablecer**](reset-method-in-class-cim-sensor.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-sensor.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La **clase \_ sensor CIM** tiene estas propiedades.
...
La **clase \_ sensor CIM** se deriva de CIM [**\_ LogicalDevice**](cim-logicaldevice.md).

WMI no implementa esta clase. Para las clases WMI derivadas del **\_ sensor CIM**, vea [Clases Win32](win32-provider.md).
