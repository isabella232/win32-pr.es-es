...
---
# <a name="reset-method-of-the-cim_wormdrive-class"></a>Método Reset de la \_ clase WORMDrive de CIM

El método **RESET** de la clase \_ [**WORMDrive**](cim-wormdrive.md) de CIM solicita un restablecimiento del dispositivo lógico. Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
