...
---
# <a name="uncompressex-method-of-the-win32_shortcutfile-class"></a>Método UncompressEx de la \_ clase ShortcutFile de Win32

El método de [clase WMI](/windows/desktop/WmiSdk/retrieving-a-class) **UncompressEx** descomprime el archivo de método abreviado lógico (o directorio) especificado en la ruta de acceso del objeto. Este método es una versión extendida del método [**UNCOMPRESS**](uncompress-method-in-class-win32-directory.md) .
