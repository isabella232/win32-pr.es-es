...
---
# <a name="resumeservice-method-of-the-win32_baseservice-class"></a>Método ResumeService de la \_ clase BaseService de Win32

El método de [clase WMI](/windows/desktop/WmiSdk/retrieving-a-class) **ResumeService** intenta poner el servicio en estado de reanudación.
