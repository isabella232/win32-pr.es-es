...
---
# <a name="cim_heatpipe-class"></a>\_Clase HeatPipe de CIM

La clase **CIM \_ HeatPipe** representa las capacidades y la administración de un dispositivo de refrigeración de canalización térmica.
...
La clase **CIM \_ HeatPipe** tiene estos tipos de miembros:
...
| Método                                                              | Descripción                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-heatpipe.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-heatpipe.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ HeatPipe** tiene estas propiedades.
...
La clase **CIM \_ HeatPipe** se deriva de [**\_ CoolingDevice de CIM**](cim-coolingdevice.md).
