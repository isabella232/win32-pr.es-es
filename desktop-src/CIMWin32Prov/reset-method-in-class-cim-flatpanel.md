...
---
# <a name="reset-method-of-the-cim_flatpanel-class"></a>Método Reset de la \_ clase FlatPanel de CIM

El método **RESET** de la \_ clase FlatPanel de CIM solicita un restablecimiento del dispositivo lógico. Este método se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
...
[\_FLATPANEL CIM](reset-method-in-class-cim-flatpanel.md)
</dt> <dt>
