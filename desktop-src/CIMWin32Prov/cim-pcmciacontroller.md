...
---
# <a name="cim_pcmciacontroller-class"></a>\_Clase PCMCIAController de CIM

La clase **CIM \_ PCMCIAController** representa las capacidades y la administración de un controlador de la Asociación Internacional de tarjetas de memoria (PCMCIA) del equipo.
...
La clase **CIM \_ PCMCIAController** tiene estos tipos de miembros:
...
La clase **CIM \_ PCMCIAController** tiene estos métodos.



| Método                                                                      | Descripción                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-pcmciacontroller.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ PCMCIAController** tiene estas propiedades.
...
Disponibilidad y estado del dispositivo. Esta propiedad se hereda del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
...
El método [**SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) se puede invocar con el parámetro *PowerState* establecido en 5 ("ciclo de energía") y el parámetro *Time* establecido en una fecha y hora específicas, o Interval, para el encendido.
...
La clase **CIM \_ PCMCIAController** se deriva del [**\_ controlador CIM**](cim-controller.md).

WMI no implementa esta clase. Para las clases WMI que se derivan de **\_ PCMCIAController CIM**, vea [clases Win32](win32-provider.md).
