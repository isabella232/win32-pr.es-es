---
description: La clase CIM PCMCIAController representa las funciones y la administración de un controlador de asociación internacional de tarjetas de memoria de equipo \_ personal (PCMCIA).
...
ms.locfileid: "118678845"
---
# <a name="cim_pcmciacontroller-class"></a>CIM \_ PCMCIAController (clase)

La **clase \_ CIM PCMCIAController representa** las funciones y la administración de un controlador de asociación internacional de tarjetas de memoria de equipo personal (PCMCIA).
...
La **clase \_ CIM PCMCIAController** tiene estos tipos de miembros:
...
La **clase \_ CIM PCMCIAController tiene** estos métodos.



| Método                                                                      | Descripción                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Restablecer**](reset-method-in-class-cim-pcmciacontroller.md)                 | Solicita un restablecimiento del dispositivo lógico. Wmi no implementa.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. Wmi no implementa.<br/> |
...
La **clase \_ CIM PCMCIAController** tiene estas propiedades.
...
Disponibilidad y estado del dispositivo. Esta propiedad se hereda de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
...
El controlador PCMCIA no está disponible.
...
Windows identificar todos los recursos que usa el dispositivo.
...
Nombre del fabricante del controlador PCMCIA.
...
Se [**admite el método SetPowerState.**](setpowerstate-method-in-class-cim-pcmciacontroller.md)
...
El [**método SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) se puede invocar con el *parámetro PowerState* establecido en 5 ("Ciclo de energía").
...
El [**método SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) se puede invocar con el parámetro *PowerState* establecido en 5 ("Power Cycle") y el parámetro *Time* establecido en una fecha y hora específicas, o un intervalo, para la encendido.
...
La **clase \_ CIM PCMCIAController** se deriva del [**controlador CIM \_**](cim-controller.md).

WMI no implementa esta clase. Para las clases WMI que se derivan de **\_ CIM PCMCIAController,** vea [Clases win32](win32-provider.md).
