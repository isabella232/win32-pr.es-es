---
description: La clase \_ de controlador CIM es una clase primaria para agrupar varios dispositivos relacionados con el control. Algunos ejemplos de controladores son controladores SCSI, controladores USB y controladores serie.
ms.assetid: 526d58bb-cdf4-42c2-ae89-7b86d99e2017
ms.tgt_platform: multiple
title: CIM_Controller clase (proveedores WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119924915"
---
# <a name="cim_controller-class-cimwin32-wmi-providers"></a>CIM_Controller clase (proveedores WMI CIMWin32)

La **clase de \_ controlador CIM** es una clase primaria para agrupar varios dispositivos relacionados con el control. Algunos ejemplos de controladores son controladores SCSI, controladores USB y controladores serie.

La **\_ clase de** controlador CIM es una abstracción para dispositivos con una sola pila de protocolos, que existen principalmente para la comunicación con dispositivos de nivel inferior (CIM ControlledBy) y para controlar o restablecer los dispositivos de bajada [**(CIM \_ ControlledBy).**](cim-controlledby.md)
...
La **clase de \_ controlador CIM** tiene estos métodos.
...
Número máximo de entidades direccionables directamente admitidas por este controlador. Se debe usar un valor de 0 si el número es desconocido o ilimitado.
...
Fecha y hora en que se restableció por última vez el controlador (apagado o reinicializado).

</dd> </dl>

## <a name="remarks"></a>Comentarios

La **clase de \_ controlador CIM** se deriva de [**\_ LOGICALDevice de CIM.**](cim-logicaldevice.md)

WMI no implementa esta clase. Para las clases derivadas del **controlador CIM, \_** vea [Clases win32.](win32-provider.md)
