---
description: Win32 \_ Refrigeration &\# 32; La clase WMI representa las propiedades de un dispositivo de refrigeración.
...
ms.locfileid: "118958904"
---
# <a name="win32_refrigeration-class"></a>Clase Refrigeration de Win32 \_

La **clase WMI \_ Refrigeration** [de](../wmisdk/retrieving-a-class.md) Win32 representa las propiedades de un dispositivo de refrigeración.
...
La **clase \_ Refrigeration de Win32** tiene estos tipos de miembros:
...
La **clase \_ Refrigeration de Win32** tiene estos métodos.



| Método            | Descripción                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Sin implementar. Para implementar este método, vea el [**método Reset**](reset-method-in-class-cim-controller.md) en [**CIM \_ Refrigeration**](cim-refrigeration.md).<br/>                 |
| **SetPowerState** | Sin implementar. Para implementar este método, vea el [**método SetPowerState**](setpowerstate-method-in-class-cim-controller.md) en [**CIM \_ Refrigeration**](cim-refrigeration.md).<br/> |
...
La **clase \_ Refrigeration de Win32** tiene estas propiedades.
...
Identificador único del dispositivo de refrigeración.
...
La **clase \_ Refrigeration de Win32** se deriva de [**CIM \_ Refrigeration**](cim-refrigeration.md).
