...
---
# <a name="win32_refrigeration-class"></a>\_Clase de refrigeración Win32

La [clase WMI](../wmisdk/retrieving-a-class.md) de **\_ refrigeración de Win32** representa las propiedades de un dispositivo de refrigeración.
...
La clase de **\_ refrigeración Win32** tiene estos tipos de miembros:
...
La clase de **\_ refrigeración Win32** tiene estos métodos.



| Método            | Descripción                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Sin implementar. Para implementar este método, consulte el método de [**restablecimiento**](reset-method-in-class-cim-controller.md) en el [**\_ frigorífico de CIM**](cim-refrigeration.md).<br/>                 |
| **SetPowerState** | Sin implementar. Para implementar este método, consulte el método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) en [**la \_ refrigeración CIM**](cim-refrigeration.md).<br/> |
...
La clase de **\_ refrigeración Win32** tiene estas propiedades.
...
Si **es true**, el dispositivo de enfriamiento proporciona enfriamiento activo, no enfriamiento pasivo.
...
La clase de **\_ refrigeración de Win32** deriva de [**la \_ refrigeración CIM**](cim-refrigeration.md).
