...
---
# <a name="cim_serialcontroller-class-cimwin32-wmi-providers"></a>CIM_SerialController (clase) (proveedores WMI de CIMWin32)

La clase **CIM \_ SerialController** representa las capacidades y la administración del dispositivo lógico de puerto serie.
...
| Método                                                                      | Descripción                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-serialcontroller.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-serialcontroller.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
Compatibilidad de nivel de chip para el controlador serie. Esta propiedad describe el almacenamiento en búfer y otras funciones del controlador serie, que pueden ser inherentes en el hardware del chip. Esta propiedad es un entero enumerado.
...
Cadenas de forma libre que proporcionan explicaciones detalladas para las características del controlador serie indicadas en la matriz de **capacidades** .
...
La clase **CIM \_ SerialController** se deriva del [**\_ controlador CIM**](cim-controller.md).
