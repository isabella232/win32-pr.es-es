...
---
# <a name="win32_pnpdevicepropertydatetimearray-class"></a>\_Clase Win32 PnPDevicePropertyDateTimeArray

Representa una propiedad de dispositivo PnP que consta de una matriz de elementos **DateTime** .
...
Tipo de datos: matriz de **DateTime**
</dt> <dt>
