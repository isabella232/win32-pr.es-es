...
---
# <a name="cim_aggregatepsextent-class"></a>\_Clase AggregatePSExtent de CIM

La clase **CIM \_ AggregatePSExtent** define el número de bloques lógicos direccionables en un único dispositivo de almacenamiento, excluidos los bloques lógicos asignados como datos de comprobación. Si se definen conjuntos de volúmenes, los bloques lógicos se incluyen en un único conjunto de volúmenes. Se trata de una agrupación alternativa para [**CIM \_ ProtectedSpaceExtent**](cim-protectedspaceextent.md), cuando solo se necesita información de resumen o cuando se usa la configuración automática.

La configuración automática puede dar lugar a que se definan miles de clases [**CIM \_ ProtectedSpaceExtent**](cim-protectedspaceextent.md) . La clase **CIM \_ AggregatePSExtent** se ha definido para que no sea necesario modelar las extensiones individuales.
...
La clase **CIM \_ AggregatePSExtent** tiene estos tipos de miembros:
...
La clase **CIM \_ AggregatePSExtent** tiene estos métodos.
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-aggregatepsextent.md) | Define el estado de energía deseado para un dispositivo lógico y el momento en que el dispositivo debe ponerse en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ AggregatePSExtent** tiene estas propiedades.
...
La clase **CIM \_ AggregatePSExtent** se deriva de [**\_ StorageExtent de CIM**](cim-storageextent.md).
