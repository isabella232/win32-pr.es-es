...
---
# <a name="cim_coolingdevice-class"></a>\_Clase CoolingDevice de CIM

La clase **CIM \_ CoolingDevice** representa las capacidades y la administración de dispositivos de enfriamiento.
...
La clase **CIM \_ CoolingDevice** tiene estos tipos de miembros:
...
La clase **CIM \_ CoolingDevice** tiene estos métodos.
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-coolingdevice.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase **CIM \_ CoolingDevice** tiene estas propiedades.
...
La **clase \_ CoolingDevice de CIM** se deriva del [**\_ LogicalDevice de CIM**](cim-logicaldevice.md).
