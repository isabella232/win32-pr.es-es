---
description: La clase CoolingDevice de CIM \_ representa las funciones y la administración de los dispositivos de refrigeración.
...
ms.locfileid: "119924895"
---
# <a name="cim_coolingdevice-class"></a>Cim \_ CoolingDevice (clase)

La **clase \_ CoolingDevice de CIM** representa las funciones y la administración de los dispositivos de refrigeración.
...
La **clase \_ CoolingDevice** de CIM tiene estos tipos de miembros:
...
La **clase \_ CoolingDevice de CIM** tiene estos métodos.



| Método                                                                   | Descripción                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Restablecer**](reset-method-in-class-cim-controller.md)                    | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-coolingdevice.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La **clase \_ CoolingDevice** de CIM tiene estas propiedades.
...
La **clase \_ CIM CoolingDevice** se deriva de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

WMI no implementa esta clase. Para las clases derivadas de **CIM \_ CoolingDevice**, vea [Clases win32](win32-provider.md).
