---
description: La clase WMI IDEController de Win32 administra las funcionalidades de un dispositivo de controlador de \_ electrónica de dispositivos integrados (IDE).
...
ms.locfileid: "127070189"
---
# <a name="win32_idecontroller-class"></a>Clase IDEController de Win32 \_

La clase WMI **\_ IDEController** [de](/windows/desktop/WmiSdk/retrieving-a-class) Win32 administra las funcionalidades de un dispositivo de controlador de electrónica de dispositivos integrados (IDE).
...
La **clase \_ IDEController de Win32** tiene estos tipos de miembros:
...
La **clase \_ IDEController de Win32** tiene estos métodos.
...
La **clase \_ IDEController de Win32** tiene estas propiedades.
...
Identificador único del controlador IDE con otros dispositivos del sistema.
...
Más información sobre el error registrado en **la propiedad LastErrorCode** e información sobre las acciones correctivas que se pueden realizar.
...
Fabricante del dispositivo del controlador IDE.
...
Si **es TRUE,** el dispositivo se puede administrar mediante energía en modo de suspensión, y así sucesivamente. La propiedad no indica que las características de administración de energía están habilitadas actualmente, solo que el dispositivo lógico es capaz de la administración de energía.
...
La **clase \_ IDEController de Win32** se deriva del [**controlador CIM \_**](cim-controller.md).
