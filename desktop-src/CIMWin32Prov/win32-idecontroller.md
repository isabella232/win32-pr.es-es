...
---
# <a name="win32_idecontroller-class"></a>\_Clase Win32 IDEController

La [clase WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ IDEController de Win32** administra las capacidades de un dispositivo de controlador de electrónica integrada de dispositivos (IDE).
...
La clase **Win32 \_ IDEController** tiene estos métodos.
...
Identificador único de la controladora IDE con otros dispositivos del sistema.
...
Si **es true**, el dispositivo puede administrarse con energía en modo de suspensión, etc. La propiedad no indica que las características de administración de energía están habilitadas actualmente, solo que el dispositivo lógico es capaz de administrar energía.
...
La **clase \_ IDEController de Win32** se deriva [**del \_ controlador CIM**](cim-controller.md).
