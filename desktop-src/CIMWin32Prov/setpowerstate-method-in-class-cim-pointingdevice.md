---
description: El método SetPowerState de la clase CIM PointingDevice establece el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo \_ en ese estado.
ms.assetid: 5ecb3f3a-76b2-4170-8583-b9a53ee23cdf
ms.tgt_platform: multiple
title: Método SetPowerState de la CIM_PointingDevice clase
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
