---
description: La clase de ventilador CIM \_ representa las funciones y la administración de un dispositivo de refrigeración de ventilador.
...
ms.locfileid: "119923875"
---
# <a name="cim_fan-class"></a>Cim \_ Fan (clase)

La **clase de \_ ventilador CIM** representa las funciones y la administración de un dispositivo de refrigeración de ventilador.
...
La **clase \_ Cim Fan** tiene estos tipos de miembros:
...
La **clase \_ Cim Fan** tiene estos métodos.



| Método                                                         | Descripción                                                                                                                              |
|:---------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Restablecer**](reset-method-in-class-cim-fan.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-fan.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo se debe colocar un dispositivo en ese estado. No implementado por WMI.<br/> |
| [**SetSpeed**](setspeed-method-in-class-cim-fan.md)           | Establece la velocidad del ventilador. No implementado por WMI.<br/>                                                                                   |
...
La **clase \_ Cim Fan** tiene estas propiedades.
...
Velocidad solicitada del ventilador, definida en revoluciones por minuto, cuando se admite un ventilador de velocidad variable. La velocidad actual viene determinada por un sensor [**\_ (Tachometer CIM)**](cim-tachometer.md)que está asociado al ventilador mediante la [**relación \_ AssociatedSensor de CIM.**](cim-associatedsensor.md)
...
La **clase de \_ ventilador CIM** se deriva de [**CIM \_ CoolingDevice**](cim-coolingdevice.md).

WMI no implementa esta clase. Para las clases derivadas del **\_ ventilador CIM,** vea [Clases win32.](win32-provider.md)
