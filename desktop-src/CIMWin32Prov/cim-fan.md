...
---
# <a name="cim_fan-class"></a>\_Clase de ventilador CIM

La clase del **\_ ventilador CIM** representa las capacidades y la administración de un dispositivo de refrigeración de ventilador.
...
La clase del **\_ ventilador CIM** tiene estos tipos de miembros:
...
La clase del **\_ ventilador CIM** tiene estos métodos.



| Método                                                         | Descripción                                                                                                                              |
|:---------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-fan.md)                 | Solicita un restablecimiento del dispositivo lógico. No implementado por WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-fan.md) | Define el estado de energía deseado para un dispositivo lógico y cuándo debe colocarse un dispositivo en ese estado. No implementado por WMI.<br/> |
...
La clase del **\_ ventilador CIM** tiene estas propiedades.
...
Velocidad de ventilador solicitada, definida en revoluciones por minuto, cuando se admite un ventilador de velocidad variable. La velocidad actual está determinada por un sensor ([**\_ tacómetro CIM**](cim-tachometer.md)) que está asociado con el ventilador mediante la [**relación \_ AssociatedSensor de CIM**](cim-associatedsensor.md) .
...
La clase del **\_ ventilador CIM** se deriva [**de \_ CoolingDevice CIM**](cim-coolingdevice.md).
