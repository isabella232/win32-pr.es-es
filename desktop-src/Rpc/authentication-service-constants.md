...
| <span id="RPC_C_AUTHN_DEC_PUBLIC"></span><span id="rpc_c_authn_dec_public"></span><dl> <dt>**RPC \_ C \_ AUTHN \_ DEC \_ PUBLIC**</dt> <dt>4</dt> </dl>           | Autenticación de clave pública DEC (reservada para uso futuro).<br/>                                                                                                                  |
...
| <span id="RPC_C_AUTHN_GSS_SCHANNEL"></span><span id="rpc_c_authn_gss_schannel"></span><dl> <dt>**RPC \_ C \_ AUTHN \_ GSS \_ SCHANNEL**</dt> <dt>14</dt> </dl>    | Use [el SSP de Schannel.](/windows/desktop/SecAuthN/secure-channel) Este SSP admite Capa de sockets seguros (SSL), tecnología de comunicación privada (PCT) y seguridad de nivel de transporte (TLS).<br/> |
...
| <span id="RPC_C_AUTHN_DPA"></span><span id="rpc_c_authn_dpa"></span><dl> <dt>**RPC \_ C \_ AUTHN \_ DPA**</dt> <dt>17</dt> </dl>                                | Use la autenticación de contraseña distribuida (DPA).<br/>                                                                                                                            |
...
Especifique RPC C AUTHN NONE para desactivar la autenticación \_ para las llamadas a procedimiento remoto \_ \_ realizadas a través de un identificador de enlace. Cuando se especifica RPC C AUTHN DEFAULT, la biblioteca en tiempo de ejecución rpc usa el servicio de autenticación WINNT rpc \_ \_ C \_ \_ \_ AUTHN para las llamadas a procedimiento remoto realizadas mediante el identificador \_ de enlace.
