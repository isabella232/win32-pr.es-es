...
El compilador MIDL no acepta los punteros únicos o completos que están fuera de \[ [](/windows/desktop/Midl/out-idl) \] .only. Estas especificaciones hacen que el compilador MIDL genere un mensaje de error.
