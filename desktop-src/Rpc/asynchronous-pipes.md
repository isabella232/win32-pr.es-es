...
A diferencia de las canalizaciones convencionales (sincrónicas), donde el servidor controla todos los detalles de envío y recepción de datos de canalización, las canalizaciones asincrónicas son simétricas. Es decir, tanto el cliente como el servidor pueden insertar y extraer datos a través de la canalización.

> [!Note]  
> Los parámetros de canalización solo se pueden pasar por referencia. Incluso si el archivo [](/windows/desktop/Midl/pipe) IDL muestra los parámetros de canalización que se pasan por valor, los códigos auxiliares generados solo aceptarán parámetros de canalización por referencia.
