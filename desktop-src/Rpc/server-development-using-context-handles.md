...
description: Desde la perspectiva del desarrollo de programas de servidor, un identificador de contexto es un puntero sin tipo. Los programas de servidor inicializan identificadores de contexto señalando los datos en memoria o en algún otro tipo de almacenamiento (por ejemplo, archivos en discos).
