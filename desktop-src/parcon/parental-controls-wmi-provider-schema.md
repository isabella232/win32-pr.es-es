---
description: El proveedor WMI de controles parentales es una instancia y un proveedor de métodos. El archivo Wpcsprov. mof controla la creación de instancias de nuevas instancias de clase, la lectura o modificación de las propiedades de instancia existentes y la invocación de métodos.
ms.assetid: 28d46969-448e-4a67-bfb3-4240b5cebe57
title: Esquema del proveedor WMI de controles parentales
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104497987"
---
# <a name="parental-controls-wmi-provider-schema"></a><span data-ttu-id="26548-104">Esquema del proveedor WMI de controles parentales</span><span class="sxs-lookup"><span data-stu-id="26548-104">Parental Controls WMI Provider Schema</span></span>

<span data-ttu-id="26548-105">El proveedor WMI de controles parentales es una instancia y un proveedor de métodos.</span><span class="sxs-lookup"><span data-stu-id="26548-105">The Parental Controls WMI Provider is an instance and method provider.</span></span> <span data-ttu-id="26548-106">El archivo Wpcsprov. mof controla la creación de instancias de nuevas instancias de clase, la lectura o modificación de las propiedades de instancia existentes y la invocación de métodos.</span><span class="sxs-lookup"><span data-stu-id="26548-106">Instantiation of new class instances, reading or modification of existing instance properties, and invocation of methods is controlled by the Wpcsprov.mof file.</span></span>

<span data-ttu-id="26548-107">La siguiente sintaxis es de namespace. mof</span><span class="sxs-lookup"><span data-stu-id="26548-107">The following syntax is from Namespace.mof</span></span>
...
<span data-ttu-id="26548-108">La siguiente sintaxis proviene de ratings. mof</span><span class="sxs-lookup"><span data-stu-id="26548-108">The following syntax is from Ratings.mof</span></span>
...
<span data-ttu-id="26548-109">La sintaxis siguiente es de WpcSettings. mof</span><span class="sxs-lookup"><span data-stu-id="26548-109">The following syntax is from WpcSettings.mof</span></span>
...
<span data-ttu-id="26548-110">La sintaxis siguiente es de WpcProvider. mof</span><span class="sxs-lookup"><span data-stu-id="26548-110">The following syntax is from WpcProvider.mof</span></span>
