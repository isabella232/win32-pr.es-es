...
Es importante tener una comprensión básica del protocolo HTTP para usar cualquiera de las interfaces.
...
> [!IMPORTANT]
> La descarga de WinHTTP 5.0 ya no está disponible. A partir del 1 de octubre de 2004, Microsoft quitó la descarga del SDK de WinHTTP 5.0 de MSDN y finalizó el soporte técnico para la versión 5.0.
