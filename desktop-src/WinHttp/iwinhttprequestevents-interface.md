---
description: Proporciona eventos para Microsoft Windows HTTP Services (WinHTTP).
...
ms.locfileid: "117744353"
---
# <a name="iwinhttprequestevents-interface"></a>Interfaz IWinHttpRequestEvents

La **interfaz IWinHttpRequestEvents** proporciona eventos para [Microsoft Windows HTTP Services (WinHTTP).](about-winhttp.md) Solo usa métodos de evento.
...
Las notificaciones se pueden finalizar llamando [a Unadvise en](/windows/win32/api/ocidl/nf-ocidl-iconnectionpoint-unadvise) el punto de conexión devuelto en el paso 2.
