...
ms.locfileid: "127070473"
---
# <a name="iwinhttprequestsetclientcertificate-method"></a>IWinHttpRequest::SetClientCertificate (método)

El **método SetClientCertificate** selecciona un certificado de cliente para enviarlo a un servidor https (Protocolo de transferencia de hipertexto seguro).
...
Microsoft Windows SERVICIOS HTTP (WinHTTP) no proporciona certificados de cliente a los servidores proxy que solicitan certificados para la autenticación.
...
En el ejemplo de scripting siguiente se muestra cómo seleccionar un certificado de cliente que se va a enviar con una solicitud. Se elige un certificado con el asunto "Mi Middle-Tier certificado" del almacén de certificados "Personal" en el Registro en **HKEY \_ LOCAL \_ MACHINE**. Dado que este ejemplo de código es específico de Microsoft JScript, que usa la barra diagonal inversa como carácter de escape, se necesitan dos barras diagonales inversas adyacentes para delimitar los componentes de la cadena de certificado.
