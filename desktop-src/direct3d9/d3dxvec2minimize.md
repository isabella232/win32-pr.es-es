...
---
# <a name="d3dxvec2minimize-function"></a>D3DXVec2Minimize función)

Devuelve un vector 2D formado por los componentes más pequeños de dos vectores 2D.
...
Puntero a una estructura [**D3DXVECTOR2**](d3dxvector2.md) que se compone de los componentes más pequeños de los dos vectores.

## <a name="remarks"></a>Observaciones

El valor devuelto para esta función es el mismo valor que se devuelve en el parámetro *pOut* . De esta manera, la función **D3DXVec2Minimize** se puede usar como parámetro de otra función.
