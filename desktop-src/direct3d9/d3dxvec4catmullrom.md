...
Realiza una interpolación Catmull-Rom, utilizando los vectores 4D especificados.
...
Puntero a una estructura [**D3DXVECTOR4**](d3dxvector4.md) que es el resultado de la interpolación Catmull-Rom.
