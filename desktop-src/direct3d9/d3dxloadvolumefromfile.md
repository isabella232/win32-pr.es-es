...
---
# <a name="d3dxloadvolumefromfile-function"></a>D3DXLoadVolumeFromFile función)
...
La configuración del compilador también determina la versión de la función. Si se define Unicode, la llamada de función se resuelve como D3DXLoadVolumeFromFileW. De lo contrario, la llamada de función se resuelve como D3DXLoadVolumeFromFileA porque se usan cadenas ANSI.
