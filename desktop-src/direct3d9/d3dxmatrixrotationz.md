...
Ángulo de rotación, en radianes. Los ángulos se miden en el sentido de las agujas del reloj cuando se ven desde el eje de giro (lado positivo) hacia el origen.
...
El valor devuelto para esta función es el mismo valor que se devuelve en el parámetro *pOut* . De esta manera, la función **D3DXMatrixRotationZ** se puede usar como parámetro de otra función.
