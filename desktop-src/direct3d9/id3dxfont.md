...
| [**GetDC**](id3dxfont--getdc.md)                         | Devuelve un identificador para un contexto de dispositivo de pantalla (DC) que tiene el conjunto de fuentes.<br/>                                                                                                                                                           |
...
| [**GetDevice**](id3dxfont--getdevice.md)                 | Recupera el dispositivo Direct3D asociado al objeto Font.<br/>                                                                                                                                                                     |
| [**GetGlyphData**](id3dxfont--getglyphdata.md)           | Devuelve información sobre la posición y la orientación de un glifo en una celda de carácter.<br/>                                                                                                                                            |
...
| [**OnLostDevice**](id3dxfont--onlostdevice.md)           | Utilice este método para liberar todas las referencias a los recursos de memoria de vídeo y eliminar todos los stateblocks. Se debe llamar a este método cada vez que se pierde un dispositivo o antes de restablecer un dispositivo.<br/>                                              |
