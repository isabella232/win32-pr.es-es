...
La configuración del compilador también determina la versión de la función. Si se define Unicode, la llamada a la función se resuelve en D3DXCreateTextureFromResourceExW. De lo contrario, la llamada de función se resuelve en D3DXCreateTextureFromResourceExA porque se usan cadenas ANSI.
