...
Este método calcula lo normal mediante la diferencia central con un tamaño de kernel de 3x3. El denominador de diferenciación central usado es 2.0. Los canales RGB del destino contienen componentes sesgados (x, y,z) de lo normal.
