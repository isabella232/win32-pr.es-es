...
---
# <a name="d3dxmatrixtranspose-function-d3dx9mathh"></a>Función D3DXMatrixTranspose (D3dx9math.h)
...
Puntero a la [**estructura D3DXMATRIX**](d3dxmatrix.md) que es la transpuesta de matriz de la matriz.
