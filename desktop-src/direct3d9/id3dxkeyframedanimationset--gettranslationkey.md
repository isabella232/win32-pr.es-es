...
---
# <a name="id3dxkeyframedanimationsetgettranslationkey-method"></a>ID3DXKeyframedAnimationSet:: GetTranslationKey (método)

Obtiene la información de traducción de un fotograma clave específico en el conjunto de animaciones.
