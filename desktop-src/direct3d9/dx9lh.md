...
Descubra las nuevas características gráficas de DirectX Windows Vista en una de estas secciones:
...
Hay algunas restricciones para el uso de recursos compartidos. Estos incluyen las siguientes:
...
Ahora puede comprobar si el dispositivo puede convertir los datos de canalización a sRGB antes de combinar el búfer de fotogramas. Esto implica que el dispositivo convierte los valores de destino de representación de sRGB. Para ver si el hardware admite la conversión, compruebe este límite:
...
Debe hacer dos cosas para crear esta textura:
