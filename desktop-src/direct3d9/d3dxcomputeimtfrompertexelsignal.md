---
description: Calcule las IMT por triángulo a partir de datos por textura. Esta función es similar a D3DXComputeIMTFromTexture, pero usa una matriz float para pasar los datos y puede calcular valores dimensionales mayores que 4.
...
ms.locfileid: "127569344"
---
# <a name="d3dxcomputeimtfrompertexelsignal-function"></a>Función D3DXComputeIMTFromPerTexelSignal

Calcule las IMT por triángulo a partir de datos por textura. Esta función es similar a [**D3DXComputeIMTFromTexture,**](d3dxcomputeimtfromtexture.md)pero usa una matriz float para pasar los datos y puede calcular valores dimensionales superiores a 4.
