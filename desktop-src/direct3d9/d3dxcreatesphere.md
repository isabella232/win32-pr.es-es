...
---
# <a name="d3dxcreatesphere-function"></a>D3DXCreateSphere función)

Utiliza un sistema de coordenadas de la mano izquierda para crear una malla que contenga una esfera.
...
Radio de la esfera. Este valor debe ser mayor o igual que 0,0 f.
