---
description: Esta sección contiene información de referencia de las interfaces COM que se usan para leer y escribir desde archivos. x.
ms.assetid: 54d8a02b-5376-49ac-a0d5-fc3cd8ab82e6
title: Interfaces de archivo de D3DX X
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105714705"
---
# <a name="d3dx-x-file-interfaces"></a>Interfaces de archivo de D3DX X

Esta sección contiene información de referencia de las interfaces COM que se usan para leer y escribir desde archivos. x.
