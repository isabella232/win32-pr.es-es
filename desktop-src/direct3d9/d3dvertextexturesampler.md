---
description: Constantes del muestreador de textura de vértices.
...
ms.locfileid: "127566660"
---
# <a name="d3dvertextexturesampler"></a>D3DVERTEXTEXTURESAMPLER

Constantes del muestreador de textura de vértices.

Estas constantes identifican los muestreadores de textura utilizados por los sombreadores de vértices.
...
Se trata de una constante interna que usa el muestreador de textura en el teselador.



| \#Definir       | Descripción                                           |
|----------------|-------------------------------------------------------|
| D3DDMAPSAMPLER | 256, que es el número máximo de muestreadores de textura. |
