...
Puntero a la estructura [**D3DXPLANE**](d3dxplane.md) de entrada, que contiene el plano que se va a transformar. El vector (a, b, c) que describe el plano debe normalizarse antes de que se llame a esta función. Vea el ejemplo.
...
Puntero a la estructura [**D3DXMATRIX**](d3dxmatrix.md) de origen, que contiene los valores de la transformación. Esta matriz debe contener la transposición inversa de los valores de transformación.
