...
Realiza una interpolación spline Hermite con los vectores 2D especificados.
...
Puntero a una estructura [**D3DXVECTOR2**](d3dxvector2.md) de origen, un vector de posición.
...
Puntero a una estructura [**D3DXVECTOR2**](d3dxvector2.md) de origen, un vector tangente.
...
Puntero a una estructura [**D3DXVECTOR2**](d3dxvector2.md) que es el resultado de la interpolación de la spline de Hermite.

## <a name="remarks"></a>Observaciones

La función **D3DXVec2Hermite** se interpola desde (positiona, tangenta) hasta (PositionB, tangentB) mediante la interpolación de spline de Hermite.
...
El valor devuelto para esta función es el mismo valor que se devuelve en el parámetro pOut. De esta manera, la función **D3DXVec2Hermite** se puede usar como parámetro de otra función.
