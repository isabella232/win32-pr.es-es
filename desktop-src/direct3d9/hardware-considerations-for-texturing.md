...
Muchas tarjetas de aceleración 3D no admiten valores iterados difusos como argumentos para combinar unidades. Sin embargo, la aplicación puede introducir datos de color iterados cuando realiza la combinación de texturas.
