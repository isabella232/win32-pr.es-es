...
![ilustración de una dirección de textura como números de columna y fila](images/uvcoordinates.jpg)
...
Un código de formato de vértice flexible (FVF) puede definir hasta ocho conjuntos de coordenadas de textura. El usuario utiliza los datos de las coordenadas de textura en los datos del vértice. Se hace referencia a los datos con un índice de base cero: 0 - 7. Hay hasta ocho fases de mezcla de textura. Una textura está asociada a una fase determinada mediante SetTexture( stageIndex, pTexture).
