...
Puntero a una estructura de [**D3DXVECTOR3**](d3dxvector3.md) de origen, que define un punto de inicio de línea.
...
Puntero a una estructura [**D3DXVECTOR3**](d3dxvector3.md) de origen que define un punto final de línea.
