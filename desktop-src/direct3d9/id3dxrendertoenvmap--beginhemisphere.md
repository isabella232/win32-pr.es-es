...
---
# <a name="id3dxrendertoenvmapbeginhemisphere-method"></a>ID3DXRenderToEnvMap:: BeginHemisphere (método)

Inicie la representación de un mapa de entorno de Hemispheric.
