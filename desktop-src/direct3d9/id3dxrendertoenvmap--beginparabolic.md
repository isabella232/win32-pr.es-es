...
---
# <a name="id3dxrendertoenvmapbeginparabolic-method"></a>ID3DXRenderToEnvMap:: BeginParabolic (método)

Inicie la representación de un mapa de entorno de parabólica.
...
Si la función se ejecuta correctamente, el valor devuelto es D3D \_ OK. Si se produce un error en la función, el valor devuelto puede ser uno de los siguientes: D3DERR \_ INVALIDCALL. E \_ FAIL
