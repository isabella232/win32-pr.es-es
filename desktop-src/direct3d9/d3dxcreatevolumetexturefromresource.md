...
ms.locfileid: "120119235"
---
# <a name="d3dxcreatevolumetexturefromresource-function"></a>Función D3DXCreateVolumeTextureFromResource
...
La configuración del compilador también determina la versión de la función. Si se define Unicode, la llamada a la función se resuelve en D3DXCreateVolumeTextureFromResourceW. De lo contrario, la llamada de función se resuelve en D3DXCreateVolumeTextureFromResourceA porque se usan cadenas ANSI.

La función es equivalente a D3DXCreateVolumeTextureFromResourceEx(pDevice, hSrcModule, pSrcResource, \_ D3DX DEFAULT, D3DX \_ \_ DEFAULT, D3DX DEFAULT, D3DX \_ DEFAULT, 0, D3DFMT \_ UNKNOWN, D3DPOOL \_ MANAGED, D3DX \_ DEFAULT, D3DX \_ DEFAULT, 0, **NULL,** **NULL,** ppVolumeTexture).
