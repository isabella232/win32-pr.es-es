...
---
# <a name="d3dxvec2scale-function"></a>D3DXVec2Scale función)
...
El valor devuelto para esta función es el mismo valor que se devuelve en el parámetro *pOut* . De esta manera, la función **D3DXVec2Scale** se puede usar como parámetro de otra función.
