---
description: Puede almacenar cualquier tipo de datos específicos de la aplicación con una superficie. Por ejemplo, una superficie que representa un mapa en un juego puede contener información sobre el terreno.
ms.assetid: a66fe0b9-1ccd-4cbd-a3e7-78081047e378
title: Datos de surface privados (Direct3D 9)
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="private-surface-data-direct3d-9"></a>Datos de surface privados (Direct3D 9)

Puede almacenar cualquier tipo de datos específicos de la aplicación con una superficie. Por ejemplo, una superficie que representa un mapa en un juego puede contener información sobre el terreno.
...
SetPrivateData asigna un búfer interno para los datos y lo copia. A continuación, puede liberar de forma segura el búfer u objeto de origen. La referencia de búfer o interfaz interna se libera cuando se llama a FreePrivateData. Esto sucede automáticamente cuando se libera la superficie.
