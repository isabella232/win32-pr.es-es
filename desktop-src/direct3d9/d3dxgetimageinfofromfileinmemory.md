...
---
# <a name="d3dxgetimageinfofromfileinmemory-function"></a>D3DXGetImageInfoFromFileInMemory función)

Recupera información sobre un archivo de imagen determinado en la memoria.
...
Puntero VOID al archivo de código fuente en la memoria.
