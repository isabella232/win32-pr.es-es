---
description: En esta sección se describen los tipos enumerados de Direct3D.
...
-   
    ...
    |                                                                                                                                                                                |
    |--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Diferencias entre Direct3D 9 y Direct3D 9Ex:<br/> Esta enumeración solo está disponible en Direct3D 9Ex.<br/>[**D3DCOMPOSERECTSOP**](./d3dcomposerectsop.md) |
...
-   
    ...
    |                                                                                                                                                                                  |
    |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Diferencias entre Direct3D 9 y Direct3D 9Ex:<br/> Esta enumeración solo está disponible en Direct3D 9Ex.<br/>[**D3DDISPLAYROTATION**](./d3ddisplayrotation.md) |
...
-   
    ...
    |                                                                                                                                                                                    |
    |------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Diferencias entre Direct3D 9 y Direct3D 9Ex:<br/> Esta enumeración solo está disponible en Direct3D 9Ex.<br/>[**D3DSCANLINEORDERING**](./d3dscanlineordering.md) |
