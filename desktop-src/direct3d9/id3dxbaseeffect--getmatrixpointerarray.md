...
---
# <a name="id3dxbaseeffectgetmatrixpointerarray-method"></a>ID3DXBaseEffect:: GetMatrixPointerArray (método)

Obtiene una matriz de punteros a matrices de nontransposed.
