...
---
# <a name="wsmansessionflagutf8-method"></a>WSMan. SessionFlagUTF8 (método)
...
**WSManFlagUTF8** es una constante de la enumeración **\_ \_ WSManSessionFlags** . Para obtener más información, vea [otras constantes de sesión](other-session-constants.md).
