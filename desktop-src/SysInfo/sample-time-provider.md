---
description: En el ejemplo siguiente se muestra cómo estructurar un proveedor de hora. En este ejemplo, el archivo DLL admite dos proveedores de tiempo de hardware.
ms.assetid: 6be08c49-be68-4b75-b740-fc1d5a2ff592
title: Proveedor de tiempo de ejemplo
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104546203"
---
# <a name="sample-time-provider"></a><span data-ttu-id="337d4-104">Proveedor de tiempo de ejemplo</span><span class="sxs-lookup"><span data-stu-id="337d4-104">Sample Time Provider</span></span>

<span data-ttu-id="337d4-105">En el ejemplo siguiente se muestra cómo estructurar un proveedor de hora.</span><span class="sxs-lookup"><span data-stu-id="337d4-105">The following example demonstrates how to structure a time provider.</span></span> <span data-ttu-id="337d4-106">En este ejemplo, el archivo DLL admite dos proveedores de tiempo de hardware.</span><span class="sxs-lookup"><span data-stu-id="337d4-106">In this example, the DLL supports two hardware time providers.</span></span>
