...
---
# <a name="getting-hardware-information"></a>Obtención de información de hardware

En el ejemplo siguiente se usa la función [**GetSystemInfo**](/windows/win32/api/sysinfoapi/nf-sysinfoapi-getsysteminfo) para obtener información de hardware, como el identificador de OEM, el tipo de procesador, el tamaño de página, etc. En el ejemplo se muestra la información en la consola de.
