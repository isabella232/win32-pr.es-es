---
description: Notificaciones de ventana
...
-   [**COMPACTACIÓN \_ DE WM**](wm-compacting.md)
-   [**WM \_ CREATE**](wm-create.md)
-   [**WM \_ DESTROY**](wm-destroy.md)
-   [**WM \_ PPPCHANGED**](../hidpi/wm-dpichanged.md)
...
-   [**WM \_ QUERYDRAMÁTICAN**](wm-querydragicon.md)
...
-   [**VENTANA \_ WMPOSCHANGING**](wm-windowposchanging.md)
