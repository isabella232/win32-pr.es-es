...
description: El sistema llama a esta función cada vez que un nuevo evento de entrada de teclado está a punto de publicarse en una cola de entrada de subproceso.
old-location: ''
ms.assetid: na
ms.date: 04/05/2019
ms.keywords: ''
...
El sistema llama a esta función cada vez que un nuevo evento de entrada de teclado está a punto de publicarse en una cola de entrada de subproceso.
...
Una aplicación instala el procedimiento de  enlace especificando el tipo de enlace WH_KEYBOARD_LL y un puntero al procedimiento de enlace en una llamada a la función **SetWindowsHookEx.**
...
La entrada de teclado puede procede del controlador de teclado local o de las llamadas a [keybd_event](/windows/desktop/api/winuser/nf-winuser-keybd_event) función.
Si la entrada procede de una llamada a **keybd_event**, la entrada se "inyectó".
Sin embargo, el WH_KEYBOARD_LL enlace no se inserta en otro proceso.
...
Sin embargo, Windows 7 y versiones posteriores, el enlace se quita en modo silencioso sin que se llame a .
...
Si la aplicación debe usar enlaces de bajo nivel, debe ejecutar los enlaces en un subproceso dedicado que pase el trabajo a un subproceso de trabajo y, a continuación, devuelva inmediatamente.
...
Esto se debe a que la entrada sin formato puede supervisar asincrónicamente los mensajes del mouse y el teclado destinados a otros subprocesos de forma más eficaz de lo que pueden hacer los enlaces de bajo nivel.
