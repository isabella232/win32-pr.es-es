...
ms.locfileid: "127466733"
---
# <a name="multiple-document-interface"></a>Interfaz de varios documentos

\[A muchos usuarios nuevos e intermedios les resulta difícil aprender a usar aplicaciones MDI. Por lo tanto, debe considerar otros modelos para la interfaz de usuario. Sin embargo, puede usar MDI para aplicaciones que no se ajustan fácilmente a un modelo existente.\]
...
| Nombre                                            | Descripción                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|-------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**WM \_ MDIACTIVATE**](wm-mdiactivate.md)       | Se envía a una ventana de cliente MDI para indicar a la ventana de cliente que active otra ventana secundaria MDI. <br/>                                                                                                                                                                                                                                                                                                                               |
...
| [**WM \_ MDIICONARRANGE**](wm-mdiiconarrange.md) | Se envía a una ventana de cliente MDI para organizar todas las ventanas secundarias de MDI minimizadas. No afecta a las ventanas secundarias que no se minimizan. <br/>                                                                                                                                                                                                                                                                                                  |
...
| [**WM \_ MDISETMENU**](wm-mdisetmenu.md)         | Se envía a una ventana de cliente MDI para reemplazar todo el menú de una ventana de marco MDI, para reemplazar el menú de ventana de la ventana de marco, o ambos. <br/>                                                                                                                                                                                                                                                                                           |
