...
| [**DisplayProperties**](systemmonitor-displayproperties.md) | Muestra el cuadro **de Graph propiedades.**<br/>                                                                                                                 |
...
| [**Restablecer**](systemmonitor-reset.md)                         | Quita todos los [**objetos CounterItem**](counteritem.md) del **objeto de colección Counters.**<br/>                                                               |
...
| [**Fuente**](systemmonitor-font.md)<br/>                                           | Recupera o establece la fuente utilizada en el control .<br/>                                                                                                                                                                              |
...
| [**LogFiles**](systemmonitor-logfilename.md)<br/>                                | Colección de uno o varios archivos de registro que se usarán como origen de los valores de contador que se muestran en el Monitor de sistema.<br/>                                                                                                                  |
...
| [**LogSourceStopTime**](systemmonitor-logsourcestoptime.md)<br/>                 | Recupera la marca de tiempo del valor del contador más reciente de un contador de la colección de contadores que se registró en los archivos de registro.<br/>                                                                                             |
...
| [**ReportValueType**](systemmonitor-reportvaluetype.md)<br/>                     | Recupera o establece un valor que determina si el gráfico de vistas Histograma e Informe muestra el último valor muestreado durante el intervalo de muestreo o un valor calculado del muestreo, como el valor promedio o mínimo del contador.<br/> |
