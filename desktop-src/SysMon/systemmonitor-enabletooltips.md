...
Recupera o establece un valor que determina si se muestra una información sobre herramientas cuando se mantiene el mouse sobre un contador en una de las vistas del gráfico (no se admite para la vista de informe).
...
True muestra una información sobre herramientas con la información del contador. en caso contrario, false.

## <a name="remarks"></a>Observaciones

En el caso de los gráficos de líneas, la información sobre herramientas está delimitada por el punto de datos más cercano al mouse. En el caso de los gráficos de barras e histogramas, la información sobre herramientas representa el valor de datos total de la barra, no un punto dentro de la barra.
...
Para la actividad en tiempo real, la información sobre herramientas contiene la ruta de acceso del contador, el valor del contador y la marca de tiempo.
