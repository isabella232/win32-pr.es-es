---
description: La segunda línea de una dirección postal.
ms.assetid: 9f53d16e-0b07-4dc9-9fc7-c656fa22e10c
title: Propiedad LocationDisp. DispCivicAddressReport. AddressLine2
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "104278168"
---
# <a name="locationdispdispcivicaddressreportaddressline2-property"></a>Propiedad LocationDisp. DispCivicAddressReport. AddressLine2
...
La segunda línea de una dirección postal.
...
Para obtener un ejemplo de cómo usar esta propiedad, vea [un ejemplo de informe de dirección cívica simple](/uwp/api/Windows.Devices.Geolocation).
