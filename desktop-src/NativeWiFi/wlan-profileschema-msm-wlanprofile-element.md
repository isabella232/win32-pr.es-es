---
description: Contiene varias configuraciones de módulos específicos del medio (MSM).
...
El elemento MSM (WLANProfile) contiene varias configuraciones del módulo específico del medio (MSM).
...
| [**protected**](wlan-profileschema-protected-sharedkey-element.md)                | [boolean](/dotnet/api/system.boolean) | Indica si la clave está cifrada.<br/> Windows XP con SP3 y la API de LAN inalámbrica **para Windows XP con SP2:** Este elemento debe tener un valor false.<br/>                                                                                                                                                                                                                                                 |
...
Para ver los perfiles de ejemplo que usan el **elemento MSM,** vea [Ejemplos de perfil inalámbrico](wireless-profile-samples.md).
...
| Requisito | Valor |
|-------------------------------------|---------------------------------------------------------------------|
| Cliente mínimo compatible<br/> | Windows Vista, Windows XP solo con aplicaciones de escritorio de SP3 \[\]<br/> |
