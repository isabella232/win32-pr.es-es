...
| [**Conectividad**](wlan-profileschema-connectivity-ihv-element.md)                |                                                                   | Contiene la configuración de conectividad relacionada con IHV.<br/> **Windows XP con SP3 e WIRELESS LAN API para Windows XP con SP2:** No se admite este elemento.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| [**IHV**](wlan-profileschema-ihv-wlanprofile-element.md)                          |                                                                   | Contiene la configuración opcional del proveedor de hardware independiente (IHV).<br/> **Windows XP con SP3 e WIRELESS LAN API para Windows XP con SP2:** No se admite este elemento.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| [**keyIndex**](wlan-profileschema-keyindex-security-element.md)                   |                                                                   | Especifica qué índice de clave se debe usar para cifrar el tráfico inalámbrico. Esto solo se usa cuando [**keyType**](wlan-profileschema-keytype-sharedkey-element.md) se establece en "networkKey".<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| [**Nombre**](wlan-profileschema-name-wlanprofile-element.md)                        | [**nameType**](wlan-profileschema-nametype-simpletype.md)        | Nombre del perfil WLAN.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [**Nombre**](wlan-profileschema-name-ssid-element.md)                               |                                                                   | Contiene el SSID de una LAN inalámbrica.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [**nonBroadcast**](wlan-profileschema-nonbroadcast-ssidconfig-element.md)         | [boolean](/dotnet/api/system.boolean) | Indica si la red difunde su SSID.<br/> **Windows XP con SP3 e WIRELESS LAN API para Windows XP con SP2:** No se admite este elemento.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [**OUI**](wlan-profileschema-oui-ouiheader-element.md)                            |                                                                   | Contiene un hexBinary de 3 bytes que identifica la IHV.<br/> **Windows XP con SP3 e WIRELESS LAN API para Windows XP con SP2:** No se admite este elemento.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [**OUIHeader**](wlan-profileschema-ouiheader-ihv-element.md)                      |                                                                   | Identifica el IHV.<br/> **Windows XP con SP3 e WIRELESS LAN API para Windows XP con SP2:** No se admite este elemento.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| [**type**](wlan-profileschema-type-ouiheader-element.md)                          |                                                                   | Contiene un **hexBinary** de 1 byte que se usa para diferenciar las NIC por el mismo IHV.<br/> **Windows XP con SP3 y la API de LAN inalámbrica para Windows XP con SP2:** No se admite este elemento.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
Para ver perfiles de ejemplo, consulte [Ejemplos de perfil inalámbrico.](wireless-profile-samples.md)
