...
Lista de identificadores únicos de la organización (OUI) asignados por IEEE.
...
|---------|------|---------------------------------------------------------------------------|
| OUI     |      | Un único OUI, con el formato de un número hexadecimal de tamaño variable.<br/> |
