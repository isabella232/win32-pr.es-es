---
title: Esquema de WinSAT
description: Puede usar el esquema de la herramienta de evaluación del sistema de Windows (WinSAT) para determinar las consultas XPath válidas que se deben ejecutar.
...
ms.locfileid: "103903289"
---
# <a name="winsat-schema"></a><span data-ttu-id="eeb7e-103">Esquema de WinSAT</span><span class="sxs-lookup"><span data-stu-id="eeb7e-103">WinSAT Schema</span></span>

<span data-ttu-id="eeb7e-104">\[Las enumeraciones de WinSAT pueden modificarse o no estar disponibles para las versiones después de Windows 8.1.\]</span><span class="sxs-lookup"><span data-stu-id="eeb7e-104">\[WinSAT enumerations may be altered or unavailable for releases after Windows 8.1.\]</span></span>

<span data-ttu-id="eeb7e-105">Puede usar el esquema de la herramienta de evaluación del sistema de Windows (WinSAT) para determinar las consultas XPath válidas que se deben ejecutar.</span><span class="sxs-lookup"><span data-stu-id="eeb7e-105">You can use the Windows System Assessment Tool (WinSAT) schema to determine valid XPath queries to run.</span></span> <span data-ttu-id="eeb7e-106">Para ejecutar una consulta XPath, vea uno de los métodos siguientes:</span><span class="sxs-lookup"><span data-stu-id="eeb7e-106">To run an XPath query, see one of the following methods:</span></span>

-   [<span data-ttu-id="eeb7e-107">**IQueryAllWinSATAssessments:: get \_ AllXML**</span><span class="sxs-lookup"><span data-stu-id="eeb7e-107">**IQueryAllWinSATAssessments::get\_AllXML**</span></span>](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml)
-   [<span data-ttu-id="eeb7e-108">**IQueryRecentWinSATAssessment:: get \_ XML**</span><span class="sxs-lookup"><span data-stu-id="eeb7e-108">**IQueryRecentWinSATAssessment::get\_XML**</span></span>](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryrecentwinsatassessment-get_xml)

<span data-ttu-id="eeb7e-109">El elemento **WinSAT** puede tener un elemento **WinsatAssessments** como elemento primario cuando se llama al método [**Get \_ AllXML**](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml) .</span><span class="sxs-lookup"><span data-stu-id="eeb7e-109">The **WinSAT** element can have a **WinsatAssessments** element as a parent element when you call the [**get\_AllXML**](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml) method.</span></span>

<span data-ttu-id="eeb7e-110">El siguiente es el esquema de WinSAT que puede usar para determinar el XPath.</span><span class="sxs-lookup"><span data-stu-id="eeb7e-110">The following is the WinSAT schema that you can use to determine the XPath.</span></span>
