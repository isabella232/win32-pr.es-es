...
## <a name="cleanup-the-http-server-api"></a>Limpieza de la API del servidor HTTP
...
## <a name="receive-a-request"></a>Recibir una solicitud
...
## <a name="send-an-http-response"></a>Enviar una respuesta HTTP
...
## <a name="send-an-http-post-response"></a>Enviar una respuesta HTTP POST
