...
<br/> La <strong>CM_Add_Empty_Log_Conf_Ex</strong> crea una configuración lógica vacía <a href="/windows-hardware/drivers/kernel/hardware-resources">para</a>un tipo de configuración especificado y una instancia de dispositivo especificada, en el equipo local o remoto.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_add_idw"><strong>CM_Add_ID</strong></a><br/></td>
<td>La <strong>CM_Add_ID</strong> agrega un identificador de dispositivo <a href="/windows-hardware/drivers/install/device-ids">especificado</a> (si aún no está presente) <a href="/windows-hardware/drivers/">a</a> la lista de identificadores de <a href="/windows-hardware/drivers/install/hardware-ids">hardware</a> o a la lista <a href="/windows-hardware/drivers/install/compatible-ids">de identificadores compatibles</a> de una instancia de dispositivo.<br/></td>
</tr>
<tr class="odd">
...
<td><blockquote>
[!Note]<br />
A partir de Windows 8 y Windows Server 2012 funcionalidad para acceder a máquinas remotas se ha quitado. No se puede acceder a las máquinas remotas cuando se ejecuta en estas versiones de Windows.
</blockquote>
...
<td>La <strong>CM_Delete_Class_Key</strong> elimina la clase de dispositivo instalada <a href="/windows-hardware/drivers/">especificada</a> del sistema.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Delete_DevNode_Key</strong> elimina las claves del Registro accesibles para el usuario especificadas que están asociadas a un dispositivo.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Enumerate_Classes,</strong> cuando se llama repetidamente, enumera las clases de <a href="/windows-hardware/drivers/"></a> dispositivo instaladas del equipo local al proporcionar el GUID de cada clase.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Enumerate_Classes_Ex,</strong> cuando se llama repetidamente, enumera las clases de dispositivo instaladas de un equipo local o <a href="/windows-hardware/drivers/">remoto,</a>al proporcionar el GUID de cada clase.<br/></td>
</tr>
<tr class="odd">
...
<td>La <strong>CM_Enumerate_Enumerators</strong> enumera los enumeradores de dispositivo de la máquina local al proporcionar el nombre de cada enumerador.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Enumerate_Enumerators_Ex</strong> enumera los enumeradores de dispositivo de un equipo local o remoto, al proporcionar el nombre de cada enumerador.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_free_log_conf"><strong>CM_Free_Log_Conf</strong></a><br/></td>
<td>La <strong>CM_Free_Log_Conf</strong> elimina una configuración lógica <a href="/windows-hardware/drivers/kernel/hardware-resources">y</a> todos los descriptores de recursos <a href="/windows-hardware/drivers/">asociados</a> del equipo local.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Free_Log_Conf_Ex</strong> elimina una configuración <a href="/windows-hardware/drivers/kernel/hardware-resources"></a> lógica y todos los descriptores de recursos <a href="/windows-hardware/drivers/">asociados</a> de un equipo local o remoto.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Free_Res_Des_Ex</strong> elimina un <a href="/windows-hardware/drivers/">descriptor de recursos de</a> una configuración <a href="/windows-hardware/drivers/kernel/hardware-resources">lógica</a> en un equipo local o remoto.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Get_Depth_Ex</strong> se usa para obtener la profundidad de un nodo de dispositivo especificado<a href="/windows-hardware/drivers/">(devnode</a>) dentro del árbol de dispositivos de un equipo local o <a href="/windows-hardware/drivers/kernel/device-tree">remoto.</a><br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Get_Device_ID_Ex</strong> recupera el identificador de instancia <a href="/windows-hardware/drivers/install/device-instance-ids">de dispositivo</a> para una instancia de dispositivo <a href="/windows-hardware/drivers/">especificada</a> en un equipo local o remoto.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Get_Device_ID_List_Size_Ex</strong> recupera el tamaño de búfer necesario para contener una lista de los <a href="/windows-hardware/drivers/install/device-instance-ids">IDs</a> de instancia de dispositivo para las instancias de dispositivo de un equipo local o <a href="/windows-hardware/drivers/">remoto.</a><br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_device_id_size"><strong>CM_Get_Device_ID_Size</strong></a><br/></td>
<td>La <strong>CM_Get_Device_ID_Size</strong> recupera el tamaño de búfer necesario para contener un identificador de instancia de <a href="/windows-hardware/drivers/install/device-instance-ids">dispositivo</a> para una instancia <a href="/windows-hardware/drivers/">de</a> dispositivo en el equipo local.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Get_First_Log_Conf_Ex</strong> obtiene la primera <a href="/windows-hardware/drivers/kernel/hardware-resources"></a> configuración lógica asociada a una instancia de <a href="/windows-hardware/drivers/">dispositivo</a> especificada en un equipo local o remoto.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Get_Log_Conf_Priority_Ex</strong> obtiene la prioridad de configuración de una configuración lógica <a href="/windows-hardware/drivers/kernel/hardware-resources">especificada</a> en un equipo local o remoto.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_next_log_conf"><strong>CM_Get_Next_Log_Conf</strong></a><br/></td>
<td>La <strong>CM_Get_Next_Log_Conf</strong> obtiene la siguiente configuración <a href="/windows-hardware/drivers/kernel/hardware-resources">lógica asociada</a> a una instancia de dispositivo <a href="/windows-hardware/drivers/">específica</a> en el equipo local.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Get_Next_Log_Conf_Ex</strong> obtiene la siguiente configuración <a href="/windows-hardware/drivers/kernel/hardware-resources">lógica asociada</a> a una instancia de dispositivo <a href="/windows-hardware/drivers/">específica</a> en un equipo local o remoto.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_next_res_des"><strong>CM_Get_Next_Res_Des</strong></a><br/></td>
<td>La <strong>CM_Get_Next_Res_Des</strong> obtiene un identificador para el <a href="/windows-hardware/drivers/">siguiente descriptor</a>de recursos , de un tipo de recurso especificado, para una configuración <a href="/windows-hardware/drivers/kernel/hardware-resources">lógica</a> en el equipo local.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Get_Res_Des_Data</strong> recupera la información almacenada en un <a href="/windows-hardware/drivers/">descriptor de recursos</a> en la máquina local.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Get_Res_Des_Data_Size</strong> obtiene el tamaño de búfer necesario para contener la información contenida en un descriptor de recursos <a href="/windows-hardware/drivers/">especificado</a> en la máquina local.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Get_Resource_Conflict_Count</strong> obtiene el número de conflictos contenidos en una lista de conflictos de recursos especificada.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Get_Sibling_Ex</strong> obtiene un identificador de instancia de dispositivo al siguiente nodo relacionado de un nodo de dispositivo especificado, en un árbol de dispositivos local o remoto del <a href="/windows-hardware/drivers/kernel/device-tree">equipo.</a><br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>función CM_Get_Version_Ex</strong> devuelve la versión 4.0 de Plug and Play (PnP) Administrador de configuración <a href="/windows-hardware/drivers/">DLL</a> (<em>Cfgmgr32.dll</em>) para una máquina local o remota. <br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Is_Dock_Station_Present_Ex</strong> identifica si una <a href="/windows-hardware/drivers/">estación</a> de acoplamiento está presente en una máquina local o remota.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Is_Version_Available</strong> indica si una máquina local admite una versión especificada de Plug and Play (PnP) Administrador de configuración <a href="/windows-hardware/drivers/">DLL</a> (<em>Cfgmgr32.dll</em>).<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>función CM_Is_Version_Available_Ex</strong> indica si una versión especificada del archivo <a href="/windows-hardware/drivers/">DLL</a> Administrador de configuración de Plug and Play (PNP) (<em>Cfgmgr32.dll</em>) es compatible con una máquina local o remota.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_locate_devnodea"><strong>CM_Locate_DevNode</strong></a><br/></td>
<td>La <strong>CM_Locate_DevNode</strong> obtiene un identificador de instancia de dispositivo para el nodo de dispositivo que está asociado a un identificador de instancia de dispositivo <a href="/windows-hardware/drivers/install/device-instance-ids">especificado</a> en la máquina local.<br/></td>
</tr>
<tr class="even">
...
<br/> La <strong>CM_Locate_DevNode_Ex</strong> obtiene un identificador de instancia de dispositivo para el nodo de dispositivo que está asociado a un identificador de instancia de dispositivo <a href="/windows-hardware/drivers/install/device-instance-ids">especificado,</a>en un equipo local o en un equipo remoto.<br/></td>
</tr>
<tr class="odd">
...
<td>La <strong>CM_Modify_Res_Des</strong> modifica un descriptor de recursos especificado en la máquina local.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Modify_Res_Des_Ex</strong> modifica un descriptor de recursos especificado en una máquina local o remota.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/ne-cfgmgr32-cm_notify_action"><strong>CM_NOTIFY_ACTION</strong></a><br/></td>
<td>Esta enumeración identifica los Plug and Play de eventos de dispositivo.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/ns-cfgmgr32-cm_notify_event_data"><strong>CM_NOTIFY_EVENT_DATA</strong></a><br/></td>
<td>Se trata de una estructura de datos de eventos de notificación de dispositivo.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Open_Class_Key</strong> abre la clave del Registro de la clase de configuración del dispositivo, la clave del Registro de la clase de interfaz de dispositivo o una subclave específica de una clase.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Open_DevNode_Key</strong> abre una clave del Registro para obtener información de configuración específica del dispositivo.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Query_And_Remove_SubTree</strong> comprueba si una instancia de dispositivo y sus elementos secundarios se pueden quitar y, si es así, los quita.<br/></td>
</tr>
<tr class="odd">
...
<br/> La <strong>CM_Query_And_Remove_SubTree_Ex</strong> comprueba si una instancia de dispositivo y sus elementos secundarios se pueden quitar y, si es así, los quita.<br/></td>
</tr>
<tr class="even">
...
<td>La <strong>CM_Query_Resource_Conflict_List</strong> identifica las instancias de dispositivo que tienen requisitos de recursos que entren en conflicto con la descripción del recurso de una instancia de dispositivo especificada.<br/></td>
</tr>
<tr class="odd">
...
<td>La <strong>CM_Setup_DevNode</strong> de dispositivo reinicia una instancia de dispositivo que no se está ejecutando porque hay un problema con la configuración del dispositivo.<br/></td>
</tr>
<tr class="odd">
...
<td>La <strong>CMP_WaitNoPendingInstallEvents</strong> espera hasta que no haya actividades de instalación de dispositivos pendientes para que el administrador de PnP realice.<br/></td>
</tr>
<tr class="even">
