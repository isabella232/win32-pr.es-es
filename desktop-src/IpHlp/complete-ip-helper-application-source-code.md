---
description: A continuación se facilita el código fuente completo de la aplicación auxiliar de IP. Se ha agregado una comprobación de errores adicional al código fuente.
ms.assetid: c0290660-8a18-4d5c-8f0a-df15da1a9167
title: Código fuente completo de la aplicación auxiliar IP
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105653085"
---
# <a name="complete-ip-helper-application-source-code"></a><span data-ttu-id="97c87-104">Código fuente completo de la aplicación auxiliar IP</span><span class="sxs-lookup"><span data-stu-id="97c87-104">Complete IP Helper Application Source Code</span></span>

<span data-ttu-id="97c87-105">A continuación se facilita el código fuente completo de la aplicación auxiliar de IP.</span><span class="sxs-lookup"><span data-stu-id="97c87-105">The following is the complete source code for the IP Helper application.</span></span> <span data-ttu-id="97c87-106">Se ha agregado una comprobación de errores adicional al código fuente.</span><span class="sxs-lookup"><span data-stu-id="97c87-106">Additional error checking has been added to source code.</span></span>
