...
Hay una solución alternativa para esta restricción en el texto en ventanas de doble búfer: cree listas de visualización OpenGL para imágenes de mapa de bits de caracteres y, a continuación, ejecute esas listas para dibujar caracteres. Hay tres pasos principales en este proceso:

1.  Seleccione una fuente para un contexto de dispositivo, estableciendo las propiedades de la fuente según sea necesario.
