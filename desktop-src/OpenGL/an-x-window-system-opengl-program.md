...
---
# <a name="an-x-window-system-opengl-program"></a><span data-ttu-id="4936e-107">Un programa OpenGL del sistema de ventanas X</span><span class="sxs-lookup"><span data-stu-id="4936e-107">An X Window System OpenGL Program</span></span>

<span data-ttu-id="4936e-108">El siguiente programa es un programa OpenGL del sistema de ventana X con el mismo código OpenGL que se usa en AUXEDEMO. Programa de ejemplo de C proporcionado con el SDK de la plataforma de Microsoft.</span><span class="sxs-lookup"><span data-stu-id="4936e-108">The following program is an X Window System OpenGL program with the same OpenGL code used in the AUXEDEMO.C sample program supplied with the Microsoft Platform SDK.</span></span> <span data-ttu-id="4936e-109">Compare este programa con el programa OpenGL de Windows del [programa trasladado a Windows](the-program-ported-to-win32.md).</span><span class="sxs-lookup"><span data-stu-id="4936e-109">Compare this program with the Windows OpenGL program in [The Program Ported to Windows](the-program-ported-to-win32.md).</span></span>
