...
description: Especifica la posición de trama para las operaciones de píxeles. | Función glRasterPos3fv (Gl.h)
ms.assetid: a6bf1823-2652-4e39-806e-ebf5b7aac9f2
keywords:
- Función glRasterPos3fv OpenGL
topic_type:
- apiref
api_name:
- glRasterPos3fv
...
ms.locfileid: "119519905"
---
# <a name="glrasterpos3fv-function"></a>Función glRasterPos3fv
