...
---
# <a name="gltexgend-function"></a>glTexGend función)
...
Los valores de *param* definen un plano de referencia en coordenadas de ojo. La matriz de MODELVIEW que se aplica a ellos no puede ser la misma en vigor cuando se transforman los vértices del polígono. Esta función establece un campo de coordenadas de textura que puede generar líneas de contorno dinámico en el movimiento de objetos.
