...
---
# <a name="glindexsv-function"></a>glIndexsv función)
...
La función **glIndexsv** actualiza el índice de color actual (de un solo valor). Toma un argumento: el nuevo valor para el índice de color actual.
...
La siguiente función recupera información relacionada con **glIndexsv**:
