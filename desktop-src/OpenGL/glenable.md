...
description: Las funciones glEnable y glDisable habilitan o deshabilitan las funcionalidades OpenGL. | Función glEnable (Gl.h)
ms.assetid: cd4590dd-ae41-47c9-9861-10d72318840f
keywords:
- Función glEnable OpenGL
topic_type:
- apiref
api_name:
- glEnable
...
ms.locfileid: "119625635"
---
# <a name="glenable-function"></a>Función glEnable

Las **funciones glEnable** [**y glDisable**](gldisable.md) habilitan o deshabilitan las funcionalidades OpenGL.
...
Las **funciones glEnable** y **glDisable** habilitan y deshabilitan varias funcionalidades de gráficos OpenGL. Use [**glIsEnabled**](glisenabled.md) o [**glGet para**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) determinar la configuración actual de cualquier funcionalidad.

Tanto **glEnable** como **glDisable** toman un solo argumento, *cap*, que puede suponer uno de los valores siguientes:
