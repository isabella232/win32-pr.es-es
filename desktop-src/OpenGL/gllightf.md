...
description: La función glLightf devuelve valores de parámetro de origen de luz.
...
ms.locfileid: "127074036"
---
# <a name="gllightf-function"></a>Función glLightf

La **función glLightf** devuelve valores de parámetro de origen de luz.
...
La **función glLightf** establece el valor o los valores de los parámetros de origen de luz individuales. El *parámetro light* denomina la luz y es un nombre simbólico de la forma GL LIGHT i , donde \_ 0 = i *<* GL MAX \_ \_ LIGHTS.
