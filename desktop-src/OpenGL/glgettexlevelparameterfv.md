...
---
# <a name="glgettexlevelparameterfv-function"></a>glGetTexLevelParameterfv función)

Las funciones **glGetTexLevelParameterfv** y [**glGetTexLevelParameteriv**](glgettexlevelparameteriv.md) devuelven los valores de los parámetros de textura para un nivel de detalle específico.
