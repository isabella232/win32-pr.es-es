...
| Nombre                                                                                                  | Significado                                                                                                                                                                                                                        |
|-------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <dl> <dt>**ENUMERACIÓN \_ \_ NO VÁLIDA DE GL**</dt> </dl>      | *target* no era una TEXTURA \_ DE GL.<br/>                                                                                                                                                                                    |
...
| <dl> <dt>**VALOR \_ NO VÁLIDO DE \_ GL**</dt> </dl>     | *width* era menor que cero o mayor que 2 + GL MAX TEXTURE SIZE, o no se pudo representar como \_ \_ \_ 2 *n* + 2 (borde) para algún valor entero de n .<br/>                                                            |
...
Los datos  se leen desde píxeles como una secuencia de bytes con o sin signo, shorts o longs, o valores de punto flotante de precisión sencilla, según el *tipo*. Estos valores se agrupan en conjuntos de uno, dos, tres o cuatro valores, según el *formato*, para formar elementos. Si *type* es GL BITMAP, los datos se consideran una cadena de bytes sin signo (y el formato \_ debe ser GL COLOR  \_ \_ INDEX). Cada byte de datos se trata como ocho elementos de 1 bit, con ordenación de bits determinada por GL \_ UNPACK \_ LSB \_ FIRST (vea [**glPixelStore**](glpixelstore-functions.md)).
...
Una imagen de textura con ancho cero indica la textura nula. Si se especifica la textura null para el nivel de detalle 0, es como si se deshabilitara el texturing.
