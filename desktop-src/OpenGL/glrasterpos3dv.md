...
---
# <a name="glrasterpos3dv-function"></a>glRasterPos3dv función)
...
Puntero a una matriz de tres elementos, que especifica las coordenadas x, y y z para la posición de la trama actual.
