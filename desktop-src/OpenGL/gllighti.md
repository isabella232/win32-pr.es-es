...
description: La función glLighti devuelve valores de parámetros de origen claro.
...
ms.locfileid: "119493315"
---
# <a name="gllighti-function"></a>Función glLighti

La **función glLighti** devuelve valores de parámetros de origen claro.
...
La **función glLighti** establece el valor o los valores de los parámetros de origen de luz individuales. El *parámetro light* nombra la luz y es un nombre simbólico de la forma GL LIGHT i , donde \_ 0 = i *<* GL MAX \_ \_ LIGHTS.
