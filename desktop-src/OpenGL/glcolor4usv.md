...
description: Establece el color actual de una matriz existente de valores de color. | Función glColor4usv (Gl.h)
ms.assetid: 93a02461-4c8c-4b57-bedd-7d3be078e4c4
keywords:
- Función glColor4usv OpenGL
topic_type:
- apiref
api_name:
- glColor4usv
...
ms.locfileid: "127362106"
---
# <a name="glcolor4usv-function"></a>Función glColor4usv
