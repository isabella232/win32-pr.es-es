...
---
# <a name="gllightfv-function"></a>glLightfv función)

La función **glLightfv** devuelve los valores de los parámetros de origen de la luz.
...
La función **glLightfv** establece el valor o los valores de los parámetros individuales de origen de la luz. El parámetro de *luz* asigna un nombre a la luz y es un nombre simbólico con el formato GL \_ Light *i*, donde 0 = *i* < las luces de contab \_ \_ .
...
Las siguientes funciones recuperan información relacionada con la función **glLightfv** :
