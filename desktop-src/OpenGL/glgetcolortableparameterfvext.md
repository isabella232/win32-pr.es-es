...
---
# <a name="glgetcolortableparameterfvext-function"></a>glGetColorTableParameterfvEXT función)

Las funciones **glGetColorTableParameterfvEXT** y [**glGetColorTableParameterivEXT**](glgetcolortableparameterivext.md) obtienen parámetros de paleta de las tablas de color.
