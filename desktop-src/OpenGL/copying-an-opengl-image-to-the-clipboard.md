...
- copiar imágenes de OpenGL en OpenGL del Portapapeles
ms.topic: article
ms.date: 05/31/2018
...
**Para copiar una imagen de OpenGL en el Portapapeles**

1.  Dibuje la imagen en un mapa de bits de memoria o en un metarchivo mejorado.
2.  Copie ese mapa de bits en el Portapapeles.
