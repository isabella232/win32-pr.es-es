...
description: Las funciones glPixelTransferf y glPixelTransferi establecen los modos de transferencia de píxeles. | función glPixelTransferf (GL. h)
ms.assetid: c18ecbb9-af2a-4662-8e3f-0ac850b04fc1
keywords:
- glPixelTransferf (función) OpenGL
topic_type:
- apiref
api_name:
- glPixelTransferf
...
ms.locfileid: "105689744"
---
# <a name="glpixeltransferf-function"></a>glPixelTransferf función)

Las funciones **glPixelTransferf** y [**glPixelTransferi**](glpixeltransferi.md) establecen los modos de transferencia de píxeles.
