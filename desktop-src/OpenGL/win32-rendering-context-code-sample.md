...
---
# <a name="windows-rendering-context-code-sample"></a><span data-ttu-id="24fba-106">Ejemplo de código de contexto de representación de Windows</span><span class="sxs-lookup"><span data-stu-id="24fba-106">Windows Rendering Context Code Sample</span></span>

<span data-ttu-id="24fba-107">En el ejemplo de código siguiente se muestra cómo se ve el código de contexto de representación de GLX en la sección anterior cuando se ha migrado a Windows.</span><span class="sxs-lookup"><span data-stu-id="24fba-107">The following code sample shows how the GLX rendering context code in the previous section looks when it has been ported to Windows.</span></span>
