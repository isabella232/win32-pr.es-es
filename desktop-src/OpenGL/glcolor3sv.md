...
description: Establece el color actual de una matriz existente de valores de color. | Función glColor3sv (Gl.h)
ms.assetid: b1be5f7b-4c5f-4d4e-8898-3621dc7a503f
keywords:
- Función glColor3sv OpenGL
topic_type:
- apiref
api_name:
- glColor3sv
...
ms.locfileid: "119061873"
---
# <a name="glcolor3sv-function"></a>Función glColor3sv
