...
| Nombre                                                                                                  | Significado                                                                                                                                                                                                                                                                  |
|-------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <dl> <dt>**ENUMERACIÓN \_ \_ NO VÁLIDA DE GL**</dt> </dl>      | *el destino* no era GL \_ TEXTURE \_ 1D.<br/>                                                                                                                                                                                                                             |
...
El texto unidimensional para una primitiva se habilita mediante [**glEnable**](glenable.md) y **glDisable** con el argumento GL \_ TEXTURE \_ 1D. Durante el texturing, parte de una imagen de textura especificada se asigna a cada primitiva habilitada. Use la **función glTexSubImage1D** para especificar una sub image contigua de una imagen de textura unidimensional existente para texturing.
