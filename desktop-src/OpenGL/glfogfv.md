...
description: La función glFogfv especifica los parámetros de parámetro de parámetro de parámetro. | Función glFogfv (Gl.h)
ms.assetid: a2243ff4-4f3a-4b8c-b4fb-ce2cd74815e4
keywords:
- Función glFogfv OpenGL
topic_type:
- apiref
api_name:
- glFogfv
...
ms.locfileid: "119625385"
---
# <a name="glfogfv-function"></a>Función glFogfv
...
| Valor                                                                                                                                                             | Significado                                                                                                                                                                                                                                                                                                                                                                                                                             |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="GL_FOG_MODE"></span><span id="gl_fog_mode"></span><dl> <dt>**MODO \_ GL GL \_**</dt> </dl>          | El *parámetro params* es un valor de punto flotante que especifica la ecuación que se va a usar para calcular el factor blend de fusión, *f*. Se aceptan tres constantes simbólicas: GL \_ LINEAR, GL \_ EXP y GL \_ EXP2. Las ecuaciones correspondientes a estas constantes simbólicas se definen en la sección Comentarios siguiente. El modo de fusión predeterminado es GL \_ EXP.<br/>                                                                           |
| <span id="GL_FOG_DENSITY"></span><span id="gl_fog_density"></span><dl> <dt>**DENSIDAD \_ GL \_ DE GL**</dt> </dl> | El *parámetro params* es un valor de punto flotante que especifica *la* densidad , la densidad de densidad usada en ambas ecuaciones exponenciales. Solo se aceptan las densidades no no preventivas. La densidad de densidad predeterminada es 1,0.<br/>                                                                                                                                                                                                              |
| <span id="GL_FOG_START"></span><span id="gl_fog_start"></span><dl> <dt>**GL \_ FOG \_ START**</dt> </dl>       | El *parámetro params* es un valor de punto flotante que especifica *start*, la distancia cercana usada en la ecuación lineal de matriz. La distancia cercana predeterminada es 0,0.<br/>                                                                                                                                                                                                                                                            |
| <span id="GL_FOG_END"></span><span id="gl_fog_end"></span><dl> <dt>**GL \_ END DE GL \_**</dt> </dl>             | El *parámetro params* es un valor de punto flotante que especifica *end*, la distancia lejana que se usa en la ecuación de matriz lineal. La distancia lejana predeterminada es 1,0.<br/>                                                                                                                                                                                                                                                                |
| <span id="GL_FOG_INDEX"></span><span id="gl_fog_index"></span><dl> <dt>**GL \_ FOG \_ INDEX**</dt> </dl>       | El *parámetro params* es un valor de punto flotante que especifica *i*<sub>f</sub> , el índice de color de color de color. El índice de indexación predeterminado es 0,0.<br/>                                                                                                                                                                                                                                                                                     |
| <span id="GL_FOG_COLOR"></span><span id="gl_fog_color"></span><dl> <dt>**GL \_ FOG \_ COLOR**</dt> </dl>       | El *parámetro params* contiene cuatro valores de punto flotante que especifican *C*<sub>f</sub> , el color de capa. Los valores enteros se asignan linealmente de forma que el valor representable más positivo se asigna a 1,0 y el valor representable más negativo se asigna a -1,0. Los valores de punto flotante se asignan directamente. Después de la conversión, todos los componentes de color se fijan en el \[ intervalo 0,1. \] El color de color azulado predeterminado es (0,0,0,0).<br/> |
...
La **función glFogfv** asigna el valor o los valores de *params* al parámetro de parámetro parameter especificado por *pname*.
