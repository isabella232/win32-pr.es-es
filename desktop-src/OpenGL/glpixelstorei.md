...
---
# <a name="glpixelstorei-function"></a>glPixelStorei función)
...
Nombre simbólico del parámetro que se va a establecer. Seis de los parámetros de almacenamiento afectan a cómo se devuelven los datos de píxeles a la memoria del cliente y, por lo tanto, son significativos solo para los comandos [**glReadPixels**](glreadpixels.md) . Son los siguientes:
...
La función [**glPixelStoref**](glpixelstoref.md) se puede usar para establecer cualquier parámetro de almacén de píxeles. Si el tipo de parámetro es booleano, y si *param* es 0,0, el parámetro es false. en caso contrario, se establece en true. Si *PName* es un parámetro de tipo entero, *param* se redondea al entero más próximo.
