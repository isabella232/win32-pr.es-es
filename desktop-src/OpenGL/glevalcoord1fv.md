...
---
# <a name="glevalcoord1fv-function"></a>glEvalCoord1fv función)

La función **glEvalCoord1fv** evalúa las asignaciones unidimensionales habilitadas.
...
La función [**glEvalCoord1fv**](glevalcoord1dv.md) evalúa las asignaciones unidimensionales habilitadas en el argumento *u*. Definir asignaciones con [**glMap1**](glmap1.md). Habilitarlas o deshabilitarlas con [**glEnable**](glenable.md) y [**glDisable**](gldisable.md).
