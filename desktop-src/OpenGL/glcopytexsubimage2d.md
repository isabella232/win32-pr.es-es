...
| <dl> <dt>**VALOR \_ NO VÁLIDO DE \_ GL**</dt> </dl>     | *level* era menor que cero o mayor que *el registro* 2 *(máx.),* donde *max* es el valor devuelto de GL MAX \_ TEXTURE \_ \_ SIZE.<br/>                                                                                                                                                                                          |
