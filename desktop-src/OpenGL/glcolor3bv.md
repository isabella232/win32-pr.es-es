...
description: Establece el color actual de una matriz existente de valores de color. | Función glColor3bv (Gl.h)
ms.assetid: 2a2151a7-1f62-4cef-b8d4-9efd9d4bcd1c
keywords:
- Función glColor3bv OpenGL
topic_type:
- apiref
api_name:
- glColor3bv
...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: c3107bad25312a261d4b9e31481aed63ecc0ac5077f8c762bdc09a4a94377f14
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 08/11/2021
ms.locfileid: "120082005"
---
# <a name="glcolor3bv-function"></a>Función glColor3bv
