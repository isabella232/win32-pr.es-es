...
description: Las funciones glGetLightfv y glGetLightiv devuelven valores de parámetro de origen claro. | Función glGetLightfv (Gl.h)
ms.assetid: 81049726-426e-4f90-bb8e-e5d467870260
keywords:
- Función glGetLightfv OpenGL
topic_type:
- apiref
api_name:
- glGetLightfv
...
ms.locfileid: "119742014"
---
# <a name="glgetlightfv-function"></a>Función glGetLightfv

Las **funciones glGetLightfv** y [**glGetLightiv**](glgetlightiv.md) devuelven valores de parámetro de origen claro.
