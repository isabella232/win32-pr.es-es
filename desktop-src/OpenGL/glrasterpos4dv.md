...
description: Especifica la posición de trama para las operaciones de píxeles. | Función glRasterPos4dv (Gl.h)
ms.assetid: d3f0ea80-6753-4c9d-a498-9166f6207692
keywords:
- Función glRasterPos4dv OpenGL
topic_type:
- apiref
api_name:
- glRasterPos4dv
...
ms.locfileid: "117795066"
---
# <a name="glrasterpos4dv-function"></a>Función glRasterPos4dv
