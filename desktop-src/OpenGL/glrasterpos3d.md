...
description: Especifica la posición de trama para las operaciones de píxeles. | Función glRasterPos3d (Gl.h)
ms.assetid: 82e526f2-7ccd-4d31-a281-7cd6d7a488c1
keywords:
- Función glRasterPos3d OpenGL
topic_type:
- apiref
api_name:
- glRasterPos3d
...
ms.locfileid: "119519985"
---
# <a name="glrasterpos3d-function"></a>Función glRasterPos3d
