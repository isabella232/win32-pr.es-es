...
---
# <a name="glindexfv-function"></a>glIndexfv función)
...
La función **glIndexfv** actualiza el índice de color actual (de un solo valor). Toma un argumento: el nuevo valor para el índice de color actual.
...
La siguiente función recupera información relacionada con **glIndexfv**:
