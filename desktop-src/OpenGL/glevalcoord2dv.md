...
---
# <a name="glevalcoord2dv-function"></a>glEvalCoord2dv función)

La función **glEvalCoord2dv** evalúa las asignaciones bidimensionales habilitadas.
...
La función **glEvalCoord2dv** evalúa las asignaciones bidimensionales habilitadas con dos valores de dominio, *u* y *v*. Definir asignaciones con [**glMap1**](glmap1.md). Habilitarlas o deshabilitarlas con [**glEnable**](glenable.md) y [**glDisable**](gldisable.md).
...
Si la generación automática normal está habilitada, **glEvalCoord2dv** llama a [**glEnable**](glenable.md) con el argumento GL \_ auto \_ normal para generar las normales de superficie analíticamente, independientemente del contenido o de la habilitación del \_ mapa normal de GL MAP2 ( \_ . Let
