...
---
# <a name="glgettexparameteriv-function"></a>glGetTexParameteriv función)

Las funciones [**glGetTexParameterfv**](glgettexparameterfv.md) y **glGetTexParameteriv** devuelven los valores de los parámetros de textura.
