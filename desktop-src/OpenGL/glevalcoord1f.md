...
description: La función glEvalCoord1f evalúa los mapas unidimensionales habilitados.
ms.assetid: 520e2d31-b9c2-4b06-ab61-c2c7aa18448a
keywords:
- Función GlEvalCoord1f OpenGL
topic_type:
- apiref
api_name:
- glEvalCoord1f
...
ms.locfileid: "118616212"
---
# <a name="glevalcoord1f-function"></a>Función glEvalCoord1f

La **función glEvalCoord1f** evalúa los mapas unidimensionales habilitados.
...
La **función glEvalCoord1f** evalúa los mapas unidimensionales habilitados en el argumento *u*. Defina mapas con [**glMap1.**](glmap1.md) Habilite o deshabilite con [**glEnable**](glenable.md) [**y glDisable.**](gldisable.md)
...
Las siguientes funciones recuperan información relacionada con **la función glEvalCoord1f:**
