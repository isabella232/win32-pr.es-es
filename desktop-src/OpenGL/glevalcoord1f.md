...
---
# <a name="glevalcoord1f-function"></a>glEvalCoord1f función)

La función **glEvalCoord1f** evalúa las asignaciones unidimensionales habilitadas.
...
La función **glEvalCoord1f** evalúa las asignaciones unidimensionales habilitadas en el argumento *u*. Definir asignaciones con [**glMap1**](glmap1.md). Habilitarlas o deshabilitarlas con [**glEnable**](glenable.md) y [**glDisable**](gldisable.md).
