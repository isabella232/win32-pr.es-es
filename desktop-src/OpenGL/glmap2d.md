...
Asignación lineal de *v*, como se presenta a [**glEvalCoord2**](glevalcoord-functions.md), a *v*^, una de las dos variables que se evalúan mediante las ecuaciones especificadas por este comando.
...
Número de flotantes o dobles entre el principio del punto de control **R** *ij* y el principio del punto de control **R** <sub>i(j\ +1\),</sub>donde *i* y *j* son los índices de punto de control *u* y *v,* respectivamente. Esto permite incrustar puntos de control en estructuras de datos arbitrarias. La única restricción es que los valores de un punto de control determinado deben ocupar ubicaciones de memoria contiguas.
...
donde **R** *ij* es un punto de control, () es *el polinómico i* th DeMoson de degree

*n* (*uorder*  =  *n* + 1)

![Ecuación que muestra el polinómico de Grado n.](images/map06.png)
