...
---
# <a name="gltexgenfv-function"></a>glTexGenfv función)
...
Matriz de floats que contiene los coeficientes para la función de generación de textura correspondiente.
