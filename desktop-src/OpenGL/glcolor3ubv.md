...
description: Establece el color actual de una matriz existente de valores de color. | Función glColor3ubv (Gl.h)
ms.assetid: 029ef387-c98e-4d90-b046-c0f81f97b54e
keywords:
- Función glColor3ubv OpenGL
topic_type:
- apiref
api_name:
- glColor3ubv
...
ms.locfileid: "118617427"
---
# <a name="glcolor3ubv-function"></a>Función glColor3ubv
