...
description: Establece el color actual de una matriz existente de valores de color. | Función glColor3fv (Gl.h)
ms.assetid: 4ffaaa7e-4fa3-45b8-acf0-850e1e9d9a60
keywords:
- Función glColor3fv OpenGL
topic_type:
- apiref
api_name:
- glColor3fv
...
ms.locfileid: "127171413"
---
# <a name="glcolor3fv-function"></a>Función glColor3fv
