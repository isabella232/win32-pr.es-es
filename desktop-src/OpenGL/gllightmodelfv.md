...
---
# <a name="gllightmodelfv-function"></a>glLightModelfv función)
...
La función **glLightModelfv** establece el parámetro del modelo de iluminación. El parámetro *PName* nombra un parámetro y *param* proporciona el nuevo valor. el valor o los valores de los parámetros individuales de origen de la luz.
...
Las siguientes funciones recuperan información relacionada con la función **glLightModelfv** :
