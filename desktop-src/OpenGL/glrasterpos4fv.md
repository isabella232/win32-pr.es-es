...
description: Especifica la posición del trama para las operaciones de píxeles. | Función glRasterPos4fv (Gl.h)
ms.assetid: acbaf057-ae90-4980-830c-e0dfc8080a84
keywords:
- Función glRasterPos4fv OpenGL
topic_type:
- apiref
api_name:
- glRasterPos4fv
...
ms.locfileid: "119492265"
---
# <a name="glrasterpos4fv-function"></a>Función glRasterPos4fv

Especifica la posición del trama para las operaciones de píxeles.
...
Puntero a una matriz de cuatro elementos, especificando las coordenadas x, y, z y w para la posición de trama actual.
