...
| Propiedad | Value |
|------------------|----------------------------------------|
| Descripción:     | Valor de GL \_ UNPACK \_ SWAP \_ BYTES       |
| Grupo de atributos: |                                        |
| Valor inicial:   | GL \_ FALSE                              |
| Comando Get:     | [**glGetBooleanv**](glgetbooleanv.md) |
...
| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ UNPACK \_ LSB \_ FIRST                                                  |
| Grupo de atributos: |                                                                                  |
| Valor inicial:   | GL \_ FALSE                                                                        |
...
| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ UNPACK \_ ROW \_ LENGTH                                                 |
| Grupo de atributos: |                                                                                  |
| Valor inicial:   | 0                                                                                |
...
| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ UNPACK \_ SKIP \_ ROWS                                                  |
| Grupo de atributos: |                                                                                  |
| Valor inicial:   | 0                                                                                |
| Comando Get:     | [**glGetIntegerv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
</dd> <dt><span id="GL_UNPACK_SKIP_PIXELS"></span><span id="gl_unpack_skip_pixels"></span>GL \_ UNPACK \_ SKIP \_ PIXELS</dt> <dd> 

| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ UNPACK \_ SKIP \_ PIXELS                                                |
| Grupo de atributos: |                                                                                  |
| Valor inicial:   | 0                                                                                |
| Comando Get:     | [**glGetIntegerv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
</dd> <dt><span id="GL_UNPACK_ALIGNMENT"></span><span id="gl_unpack_alignment"></span>ALINEACIÓN \_ DE DESEMPAQUETE \_ DE GL</dt> <dd> 

| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ UNPACK \_ ALIGNMENT                                                   |
| Grupo de atributos: |                                                                                  |
| Valor inicial:   | 4                                                                                |
| Comando Get:     | [**glGetIntegerv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
</dd> <dt><span id="GL_PACK_SWAP_BYTES"></span><span id="gl_pack_swap_bytes"></span>BYTES DE \_ INTERCAMBIO \_ DEL PAQUETE \_ GL</dt> <dd> 

| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ PACK \_ SWAP \_ BYTES                                                   |
| Grupo de atributos: |                                                                                  |
| Valor inicial:   | GL \_ FALSE                                                                        |
| Comando Get:     | [**glGetBooleanv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ PACK \_ LSB \_ FIRST                                                    |
| Grupo de atributos: |                                                                                  |
| Valor inicial:   | GL \_ FALSE                                                                        |
| Comando Get:     | [**glGetBooleanv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
</dd> <dt><span id="GL_PACK_ROW_LENGTH"></span><span id="gl_pack_row_length"></span>LONGITUD DE \_ FILA \_ DEL PAQUETE \_ GL</dt> <dd> 

| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ PACK \_ ROW \_ LENGTH                                                   |
| Grupo de atributos: |                                                                                  |
| Valor inicial:   | 0                                                                                |
| Comando Get:     | [**glGetIntegerv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ PACK \_ SKIP \_ ROWS                                                    |
| Grupo de atributos: |                                                                                  |
| Valor inicial:   | 0                                                                                |
| Comando Get:     | [**glGetIntegerv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ PACK \_ SKIP \_ PIXELS                                                  |
| Grupo de atributos: |                                                                                  |
| Valor inicial:   | 0                                                                                |
| Comando Get:     | [**glGetIntegerv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
</dd> <dt><span id="GL_PACK_ALIGNMENT"></span><span id="gl_pack_alignment"></span>ALINEACIÓN \_ DEL PAQUETE \_ GL</dt> <dd> 

| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ PACK \_ ALIGNMENT                                                     |
| Grupo de atributos: |                                                                                  |
| Valor inicial:   | 4                                                                                |
| Comando Get:     | [**glGetIntegerv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | True si los colores están asignados                                                        |
| Grupo de atributos: | píxel                                                                            |
| Valor inicial:   | GL \_ FALSE                                                                        |
| Comando Get:     | [**glGetBooleanv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | True si se asignan valores de galería de símbolos                                                |
| Grupo de atributos: | píxel                                                                            |
| Valor inicial:   | GL \_ FALSE                                                                        |
| Comando Get:     | [**glGetBooleanv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ INDEX \_ SHIFT                                                        |
| Grupo de atributos: | píxel                                                                            |
| Valor inicial:   | 0                                                                                |
| Comando Get:     | [**glGetIntegerv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ INDEX \_ OFFSET                                                       |
| Grupo de atributos: | píxel                                                                            |
| Valor inicial:   | 0                                                                                |
| Comando Get:     | [**glGetIntegerv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
| Propiedad | Value |
|------------------|--------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ *x* \_ SCALE; es GL \_ RED, GL \_ BLUE, GL ALPHA o GL \_ \_ DEPTH         |
| Grupo de atributos: | píxel                                                                          |
| Valor inicial:   | 1                                                                              |
...
| Propiedad | Value |
|------------------|--------------------------------------------------------------------------------|
| Descripción:     | Valor de GL \_ *x* \_ BIAS; *x* es GL \_ RED GL \_ BLUE, GL ALPHA o GL \_ \_ DEPTH       |
| Grupo de atributos: | píxel                                                                          |
| Valor inicial:   | 0                                                                              |
| Comando Get:     | [**glGetFloatv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
| Propiedad | Value |
|------------------|----------------------------------------|
| Descripción:     | **tablas de traducción glPixelMap**      |
| Grupo de atributos: | píxel                                  |
| Valor inicial:   | 0                                    |
| Comando Get:     | [**glGetPixelMap**](glgetpixelmap.md) |
...
| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Tamaño de la tabla *x*                                                                |
| Grupo de atributos: | píxel                                                                            |
| Valor inicial:   | 1                                                                                |
| Comando Get:     | [**glGetIntegerv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
...
</dd> <dt><span id="GL_READ_BUFFER"></span><span id="gl_read_buffer"></span>BÚFER \_ DE LECTURA DE \_ GL</dt> <dd> 

| Propiedad | Value |
|------------------|----------------------------------------------------------------------------------|
| Descripción:     | Lectura del búfer de origen                                                               |
| Grupo de atributos: | píxel                                                                            |
| Valor inicial:   |                                                                                  |
| Comando Get:     | [**glGetIntegerv**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) |
