...
description: Especifica la posición de trama para las operaciones de píxeles. | Función glRasterPos3i (Gl.h)
ms.assetid: c9c4771a-8eac-4e30-ab5f-7dd3b08a83cc
keywords:
- Función glRasterPos3i OpenGL
topic_type:
- apiref
api_name:
- glRasterPos3i
...
ms.locfileid: "118358314"
---
# <a name="glrasterpos3i-function"></a>Función glRasterPos3i
