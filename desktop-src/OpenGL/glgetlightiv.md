...
---
# <a name="glgetlightiv-function"></a>glGetLightiv función)

Las funciones [**glGetLightfv**](glgetlightfv.md) y **glGetLightiv** devuelven los valores de los parámetros de origen Light.
