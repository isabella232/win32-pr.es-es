...
description: Especifica la posición de trama para las operaciones de píxeles. | Función glRasterPos3sv (Gl.h)
ms.assetid: 7b9dcc0c-8d86-4435-8e21-798dbca613fd
keywords:
- Función glRasterPos3sv OpenGL
topic_type:
- apiref
api_name:
- glRasterPos3sv
...
ms.locfileid: "118358355"
---
# <a name="glrasterpos3sv-function"></a>Función glRasterPos3sv
