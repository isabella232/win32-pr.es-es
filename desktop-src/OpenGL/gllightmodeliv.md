...
---
# <a name="gllightmodeliv-function"></a>glLightModeliv función)
...
La función **glLightModeliv** establece el parámetro del modelo de iluminación. El parámetro *PName* nombra un parámetro y *param* proporciona el nuevo valor. el valor o los valores de los parámetros individuales de origen de la luz.
