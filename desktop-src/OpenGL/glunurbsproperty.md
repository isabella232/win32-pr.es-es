...
ms.locfileid: "127244958"
---
# <a name="glunurbsproperty-function"></a>función gluNurbsProperty

La **función gluNurbsProperty** establece una propiedad B-Spline no uniforme de rational [(SPLINEBS).](using-nurbs-curves-and-surfaces.md)
