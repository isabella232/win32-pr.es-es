...
Esta información general se centra en cómo se usan las transiciones y los guiones gráficos en la animación de Windows. Para obtener información general sobre los componentes de animación de Windows, vea [Información general sobre animaciones de Windows.](scenic-animation-api-overview.md)
...
Una transición define cómo cambia una variable de animación única durante un intervalo de tiempo determinado. Animación de Windows incluye una biblioteca de transiciones comunes que los desarrolladores pueden aplicar a una o varias variables de animación. Los distintos tipos de transiciones tienen conjuntos de parámetros diferentes, que pueden incluir el valor de la variable cuando se completa la transición, la duración de la transición o cantidades únicas para la función matemática subyacente, como la aceleración o el intervalo de oscilación.
...
|----------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| aceleración y ralentización<br/>       | La variable de animación se acelera y, a continuación, se ralentiza durante una duración determinada.<br/>                                                                                                               |
...
| parabólica desde la aceleración<br/> | La variable de animación pasa de su valor inicial a un valor final especificado, con una velocidad final especificada, cambiando su velocidad con una aceleración especificada.<br/>               |
...
| sinusoidal desde intervalo<br/>       | La variable oscila dentro de un intervalo determinado de valores, con un período de oscilación especificado, durante una duración determinada.<br/>                                                                     |
| sinusoidal desde la velocidad<br/>    | La variable oscila con un período especificado de oscilación, durante una duración determinada. La amplitud de la oscilación viene determinada por la velocidad inicial de la variable.<br/>                      |
...
Tenga en cuenta que, en un escenario tan sencillo, una opción alternativa es usar el [**método IUIAnimationManager::ScheduleTransition.**](/windows/desktop/api/UIAnimation/nf-uianimation-iuianimationmanager-scheduletransition)
...
El desplazamiento en el que se agrega un fotograma clave siempre es relativo a otro fotograma clave. En el diagrama siguiente se muestra el resultado de agregar fotograma clave1 y la transición T4, que se aplica a la variable Z, se alinea con fotograma clave1 y se crea con una duración fija. Por supuesto, dado que todavía no se conocen las duraciones de las otras transiciones, T4 podría no ser la última transición en finalizar.
...
El administrador de animaciones no necesita cancelar ni recortar C para programar antes de que haya transcurrido su retraso más largo aceptable, por lo que la reunión de C y G determina cuándo se inicia G.
...
Como segundo ejemplo, considere un escenario como el anterior, pero con un retraso aceptable más corto y más largo especificado para G.
