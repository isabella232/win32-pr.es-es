...
Si no controla un mensaje determinado en el procedimiento de ventana, pase los parámetros del mensaje directamente a la [**función DefWindowProc.**](/windows/desktop/api/winuser/nf-winuser-defwindowproca) Esta función realiza la acción predeterminada para el mensaje, que varía según el tipo de mensaje.
...
En su lugar, debe mover el trabajo a otro subproceso mediante una de las funciones multitarea integradas en Windows:
