---
description: ColorSpace incrustado en la imagen. Tomado de la información del archivo de imagen intercambiable (EXIF).
...
ms.locfileid: "105706262"
---
# <a name="systemimagecolorspace"></a>System. Image. ColorSpace

ColorSpace incrustado en la imagen. Tomado de la información del archivo de imagen intercambiable (EXIF).
