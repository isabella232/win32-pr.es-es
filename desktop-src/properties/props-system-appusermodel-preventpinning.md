---
description: Deshabilita la capacidad de anclar un acceso directo o una ventana a la barra de tareas o al menú Inicio. Esta propiedad también hace que el elemento no sea apto para su inclusión en la lista de menú Inicio la lista de MFU (Usado con más frecuencia).
