...
Null indica el caso normal (el archivo está disponible sin conexión). El caso parcial es solo para las carpetas en las que cierto contenido puede estar disponible sin conexión y otros no.
