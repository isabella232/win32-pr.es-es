---
description: Novedad de Windows 7. Elemento contenedor para los elementos relatedProperty.
...
ms.locfileid: "118970964"
---
# <a name="relatedpropertyinfo"></a>relatedPropertyInfo

Novedad de Windows 7. Elemento contenedor para [los elementos relatedProperty.](./propdesc-schema-relatedproperty.md) Solo debe haber un elemento [relatedPropertyInfo]() para cada [elemento propertyDescription.](./propdesc-schema-propertydescription.md)
