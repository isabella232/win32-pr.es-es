...
| Value                                                                                                                                                                                                                                                           | Significado                                                                                                                                                                                         |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="BEGIN_NESTED_SYSTEM_CHANGE"></span><span id="begin_nested_system_change"></span><dl> <dt>**BEGIN \_ CAMBIO \_ DEL \_ SISTEMA ANIDADO**</dt> <dt>102</dt> </dl> | Ha comenzado un cambio en el sistema. Una llamada anidada posterior no crea un nuevo punto de restauración. <br/> Las llamadas posteriores deben usar END \_ NESTED \_ SYSTEM \_ CHANGE, no END SYSTEM \_ \_ CHANGE.<br/> |
| <span id="BEGIN_SYSTEM_CHANGE"></span><span id="begin_system_change"></span><dl> <dt>**BEGIN \_ CAMBIO \_ DEL SISTEMA**</dt> <dt>100</dt> </dl>                       | Ha comenzado un cambio en el sistema.<br/>                                                                                                                                                           |
...
| <span id="END_SYSTEM_CHANGE"></span><span id="end_system_change"></span><dl> <dt>**END \_ CAMBIO \_ DEL SISTEMA**</dt> <dt>101</dt> </dl>                             | Ha finalizado un cambio del sistema.<br/>                                                                                                                                                           |
...
| Value                                                                                                                                                                                                                                          | Significado                                                                                                                                                       |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="APPLICATION_INSTALL"></span><span id="application_install"></span><dl> <dt>**APLICACIÓN \_ INSTALACIÓN**</dt> <dt>0</dt> </dl>         | Se ha instalado una aplicación.<br/>                                                                                                                 |
...
| <span id="MODIFY_SETTINGS"></span><span id="modify_settings"></span><dl> <dt>**MODIFY \_ CONFIGURACIÓN**</dt> <dt>12</dt> </dl>                    | A una aplicación se le han agregado o quitado características.<br/>                                                                                                  |
