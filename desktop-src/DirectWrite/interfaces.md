...
| [**IDWriteFactory**](/windows/win32/api/dwrite/nn-dwrite-idwritefactory) | Se usa para crear todos los objetos DirectWrite posteriores. Esta interfaz es la interfaz de generador raíz para todos DirectWrite objetos. |
| [**IDWriteFactory1**](/windows/win32/api/dwrite_1/nn-dwrite_1-idwritefactory1) | Interfaz de generador raíz para todos [DirectWrite](direct-write-portal.md) objetos. |
| [**IDWriteFactory2**](idwritefactory2.md) | Interfaz de generador raíz para todos [DirectWrite](direct-write-portal.md) objetos. |
| [**IDWriteFactory3**](/windows/win32/api/dwrite_3/nn-dwrite_3-idwritefactory3) | Interfaz de generador raíz para todos [DirectWrite](direct-write-portal.md) objetos. |
...
| [**IDWriteFactory6**](/windows/win32/api/dwrite_3/nn-dwrite_3-idwritefactory6) | Representa un objeto de generador a partir del cual se crean DirectWrite objetos. **IDWriteFactory6 agrega** nuevas características para trabajar con fuentes y recursos de fuente. |
| [**IDWriteFactory7**](/windows/win32/api/dwrite_3/nn-dwrite_3-idwritefactory7) | Esta interfaz representa un objeto de generador a partir del cual se crean DirectWrite objetos. **IDWriteFactory7 agrega** nuevas características para trabajar con fuentes del sistema. |
