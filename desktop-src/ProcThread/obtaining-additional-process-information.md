...
-   Para obtener el recuento de identificadores de los objetos de interfaz gráfica de usuario (GUI) en uso, use la [**función GetGuiResources.**](/windows/desktop/api/Winuser/nf-winuser-getguiresources)
