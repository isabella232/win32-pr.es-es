...
Si tiene un identificador de proceso, puede obtener el identificador del proceso llamando a la [**función OpenProcess.**](/windows/win32/api/processthreadsapi/nf-processthreadsapi-openprocess) **OpenProcess** permite especificar los derechos de acceso del identificador y si se puede heredar.
