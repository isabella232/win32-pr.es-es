...
Dado que la eliminación de la división de nodos puede afectar potencialmente a las aplicaciones existentes, hay un valor del Registro disponible para permitir volver a participar en el comportamiento de división de nodos heredado. La división de nodos se puede volver **a** habilitar mediante la creación de un REG_DWORD denominado "SplitLargeNodes" con el valor 1 debajo HKEY_LOCAL_MACHINE\System\CurrentControlSet\Control\NUMA. Los cambios en esta configuración requieren que se realice un reinicio.
