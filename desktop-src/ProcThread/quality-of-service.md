---
description: Calidad de servicio indica el rendimiento y la eficacia de energía de un subproceso, lo que puede influir en la programación de subprocesos y la administración de energía del procesador.
...
| Fecha límite | Subprocesos etiquetados explícitamente por el [servicio Programador](/windows/desktop/procthread/multimedia-class-scheduler-service) de clases multimedia para indicar que los subprocesos de audio requieren rendimiento para cumplir las fechas límite. | Alto rendimiento para cumplir las fechas límite de los medios. | 2004 |
