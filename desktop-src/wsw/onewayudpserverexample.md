...
description: En este ejemplo se muestra un servidor UDP que acepta un canal y recibe mensajes unidireccionales.
...
ms.locfileid: "103779404"
---
# <a name="onewayudpserverexample"></a><span data-ttu-id="b0094-106">OneWayUdpServerExample</span><span class="sxs-lookup"><span data-stu-id="b0094-106">OneWayUdpServerExample</span></span>

<span data-ttu-id="b0094-107">En este ejemplo se muestra un servidor UDP que acepta un canal y recibe mensajes unidireccionales.</span><span class="sxs-lookup"><span data-stu-id="b0094-107">This example shows a UDP server that accepts a channel and receives one-way messages.</span></span>

-   [<span data-ttu-id="b0094-108">OneWayUdpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="b0094-108">OneWayUdpServer.cpp</span></span>](#onewayudpservercpp)
-   [<span data-ttu-id="b0094-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="b0094-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="b0094-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="b0094-110">Makefile</span></span>](#makefile)

## <a name="onewayudpservercpp"></a><span data-ttu-id="b0094-111">OneWayUdpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="b0094-111">OneWayUdpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="b0094-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="b0094-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="b0094-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="b0094-113">Makefile</span></span>
