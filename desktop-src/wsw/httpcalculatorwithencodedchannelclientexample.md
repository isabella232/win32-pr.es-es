...
description: En este ejemplo se muestra cómo usar el proxy de servicio para comunicarse con un servicio de calculadora basado en HTTP mediante un canal personalizado. El canal utiliza un codificador personalizado.
...
ms.locfileid: "103994593"
---
# <a name="httpcalculatorwithencodedchannelclientexample"></a><span data-ttu-id="da82e-107">HttpCalculatorWithEncodedChannelClientExample</span><span class="sxs-lookup"><span data-stu-id="da82e-107">HttpCalculatorWithEncodedChannelClientExample</span></span>

<span data-ttu-id="da82e-108">En este ejemplo se muestra cómo usar el proxy de servicio para comunicarse con un servicio de calculadora basado en HTTP mediante un canal personalizado.</span><span class="sxs-lookup"><span data-stu-id="da82e-108">This example show how to use the service proxy to talk to an HTTP based calculator service using a custom channel.</span></span> <span data-ttu-id="da82e-109">El canal utiliza un codificador personalizado.</span><span class="sxs-lookup"><span data-stu-id="da82e-109">The channel is uses a custom encoder.</span></span>

-   [<span data-ttu-id="da82e-110">HttpCalculatorWithEncodedChannelClient. cpp</span><span class="sxs-lookup"><span data-stu-id="da82e-110">HttpCalculatorWithEncodedChannelClient.cpp</span></span>](#httpcalculatorwithencodedchannelclientcpp)
-   [<span data-ttu-id="da82e-111">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="da82e-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="da82e-112">EncodedChannel. cpp</span><span class="sxs-lookup"><span data-stu-id="da82e-112">EncodedChannel.cpp</span></span>](#encodedchannelcpp)
-   [<span data-ttu-id="da82e-113">EncodedChannel. h</span><span class="sxs-lookup"><span data-stu-id="da82e-113">EncodedChannel.h</span></span>](#encodedchannelh)
-   [<span data-ttu-id="da82e-114">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="da82e-114">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithencodedchannelclientcpp"></a><span data-ttu-id="da82e-115">HttpCalculatorWithEncodedChannelClient. cpp</span><span class="sxs-lookup"><span data-stu-id="da82e-115">HttpCalculatorWithEncodedChannelClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="da82e-116">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="da82e-116">CalculatorService.wsdl</span></span>
...
## <a name="encodedchannelcpp"></a><span data-ttu-id="da82e-117">EncodedChannel. cpp</span><span class="sxs-lookup"><span data-stu-id="da82e-117">EncodedChannel.cpp</span></span>
...
## <a name="encodedchannelh"></a><span data-ttu-id="da82e-118">EncodedChannel. h</span><span class="sxs-lookup"><span data-stu-id="da82e-118">EncodedChannel.h</span></span>
...
## <a name="makefile"></a><span data-ttu-id="da82e-119">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="da82e-119">Makefile</span></span>
