...
description: Vea un ejemplo de solicitud y respuesta al servidor TCP que usa Windows Web Services API (WWSAPI). Este ejemplo acepta un canal y recibe y responde a los mensajes.
