...
---
# <a name="httpcalculatorwithkerberosoversslclientexample"></a><span data-ttu-id="dd092-106">HttpCalculatorWithKerberosOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="dd092-106">HttpCalculatorWithKerberosOverSslClientExample</span></span>

<span data-ttu-id="dd092-107">En este ejemplo se muestra un cliente HTTP que usa el proxy de servicio para comunicarse con un servicio de calculadora, con seguridad de modo mixto de Kerberos a través de SSL.</span><span class="sxs-lookup"><span data-stu-id="dd092-107">This example shows a HTTP client that uses service proxy to talk to a calculator service, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="dd092-108">En esta configuración, la conexión de transporte está protegida (firmada, cifrada) por SSL, que también proporciona autenticación de servidor.</span><span class="sxs-lookup"><span data-stu-id="dd092-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="dd092-109">La autenticación del cliente se proporciona mediante un vale APREQ de Kerberos en un encabezado WS-Security del mensaje.</span><span class="sxs-lookup"><span data-stu-id="dd092-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="dd092-110">CalculatorClientKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="dd092-110">CalculatorClientKerberosOverSsl.cpp</span></span>](#calculatorclientkerberosoversslcpp)
-   [<span data-ttu-id="dd092-111">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="dd092-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="dd092-112">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="dd092-112">Makefile</span></span>](#makefile)

## <a name="calculatorclientkerberosoversslcpp"></a><span data-ttu-id="dd092-113">CalculatorClientKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="dd092-113">CalculatorClientKerberosOverSsl.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="dd092-114">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="dd092-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="dd092-115">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="dd092-115">Makefile</span></span>
