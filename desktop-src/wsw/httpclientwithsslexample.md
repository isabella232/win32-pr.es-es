...
description: En este ejemplo se muestra un cliente HTTP que envía mensajes de solicitud-respuesta, con seguridad de transporte SSL.
...
ms.locfileid: "103772625"
---
# <a name="httpclientwithsslexample"></a><span data-ttu-id="ae3af-106">HttpClientWithSslExample</span><span class="sxs-lookup"><span data-stu-id="ae3af-106">HttpClientWithSslExample</span></span>

<span data-ttu-id="ae3af-107">En este ejemplo se muestra un cliente HTTP que envía mensajes de solicitud-respuesta, con seguridad de transporte SSL.</span><span class="sxs-lookup"><span data-stu-id="ae3af-107">This example shows a HTTP client that sends request-reply messages, with SSL transport security.</span></span>

-   [<span data-ttu-id="ae3af-108">HttpClientWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="ae3af-108">HttpClientWithSsl.cpp</span></span>](#httpclientwithsslcpp)
-   [<span data-ttu-id="ae3af-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="ae3af-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="ae3af-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="ae3af-110">Makefile</span></span>](#makefile)

## <a name="httpclientwithsslcpp"></a><span data-ttu-id="ae3af-111">HttpClientWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="ae3af-111">HttpClientWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="ae3af-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="ae3af-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="ae3af-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="ae3af-113">Makefile</span></span>
