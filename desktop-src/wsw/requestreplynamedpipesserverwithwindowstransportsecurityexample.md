...
description: En este ejemplo se muestra un servidor de canalizaciones con nombre que acepta un canal y recibe y responde a los mensajes con seguridad proporcionada por la seguridad de transporte de Windows SSPI.
...
ms.locfileid: "104075032"
---
# <a name="requestreplynamedpipesserverwithwindowstransportsecurityexample"></a><span data-ttu-id="d4ef4-103">RequestReplyNamedPipesServerWithWindowsTransportSecurityExample</span><span class="sxs-lookup"><span data-stu-id="d4ef4-103">RequestReplyNamedPipesServerWithWindowsTransportSecurityExample</span></span>

<span data-ttu-id="d4ef4-104">En este ejemplo se muestra un servidor de canalizaciones con nombre que acepta un canal y recibe y responde a los mensajes con seguridad proporcionada por la seguridad de transporte de Windows SSPI.</span><span class="sxs-lookup"><span data-stu-id="d4ef4-104">This example shows a named pipes server that accepts a channel, and receives and replies to messages with security provided by Windows SSPI transport security.</span></span>

-   [<span data-ttu-id="d4ef4-105">RequestReplyNamedPipesServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="d4ef4-105">RequestReplyNamedPipesServerWithWindowsTransportSecurity.cpp</span></span>](#requestreplynamedpipesserverwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="d4ef4-106">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="d4ef4-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="d4ef4-107">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="d4ef4-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesserverwithwindowstransportsecuritycpp"></a><span data-ttu-id="d4ef4-108">RequestReplyNamedPipesServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="d4ef4-108">RequestReplyNamedPipesServerWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="d4ef4-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="d4ef4-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="d4ef4-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="d4ef4-110">Makefile</span></span>
