...
description: En este ejemplo se muestra un servidor de canalizaciones con nombre que acepta un canal y recibe y responde a los mensajes con seguridad proporcionada por Windows seguridad de transporte de SSPI.
...
En este ejemplo se muestra un servidor de canalizaciones con nombre que acepta un canal y recibe y responde a los mensajes con seguridad proporcionada por Windows seguridad de transporte de SSPI.
