...
description: En este ejemplo se muestra cómo utilizar el host de servicio para administrar solicitudes HTTP sin procesar (no SOAP).
...
ms.locfileid: "103777784"
---
# <a name="httprawserviceexample"></a><span data-ttu-id="790f9-106">HttpRawServiceExample</span><span class="sxs-lookup"><span data-stu-id="790f9-106">HttpRawServiceExample</span></span>

<span data-ttu-id="790f9-107">En este ejemplo se muestra cómo utilizar el host de servicio para administrar solicitudes HTTP sin procesar (no SOAP).</span><span class="sxs-lookup"><span data-stu-id="790f9-107">This example shows how to use service host to handle raw (non-SOAP) HTTP requests.</span></span>

## <a name="httprawservicecpp"></a><span data-ttu-id="790f9-108">HttpRawService. cpp</span><span class="sxs-lookup"><span data-stu-id="790f9-108">HttpRawService.cpp</span></span>
