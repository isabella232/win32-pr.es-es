...
description: En este ejemplo se muestra un cliente HTTP que realiza la solicitud-respuesta mediante las API de streaming.
...
ms.locfileid: "105695488"
---
# <a name="streaminghttpclientexample"></a><span data-ttu-id="3c559-106">StreamingHttpClientExample</span><span class="sxs-lookup"><span data-stu-id="3c559-106">StreamingHttpClientExample</span></span>

<span data-ttu-id="3c559-107">En este ejemplo se muestra un cliente HTTP que realiza la solicitud-respuesta mediante las API de streaming.</span><span class="sxs-lookup"><span data-stu-id="3c559-107">This example shows an HTTP client that does request-reply using the streaming APIs.</span></span>

-   [<span data-ttu-id="3c559-108">StreamingHttpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="3c559-108">StreamingHttpClient.cpp</span></span>](#streaminghttpclientcpp)
-   [<span data-ttu-id="3c559-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="3c559-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="3c559-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="3c559-110">Makefile</span></span>](#makefile)

## <a name="streaminghttpclientcpp"></a><span data-ttu-id="3c559-111">StreamingHttpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="3c559-111">StreamingHttpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="3c559-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="3c559-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="3c559-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="3c559-113">Makefile</span></span>
