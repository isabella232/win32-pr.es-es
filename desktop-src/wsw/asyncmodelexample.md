...
---
# <a name="asynchronous-function-example"></a><span data-ttu-id="bb077-106">Ejemplo de función asincrónica</span><span class="sxs-lookup"><span data-stu-id="bb077-106">Asynchronous Function Example</span></span>

<span data-ttu-id="bb077-107">Este ejemplo muestra cómo implementar y llamar a funciones asincrónicas.</span><span class="sxs-lookup"><span data-stu-id="bb077-107">This example illustrates implementing and calling asynchronous functions.</span></span>

<span data-ttu-id="bb077-108">El ejemplo consta de las siguientes partes:</span><span class="sxs-lookup"><span data-stu-id="bb077-108">The example consists of the following parts:</span></span>

-   <span data-ttu-id="bb077-109">La función Add, que agregará dos números de forma sincrónica o asincrónica.</span><span class="sxs-lookup"><span data-stu-id="bb077-109">The Add function which will add two numbers synchronously or asynchronously.</span></span> <span data-ttu-id="bb077-110">Crea un subproceso como detalle de implementación para el caso asincrónico.</span><span class="sxs-lookup"><span data-stu-id="bb077-110">It creates a thread as an implementation detail for the asynchronous case.</span></span>
-   <span data-ttu-id="bb077-111">La función CallAddSync invoca las funciones Add sincrónicamente.</span><span class="sxs-lookup"><span data-stu-id="bb077-111">The CallAddSync function invokes the Add functions synchronously.</span></span>
-   <span data-ttu-id="bb077-112">La función CallAddAsync invoca las funciones de adición de forma asincrónica.</span><span class="sxs-lookup"><span data-stu-id="bb077-112">The CallAddAsync function invokes the Add functions asynchronously.</span></span>

## <a name="asyncmodelcpp"></a><span data-ttu-id="bb077-113">AsyncModel. cpp</span><span class="sxs-lookup"><span data-stu-id="bb077-113">AsyncModel.cpp</span></span>
