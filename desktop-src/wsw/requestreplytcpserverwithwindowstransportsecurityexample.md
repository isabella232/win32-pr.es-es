...
description: En este ejemplo se muestra un servidor TCP que acepta un canal y recibe y responde a los mensajes, con la seguridad proporcionada por la seguridad de transporte basada en Windows SSPI.
...
ms.locfileid: "104149025"
---
# <a name="requestreplytcpserverwithwindowstransportsecurity-example"></a><span data-ttu-id="7cc81-106">Ejemplo de RequestReplyTcpServerWithWindowsTransportSecurity</span><span class="sxs-lookup"><span data-stu-id="7cc81-106">RequestReplyTcpServerWithWindowsTransportSecurity example</span></span>

<span data-ttu-id="7cc81-107">En este ejemplo se muestra un servidor TCP que acepta un canal y recibe y responde a los mensajes, con la seguridad proporcionada por la seguridad de transporte basada en Windows SSPI.</span><span class="sxs-lookup"><span data-stu-id="7cc81-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with security provided by Windows SSPI-based transport security.</span></span>

-   [<span data-ttu-id="7cc81-108">RequestReplyTcpServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="7cc81-108">RequestReplyTcpServerWithWindowsTransportSecurity.cpp</span></span>](#requestreplytcpserverwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="7cc81-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="7cc81-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="7cc81-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="7cc81-110">Makefile</span></span>](#makefile)

## <a name="requestreplytcpserverwithwindowstransportsecuritycpp"></a><span data-ttu-id="7cc81-111">RequestReplyTcpServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="7cc81-111">RequestReplyTcpServerWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="7cc81-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="7cc81-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="7cc81-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="7cc81-113">Makefile</span></span>
