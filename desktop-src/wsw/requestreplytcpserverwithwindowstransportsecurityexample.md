...
En este ejemplo se muestra un servidor TCP que acepta un canal y recibe y responde a los mensajes, con la seguridad proporcionada por la seguridad de transporte basada en Windows SSPI.
