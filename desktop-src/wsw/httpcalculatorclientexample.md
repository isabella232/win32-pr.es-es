...
description: En este ejemplo se muestra cómo usar el proxy de servicio para comunicarse con un servicio de calculadora basado en HTTP.
ms.assetid: dd97613d-3bb7-427c-a292-220d1efed96c
keywords:
- Servicios Web de HttpCalculatorClientExample para Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105714261"
---
# <a name="httpcalculatorclientexample"></a><span data-ttu-id="cd70a-106">HttpCalculatorClientExample</span><span class="sxs-lookup"><span data-stu-id="cd70a-106">HttpCalculatorClientExample</span></span>

<span data-ttu-id="cd70a-107">En este ejemplo se muestra cómo usar el proxy de servicio para comunicarse con un servicio de calculadora basado en HTTP.</span><span class="sxs-lookup"><span data-stu-id="cd70a-107">This example show how to use the service proxy to talk to an HTTP based calculator service.</span></span>

-   [<span data-ttu-id="cd70a-108">HttpCalculatorClient. cpp</span><span class="sxs-lookup"><span data-stu-id="cd70a-108">HttpCalculatorClient.cpp</span></span>](#httpcalculatorclientcpp)
-   [<span data-ttu-id="cd70a-109">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="cd70a-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="cd70a-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="cd70a-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorclientcpp"></a><span data-ttu-id="cd70a-111">HttpCalculatorClient. cpp</span><span class="sxs-lookup"><span data-stu-id="cd70a-111">HttpCalculatorClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="cd70a-112">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="cd70a-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="cd70a-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="cd70a-113">Makefile</span></span>
