...
description: Revise un ejemplo de navegación XML que usa Windows Web Services API (WWSAPI). En este ejemplo se escribe XML en un búfer XML y, a continuación, se vuelve a leer.
