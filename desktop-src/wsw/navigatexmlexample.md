...
---
# <a name="navigatexmlexample"></a><span data-ttu-id="2f8f7-106">NavigateXmlExample</span><span class="sxs-lookup"><span data-stu-id="2f8f7-106">NavigateXmlExample</span></span>

<span data-ttu-id="2f8f7-107">Este ejemplo escribe XML en un búfer XML y, a continuación, lo lee de nuevo.</span><span class="sxs-lookup"><span data-stu-id="2f8f7-107">This example writes XML to an XML buffer, and then reads it back out.</span></span>

## <a name="navigatexmlcpp"></a><span data-ttu-id="2f8f7-108">NavigateXml. cpp</span><span class="sxs-lookup"><span data-stu-id="2f8f7-108">NavigateXml.cpp</span></span>
