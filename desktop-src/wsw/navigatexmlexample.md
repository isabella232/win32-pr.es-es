...
---
# <a name="navigatexmlexample"></a><span data-ttu-id="f8fb7-107">NavigateXmlExample</span><span class="sxs-lookup"><span data-stu-id="f8fb7-107">NavigateXmlExample</span></span>

<span data-ttu-id="f8fb7-108">En este ejemplo se escribe XML en un búfer XML y, a continuación, se vuelve a leer.</span><span class="sxs-lookup"><span data-stu-id="f8fb7-108">This example writes XML to an XML buffer, and then reads it back out.</span></span>

## <a name="navigatexmlcpp"></a><span data-ttu-id="f8fb7-109">NavigateXml.cpp</span><span class="sxs-lookup"><span data-stu-id="f8fb7-109">NavigateXml.cpp</span></span>
