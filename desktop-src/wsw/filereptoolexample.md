...
description: Esta es la herramienta de línea de comandos que controla el servicio FileRep.
...
ms.locfileid: "104269101"
---
# <a name="filereptoolexample"></a><span data-ttu-id="9f3a2-106">FileRepToolExample</span><span class="sxs-lookup"><span data-stu-id="9f3a2-106">FileRepToolExample</span></span>

<span data-ttu-id="9f3a2-107">Esta es la herramienta de línea de comandos que controla el [servicio FileRep](filerepserviceexample.md).</span><span class="sxs-lookup"><span data-stu-id="9f3a2-107">This is the command line tool that drives the [FileRep service](filerepserviceexample.md).</span></span> <span data-ttu-id="9f3a2-108">Puede encontrar una descripción más detallada de este ejemplo.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-108">A more detailed description of this sample can be found there.</span></span>

<span data-ttu-id="9f3a2-109">Los parámetros de la línea de comandos son los siguientes:</span><span class="sxs-lookup"><span data-stu-id="9f3a2-109">The command line parameters are as follows:</span></span>

<span data-ttu-id="9f3a2-110">WsFileRep.exe <Client Service Url> <Server Service Url> <Source File> <Destination File> \[ /Encoding: <Binary/Text/MTOM>\] \[ /Sync\]</span><span class="sxs-lookup"><span data-stu-id="9f3a2-110">WsFileRep.exe <Client Service Url> <Server Service Url> <Source File> <Destination File> \[/encoding:<binary/text/MTOM>\] \[/sync\]</span></span>

<span data-ttu-id="9f3a2-111">URL del servicio de cliente: obligatorio.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-111">Client Service Url: Mandatory.</span></span> <span data-ttu-id="9f3a2-112">Dirección URL del servicio de cliente.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-112">Url of the client service.</span></span>

<span data-ttu-id="9f3a2-113">URL del servicio de servidor: obligatorio.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-113">Server Service Url: Mandatory.</span></span> <span data-ttu-id="9f3a2-114">Dirección URL del servicio de servidor.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-114">Url of the server service.</span></span>

<span data-ttu-id="9f3a2-115">Archivo de origen: obligatorio.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-115">Source File: Mandatory.</span></span> <span data-ttu-id="9f3a2-116">Nombre local completo del archivo de código fuente.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-116">Fully qualified local name of the source file.</span></span> <span data-ttu-id="9f3a2-117">El archivo se encuentra en el equipo en el que se ejecuta el servicio de servidor.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-117">The file is located on the machine where the server service runs.</span></span>

<span data-ttu-id="9f3a2-118">Archivo de destino: obligatorio.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-118">Destination file: Mandatory.</span></span> <span data-ttu-id="9f3a2-119">Nombre local completo del archivo de destino.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-119">Fully qualified local name of the destination file.</span></span> <span data-ttu-id="9f3a2-120">El archivo se ubicará en el equipo en el que se ejecuta el servicio de cliente.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-120">The file will be located on the machine where the client service runs.</span></span>

<span data-ttu-id="9f3a2-121">Codificación: opcional.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-121">Encoding: Optional.</span></span> <span data-ttu-id="9f3a2-122">Especifica la codificación de mensajes para los mensajes enviados entre los servicios de cliente y servidor.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-122">Specifies the message encoding for the messages sent between the client and server services.</span></span> <span data-ttu-id="9f3a2-123">La codificación utilizada para la comunicación entre la herramienta de línea de comandos y el servicio de cliente no se puede cambiar por razones de simplicidad.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-123">The encoding used for the communication between the command line tool and the client service cannot be changed for simplicity reasons.</span></span> <span data-ttu-id="9f3a2-124">Los parámetros válidos son Binary, Text y MTOM.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-124">Valid parameters are binary, text and MTOM.</span></span> <span data-ttu-id="9f3a2-125">Si no se especifica el parámetro, se usa la codificación predeterminada para el transporte.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-125">If the parameter is not specified the default encoding for transport is used.</span></span>

<span data-ttu-id="9f3a2-126">Sincronización: opcional.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-126">Sync: Optional.</span></span> <span data-ttu-id="9f3a2-127">Cuando se establece, la solicitud se completa de forma sincrónica.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-127">When set, the request completes synchronously.</span></span> <span data-ttu-id="9f3a2-128">De lo contrario, la solicitud se completará de forma asincrónica.</span><span class="sxs-lookup"><span data-stu-id="9f3a2-128">Otherwise the request will complete asynchronously.</span></span>

-   [<span data-ttu-id="9f3a2-129">Herramienta. cpp</span><span class="sxs-lookup"><span data-stu-id="9f3a2-129">Tool.cpp</span></span>](#toolcpp)
-   [<span data-ttu-id="9f3a2-130">Common. h</span><span class="sxs-lookup"><span data-stu-id="9f3a2-130">common.h</span></span>](#commonh)
-   [<span data-ttu-id="9f3a2-131">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="9f3a2-131">Related topics</span></span>](#related-topics)

## <a name="toolcpp"></a><span data-ttu-id="9f3a2-132">Herramienta. cpp</span><span class="sxs-lookup"><span data-stu-id="9f3a2-132">Tool.cpp</span></span>
...
## <a name="commonh"></a><span data-ttu-id="9f3a2-133">common.h</span><span class="sxs-lookup"><span data-stu-id="9f3a2-133">common.h</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="9f3a2-134">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="9f3a2-134">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="9f3a2-135">FileRepServiceExample</span><span class="sxs-lookup"><span data-stu-id="9f3a2-135">FileRepServiceExample</span></span>](filerepserviceexample.md)
</dt> </dl>
