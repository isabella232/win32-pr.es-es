...
---
# <a name="readwritebytesxmlexample"></a><span data-ttu-id="b6a60-106">ReadWriteBytesXmlExample</span><span class="sxs-lookup"><span data-stu-id="b6a60-106">ReadWriteBytesXmlExample</span></span>

<span data-ttu-id="b6a60-107">En este ejemplo se escriben datos binarios mediante la codificación MTOM y se vuelve a leer.</span><span class="sxs-lookup"><span data-stu-id="b6a60-107">This example writes binary data using the MTOM encoding and reads it back out.</span></span>

## <a name="readwritebytesxmlcpp"></a><span data-ttu-id="b6a60-108">ReadWriteBytesXml. cpp</span><span class="sxs-lookup"><span data-stu-id="b6a60-108">ReadWriteBytesXml.cpp</span></span>
