...
---
# <a name="streamingtcpserverexample"></a><span data-ttu-id="08f20-106">StreamingTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="08f20-106">StreamingTcpServerExample</span></span>

<span data-ttu-id="08f20-107">Este ejemplo muestra un servidor TCP que acepta un canal y Lee los mensajes unidireccionales de una manera de transmisión por secuencias.</span><span class="sxs-lookup"><span data-stu-id="08f20-107">This example shows a TCP server that accepts a channel, and reads one-way messages in a streaming fashion.</span></span>

-   [<span data-ttu-id="08f20-108">StreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="08f20-108">StreamingTcpServer.cpp</span></span>](#streamingtcpservercpp)
-   [<span data-ttu-id="08f20-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="08f20-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="08f20-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="08f20-110">Makefile</span></span>](#makefile)

## <a name="streamingtcpservercpp"></a><span data-ttu-id="08f20-111">StreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="08f20-111">StreamingTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="08f20-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="08f20-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="08f20-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="08f20-113">Makefile</span></span>
