...
description: En este ejemplo se muestra cómo usar el proxy de servicio para comunicarse con un servicio PurchaseOrder basado en HTTP.
...
ms.locfileid: "104075912"
---
# <a name="httppurchaseorderclientexample"></a><span data-ttu-id="eac8b-106">HttpPurchaseOrderClientExample</span><span class="sxs-lookup"><span data-stu-id="eac8b-106">HttpPurchaseOrderClientExample</span></span>

<span data-ttu-id="eac8b-107">En este ejemplo se muestra cómo usar el proxy de servicio para comunicarse con un servicio PurchaseOrder basado en HTTP.</span><span class="sxs-lookup"><span data-stu-id="eac8b-107">This example show how to use the service proxy to talk to an HTTP based PurchaseOrder service.</span></span>

-   [<span data-ttu-id="eac8b-108">HttpPurchaseOrderClient. cpp</span><span class="sxs-lookup"><span data-stu-id="eac8b-108">HttpPurchaseOrderClient.cpp</span></span>](#httppurchaseorderclientcpp)
-   [<span data-ttu-id="eac8b-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="eac8b-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="eac8b-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="eac8b-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderclientcpp"></a><span data-ttu-id="eac8b-111">HttpPurchaseOrderClient. cpp</span><span class="sxs-lookup"><span data-stu-id="eac8b-111">HttpPurchaseOrderClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="eac8b-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="eac8b-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="eac8b-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="eac8b-113">Makefile</span></span>
