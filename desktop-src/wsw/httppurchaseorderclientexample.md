...
description: En este ejemplo se muestra cómo usar el proxy de servicio para hablar con un servicio PurchaseOrder basado en HTTP.
...
ms.locfileid: "127256059"
---
# <a name="httppurchaseorderclientexample"></a>HttpPurchaseOrderClientExample

En este ejemplo se muestra cómo usar el proxy de servicio para hablar con un servicio PurchaseOrder basado en HTTP.
