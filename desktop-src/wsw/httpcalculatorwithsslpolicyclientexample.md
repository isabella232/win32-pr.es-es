...
description: En este ejemplo se muestra cómo usar las rutinas de aplicación auxiliar de directivas generadas por wsutil para crear un proxy de servicio para comunicarse con un servicio de calculadora, con seguridad de transporte SSL.
...
ms.locfileid: "103994297"
---
# <a name="httpcalculatorwithsslpolicyclientexample"></a><span data-ttu-id="3cbbc-106">HttpCalculatorWithSslPolicyClientExample</span><span class="sxs-lookup"><span data-stu-id="3cbbc-106">HttpCalculatorWithSslPolicyClientExample</span></span>

<span data-ttu-id="3cbbc-107">En este ejemplo se muestra cómo usar las rutinas de aplicación auxiliar de directivas generadas por wsutil para crear un proxy de servicio para comunicarse con un servicio de calculadora, con seguridad de transporte SSL.</span><span class="sxs-lookup"><span data-stu-id="3cbbc-107">This example shows how to use the wsutil generated policy helper routines to create service proxy to talk to a calculator service, with SSL transport security.</span></span> <span data-ttu-id="3cbbc-108">En esta configuración, la conexión de transporte está protegida (firmada, cifrada) por SSL, que también proporciona autenticación de servidor.</span><span class="sxs-lookup"><span data-stu-id="3cbbc-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span>

-   [<span data-ttu-id="3cbbc-109">HttpCalculatorWithSslPolicyClient. cpp</span><span class="sxs-lookup"><span data-stu-id="3cbbc-109">HttpCalculatorWithSslPolicyClient.cpp</span></span>](#httpcalculatorwithsslpolicyclientcpp)
-   [<span data-ttu-id="3cbbc-110">CalculatorServiceWithPolicy. wsdl</span><span class="sxs-lookup"><span data-stu-id="3cbbc-110">CalculatorServiceWithPolicy.wsdl</span></span>](#calculatorservicewithpolicywsdl)
-   [<span data-ttu-id="3cbbc-111">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="3cbbc-111">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithsslpolicyclientcpp"></a><span data-ttu-id="3cbbc-112">HttpCalculatorWithSslPolicyClient. cpp</span><span class="sxs-lookup"><span data-stu-id="3cbbc-112">HttpCalculatorWithSslPolicyClient.cpp</span></span>
...
## <a name="calculatorservicewithpolicywsdl"></a><span data-ttu-id="3cbbc-113">CalculatorServiceWithPolicy. wsdl</span><span class="sxs-lookup"><span data-stu-id="3cbbc-113">CalculatorServiceWithPolicy.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="3cbbc-114">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="3cbbc-114">Makefile</span></span>
