...
description: En este ejemplo se muestra cómo usar el host de servicio para hospedar un servicio PurchaseOrder a través de HTTP, con seguridad de transporte SSL.
...
---
# <a name="httppurchaseorderwithsslserviceexample"></a><span data-ttu-id="d13b4-106">HttpPurchaseOrderWithSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="d13b4-106">HttpPurchaseOrderWithSslServiceExample</span></span>

<span data-ttu-id="d13b4-107">En este ejemplo se muestra cómo usar el host de servicio para hospedar un servicio PurchaseOrder a través de HTTP, con seguridad de transporte SSL.</span><span class="sxs-lookup"><span data-stu-id="d13b4-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with SSL transport security.</span></span>

-   [<span data-ttu-id="d13b4-108">HttpPurchaseOrderServiceWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="d13b4-108">HttpPurchaseOrderServiceWithSsl.cpp</span></span>](#httppurchaseorderservicewithsslcpp)
-   [<span data-ttu-id="d13b4-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="d13b4-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="d13b4-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="d13b4-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderservicewithsslcpp"></a><span data-ttu-id="d13b4-111">HttpPurchaseOrderServiceWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="d13b4-111">HttpPurchaseOrderServiceWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="d13b4-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="d13b4-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="d13b4-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="d13b4-113">Makefile</span></span>
