...
<span id="Connections"></span><span id="connections"></span><span id="CONNECTIONS"></span>Conexiones
</dt> <dd>

Opcional. Especifica el número máximo de solicitudes simultáneas que se procesarán. Si se omite, el valor predeterminado es 100.
