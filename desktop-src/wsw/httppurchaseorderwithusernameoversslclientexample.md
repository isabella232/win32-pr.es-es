...
description: En este ejemplo se muestra un cliente HTTP que usa el proxy de servicio para hablar con un servicio PurchaseOrder, con el nombre de usuario sobre la seguridad en modo mixto de SSL.
