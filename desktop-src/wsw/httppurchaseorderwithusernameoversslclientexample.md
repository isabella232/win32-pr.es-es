...
description: En este ejemplo se muestra un cliente HTTP que usa el proxy de servicio para comunicarse con un servicio PurchaseOrder, con la seguridad de modo mixto de nombre de usuario sobre SSL.
...
ms.locfileid: "104269114"
---
# <a name="httppurchaseorderwithusernameoversslclientexample"></a><span data-ttu-id="45737-106">HttpPurchaseOrderWithUsernameOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="45737-106">HttpPurchaseOrderWithUsernameOverSslClientExample</span></span>

<span data-ttu-id="45737-107">En este ejemplo se muestra un cliente HTTP que usa el proxy de servicio para comunicarse con un servicio PurchaseOrder, con la seguridad de modo mixto de nombre de usuario sobre SSL.</span><span class="sxs-lookup"><span data-stu-id="45737-107">This example shows a HTTP client that uses service proxy to talk to a PurchaseOrder service, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="45737-108">En esta configuración, la conexión de transporte está protegida (firmada, cifrada) por SSL, que también proporciona autenticación de servidor.</span><span class="sxs-lookup"><span data-stu-id="45737-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="45737-109">La autenticación del cliente se proporciona mediante un par de nombre de usuario y contraseña en un encabezado de WS-Security en el mensaje.</span><span class="sxs-lookup"><span data-stu-id="45737-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="45737-110">PurchaseOrderClientUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="45737-110">PurchaseOrderClientUserNameOverSsl.cpp</span></span>](#purchaseorderclientusernameoversslcpp)
-   [<span data-ttu-id="45737-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="45737-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="45737-112">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="45737-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderclientusernameoversslcpp"></a><span data-ttu-id="45737-113">PurchaseOrderClientUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="45737-113">PurchaseOrderClientUserNameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="45737-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="45737-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="45737-115">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="45737-115">Makefile</span></span>
