...
description: En este ejemplo se muestra un servidor HTTP que acepta un canal y realiza el procesamiento de solicitud-respuesta en streaming.
...
ms.locfileid: "103903921"
---
# <a name="streaminghttpserverexample"></a><span data-ttu-id="804c1-106">StreamingHttpServerExample</span><span class="sxs-lookup"><span data-stu-id="804c1-106">StreamingHttpServerExample</span></span>

<span data-ttu-id="804c1-107">En este ejemplo se muestra un servidor HTTP que acepta un canal y realiza el procesamiento de solicitud-respuesta en streaming.</span><span class="sxs-lookup"><span data-stu-id="804c1-107">This example shows an HTTP server that accepts a channel, and does request-reply processing in a streaming fashion.</span></span>

-   [<span data-ttu-id="804c1-108">StreamingHttpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="804c1-108">StreamingHttpServer.cpp</span></span>](#streaminghttpservercpp)
-   [<span data-ttu-id="804c1-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="804c1-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="804c1-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="804c1-110">Makefile</span></span>](#makefile)

## <a name="streaminghttpservercpp"></a><span data-ttu-id="804c1-111">StreamingHttpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="804c1-111">StreamingHttpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="804c1-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="804c1-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="804c1-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="804c1-113">Makefile</span></span>
