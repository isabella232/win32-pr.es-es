...
description: Aplicación de servicio de ejemplo que muestra la cancelación de llamadas del lado servidor.
...
ms.locfileid: "104075801"
---
# <a name="blockingserviceexample"></a><span data-ttu-id="37bbd-106">BlockingServiceExample</span><span class="sxs-lookup"><span data-stu-id="37bbd-106">BlockingServiceExample</span></span>

<span data-ttu-id="37bbd-107">Aplicación de servicio de ejemplo que muestra la cancelación de llamadas del lado servidor.</span><span class="sxs-lookup"><span data-stu-id="37bbd-107">Example service application demonstrating server side call cancellation.</span></span>

-   [<span data-ttu-id="37bbd-108">CancellingService. cpp</span><span class="sxs-lookup"><span data-stu-id="37bbd-108">CancellingService.cpp</span></span>](#cancellingservicecpp)
-   [<span data-ttu-id="37bbd-109">BlockUnBlockService. wsdl</span><span class="sxs-lookup"><span data-stu-id="37bbd-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="37bbd-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="37bbd-110">Makefile</span></span>](#makefile)

## <a name="cancellingservicecpp"></a><span data-ttu-id="37bbd-111">CancellingService. cpp</span><span class="sxs-lookup"><span data-stu-id="37bbd-111">CancellingService.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="37bbd-112">BlockUnBlockService. wsdl</span><span class="sxs-lookup"><span data-stu-id="37bbd-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="37bbd-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="37bbd-113">Makefile</span></span>
