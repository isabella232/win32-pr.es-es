...
description: En este ejemplo se muestra un cliente TCP que envía mensajes de solicitud-respuesta.
...
---
# <a name="requestreplytcpclientexample"></a><span data-ttu-id="5f390-106">RequestReplyTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="5f390-106">RequestReplyTcpClientExample</span></span>

<span data-ttu-id="5f390-107">En este ejemplo se muestra un cliente TCP que envía mensajes de solicitud-respuesta.</span><span class="sxs-lookup"><span data-stu-id="5f390-107">This example shows a TCP client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="5f390-108">RequestReplyTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="5f390-108">RequestReplyTcpClient.cpp</span></span>](#requestreplytcpclientcpp)
-   [<span data-ttu-id="5f390-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="5f390-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="5f390-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="5f390-110">Makefile</span></span>](#makefile)

## <a name="requestreplytcpclientcpp"></a><span data-ttu-id="5f390-111">RequestReplyTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="5f390-111">RequestReplyTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="5f390-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="5f390-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="5f390-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="5f390-113">Makefile</span></span>
