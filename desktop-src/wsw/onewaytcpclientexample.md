...
---
# <a name="onewaytcpclientexample"></a><span data-ttu-id="264b9-106">OneWayTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="264b9-106">OneWayTcpClientExample</span></span>

<span data-ttu-id="264b9-107">En este ejemplo se muestra un cliente TCP que envía mensajes unidireccionales.</span><span class="sxs-lookup"><span data-stu-id="264b9-107">This example shows a TCP client that sends a one-way messages.</span></span>

-   [<span data-ttu-id="264b9-108">OneWayTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="264b9-108">OneWayTcpClient.cpp</span></span>](#onewaytcpclientcpp)
-   [<span data-ttu-id="264b9-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="264b9-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="264b9-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="264b9-110">Makefile</span></span>](#makefile)

## <a name="onewaytcpclientcpp"></a><span data-ttu-id="264b9-111">OneWayTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="264b9-111">OneWayTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="264b9-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="264b9-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="264b9-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="264b9-113">Makefile</span></span>
