...
Los archivos CSV creados por wstrace.bat archivos de texto de variables separadas por comas simples. Estos archivos se pueden abrir en Excel, Bloc de notas, etc.
