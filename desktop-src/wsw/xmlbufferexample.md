...
---
# <a name="xmlbufferexample"></a><span data-ttu-id="d40e9-106">XmlBufferExample</span><span class="sxs-lookup"><span data-stu-id="d40e9-106">XmlBufferExample</span></span>

<span data-ttu-id="d40e9-107">En este ejemplo se muestra el uso de las API de búfer XML.</span><span class="sxs-lookup"><span data-stu-id="d40e9-107">This example shows some use of the xml buffer APIs.</span></span>

## <a name="xmlbuffercpp"></a><span data-ttu-id="d40e9-108">XmlBuffer. cpp</span><span class="sxs-lookup"><span data-stu-id="d40e9-108">XmlBuffer.cpp</span></span>
