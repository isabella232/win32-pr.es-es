...
description: En este ejemplo se muestra la importación de metadatos de un punto de conexión que admite el enlace de seguridad de mensaje de WS \_ username \_ con el enlace de \_ seguridad de \_ \_ transporte WS SSL \_ \_ \_ .
ms.assetid: 1bce97e2-a841-4c4b-af5e-f747c3fb6e8d
keywords:
- MetadataImportWithUsernameOverSslExample API de servicios Web de Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105695244"
---
# <a name="metadataimportwithusernameoversslexample"></a><span data-ttu-id="8d9cb-106">MetadataImportWithUsernameOverSslExample</span><span class="sxs-lookup"><span data-stu-id="8d9cb-106">MetadataImportWithUsernameOverSslExample</span></span>

<span data-ttu-id="8d9cb-107">En este ejemplo se muestra la importación de metadatos de un punto de conexión que admite el [**enlace de seguridad de mensaje de WS \_ username \_ \_ \_**](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding) con el enlace de [**\_ seguridad de \_ transporte \_ \_ WS SSL**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span><span class="sxs-lookup"><span data-stu-id="8d9cb-107">This example illustrates importing metadata from an endpoint that supports [**WS\_USERNAME\_MESSAGE\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding) with [**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span></span>

## <a name="metadataimportwithusernameoversslexamplecpp"></a><span data-ttu-id="8d9cb-108">MetadataImportWithUsernameOverSslExample. cpp</span><span class="sxs-lookup"><span data-stu-id="8d9cb-108">MetadataImportWithUsernameOverSslExample.cpp</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="8d9cb-109">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="8d9cb-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="8d9cb-110">**\_enlace de \_ seguridad de mensaje \_ \_ de WS username**</span><span class="sxs-lookup"><span data-stu-id="8d9cb-110">**WS\_USERNAME\_MESSAGE\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding)
</dt> <dt>

[<span data-ttu-id="8d9cb-111">**\_enlace de \_ seguridad de transporte WS SSL \_ \_**</span><span class="sxs-lookup"><span data-stu-id="8d9cb-111">**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)
</dt> </dl>
