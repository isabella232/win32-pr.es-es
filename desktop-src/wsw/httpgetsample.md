---
title: HttpGetSample
description: En este ejemplo se muestra cómo usar el host de servicio para hospedar un servicio PurchaseOrder a través de HTTP. El servicio expone metadatos sobre HTTP GET y WS-Metadata Exchange v 1.1. El servicio también muestra cómo implementar una portada para un servicio de WWSAPI.
...
ms.locfileid: "104420128"
---
# <a name="httpgetsample"></a><span data-ttu-id="5f560-108">HttpGetSample</span><span class="sxs-lookup"><span data-stu-id="5f560-108">HttpGetSample</span></span>

<span data-ttu-id="5f560-109">En este ejemplo se muestra cómo usar el host de servicio para hospedar un servicio PurchaseOrder a través de HTTP.</span><span class="sxs-lookup"><span data-stu-id="5f560-109">This example shows how to use service host for hosting a PurchaseOrder service over HTTP.</span></span> <span data-ttu-id="5f560-110">El servicio expone metadatos sobre HTTP GET y WS-Metadata Exchange v 1.1.</span><span class="sxs-lookup"><span data-stu-id="5f560-110">The service exposes metadata over HTTP GET and WS-Metadata Exchange v1.1.</span></span> <span data-ttu-id="5f560-111">El servicio también muestra cómo implementar una portada para un servicio de WWSAPI.</span><span class="sxs-lookup"><span data-stu-id="5f560-111">The service also shows how to implement a cover page for a WWSAPI service.</span></span>

-   [<span data-ttu-id="5f560-112">HttpGetService. cpp</span><span class="sxs-lookup"><span data-stu-id="5f560-112">HttpGetService.cpp</span></span>](#httpgetservicecpp)
-   [<span data-ttu-id="5f560-113">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="5f560-113">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="5f560-114">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="5f560-114">Makefile</span></span>](#makefile)

## <a name="httpgetservicecpp"></a><span data-ttu-id="5f560-115">HttpGetService. cpp</span><span class="sxs-lookup"><span data-stu-id="5f560-115">HttpGetService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="5f560-116">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="5f560-116">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="5f560-117">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="5f560-117">Makefile</span></span>
