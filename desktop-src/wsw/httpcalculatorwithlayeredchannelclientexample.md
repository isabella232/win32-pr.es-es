...
---
# <a name="httpcalculatorwithlayeredchannelclientexample"></a><span data-ttu-id="e1dd1-107">HttpCalculatorWithLayeredChannelClientExample</span><span class="sxs-lookup"><span data-stu-id="e1dd1-107">HttpCalculatorWithLayeredChannelClientExample</span></span>

<span data-ttu-id="e1dd1-108">En este ejemplo se muestra cómo usar el proxy de servicio para comunicarse con un servicio de calculadora basado en HTTP mediante un canal personalizado.</span><span class="sxs-lookup"><span data-stu-id="e1dd1-108">This example show how to use the service proxy to talk to an HTTP based calculator service using a custom channel.</span></span> <span data-ttu-id="e1dd1-109">El canal personalizado es un canal en capas que simplemente delega toda la funcionalidad en el canal HTTP existente.</span><span class="sxs-lookup"><span data-stu-id="e1dd1-109">The custom channel is a layered channel which simply delegates all functionality to the existing HTTP channel.</span></span>

-   [<span data-ttu-id="e1dd1-110">HttpCalculatorWithLayeredChannelClient. cpp</span><span class="sxs-lookup"><span data-stu-id="e1dd1-110">HttpCalculatorWithLayeredChannelClient.cpp</span></span>](#httpcalculatorwithlayeredchannelclientcpp)
-   [<span data-ttu-id="e1dd1-111">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="e1dd1-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="e1dd1-112">LayeredChannel. h</span><span class="sxs-lookup"><span data-stu-id="e1dd1-112">LayeredChannel.h</span></span>](#layeredchannelh)
-   [<span data-ttu-id="e1dd1-113">LayeredChannel. cpp</span><span class="sxs-lookup"><span data-stu-id="e1dd1-113">LayeredChannel.cpp</span></span>](#layeredchannelcpp)
-   [<span data-ttu-id="e1dd1-114">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="e1dd1-114">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithlayeredchannelclientcpp"></a><span data-ttu-id="e1dd1-115">HttpCalculatorWithLayeredChannelClient. cpp</span><span class="sxs-lookup"><span data-stu-id="e1dd1-115">HttpCalculatorWithLayeredChannelClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="e1dd1-116">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="e1dd1-116">CalculatorService.wsdl</span></span>
...
## <a name="layeredchannelh"></a><span data-ttu-id="e1dd1-117">LayeredChannel. h</span><span class="sxs-lookup"><span data-stu-id="e1dd1-117">LayeredChannel.h</span></span>
...
## <a name="layeredchannelcpp"></a><span data-ttu-id="e1dd1-118">LayeredChannel. cpp</span><span class="sxs-lookup"><span data-stu-id="e1dd1-118">LayeredChannel.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="e1dd1-119">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="e1dd1-119">Makefile</span></span>
