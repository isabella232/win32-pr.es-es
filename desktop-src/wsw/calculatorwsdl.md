...
description: Este es un ejemplo de WSDL/Schema para los ejemplos de servicio de la calculadora.
ms.assetid: 6dbea7dc-2d5c-4e6d-9941-9a93943e1914
keywords:
- Servicios Web de CalculatorWsdl para Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103785505"
---
# <a name="calculatorwsdl"></a><span data-ttu-id="42424-106">CalculatorWsdl</span><span class="sxs-lookup"><span data-stu-id="42424-106">CalculatorWsdl</span></span>

<span data-ttu-id="42424-107">Este es un ejemplo de WSDL/Schema para los ejemplos de servicio de la calculadora.</span><span class="sxs-lookup"><span data-stu-id="42424-107">This is an example wsdl/schema for the calculator service samples.</span></span>

## <a name="calculatorwsdl"></a><span data-ttu-id="42424-108">Calculadora. wsdl</span><span class="sxs-lookup"><span data-stu-id="42424-108">Calculator.wsdl</span></span>
