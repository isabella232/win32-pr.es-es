...
---
# <a name="policytemplateexample"></a><span data-ttu-id="38b11-106">PolicyTemplateExample</span><span class="sxs-lookup"><span data-stu-id="38b11-106">PolicyTemplateExample</span></span>

<span data-ttu-id="38b11-107">Este ejemplo muestra cómo crear manualmente la descripción de la Directiva y usarla para crear el proxy del servicio.</span><span class="sxs-lookup"><span data-stu-id="38b11-107">This example illustrates how to manually create policy description and use it to create service proxy.</span></span>

-   [<span data-ttu-id="38b11-108">PolicyTemplate. cpp</span><span class="sxs-lookup"><span data-stu-id="38b11-108">PolicyTemplate.cpp</span></span>](#policytemplatecpp)
-   [<span data-ttu-id="38b11-109">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="38b11-109">Makefile</span></span>](#makefile)

## <a name="policytemplatecpp"></a><span data-ttu-id="38b11-110">PolicyTemplate. cpp</span><span class="sxs-lookup"><span data-stu-id="38b11-110">PolicyTemplate.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="38b11-111">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="38b11-111">Makefile</span></span>
