...
description: En este ejemplo se muestra la importación de metadatos de un punto de conexión que admite el uso de un token X509 mediante el enlace de seguridad de mensaje de token de WS \_ XML \_ con el \_ \_ \_ \_ enlace de seguridad de transporte WS SSL \_ \_ \_ .
ms.assetid: 9dbeea65-1752-4fe1-b425-f622e24acef0
keywords:
- MetadataImportWithX509OverSslExample API de servicios Web de Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103774479"
---
# <a name="metadataimportwithx509oversslexample"></a><span data-ttu-id="2cd0a-106">MetadataImportWithX509OverSslExample</span><span class="sxs-lookup"><span data-stu-id="2cd0a-106">MetadataImportWithX509OverSslExample</span></span>

<span data-ttu-id="2cd0a-107">En este ejemplo se muestra la importación de metadatos de un punto de conexión que admite el uso de un token X509 mediante el [**enlace de seguridad de mensaje de token de WS \_ XML \_ \_ \_ \_**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) con el enlace de [**\_ seguridad de \_ transporte \_ \_ WS SSL**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span><span class="sxs-lookup"><span data-stu-id="2cd0a-107">This example illustrates importing metadata from an endpoint that supports using a X509 token using [**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) with [**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span></span>

## <a name="metadataimportwithx509oversslexamplecpp"></a><span data-ttu-id="2cd0a-108">MetadataImportWithX509OverSslExample. cpp</span><span class="sxs-lookup"><span data-stu-id="2cd0a-108">MetadataImportWithX509OverSslExample.cpp</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="2cd0a-109">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="2cd0a-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="2cd0a-110">**\_enlace de \_ seguridad de mensaje de token \_ \_ de WS XML \_**</span><span class="sxs-lookup"><span data-stu-id="2cd0a-110">**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding)
</dt> <dt>

[<span data-ttu-id="2cd0a-111">**\_enlace de \_ seguridad de transporte WS SSL \_ \_**</span><span class="sxs-lookup"><span data-stu-id="2cd0a-111">**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)
</dt> </dl>
