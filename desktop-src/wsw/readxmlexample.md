...
description: En este ejemplo se lee un nodo XML por nodo.
ms.assetid: 938825f6-43dd-4e24-a04d-c46290509a64
keywords:
- Servicios Web de ReadXmlExample para Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104268234"
---
# <a name="readxmlexample"></a><span data-ttu-id="4ef03-106">ReadXmlExample</span><span class="sxs-lookup"><span data-stu-id="4ef03-106">ReadXmlExample</span></span>

<span data-ttu-id="4ef03-107">En este ejemplo se lee un nodo XML por nodo.</span><span class="sxs-lookup"><span data-stu-id="4ef03-107">This example reads XML node by node.</span></span>

## <a name="readxmlcpp"></a><span data-ttu-id="4ef03-108">ReadXml. cpp</span><span class="sxs-lookup"><span data-stu-id="4ef03-108">ReadXml.cpp</span></span>
