...
description: En este ejemplo se muestra la implementación de una función asincrónica compleja mediante WsAsyncExecute.
ms.assetid: f84de03f-ecfb-494e-9a1d-a96d399a41c0
keywords:
- Servicios Web de AsyncAdd3ImplicitExample para Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103777125"
---
# <a name="asyncadd3implicitexample"></a><span data-ttu-id="bde8f-106">AsyncAdd3ImplicitExample</span><span class="sxs-lookup"><span data-stu-id="bde8f-106">AsyncAdd3ImplicitExample</span></span>

<span data-ttu-id="bde8f-107">En este ejemplo se muestra la implementación de una función asincrónica compleja mediante [**WsAsyncExecute**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).</span><span class="sxs-lookup"><span data-stu-id="bde8f-107">This example illustrates implementing a complex asynchronous function using [**WsAsyncExecute**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).</span></span>

<span data-ttu-id="bde8f-108">En el ejemplo se implementa una función asincrónica ' AddThree ' que agrega tres enteros juntos mediante la compilación de una función Add existente que puede agregar dos enteros de forma asincrónica.</span><span class="sxs-lookup"><span data-stu-id="bde8f-108">The example implements an asynchronous function 'AddThree' which adds three integers together by building upon an existing Add function which can add two integers asynchronously.</span></span>

## <a name="asyncadd3implicitcpp"></a><span data-ttu-id="bde8f-109">AsyncAdd3Implicit. cpp</span><span class="sxs-lookup"><span data-stu-id="bde8f-109">AsyncAdd3Implicit.cpp</span></span>
