...
description: Revise un ejemplo de cliente HTTP que usa Windows Web Services API (WWSAPI). En este ejemplo se muestra un cliente HTTP que envía mensajes de solicitud-respuesta.
