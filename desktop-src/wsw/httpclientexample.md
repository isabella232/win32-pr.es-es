...
description: Revise un ejemplo de cliente HTTP que usa la API de servicios web de Windows (WWSAPI). En este ejemplo se muestra un cliente HTTP que envía mensajes de solicitud-respuesta.
...
ms.locfileid: "112404138"
---
# <a name="httpclientexample"></a><span data-ttu-id="0d2c5-107">HttpClientExample</span><span class="sxs-lookup"><span data-stu-id="0d2c5-107">HttpClientExample</span></span>

<span data-ttu-id="0d2c5-108">En este ejemplo se muestra un cliente HTTP que envía mensajes de solicitud-respuesta.</span><span class="sxs-lookup"><span data-stu-id="0d2c5-108">This example shows a HTTP client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="0d2c5-109">HttpClient.cpp</span><span class="sxs-lookup"><span data-stu-id="0d2c5-109">HttpClient.cpp</span></span>](#httpclientcpp)
-   [<span data-ttu-id="0d2c5-110">PurchaseOrder.wsdl</span><span class="sxs-lookup"><span data-stu-id="0d2c5-110">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="0d2c5-111">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="0d2c5-111">Makefile</span></span>](#makefile)

## <a name="httpclientcpp"></a><span data-ttu-id="0d2c5-112">HttpClient.cpp</span><span class="sxs-lookup"><span data-stu-id="0d2c5-112">HttpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="0d2c5-113">PurchaseOrder.wsdl</span><span class="sxs-lookup"><span data-stu-id="0d2c5-113">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0d2c5-114">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="0d2c5-114">Makefile</span></span>
