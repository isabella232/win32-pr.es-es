...
---
# <a name="readxmlsimpleexample"></a><span data-ttu-id="89eff-106">ReadXmlSimpleExample</span><span class="sxs-lookup"><span data-stu-id="89eff-106">ReadXmlSimpleExample</span></span>

<span data-ttu-id="89eff-107">En este ejemplo se lee un documento XML simple.</span><span class="sxs-lookup"><span data-stu-id="89eff-107">This example reads a simple xml document.</span></span>

## <a name="readxmlsimplecpp"></a><span data-ttu-id="89eff-108">ReadXmlSimple. cpp</span><span class="sxs-lookup"><span data-stu-id="89eff-108">ReadXmlSimple.cpp</span></span>
