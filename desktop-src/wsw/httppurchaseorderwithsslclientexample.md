...
---
# <a name="httppurchaseorderwithsslclientexample"></a><span data-ttu-id="fe004-106">HttpPurchaseOrderWithSslClientExample</span><span class="sxs-lookup"><span data-stu-id="fe004-106">HttpPurchaseOrderWithSslClientExample</span></span>

<span data-ttu-id="fe004-107">En este ejemplo se muestra cómo usar el proxy de servicio para comunicarse con un servicio PurchaseOrder, con seguridad de transporte SSL.</span><span class="sxs-lookup"><span data-stu-id="fe004-107">This example show how to use the service proxy to talk to a PurchaseOrder service, with SSL transport security.</span></span>

-   [<span data-ttu-id="fe004-108">HttpPurchaseOrderClientWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="fe004-108">HttpPurchaseOrderClientWithSsl.cpp</span></span>](#httppurchaseorderclientwithsslcpp)
-   [<span data-ttu-id="fe004-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="fe004-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="fe004-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="fe004-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderclientwithsslcpp"></a><span data-ttu-id="fe004-111">HttpPurchaseOrderClientWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="fe004-111">HttpPurchaseOrderClientWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="fe004-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="fe004-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="fe004-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="fe004-113">Makefile</span></span>
