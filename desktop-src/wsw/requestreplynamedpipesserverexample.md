...
description: En este ejemplo se muestra un servidor de canalizaciones con nombre que acepta un canal y recibe y responde a los mensajes.
...
ms.locfileid: "103772775"
---
# <a name="requestreplynamedpipesserverexample"></a><span data-ttu-id="5bd0e-103">RequestReplyNamedPipesServerExample</span><span class="sxs-lookup"><span data-stu-id="5bd0e-103">RequestReplyNamedPipesServerExample</span></span>

<span data-ttu-id="5bd0e-104">En este ejemplo se muestra un servidor de canalizaciones con nombre que acepta un canal y recibe y responde a los mensajes.</span><span class="sxs-lookup"><span data-stu-id="5bd0e-104">This example shows a named pipes server that accepts a channel and receives and replies to messages.</span></span>

-   [<span data-ttu-id="5bd0e-105">RequestReplyNamedPipesServer. cpp</span><span class="sxs-lookup"><span data-stu-id="5bd0e-105">RequestReplyNamedPipesServer.cpp</span></span>](#requestreplynamedpipesservercpp)
-   [<span data-ttu-id="5bd0e-106">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="5bd0e-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="5bd0e-107">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="5bd0e-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesservercpp"></a><span data-ttu-id="5bd0e-108">RequestReplyNamedPipesServer. cpp</span><span class="sxs-lookup"><span data-stu-id="5bd0e-108">RequestReplyNamedPipesServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="5bd0e-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="5bd0e-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="5bd0e-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="5bd0e-110">Makefile</span></span>
