...
description: En este ejemplo se muestra un servidor UDP que realiza escuchas en una dirección de multidifusión y responde a las solicitudes enviadas a esa dirección.
...
ms.locfileid: "105656264"
---
# <a name="multicastudpserverexample"></a><span data-ttu-id="e7289-106">MulticastUdpServerExample</span><span class="sxs-lookup"><span data-stu-id="e7289-106">MulticastUdpServerExample</span></span>

<span data-ttu-id="e7289-107">En este ejemplo se muestra un servidor UDP que realiza escuchas en una dirección de multidifusión y responde a las solicitudes enviadas a esa dirección.</span><span class="sxs-lookup"><span data-stu-id="e7289-107">This example shows a UDP server that listens on a multicast address and replies to requests sent to that address.</span></span>

-   [<span data-ttu-id="e7289-108">MulticastUdpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="e7289-108">MulticastUdpServer.cpp</span></span>](#multicastudpservercpp)
-   [<span data-ttu-id="e7289-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="e7289-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="e7289-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="e7289-110">Makefile</span></span>](#makefile)

## <a name="multicastudpservercpp"></a><span data-ttu-id="e7289-111">MulticastUdpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="e7289-111">MulticastUdpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="e7289-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="e7289-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="e7289-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="e7289-113">Makefile</span></span>
