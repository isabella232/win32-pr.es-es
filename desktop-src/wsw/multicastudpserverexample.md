...
En este ejemplo se muestra un servidor UDP que realiza escuchas en una dirección de multidifusión y responde a las solicitudes enviadas a esa dirección.
