...
---
# <a name="derivedtypeexample"></a><span data-ttu-id="4bad0-107">DerivedTypeExample</span><span class="sxs-lookup"><span data-stu-id="4bad0-107">DerivedTypeExample</span></span>

<span data-ttu-id="4bad0-108">En este ejemplo se escriben y se leen los tipos derivados mediante las funciones auxiliares de C++ generadas por Wsutil.</span><span class="sxs-lookup"><span data-stu-id="4bad0-108">This example writes and reads derived types using Wsutil generated C++ helper functions.</span></span> <span data-ttu-id="4bad0-109">Vea [**\_ asignación de \_ \_ campos de \_ atributos de tipo WS**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) para obtener más información sobre las descripciones de tipos derivados.</span><span class="sxs-lookup"><span data-stu-id="4bad0-109">See [**WS\_TYPE\_ATTRIBUTE\_FIELD\_MAPPING**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) for more about derived type descriptions.</span></span>

-   [<span data-ttu-id="4bad0-110">DerivedType. cpp</span><span class="sxs-lookup"><span data-stu-id="4bad0-110">DerivedType.cpp</span></span>](#derivedtypecpp)
-   [<span data-ttu-id="4bad0-111">DerivedType. xsd</span><span class="sxs-lookup"><span data-stu-id="4bad0-111">DerivedType.xsd</span></span>](#derivedtypexsd)
-   [<span data-ttu-id="4bad0-112">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="4bad0-112">Related topics</span></span>](#related-topics)

## <a name="derivedtypecpp"></a><span data-ttu-id="4bad0-113">DerivedType. cpp</span><span class="sxs-lookup"><span data-stu-id="4bad0-113">DerivedType.cpp</span></span>
...
## <a name="derivedtypexsd"></a><span data-ttu-id="4bad0-114">DerivedType. xsd</span><span class="sxs-lookup"><span data-stu-id="4bad0-114">DerivedType.xsd</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="4bad0-115">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="4bad0-115">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="4bad0-116">**\_asignación de \_ campos de atributo de tipo WS \_ \_**</span><span class="sxs-lookup"><span data-stu-id="4bad0-116">**WS\_TYPE\_ATTRIBUTE\_FIELD\_MAPPING**</span></span>](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping)
</dt> </dl>
