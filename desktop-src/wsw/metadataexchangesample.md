...
---
# <a name="metadataexchangesample"></a><span data-ttu-id="522f9-107">MetadataExchangeSample</span><span class="sxs-lookup"><span data-stu-id="522f9-107">MetadataExchangeSample</span></span>

<span data-ttu-id="522f9-108">En este ejemplo se muestra cómo usar el host de servicio para hospedar un servicio PurchaseOrder a través de TCP.</span><span class="sxs-lookup"><span data-stu-id="522f9-108">This example shows how to use service host for hosting a PurchaseOrder service over TCP.</span></span> <span data-ttu-id="522f9-109">El servicio también admite WS-MetadataExchange.</span><span class="sxs-lookup"><span data-stu-id="522f9-109">The service also supports WS-MetadataExchange.</span></span>

-   [<span data-ttu-id="522f9-110">MexService. cpp</span><span class="sxs-lookup"><span data-stu-id="522f9-110">MexService.cpp</span></span>](#mexservicecpp)
-   [<span data-ttu-id="522f9-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="522f9-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="522f9-112">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="522f9-112">Makefile</span></span>](#makefile)

## <a name="mexservicecpp"></a><span data-ttu-id="522f9-113">MexService. cpp</span><span class="sxs-lookup"><span data-stu-id="522f9-113">MexService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="522f9-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="522f9-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="522f9-115">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="522f9-115">Makefile</span></span>
