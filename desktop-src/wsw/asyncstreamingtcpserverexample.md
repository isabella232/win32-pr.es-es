...
---
# <a name="asyncstreamingtcpserverexample"></a><span data-ttu-id="0eaa3-106">AsyncStreamingTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="0eaa3-106">AsyncStreamingTcpServerExample</span></span>

<span data-ttu-id="0eaa3-107">En este ejemplo se muestra un servidor TCP que recibe mensajes unidireccionales en un modo de transmisión por secuencias asincrónica.</span><span class="sxs-lookup"><span data-stu-id="0eaa3-107">This example shows a TCP server that receives one-way messages in an asynchronous streaming fashion.</span></span>

-   [<span data-ttu-id="0eaa3-108">AsyncStreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="0eaa3-108">AsyncStreamingTcpServer.cpp</span></span>](#asyncstreamingtcpservercpp)
-   [<span data-ttu-id="0eaa3-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="0eaa3-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="0eaa3-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="0eaa3-110">Makefile</span></span>](#makefile)

## <a name="asyncstreamingtcpservercpp"></a><span data-ttu-id="0eaa3-111">AsyncStreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="0eaa3-111">AsyncStreamingTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="0eaa3-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="0eaa3-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0eaa3-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="0eaa3-113">Makefile</span></span>
