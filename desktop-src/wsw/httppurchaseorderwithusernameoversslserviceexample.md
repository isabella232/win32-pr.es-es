...
description: En este ejemplo se muestra cómo usar el host de servicio para hospedar un servicio PurchaseOrder a través de HTTP, con el nombre de usuario sobre la seguridad de modo mixto de SSL.
...
ms.locfileid: "103777785"
---
# <a name="httppurchaseorderwithusernameoversslserviceexample"></a><span data-ttu-id="9948f-106">HttpPurchaseOrderWithUserNameOverSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="9948f-106">HttpPurchaseOrderWithUserNameOverSslServiceExample</span></span>

<span data-ttu-id="9948f-107">En este ejemplo se muestra cómo usar el host de servicio para hospedar un servicio PurchaseOrder a través de HTTP, con el nombre de usuario sobre la seguridad de modo mixto de SSL.</span><span class="sxs-lookup"><span data-stu-id="9948f-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="9948f-108">En esta configuración, la conexión de transporte está protegida (firmada, cifrada) por SSL, que también proporciona autenticación de servidor.</span><span class="sxs-lookup"><span data-stu-id="9948f-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="9948f-109">La autenticación del cliente se proporciona mediante un par de nombre de usuario y contraseña en un encabezado de WS-Security en el mensaje.</span><span class="sxs-lookup"><span data-stu-id="9948f-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="9948f-110">PurchaseOrderServiceUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="9948f-110">PurchaseOrderServiceUserNameOverSsl.cpp</span></span>](#purchaseorderserviceusernameoversslcpp)
-   [<span data-ttu-id="9948f-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="9948f-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="9948f-112">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="9948f-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderserviceusernameoversslcpp"></a><span data-ttu-id="9948f-113">PurchaseOrderServiceUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="9948f-113">PurchaseOrderServiceUserNameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="9948f-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="9948f-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="9948f-115">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="9948f-115">Makefile</span></span>
