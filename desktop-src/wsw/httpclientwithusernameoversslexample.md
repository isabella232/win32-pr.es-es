...
description: En este ejemplo se muestra un cliente HTTP que envía mensajes de solicitud-respuesta, con el nombre de usuario sobre la seguridad de modo mixto de SSL.
...
ms.locfileid: "104075913"
---
# <a name="httpclientwithusernameoversslexample"></a><span data-ttu-id="e1cd8-106">HttpClientWithUsernameOverSslExample</span><span class="sxs-lookup"><span data-stu-id="e1cd8-106">HttpClientWithUsernameOverSslExample</span></span>

<span data-ttu-id="e1cd8-107">En este ejemplo se muestra un cliente HTTP que envía mensajes de solicitud-respuesta, con el nombre de usuario sobre la seguridad de modo mixto de SSL.</span><span class="sxs-lookup"><span data-stu-id="e1cd8-107">This example shows a HTTP client that sends request-reply messages, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="e1cd8-108">En esta configuración, la conexión de transporte está protegida (firmada, cifrada) por SSL, que también proporciona autenticación de servidor.</span><span class="sxs-lookup"><span data-stu-id="e1cd8-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="e1cd8-109">La autenticación del cliente se proporciona mediante un par de nombre de usuario y contraseña en un encabezado de WS-Security en el mensaje.</span><span class="sxs-lookup"><span data-stu-id="e1cd8-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="e1cd8-110">HttpClientWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="e1cd8-110">HttpClientWithUsernameOverSsl.cpp</span></span>](#httpclientwithusernameoversslcpp)
-   [<span data-ttu-id="e1cd8-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="e1cd8-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="e1cd8-112">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="e1cd8-112">Makefile</span></span>](#makefile)

## <a name="httpclientwithusernameoversslcpp"></a><span data-ttu-id="e1cd8-113">HttpClientWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="e1cd8-113">HttpClientWithUsernameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="e1cd8-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="e1cd8-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="e1cd8-115">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="e1cd8-115">Makefile</span></span>
