...
description: Revise un ejemplo de cliente sin tipo que usa la API de servicios web de Windows (WWSAPI). En este ejemplo se muestra un cliente HTTP que envía mensajes de solicitud-respuesta.
...
ms.locfileid: "112409738"
---
# <a name="untypedclientexample"></a><span data-ttu-id="c02e7-107">UnTypedClientExample</span><span class="sxs-lookup"><span data-stu-id="c02e7-107">UnTypedClientExample</span></span>

<span data-ttu-id="c02e7-108">En este ejemplo se muestra un cliente HTTP que envía mensajes de solicitud-respuesta.</span><span class="sxs-lookup"><span data-stu-id="c02e7-108">This example shows a HTTP client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="c02e7-109">UnTypedClient.cpp</span><span class="sxs-lookup"><span data-stu-id="c02e7-109">UnTypedClient.cpp</span></span>](#untypedclientcpp)
-   [<span data-ttu-id="c02e7-110">PurchaseOrder.wsdl</span><span class="sxs-lookup"><span data-stu-id="c02e7-110">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="c02e7-111">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="c02e7-111">Makefile</span></span>](#makefile)

## <a name="untypedclientcpp"></a><span data-ttu-id="c02e7-112">UnTypedClient.cpp</span><span class="sxs-lookup"><span data-stu-id="c02e7-112">UnTypedClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="c02e7-113">PurchaseOrder.wsdl</span><span class="sxs-lookup"><span data-stu-id="c02e7-113">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="c02e7-114">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="c02e7-114">Makefile</span></span>
