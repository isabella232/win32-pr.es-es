...
description: En este ejemplo se muestra un cliente HTTP que envía mensajes de solicitud-respuesta.
...
ms.locfileid: "104356875"
---
# <a name="untypedclientexample"></a><span data-ttu-id="563f2-106">UnTypedClientExample</span><span class="sxs-lookup"><span data-stu-id="563f2-106">UnTypedClientExample</span></span>

<span data-ttu-id="563f2-107">En este ejemplo se muestra un cliente HTTP que envía mensajes de solicitud-respuesta.</span><span class="sxs-lookup"><span data-stu-id="563f2-107">This example shows a HTTP client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="563f2-108">UnTypedClient. cpp</span><span class="sxs-lookup"><span data-stu-id="563f2-108">UnTypedClient.cpp</span></span>](#untypedclientcpp)
-   [<span data-ttu-id="563f2-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="563f2-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="563f2-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="563f2-110">Makefile</span></span>](#makefile)

## <a name="untypedclientcpp"></a><span data-ttu-id="563f2-111">UnTypedClient. cpp</span><span class="sxs-lookup"><span data-stu-id="563f2-111">UnTypedClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="563f2-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="563f2-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="563f2-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="563f2-113">Makefile</span></span>
