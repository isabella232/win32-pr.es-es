...
---
# <a name="httpcalculatorwithsslpolicyserviceexample"></a><span data-ttu-id="f3736-106">HttpCalculatorWithSslPolicyServiceExample</span><span class="sxs-lookup"><span data-stu-id="f3736-106">HttpCalculatorWithSslPolicyServiceExample</span></span>

<span data-ttu-id="f3736-107">En este ejemplo se muestra cómo usar el host de servicio para hospedar un servicio de calculadora a través de HTTP, con seguridad de transporte SSL y autenticación básica de encabezado HTTP.</span><span class="sxs-lookup"><span data-stu-id="f3736-107">This example shows how to use service host for hosting a calculator service over HTTP, with SSL transport security and HTTP header basic authentication.</span></span> <span data-ttu-id="f3736-108">En esta configuración, la conexión de transporte está protegida (firmada, cifrada) por SSL, que también proporciona autenticación de servidor.</span><span class="sxs-lookup"><span data-stu-id="f3736-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="f3736-109">La autenticación de cliente se proporciona mediante un par de nombre de usuario y contraseña proporcionado en encabezados HTTP mediante el esquema básico.</span><span class="sxs-lookup"><span data-stu-id="f3736-109">Client authentication is provided by a username/password pair supplied in HTTP headers using the basic scheme.</span></span>

-   [<span data-ttu-id="f3736-110">HttpCalculatorWithSslPolicyService.cpp</span><span class="sxs-lookup"><span data-stu-id="f3736-110">HttpCalculatorWithSslPolicyService.cpp</span></span>](#httpcalculatorwithsslpolicyservicecpp)
-   [<span data-ttu-id="f3736-111">CalculatorServiceWithPolicy.wsdl</span><span class="sxs-lookup"><span data-stu-id="f3736-111">CalculatorServiceWithPolicy.wsdl</span></span>](#calculatorservicewithpolicywsdl)
-   [<span data-ttu-id="f3736-112">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="f3736-112">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithsslpolicyservicecpp"></a><span data-ttu-id="f3736-113">HttpCalculatorWithSslPolicyService.cpp</span><span class="sxs-lookup"><span data-stu-id="f3736-113">HttpCalculatorWithSslPolicyService.cpp</span></span>
...
## <a name="calculatorservicewithpolicywsdl"></a><span data-ttu-id="f3736-114">CalculatorServiceWithPolicy.wsdl</span><span class="sxs-lookup"><span data-stu-id="f3736-114">CalculatorServiceWithPolicy.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f3736-115">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="f3736-115">Makefile</span></span>
