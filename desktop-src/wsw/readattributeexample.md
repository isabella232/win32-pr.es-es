...
description: En este ejemplo se lee un atributo.
ms.assetid: e37946f0-66e0-4fb1-aeee-db4447ed4030
keywords:
- Servicios Web de ReadAttributeExample para Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104075038"
---
# <a name="readattributeexample"></a><span data-ttu-id="3629f-106">ReadAttributeExample</span><span class="sxs-lookup"><span data-stu-id="3629f-106">ReadAttributeExample</span></span>

<span data-ttu-id="3629f-107">En este ejemplo se lee un atributo.</span><span class="sxs-lookup"><span data-stu-id="3629f-107">This example reads an attribute.</span></span>

## <a name="readattributecpp"></a><span data-ttu-id="3629f-108">ReadAttribute. cpp</span><span class="sxs-lookup"><span data-stu-id="3629f-108">ReadAttribute.cpp</span></span>
