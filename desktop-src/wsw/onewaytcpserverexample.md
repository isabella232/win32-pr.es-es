...
description: En este ejemplo se muestra un servidor TCP que acepta un canal y recibe mensajes unidireccionales.
...
ms.locfileid: "104269384"
---
# <a name="onewaytcpserverexample"></a><span data-ttu-id="05d8e-106">OneWayTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="05d8e-106">OneWayTcpServerExample</span></span>

<span data-ttu-id="05d8e-107">En este ejemplo se muestra un servidor TCP que acepta un canal y recibe mensajes unidireccionales.</span><span class="sxs-lookup"><span data-stu-id="05d8e-107">This example shows a TCP server that accepts a channel and receives one-way messages.</span></span>

-   [<span data-ttu-id="05d8e-108">OneWayTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="05d8e-108">OneWayTcpServer.cpp</span></span>](#onewaytcpservercpp)
-   [<span data-ttu-id="05d8e-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="05d8e-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="05d8e-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="05d8e-110">Makefile</span></span>](#makefile)

## <a name="onewaytcpservercpp"></a><span data-ttu-id="05d8e-111">OneWayTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="05d8e-111">OneWayTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="05d8e-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="05d8e-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="05d8e-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="05d8e-113">Makefile</span></span>
