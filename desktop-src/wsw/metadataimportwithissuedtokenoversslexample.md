...
description: En este ejemplo se muestra la importación de metadatos de un punto de conexión que admite el uso de un token emitido que se obtiene del servicio de token de seguridad (STS) de emisión mediante WsRequestSecurityToken y se presenta al servicio mediante el \_ enlace de seguridad de mensaje de token de WS XML \_ con el \_ \_ \_ enlace de seguridad de \_ transporte SSL de WS \_ \_ \_ . Consulte Federación para obtener más información.
ms.assetid: 31d1386a-1733-4e7a-add1-9050528075c8
keywords:
- MetadataImportWithIssuedTokenOverSslExample API de servicios Web de Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104418452"
---
# <a name="metadataimportwithissuedtokenoversslexample"></a><span data-ttu-id="10314-107">MetadataImportWithIssuedTokenOverSslExample</span><span class="sxs-lookup"><span data-stu-id="10314-107">MetadataImportWithIssuedTokenOverSslExample</span></span>

<span data-ttu-id="10314-108">En este ejemplo se muestra la importación de metadatos de un punto de conexión que admite el uso de un token emitido que se obtiene del servicio de token de seguridad (STS) de emisión mediante [**WsRequestSecurityToken**](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken) y se presenta al servicio mediante el [**enlace de \_ seguridad de \_ \_ mensaje \_ \_ de token de WS XML**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) con el enlace de [**\_ \_ \_ seguridad \_ de transporte SSL de WS**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span><span class="sxs-lookup"><span data-stu-id="10314-108">This example illustrates importing metadata from an endpoint that supports using an issued token that is obtained from the issuing security token service (STS) using [**WsRequestSecurityToken**](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken) and presented to the service using [**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) with [**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span></span> <span data-ttu-id="10314-109">Consulte [Federación](federation.md) para obtener más información.</span><span class="sxs-lookup"><span data-stu-id="10314-109">See [Federation](federation.md) for more information.</span></span>

## <a name="metadataimportwithissuedtokenoversslexamplecpp"></a><span data-ttu-id="10314-110">MetadataImportWithIssuedTokenOverSslExample. cpp</span><span class="sxs-lookup"><span data-stu-id="10314-110">MetadataImportWithIssuedTokenOverSslExample.cpp</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="10314-111">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="10314-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="10314-112">**WsRequestSecurityToken**</span><span class="sxs-lookup"><span data-stu-id="10314-112">**WsRequestSecurityToken**</span></span>](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken)
</dt> <dt>

[<span data-ttu-id="10314-113">**\_enlace de \_ seguridad de mensaje de token \_ \_ de WS XML \_**</span><span class="sxs-lookup"><span data-stu-id="10314-113">**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding)
</dt> <dt>

[<span data-ttu-id="10314-114">**\_enlace de \_ seguridad de transporte WS SSL \_ \_**</span><span class="sxs-lookup"><span data-stu-id="10314-114">**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)
</dt> <dt>

[<span data-ttu-id="10314-115">Federación</span><span class="sxs-lookup"><span data-stu-id="10314-115">Federation</span></span>](federation.md)
</dt> </dl>
