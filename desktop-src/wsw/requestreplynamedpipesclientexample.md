...
description: En este ejemplo se muestra un cliente de canalización con nombre que envía mensajes de solicitud-respuesta.
...
---
# <a name="requestreplynamedpipesclientexample"></a><span data-ttu-id="17c0c-103">RequestReplyNamedPipesClientExample</span><span class="sxs-lookup"><span data-stu-id="17c0c-103">RequestReplyNamedPipesClientExample</span></span>

<span data-ttu-id="17c0c-104">En este ejemplo se muestra un cliente de canalización con nombre que envía mensajes de solicitud-respuesta.</span><span class="sxs-lookup"><span data-stu-id="17c0c-104">This example shows a named pipe client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="17c0c-105">RequestReplyNamedPipesClient. cpp</span><span class="sxs-lookup"><span data-stu-id="17c0c-105">RequestReplyNamedPipesClient.cpp</span></span>](#requestreplynamedpipesclientcpp)
-   [<span data-ttu-id="17c0c-106">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="17c0c-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="17c0c-107">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="17c0c-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesclientcpp"></a><span data-ttu-id="17c0c-108">RequestReplyNamedPipesClient. cpp</span><span class="sxs-lookup"><span data-stu-id="17c0c-108">RequestReplyNamedPipesClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="17c0c-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="17c0c-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="17c0c-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="17c0c-110">Makefile</span></span>
