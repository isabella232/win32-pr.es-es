...
description: Aplicación cliente de ejemplo que muestra cómo abandonar una llamada.
...
ms.locfileid: "104418681"
---
# <a name="callabandonexample"></a><span data-ttu-id="bcb40-106">CallAbandonExample</span><span class="sxs-lookup"><span data-stu-id="bcb40-106">CallAbandonExample</span></span>

<span data-ttu-id="bcb40-107">Aplicación cliente de ejemplo que muestra cómo abandonar una llamada.</span><span class="sxs-lookup"><span data-stu-id="bcb40-107">Example client application demonstrating abandoning a call.</span></span>

-   [<span data-ttu-id="bcb40-108">AbandonCallClient. cpp</span><span class="sxs-lookup"><span data-stu-id="bcb40-108">AbandonCallClient.cpp</span></span>](#abandoncallclientcpp)
-   [<span data-ttu-id="bcb40-109">BlockUnBlockService. wsdl</span><span class="sxs-lookup"><span data-stu-id="bcb40-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="bcb40-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="bcb40-110">Makefile</span></span>](#makefile)

## <a name="abandoncallclientcpp"></a><span data-ttu-id="bcb40-111">AbandonCallClient. cpp</span><span class="sxs-lookup"><span data-stu-id="bcb40-111">AbandonCallClient.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="bcb40-112">BlockUnBlockService. wsdl</span><span class="sxs-lookup"><span data-stu-id="bcb40-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="bcb40-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="bcb40-113">Makefile</span></span>
