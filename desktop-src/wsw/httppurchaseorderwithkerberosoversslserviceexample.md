...
description: En este ejemplo se muestra cómo usar el host de servicio para hospedar un servicio PurchaseOrder a través de HTTP, con seguridad de modo mixto de Kerberos sobre SSL.
...
ms.locfileid: "105704701"
---
# <a name="httppurchaseorderwithkerberosoversslserviceexample"></a><span data-ttu-id="a5edd-106">HttpPurchaseOrderWithKerberosOverSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="a5edd-106">HttpPurchaseOrderWithKerberosOverSslServiceExample</span></span>

<span data-ttu-id="a5edd-107">En este ejemplo se muestra cómo usar el host de servicio para hospedar un servicio PurchaseOrder a través de HTTP, con seguridad de modo mixto de Kerberos sobre SSL.</span><span class="sxs-lookup"><span data-stu-id="a5edd-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="a5edd-108">En esta configuración, la conexión de transporte está protegida (firmada, cifrada) por SSL, que también proporciona autenticación de servidor.</span><span class="sxs-lookup"><span data-stu-id="a5edd-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="a5edd-109">La autenticación del cliente se proporciona mediante un vale APREQ de Kerberos en un encabezado WS-Security del mensaje.</span><span class="sxs-lookup"><span data-stu-id="a5edd-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="a5edd-110">PurchaseOrderServiceKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="a5edd-110">PurchaseOrderServiceKerberosOverSsl.cpp</span></span>](#purchaseorderservicekerberosoversslcpp)
-   [<span data-ttu-id="a5edd-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="a5edd-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="a5edd-112">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="a5edd-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderservicekerberosoversslcpp"></a><span data-ttu-id="a5edd-113">PurchaseOrderServiceKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="a5edd-113">PurchaseOrderServiceKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="a5edd-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="a5edd-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="a5edd-115">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="a5edd-115">Makefile</span></span>
