...
description: En este ejemplo se muestra cómo usar el host de servicio para hospedar un servicio PurchaseOrder a través de HTTP, con kerberos sobre la seguridad en modo mixto de SSL.
