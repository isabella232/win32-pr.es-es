...
description: En este ejemplo se muestra el proxy de servicio que se comunica con un servicio ASMX TerraService mediante la \_ \_ propiedad de \_ \_ canal personalizado del modo de configuración del proxy WS http \_ .
...
ms.locfileid: "104357232"
---
# <a name="asmxterraservicesamplewithcustomproxy"></a><span data-ttu-id="61137-106">AsmxTerraServiceSampleWithCustomProxy</span><span class="sxs-lookup"><span data-stu-id="61137-106">AsmxTerraServiceSampleWithCustomProxy</span></span>

<span data-ttu-id="61137-107">En este ejemplo se muestra el proxy de servicio que se comunica con un servicio ASMX TerraService mediante la propiedad de canal [**personalizado del modo de \_ configuración del \_ proxy \_ \_ \_ WS http**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) .</span><span class="sxs-lookup"><span data-stu-id="61137-107">This examples shows service proxy talking to a ASMX TerraService service using [**WS\_HTTP\_PROXY\_SETTING\_MODE\_CUSTOM**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) channel property.</span></span>

-   [<span data-ttu-id="61137-108">AsmxCustomProxyClient. cpp</span><span class="sxs-lookup"><span data-stu-id="61137-108">AsmxCustomProxyClient.cpp</span></span>](#asmxcustomproxyclientcpp)
-   [<span data-ttu-id="61137-109">terraserviceusa. com. wsdl</span><span class="sxs-lookup"><span data-stu-id="61137-109">terraserviceusa.com.wsdl</span></span>](#terraserviceusacomwsdl)
-   [<span data-ttu-id="61137-110">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="61137-110">Related topics</span></span>](#related-topics)

## <a name="asmxcustomproxyclientcpp"></a><span data-ttu-id="61137-111">AsmxCustomProxyClient. cpp</span><span class="sxs-lookup"><span data-stu-id="61137-111">AsmxCustomProxyClient.cpp</span></span>
...
## <a name="terraserviceusacomwsdl"></a><span data-ttu-id="61137-112">terraserviceusa. com. wsdl</span><span class="sxs-lookup"><span data-stu-id="61137-112">terraserviceusa.com.wsdl</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="61137-113">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="61137-113">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="61137-114">**\_modo de \_ configuración de proxy WS http \_ \_ \_ personalizado**</span><span class="sxs-lookup"><span data-stu-id="61137-114">**WS\_HTTP\_PROXY\_SETTING\_MODE\_CUSTOM**</span></span>](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode)
</dt> </dl>
