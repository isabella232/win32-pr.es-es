...
description: En este ejemplo se muestra un cliente TCP que envía mensajes unidireccionales en un modo de transmisión por secuencias asincrónica.
...
ms.locfileid: "104357228"
---
# <a name="asyncstreamingtcpclientexample"></a><span data-ttu-id="2f65f-106">AsyncStreamingTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="2f65f-106">AsyncStreamingTcpClientExample</span></span>

<span data-ttu-id="2f65f-107">En este ejemplo se muestra un cliente TCP que envía mensajes unidireccionales en un modo de transmisión por secuencias asincrónica.</span><span class="sxs-lookup"><span data-stu-id="2f65f-107">This example shows a TCP client that sends one-way messages in an asynchronous streaming fashion.</span></span>

-   [<span data-ttu-id="2f65f-108">AsyncStreamingTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="2f65f-108">AsyncStreamingTcpClient.cpp</span></span>](#asyncstreamingtcpclientcpp)
-   [<span data-ttu-id="2f65f-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="2f65f-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="2f65f-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="2f65f-110">Makefile</span></span>](#makefile)

## <a name="asyncstreamingtcpclientcpp"></a><span data-ttu-id="2f65f-111">AsyncStreamingTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="2f65f-111">AsyncStreamingTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="2f65f-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="2f65f-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="2f65f-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="2f65f-113">Makefile</span></span>
