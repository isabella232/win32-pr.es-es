...
description: En este ejemplo se escribe un documento mediante un diccionario de WS \_ XML \_ .
...
ms.locfileid: "104357369"
---
# <a name="xmldictionaryexample"></a><span data-ttu-id="f4bf5-106">XmlDictionaryExample</span><span class="sxs-lookup"><span data-stu-id="f4bf5-106">XmlDictionaryExample</span></span>

<span data-ttu-id="f4bf5-107">En este ejemplo se escribe un documento mediante un diccionario de WS \_ XML \_ .</span><span class="sxs-lookup"><span data-stu-id="f4bf5-107">This example writes a document using a WS\_XML\_DICTIONARY.</span></span>

-   [<span data-ttu-id="f4bf5-108">XmlDictionary. cpp</span><span class="sxs-lookup"><span data-stu-id="f4bf5-108">XmlDictionary.cpp</span></span>](#xmldictionarycpp)
-   [<span data-ttu-id="f4bf5-109">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="f4bf5-109">Makefile</span></span>](#makefile)

## <a name="xmldictionarycpp"></a><span data-ttu-id="f4bf5-110">XmlDictionary. cpp</span><span class="sxs-lookup"><span data-stu-id="f4bf5-110">XmlDictionary.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f4bf5-111">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="f4bf5-111">Makefile</span></span>
