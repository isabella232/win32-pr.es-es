...
description: Consulte un ejemplo de servidor HTTP que usa la API Windows Web Services. En este ejemplo se muestra un servidor TCP que acepta un canal y recibe y responde a los mensajes.
