...
description: Este ejemplo codifica y descodifica un mensaje.
ms.assetid: b1f0a1df-22be-4c86-9a7a-0a4d4f363206
keywords:
- Servicios Web de MessageEncodingExample para Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104075789"
---
# <a name="messageencodingexample"></a><span data-ttu-id="737ff-106">MessageEncodingExample</span><span class="sxs-lookup"><span data-stu-id="737ff-106">MessageEncodingExample</span></span>

<span data-ttu-id="737ff-107">Este ejemplo codifica y descodifica un mensaje.</span><span class="sxs-lookup"><span data-stu-id="737ff-107">This example encodes and decodes a message.</span></span>

-   [<span data-ttu-id="737ff-108">MessageEncoding. cpp</span><span class="sxs-lookup"><span data-stu-id="737ff-108">MessageEncoding.cpp</span></span>](#messageencodingcpp)
-   [<span data-ttu-id="737ff-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="737ff-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="737ff-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="737ff-110">Makefile</span></span>](#makefile)

## <a name="messageencodingcpp"></a><span data-ttu-id="737ff-111">MessageEncoding. cpp</span><span class="sxs-lookup"><span data-stu-id="737ff-111">MessageEncoding.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="737ff-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="737ff-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="737ff-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="737ff-113">Makefile</span></span>
