...
description: Implementación de un servicio de calculadora con sesión mediante el host de servicio.
...
---
# <a name="sessionfullcalculatorserviceexample"></a><span data-ttu-id="985ba-106">SessionfullCalculatorServiceExample</span><span class="sxs-lookup"><span data-stu-id="985ba-106">SessionfullCalculatorServiceExample</span></span>

<span data-ttu-id="985ba-107">Implementación de un servicio de calculadora con sesión mediante el host de servicio.</span><span class="sxs-lookup"><span data-stu-id="985ba-107">An implementation of a sessionful calculator service using the Service Host.</span></span>

-   [<span data-ttu-id="985ba-108">SessionfullCalculatorService. cpp</span><span class="sxs-lookup"><span data-stu-id="985ba-108">SessionfullCalculatorService.cpp</span></span>](#sessionfullcalculatorservicecpp)
-   [<span data-ttu-id="985ba-109">SessionBasedCalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="985ba-109">SessionBasedCalculatorService.wsdl</span></span>](#sessionbasedcalculatorservicewsdl)
-   [<span data-ttu-id="985ba-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="985ba-110">Makefile</span></span>](#makefile)

## <a name="sessionfullcalculatorservicecpp"></a><span data-ttu-id="985ba-111">SessionfullCalculatorService. cpp</span><span class="sxs-lookup"><span data-stu-id="985ba-111">SessionfullCalculatorService.cpp</span></span>
...
## <a name="sessionbasedcalculatorservicewsdl"></a><span data-ttu-id="985ba-112">SessionBasedCalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="985ba-112">SessionBasedCalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="985ba-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="985ba-113">Makefile</span></span>
