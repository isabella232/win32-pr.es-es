...
description: En este ejemplo se muestra un servidor TCP que acepta un canal y recibe y responde a los mensajes, con la seguridad de modo mixto de nombre de usuario sobre SSL.
...
ms.locfileid: "105665741"
---
# <a name="httpserverwithusernameoversslexample"></a><span data-ttu-id="6f146-106">HttpServerWithUsernameOverSslExample</span><span class="sxs-lookup"><span data-stu-id="6f146-106">HttpServerWithUsernameOverSslExample</span></span>

<span data-ttu-id="6f146-107">En este ejemplo se muestra un servidor TCP que acepta un canal y recibe y responde a los mensajes, con la seguridad de modo mixto de nombre de usuario sobre SSL.</span><span class="sxs-lookup"><span data-stu-id="6f146-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="6f146-108">En esta configuración, la conexión de transporte está protegida (firmada, cifrada) por SSL, que también proporciona autenticación de servidor.</span><span class="sxs-lookup"><span data-stu-id="6f146-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="6f146-109">La autenticación del cliente se proporciona mediante un par de nombre de usuario y contraseña en un encabezado de WS-Security en el mensaje.</span><span class="sxs-lookup"><span data-stu-id="6f146-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="6f146-110">HttpServerWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="6f146-110">HttpServerWithUsernameOverSsl.cpp</span></span>](#httpserverwithusernameoversslcpp)
-   [<span data-ttu-id="6f146-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="6f146-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="6f146-112">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="6f146-112">Makefile</span></span>](#makefile)

## <a name="httpserverwithusernameoversslcpp"></a><span data-ttu-id="6f146-113">HttpServerWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="6f146-113">HttpServerWithUsernameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="6f146-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="6f146-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="6f146-115">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="6f146-115">Makefile</span></span>
