...
---
# <a name="httpclientwithkerberosoversslexample"></a><span data-ttu-id="0184f-106">HttpClientWithKerberosOverSslExample</span><span class="sxs-lookup"><span data-stu-id="0184f-106">HttpClientWithKerberosOverSslExample</span></span>

<span data-ttu-id="0184f-107">En este ejemplo se muestra un cliente HTTP que envía mensajes de solicitud-respuesta, con seguridad de modo mixto de Kerberos a través de SSL.</span><span class="sxs-lookup"><span data-stu-id="0184f-107">This example shows a HTTP client that sends request-reply messages, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="0184f-108">En esta configuración, la conexión de transporte está protegida (firmada, cifrada) por SSL, que también proporciona autenticación de servidor.</span><span class="sxs-lookup"><span data-stu-id="0184f-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="0184f-109">La autenticación del cliente se proporciona mediante un vale APREQ de Kerberos en un encabezado WS-Security del mensaje.</span><span class="sxs-lookup"><span data-stu-id="0184f-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="0184f-110">HttpClientWithKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="0184f-110">HttpClientWithKerberosOverSsl.cpp</span></span>](#httpclientwithkerberosoversslcpp)
-   [<span data-ttu-id="0184f-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="0184f-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="0184f-112">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="0184f-112">Makefile</span></span>](#makefile)

## <a name="httpclientwithkerberosoversslcpp"></a><span data-ttu-id="0184f-113">HttpClientWithKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="0184f-113">HttpClientWithKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="0184f-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="0184f-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0184f-115">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="0184f-115">Makefile</span></span>
