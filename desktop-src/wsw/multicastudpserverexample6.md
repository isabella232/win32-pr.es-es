...
---
# <a name="multicastudpserverexample6"></a><span data-ttu-id="3a8da-107">MulticastUdpServerExample6</span><span class="sxs-lookup"><span data-stu-id="3a8da-107">MulticastUdpServerExample6</span></span>

<span data-ttu-id="3a8da-108">En este ejemplo se muestra un servidor UDP que realiza escuchas en una dirección de multidifusión y responde a las solicitudes enviadas a esa dirección.</span><span class="sxs-lookup"><span data-stu-id="3a8da-108">This example shows a UDP server that listens on a multicast address and replies to requests sent to that address.</span></span> <span data-ttu-id="3a8da-109">En este ejemplo se usa IPv6.</span><span class="sxs-lookup"><span data-stu-id="3a8da-109">This example uses IPv6.</span></span>

-   [<span data-ttu-id="3a8da-110">MulticastUdpServer6. cpp</span><span class="sxs-lookup"><span data-stu-id="3a8da-110">MulticastUdpServer6.cpp</span></span>](#multicastudpserver6cpp)
-   [<span data-ttu-id="3a8da-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="3a8da-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="3a8da-112">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="3a8da-112">Makefile</span></span>](#makefile)

## <a name="multicastudpserver6cpp"></a><span data-ttu-id="3a8da-113">MulticastUdpServer6. cpp</span><span class="sxs-lookup"><span data-stu-id="3a8da-113">MulticastUdpServer6.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="3a8da-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="3a8da-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="3a8da-115">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="3a8da-115">Makefile</span></span>
