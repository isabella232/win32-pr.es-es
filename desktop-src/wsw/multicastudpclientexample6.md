...
description: En este ejemplo se muestra un cliente UDP que multidifusión una solicitud y, a continuación, espera los mensajes de respuesta de los servidores con IPv6.
...
ms.locfileid: "104356813"
---
# <a name="multicastudpclientexample6"></a><span data-ttu-id="15ea9-106">MulticastUdpClientExample6</span><span class="sxs-lookup"><span data-stu-id="15ea9-106">MulticastUdpClientExample6</span></span>

<span data-ttu-id="15ea9-107">En este ejemplo se muestra un cliente UDP que multidifusión una solicitud y, a continuación, espera los mensajes de respuesta de los servidores con IPv6.</span><span class="sxs-lookup"><span data-stu-id="15ea9-107">This example shows a UDP client that multicasts a request and then waits for reply messages from servers, using IPv6.</span></span>

-   [<span data-ttu-id="15ea9-108">MulticastUdpClient6. cpp</span><span class="sxs-lookup"><span data-stu-id="15ea9-108">MulticastUdpClient6.cpp</span></span>](#multicastudpclient6cpp)
-   [<span data-ttu-id="15ea9-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="15ea9-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="15ea9-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="15ea9-110">Makefile</span></span>](#makefile)

## <a name="multicastudpclient6cpp"></a><span data-ttu-id="15ea9-111">MulticastUdpClient6. cpp</span><span class="sxs-lookup"><span data-stu-id="15ea9-111">MulticastUdpClient6.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="15ea9-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="15ea9-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="15ea9-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="15ea9-113">Makefile</span></span>
