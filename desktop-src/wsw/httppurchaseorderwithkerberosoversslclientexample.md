...
---
# <a name="httppurchaseorderwithkerberosoversslclientexample"></a><span data-ttu-id="0685e-106">HttpPurchaseOrderWithKerberosOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="0685e-106">HttpPurchaseOrderWithKerberosOverSslClientExample</span></span>

<span data-ttu-id="0685e-107">En este ejemplo se muestra un cliente HTTP que usa el proxy de servicio para comunicarse con un servicio PurchaseOrder, con seguridad de modo mixto de Kerberos a través de SSL.</span><span class="sxs-lookup"><span data-stu-id="0685e-107">This example shows a HTTP client that uses service proxy to talk to a PurchaseOrder service, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="0685e-108">En esta configuración, la conexión de transporte está protegida (firmada, cifrada) por SSL, que también proporciona autenticación de servidor.</span><span class="sxs-lookup"><span data-stu-id="0685e-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="0685e-109">La autenticación del cliente se proporciona mediante un vale APREQ de Kerberos en un encabezado WS-Security del mensaje.</span><span class="sxs-lookup"><span data-stu-id="0685e-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="0685e-110">PurchaseOrderClientKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="0685e-110">PurchaseOrderClientKerberosOverSsl.cpp</span></span>](#purchaseorderclientkerberosoversslcpp)
-   [<span data-ttu-id="0685e-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="0685e-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="0685e-112">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="0685e-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderclientkerberosoversslcpp"></a><span data-ttu-id="0685e-113">PurchaseOrderClientKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="0685e-113">PurchaseOrderClientKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="0685e-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="0685e-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0685e-115">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="0685e-115">Makefile</span></span>
