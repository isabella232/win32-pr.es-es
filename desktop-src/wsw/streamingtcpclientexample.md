...
---
# <a name="streamingtcpclientexample"></a><span data-ttu-id="569e1-106">StreamingTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="569e1-106">StreamingTcpClientExample</span></span>

<span data-ttu-id="569e1-107">En este ejemplo se muestra un cliente TCP que envía mensajes unidireccionales de una manera de transmisión por secuencias.</span><span class="sxs-lookup"><span data-stu-id="569e1-107">This example shows a TCP client that sends one-way messages in a streaming fashion.</span></span>

-   [<span data-ttu-id="569e1-108">StreamingTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="569e1-108">StreamingTcpClient.cpp</span></span>](#streamingtcpclientcpp)
-   [<span data-ttu-id="569e1-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="569e1-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="569e1-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="569e1-110">Makefile</span></span>](#makefile)

## <a name="streamingtcpclientcpp"></a><span data-ttu-id="569e1-111">StreamingTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="569e1-111">StreamingTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="569e1-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="569e1-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="569e1-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="569e1-113">Makefile</span></span>
