...
description: En este ejemplo se muestra cómo usar encabezados personalizados con el proxy de servicio.
...
ms.locfileid: "104418849"
---
# <a name="httpcustomheaderpurchaseorderclientexample"></a><span data-ttu-id="aa8bb-106">HttpCustomHeaderPurchaseOrderClientExample</span><span class="sxs-lookup"><span data-stu-id="aa8bb-106">HttpCustomHeaderPurchaseOrderClientExample</span></span>

<span data-ttu-id="aa8bb-107">En este ejemplo se muestra cómo usar encabezados personalizados con el proxy de servicio.</span><span class="sxs-lookup"><span data-stu-id="aa8bb-107">This examples shows how to use custom headers with service proxy.</span></span>

-   [<span data-ttu-id="aa8bb-108">HttpCustomHeaderClient. cpp</span><span class="sxs-lookup"><span data-stu-id="aa8bb-108">HttpCustomHeaderClient.cpp</span></span>](#httpcustomheaderclientcpp)
-   [<span data-ttu-id="aa8bb-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="aa8bb-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="aa8bb-110">OrderSessionHeader. xsd</span><span class="sxs-lookup"><span data-stu-id="aa8bb-110">OrderSessionHeader.xsd</span></span>](#ordersessionheaderxsd)
-   [<span data-ttu-id="aa8bb-111">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="aa8bb-111">Makefile</span></span>](#makefile)

## <a name="httpcustomheaderclientcpp"></a><span data-ttu-id="aa8bb-112">HttpCustomHeaderClient. cpp</span><span class="sxs-lookup"><span data-stu-id="aa8bb-112">HttpCustomHeaderClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="aa8bb-113">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="aa8bb-113">PurchaseOrder.wsdl</span></span>
...
## <a name="ordersessionheaderxsd"></a><span data-ttu-id="aa8bb-114">OrderSessionHeader. xsd</span><span class="sxs-lookup"><span data-stu-id="aa8bb-114">OrderSessionHeader.xsd</span></span>
...
## <a name="makefile"></a><span data-ttu-id="aa8bb-115">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="aa8bb-115">Makefile</span></span>
