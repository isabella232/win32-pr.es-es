...
---
# <a name="onewayudpclientexample"></a><span data-ttu-id="b43c4-106">OneWayUdpClientExample</span><span class="sxs-lookup"><span data-stu-id="b43c4-106">OneWayUdpClientExample</span></span>

<span data-ttu-id="b43c4-107">En este ejemplo se muestra un cliente UDP que envía mensajes unidireccionales.</span><span class="sxs-lookup"><span data-stu-id="b43c4-107">This example shows a UDP client that sends a one-way messages.</span></span>

-   [<span data-ttu-id="b43c4-108">OneWayUdpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="b43c4-108">OneWayUdpClient.cpp</span></span>](#onewayudpclientcpp)
-   [<span data-ttu-id="b43c4-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="b43c4-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="b43c4-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="b43c4-110">Makefile</span></span>](#makefile)

## <a name="onewayudpclientcpp"></a><span data-ttu-id="b43c4-111">OneWayUdpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="b43c4-111">OneWayUdpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="b43c4-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="b43c4-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="b43c4-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="b43c4-113">Makefile</span></span>
