...
description: En este ejemplo se muestra cómo usar el host de servicio para hospedar un servicio de calculadora a través de HTTP.
...
ms.locfileid: "104076387"
---
# <a name="httpcalculatorserviceexample"></a><span data-ttu-id="32433-106">HttpCalculatorServiceExample</span><span class="sxs-lookup"><span data-stu-id="32433-106">HttpCalculatorServiceExample</span></span>

<span data-ttu-id="32433-107">En este ejemplo se muestra cómo usar el host de servicio para hospedar un servicio de calculadora a través de HTTP.</span><span class="sxs-lookup"><span data-stu-id="32433-107">This example shows how to use service host for hosting a calculator service over HTTP.</span></span>

-   [<span data-ttu-id="32433-108">HttpCalculatorService. cpp</span><span class="sxs-lookup"><span data-stu-id="32433-108">HttpCalculatorService.cpp</span></span>](#httpcalculatorservicecpp)
-   [<span data-ttu-id="32433-109">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="32433-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="32433-110">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="32433-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorservicecpp"></a><span data-ttu-id="32433-111">HttpCalculatorService. cpp</span><span class="sxs-lookup"><span data-stu-id="32433-111">HttpCalculatorService.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="32433-112">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="32433-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="32433-113">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="32433-113">Makefile</span></span>
