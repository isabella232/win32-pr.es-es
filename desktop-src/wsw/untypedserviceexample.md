...
Este ejemplo muestra cómo implementar un servicio sin tipo con el modelo de servicio. En este caso, el modelo de servicio proporciona la infraestructura de la placa de caldera.
