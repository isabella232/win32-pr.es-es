...
description: Este ejemplo muestra cómo implementar un servicio sin tipo con el modelo de servicio. En este caso, el modelo de servicio proporciona la infraestructura de la placa de caldera.
...
ms.locfileid: "104075397"
---
# <a name="untypedserviceexample"></a><span data-ttu-id="a66bd-107">UnTypedServiceExample</span><span class="sxs-lookup"><span data-stu-id="a66bd-107">UnTypedServiceExample</span></span>

<span data-ttu-id="a66bd-108">Este ejemplo muestra cómo implementar un servicio sin tipo con el modelo de servicio.</span><span class="sxs-lookup"><span data-stu-id="a66bd-108">This sample shows how implement an untyped service with Service Model.</span></span> <span data-ttu-id="a66bd-109">En este caso, el modelo de servicio proporciona la infraestructura de la placa de caldera.</span><span class="sxs-lookup"><span data-stu-id="a66bd-109">Service Model in this case provides the boiler plate infrastructure.</span></span>

-   [<span data-ttu-id="a66bd-110">UnTypedService. cpp</span><span class="sxs-lookup"><span data-stu-id="a66bd-110">UnTypedService.cpp</span></span>](#untypedservicecpp)
-   [<span data-ttu-id="a66bd-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="a66bd-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="a66bd-112">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="a66bd-112">Makefile</span></span>](#makefile)

## <a name="untypedservicecpp"></a><span data-ttu-id="a66bd-113">UnTypedService. cpp</span><span class="sxs-lookup"><span data-stu-id="a66bd-113">UnTypedService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="a66bd-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="a66bd-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="a66bd-115">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="a66bd-115">Makefile</span></span>
