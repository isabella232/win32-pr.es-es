...
description: Este ejemplo muestra un servidor TCP que acepta un canal y recibe y responde a los mensajes, con seguridad de modo mixto de Kerberos a través de SSL.
...
ms.locfileid: "103994577"
---
# <a name="httpserverwithkerberosoversslexample"></a><span data-ttu-id="e264d-106">HttpServerWithKerberosOverSslExample</span><span class="sxs-lookup"><span data-stu-id="e264d-106">HttpServerWithKerberosOverSslExample</span></span>

<span data-ttu-id="e264d-107">Este ejemplo muestra un servidor TCP que acepta un canal y recibe y responde a los mensajes, con seguridad de modo mixto de Kerberos a través de SSL.</span><span class="sxs-lookup"><span data-stu-id="e264d-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="e264d-108">En esta configuración, la conexión de transporte está protegida (firmada, cifrada) por SSL, que también proporciona autenticación de servidor.</span><span class="sxs-lookup"><span data-stu-id="e264d-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="e264d-109">La autenticación del cliente se proporciona mediante un vale APREQ de Kerberos en un encabezado WS-Security del mensaje.</span><span class="sxs-lookup"><span data-stu-id="e264d-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="e264d-110">HttpServerWithKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="e264d-110">HttpServerWithKerberosOverSsl.cpp</span></span>](#httpserverwithkerberosoversslcpp)
-   [<span data-ttu-id="e264d-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="e264d-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="e264d-112">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="e264d-112">Makefile</span></span>](#makefile)

## <a name="httpserverwithkerberosoversslcpp"></a><span data-ttu-id="e264d-113">HttpServerWithKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="e264d-113">HttpServerWithKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="e264d-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="e264d-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="e264d-115">Archivo Make</span><span class="sxs-lookup"><span data-stu-id="e264d-115">Makefile</span></span>
