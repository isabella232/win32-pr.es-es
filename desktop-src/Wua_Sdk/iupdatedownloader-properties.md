...
| [**Se aplica**](/windows/desktop/api/Wuapi/nf-wuapi-iupdatedownloader-get_isforced)                       | Obtiene y establece un valor booleano que indica si Windows Update Agent (WUA) fuerza la descarga de actualizaciones que ya están instaladas o que no se pueden instalar. |
