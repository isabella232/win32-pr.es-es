...
Contiene una lista de los equipos de la carpeta **equipos** de la herramienta de administración de servicios de componentes. Contiene un objeto para cada equipo.
