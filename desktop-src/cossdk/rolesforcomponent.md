...
Contiene un objeto para cada rol asignado al componente con el que está relacionada la colección. Los roles ya deben estar asignados en el nivel de aplicación.
