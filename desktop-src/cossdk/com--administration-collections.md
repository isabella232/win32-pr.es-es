...
| [**ErrorInfo**](errorinfo.md)                                         | Recupera información de error extendida relativa a los métodos que tratan con varios objetos .                                                               |
...
| [**InterfacesForComponent**](interfacesforcomponent.md)               | Contiene un objeto para cada interfaz expuesta por el componente con el que está relacionada la colección.                                                    |
...
| [**Roles**](roles.md)                                                 | Contiene un objeto para cada rol asignado a la aplicación con la que está relacionado.                                                                  |
