---
description: Cuando un objeto se activa en un contexto determinado, las llamadas posteriores a o desde él, dentro del contexto, se controlan de forma diferente a las llamadas a través del límite de contexto.
