...
---
# <a name="appdomainhelper-class"></a>Clase AppDomainHelper
...
Utilice esta clase para tener acceso a los métodos de [**IAppDomainHelper**](/windows/desktop/api/ComSvcs/nn-comsvcs-iappdomainhelper).

## <a name="remarks"></a>Observaciones

Para crear este objeto, llame a [**CoCreateInstance**](/windows/desktop/api/combaseapi/nf-combaseapi-cocreateinstance).

Para usar esta clase desde Microsoft Visual Basic, agregue una referencia a la biblioteca de tipos de servicios COM+. Un objeto AppDomainHelper se puede declarar con "COMSVCSLib. AppDomainHelper" como nombre de clase.
