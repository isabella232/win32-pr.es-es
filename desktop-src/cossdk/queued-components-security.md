...
Los componentes en cola de COM+ se ejecuta a través de DCOM, por  lo que  puede ayudar a  proteger la integridad y confidencialidad de las llamadas a métodos en cola seleccionando Privacidad de paquetes como la opción Nivel de autenticación de llamadas en la pestaña Seguridad de la hoja Propiedades de la aplicación en cola. 
...
[Limitaciones de seguridad en modo de grupo de trabajo](security-limitations-in-workgroup-mode.md)
</dt> <dt>
