...
En el ejemplo siguiente se llama a la función [**PdhEnumObjectItems**](/windows/desktop/api/Pdh/nf-pdh-pdhenumobjectitemsa) para enumerar las instancias y los contadores de los objetos de proceso en el equipo local.
