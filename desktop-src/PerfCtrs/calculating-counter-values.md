...
---
# <a name="calculating-counter-values"></a><span data-ttu-id="5d15d-103">Cálculo de valores de contadores</span><span class="sxs-lookup"><span data-stu-id="5d15d-103">Calculating Counter Values</span></span>

<span data-ttu-id="5d15d-104">La mayoría de los tipos de contadores usan una fórmula para calcular un valor que se pueda mostrar para el contador.</span><span class="sxs-lookup"><span data-stu-id="5d15d-104">Most counter types use a formula for calculating a displayable value for the counter.</span></span> <span data-ttu-id="5d15d-105">Para obtener una lista de los tipos de contador y sus fórmulas, vea la sección tipos de contador del [Kit de implementación de Windows Server 2003](/previous-versions/windows/it-pro/windows-server-2003/cc776490(v=ws.10)).</span><span class="sxs-lookup"><span data-stu-id="5d15d-105">For a list of counter types and their formulas, see the Counter Types section of the [Windows Server 2003 Deployment Kit](/previous-versions/windows/it-pro/windows-server-2003/cc776490(v=ws.10)).</span></span> <span data-ttu-id="5d15d-106">Si el contador requiere dos ejemplos para calcular el valor que se va a mostrar, se establece la marca del tipo de contador `PERF_DELTA_COUNTER` .</span><span class="sxs-lookup"><span data-stu-id="5d15d-106">If the counter requires two samples in order to calculate the displayable value, the counter type's `PERF_DELTA_COUNTER` flag is set.</span></span>

<span data-ttu-id="5d15d-107">En el ejemplo siguiente se muestra cómo usar los datos sin procesar para calcular un valor que se pueda mostrar para cada tipo de contador.</span><span class="sxs-lookup"><span data-stu-id="5d15d-107">The following example shows how to use the raw data to calculate a displayable value for each counter type.</span></span> <span data-ttu-id="5d15d-108">Este ejemplo se basa en el ejemplo de [recuperación de datos de contador](retrieving-counter-data.md).</span><span class="sxs-lookup"><span data-stu-id="5d15d-108">This example builds on the example in [Retrieving Counter Data](retrieving-counter-data.md).</span></span>
