...
---
# <a name="ienumpstoretypes-interface"></a>IEnumPStoreTypes (interfaz)
...
| [**Reset**](ienumpstoretypes-reset.md) | Restablece al principio de la secuencia de enumeración.<br/>                                    |
