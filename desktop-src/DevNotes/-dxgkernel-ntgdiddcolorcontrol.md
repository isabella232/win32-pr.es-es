...
---
# <a name="ntgdiddcolorcontrol-function"></a>NtGdiDdColorControl función)
...
Controla los controles de luminancia y luminosidad de una superficie superpuesta.
...
Identificador de la [**estructura \_ \_ local del área DD**](/windows/win32/api/ddrawint/ns-ddrawint-dd_surface_local) que representa la superficie superpuesta.
...
Puntero a una estructura [**DD \_ COLORCONTROLDATA**](/windows/win32/api/ddrawint/ns-ddrawint-dd_colorcontroldata) que contiene la información de control de color para una superficie de superposición especificada.
