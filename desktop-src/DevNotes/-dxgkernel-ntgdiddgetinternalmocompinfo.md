...
---
# <a name="ntgdiddgetinternalmocompinfo-function"></a>NtGdiDdGetInternalMoCompInfo función)
...
Permite que el controlador informe de que asigna internamente la memoria de la pantalla para realizar la compensación de movimiento.
...
Puntero a una estructura [**DD \_ GETINTERNALMOCOMPDATA**](/windows/win32/api/ddrawint/ns-ddrawint-dd_getinternalmocompdata) que contiene los requisitos de memoria interna.
