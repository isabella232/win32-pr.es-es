...
---
# <a name="ntgdiddbeginmocompframe-function"></a>NtGdiDdBeginMoCompFrame función)
...
Inicia la descodificación de un nuevo marco.
...
Puntero a una estructura [**DD \_ BEGINMOCOMPFRAMEDATA**](/windows/win32/api/ddrawint/ns-ddrawint-dd_beginmocompframedata) que contiene la información necesaria para iniciar la descodificación de un nuevo marco.
