...
---
# <a name="ntgdiddupdateoverlay-function"></a>NtGdiDdUpdateOverlay función)
...
Cambia de posición o modifica los atributos visuales de una superficie superpuesta.
...
Identificador de una [**estructura \_ \_ local**](/windows/win32/api/ddrawint/ns-ddrawint-dd_surface_local) de la superficie de DD que describe la superficie de superposición.
...
Puntero a una estructura [**DD \_ UPDATEOVERLAYDATA**](/windows/win32/api/ddrawint/ns-ddrawint-dd_updateoverlaydata) que contiene la información necesaria para actualizar la superposición.
