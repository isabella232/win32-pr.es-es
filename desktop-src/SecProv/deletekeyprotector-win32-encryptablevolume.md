...
Si el volumen aún no está descifrado por completo, use [**DisableKeyProtectors**](disablekeyprotectors-win32-encryptablevolume.md) antes de quitar el último protector de clave del volumen para asegurarse de que las partes cifradas del volumen permanecen accesibles.
