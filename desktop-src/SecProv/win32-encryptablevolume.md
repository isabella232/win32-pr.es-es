...
ms.locfileid: "127073585"
---
# <a name="win32_encryptablevolume-class"></a>Clase EncryptableVolume de Win32 \_
...
Cada tipo de protector de clave proporciona una experiencia de autenticación diferente para desbloquear el acceso a los datos cifrados. Las claves externas y las contraseñas numéricas pueden proporcionar autenticación durante los escenarios de recuperación. En el caso de los protectores de claves basados en TPM, es posible que primero deba inicializar correctamente el TPM. Para obtener más información, vea la clase [**de proveedor WMI de \_ Tpm win32.**](win32-tpm.md)
...
| [**ClearAllAutoUnlockKeys**](clearallautounlockkeys-win32-encryptablevolume.md)                                         | Quita todas las claves externas y la información relacionada guardada en el volumen del sistema operativo que se ejecuta actualmente y que se usa para desbloquear automáticamente los volúmenes de datos.<br/>                                                                                                             |
...
| [**DeleteKeyProtectors**](deletekeyprotectors-win32-encryptablevolume.md)                                               | Elimina todos los protectores de clave del volumen.<br/>                                                                                                                                                                                                                                 |
...
| [**Cifrar**](encrypt-win32-encryptablevolume.md)                                                                       | Comienza el cifrado de un volumen completamente descifrado o reanuda el cifrado de un volumen parcialmente cifrado.<br/>                                                                                                                                                                       |
...
| [**IsNumericalPasswordValid**](isnumericalpasswordvalid-win32-encryptablevolume.md)                                     | Indica si la contraseña numérica cumple los requisitos de formato especial.<br/>                                                                                                                                                                                            |
...
Para los volúmenes sin letras de unidad, este valor es **NULL.**
...
Este identificador es una cadena vacía si el volumen es un volumen NTFS completamente descifrado estándar; de lo contrario, tiene un valor único.
...
Para habilitar las conexiones remotas, se debe permitir el tráfico WMI remoto. Para obtener más información sobre cómo habilitar el tráfico WMI, vea [Conectarse](../wmisdk/connecting-to-wmi-remotely-starting-with-vista.md)a WMI de forma remota a partir de Vista .
