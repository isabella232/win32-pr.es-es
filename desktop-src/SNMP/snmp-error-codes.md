---
title: Códigos de error snmp (Snmp.h)
...
| <span id="SNMP_ERRORSTATUS_GENERR"></span><span id="snmp_errorstatus_generr"></span><dl> <dt>**SNMP \_ ERRORSTATUS \_ GENERR**</dt> <dt>5</dt> </dl>                                         | Error distinto de uno de los enumerados aquí durante la operación SNMP solicitada.<br/>                                                          |
...
| <span id="SNMP_ERRORSTATUS_UNDOFAILED"></span><span id="snmp_errorstatus_undofailed"></span><dl> <dt>**SNMP \_ ERRORSTATUS \_ UNDOFAILED**</dt> <dt>15</dt> </dl>                            | No se han producido errores de validación. Algunas variables se actualizaron porque no era posible deshacer su asignación.<br/>                                    |
