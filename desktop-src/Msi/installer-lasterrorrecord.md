...
---
# <a name="installerlasterrorrecord-method"></a>Instalador. LastErrorRecord (método)

El método **LastErrorRecord** del objeto de [**instalador**](installer-object.md) devuelve un objeto de [**registro**](record-object.md) que contiene los parámetros de error del error más reciente de la función que generó el registro de errores.
...
El objeto de [**registro**](record-object.md) se restablece después de la ejecución de esta función de cualquier función que genera un registro de errores.
...
En el ejemplo siguiente de VBScript se usa una llamada a [**OpenDatabase**](installer-opendatabase.md) para mostrar cómo obtener información de error extendida de uno de los métodos o propiedades que admiten el método **LastErrorRecord** . El ejemplo genera un mensaje de error cuando se produce un error en el método **OpenDatabase** . El objeto **Err** se usa para determinar si se encontró un error.
