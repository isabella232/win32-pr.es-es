...
---
# <a name="moduleinstalluisequence-table"></a>Tabla ModuleInstallUISequence
...
Si esta tabla está presente, la [tabla InstallUISequence](installuisequence-table.md) también debe estar presente en el módulo de combinación.
