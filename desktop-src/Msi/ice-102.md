...
Si el valor del campo ConfigType de la tabla [MsiServiceConfig](msiserviceconfig-table.md) es **SERVICE CONFIG REQUIRED \_ \_ \_ PRIVILEGES \_ INFO,** el valor del campo Argument debe contener una cadena válida de **Constantes de privilegios**.
...
| En la entrada de tabla MsiServiceConfig (MsiServiceConfig = ) \[ 1 \] , argument =%s no es un parámetro %s válido. Debe ser %s.                                                                            | El campo Argument de [la tabla MsiServiceConfig](msiserviceconfig-table.md) no contiene uno de los valores permitidos.                                                                                                          |
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| En la entrada de tabla MsiServiceConfig (MsiServiceConfig = ) 1 , el \[ campo Argumento se deja en \] blanco. Se usará el valor predeterminado de apagado predeterminado de 180000            | El retraso de tiempo es de 180 000 milisegundos porque el campo Argument de la [tabla MsiServiceConfig](msiserviceconfig-table.md) está en blanco.                        |
