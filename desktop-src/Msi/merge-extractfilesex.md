...
---
# <a name="mergeextractfilesex-method"></a>Merge. ExtractFilesEx (método)
...
Se establece para especificar el uso de nombres de archivo largos para los segmentos de ruta de acceso y los nombres de archivo finales.
...
Consulte función [**ExtractFilesEx**](/windows/desktop/api/Mergemod/nf-mergemod-imsmmerge2-extractfilesex) .
