...
Los autores de paquetes pueden supervisar los mensajes de Windows Installer internos a través de la creación de una aplicación ejecutable que contiene un controlador de devolución de llamada basado en registros para recibir los mensajes y la funcionalidad para iniciar una instalación.

El controlador basado en registros del ejemplo siguiente se ajusta al prototipo de [**registro del \_ controlador \_ INSTALLUI**](/windows/win32/api/msi/nc-msi-installui_handler_record) y se pasa un puntero a este controlador de devolución de llamada a la función [**MsiSetExternalUIRecord**](/windows/desktop/api/Msi/nf-msi-msisetexternaluirecord) .
