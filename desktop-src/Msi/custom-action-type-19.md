---
description: Los desarrolladores de Windows installer pueden optar por usar un tipo de acción personalizada 19 cuando las acciones estándar no son suficientes para ejecutar la instalación.
