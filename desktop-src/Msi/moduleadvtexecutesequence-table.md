...
---
# <a name="moduleadvtexecutesequence-table"></a>Tabla ModuleAdvtExecuteSequence
...
La tabla ModuleAdvtExecuteSequence tiene las columnas siguientes.
...
Si esta tabla está presente, la [tabla AdvtExecuteSequence](advtexecutesequence-table.md) también debe estar presente en el módulo de combinación.
