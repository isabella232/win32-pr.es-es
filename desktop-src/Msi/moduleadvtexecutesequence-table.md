...
ms.locfileid: "127261207"
---
# <a name="moduleadvtexecutesequence-table"></a>ModuleAdvtExecuteSequence Table

Una herramienta de combinación evalúa la tabla ModuleAdvtExecuteSequence y, a continuación, inserta las acciones calculadas en la tabla [AdvtExecuteSequence](advtexecutesequence-table.md) con un número de secuencia correcto.

La tabla ModuleAdvtExecuteSequence tiene las siguientes columnas.
...
Si esta tabla está presente, [la tabla AdvtExecuteSequence](advtexecutesequence-table.md) también debe estar presente en el módulo merge.
