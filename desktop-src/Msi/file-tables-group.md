---
description: El grupo de archivos de tablas contiene todas las tablas Windows installer relacionadas con los archivos.
...
-   La [tabla RemoveIniFile](removeinifile-table.md) contiene la información que una aplicación necesita eliminar de un .ini archivo.
-   La [tabla Entorno](environment-table.md) se usa para establecer los valores de las variables de entorno.
-   La [tabla Icono](icon-table.md) proporciona información de icono que se copia en un archivo como parte del anuncio del producto.
