---
description: ICE76 comprueba el uso del catálogo de SFP (WFP) en los paquetes de Windows Installer para Windows Me. Este ICE también comprueba que ningún archivo de la tabla BindImage haga referencia a los catálogos de SFP.
...
ms.locfileid: "120129435"
---
# <a name="ice76"></a>ICE76

ICE76 comprueba el uso del catálogo de SFP (WFP) en los paquetes de Windows Installer para Windows Me. Este ICE también comprueba que ningún archivo de la tabla BindImage [haga](bindimage-table.md) referencia a los catálogos de SFP.
