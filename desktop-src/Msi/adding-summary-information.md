...
Las propiedades restantes del flujo de información de resumen no son necesarias, pero se deben establecer para el MNP2000.msi ejemplo.
...
**Msiinfo.exe MNP2000.msi -T "Base de datos de instalación" -J Asunto -A "Microsoft Corporation" -K "Instalador, MSI, Database" -O "Esta base de datos del instalador contiene la lógica y los datos necesarios para instalar Bloc de notas." -P ;1033 -V {4966AEC4-3C59-4B07-9B98-1B6A7103C0D3} -G 200 -W 0 -N Orca -U 0**

Para obtener más información sobre la información de resumen, vea Acerca del flujo de información de resumen [,](about-the-summary-information-stream.md) [Uso](using-the-summary-information-stream.md)del flujo de información de resumen y Referencia de secuencia de información [de resumen](summary-information-stream-reference.md).

Consulte El conjunto [de propiedades de secuencia](summary-information-stream-property-set.md) de información de resumen para obtener una lista completa de todas las propiedades de información de resumen y Descripciones de propiedades de [resumen](summary-property-descriptions.md) para obtener su descripción.
