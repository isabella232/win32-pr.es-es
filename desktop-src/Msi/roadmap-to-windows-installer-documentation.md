...
title: Hoja de ruta para Windows installer
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="roadmap-to-windows-installer-documentation"></a>Hoja de ruta para Windows installer
...
Para obtener una lista de sugerencias sobre el uso del instalador Windows, vea [Windows Procedimientos recomendados del instalador .](windows-installer-best-practices.md)
...
-   La información de las [secciones Novedades](what-s-new-in-windows-installer.md) de Windows Installer se puede usar para identificar nuevas características que no son compatibles con versiones anteriores de Windows Installer.
-   [Digital Signatures and Windows Installer](digital-signatures-and-windows-installer.md) describe cómo se pueden usar las firmas digitales con paquetes, transformaciones, revisiones, módulos de combinación y archivos de archivado externos.
