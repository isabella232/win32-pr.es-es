...
Un servicio del sistema de Windows Vista que facilita el inicio de instalaciones que requieren privilegios elevados para ejecutarse. Proporciona la interfaz de usuario de consentimiento que usa el control de cuentas de usuario para solicitar a un usuario autorización de administrador.
