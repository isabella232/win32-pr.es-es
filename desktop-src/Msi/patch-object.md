...
| [**SourceListClearSource**](patch-sourcelistclearsource.md)         | Quite una red o un origen de dirección URL de la lista de origen.<br/>                                                                         |
...
| [**Orígenes**](patch-sources.md)<br/>               | Enumera todos los orígenes de esta instancia de revisión.<br/>                                             |
| [**Estado**](patch-state.md)<br/>                   | Estado de instalación de la revisión.<br/>                                                                |
