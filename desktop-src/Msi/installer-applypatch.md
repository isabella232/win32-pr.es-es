...
Dado que el delimitador de lista para transformaciones, orígenes y revisiones es un punto y coma, este carácter no debe usarse para los nombres de archivo o las rutas de acceso.
