...
<span id="_msi_basic_ui_gly"></span><span id="_MSI_BASIC_UI_GLY"></span>**interfaz de usuario básica**
</dt> <dd>

Un nivel de las funcionalidades de la interfaz [*de usuario interna del instalador.*](i-gly.md) El nivel de interfaz de usuario (UI) básico admite una interfaz de usuario para la instalación que tiene un progreso sencillo y un control de errores. Para obtener más información sobre los niveles de interfaz de usuario, [vea Interfaz de usuario levels](user-interface-levels.md).
