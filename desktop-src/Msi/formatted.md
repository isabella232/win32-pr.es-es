...
ms.locfileid: "119649654"
---
# <a name="formatted"></a>Formato

El tipo de datos Con formato es una cadena de texto que se procesa para resolver nombres de propiedad incrustados, claves de tabla, referencias de variables de entorno y otras subcadenas especiales. Se reconocen las convenciones siguientes para resolver la cadena:
