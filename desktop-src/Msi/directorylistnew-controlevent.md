---
description: Este evento notifica al control DirectoryList que se debe crear una nueva carpeta; crea la nueva carpeta y selecciona el campo de nombre de la carpeta para editarla.
