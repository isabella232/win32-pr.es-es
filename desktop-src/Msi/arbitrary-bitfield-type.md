...
Tipo "Bitfield" sin solicitudes de contexto que el usuario proporcione un entero cuyo valor se usa para establecer uno o varios bits en un campo de bits. Este texto puede estar en cualquier idioma compatible con la página de códigos de la base de datos.
