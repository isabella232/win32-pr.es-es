---
description: Hay dos maneras de crear la base de Windows de instalación del instalador de forma que solo se llame a una acción cuando se desinstala el paquete.
