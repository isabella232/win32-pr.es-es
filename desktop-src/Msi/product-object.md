...
| [**SourceListClearSource**](product-sourcelistclearsource.md)         | Quite una red o un origen de dirección URL de la lista de origen.<br/>                                                    |
...
| [**UserSid**](product-usersid.md)<br/>                 | Devuelve el SID de usuario, con qué cuenta está disponible esta instancia de producto.<br/>    |
