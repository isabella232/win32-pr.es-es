---
description: La acción RMCCPSearch usa firmas de archivo para validar que los productos aptos están instalados en un sistema antes de realizar una instalación de actualización.
...
La acción RMCCPSearch usa firmas de archivo para validar que los productos aptos están instalados en un sistema antes de realizar una instalación de actualización.
...
La acción RMCCPSearch requiere que la propiedad [**CCP \_ DRIVE**](ccp-drive.md) se [](v-gly.md) establezca en la ruta de acceso raíz en el volumen extraíble que tiene la instalación de cualquiera de los productos aptos.
