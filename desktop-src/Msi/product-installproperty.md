...
Para recuperar el identificador de producto, el propietario registrado o la empresa registrada de las aplicaciones que ya están instaladas, establezca *property* en uno de los siguientes valores de cadena de texto.
...
Las propiedades de la lista siguiente también se pueden recuperar de las aplicaciones que se anuncian. Estas propiedades no se pueden recuperar para las instancias de producto que se instalan en un contexto no administrado por usuario para cuentas de usuario que no sean la cuenta de usuario actual.
...
| LENGUAJE \_ INSTALLPROPERTY             | Idioma del producto.                                                                                                                                                                                                                                                                                    |
| INSTALLPROPERTY \_ PRODUCTNAME          | Legible: nombre del producto. Para obtener más información, vea la [**propiedad ProductName.**](productname.md)                                                                                                                                                                                              |
