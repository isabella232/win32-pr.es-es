---
description: Para obtener información sobre los atributos de control, vea el vínculo al control concreto que debe crear en Controles, así como los vínculos a atributos de control concretos en las listas siguientes.
