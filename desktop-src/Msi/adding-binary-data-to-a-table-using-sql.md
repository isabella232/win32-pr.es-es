---
description: Los datos binarios no se pueden insertar en una tabla directamente mediante las consultas INSERT INTO SQL UPDATE.
...
ms.locfileid: "127159214"
---
# <a name="adding-binary-data-to-a-table-using-sql"></a>Agregar datos binarios a una tabla mediante SQL

Los datos binarios no se pueden insertar en una tabla directamente mediante las consultas INSERT INTO SQL UPDATE. Para agregar datos binarios a una tabla, primero debe usar el marcador de parámetro (?) en la consulta como marcador de posición para el valor binario. La ejecución de la consulta debe incluir un registro que contenga los datos binarios en uno de sus campos.
