...
-   Use las API de Direct3D 9 Windows XP y versiones posteriores. Todo el hardware admite las API de Direct3D 9, incluso hardware de nivel 11 de Direct3D más reciente.
-   Use las API de Direct3D 10 con Windows Vista y versiones posteriores. Solo el hardware de nivel 10 de Direct3D y versiones posteriores admite las API de Direct3D 10.
...
-   Los vértices y los recursos de sombreador fluyen a primitivos, que se pueden ampliar.
