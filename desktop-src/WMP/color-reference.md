...
| ydalmond ( \# FFEBCD)  | blue ( \# 0000FF)             | blueviolet ( \# 8A2BE2)           | brown \# (A52A2A)             |
| burlywood ( \# DEB887)       | blueblue ( \# 5F9EA0)        | chartreuse ( \# 7FFF00)           | chocolate \# (D2691E)         |
| coral ( \# FF7F50)           | flowerblue ( \# 6495ED)   | cornsilk \# (FFF8DC)             | crimson \# (DC143C)           |
| cian ( \# 00FFFF)            | darkblue ( \# 00008B)         | darkcyan ( \# 008B8B)             | darkgoldenrod ( \# B8860B)     |
...
| ushblush ( \# FFF0F5)   | ygreen ( \# 7CFC00)        | ffchiffon \# (FFFACD)         | lightblue \# (ADD8E6)         |
...
| yturquoise \# (AFEEEE)   | yvioletred ( \# DB7093)    | yyawhip ( \# FFEFD5)           | uffpuff ( \# FFDAB9)         |
| ( \# CD853F)            | rosa \# (FFC0CB)             | plum ( \# DDA0DD)                 | blueblue ( \# B0E0E6)        |
| púrpura ( \# 800080)          | red ( \# FF0000)              | rosybrown \# (BC8F8F)            | blueblue ( \# 4169E1)         |
| wnbrown ( \# 8B4513)     | ( \# FA8072)           | lugar de trabajo ( \# F4A460)           | seagreen ( \# 2E8B57)          |
