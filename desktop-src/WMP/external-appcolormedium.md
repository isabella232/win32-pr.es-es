...
description: Nota En este tema se describe la funcionalidad diseñada para su uso por las tiendas en línea. | External.appColorMedium
ms.assetid: 85381b64-6d6c-4e08-9d1d-05372c0b818c
keywords:
- External.appColorMedium Reproductor de Windows Media
topic_type:
- apiref
api_name:
...
La **propiedad appColorMedium** recupera el color sombreado medio actual de la interfaz Reproductor de Windows Media usuario.
