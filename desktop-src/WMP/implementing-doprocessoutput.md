...
-   Si el complemento no está habilitado actualmente, simplemente copie los datos sin modificar en el búfer de salida. Si el complemento convierte los datos a un formato diferente, también debe realizar el procesamiento de conversión aquí.
    ...
    -   Recupere un puntero a la estructura de formato de entrada. Deberá recuperar los datos de miembro de esta estructura, así que copie el puntero de *m \_ mtInput*.**pbformat** a una variable de puntero local de un tipo que coincide con el tipo de estructura de formato. En el ejemplo siguiente se almacena un puntero a una estructura de formato de **entrada DE FORMA DEDATOX:**
