---
title: Escritura del código
description: Escritura del código
...
- escribir código para máscaras, Reproductor de Windows Media Mobile
...
-   [Sección Marquee](marquee-section.md)
-   [Sección Barras de seguimiento](trackbars-section.md)

Para obtener más información sobre los detalles de los archivos de definición de máscara, vea La [referencia de máscara](skin-reference.md).
