...
|--------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|
| Borde             | Interfaz de usuario fija y personalizada creada por el propietario del contenido para mostrar, vincular y reproducir todos los medios empaquetados en el Windows de descarga multimedia. Las técnicas usadas para crear bordes son similares a las que se usan para crear máscaras. | .wmz                                     |
