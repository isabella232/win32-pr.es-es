...
description: El atributo RecordingTime es la fecha y hora de la grabación original, para los elementos en los que esta fecha es diferente de la fecha de lanzamiento.
ms.assetid: 39f7356b-b4b9-48cd-bd14-1336a2f4736a
keywords:
- Atributo RecordingTime Reproductor de Windows Media
topic_type:
- apiref
api_name:
- RecordingTime
...
El **atributo RecordingTime** es la fecha y hora de la grabación original, para los elementos en los que esta fecha es diferente de la fecha de lanzamiento.
