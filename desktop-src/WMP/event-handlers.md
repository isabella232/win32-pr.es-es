...
- events,JScript
- JScript para máscaras, controladores de eventos
ms.topic: article
ms.date: 05/31/2018
...
Microsoft JScript se usa para procesar eventos en el archivo de definición de máscara. Vea [Control de eventos](handling-events.md) para obtener más información sobre los controladores de eventos.
