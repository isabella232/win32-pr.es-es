...
description: El atributo backgroundColor especifica o recupera el color de fondo en el control de cuadro de lista.
ms.assetid: 1ffa51cc-6d28-4b83-8127-eb2a67d98c79
keywords:
- LISTBOX.backgroundColor Reproductor de Windows Media
topic_type:
- apiref
api_name:
...
ms.locfileid: "118118950"
---
# <a name="listboxbackgroundcolor"></a>LISTBOX.backgroundColor

El **atributo backgroundColor** especifica o recupera el color de fondo en el control de cuadro de lista.
