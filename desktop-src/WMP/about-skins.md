...
description: Obtenga información sobre las máscaras. Las máscaras son archivos de arte informáticos organizados por un archivo de texto, que Reproductor de Windows Media cómo mostrar una máscara.
...
Las máscaras son simplemente colecciones de uno o varios archivos de arte informáticos, organizados por un archivo de texto, que indica a Reproductor de Windows Media cómo usar estos archivos para mostrar una máscara. Puede usar una variedad de programas para modificar el arte existente o crear un arte sencillo propio. Por ejemplo, con las herramientas de dibujo y las imágenes prediseñadas proporcionadas con Microsoft PowerPoint, puede crear ilustraciones arrastrando y colocando. Del mismo modo, no es necesario ser programador para crear el archivo de texto que se usa para definir una máscara individual.
...
| Sección                                                                                           | Descripción                                                                               |
|---------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|
| [¿Por qué crear máscaras?](why-make-skins.md)                                                             | Describe algunos de los usos de máscaras.                                                     |
| [Archivos de máscara](skin-files.md)                                                                      | Detalla los tipos de archivo de las máscaras y sus usos.                                          |
...
| [Envío de la máscara](submitting-your-skin.md)                                                  | Ya no se admite la distribución de máscaras en el sitio web de WMPlugins.                  |
