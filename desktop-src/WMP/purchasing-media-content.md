...
Si la tienda en línea activa es de tipo 1, Reproductor de Windows Media tiene acceso para realizar un seguimiento, un álbum y enumerar los precios en el catálogo de la tienda en línea. Esos precios del catálogo son cadenas que tienen un formato que solo entiende la tienda en línea. Reproductor de Windows Media no interpreta las cadenas de precio; simplemente los muestra en elementos de la interfaz de usuario, como los botones Comprar.
