...
La **interfaz IWMPStringCollection2 (VB y C#)** tiene estos métodos.
...
Obtenga una **interfaz IWMPStringCollection2** mediante la conversión del valor devuelto por el [**método IWMPMediaCollection.getAttributeStringCollection.**](/previous-versions/windows/desktop/api/wmp/nf-wmp-iwmpmediacollection-getattributestringcollection)
