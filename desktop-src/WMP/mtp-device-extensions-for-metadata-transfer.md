...
- Reproductor de Windows Media,Media Transfer Protocol (MTP)
...
El estado se indica a través del parámetro de respuesta 3 bit a bit mediante las marcas siguientes.



| Marca                                             | Value | Descripción                                                                                                                                                                                                                          |
|--------------------------------------------------|-------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **WMP \_ MDRT \_ MARCA LOS ELEMENTOS \_ ELIMINADOS NO INFORMES \_ \_** | 0x1   | Los elementos se eliminaron antes de que se notificase el primer nombre de ruta de acceso del objeto. Esto suele indicar que se ha formatear el dispositivo.                                                                                                           |
| **WMP \_ MDRT \_ MARCA ELEMENTOS \_ AGREGADOS NO \_ \_ COMUNICADOS**   | 0x2   | El dispositivo contiene algunos elementos agregados que no se pueden devolver en la lista de PUOIDS. Tenga en cuenta que esta marca no es redundante con el parámetro de respuesta 2. Establezca esta marca solo cuando haya elementos solicitados que el dispositivo no pueda devolver. |



 

Los bits del 2 al 31 están reservados para su uso futuro. Estos bits deben establecerse en cero.
...
Reproductor de Windows Media los valores de los atributos enumerados en Acerca de [los](about-the-metadata.md) metadatos para cada ELEMENTOID modificado devuelto en la respuesta. Reproductor de Windows Media enviar valores actualizados para estos atributos al dispositivo en comandos posteriores.
