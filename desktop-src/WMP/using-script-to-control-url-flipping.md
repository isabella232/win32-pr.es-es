...
- Reproductor de Windows Media Streaming multimedia enriquecido y móvil
...
En primer lugar, debe crear una página web del conjunto de fotogramas que contenga el fotograma con el reproductor insertado y el marco que muestra el código HTML de streaming. Cada uno de estos dos marcos mostrará inicialmente una página web independiente, por lo que creará un total de tres páginas web. En el código de ejemplo siguiente se muestra la página web del conjunto de marcos:
...
El ejemplo de página web anterior incorpora dos fotogramas. El primer fotograma se muestra en la mitad izquierda de la ventana del explorador y muestra la página web denominada embed \_player.htm. El código de ejemplo siguiente crea esta página web:
...
El segundo fotograma del conjunto de marcos se muestra en la mitad derecha de la ventana del explorador y muestra una página web denominada "blank.htm". El código de ejemplo siguiente crea esta página web:
...
Cuando se carga la página del conjunto de marcos en el explorador, el marco izquierdo muestra el reproductor incrustado y el marco derecho muestra el texto "Cargando...". para informar al usuario de que se acercan más datos. Cuando el primer comando de script de dirección URL llega de la secuencia HTML, el controlador de eventos simplemente cambia el valor de la **marca booleana.** Cuando cada comando de script de dirección URL posterior llega desde la secuencia HTML, el script del controlador de eventos carga la nueva dirección URL en el marco denominado "content" y la página web completa se muestra en el marco ubicado en la mitad derecha de la ventana del explorador.
...
[**Volteo de dirección URL**](url-flipping.md)
</dt> </dl>
