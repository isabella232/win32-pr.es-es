...
Puede crear una lista de reproducción con cualquier editor de texto, como Microsoft Bloc de notas. Abra el editor de texto. Escriba las entradas de script que desea implementar. Cuando haya terminado de escribir en Bloc de notas, guarde el archivo con un nombre de archivo y una extensión de nombre de archivo adecuados. Para obtener más información sobre las extensiones, vea [Directrices de extensión de metarchivo](metafile-extension-guidelines.md). Normalmente, el nombre de archivo es el nombre de la secuencia o el archivo multimedia Windows seguido de una extensión de .locución, .wvx o .asx. Por ejemplo, si el contenido multimedia es un archivo de audio multimedia Windows que tiene una extensión .wma, use la extensión .extension al asignar un nombre a la lista de reproducción. Las listas de reproducción no deben incluir ningún código de formato de un procesador de palabras, como Microsoft Word. Para asegurarse de que no se incluyen códigos de formato en la lista de reproducción, guarde el archivo como un archivo ASCII o de texto sin formato.
...
Si un elemento no tiene ningún elemento secundario (los que modifican o están contenidos dentro de otro elemento), se puede usar un carácter de barra diagonal única (/) al final de la etiqueta de apertura, justo antes de ">", en lugar de una etiqueta de cierre. Los elementos secundarios de un elemento deben aparecer entre la etiqueta de apertura y cierre de ese elemento; De lo contrario, no son elementos secundarios para ese elemento y se omiten o provocan un error en la sintaxis de la lista de reproducción.

Los cuatro primeros caracteres de una lista de reproducción deben ser &lt; "ASX". El **elemento ASX** se usa en todas las listas de reproducción, independientemente de si su extensión es .desenlace, .wvx o .asx. Solo debe haber un elemento **ASX** por lista de reproducción. Este elemento identifica el archivo como una lista de Windows de metarchivo multimedia. No especifica el tipo de lista de reproducción.
...
El atributo **BANNERBAR** opcional define si el control Reproductor de Windows Media reserva espacio para un gráfico de banner. (Use el **elemento BANNER** para especificar el gráfico que se mostrará). Si el valor de **BANNERBAR** es FIXED, Reproductor de Windows Media reserva espacio de banner para la presentación y para cada clip, si la lista de reproducción del metarchivo especifica un banner para el programa o clip. Esto mantendrá el tamaño de la ventana de Reproductor de Windows Media igual (excepto cuando cambia el tamaño del vídeo) independientemente de la ausencia o presencia de un gráfico de banner. Si el clip o la presentación no tienen un banner asociado, el espacio reservado para uno es negro. Si el valor del atributo **BANNERBAR** es AUTO, Reproductor de Windows Media reserva espacio para el banner solo cuando el clip o el show incluya uno.
...
Para obtener más información sobre los tres atributos del **elemento ASX,** vea la entrada de referencia del [elemento ASX](asx-element.md).
...
Asegúrese de que la lista de reproducción funciona haciendo doble clic en Windows Explorer. Reproductor de Windows Media abrir e iniciar la transmisión por secuencias del contenido multimedia. Una vez que haya confirmado que la lista de reproducción funciona, guárdela en el servidor web junto con las páginas web y vincárrela a él mediante un **elemento HREF,** o bien insórrela en una página web mediante el elemento **Reproductor de Windows Media OBJECT.**

Las secciones siguientes contienen más información:

-   [Anidamiento de metarchivos](nesting-metafiles.md)
-   [Usar páginas ASP para crear dinámicamente listas de reproducción Windows de metarchivo multimedia](using-asp-pages-to-dynamically-create-windows-media-metafile-playlists.md)
