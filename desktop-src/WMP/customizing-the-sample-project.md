...
keywords:
- Reproductor de Windows Media en línea, personalización de proyectos de ejemplo
- tiendas en línea, personalización de proyectos de ejemplo
- tiendas en línea de tipo 2, personalización de proyectos de ejemplo
...
-   **CYourProject::allow CDYourProject**. Use esta función para aplicar las reglas de negocio para permitir a los usuarios copiar contenido protegido en un CD.
...
-   La implementación de **CAllowBaseDialog &lt; T &gt; ::OnRemoveMediaFromPlaylist**.
