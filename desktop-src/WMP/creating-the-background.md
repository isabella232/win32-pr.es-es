...
description: Creación del fondo
...
ms.locfileid: "117750418"
---
# <a name="creating-the-background"></a>Creación del fondo

Ahora está listo para crear la imagen de fondo. Mantenga la capa de rectángulo visible, pero manténla detrás de la capa en la que está dibujando y ús usarla como guía para crear las imágenes para la máscara. Querrá ensamblar cada elemento en una o varias capas para facilitar la copia en otro archivo más adelante. Por ejemplo, el botón PlayPause tendrá que copiarse en el archivo en pausa, el archivo deshabilitado y el archivo región. Al mover el arte al archivo región, asegúrese de que el arte que copie no tenga ningún efecto perimetral complejo, como sombras o biseles.
...
El diagrama siguiente es la imagen background.

![archivo en segundo plano](images/ceswmbak.png)

Se usaron biseles, relieves y sombras para crear los efectos visuales para los distintos elementos. Tenga en cuenta que no hay ningún botón para la imagen de posición del volumen. Se creará más adelante.
