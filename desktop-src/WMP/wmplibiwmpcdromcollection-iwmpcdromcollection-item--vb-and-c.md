...
En el ejemplo siguiente se usa el **elemento** para mostrar el especificador de unidad y el nombre de lista de reproducción de cada CD disponible en el equipo en un cuadro de lista. Si la unidad contiene realmente contenido de DVD, se requiere Windows XP o posterior. El objeto **AxWMPLib. AxWindowsMediaPlayer** se representa mediante la variable denominada Player.
