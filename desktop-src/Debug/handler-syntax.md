...
|-----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **\_\_try**     | Comienza un cuerpo de código guardado. Se usa con la **\_ \_ palabra clave except** para construir un controlador de [excepciones](exception-handler-syntax.md)o con la palabra clave **\_ \_ finally** para construir un [controlador de terminación](termination-handler-syntax.md). |
