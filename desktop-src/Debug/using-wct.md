...
---
# <a name="using-wct"></a><span data-ttu-id="1cda7-104">Usar WCT</span><span class="sxs-lookup"><span data-stu-id="1cda7-104">Using WCT</span></span>

<span data-ttu-id="1cda7-105">En el código de ejemplo siguiente se muestra el uso de la API de recorrido de la cadena de espera.</span><span class="sxs-lookup"><span data-stu-id="1cda7-105">The following sample code demonstrates the use of the wait chain traversal API.</span></span> <span data-ttu-id="1cda7-106">Enumera todos los subprocesos del sistema e imprime la cadena de espera para cada subproceso.</span><span class="sxs-lookup"><span data-stu-id="1cda7-106">It enumerates all threads in the system and prints the wait chain for each thread.</span></span>

<span data-ttu-id="1cda7-107">Para enumerar todos los subprocesos del sistema, ejecute el ejemplo sin parámetros.</span><span class="sxs-lookup"><span data-stu-id="1cda7-107">To enumerate all threads in the system, run the sample with no parameters.</span></span> <span data-ttu-id="1cda7-108">Para enumerar solo los subprocesos de un proceso especificado, ejecute el ejemplo y pase el identificador de proceso como parámetro.</span><span class="sxs-lookup"><span data-stu-id="1cda7-108">To enumerate only the threads from a specified process, run the sample and pass the process identifier as a parameter.</span></span> <span data-ttu-id="1cda7-109">En el ejemplo se realizan los pasos siguientes:</span><span class="sxs-lookup"><span data-stu-id="1cda7-109">The sample performs the following steps:</span></span>

1. <span data-ttu-id="1cda7-110">Llama a la función [RegisterWaitChainCOMCallback](/windows/desktop/api/Wct/nf-wct-registerwaitchaincomcallback) para registrar las funciones de devolución de llamada com.</span><span class="sxs-lookup"><span data-stu-id="1cda7-110">Calls the [RegisterWaitChainCOMCallback](/windows/desktop/api/Wct/nf-wct-registerwaitchaincomcallback) function to register the COM callback functions.</span></span>
2. <span data-ttu-id="1cda7-111">Llama a la función [OpenThreadWaitChainSession](/windows/desktop/api/Wct/nf-wct-openthreadwaitchainsession) para crear la sesión de la cadena de espera.</span><span class="sxs-lookup"><span data-stu-id="1cda7-111">Calls the [OpenThreadWaitChainSession](/windows/desktop/api/Wct/nf-wct-openthreadwaitchainsession) function to create the wait chain session.</span></span>
3. <span data-ttu-id="1cda7-112">Llama a la función [AdjustTokenPrivileges](/windows/win32/api/securitybaseapi/nf-securitybaseapi-adjusttokenprivileges) para habilitar el \_ privilegio de nombre de depuración de se \_ .</span><span class="sxs-lookup"><span data-stu-id="1cda7-112">Calls the [AdjustTokenPrivileges](/windows/win32/api/securitybaseapi/nf-securitybaseapi-adjusttokenprivileges) function to enable the SE\_DEBUG\_NAME privilege.</span></span>
4. <span data-ttu-id="1cda7-113">Llama a las funciones [EnumProcesses](/windows/win32/api/psapi/nf-psapi-enumprocesses) y [CreateToolhelp32Snapshot](/windows/win32/api/tlhelp32/nf-tlhelp32-createtoolhelp32snapshot) para enumerar los subprocesos especificados.</span><span class="sxs-lookup"><span data-stu-id="1cda7-113">Calls the [EnumProcesses](/windows/win32/api/psapi/nf-psapi-enumprocesses) and [CreateToolhelp32Snapshot](/windows/win32/api/tlhelp32/nf-tlhelp32-createtoolhelp32snapshot) functions to enumerate the specified threads.</span></span>
5. <span data-ttu-id="1cda7-114">Llama a [GetThreadWaitChain](/windows/desktop/api/Wct/nf-wct-getthreadwaitchain) para recuperar una matriz de estructuras de [ \_ \_ información del nodo WAITCHAIN](/windows/desktop/api/Wct/ns-wct-waitchain_node_info) que contienen los nodos de la cadena de espera.</span><span class="sxs-lookup"><span data-stu-id="1cda7-114">Calls the [GetThreadWaitChain](/windows/desktop/api/Wct/nf-wct-getthreadwaitchain) to retrieve an array of [WAITCHAIN\_NODE\_INFO](/windows/desktop/api/Wct/ns-wct-waitchain_node_info) structures that contain the nodes of the wait chain.</span></span>
6. <span data-ttu-id="1cda7-115">Imprime información de la cadena de espera.</span><span class="sxs-lookup"><span data-stu-id="1cda7-115">Prints information from the wait chain.</span></span>
7. <span data-ttu-id="1cda7-116">Llama a la función [CloseThreadWaitChainSession](/windows/desktop/api/Wct/nf-wct-closethreadwaitchainsession) para limpiar la cadena de espera.</span><span class="sxs-lookup"><span data-stu-id="1cda7-116">Calls the [CloseThreadWaitChainSession](/windows/desktop/api/Wct/nf-wct-closethreadwaitchainsession) function to clean up the wait chain.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="1cda7-117">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="1cda7-117">Related topics</span></span>

<span data-ttu-id="1cda7-118">[Wait Chain Traversal](wait-chain-traversal.md), [referencia de WCT](wct-reference.md), [MSDN Magazine 2007 julio-Bugslayer: permisión de cadena de espera](/archive/msdn-magazine/2007/july/bugslayer-wait-chain-traversal), [Soporte técnico de Microsoft: corregir problemas con aplicaciones de Microsoft Store](https://support.microsoft.com/help/4027498/microsoft-store-fix-problems-with-apps)</span><span class="sxs-lookup"><span data-stu-id="1cda7-118">[Wait Chain Traversal](wait-chain-traversal.md), [WCT Reference](wct-reference.md), [MSDN Magazine 2007 July - Bugslayer: Wait Chain Traversal](/archive/msdn-magazine/2007/july/bugslayer-wait-chain-traversal), [Microsoft Support: Fix problems with apps from Microsoft Store](https://support.microsoft.com/help/4027498/microsoft-store-fix-problems-with-apps)</span></span>
