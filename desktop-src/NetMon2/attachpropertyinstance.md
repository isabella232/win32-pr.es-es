...
---
# <a name="attachpropertyinstance-function"></a>AttachPropertyInstance función)

La función **AttachPropertyInstance** asigna una propiedad existente a una ubicación específica en los datos reconocidos.
...
El número de identificación es relativo al archivo de ayuda asociado a la [*base de datos de propiedades*](p.md)de protocolo.
...
Durante la implementación de [**AttachProperties**](attachproperties.md), llame a **AttachPropertyInstance** para usar los datos tal como existen en la captura. También puede llamar a la función [**AttachPropertyInstanceEx**](attachpropertyinstanceex.md) para modificar los datos de la propiedad. Sin embargo, se recomienda que use los datos tal como existen en la captura.
