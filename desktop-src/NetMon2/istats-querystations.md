...
---
# <a name="istatsquerystations-method"></a>IStas:: QueryStations (método)
...
En la salida, esta estructura devuelve el número de equipos que capturan datos y una estructura [STATIONQUERY](stationquery.md) para cada equipo encontrado. Tenga en cuenta que esta información puede incluir equipos con versiones de Monitor de red esa versión previa 2,0.
