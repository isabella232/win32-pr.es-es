...
En la ilustración siguiente se muestra la [relación](experts.md) entre las [aplicaciones](parsers.md) de expertos y analizadores y otros componentes de la Monitor de red de análisis.
