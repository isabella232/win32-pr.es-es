...
-   Cada uno de los designadores, así como sus valores, son cadenas. Tenga en cuenta que las cadenas devueltas por las **funciones GetString** son realmente punteros a BLOB y no se deben cambiar. Por este motivo, estas cadenas deben especificarse como **const char** _ pX* para evitar que las aplicaciones las \_ cambien accidentalmente.
