...
---
# <a name="getcapturetotalframes-function"></a>GetCaptureTotalFrames función)
...
Identificador de la captura. Para obtener información acerca de cómo obtener el identificador de captura, vea la sección Comentarios de este tema **GetCaptureTotalFrames** .
...
Los [*expertos*](e.md) y [*analizadores*](p.md) pueden llamar a la función **GetCaptureTotalFrames** .
