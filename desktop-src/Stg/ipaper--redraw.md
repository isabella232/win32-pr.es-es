...
---
# <a name="ipaperredraw"></a><span data-ttu-id="eadd3-103">IPaper:: redraw</span><span class="sxs-lookup"><span data-stu-id="eadd3-103">IPaper::Redraw</span></span>

<span data-ttu-id="eadd3-104">El método **IPaper:: redraw** se basa en la tecnología de punto de conexión.</span><span class="sxs-lookup"><span data-stu-id="eadd3-104">The **IPaper::Redraw** method relies on the connection point technology.</span></span>

<span data-ttu-id="eadd3-105">El siguiente código de ejemplo es el método **redraw** de Paper. cpp.</span><span class="sxs-lookup"><span data-stu-id="eadd3-105">The following sample code is the **Redraw** method from Paper.cpp.</span></span>
...
<span data-ttu-id="eadd3-106">Para obtener más información, vea método [**IPaperSink**](ipapersink-methods.md) .</span><span class="sxs-lookup"><span data-stu-id="eadd3-106">For more information, see [**IPaperSink**](ipapersink-methods.md) method.</span></span>
