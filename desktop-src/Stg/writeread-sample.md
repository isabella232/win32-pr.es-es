...
---
# <a name="writeread-sample"></a><span data-ttu-id="16bb8-104">Ejemplo de WriteRead</span><span class="sxs-lookup"><span data-stu-id="16bb8-104">WriteRead Sample</span></span>

<span data-ttu-id="16bb8-105">WriteRead. cpp crea un conjunto de propiedades, escribe una propiedad, cierra y vuelve a abrir el conjunto de propiedades y vuelve a leer la propiedad.</span><span class="sxs-lookup"><span data-stu-id="16bb8-105">The WriteRead.cpp creates a property set, writes a property, closes and reopens the property set, and reads back the property.</span></span> <span data-ttu-id="16bb8-106">Esta aplicación de ejemplo crea el archivo "WriteRead. STG" en el directorio actual.</span><span class="sxs-lookup"><span data-stu-id="16bb8-106">This sample application creates the file "WriteRead.stg" in the current directory.</span></span> <span data-ttu-id="16bb8-107">Crea conjuntos de propiedades en un archivo de almacenamiento de estructura, pero un cambio de una línea hace que cree conjuntos de propiedades del sistema de archivos NTFS.</span><span class="sxs-lookup"><span data-stu-id="16bb8-107">It creates property sets in a structure storage file, but a one-line change causes it to create NTFS file system property sets.</span></span>
