...
Cuando **StoServe se** compila para ANSI (no para Unicode), esta llamada se reduce realmente a una llamada a una función suplente APPUTIL interna. Para admitir esto, se usa el siguiente esquema de macro en Apputil.h, que es un archivo incluido en todo el código de ejemplo . Archivos CPP.
