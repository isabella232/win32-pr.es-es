...
A continuación se muestran los cuatro métodos de la implementación de [**IFillLockBytes**](/windows/desktop/api/Objidl/nn-objidl-ifilllockbytes) .
...
Escribe un nuevo bloque de bytes en el final de una matriz de bytes. El tamaño del bloque se especifica como un parámetro de [**FillAppend**](/windows/desktop/api/Objidl/nf-objidl-ifilllockbytes-fillappend).
...
Establece el tamaño de la matriz de bytes. Devuelve E \_ FAIL from llama a [**ILockBytes:: readatum**](/windows/desktop/api/Objidl/nf-objidl-ilockbytes-readat) que intentan obtener acceso a los datos más allá del límite superior especificado por el método.
