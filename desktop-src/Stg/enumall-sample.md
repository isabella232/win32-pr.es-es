---
title: Ejemplo de EnumAll
description: Coloca todas las propiedades en todos los conjuntos de propiedades de un archivo de almacenamiento.
ms.assetid: 40dd62b8-f76a-4cd8-9a9f-6ac344389b6c
keywords:
- Strctd de almacenamiento estructurado STG, ejemplos, EnumAll
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104356990"
---
# <a name="enumall-sample"></a><span data-ttu-id="3c753-104">Ejemplo de EnumAll</span><span class="sxs-lookup"><span data-stu-id="3c753-104">EnumAll Sample</span></span>

<span data-ttu-id="3c753-105">La aplicación de ejemplo EnumAll. cpp coloca todas las propiedades en todos los conjuntos de propiedades de un archivo de almacenamiento.</span><span class="sxs-lookup"><span data-stu-id="3c753-105">The EnumAll.cpp sample application puts all properties in all property sets of a storage file.</span></span>
