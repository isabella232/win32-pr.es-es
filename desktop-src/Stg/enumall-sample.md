...
---
# <a name="enumall-sample"></a>Ejemplo de EnumAll

La aplicación de ejemplo EnumAll. cpp coloca todas las propiedades en todos los conjuntos de propiedades de un archivo de almacenamiento.
