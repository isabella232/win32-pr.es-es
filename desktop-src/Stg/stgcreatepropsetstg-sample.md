...
---
# <a name="stgcreatepropsetstg-sample"></a>Ejemplo de StgCreatePropSetStg

El ejemplo StgCreatePropSetStg. cpp muestra cómo se puede usar la función [**StgCreatePropSetStg**](/windows/desktop/api/coml2api/nf-coml2api-stgcreatepropsetstg) para crear una interfaz [**IPropertySetStorage**](/windows/desktop/api/Propidl/nn-propidl-ipropertysetstorage) sobre cualquier interfaz [**IStorage**](/windows/desktop/api/Objidl/nn-objidl-istorage) determinada.
