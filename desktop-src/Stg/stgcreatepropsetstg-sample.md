---
title: Ejemplo de StgCreatePropSetStg
description: Muestra cómo se puede usar la función StgCreatePropSetStg para crear una interfaz IPropertySetStorage sobre una interfaz IStorage determinada.
ms.assetid: f0d0664a-2cfd-4eb0-b1d5-47d1545394fd
keywords:
- Strctd de almacenamiento estructurado STG, ejemplos, StgCreatePropSetStg
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104419013"
---
# <a name="stgcreatepropsetstg-sample"></a><span data-ttu-id="a7b17-104">Ejemplo de StgCreatePropSetStg</span><span class="sxs-lookup"><span data-stu-id="a7b17-104">StgCreatePropSetStg Sample</span></span>

<span data-ttu-id="a7b17-105">El ejemplo StgCreatePropSetStg. cpp muestra cómo se puede usar la función [**StgCreatePropSetStg**](/windows/desktop/api/coml2api/nf-coml2api-stgcreatepropsetstg) para crear una interfaz [**IPropertySetStorage**](/windows/desktop/api/Propidl/nn-propidl-ipropertysetstorage) sobre cualquier interfaz [**IStorage**](/windows/desktop/api/Objidl/nn-objidl-istorage) determinada.</span><span class="sxs-lookup"><span data-stu-id="a7b17-105">The StgCreatePropSetStg.cpp sample shows how the [**StgCreatePropSetStg**](/windows/desktop/api/coml2api/nf-coml2api-stgcreatepropsetstg) function can be used to create an [**IPropertySetStorage**](/windows/desktop/api/Propidl/nn-propidl-ipropertysetstorage) interface on top of any given [**IStorage**](/windows/desktop/api/Objidl/nn-objidl-istorage) interface.</span></span>
