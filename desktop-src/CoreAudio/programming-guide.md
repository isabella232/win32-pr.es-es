...
| [Audio en modo de usuario protegido (IAM)](protected-user-mode-audio--puma-.md)                                                   | Describe las actualizaciones de Audio en modo de usuario protegido (IAM), el motor de audio en modo de usuario en el entorno protegido (PE), que proporciona un entorno más seguro para el procesamiento y la representación de audio.              |
...
| [Administración de flujos](stream-management.md)                                                                                 | La API de sesión de audio de Windows (WASAPI) proporciona a un cliente un conjunto completo de métodos para crear y administrar secuencias de audio.                                                                             |
