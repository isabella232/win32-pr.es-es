...
ms.locfileid: "118406898"
---
# <a name="working-with-device-roles"></a>Trabajar con roles de dispositivo

MMDevice [API admite roles](mmdevice-api.md) de dispositivo. La [**enumeración ERole**](/windows/win32/api/mmdeviceapi/ne-mmdeviceapi-erole) define los roles de dispositivo que admite MMDevice API.

> [!Note]  
> Aunque [MMDevice API admite roles](mmdevice-api.md) de dispositivo, la interfaz de usuario de Windows Vista no implementa compatibilidad con esta característica.
