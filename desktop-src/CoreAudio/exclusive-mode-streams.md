...
Para obtener más información sobre **AvSetMmThreadCharacteristics** y **AvRevertMmThreadCharacteristics,** vea la documentación Windows SDK .
...
Para obtener más información **sobre WaitForSingleObject**, vea la documentación Windows SDK datos.
