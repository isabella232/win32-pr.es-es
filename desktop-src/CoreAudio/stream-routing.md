---
description: El enrutamiento de secuencias es la capacidad de una aplicación multimedia de cambiar secuencias entre dispositivos con una interrupción mínima en la reproducción o la sesión de captura.
ms.assetid: fc6efe89-013c-47af-870e-8705fa60c99c
title: Enrutamiento de secuencias
ms.topic: article
ms.date: 05/31/2018
...
Los ejemplos siguientes, incluidos en el SDK de Windows, muestran cómo una aplicación puede controlar las notificaciones de enrutamiento de secuencias.
