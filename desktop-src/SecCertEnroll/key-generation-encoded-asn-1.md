...
---
# <a name="key-generation-encoded-asn1"></a><span data-ttu-id="eb50c-103">ASN de generación de claves codificado. 1</span><span class="sxs-lookup"><span data-stu-id="eb50c-103">Key Generation Encoded ASN.1</span></span>

<span data-ttu-id="eb50c-104">El ejemplo siguiente contiene una solicitud de generación de clave que se muestra en formato ASN. 1.</span><span class="sxs-lookup"><span data-stu-id="eb50c-104">The following example contains a key generation request shown in ASN.1 format.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="eb50c-105">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="eb50c-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="eb50c-106">Solicitudes de ejemplo</span><span class="sxs-lookup"><span data-stu-id="eb50c-106">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
