...
---
# <a name="cmc-renewal-encoded-asn1"></a><span data-ttu-id="516ae-105">ASN de renovación codificada de CMC. 1</span><span class="sxs-lookup"><span data-stu-id="516ae-105">CMC Renewal Encoded ASN.1</span></span>

<span data-ttu-id="516ae-106">El ejemplo siguiente contiene una solicitud de renovación de CMC que se muestra en formato ASN. 1.</span><span class="sxs-lookup"><span data-stu-id="516ae-106">The following example contains a CMC renewal request shown in ASN.1 format.</span></span> <span data-ttu-id="516ae-107">El ejemplo se generó con las herramientas Certreq.exe y Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="516ae-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="516ae-108">El archivo. inf que se usa como entrada para Certreq.exe contiene la configuración siguiente.</span><span class="sxs-lookup"><span data-stu-id="516ae-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="516ae-109">La configuración especifica el tipo de solicitud (CMC) y el número de serie del certificado en el que se basa la solicitud.</span><span class="sxs-lookup"><span data-stu-id="516ae-109">The configuration specifies the type of request (CMC) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="516ae-110">Esto genera el siguiente resultado.</span><span class="sxs-lookup"><span data-stu-id="516ae-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="516ae-111">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="516ae-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="516ae-112">Solicitudes de ejemplo</span><span class="sxs-lookup"><span data-stu-id="516ae-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
