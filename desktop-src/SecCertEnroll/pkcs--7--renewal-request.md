...
---
# <a name="pkcs-7-renewal-request"></a><span data-ttu-id="853df-105">Solicitud de renovación de PKCS \# 7</span><span class="sxs-lookup"><span data-stu-id="853df-105">PKCS \#7 Renewal Request</span></span>

<span data-ttu-id="853df-106">El ejemplo siguiente contiene una solicitud de renovación de PKCS \# 7.</span><span class="sxs-lookup"><span data-stu-id="853df-106">The following example contains a PKCS \#7 renewal request.</span></span> <span data-ttu-id="853df-107">El ejemplo se generó con las herramientas Certreq.exe y Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="853df-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="853df-108">El archivo. inf que se usa como entrada para Certreq.exe contiene la configuración siguiente.</span><span class="sxs-lookup"><span data-stu-id="853df-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="853df-109">La configuración especifica el tipo de solicitud (PKCS \# 7) y el número de serie del certificado en el que se basa la solicitud.</span><span class="sxs-lookup"><span data-stu-id="853df-109">The configuration specifies the type of request (PKCS \#7) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="853df-110">Esto genera el siguiente resultado.</span><span class="sxs-lookup"><span data-stu-id="853df-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="853df-111">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="853df-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="853df-112">Solicitudes de ejemplo</span><span class="sxs-lookup"><span data-stu-id="853df-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
