...
title: Enumerar los proveedores instalados
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103910613"
---
# <a name="enumerating-installed-providers"></a><span data-ttu-id="fe486-103">Enumerar los proveedores instalados</span><span class="sxs-lookup"><span data-stu-id="fe486-103">Enumerating Installed Providers</span></span>

<span data-ttu-id="fe486-104">En el ejemplo siguiente se muestra cómo usar la API de inscripción de certificados para enumerar los proveedores instalados en un equipo.</span><span class="sxs-lookup"><span data-stu-id="fe486-104">The following example shows how to use the Certificate Enrollment API to enumerate the providers installed on a computer.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="fe486-105">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="fe486-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="fe486-106">Descripción de los proveedores de servicios criptográficos</span><span class="sxs-lookup"><span data-stu-id="fe486-106">Understanding Cryptographic Providers</span></span>](understanding-cryptographic-providers.md)
</dt> </dl>
