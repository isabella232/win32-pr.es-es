...
---
# <a name="cmc-request"></a><span data-ttu-id="dfd40-105">Solicitud de CMC</span><span class="sxs-lookup"><span data-stu-id="dfd40-105">CMC Request</span></span>

<span data-ttu-id="dfd40-106">El ejemplo siguiente contiene una solicitud de certificado CMC.</span><span class="sxs-lookup"><span data-stu-id="dfd40-106">The following example contains a CMC certificate request.</span></span> <span data-ttu-id="dfd40-107">El ejemplo se generó con las herramientas Certreq.exe y Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="dfd40-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="dfd40-108">El archivo. inf que se usa como entrada para Certreq.exe contiene la configuración siguiente.</span><span class="sxs-lookup"><span data-stu-id="dfd40-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="dfd40-109">Esta configuración genera el siguiente resultado de ejemplo.</span><span class="sxs-lookup"><span data-stu-id="dfd40-109">This configuration generates the following sample output.</span></span> <span data-ttu-id="dfd40-110">La configuración especifica el asunto, el tipo de solicitud (CMC) y la plantilla de certificado (usuario).</span><span class="sxs-lookup"><span data-stu-id="dfd40-110">The configuration specifies the subject, type of request (CMC), and certificate template (User).</span></span> <span data-ttu-id="dfd40-111">La plantilla de usuario especifica que:</span><span class="sxs-lookup"><span data-stu-id="dfd40-111">The User template specifies that:</span></span>

-   <span data-ttu-id="dfd40-112">La solicitud debe usar el proveedor de servicios criptográficos de base de Microsoft 1,0 o el proveedor de servicios criptográficos de Microsoft mejorado 1,0.</span><span class="sxs-lookup"><span data-stu-id="dfd40-112">The request must use either the Microsoft Base Cryptographic Provider 1.0 or the Microsoft Enhanced Cryptographic Provider 1.0.</span></span>
-   <span data-ttu-id="dfd40-113">El nombre del firmante se debe crear a partir de Active Directory.</span><span class="sxs-lookup"><span data-stu-id="dfd40-113">The subject name must be built from Active Directory.</span></span>
-   <span data-ttu-id="dfd40-114">La solicitud incluye el nombre de la plantilla de certificado, el uso mejorado de clave (EKU) y las extensiones de uso de claves.</span><span class="sxs-lookup"><span data-stu-id="dfd40-114">The request includes the Certificate Template Name, Enhanced Key Usage (EKU), and Key Usage extensions.</span></span> <span data-ttu-id="dfd40-115">La extensión EKU especifica que el certificado emitido se puede usar para Sistema de cifrado de archivos (EFS), correo electrónico seguro y autenticación del cliente.</span><span class="sxs-lookup"><span data-stu-id="dfd40-115">The EKU extension specifies that the issued certificate can be used for Encrypting File System (EFS), secure email, and client authentication.</span></span>

<span data-ttu-id="dfd40-116">Una solicitud de certificado CMC se representa mediante la interfaz [**IX509CertificateRequestCmc**](/windows/desktop/api/CertEnroll/nn-certenroll-ix509certificaterequestcmc) .</span><span class="sxs-lookup"><span data-stu-id="dfd40-116">A CMC certificate request is represented by the [**IX509CertificateRequestCmc**](/windows/desktop/api/CertEnroll/nn-certenroll-ix509certificaterequestcmc) interface.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="dfd40-117">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="dfd40-117">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="dfd40-118">Solicitudes de ejemplo</span><span class="sxs-lookup"><span data-stu-id="dfd40-118">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
