...
---
# <a name="pkcs-7-eobo-request"></a><span data-ttu-id="0c046-105">\#Solicitud EOBO PKCS 7</span><span class="sxs-lookup"><span data-stu-id="0c046-105">PKCS \#7 EOBO Request</span></span>

<span data-ttu-id="0c046-106">El ejemplo siguiente contiene una \# solicitud de inscripción PKCS 7 en nombre de (EOBO).</span><span class="sxs-lookup"><span data-stu-id="0c046-106">The following example contains a PKCS \#7 Enroll On Behalf Of (EOBO) request.</span></span> <span data-ttu-id="0c046-107">El ejemplo se generó con las herramientas Certreq.exe y Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="0c046-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="0c046-108">El archivo. inf que se usa como entrada para Certreq.exe contiene la configuración siguiente.</span><span class="sxs-lookup"><span data-stu-id="0c046-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="0c046-109">Esta configuración genera el siguiente resultado de ejemplo.</span><span class="sxs-lookup"><span data-stu-id="0c046-109">This configuration generates the following sample output.</span></span> <span data-ttu-id="0c046-110">La configuración especifica el tipo de solicitud (PKCS \# 7), el nombre de la entidad que solicita la inscripción y el nombre de la plantilla.</span><span class="sxs-lookup"><span data-stu-id="0c046-110">The configuration specifies the type of request (PKCS \#7), the name of the entity requesting the enrollment, and the name of the template.</span></span> <span data-ttu-id="0c046-111">La plantilla de usuario especifica que:</span><span class="sxs-lookup"><span data-stu-id="0c046-111">The User template specifies that:</span></span>

-   <span data-ttu-id="0c046-112">La solicitud debe usar el proveedor de servicios criptográficos de base de Microsoft 1,0 o el proveedor de servicios criptográficos de Microsoft mejorado 1,0.</span><span class="sxs-lookup"><span data-stu-id="0c046-112">The request must use either the Microsoft Base Cryptographic Provider 1.0 or the Microsoft Enhanced Cryptographic Provider 1.0.</span></span>
-   <span data-ttu-id="0c046-113">El nombre del firmante se debe crear a partir de Active Directory.</span><span class="sxs-lookup"><span data-stu-id="0c046-113">The subject name must be built from Active Directory.</span></span>
-   <span data-ttu-id="0c046-114">La solicitud incluye el nombre de la plantilla de certificado, el uso mejorado de clave (EKU) y las extensiones de uso de claves.</span><span class="sxs-lookup"><span data-stu-id="0c046-114">The request includes the Certificate Template Name, Enhanced Key Usage (EKU), and Key Usage extensions.</span></span> <span data-ttu-id="0c046-115">La extensión EKU especifica que el certificado emitido se puede usar para Sistema de cifrado de archivos (EFS), correo electrónico seguro y autenticación del cliente.</span><span class="sxs-lookup"><span data-stu-id="0c046-115">The EKU extension specifies that the issued certificate can be used for Encrypting File System (EFS), secure email, and client authentication.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="0c046-116">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="0c046-116">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="0c046-117">Solicitudes de ejemplo</span><span class="sxs-lookup"><span data-stu-id="0c046-117">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
