...
---
# <a name="cmc-renewal-request"></a><span data-ttu-id="d5230-105">Solicitud de renovación de CMC</span><span class="sxs-lookup"><span data-stu-id="d5230-105">CMC Renewal Request</span></span>

<span data-ttu-id="d5230-106">El ejemplo siguiente contiene una solicitud de renovación de CMC.</span><span class="sxs-lookup"><span data-stu-id="d5230-106">The following example contains a CMC renewal request.</span></span> <span data-ttu-id="d5230-107">El ejemplo se generó con las herramientas Certreq.exe y Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="d5230-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="d5230-108">El archivo. inf que se usa como entrada para Certreq.exe contiene la configuración siguiente.</span><span class="sxs-lookup"><span data-stu-id="d5230-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="d5230-109">La configuración especifica el tipo de solicitud (CMC) y el número de serie del certificado en el que se basa la solicitud.</span><span class="sxs-lookup"><span data-stu-id="d5230-109">The configuration specifies the type of request (CMC) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="d5230-110">Esto genera el siguiente resultado.</span><span class="sxs-lookup"><span data-stu-id="d5230-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="d5230-111">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="d5230-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="d5230-112">Solicitudes de ejemplo</span><span class="sxs-lookup"><span data-stu-id="d5230-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
