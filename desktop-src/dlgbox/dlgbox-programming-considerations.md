...
Si la búsqueda de un control con un mnemotécnico correspondiente encuentra una ventana con el estilo **WS \_ EX \_ CONTROLPARENT,** el sistema busca recursivamente los secundarios de la ventana.
