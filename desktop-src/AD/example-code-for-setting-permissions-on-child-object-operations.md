...
---
# <a name="example-code-for-setting-permissions-on-child-object-operations"></a><span data-ttu-id="3fafd-104">Código de ejemplo para establecer permisos en operaciones de objetos secundarios</span><span class="sxs-lookup"><span data-stu-id="3fafd-104">Example Code for Setting Permissions on Child Object Operations</span></span>

<span data-ttu-id="3fafd-105">En el siguiente ejemplo de código de C y C++ se crea una ACE que asigna los derechos de creación de los objetos de usuario al administrador de confianza especificado.</span><span class="sxs-lookup"><span data-stu-id="3fafd-105">The following C and C++ code example creates an ACE that assigns creation rights for user objects to the specified trustee.</span></span>
