...
---
# <a name="example-code-for-installing-an-rnr-service-class"></a><span data-ttu-id="f0ed1-105">Código de ejemplo para instalar una clase de servicio RnR</span><span class="sxs-lookup"><span data-stu-id="f0ed1-105">Example Code for Installing an RnR Service Class</span></span>

<span data-ttu-id="f0ed1-106">El programa siguiente instala una clase de servicio RnR.</span><span class="sxs-lookup"><span data-stu-id="f0ed1-106">The following program installs an RnR Service class.</span></span>
