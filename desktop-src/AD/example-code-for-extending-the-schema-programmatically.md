...
---
# <a name="example-code-for-extending-the-schema-programmatically"></a><span data-ttu-id="49c3c-105">Código de ejemplo para extender el esquema mediante programación</span><span class="sxs-lookup"><span data-stu-id="49c3c-105">Example Code for Extending the Schema Programmatically</span></span>

<span data-ttu-id="49c3c-106">En este tema se incluye un ejemplo de código de C++ que extiende mediante programación el esquema de Active Directory.</span><span class="sxs-lookup"><span data-stu-id="49c3c-106">This topic includes a C++ code example that programmatically extends the Active Directory Schema.</span></span>
