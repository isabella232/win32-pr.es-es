...
---
# <a name="example-code-for-converting-an-objectsid-into-a-bindable-string"></a><span data-ttu-id="e8b08-103">Código de ejemplo para convertir un objectSid en una cadena enlazable</span><span class="sxs-lookup"><span data-stu-id="e8b08-103">Example Code for Converting an objectSid into a Bindable String</span></span>

<span data-ttu-id="e8b08-104">Este tema contiene un ejemplo de código que convierte un **objectSid** en una cadena enlazable para agregar un miembro que pertenece a un dominio de nivel inferior a un grupo en un dominio de nivel superior.</span><span class="sxs-lookup"><span data-stu-id="e8b08-104">This topic contains a code example that converts an **objectSid** to a bindable string to add a member that belongs to a down-level domain to a group in an up-level domain.</span></span>

<span data-ttu-id="e8b08-105">En el ejemplo de código de C++ siguiente se muestra cómo convertir un **objectSid** en una cadena enlazable.</span><span class="sxs-lookup"><span data-stu-id="e8b08-105">The following C++ code example shows how to convert an **objectSid** into a bindable string.</span></span>
