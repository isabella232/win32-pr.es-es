...
---
# <a name="composing-the-spns-for-a-service-with-an-scp"></a><span data-ttu-id="af62d-105">Creación de los SPN para un servicio con un SCP</span><span class="sxs-lookup"><span data-stu-id="af62d-105">Composing the SPNs for a Service with an SCP</span></span>

<span data-ttu-id="af62d-106">En el ejemplo de código siguiente se compone un SPN para un servicio que usa un punto de conexión de servicio (SCP).</span><span class="sxs-lookup"><span data-stu-id="af62d-106">The following code example composes an SPN for a service that uses a service connection point (SCP).</span></span> <span data-ttu-id="af62d-107">El SPN devuelto tiene el formato siguiente.</span><span class="sxs-lookup"><span data-stu-id="af62d-107">The returned SPN has the following format.</span></span>
...
<span data-ttu-id="af62d-108">" &lt; clase &gt; de servicio" y " &lt; nombre de servicio &gt; " se corresponden con los parámetros *pszDNofSCP* y *pszServiceClass* .</span><span class="sxs-lookup"><span data-stu-id="af62d-108">"&lt;service class&gt;" and "&lt;service name&gt;" correspond to the *pszDNofSCP* and *pszServiceClass* parameters.</span></span> <span data-ttu-id="af62d-109">" &lt; host &gt; " tiene como valor predeterminado el nombre DNS del equipo local.</span><span class="sxs-lookup"><span data-stu-id="af62d-109">"&lt;host&gt;" defaults to the DNS name of the local computer.</span></span>
