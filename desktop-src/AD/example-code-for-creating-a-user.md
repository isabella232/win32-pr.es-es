---
title: Código de ejemplo para crear un usuario
description: En este tema se incluyen ejemplos de código que crean un usuario en un dominio controlado por Active Directory Domain Services.
...
ms.locfileid: "104075130"
---
# <a name="example-code-for-creating-a-user"></a><span data-ttu-id="a899b-104">Código de ejemplo para crear un usuario</span><span class="sxs-lookup"><span data-stu-id="a899b-104">Example Code for Creating a User</span></span>

<span data-ttu-id="a899b-105">En este tema se incluyen ejemplos de código que crean un usuario en un dominio controlado por Active Directory Domain Services.</span><span class="sxs-lookup"><span data-stu-id="a899b-105">This topic includes code examples that create a user in a domain controlled by Active Directory Domain Services.</span></span>
