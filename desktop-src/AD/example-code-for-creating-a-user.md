...
ms.locfileid: "118962344"
---
# <a name="example-code-for-creating-a-user"></a>Código de ejemplo para crear un usuario

En este tema se incluyen ejemplos de código que crean un usuario en un dominio controlado por Active Directory Domain Services.
