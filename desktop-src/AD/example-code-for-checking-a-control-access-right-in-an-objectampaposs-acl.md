...
---
# <a name="example-code-for-checking-a-control-access-right-in-an-objects-acl"></a><span data-ttu-id="69e4a-104">Código de ejemplo para comprobar el derecho de acceso de un control en la ACL de un objeto</span><span class="sxs-lookup"><span data-stu-id="69e4a-104">Example Code for Checking a Control Access Right in an Object's ACL</span></span>

<span data-ttu-id="69e4a-105">El siguiente ejemplo se puede usar para comprobar que el usuario que ha iniciado la sesión actual tiene permisos para un derecho de acceso de control en el objeto especificado.</span><span class="sxs-lookup"><span data-stu-id="69e4a-105">The following example can be used to verify that the currently logged-on user has permissions for a control access right on the specified object.</span></span>
