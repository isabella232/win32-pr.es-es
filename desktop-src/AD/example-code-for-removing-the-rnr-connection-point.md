...
---
# <a name="example-code-for-removing-the-rnr-connection-point"></a><span data-ttu-id="45503-106">Código de ejemplo para quitar el punto de conexión de RnR</span><span class="sxs-lookup"><span data-stu-id="45503-106">Example Code for Removing the RnR Connection Point</span></span>

<span data-ttu-id="45503-107">El siguiente ejemplo de código se usa en el ejemplo de código del servicio Winsock para anular el registro del punto de conexión de RnR para el servicio.</span><span class="sxs-lookup"><span data-stu-id="45503-107">The following code example is used by the Winsock service code example to unregister the RnR connection point for the service.</span></span>
