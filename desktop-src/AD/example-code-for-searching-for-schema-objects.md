...
---
# <a name="example-code-for-searching-for-schema-objects"></a><span data-ttu-id="b6a20-104">Código de ejemplo para buscar objetos de esquema</span><span class="sxs-lookup"><span data-stu-id="b6a20-104">Example Code for Searching for Schema Objects</span></span>

<span data-ttu-id="b6a20-105">En este tema se incluye un ejemplo de código que se usa para buscar objetos de esquema.</span><span class="sxs-lookup"><span data-stu-id="b6a20-105">This topic includes a code example used to search for schema objects.</span></span>

<span data-ttu-id="b6a20-106">En el ejemplo de código de C++ siguiente se muestra cómo buscar objetos de esquema que tienen bits establecidos en el atributo **systemFlags** .</span><span class="sxs-lookup"><span data-stu-id="b6a20-106">The following C++ code example shows how to search for schema objects that have bits set in the **systemFlags** attribute.</span></span>
...
<span data-ttu-id="b6a20-107">En el siguiente ejemplo de código de C y C++ se muestra cómo buscar objetos de esquema replicados en el catálogo global.</span><span class="sxs-lookup"><span data-stu-id="b6a20-107">The following C and C++ code example shows how to search for schema objects replicated to the global catalog.</span></span>
...
<span data-ttu-id="b6a20-108">En el siguiente ejemplo de código de C y C++ se muestra cómo buscar objetos de esquema indexados.</span><span class="sxs-lookup"><span data-stu-id="b6a20-108">The following C and C++ code example shows how to search for indexed schema objects.</span></span>
