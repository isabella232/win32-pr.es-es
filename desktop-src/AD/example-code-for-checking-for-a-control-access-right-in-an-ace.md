...
---
# <a name="example-code-for-checking-for-a-control-access-right-in-an-ace"></a><span data-ttu-id="12937-104">Código de ejemplo para comprobar el derecho de acceso de un control en una ACE</span><span class="sxs-lookup"><span data-stu-id="12937-104">Example Code for Checking for a Control Access Right in an ACE</span></span>

<span data-ttu-id="12937-105">En el siguiente ejemplo de código de C++ se comprueba un derecho de acceso de control especificado en una ACE de la ACL del objeto especificado.</span><span class="sxs-lookup"><span data-stu-id="12937-105">The following C++ code example verifies a specified control access right in an ACE in the ACL of the specified object.</span></span>
