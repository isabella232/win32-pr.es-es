---
title: Código de ejemplo para usar el catálogo global para buscar usuarios en un bosque
description: En este tema se incluyen ejemplos de código que se usan para buscar usuarios en un bosque.
ms.assetid: bdcbfb7e-e1ea-4275-96b0-1c895e28e176
ms.tgt_platform: multiple
keywords:
- Active Directory ejemplos Active Directory, usar el catálogo global para buscar usuarios en un bosque
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103773165"
---
# <a name="example-code-for-using-the-global-catalog-to-find-users-in-a-forest"></a><span data-ttu-id="2deef-104">Código de ejemplo para usar el catálogo global para buscar usuarios en un bosque</span><span class="sxs-lookup"><span data-stu-id="2deef-104">Example Code for Using the Global Catalog to Find Users in a Forest</span></span>

<span data-ttu-id="2deef-105">En este tema se incluyen ejemplos de código que se usan para buscar usuarios en un bosque.</span><span class="sxs-lookup"><span data-stu-id="2deef-105">This topic includes code examples used to search for users in a forest.</span></span>

<span data-ttu-id="2deef-106">En el siguiente ejemplo de código de Visual Basic se muestra cómo usar ADSI para buscar usuarios en un bosque.</span><span class="sxs-lookup"><span data-stu-id="2deef-106">The following Visual Basic code example shows how to use ADSI to search for users in a forest.</span></span>
...
<span data-ttu-id="2deef-107">En el siguiente ejemplo de código de C++ se usa ADSI para buscar usuarios en un bosque.</span><span class="sxs-lookup"><span data-stu-id="2deef-107">The following C++ code example uses ADSI to search for users in a forest.</span></span>
