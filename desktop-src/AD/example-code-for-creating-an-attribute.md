---
title: Código de ejemplo para crear un atributo
description: En el ejemplo de código siguiente se crea un objeto attributeSchema en el contenedor de esquemas.
ms.assetid: 5f679a88-29d1-44ec-918b-091522188ae9
ms.tgt_platform: multiple
keywords:
- Código de ejemplo para crear un atributo AD
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104487447"
---
# <a name="example-code-for-creating-an-attribute"></a><span data-ttu-id="d9929-104">Código de ejemplo para crear un atributo</span><span class="sxs-lookup"><span data-stu-id="d9929-104">Example Code for Creating an Attribute</span></span>

<span data-ttu-id="d9929-105">En el ejemplo de código siguiente se crea un objeto [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) en el contenedor de esquemas.</span><span class="sxs-lookup"><span data-stu-id="d9929-105">The following code example creates an [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) object in the schema container.</span></span>

<span data-ttu-id="d9929-106">La función **CreateAttribute** crea un objeto [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) en el contenedor de esquemas, pero no lo confirma en el directorio.</span><span class="sxs-lookup"><span data-stu-id="d9929-106">The **CreateAttribute** function creates an [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) object in the schema container, but does not commit it to the directory.</span></span> <span data-ttu-id="d9929-107">Llame al método [**IADs. SetInfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) para confirmar el nuevo objeto **attributeSchema** en el directorio.</span><span class="sxs-lookup"><span data-stu-id="d9929-107">Call the [**IADs.SetInfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) method to commit the new **attributeSchema** object to the directory.</span></span>

<span data-ttu-id="d9929-108">La función **BytesToVariantArray** es una función de utilidad que empaqueta una cadena de octetos en una matriz Variant.</span><span class="sxs-lookup"><span data-stu-id="d9929-108">The **BytesToVariantArray** function is a utility function that packs an octet string into a variant array.</span></span>
