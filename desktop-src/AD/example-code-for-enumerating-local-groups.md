...
En este tema se incluye un ejemplo de código que enumera todos los objetos de una clase especificada.

En el siguiente ejemplo de código de C++ se enumeran todos los objetos de una clase especificada mediante ADSI.
