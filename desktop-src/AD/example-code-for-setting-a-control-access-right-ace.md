...
---
# <a name="example-code-for-setting-a-control-access-right-ace"></a><span data-ttu-id="f9d5b-104">Código de ejemplo para establecer una ACE derecha de control de acceso</span><span class="sxs-lookup"><span data-stu-id="f9d5b-104">Example Code for Setting a Control Access Right ACE</span></span>

<span data-ttu-id="f9d5b-105">El siguiente ejemplo de código de C/C++ agrega una ACE para un derecho de acceso de control a la ACL de un objeto.</span><span class="sxs-lookup"><span data-stu-id="f9d5b-105">The following C/C++ code example adds an ACE for a control access right to the ACL of an object.</span></span>
