---
title: Código de ejemplo para crear un grupo
description: En este tema se incluye un código de ejemplo de código que crea un grupo.
...
---
# <a name="example-code-for-creating-a-group"></a><span data-ttu-id="07f38-104">Código de ejemplo para crear un grupo</span><span class="sxs-lookup"><span data-stu-id="07f38-104">Example Code for Creating a Group</span></span>

<span data-ttu-id="07f38-105">El siguiente ejemplo de código de C++ contiene una función que crea un grupo con solo las propiedades esenciales establecidas explícitamente (**CN**, **sAMAccountType**, **GroupType**) y no contiene miembros.</span><span class="sxs-lookup"><span data-stu-id="07f38-105">The following C++ code example contains a function that creates a group with only the essential properties explicitly set (**cn**, **sAMAccountType**, **groupType**) and containing no members.</span></span>
...
<span data-ttu-id="07f38-106">En el siguiente ejemplo de código Visual Basic se crea un grupo que solo tiene las propiedades esenciales establecidas explícitamente (**CN**, **sAMAccountType**, **GroupType**) y no contiene miembros.</span><span class="sxs-lookup"><span data-stu-id="07f38-106">The following Visual Basic code example creates a group with only the essential properties explicitly set (**cn**, **sAMAccountType**, **groupType**) and containing no members.</span></span>
