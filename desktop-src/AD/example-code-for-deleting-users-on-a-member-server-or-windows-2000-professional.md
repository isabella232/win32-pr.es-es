...
description: Este tema contiene un ejemplo de código que muestra cómo eliminar un usuario en un servidor miembro o una estación de trabajo.
...
ms.locfileid: "104075126"
---
# <a name="example-code-for-deleting-users-on-a-member-server-or-windows-2000-professional"></a><span data-ttu-id="a0255-104">Código de ejemplo para eliminar usuarios en un servidor miembro o Windows 2000 Professional</span><span class="sxs-lookup"><span data-stu-id="a0255-104">Example Code for Deleting Users on a Member Server or Windows 2000 Professional</span></span>

<span data-ttu-id="a0255-105">En el siguiente código de Visual Basic se elimina un usuario de un servidor miembro o una estación de trabajo.</span><span class="sxs-lookup"><span data-stu-id="a0255-105">The following Visual Basic code deletes a user on a member server or workstation.</span></span>
