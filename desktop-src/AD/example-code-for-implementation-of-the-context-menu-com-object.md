...
---
# <a name="example-code-for-implementation-of-the-context-menu-com-object"></a><span data-ttu-id="1a7c1-105">Código de ejemplo para la implementación del objeto COM del menú contextual</span><span class="sxs-lookup"><span data-stu-id="1a7c1-105">Example Code for Implementation of the Context Menu COM Object</span></span>

<span data-ttu-id="1a7c1-106">El siguiente ejemplo de código se puede usar para implementar una Active Directory extensión del menú contextual.</span><span class="sxs-lookup"><span data-stu-id="1a7c1-106">The following code example can be used to implement an Active Directory context menu extension.</span></span> <span data-ttu-id="1a7c1-107">El elemento de menú contextual único mostrará un cuadro de mensaje que contiene el ADsPath de cada elemento seleccionado.</span><span class="sxs-lookup"><span data-stu-id="1a7c1-107">The single context menu item will display a message box that contains the ADsPath of each item selected.</span></span>

## <a name="ishellextinit-implementation"></a><span data-ttu-id="1a7c1-108">Implementación de IShellExtInit</span><span class="sxs-lookup"><span data-stu-id="1a7c1-108">IShellExtInit Implementation</span></span>

<span data-ttu-id="1a7c1-109">El siguiente ejemplo de código se puede usar para implementar los métodos [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) .</span><span class="sxs-lookup"><span data-stu-id="1a7c1-109">The following code example can be used to implement the [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) methods.</span></span>
...
## <a name="icontextmenu-implementation"></a><span data-ttu-id="1a7c1-110">Implementación de IContextMenu</span><span class="sxs-lookup"><span data-stu-id="1a7c1-110">IContextMenu Implementation</span></span>

<span data-ttu-id="1a7c1-111">El siguiente ejemplo de código se puede usar para implementar los métodos [**IContextMenu**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-icontextmenu) .</span><span class="sxs-lookup"><span data-stu-id="1a7c1-111">The following code example can be used to implement the [**IContextMenu**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-icontextmenu) methods.</span></span>
