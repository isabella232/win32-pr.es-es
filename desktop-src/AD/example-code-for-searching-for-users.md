...
---
# <a name="example-code-for-searching-for-users"></a><span data-ttu-id="15ac8-104">Código de ejemplo para buscar usuarios</span><span class="sxs-lookup"><span data-stu-id="15ac8-104">Example Code for Searching for Users</span></span>

<span data-ttu-id="15ac8-105">Los siguientes ejemplos de código buscan usuarios en el dominio de la cuenta de usuario con la que se está ejecutando el proceso de llamada.</span><span class="sxs-lookup"><span data-stu-id="15ac8-105">The following code examples search for users in the domain of the user account under which the calling process is running.</span></span>

-   [<span data-ttu-id="15ac8-106">Ejemplo de C++</span><span class="sxs-lookup"><span data-stu-id="15ac8-106">C++ Example</span></span>](#c-example)
-   [<span data-ttu-id="15ac8-107">Ejemplo de Visual Basic</span><span class="sxs-lookup"><span data-stu-id="15ac8-107">Visual Basic Example</span></span>](#visual-basic-example)

## <a name="c-example"></a><span data-ttu-id="15ac8-108">Ejemplo de C++</span><span class="sxs-lookup"><span data-stu-id="15ac8-108">C++ Example</span></span>

<span data-ttu-id="15ac8-109">En el siguiente ejemplo de código de C++ se busca en el dominio actual todos los usuarios o un usuario específico basado en un filtro especificado.</span><span class="sxs-lookup"><span data-stu-id="15ac8-109">The following C++ code example searches the current domain for all users, or a specific user based on a specified filter.</span></span>
...
## <a name="visual-basic-example"></a><span data-ttu-id="15ac8-110">Ejemplo de Visual Basic</span><span class="sxs-lookup"><span data-stu-id="15ac8-110">Visual Basic Example</span></span>

<span data-ttu-id="15ac8-111">En el siguiente ejemplo de código Visual Basic se busca en el dominio actual los usuarios con el apellido especificado y se devuelven los atributos name y [**distinguishedName**](/windows/desktop/ADSchema/a-distinguishedname) para los objetos encontrados.</span><span class="sxs-lookup"><span data-stu-id="15ac8-111">The following Visual Basic code example searches the current domain for users with the specified surname and returns the name and [**distinguishedName**](/windows/desktop/ADSchema/a-distinguishedname) attributes for the objects that are found.</span></span> <span data-ttu-id="15ac8-112">En el ejemplo de código siguiente se usa ADO para realizar la búsqueda.</span><span class="sxs-lookup"><span data-stu-id="15ac8-112">The following code example uses ADO to perform the search.</span></span>
