---
description: 'Cryptography API: Next Generation (CNG) define las siguientes funciones que se usan con el sistema de configuración criptográfica CNG.'
...
ms.locfileid: "127271247"
---
# <a name="cng-cryptographic-configuration-functions"></a>Funciones de configuración criptográfica de CNG

Cryptography API: Next Generation (CNG) define las siguientes funciones que se usan con el sistema de configuración criptográfica CNG.
