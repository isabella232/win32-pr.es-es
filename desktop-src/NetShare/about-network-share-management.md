...
-   [Novedades de la administración de recursos compartidos de red en Windows Server 2008 R2 y Windows 7](what-s-new-in-network-share-management-in-windows-server-2008-r2-and-windows-7.md)
-   [Funciones de NetFile](netfile-functions.md)
-   [Funciones de recurso compartido de red](network-share-functions.md)
-   [Funciones de sesión](session-functions.md)
-   [Funciones de estadísticas](statistics-functions.md)
