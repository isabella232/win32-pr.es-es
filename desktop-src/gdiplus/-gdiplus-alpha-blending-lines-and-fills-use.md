...
En Windows GDI+, un color es un valor de 32 bits con 8 bits para alfa, rojo, verde y azul. El valor alfa indica la transparencia del color, la medida en la que el color se mezcla con el color de fondo. Los valores alfa oscilan entre 0 y 255, donde 0 representa un color completamente transparente y 255 representa un color totalmente opaco.
...
Por ejemplo, supongamos que el componente rojo del color de origen es 150 y el componente rojo del color de fondo es 100. Si el valor alfa es 200, el componente rojo del color resultante se calcula de la manera siguiente:
...
-   [Dibujar con pinceles opacos y semitransparentes](-gdiplus-drawing-with-opaque-and-semitransparent-brushes-use.md)
-   [Usar el modo de composición para controlar la mezcla alfa](-gdiplus-using-compositing-mode-to-control-alpha-blending-use.md)
