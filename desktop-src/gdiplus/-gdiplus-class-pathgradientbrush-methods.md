---
description: En este tema se enumeran los métodos de la clase PathGradientBrush. Para obtener una lista completa de clases, consulte clase PathGradientBrushXX.
ms.assetid: 17dc4bef-a8ee-4ff2-ade0-ff5cdb0633df
title: Métodos PathGradientBrush
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "104997549"
---
# <a name="pathgradientbrush-methods"></a>Métodos PathGradientBrush

En este tema se enumeran los métodos de la clase [**PathGradientBrush**](/windows/desktop/api/gdipluspath/nl-gdipluspath-pathgradientbrush) . Para obtener una lista completa de clases, consulte **clase PathGradientBrushXX**.
...
-   [**SetCenterPoint (& de PointF)**](/previous-versions//ms535095(v=vs.85))
