...
---
# <a name="graphicspath-methods"></a>Métodos GraphicsPath

En este tema se enumeran los métodos de la clase [**GraphicsPath**](/windows/desktop/api/gdipluspath/nl-gdipluspath-graphicspath) . Para obtener una lista completa de clases, vea **GraphicsPath (clase**).
...
-   [**AddBezier (punto&, punto&, punto&, punto&)**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-addbezier(inconstpoint__inconstpoint__inconstpoint__inconstpoint_))
...
-   [**AddBezier (PointF&,& de PointF,& de PointF,& de PointF)**](/previous-versions//ms535623(v=vs.85))
...
-   [**AddEllipse (rectángulo&)**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-addellipse(inconstrect_))
...
-   [**AddLine (PointF&,& de PointF)**](/previous-versions//ms535602(v=vs.85))
...
-   [**AddRectangle (rectángulo&)**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-addrectangle(inconstrect_))
...
-   [**Clonar**](/windows/desktop/api/Gdipluspath/nf-gdipluspath-graphicspath-clone)
...
-   [**Acoplar**](/windows/desktop/api/Gdipluspath/nf-gdipluspath-graphicspath-flatten)
...
-   [**IsOutlineVisible (punto&, lápiz \* , gráficos \* )**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-isoutlinevisible(inconstpoint__inconstpen_inconstgraphics))
...
-   [**IsOutlineVisible (PointF&, lápiz \* , gráficos \* )**](/previous-versions//ms535580(v=vs.85))
-   [**IsVisible (REAL, REAL, gráficos \* )**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-isvisible(inreal_inreal_inconstgraphics))
-   [**IsVisible (PointF&, gráficos \* )**](/previous-versions//ms535574(v=vs.85))
...
-   [**IsVisible (Point&, gráficos \* )**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-isvisible(inconstpoint__inconstgraphics))
-   [**Esquema**](/windows/desktop/api/Gdipluspath/nf-gdipluspath-graphicspath-outline)
...
-   [**Ajustar**](/windows/desktop/api/Gdipluspath/nf-gdipluspath-graphicspath-warp)
-   [**Ancha**](/windows/desktop/api/Gdipluspath/nf-gdipluspath-graphicspath-widen)
