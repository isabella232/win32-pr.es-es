---
description: En este tema se enumeran los métodos de la clase Region. Para obtener una lista de clases completa, vea Clase región.
...
ms.locfileid: "118249115"
---
# <a name="region-methods"></a>Métodos de región

En este tema se enumeran los métodos de la [**clase Region.**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-region) Para obtener una lista de clases completa, vea **Region Class**.

-   [**Clonar**](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-region-clone)
...
-   [**Igual a**](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-region-equals)
