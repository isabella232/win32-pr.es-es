...
En la ilustración siguiente se muestra una posible salida del código anterior. Si ejecuta el código, la salida podría ser diferente, dependiendo de las fuentes instaladas en el equipo.
