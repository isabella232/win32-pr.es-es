---
description: En este tema se enumeran los métodos de la clase Rect. Para obtener una lista de clases completa, vea Clase Rect.
...
ms.locfileid: "119831175"
---
# <a name="rect-methods"></a>Métodos rect

En este tema se enumeran los métodos de [**la clase Rect.**](/windows/desktop/api/gdiplustypes/nl-gdiplustypes-rect) Para obtener una lista de clases completa, **vea Clase Rect**.

-   [**Clon**](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rect-clone)
...
-   [**Es igual que**](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rect-equals)
...
-   [**Inflado(punto&)**](/windows/win32/api/gdiplustypes/nf-gdiplustypes-rect-inflate(inconstpoint_))
...
-   [**Unión**](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rect-union)
