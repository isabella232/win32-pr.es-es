...
---
# <a name="msmq-group-class"></a>MSMQ-Group (clase)

Se utiliza para definir un grupo de colas MSMQ (también conocido como lista de distribución).
...
|-------------------|---------------------------------------------------------|
| CN                | MSMQ-Group                                              |
| Nombre para mostrar de LDAP | msMQ: Grupo                                              |
| Actualizar privilegio  | Propietario de la cola.                                        |
| Frecuencia de actualización  | Cada vez que se agrega o se quita un miembro de un grupo. |
| Identificador de esquema-GUID    | 46b27aac-aafa-4ffb-b773-e5bf621ee87b                    |
...
| [**Miembro**](a-member.md)                                                  | True      | **MSMQ: Grupo**                  |
