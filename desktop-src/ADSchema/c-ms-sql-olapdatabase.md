...
---
# <a name="ms-sql-olapdatabase-class"></a>Clase MS-SQL-OLAPDatabase

Contenedor para almacenar objetos [**MS-SQL-OLAPCube**](c-ms-sql-olapcube.md) .
...
| Nombre para mostrar de LDAP | mS-SQL-OLAPDatabase                  |
| Actualizar privilegio  | El sistema establece este valor.     |
| Frecuencia de actualización  | En el programa de instalación del sistema.                     |
| Identificador de esquema-GUID    | 20af031a-ccef-11d2-9993-0000f87a57d4 |
...
| Posibles superiores          | [**MS-SQL-OLAPServer**](c-ms-sql-olapserver.md)                                             |
| Clases auxiliares           | \-                                                                                           |
...
| [**MS-SQL-aplicaciones**](a-ms-sql-applications.md)                      | False     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-ConnectionURL**](a-ms-sql-connectionurl.md)                    | False     | **MS-SQL-OLAPDatabase**         |
| [**Contacto de MS-SQL**](a-ms-sql-contact.md)                                | False     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-Descripción**](a-ms-sql-description.md)                        | False     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | False     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-palabras clave**](a-ms-sql-keywords.md)                              | False     | **MS-SQL-OLAPDatabase**         |
...
| [**Nombre MS-SQL**](a-ms-sql-name.md)                                      | False     | **MS-SQL-OLAPDatabase**         |
...
| [**Estado de MS-SQL**](a-ms-sql-status.md)                                  | False     | **MS-SQL-OLAPDatabase**         |
| [**Tipo MS-SQL**](a-ms-sql-type.md)                                      | False     | **MS-SQL-OLAPDatabase**         |
