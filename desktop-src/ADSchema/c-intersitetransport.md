...
---
# <a name="inter-site-transport-class"></a>Clase de transporte entre sitios

Atributo opcional de objetos ntdsConnection. Si está presente, contiene el DN de un objeto interSiteTransport en la CN = transportes entre sitios, CN = Sites, CN = Configuration,... contenedor.



| Entrada | Value |
|-------------------|------------------------------------------------------------------------------------------------------------------------------------|
| CN                | Transporte entre sitios                                                                                                               |
| Nombre para mostrar de LDAP | interSiteTransport                                                                                                                 |
| Actualizar privilegio  | El KCC o el administrador de empresa establecen este valor.                                                                          |
| Frecuencia de actualización  | Creado/administrado por el comprobador de coherencia de la información en respuesta a los cambios en la topología de red (incluidas las interrupciones temporales). |
| Identificador de esquema-GUID    | 26d97376-6070-11d1-a9c6-0000f80367c1                                                                                               |
...
| Posibles superiores          | [**Inter-site-Transport-Container**](c-intersitetransportcontainer.md)                      |
| Clases auxiliares           | \-                                                                                           |
...
| [**Opciones**](a-options.md)                                              | False     | **Transporte entre sitios**        |
...
| [**REPL-intervalo**](a-replinterval.md)                                   | False     | **Transporte entre sitios**        |
...
| [**Transport-Address-Attribute**](a-transportaddressattribute.md)        | True      | **Transporte entre sitios**        |
| [**Transport-DLL-Name**](a-transportdllname.md)                          | True      | **Transporte entre sitios**        |
