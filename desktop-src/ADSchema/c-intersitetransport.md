---
title: Inter-Site-Transport (clase)
...
keywords:
- Esquema de AD de la clase de transporte entre sitios
...
ms.locfileid: "119703685"
---
# <a name="inter-site-transport-class"></a>Inter-Site-Transport (clase)

Atributo opcional de objetos ntdsConnection. Si está presente, contiene el DN de un objeto interSiteTransport en CN=Inter-Site Transports,CN=Sites,CN=Configuration,... Contenedor.
...
| Actualizar privilegios  | Este valor lo establece el administrador de KCC o de la empresa.                                                                          |
| Frecuencia de actualización  | Creado o administrado por knowledge consistency Checker en respuesta a los cambios en la topología de red (incluidas las interrupciones temporales). |
...
| [**Opciones**](a-options.md)                                              | Falso     | **Transporte entre sitios**        |
...
| [**Intervalo de repl**](a-replinterval.md)                                   | Falso     | **Transporte entre sitios**        |
...
| [**Transport-Address-Attribute**](a-transportaddressattribute.md)        | Verdadero      | **Transporte entre sitios**        |
| [**Transport-DLL-Name**](a-transportdllname.md)                          | Verdadero      | **Transporte entre sitios**        |
