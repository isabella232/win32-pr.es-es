...
---
# <a name="ms-wmi-rangeparam-class"></a>clase MS-WMI-RangeParam

Clase de parámetro de intervalo que es la base de PolicyTemplate. Describe una propiedad combinable del destino. Cada subclase implementa un tipo específico. Implementa el método Merge para admitir la combinación. Implementa un método Resolve para generar la propiedad de destino final.
...
| Nombre para mostrar de LDAP | msWMI-RangeParam                     |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 45fb5a57-5018-4d0f-9056-997c8c9122d9 |
