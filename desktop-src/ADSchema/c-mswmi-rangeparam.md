---
title: ms-WMI-RangeParam (clase)
description: Clase de parámetro Range que es la base de PolicyTemplate.
ms.assetid: 7940acc7-84af-47a2-8353-3ebb39eb9314
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-WMI-RangeParam
- Esquema de AD de la clase msWMI-RangeParam
topic_type:
- apiref
api_name:
- ms-WMI-RangeParam
...
ms.locfileid: "118175084"
---
# <a name="ms-wmi-rangeparam-class"></a>ms-WMI-RangeParam (clase)

Clase de parámetro Range que es la base de PolicyTemplate. Describe una propiedad combinable del destino. Cada subclase implementa un tipo específico. Implementa el método merge para admitir la combinación. Implementa un método resolve para generar la propiedad de destino final.
...
| [**ms-WMI-PropertyName**](a-mswmi-propertyname.md)                         | Verdadero      | **ms-WMI-RangeParam**           |
| [**ms-WMI-TargetClass**](a-mswmi-targetclass.md)                           | True      | **ms-WMI-RangeParam**           |
| [**ms-WMI-TargetType**](a-mswmi-targettype.md)                             | True      | **ms-WMI-RangeParam**           |
| [**netboot-SCP-BL**](a-netbootscpbl.md)                                    | Falso     | [**Arriba**](c-top.md)<br/> |
| [**Miembro no de seguridad-BL**](a-nonsecuritymemberbl.md)                     | Falso     | [**Arriba**](c-top.md)<br/> |
