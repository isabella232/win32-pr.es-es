---
title: ms-DS-Optional-Feature (clase)
description: Configuración de una característica DS opcional.
ms.assetid: 236ff60d-84a2-4c71-9759-1863e24b2a98
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-DS-Optional-Feature
...
ms.locfileid: "119879985"
---
# <a name="ms-ds-optional-feature-class"></a>ms-DS-Optional-Feature (clase)

Configuración de una característica DS opcional.
...
| Descriptor de seguridad predeterminado | D:(A;; RPLCLORC;;; AU)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; EA)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; CO)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; SY) |
...
| [**ms-DS-Optional-Feature-Flags**](a-msds-optionalfeatureflags.md)                    | Verdadero      | **ms-DS-Optional-Feature**      |
| [**ms-DS-Optional-Feature-GUID**](a-msds-optionalfeatureguid.md)                      | Verdadero      | **ms-DS-Optional-Feature**      |
