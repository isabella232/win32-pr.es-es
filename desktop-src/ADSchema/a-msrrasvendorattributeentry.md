...
Cadena que permite a los proveedores agregar atributos de enrutador al DS para su uso en las consultas, con el formato AttributeName: vendorID: AttributeType.
...
| Nombre para mostrar de LDAP | msRRASVendorAttributeEntry                  |
| Tamaño              | \-                                          |
...
| Clases usadas en        | [**RRAS-Administration-Diccionario**](c-rrasadministrationdictionary.md)<br/> |
