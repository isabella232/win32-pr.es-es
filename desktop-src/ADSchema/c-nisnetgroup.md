...
---
# <a name="nisnetgroup-class"></a>clase nisNetgroup

Contiene una abstracción de un netgroup que puede hacer referencia a otros netgroups.
...
|-------------------|--------------------------------------|
| CN                | nisNetgroup                          |
| Nombre para mostrar de LDAP | nisNetgroup                          |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 72efbf84-6e7b-4a5c-a8db-8a75a7cad254 |
...
| [**Nombre común**](a-cn.md)                                                 | True      | **nisNetgroup** [ **superior**](c-top.md)<br/> |
| [**Creación: marca de tiempo**](a-createtimestamp.md)                              | False     | [**Arriba**](c-top.md)<br/>                 |
| [**Descripción**](a-description.md)                                        | False     | **nisNetgroup** [ **superior**](c-top.md)<br/> |
...
| [**msSFU-30-nombre**](a-mssfu30name.md)                                      | False     | **nisNetgroup**                                 |
| [**msSFU-30-netgroup-host-at-Domain**](a-mssfu30netgrouphostatdomain.md)   | False     | **nisNetgroup**                                 |
| [**msSFU-30-netgroup-usuario en dominio**](a-mssfu30netgroupuseratdomain.md)   | False     | **nisNetgroup**                                 |
| [**msSFU-30-NIS-dominio**](a-mssfu30nisdomain.md)                           | False     | **nisNetgroup**                                 |
