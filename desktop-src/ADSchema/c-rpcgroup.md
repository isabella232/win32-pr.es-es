...
---
# <a name="rpc-group-class"></a>RPC: clase de grupo

Representa un grupo de RPC.
...
|-------------------|--------------------------------------|
| CN                | Grupo RPC                            |
| Nombre para mostrar de LDAP | rpcGroup                             |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 88611bdf-8cf4-11d0-afda-00c04fd930c9 |
...
| [**RPC-NS-Group**](a-rpcnsgroup.md)                                      | False     | **Grupo RPC**                                                                            |
| [**ID. de objeto de RPC-NS**](a-rpcnsobjectid.md)                               | False     | **Grupo RPC**                                                                            |
