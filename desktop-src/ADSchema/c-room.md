...
---
# <a name="room-class"></a>Room (clase)

La clase de objeto Room se usa para definir entradas que representan salones.
...
|-------------------|--------------------------------------|
| CN                | room                                 |
| Nombre para mostrar de LDAP | room                                 |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 7860e5d2-c8b0-4cbb-bd45-d9455beb9206 |
...
| [**Nombre común**](a-cn.md)                                                 | True      | **espacio** [ **superior**](c-top.md)<br/> |
| [**Creación: marca de tiempo**](a-createtimestamp.md)                              | False     | [**Arriba**](c-top.md)<br/>          |
| [**Descripción**](a-description.md)                                        | False     | **espacio** [ **superior**](c-top.md)<br/> |
...
| [**Location**](a-location.md)                                              | False     | **misma**                                 |
...
| [**roomNumber**](a-roomnumber.md)                                          | False     | **misma**                                 |
| [**SD-derechos-efectivos**](a-sdrightseffective.md)                          | False     | [**Arriba**](c-top.md)<br/>          |
| [**Vea también**](a-seealso.md)                                               | False     | **misma**                                 |
...
| [**Número de teléfono**](a-telephonenumber.md)                               | False     | **misma**                                 |
