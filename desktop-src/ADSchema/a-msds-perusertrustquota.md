...
description: Se usa para aplicar una cuota por usuario para crear objetos Trusted-Domain autorizados por el nuevo derecho de acceso de control, Create-Inbound-Forest-Trust.
ms.assetid: 3b198b24-5282-4d13-8d35-88f34c11ce94
ms.tgt_platform: multiple
keywords:
- Esquema de AD del atributo MS-DS-Per-User-Trust-Quota
- Esquema de AD del atributo msDS-PerUserTrustQuota
topic_type:
- apiref
api_name:
...
ms.locfileid: "118425831"
---
# <a name="ms-ds-per-user-trust-quota-attribute"></a>Atributo MS-DS-Per-User-Trust-Quota

Se usa para aplicar una cuota por usuario para crear objetos Trusted-Domain autorizados por el nuevo derecho de acceso de control, Create-Inbound-Forest-Trust. Este atributo limita el número de objetos Trusted-Domain que puede crear un único usuario que no es administrador.
