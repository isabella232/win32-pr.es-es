...
---
# <a name="account-class"></a>clase de cuenta

La clase de objeto Account se utiliza para definir entradas que representan cuentas de equipo.
...
|-------------------|--------------------------------------|
| CN                | account                              |
| Nombre para mostrar de LDAP | account                              |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 2628a46a-a6ad-4ae0-b854-2b12d9fe6f9e |
...
| [**Descripción**](a-description.md)                                        | False     |  [ **parte superior** de la cuenta](c-top.md)<br/> |
...
| [**organizar**](a-host.md)                                                      | False     | **account**                                 |
...
| [**Localidad: nombre**](a-l.md)                                                | False     | **account**                                 |
...
| [**Nombre de unidad organizativa**](a-ou.md)                                    | False     | **account**                                 |
| [**Nombre de la organización**](a-o.md)                                            | False     | **account**                                 |
...
| [**Vea también**](a-seealso.md)                                               | False     | **account**                                 |
