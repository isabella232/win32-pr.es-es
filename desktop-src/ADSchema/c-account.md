---
title: account (clase)
description: La clase de objeto account se usa para definir entradas que representan cuentas de equipo.
ms.assetid: 94199a02-47ea-4b44-b116-e6bed0aa1e1e
ms.tgt_platform: multiple
keywords:
- account class AD Schema (Esquema de AD de clase de cuenta)
topic_type:
- apiref
api_name:
- account
...
ms.locfileid: "119644223"
---
# <a name="account-class"></a>account (clase)

La clase de objeto account se usa para definir entradas que representan cuentas de equipo.
...
| [**Descripción**](a-description.md)                                        | Falso     | **account** [ **Top**](c-top.md)<br/> |
...
| [**Nombre de unidad organizativa**](a-ou.md)                                    | Falso     | **account**                                 |
| [**Nombre de la organización**](a-o.md)                                            | Falso     | **account**                                 |
...
| [**Consulte también**](a-seealso.md)                                               | Falso     | **account**                                 |
