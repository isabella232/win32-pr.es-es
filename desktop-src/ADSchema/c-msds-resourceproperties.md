...
---
# <a name="ms-ds-resource-properties-class"></a>clase MS-DS-Resource-Properties
...
| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Propiedades de MS-DS-Resource            |
| Nombre para mostrar de LDAP | msDS-ResourceProperties              |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 7a4a4584-b350-478f-acd6-b4b852d82cc0 |
