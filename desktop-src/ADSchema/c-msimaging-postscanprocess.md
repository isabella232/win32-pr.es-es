---
title: ms-Imaging-PostScanProcess (clase)
description: Enterprise Objeto Scan Post Scan Process .
ms.assetid: cc205301-5e8a-4752-8180-5b860e65f67f
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-Imaging-PostScanProcess
- Esquema de AD de la clase msImaging-PostScanProcess
topic_type:
- apiref
api_name:
...
ms.locfileid: "118175749"
---
# <a name="ms-imaging-postscanprocess-class"></a>ms-Imaging-PostScanProcess (clase)

Enterprise Objeto Scan Post Scan Process .
...
| Posibles superiores          | [**ms-Imaging-PSP**](c-msimaging-psps.md)                                                      |
| Clases auxiliares           | \-                                                                                               |
...
| [**Nombre para mostrar**](a-displayname.md)                                            | True      | **ms-Imaging-PostScanProcess** [ **Top**](c-top.md)<br/> |
...
| [**ms-Imaging-PSP-Identifier**](a-msimaging-pspidentifier.md)                   | Verdadero      | **ms-Imaging-PostScanProcess**                                 |
| [**ms-Imaging-PSP-String**](a-msimaging-pspstring.md)                           | Falso     | **ms-Imaging-PostScanProcess**                                 |
...
| [**Nombre del servidor**](a-servername.md)                                              | Falso     | **ms-Imaging-PostScanProcess**                                 |
