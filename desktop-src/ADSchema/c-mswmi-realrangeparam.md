---
title: ms-WMI-RealRangeParam (clase)
description: Objeto de parámetro de intervalo de números reales.
ms.assetid: 8cb85f16-fb13-4014-8ee9-4d513088554a
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-WMI-RealRangeParam
- Esquema de AD de la clase msWMI-RealRangeParam
topic_type:
- apiref
api_name:
...
ms.locfileid: "118422206"
---
# <a name="ms-wmi-realrangeparam-class"></a>ms-WMI-RealRangeParam (clase)

Objeto de parámetro de intervalo de números reales.
...
| [**ms-WMI-int8Default**](a-mswmi-int8default.md)                           | Verdadero      | **ms-WMI-RealRangeParam**                                  |
