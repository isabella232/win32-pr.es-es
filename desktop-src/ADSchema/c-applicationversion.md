...
description: Los desarrolladores de aplicaciones pueden usar para almacenar información de versión sobre su aplicación o su esquema.
ms.assetid: 8f094e03-7ea8-4721-b95e-a9d0681fba08
ms.tgt_platform: multiple
keywords:
- Application-Version esquema de AD de clase
...
ms.locfileid: "119021903"
---
# <a name="application-version-class"></a>Application-Version clase

Los desarrolladores de aplicaciones pueden usar para almacenar información de versión sobre su aplicación o su esquema.
...
| Posibles superiores          | [**Unidad**](c-container.md)[**organizativa del equipo**](c-computer.md)[**contenedor**](c-organizationalunit.md) |
| Clases auxiliares           | \-                                                                                                                |
...
| [**App-Schema-Version**](a-appschemaversion.md)                            | Falso     | **Versión de la aplicación**                                          |
...
| [**Palabras clave**](a-keywords.md)                                              | Falso     | **Versión de la aplicación**                                          |
| [**Último elemento primario conocido**](a-lastknownparent.md)                              | Falso     | [**Arriba**](c-top.md)<br/>                                  |
| [**Administrado por**](a-managedby.md)                                           | Falso     | **Versión de la aplicación**                                          |
...
| [**Propietario**](a-owner.md)                                                    | Falso     | **Versión de la aplicación**                                          |
...
| [**Vendor**](a-vendor.md)                                                  | Falso     | **Versión de la aplicación**                                          |
| [**Número de versión**](a-versionnumber.md)                                   | Falso     | **Versión de la aplicación**                                          |
| [**Version-Number-Hi**](a-versionnumberhi.md)                              | Falso     | **Versión de la aplicación**                                          |
| [**Version-Number-Lo**](a-versionnumberlo.md)                              | Falso     | **Versión de la aplicación**                                          |
...
| [**Número de versión**](a-versionnumber.md)                                   | Falso     | **Versión de la aplicación**                                          |
| [**Version-Number-Hi**](a-versionnumberhi.md)                              | Falso     | **Versión de la aplicación**                                          |
| [**Número de versión:Lo**](a-versionnumberlo.md)                              | Falso     | **Versión de la aplicación**                                          |
| [**Wbem-Path**](a-wbempath.md)                                             | Falso     | [**Arriba**](c-top.md)<br/>                                  |
