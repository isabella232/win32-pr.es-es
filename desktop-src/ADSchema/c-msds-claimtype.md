...
---
# <a name="ms-ds-claim-type-class"></a>clase MS-DS-Claim-Type

Una instancia de esta clase contiene la definición de un tipo de demanda que se puede definir en las entidades de seguridad.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Tipo de notificaciones de MS-DS-Claim                     |
| Nombre para mostrar de LDAP | msDS-ClaimType                       |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 81a3857c-5469-4d8f-aae6-c27699762604 |
...
| Posibles superiores          | [**Tipos de notificaciones de MS-DS**](c-msds-claimtypes.md)                                               |
| Clases auxiliares           | \-                                                                                           |
...
| [**Microsoft-DS-Claim-Attribute-Source**](a-msds-claimattributesource.md)                          | False     | **Tipo de notificaciones de MS-DS-Claim**                                                              |
| [**MS-DS-Claim-is-Single-valued**](a-msds-claimissinglevalued.md)                           | False     | **Tipo de notificaciones de MS-DS-Claim**                                                              |
| [**MS-DS-Claim-is-Value-Limit (restringido)**](a-msds-claimisvaluespacerestricted.md)          | False     | **Tipo de notificaciones de MS-DS-Claim**                                                              |
...
| [**Origen de notificaciones de MS-DS-Claim**](a-msds-claimsource.md)                                             | False     | **Tipo de notificaciones de MS-DS-Claim**                                                              |
| [**MS-DS-Claim-Source-Type**](a-msds-claimsourcetype.md)                                    | False     | **Tipo de notificaciones de MS-DS-Claim**                                                              |
| [**MS-DS-Claim-Type-se aplica a la clase**](a-msds-claimtypeappliestoclass.md)                  | False     | **Tipo de notificaciones de MS-DS-Claim**                                                              |
| [**MS-DS-Claim-Value-Type**](a-msds-claimvaluetype.md)                                      | False     | **Tipo de notificaciones de MS-DS-Claim**                                                              |
