...
description: Una instancia de esta clase contiene la definición de un tipo de notificación que se puede definir en las entidades de seguridad.
ms.assetid: 7edfd085-ab6e-47f3-8e36-793946f06049
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-DS-Claim-Type
...
ms.locfileid: "119922455"
---
# <a name="ms-ds-claim-type-class"></a>clase ms-DS-Claim-Type

Una instancia de esta clase contiene la definición de un tipo de notificación que se puede definir en las entidades de seguridad.
...
| Posibles superiores          | [**ms-DS-Claim-Types**](c-msds-claimtypes.md)                                               |
| Clases auxiliares           | \-                                                                                           |
