...
---
# <a name="sync-attributes-attribute"></a>Sync-Attributes atributo)

Atributos que contienen información sobre los objetos de sincronización.
...
|-------------------|--------------------------------------|
| CN                | Sync-Attributes                      |
| Nombre para mostrar de LDAP | syncAttributes                       |
| Tamaño              | \-                                   |
