...
---
# <a name="dhcp-ranges-attribute"></a>atributo DHCP-Ranges

El atributo **DHCP-Ranges** no se usa actualmente.
...
|-------------------|--------------------------------------|
| CN                | Intervalos DHCP                          |
| Nombre para mostrar de LDAP | dhcpRanges                           |
| Tamaño              | \-                                   |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.707               |
| System-ID-GUID    | 963d2748-48be-11d1-a9c3-0000f80367c1 |
