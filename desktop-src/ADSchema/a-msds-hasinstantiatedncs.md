...
| Frecuencia de actualización  | Aproximadamente el doble de frecuencia que hasMasterNCs/hasPartialReplicaNCs. Estos atributos existentes solo se actualizan cuando el controlador de dominio agrega o quita una partición (por ejemplo, al cambiar de CONTROLADOR de dominio a GC o viceversa). |
