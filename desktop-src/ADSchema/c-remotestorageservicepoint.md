---
title: Remote-Storage-Service-Point (clase)
description: Esta clase contiene información sobre la ubicación de almacenamiento remoto de los archivos almacenados sin conexión.
ms.assetid: e50959ad-720d-4ac7-a0cc-ceff5d80b774
ms.tgt_platform: multiple
keywords:
- Remote-Storage-Service-Point class AD Schema (Esquema de AD de clase Remote-Storage-Service-Point)
- remoteStorageServicePoint (clase AD Schema)
topic_type:
- apiref
api_name:
...
ms.locfileid: "118959694"
---
# <a name="remote-storage-service-point-class"></a>Remote-Storage-Service-Point (clase)

Esta clase contiene información sobre la ubicación de almacenamiento remoto de los archivos almacenados sin conexión.
