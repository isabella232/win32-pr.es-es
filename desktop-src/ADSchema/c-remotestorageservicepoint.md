...
---
# <a name="remote-storage-service-point-class"></a>Remote-Storage: clase de punto de servicio

Esta clase contiene información sobre la ubicación de almacenamiento remoto para los archivos que se almacenan sin conexión.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Remoto-almacenamiento-punto de servicio         |
| Nombre para mostrar de LDAP | remoteStorageServicePoint            |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 2a39c5bd-8960-11d1-aebc-0000f80367c1 |
...
| [**Almacenamiento remoto-GUID**](a-remotestorageguid.md)                        | False     | **Remoto-almacenamiento-punto de servicio**                                                         |
