...
---
# <a name="dhcp-properties-attribute"></a>DHCP-propiedades (atributo)

El atributo **DHCP-Properties** no se usa actualmente.



| Entrada | Value |
|-------------------|-------------------------------------------------------|
| CN                | Propiedades de DHCP                                       |
| Nombre para mostrar de LDAP | dhcpProperties                                        |
| Tamaño              | \-                                                    |
