...
---
# <a name="file-link-tracking-class"></a>Clase de seguimiento de vínculos de archivos

Contenedor de objetos de entrada de seguimiento de archivos.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Seguimiento de vínculos de archivos                   |
| Nombre para mostrar de LDAP | fileLinkTracking                     |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | dd712229-10e4-11d0-a05f-00aa006c33ed |
