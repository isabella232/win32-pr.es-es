---
title: Clase File-Link-Tracking
description: Contenedor para objetos File-Link-Tracking-Entry.
ms.assetid: 15ed6bd8-bbd7-4d64-a02b-599bddf4492b
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase File-Link-Tracking
- fileLinkTracking (clase) Esquema de AD
topic_type:
- apiref
api_name:
- File-Link-Tracking
...
ms.locfileid: "119922745"
---
# <a name="file-link-tracking-class"></a>Clase File-Link-Tracking

Contenedor para objetos File-Link-Tracking-Entry.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Seguimiento de vínculos de archivo                   |
