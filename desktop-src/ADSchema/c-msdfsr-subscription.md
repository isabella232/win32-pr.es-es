---
title: ms-DFSR-Subscription (clase)
...
- Esquema de AD de la clase msDFSR-Subscription
topic_type:
- apiref
api_name:
...
ms.locfileid: "119880635"
---
# <a name="ms-dfsr-subscription-class"></a>ms-DFSR-Subscription (clase)
...
| Posibles superiores          | [**ms-DFSR-Subscriber**](c-msdfsr-subscriber.md)                                                                                |
| Clases auxiliares           | \-                                                                                                                               |
...
| [**ms-DFSR-ContentSetGuid**](a-msdfsr-contentsetguid.md)                   | Verdadero      | **ms-DFSR-Subscription**        |
...
| [**ms-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)       | Verdadero      | **ms-DFSR-Subscription**        |
...
La **clase ms-DFSR-Subscription** forma parte de la compatibilidad del servicio de replicación Sistema de archivos distribuido (DFS).
