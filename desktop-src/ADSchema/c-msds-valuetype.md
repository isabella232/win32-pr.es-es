...
---
# <a name="ms-ds-value-type-class"></a>clase MS-DS-Value-Type

Un objeto de tipo de valor contiene información de tipo de valor para una propiedad de recurso.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Tipo de valor MS-DS-Value                     |
| Nombre para mostrar de LDAP | msDS-ValueType                       |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | e3c27fdf-b01d-4f4e-87e7-056eef0eb922 |
...
| [**MS-DS-Claim-is-Single-valued**](a-msds-claimissinglevalued.md)                           | True      | **Tipo de valor MS-DS-Value**            |
| [**MS-DS-Claim-is-Value-Limit (restringido)**](a-msds-claimisvaluespacerestricted.md)          | True      | **Tipo de valor MS-DS-Value**            |
| [**MS-DS-Claim-shares-posibles-Values-with-BL**](a-msds-claimsharespossiblevalueswithbl.md) | False     | [**Arriba**](c-top.md)<br/> |
| [**MS-DS-Claim-Value-Type**](a-msds-claimvaluetype.md)                                      | True      | **Tipo de valor MS-DS-Value**            |
...
| [**MS-DS-IS-possible-Values-present**](a-msds-ispossiblevaluespresent.md)                   | True      | **Tipo de valor MS-DS-Value**            |
