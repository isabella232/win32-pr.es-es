...
---
# <a name="ipsec-base-class"></a>Ipsec-Base (clase)

Clase base de IPSEC de la que se derivan todas las clases IPSEC.
...
|-------------------|--------------------------------------|
| CN                | Ipsec-Base                           |
| Nombre para mostrar de LDAP | ipsecBase                            |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | b40ff825-427a-11d1-a9c2-0000f80367c1 |
...
| [**IPSec-datos**](a-ipsecdata.md)                                         | False     | **IPSec: base**                  |
| [**IPSec-tipo de datos**](a-ipsecdatatype.md)                                | False     | **IPSec: base**                  |
| [**IDENTIFICADOR de IPSec**](a-ipsecid.md)                                             | False     | **IPSec: base**                  |
| [**Nombre de IPSec**](a-ipsecname.md)                                         | False     | **IPSec: base**                  |
| [**Referencia de IPSec-owners**](a-ipsecownersreference.md)                  | False     | **IPSec: base**                  |
