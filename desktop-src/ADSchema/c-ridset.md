...
Hay uno de estos por cada controlador de dominio. Contiene los grupos de RID asignados por el controlador de dominio.
...
|-------------------|--------------------------------------|
| CN                | RID-Set                              |
| Nombre para mostrar de LDAP | rIDSet                               |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 7bfdcb89-4807-11d1-a9c3-0000f80367c1 |
...
| Posibles superiores          | [**Usuario**](c-user.md) de [**contenedor**](c-container.md)de [**equipos**](c-computer.md)         |
| Clases auxiliares           | \-                                                                                           |
...
| [**RID-asignación: Grupo**](a-ridallocationpool.md)                        | True      | **RID: conjunto**                     |
| [**RID-siguiente-RID**](a-ridnextrid.md)                                      | True      | **RID: conjunto**                     |
| [**RID-anterior: Grupo de asignación**](a-ridpreviousallocationpool.md)       | True      | **RID: conjunto**                     |
| [**RID: grupo usado**](a-ridusedpool.md)                                    | True      | **RID: conjunto**                     |
