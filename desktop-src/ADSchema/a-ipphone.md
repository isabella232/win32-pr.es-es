...
---
# <a name="phone-ip-primary-attribute"></a>Teléfono-IP-atributo principal

La dirección TCP/IP del teléfono. Utilizado por telefonía.



| Entrada | Value |
|-------------------|----------------------------------------------------------------------------------|
| CN                | Teléfono-IP-principal                                                                 |
| Nombre para mostrar de LDAP | ipPhone                                                                          |
| Tamaño              | \-                                                                               |
