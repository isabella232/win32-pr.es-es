...
---
# <a name="ms-wmi-wmigpo-class"></a>clase MS-WMI-WMIGPO

Este valor se escribe en el Active Directory en la ruta de acceso a la que apunta el objeto directiva de grupo correspondiente. Está diseñado para unir los distintos objetos que se usan para expresar las extensiones WMI en la infraestructura de directiva de grupo.
...
|-------------------|--------------------------------------|
| CN                | MS-WMI-WMIGPO                        |
| Nombre para mostrar de LDAP | msWMI-WMIGPO                         |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 05630000-3927-4ede-bf27-ca91f275c26f |
...
| [**MS-WMI-intFlags1**](a-mswmi-intflags1.md)                               | False     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-intFlags2**](a-mswmi-intflags2.md)                               | False     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-intFlags3**](a-mswmi-intflags3.md)                               | False     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-intFlags4**](a-mswmi-intflags4.md)                               | False     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-Parm1**](a-mswmi-parm1.md)                                       | False     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-Parm2**](a-mswmi-parm2.md)                                       | False     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-Parm3**](a-mswmi-parm3.md)                                       | False     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-Parm4**](a-mswmi-parm4.md)                                       | False     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-TargetClass**](a-mswmi-targetclass.md)                           | True      | **MS-WMI-WMIGPO**               |
