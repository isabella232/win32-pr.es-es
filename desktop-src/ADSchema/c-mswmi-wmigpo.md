---
title: ms-WMI-WMIGPO (clase)
description: Este valor se escribe en el Active Directory en la ruta de acceso a la que apunta el objeto directiva de grupo objeto. Está diseñado para unir los distintos objetos que se usan para expresar las extensiones WMI a la infraestructura directiva de grupo datos.
...
ms.locfileid: "119753635"
---
# <a name="ms-wmi-wmigpo-class"></a>ms-WMI-WMIGPO (clase)

Este valor se escribe en el Active Directory en la ruta de acceso a la que apunta el objeto directiva de grupo objeto. Está diseñado para unir los distintos objetos que se usan para expresar las extensiones WMI a la infraestructura directiva de grupo datos.
...
| [**ms-WMI-TargetClass**](a-mswmi-targetclass.md)                           | Verdadero      | **ms-WMI-WMIGPO**               |
