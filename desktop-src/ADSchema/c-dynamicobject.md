...
---
# <a name="dynamic-object-class"></a>Dynamic-Object (clase)

Esta clase, si está presente en una entrada, indica que esta entrada tiene una duración limitada y puede desaparecer automáticamente cuando su período de vida ha alcanzado 0. Si el cliente no ha proporcionado un valor para el atributo entryTtl, el servidor proporcionará uno.
...
|-------------------|--------------------------------------|
| CN                | Dynamic-Object                       |
| Nombre para mostrar de LDAP | dynamicObject                        |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 66d51249-3355-4c1f-b24e-81f252aca23b |
...
| [**Entrada: TTL**](a-entryttl.md)                                             | False     | **Objeto dinámico**              |
...
| [**MS-DS-entry-Time-to-Die**](a-msds-entry-time-to-die.md)                 | False     | **Objeto dinámico**              |
