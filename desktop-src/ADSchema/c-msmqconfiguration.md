...
---
# <a name="msmq-configuration-class"></a>MSMQ-Configuration (clase)

Este objeto contiene los parámetros de configuración de MSMQ para un equipo específico. Los atributos de esta clase son específicos de MSMQ y se usan para las decisiones de enrutamiento de MSMQ.
...
| Nombre para mostrar de LDAP | mSMQConfiguration                                                                                     |
| Actualizar privilegio  | Propietario de la cola.                                                                                      |
| Frecuencia de actualización  | Se crea una instancia de esta clase por cada equipo que instala MSMQ, bajo el objeto de equipo. |
| Identificador de esquema-GUID    | 9a0dc344-c100-11d1-bbc5-0080c76670c0                                                                  |
...
| Posibles superiores          | [**Computer**](c-computer.md)                                                               |
| Clases auxiliares           | \-                                                                                           |
...
| [**MSMQ-equipo-tipo**](a-msmqcomputertype.md)                          | False     | **MSMQ-configuración**          |
| [**MSMQ-equipo-tipo-ex**](a-msmqcomputertypeex.md)                     | False     | **MSMQ-configuración**          |
| [**Servicios dependientes de MSMQ-Client-Services**](a-msmqdependentclientservices.md)   | False     | **MSMQ-configuración**          |
| [**Servicios de MSMQ-DS**](a-msmqdsservices.md)                              | False     | **MSMQ-configuración**          |
| [**Cifrado de clave de MSMQ**](a-msmqencryptkey.md)                              | False     | **MSMQ-configuración**          |
| [**MSMQ-externo**](a-msmqforeign.md)                                     | False     | **MSMQ-configuración**          |
| [**MSMQ-in-Routing-servers**](a-msmqinroutingservers.md)                 | False     | **MSMQ-configuración**          |
| [**Cuota de MSMQ-Journal**](a-msmqjournalquota.md)                          | False     | **MSMQ-configuración**          |
| [**MSMQ-OS-tipo**](a-msmqostype.md)                                      | False     | **MSMQ-configuración**          |
| [**MSMQ-out-Routing-servers**](a-msmqoutroutingservers.md)               | False     | **MSMQ-configuración**          |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                    | False     | **MSMQ-configuración**          |
| [**MSMQ-cuota**](a-msmqquota.md)                                         | False     | **MSMQ-configuración**          |
| [**Servicios de enrutamiento de MSMQ**](a-msmqroutingservices.md)                    | False     | **MSMQ-configuración**          |
| [**Tipo de servicio de MSMQ**](a-msmqservicetype.md)                            | False     | **MSMQ-configuración**          |
| [**Firma de MSMQ**](a-msmqsignkey.md)                                    | False     | **MSMQ-configuración**          |
| [**MSMQ-sitios**](a-msmqsites.md)                                         | False     | **MSMQ-configuración**          |
...
| Nombre común                                                              |
|--------------------------------------------------------------------------|
| [**MSMQ-recepción-mensajes con problemas de entrega**](r-msmq-receive-dead-letter.md)           |
| [**MSMQ-PEEK-mensajes con problemas de entrega**](r-msmq-peek-dead-letter.md)                 |
