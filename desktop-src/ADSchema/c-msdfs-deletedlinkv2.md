...
keywords:
- Esquema de AD de la clase ms-DFS-Deleted-Link-v2
- Esquema de AD de la clase msDFS-DeletedLinkv2
topic_type:
- apiref
api_name:
...
ms.locfileid: "117836451"
---
# <a name="ms-dfs-deleted-link-v2-class"></a>clase ms-DFS-Deleted-Link-v2

Vínculo DFS eliminado en el espacio de nombres DFS.
...
| Posibles superiores          | [**ms-DFS-Namespace-v2**](c-msdfs-namespacev2.md)                                           |
| Clases auxiliares           | \-                                                                                           |
...
| [**ms-DFS-Last-Modified-v2**](a-msdfs-lastmodifiedv2.md)                      | Verdadero      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Link-Identity-GUID-v2**](a-msdfs-linkidentityguidv2.md)             | Verdadero      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Link-Path-v2**](a-msdfs-linkpathv2.md)                              | Verdadero      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Namespace-Identity-GUID-v2**](a-msdfs-namespaceidentityguidv2.md)   | Verdadero      | **ms-DFS-Deleted-Link-v2**      |
