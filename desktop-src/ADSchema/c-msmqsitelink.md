...
---
# <a name="msmq-site-link-class"></a>MSMQ-site-Link (clase)

Contiene información acerca de la conectividad de enrutamiento de MSMQ entre sitios. Este objeto se crea para cada vínculo de enrutamiento que se crea y contiene información de conectividad. Estos objetos están incluidos en los objetos de servicios de MSMQ.



| Entrada | Value |
|-------------------|-------------------------------------------------------------------|
| CN                | Vínculo de MSMQ-sitio                                                    |
| Nombre para mostrar de LDAP | mSMQSiteLink                                                      |
| Actualizar privilegio  | Propietario de la cola.                                                  |
| Frecuencia de actualización  | Se crea una instancia de cada par de sitios que están conectados. |
| Identificador de esquema-GUID    | 9a0dc346-c100-11d1-bbc5-0080c76670c0                              |
...
| Posibles superiores          | [**Configuración de MSMQ-Enterprise**](c-msmqenterprisesettings.md)                                 |
| Clases auxiliares           | \-                                                                                           |
...
| [**MSMQ-costo**](a-msmqcost.md)                                           | True      | **Vínculo de MSMQ-sitio**              |
| [**MSMQ-sitio-1**](a-msmqsite1.md)                                        | True      | **Vínculo de MSMQ-sitio**              |
| [**MSMQ-sitio-2**](a-msmqsite2.md)                                        | True      | **Vínculo de MSMQ-sitio**              |
| [**MSMQ-sitio-puertas**](a-msmqsitegates.md)                                | False     | **Vínculo de MSMQ-sitio**              |
| [**MSMQ-sitio-puertas-MIG**](a-msmqsitegatesmig.md)                         | False     | **Vínculo de MSMQ-sitio**              |
