...
---
# <a name="ms-sql-sqlrepository-class"></a>Clase MS-SQL-SQLRepository

Clase para almacenar propiedades de repositorio de SQL Server.
...
| Nombre para mostrar de LDAP | mS-SQL-SQLRepository                 |
| Actualizar privilegio  | El sistema establece este valor.     |
| Frecuencia de actualización  | En el programa de instalación del sistema.                     |
| Identificador de esquema-GUID    | 11d43c5c-ccef-11d2-9993-0000f87a57d4 |
...
| [**MS-SQL-compilación**](a-ms-sql-build.md)                                    | False     | **MS-SQL-SQLRepository**        |
| [**Contacto de MS-SQL**](a-ms-sql-contact.md)                                | False     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-Descripción**](a-ms-sql-description.md)                        | False     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-InformationDirectory**](a-ms-sql-informationdirectory.md)      | False     | **MS-SQL-SQLRepository**        |
| [**Nombre MS-SQL**](a-ms-sql-name.md)                                      | False     | **MS-SQL-SQLRepository**        |
| [**Estado de MS-SQL**](a-ms-sql-status.md)                                  | False     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-versión**](a-ms-sql-version.md)                                | False     | **MS-SQL-SQLRepository**        |
