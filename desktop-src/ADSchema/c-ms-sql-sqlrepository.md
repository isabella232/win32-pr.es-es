...
description: Clase para almacenar SQL Server propiedades del repositorio.
...
ms.locfileid: "119323915"
---
# <a name="ms-sql-sqlrepository-class"></a>Clase MS-SQL-SQLRepository

Clase para almacenar SQL Server propiedades del repositorio.
