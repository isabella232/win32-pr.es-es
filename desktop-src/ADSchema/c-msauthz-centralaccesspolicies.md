---
title: ms-Authz-Central-Access-Policies (clase)
...
keywords:
- Esquema de AD de la clase ms-Authz-Central-Access-Policies
- Esquema de AD de la clase msAuthz-CentralAccessPolicies
topic_type:
- apiref
api_name:
...
ms.locfileid: "118959904"
---
# <a name="ms-authz-central-access-policies-class"></a>ms-Authz-Central-Access-Policies (clase)
