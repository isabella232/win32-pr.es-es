...
---
# <a name="ms-wmi-rule-class"></a>clase MS-WMI-Rule
...
|-------------------|--------------------------------------|
| CN                | MS-WMI-regla                          |
| Nombre para mostrar de LDAP | msWMI: regla                           |
| Actualizar privilegio  | Administrador de directiva de grupo           |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 3c7e6f83-dd0e-481b-a0c2-74cd96ef2a66 |
...
| [**MS-WMI-consulta**](a-mswmi-query.md)                                       | True      | **MS-WMI-regla**                 |
| [**MS-WMI-QueryLanguage**](a-mswmi-querylanguage.md)                       | True      | **MS-WMI-regla**                 |
| [**MS-WMI-TargetNameSpace**](a-mswmi-targetnamespace.md)                   | True      | **MS-WMI-regla**                 |
