...
---
# <a name="msmq-custom-recipient-class"></a>Clase MSMQ-Custom-recipient

Se utiliza para definir un destinatario de MSMQ personalizado (también conocido como cola de alias). Define un alias para una cola fuera de la empresa. Contiene el nombre de formato de esa cola.
