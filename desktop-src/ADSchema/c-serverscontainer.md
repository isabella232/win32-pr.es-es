...
---
# <a name="servers-container-class"></a>Servers-Container (clase)

Contiene objetos de servidor en un sitio.
...
| Nombre para mostrar de LDAP | serversContainer                     |
| Actualizar privilegio  | Administrador de dominio                 |
| Frecuencia de actualización  | Cuando se crea un sitio.              |
| Identificador de esquema-GUID    | f780acc0-56f0-11d1-a9c6-0000f80367c1 |
...
| Descriptor de seguridad predeterminado | D: (A;; CC;;; BA) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; ESTÉ |
