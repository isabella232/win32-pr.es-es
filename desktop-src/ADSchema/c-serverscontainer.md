...
keywords:
- Servers-Container esquema de AD de la clase
- serversContainer class AD Schema
topic_type:
- apiref
api_name:
- Servers-Container
...
| Descriptor de seguridad predeterminado | D:(A;; CC;;; BA)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
