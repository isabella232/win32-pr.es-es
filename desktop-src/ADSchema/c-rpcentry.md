---
title: rpc-Entry (clase)
description: Clase abstracta cuyas subclases usa el servicio de nombres RPC (Ns), al que se accede mediante las funciones RpcNs\ de la API win32.
...
ms.locfileid: "119801555"
---
# <a name="rpc-entry-class"></a>rpc-Entry (clase)

Clase abstracta cuyas subclases usa el servicio de nombres RPC (Ns), al que se accede mediante las funciones RpcNs de la \* API win32.
