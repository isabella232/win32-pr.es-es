...
---
# <a name="rpc-entry-class"></a>RPC: clase de entrada

Clase abstracta cuyas subclases se usan en el servicio de nombres de RPC (NS), al que se tiene acceso mediante las \* funciones RpcNs de la API de Win32.
...
|-------------------|--------------------------------------|
| CN                | Entrada RPC                            |
| Nombre para mostrar de LDAP | rpcEntry                             |
| Actualizar privilegio  | Administrador de esquema                 |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | bf967aac-0de6-11d0-a285-00aa003049e2 |
