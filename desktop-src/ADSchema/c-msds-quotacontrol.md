---
title: ms-DS-Quota-Control (clase)
description: Clase que se usa para representar las especificaciones de cuota de la base de datos de directorio.
ms.assetid: e37897f8-9646-4bc8-b6e6-9da4a83d66d5
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-DS-Quota-Control
...
ms.locfileid: "119879895"
---
# <a name="ms-ds-quota-control-class"></a>ms-DS-Quota-Control (clase)

Clase que se usa para representar las especificaciones de cuota de la base de datos de directorio.
...
| Posibles superiores          | [**ms-DS-Quota-Container**](c-msds-quotacontainer.md)   |
| Clases auxiliares           | \-                                                       |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                             |
| Descriptor de seguridad predeterminado | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPLCLORC;;; BA) |
...
| [**Common-Name**](a-cn.md)                                                 | Verdadero      | **ms-DS-Quota-Control** [ **Top**](c-top.md)<br/> |
...
| [**ms-DS-Quota-Amount**](a-msds-quotaamount.md)                            | Verdadero      | **ms-DS-Quota-Control**                                 |
| [**ms-DS-Quota-Trustee**](a-msds-quotatrustee.md)                          | Verdadero      | **ms-DS-Quota-Control**                                 |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)                                | Falso     | [**Arriba**](c-top.md)<br/>                         |
| [**Canonical-Name**](a-canonicalname.md)                                                    | Falso     | [**Arriba**](c-top.md)<br/>                         |
| [**Nombre común**](a-cn.md)                                                                  | Verdadero      | **ms-DS-Quota-Control** [ **Top**](c-top.md)<br/> |
