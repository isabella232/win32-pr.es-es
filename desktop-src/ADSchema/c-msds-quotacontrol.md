...
---
# <a name="ms-ds-quota-control-class"></a>clase MS-DS-quota-control

Clase utilizada para representar las especificaciones de cuota para la base de datos de directorio.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Control de cuota MS-DS                  |
| Nombre para mostrar de LDAP | msDS-QuotaControl                    |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | de91fc26-bd02-4b52-ae26-795999e96fc7 |
...
| Posibles superiores          | [**Contenedor de Microsoft-DS-quota**](c-msds-quotacontainer.md)   |
| Clases auxiliares           | \-                                                       |
| Descriptor de NT-Security-      | O:BAG: BAD: S:                                             |
| Descriptor de seguridad predeterminado | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPLCLORC;;; BSE |
...
| [**Nombre común**](a-cn.md)                                                 | True      | **MS-DS-quota-control** [ **superior**](c-top.md)<br/> |
...
| [**MS-DS-quota-amount**](a-msds-quotaamount.md)                            | True      | **Control de cuota MS-DS**                                 |
| [**MS-DS-quota-Trustee**](a-msds-quotatrustee.md)                          | True      | **Control de cuota MS-DS**                                 |
