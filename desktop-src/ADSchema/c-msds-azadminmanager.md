...
---
# <a name="ms-ds-az-admin-manager-class"></a>clase MS-DS-AZ-admin-Manager

Raíz de la instancia del almacén de directivas de autorización. Tenga en cuenta que puede haber muchas instancias de almacén.
...
| Nombre para mostrar de LDAP | msDS-AzAdminManager                             |
| Actualizar privilegio  | El administrador de AzRoles establece este valor. |
| Frecuencia de actualización  | Durante la inicialización o el cambio de directiva.         |
| Identificador de esquema-GUID    | cfee1051-5f28-4bae-a863-5d0cc18a8ed1            |
...
| [**Descripción**](a-description.md)                                        | False     | **MS-DS-AZ-admin-Manager** [ **Top**](c-top.md)<br/> |
