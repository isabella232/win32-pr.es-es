---
title: ms-TPM-Information-Object (Clase)
description: Esta clase contiene información de recuperación para un Módulo de plataforma segura (TPM).
ms.assetid: 75897787-f177-4899-905d-6ae2f2f7a16f
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-TPM-Information-Object
- Esquema de AD de la clase msTPM-InformationObject
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879315"
---
# <a name="ms-tpm-information-object-class"></a>ms-TPM-Information-Object (Clase)

Esta clase contiene información de recuperación para un Módulo de plataforma segura (TPM).
...
| Posibles superiores          | [**ms-TPM-Information-Objects-Container**](c-mstpm-informationobjectscontainer.md)                  |
| Clases auxiliares           | \-                                                                                                   |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                         |
| Descriptor de seguridad predeterminado | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLO;;;D C)(A;; WP;;; CO) |
...
| [**ms-TPM-OwnerInformation**](a-mstpm-ownerinformation.md)                                  | Verdadero      | **ms-TPM-Information-Object**   |
