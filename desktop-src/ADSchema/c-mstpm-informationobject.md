...
---
# <a name="ms-tpm-information-object-class"></a>clase de objeto de información de MS-TPM

Esta clase contiene información de recuperación de un dispositivo Módulo de plataforma segura (TPM).



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Objeto de información de MS-TPM            |
| Nombre para mostrar de LDAP | msTPM-InformationObject              |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 85045b6a-47a6-4243-a7cc-6890701f662c |
...
| Posibles superiores          | [**Contenedor de objetos MS-TPM-Information-Objects**](c-mstpm-informationobjectscontainer.md)                  |
| Clases auxiliares           | \-                                                                                                   |
| Descriptor de NT-Security-      | O:BAG: BAD: S:                                                                                         |
| Descriptor de seguridad predeterminado | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLO;;;D C) (A;; WP;;; USTEDES |
...
| [**MS-TPM-OwnerInformation**](a-mstpm-ownerinformation.md)                                  | True      | **Objeto de información de MS-TPM**   |
| [**MS-TPM-Owner-Information-Temp**](a-mstpm-ownerinformationtemp.md)                        | False     | **Objeto de información de MS-TPM**   |
| [**MS-TPM-SRK-pub-huella digital**](a-mstpm-srkpubthumbprint.md)                                | False     | **Objeto de información de MS-TPM**   |
