...
Contiene los límites de recursos reservables para una subred. Estos límites pueden ser para cada tipo de servicio de ACS o para todos los tipos de servicio.



| Entrada | Value |
|-------------------|------------------------------------------------|
| CN                | ACS-recursos-límites                            |
| Nombre para mostrar de LDAP | aCSResourceLimits                              |
| Actualizar privilegio  | El administrador del dominio establece este valor. |
| Frecuencia de actualización  | \-                                             |
| Identificador de esquema-GUID    | 2e899b04-2834-11d3-91d4-0000f87a57d4           |
...
|---------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-allocable-RSVP-ancho de banda**](a-acsallocablersvpbandwidth.md)       | False     | **ACS-recursos-límites**         |
| [**ACS-Max-pico-ancho de banda**](a-acsmaxpeakbandwidth.md)                   | False     | **ACS-recursos-límites**         |
| [**ACS-Max-pico-ancho de banda por flujo**](a-acsmaxpeakbandwidthperflow.md)   | False     | **ACS-recursos-límites**         |
| [**ACS-Max-token-Rate-per-Flow**](a-acsmaxtokenrateperflow.md)           | False     | **ACS-recursos-límites**         |
| [**ACS-tipo de servicio**](a-acsservicetype.md)                              | False     | **ACS-recursos-límites**         |
