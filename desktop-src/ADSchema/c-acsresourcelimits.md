...
description: Contiene límites de recursos reservables para una subred. Estos límites pueden ser para cada tipo de servicio de ACS o para todos los tipos de servicio.
ms.assetid: 6b1d15e8-a60b-4253-8521-db3c9ebbb69b
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ACS-Resource-Limits
- aCSResourceLimits (clase, esquema de AD)
topic_type:
- apiref
api_name:
- ACS-Resource-Limits
...
ms.locfileid: "119021883"
---
# <a name="acs-resource-limits-class"></a>ACS-Resource-Limits (clase)

Contiene límites de recursos reservables para una subred. Estos límites pueden ser para cada tipo de servicio de ACS o para todos los tipos de servicio.



| Entrada | Value |
|-------------------|------------------------------------------------|
| CN                | Límites de recursos de ACS                            |
...
|---------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-Allocable-RSVP-Bandwidth**](a-acsallocablersvpbandwidth.md)       | Falso     | **Límites de recursos de ACS**         |
| [**ACS-Max-Peak-Bandwidth**](a-acsmaxpeakbandwidth.md)                   | Falso     | **Límites de recursos de ACS**         |
| [**ACS-Max-Peak-Bandwidth-Per-Flow**](a-acsmaxpeakbandwidthperflow.md)   | Falso     | **Límites de recursos de ACS**         |
| [**ACS-Max-Token-Rate-Per-Flow**](a-acsmaxtokenrateperflow.md)           | Falso     | **Límites de recursos de ACS**         |
| [**ACS-Service-Type**](a-acsservicetype.md)                              | Falso     | **Límites de recursos de ACS**         |
