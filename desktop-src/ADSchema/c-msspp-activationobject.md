---
title: ms-SPP-Activation-Object (clase)
...
keywords:
- Esquema de AD de la clase ms-SPP-Activation-Object
- Esquema de AD de la clase msSPP-ActivationObject
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879435"
---
# <a name="ms-spp-activation-object-class"></a>ms-SPP-Activation-Object (clase)

Activation Object used in Active Directory based activation
...
| Descriptor de seguridad predeterminado | O:BAG:BAD: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPLCLORC;;; AU)                 |
...
| [**ms-SPP-CSVLK-Partial-Product-Key**](a-msspp-csvlkpartialproductkey.md)                   | Verdadero      | **ms-SPP-Activation-Object**    |
| [**ms-SPP-CSVLK-Pid**](a-msspp-csvlkpid.md)                                                 | Verdadero      | **ms-SPP-Activation-Object**    |
| [**ms-SPP-CSVLK-Sku-Id**](a-msspp-csvlkskuid.md)                                            | Verdadero      | **ms-SPP-Activation-Object**    |
...
| [**ms-SPP-KMS-Ids**](a-msspp-kmsids.md)                                                     | Verdadero      | **ms-SPP-Activation-Object**    |
| [**ms-SPP-Online-License**](a-msspp-onlinelicense.md)                                       | Falso     | **ms-SPP-Activation-Object**    |
| [**ms-SPP-Teléfono-License**](a-msspp-phonelicense.md)                                         | Falso     | **ms-SPP-Activation-Object**    |
