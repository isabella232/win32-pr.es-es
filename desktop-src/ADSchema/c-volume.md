...
Contiene información acerca de un dispositivo o un archivo de almacenamiento. Esta clase se usa para crear carpetas compartidas.
...
|-------------------|--------------------------------------|
| CN                | Volumen                               |
| Nombre para mostrar de LDAP | volumen                               |
| Actualizar privilegio  | Administrador de dominio                 |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | bf967abb-0de6-11d0-a285-00aa003049e2 |
...
| [**Indexación de contenido: permitido**](a-contentindexingallowed.md)              | False     | **Volumen**                                                                               |
...
| [**Última indexación de contenido**](a-lastcontentindexed.md)                      | False     | **Volumen**                                                                               |
...
| [**Nombre UNC**](a-uncname.md)                                             | True      | **Volumen**                                                                               |
