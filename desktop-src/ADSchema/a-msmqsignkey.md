...
---
# <a name="msmq-sign-key-attribute"></a>Atributo MSMQ-Sign-Key

La clave de firma pública del equipo.
...
|-------------------|-------------------------------------------------------|
| CN                | Firma de MSMQ                                         |
| Nombre para mostrar de LDAP | mSMQSignKey                                           |
| Tamaño              | \-                                                    |
| Actualizar privilegio  | \-                                                    |
| Frecuencia de actualización  | \-                                                    |
| Attribute-Id      | 1.2.840.113556.1.4.937                                |
| System-ID-GUID    | 9a0dc332-c100-11d1-bbc5-0080c76670c0                  |
