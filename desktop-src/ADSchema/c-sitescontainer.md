...
|-------------------|------------------------------------------|
| CN                | Sites-Container                          |
| Nombre para mostrar de LDAP | sitesContainer                           |
| Actualizar privilegio  | El sistema mantiene este objeto. |
| Frecuencia de actualización  | Cuando se crea el servicio de directorio.   |
| Identificador de esquema-GUID    | 7a4117da-cd67-11d0-afff-0000f80367c1     |
