---
title: ms-DFSR-Connection (clase)
description: Representa una conexión direccional entre dos miembros.
ms.assetid: febdbcf7-c5bd-4e4d-83e7-3070166093d0
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-DFSR-Connection
- Esquema de AD de la clase msDFSR-Connection
topic_type:
- apiref
api_name:
- ms-DFSR-Connection
...
ms.locfileid: "117836228"
---
# <a name="ms-dfsr-connection-class"></a>ms-DFSR-Connection (clase)
...
| Schema-Id-Guid    | e58f972e-64b5-46ef-8d8b-él3e1897eab |
...
| Posibles superiores          | [**ms-DFSR-Member**](c-msdfsr-member.md)                                                                                        |
| Clases auxiliares           | \-                                                                                                                               |
...
| [**Desde el servidor**](a-fromserver.md)                                         | Verdadero      | **ms-DFSR-Connection**          |
...
La **clase ms-DFSR-Connection** forma parte de la compatibilidad del servicio de replicación Sistema de archivos distribuido (DFS).
