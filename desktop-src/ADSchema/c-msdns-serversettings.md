---
title: clase ms-DNS-Server-Configuración
...
keywords:
- ms-DNS-Server-Configuración esquema de AD
- Esquema de AD de la clase msDNS-ServerSettings
topic_type:
- apiref
api_name:
...
ms.locfileid: "119880615"
---
# <a name="ms-dns-server-settings-class"></a>clase ms-DNS-Server-Configuración

Un contenedor para almacenar la configuración del servidor DNS.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | ms-DNS-Server-Configuración               |
...
| [**ms-DNS-Keymaster-Zones**](a-msdns-keymasterzones.md)                                     | Falso     | **ms-DNS-Server-Configuración**      |
