...
---
# <a name="ms-dns-server-settings-class"></a>clase de configuración MS-DNS-Server
...
| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Configuración de MS-DNS-Server               |
| Nombre para mostrar de LDAP | msDN: ServerSettings                 |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | ef2fc3ed-6e18-415b-99e4-3114a8cb124b |
...
| [**MS-DNS-maestro-Zones**](a-msdns-keymasterzones.md)                                     | False     | **Configuración de MS-DNS-Server**      |
