...
---
# <a name="mssfu-30-network-user-class"></a>msSFU-30-Network-clase de usuario

Representa datos de archivos de red.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | msSFU-30-red-usuario                |
| Nombre para mostrar de LDAP | msSFU30NetworkUser                   |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | e15334a3-0bf0-4427-b672-11f5d84acc92 |
...
| [**msSFU-30-clave-valores**](a-mssfu30keyvalues.md)                           | False     | **msSFU-30-red-usuario**       |
| [**msSFU-30-nombre**](a-mssfu30name.md)                                      | False     | **msSFU-30-red-usuario**       |
| [**msSFU-30-NIS-dominio**](a-mssfu30nisdomain.md)                           | False     | **msSFU-30-red-usuario**       |
...
| [**nisMapName**](a-nismapname.md)                                          | False     | **msSFU-30-red-usuario**       |
