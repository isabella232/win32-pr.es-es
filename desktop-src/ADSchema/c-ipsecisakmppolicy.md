---
title: Ipsec-ISAKMP-Policy (clase)
description: La clase Ipsec-ISAKMP-Policy es solo para uso interno.
ms.assetid: a40b4289-01c9-489d-a755-725978d6dfc2
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase Ipsec-ISAKMP-Policy
...
ms.locfileid: "119324235"
---
# <a name="ipsec-isakmp-policy-class"></a>Ipsec-ISAKMP-Policy (clase)

La **clase Ipsec-ISAKMP-Policy** es solo para uso interno.
...
| Posibles superiores          | [**Contenedor de equipos de unidad**](c-organizationalunit.md)[**organizativa**](c-computer.md)[](c-container.md) |
| Clases auxiliares           | \-                                                                                                                |
