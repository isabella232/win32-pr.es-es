...
---
# <a name="ipsec-isakmp-policy-class"></a>IPSec-ISAKMP-clase de Directiva

La clase **IPSec-ISAKMP-Policy** solo es para uso interno.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | IPSec-ISAKMP-Directiva                  |
| Nombre para mostrar de LDAP | ipsecISAKMPPolicy                    |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | b40ff828-427a-11d1-a9c2-0000f80367c1 |
