---
title: ms-Authz-Central-Access-Rules (clase)
...
keywords:
- Esquema de AD de la clase ms-Authz-Central-Access-Rules
- Esquema de AD de la clase msAuthz-CentralAccessRules
topic_type:
- apiref
api_name:
...
ms.locfileid: "119801785"
---
# <a name="ms-authz-central-access-rules-class"></a>ms-Authz-Central-Access-Rules (clase)
