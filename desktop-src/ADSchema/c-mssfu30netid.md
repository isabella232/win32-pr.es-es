...
---
# <a name="mssfu-30-net-id-class"></a>msSFU-30-net-ID (clase)

Se usa para almacenar el identificador de red.
...
|-------------------|--------------------------------------|
| CN                | msSFU-30-net-ID                      |
| Nombre para mostrar de LDAP | msSFU30NetId                         |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | e263192c-2a02-48df-9792-94f2328781a0 |
...
| [**msSFU-30-clave-valores**](a-mssfu30keyvalues.md)                           | False     | **msSFU-30-net-ID**             |
| [**msSFU-30-nombre**](a-mssfu30name.md)                                      | False     | **msSFU-30-net-ID**             |
| [**msSFU-30-NIS-dominio**](a-mssfu30nisdomain.md)                           | False     | **msSFU-30-net-ID**             |
...
| [**nisMapName**](a-nismapname.md)                                          | False     | **msSFU-30-net-ID**             |
