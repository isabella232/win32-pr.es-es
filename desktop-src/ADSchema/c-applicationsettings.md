...
keywords:
- Application-Settings esquema de AD de la clase
- ApplicationSettings class AD Schema (Esquema de AD de la clase applicationSettings)
topic_type:
- apiref
api_name:
...
ms.locfileid: "119643915"
---
# <a name="application-settings-class"></a>Application-Settings clase

Clase base para la configuración de la aplicación específica del servidor.
...
| Posibles superiores          | [**Servidor**](c-server.md)             |
| Clases auxiliares           | \-                                     |
...
| [**Nombre de la aplicación**](a-applicationname.md)                             | Falso     | **Application-Configuración**        |
...
| [**Lista de notificaciones**](a-notificationlist.md)                           | Falso     | **Application-Configuración**        |
...
| [**Allowed-Child-Classes**](a-allowedchildclasses.md)                      | Falso     | [**Arriba**](c-top.md)<br/> |
| [**Allowed-Child-Classes-Effective**](a-allowedchildclasseseffective.md)   | Falso     | [**Arriba**](c-top.md)<br/> |
| [**Nombre de la aplicación**](a-applicationname.md)                               | Falso     | **Aplicación Configuración**        |
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falso     | [**Arriba**](c-top.md)<br/> |
| [**Canonical-Name**](a-canonicalname.md)                                   | Falso     | [**Arriba**](c-top.md)<br/> |
| [**Common-Name**](a-cn.md)                                                 | Falso     | [**Arriba**](c-top.md)<br/> |
...
| [**ms-DS-Configuración**](a-msds-settings.md)                                   | Falso     | **Application-Configuración**        |
