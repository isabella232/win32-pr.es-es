...
Un contenedor para almacenar objetos de servidor. Representa una ubicación física que contiene equipos. Se utilizan para administrar la replicación.
...
|-------------------|--------------------------------------|
| CN                | Sitio                                 |
| Nombre para mostrar de LDAP | site                                 |
| Actualizar privilegio  | Administrador de dominio                 |
| Frecuencia de actualización  | Siempre que se necesita un nuevo sitio.       |
| Identificador de esquema-GUID    | bf967ab3-0de6-11d0-a285-00aa003049e2 |
...
| Posibles superiores          | [**Sitios: contenedor**](c-sitescontainer.md)              |
| Clases auxiliares           | \-                                                       |
| Descriptor de NT-Security-      | O:BAG: BAD: S:                                             |
| Descriptor de seguridad predeterminado | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; ESTÉ |
...
| [**GP: vínculo**](a-gplink.md)                                               | False     | **Sitio**                        |
| [**GP-opciones**](a-gpoptions.md)                                         | False     | **Sitio**                        |
...
| [**Location**](a-location.md)                                            | False     | **Sitio**                        |
| [**Administrado: por**](a-managedby.md)                                         | False     | **Sitio**                        |
...
| [**MSMQ-Interval1**](a-msmqinterval1.md)                                 | False     | **Sitio**                        |
| [**MSMQ-Interval2**](a-msmqinterval2.md)                                 | False     | **Sitio**                        |
| [**Código auxiliar de MSMQ-Nt4**](a-msmqnt4stub.md)                                    | False     | **Sitio**                        |
| [**MSMQ-sitio-externo**](a-msmqsiteforeign.md)                            | False     | **Sitio**                        |
| [**IDENTIFICADOR de sitio de MSMQ**](a-msmqsiteid.md)                                      | False     | **Sitio**                        |
...
| [**Lista de notificaciones**](a-notificationlist.md)                           | False     | **Sitio**                        |
...
| Nombre común                                          |
|------------------------------------------------------|
| [**Conector de MSMQ-Open-**](r-msmq-open-connector.md) |
...
| [**MS-DS-cabeza de puente-servidores-usados**](a-msds-bridgeheadserversused.md)          | False     | **Sitio**                        |
| [**MS-DS-Consistency-Child-Count**](a-ms-ds-consistencychildcount.md)         | False     | [**Arriba**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | False     | [**Arriba**](c-top.md)<br/> |
