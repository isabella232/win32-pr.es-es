...
description: Contiene parámetros de configuración para un servidor acs (servicio de control de asignación de ancho de banda).
ms.assetid: 454425ae-2bc3-4407-b328-b9873e70e2bb
ms.tgt_platform: multiple
keywords:
- ACS-Subnet esquema de AD de clase
- aCSSubnet class AD Schema
topic_type:
- apiref
api_name:
- ACS-Subnet
...
ms.locfileid: "119702285"
---
# <a name="acs-subnet-class"></a>ACS-Subnet clase

Contiene parámetros de configuración para un servidor acs (servicio de control de asignación de ancho de banda).
...
| [**Tiempo de espera de caché de ACS**](a-acscachetimeout.md)                              | Falso     | **ACS-Subnet**                  |
| [**ACS-ESTAM-DeadTime**](a-acsdsbmdeadtime.md)                              | Falso     | **ACS-Subnet**                  |
| [**ACS-UNAM-Prioridad**](a-acsdsbmpriority.md)                              | Falso     | **ACS-Subnet**                  |
| [**ACS-LOM-Refresh**](a-acsdsbmrefresh.md)                                | Falso     | **ACS-Subnet**                  |
...
| [**Acs no reservado, tamaño mínimo con unas medidas de seguridad mínimas**](a-acsnonreservedminpolicedsize.md) | Falso     | **ACS-Subnet**                  |
| [**Velocidad máxima no reservada de ACS**](a-acsnonreservedpeakrate.md)              | Falso     | **ACS-Subnet**                  |
| [**Tamaño de token no reservado de ACS**](a-acsnonreservedtokensize.md)            | Falso     | **ACS-Subnet**                  |
| [**Límite de tx no reservado de ACS**](a-acsnonreservedtxlimit.md)                | Falso     | **ACS-Subnet**                  |
| [**ACS no reservada-tx-size**](a-acsnonreservedtxsize.md)                  | Falso     | **ACS-Subnet**                  |
...
| [**ACS-ESTAM-DeadTime**](a-acsdsbmdeadtime.md)                              | Falso     | **ACS-Subnet**                  |
| [**ACS-ESTOM-Prioridad**](a-acsdsbmpriority.md)                              | Falso     | **ACS-Subnet**                  |
| [**ACS-LOM-Refresh**](a-acsdsbmrefresh.md)                                | Falso     | **ACS-Subnet**                  |
| [**ACS-Enable-ACS-Service**](a-acsenableacsservice.md)                     | Falso     | **ACS-Subnet**                  |
| [**ACS-Enable-RSVP-Accounting**](a-acsenablersvpaccounting.md)             | Falso     | **ACS-Subnet**                  |
| [**ACS-Enable-RSVP-Message-Logging**](a-acsenablersvpmessagelogging.md)    | Falso     | **ACS-Subnet**                  |
...
| [**Tamaño de token no reservado de ACS**](a-acsnonreservedtokensize.md)            | Falso     | **ACS-Subnet**                  |
| [**Límite de tx-tx no reservado de ACS**](a-acsnonreservedtxlimit.md)                | Falso     | **ACS-Subnet**                  |
...
| [**ACS-ESTAM-DeadTime**](a-acsdsbmdeadtime.md)                                 | Falso     | **ACS-Subnet**                  |
| [**ACS-UNAM-Prioridad**](a-acsdsbmpriority.md)                                 | Falso     | **ACS-Subnet**                  |
| [**ACS-ESTAM-Refresh**](a-acsdsbmrefresh.md)                                   | Falso     | **ACS-Subnet**                  |
| [**ACS-Enable-ACS-Service**](a-acsenableacsservice.md)                        | Falso     | **ACS-Subnet**                  |
| [**ACS-Enable-RSVP-Accounting**](a-acsenablersvpaccounting.md)                | Falso     | **ACS-Subnet**                  |
| [**ACS-Enable-RSVP-Message-Logging**](a-acsenablersvpmessagelogging.md)       | Falso     | **ACS-Subnet**                  |
| [**Acs-Event-Log-Level**](a-acseventloglevel.md)                              | Falso     | **ACS-Subnet**                  |
