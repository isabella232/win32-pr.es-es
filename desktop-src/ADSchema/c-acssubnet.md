...
---
# <a name="acs-subnet-class"></a>ACS-Subnet (clase)

Contiene los parámetros de configuración de un servidor de ACS (servicio de control de asignación de ancho de banda).
...
|-------------------|--------------------------------------|
| CN                | ACS-Subnet                           |
| Nombre para mostrar de LDAP | aCSSubnet                            |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 7f561289-5301-11d1-a9c5-0000f80367c1 |
...
|-----------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-allocable-RSVP-ancho de banda**](a-acsallocablersvpbandwidth.md)         | False     | **ACS-subred**                  |
| [**ACS-cache-timeout**](a-acscachetimeout.md)                              | False     | **ACS-subred**                  |
| [**ACS-DSBM-DeadTime**](a-acsdsbmdeadtime.md)                              | False     | **ACS-subred**                  |
| [**ACS-DSBM-prioridad**](a-acsdsbmpriority.md)                              | False     | **ACS-subred**                  |
| [**ACS-DSBM-actualizar**](a-acsdsbmrefresh.md)                                | False     | **ACS-subred**                  |
| [**ACS-enable-ACS-Service**](a-acsenableacsservice.md)                     | False     | **ACS-subred**                  |
| [**ACS-enable-RSVP-cuentas**](a-acsenablersvpaccounting.md)             | False     | **ACS-subred**                  |
| [**ACS-enable-RSVP-registro de mensajes**](a-acsenablersvpmessagelogging.md)    | False     | **ACS-subred**                  |
| [**Nivel de registro de eventos de ACS**](a-acseventloglevel.md)                           | False     | **ACS-subred**                  |
| [**ACS-Max-Duration-per-Flow**](a-acsmaxdurationperflow.md)                | False     | **ACS-subred**                  |
| [**ACS-Max-no-of-Account-files**](a-acsmaxnoofaccountfiles.md)             | False     | **ACS-subred**                  |
| [**ACS-Max-no-of-log-files**](a-acsmaxnooflogfiles.md)                     | False     | **ACS-subred**                  |
| [**ACS-Max-pico-ancho de banda**](a-acsmaxpeakbandwidth.md)                     | False     | **ACS-subred**                  |
| [**ACS-Max-pico-ancho de banda por flujo**](a-acsmaxpeakbandwidthperflow.md)     | False     | **ACS-subred**                  |
| [**ACS-Max-Size-of-RSVP-Account-File**](a-acsmaxsizeofrsvpaccountfile.md)  | False     | **ACS-subred**                  |
| [**ACS-Max-Size-of-RSVP-log-file**](a-acsmaxsizeofrsvplogfile.md)          | False     | **ACS-subred**                  |
| [**ACS-Max-token-Rate-per-Flow**](a-acsmaxtokenrateperflow.md)             | False     | **ACS-subred**                  |
| [**ACS-no reservado-Max-SDU-size**](a-acsnonreservedmaxsdusize.md)         | False     | **ACS-subred**                  |
| [**ACS-no reservado-número mínimo de directivas**](a-acsnonreservedminpolicedsize.md) | False     | **ACS-subred**                  |
| [**ACS-no reservado-tasa máxima**](a-acsnonreservedpeakrate.md)              | False     | **ACS-subred**                  |
| [**ACS-no reservado-tamaño del token**](a-acsnonreservedtokensize.md)            | False     | **ACS-subred**                  |
| [**ACS-no reservado-TX-límite**](a-acsnonreservedtxlimit.md)                | False     | **ACS-subred**                  |
| [**ACS-no reservado-TX-size**](a-acsnonreservedtxsize.md)                  | False     | **ACS-subred**                  |
| [**ACS-RSVP-Account-files-Location**](a-acsrsvpaccountfileslocation.md)    | False     | **ACS-subred**                  |
| [**ACS-RSVP-log-files-Location**](a-acsrsvplogfileslocation.md)            | False     | **ACS-subred**                  |
| [**ACS-servidor-lista**](a-acsserverlist.md)                                  | False     | **ACS-subred**                  |
