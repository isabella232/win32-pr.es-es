...
keywords:
- Esquema de AD de clase de dominio
- esquema de AD de clase de dominio
topic_type:
- apiref
api_name:
...
ms.locfileid: "119643454"
---
# <a name="domain-class"></a>Clase de dominio

Contiene información sobre un dominio.
...
| System-Only                 | Falso                                            |
| Object-Category             | 2                                                |
| Default-Object-Category     | [**DNS de dominio**](c-domaindns.md)<br/>     |
...
| Posibles superiores          | [**Dominio de**](c-organization.md)**organización** |
| Clases auxiliares           | \-                                               |
...
| [**Componente de dominio**](a-dc.md)                                          | Verdadero      | **Dominio**                      |
...
| Nombre común                                  |
|----------------------------------------------|
| [**Contraseña de dominio**](r-domain-password.md) |
...
| Rdn-Att-Id                  | [**Componente de dominio**](a-dc.md)<br/>      |
| Subclase de                 | [**Arriba**](c-top.md)<br/>                  |
| Posibles superiores          | [**Dominio de**](c-organization.md)**la organización** |
| Clases auxiliares           | \-                                               |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                     |
| Descriptor de seguridad predeterminado | \-                                               |
| System-Flags                | 0x00000010                                       |
