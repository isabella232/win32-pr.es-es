...
ms.locfileid: "119703915"
---
# <a name="application-site-settings-class"></a>Clase Application-Site-Configuración
...
| Entrada | Valor |
|-------------------|------------------------------------------------------|
| CN                | Application-Site-Configuración                            |
| Ldap-Display-Name | applicationSiteSettings                              |
| Privilegio actualizar  | El sistema establece este valor.                          |
| Frecuencia de actualización  | Cada vez que este derecho extendido se aplica a una nueva clase. |
...
| [**Nombre de la aplicación**](a-applicationname.md)                             | Falso     | **Application-Site-Configuración**   |
...
| [**Lista de notificaciones**](a-notificationlist.md)                           | Falso     | **Application-Site-Configuración**   |
