...
---
# <a name="application-site-settings-class"></a>Clase de configuración de sitio de aplicación

Contiene toda la configuración específica del sitio.



| Entrada | Value |
|-------------------|------------------------------------------------------|
| CN                | Configuración del sitio de la aplicación                            |
| Nombre para mostrar de LDAP | applicationSiteSettings                              |
| Actualizar privilegio  | El sistema establece este valor.                          |
| Frecuencia de actualización  | Siempre que este derecho extendido se aplica a una nueva clase. |
| Identificador de esquema-GUID    | 19195a5c-6da0-11d0-afd3-00c04fd930c9                 |
...
| [**Nombre de la aplicación**](a-applicationname.md)                             | False     | **Configuración del sitio de la aplicación**   |
...
| [**Lista de notificaciones**](a-notificationlist.md)                           | False     | **Configuración del sitio de la aplicación**   |
