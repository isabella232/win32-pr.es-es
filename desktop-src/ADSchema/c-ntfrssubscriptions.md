...
---
# <a name="ntfrs-subscriptions-class"></a>NTFRS-Subscriptions (clase)

Contiene un conjunto de suscripciones a un conjunto de réplicas.
...
| Nombre para mostrar de LDAP | nTFRSSubscriptions                   |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 2a132587-9373-11d1-aebc-0000f80367c1 |
...
| Posibles superiores          | **NTFRS-suscripciones usuario del**[**equipo**](c-computer.md)[](c-user.md)                                                      |
| Clases auxiliares           | \-                                                                                                                               |
...
| [**FRS-extensiones**](a-frsextensions.md)                                 | False     | **NTFRS-suscripciones**         |
| [**FRS-Member-Reference-BL**](a-frsmemberreferencebl.md)                 | False     | [**Arriba**](c-top.md)<br/> |
| [**Versión de FRS**](a-frsversion.md)                                       | False     | **NTFRS-suscripciones**         |
| [**FRS-Working-path**](a-frsworkingpath.md)                              | False     | **NTFRS-suscripciones**         |
