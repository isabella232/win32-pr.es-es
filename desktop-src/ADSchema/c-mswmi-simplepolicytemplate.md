---
title: ms-WMI-SimplePolicyTemplate (clase)
description: Proporciona un tipo de plantilla que no se puede combinar. Se usa en casos en los que el objeto de destino no está pensado para combinarse (combinarse).
ms.assetid: 49ef0059-6ee1-4c1a-b02e-1f3a2dd06c64
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-WMI-SimplePolicyTemplate
- Esquema de AD de la clase msWMI-SimplePolicyTemplate
topic_type:
- apiref
api_name:
...
ms.locfileid: "119753624"
---
# <a name="ms-wmi-simplepolicytemplate-class"></a>ms-WMI-SimplePolicyTemplate (clase)

Proporciona un tipo de plantilla que no se puede combinar. Se usa en casos en los que el objeto de destino no está pensado para combinarse (combinarse).
