...
---
# <a name="ms-wmi-simplepolicytemplate-class"></a>clase MS-WMI-SimplePolicyTemplate

Proporciona un tipo de plantilla que no se puede combinar. Se usa en los casos en los que el objeto de destino no está diseñado para combinarse (combinarse).
...
| Nombre para mostrar de LDAP | msWMI-SimplePolicyTemplate           |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 6cc8b2b5-12df-44f6-8307-e74f5cdee369 |
...
| Descriptor de seguridad predeterminado | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPCCDCLCLODTRC;;; ESTÉ |
...
| [**Autor de MS-WMI**](a-mswmi-author.md)                                     | False     | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
...
| [**IDENTIFICADOR de MS-WMI**](a-mswmi-id.md)                                             | True      | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
...
| [**Nombre MS-WMI**](a-mswmi-name.md)                                         | True      | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
