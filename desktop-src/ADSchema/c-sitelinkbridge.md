...
---
# <a name="site-link-bridge-class"></a>Clase de puente de vínculo de sitio

Objeto para realizar el seguimiento de los vínculos a sitios que están conectados de manera transitiva.



| Entrada | Value |
|-------------------|--------------------------------------------------------------------|
| CN                | Puente de vínculo de sitio                                                   |
| Nombre para mostrar de LDAP | siteLinkBridge                                                     |
| Actualizar privilegio  | Administrador de dominio                                               |
| Frecuencia de actualización  | Cada vez que es necesario agregar o quitar un vínculo a sitios del puente. |
| Identificador de esquema-GUID    | d50c2cdf-8951-11d1-aebc-0000f80367c1                               |
...
| [**Site-Link-List**](a-sitelinklist.md)                                  | True      | **Puente de vínculo de sitio**            |
