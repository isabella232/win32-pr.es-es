...
---
# <a name="file-link-tracking-entry-class"></a>Clase de entrada de seguimiento de vínculos de archivos

Contiene la información del GUID y del equipo actual para un archivo de seguimiento de vínculos.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Entrada de seguimiento de vínculos de archivos             |
| Nombre para mostrar de LDAP | fileLinkTrackingEntry                |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 8e4eb2ed-4712-11d0-a1a0-00c04fd930c9 |
