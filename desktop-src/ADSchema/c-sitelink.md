...
|-------------------|----------------------------------------------------|
| CN                | Site-Link                                          |
| Nombre para mostrar de LDAP | siteLink                                           |
| Actualizar privilegio  | Administrador de dominio                               |
| Frecuencia de actualización  | Cada vez que los sitios conectados a este vínculo cambian. |
| Identificador de esquema-GUID    | d50c2cde-8951-11d1-aebc-0000f80367c1               |
...
| [**Costos**](a-cost.md)                                                    | False     | **Sitio-vínculo**                   |
...
| [**Opciones**](a-options.md)                                              | False     | **Sitio-vínculo**                   |
...
| [**REPL-intervalo**](a-replinterval.md)                                   | False     | **Sitio-vínculo**                   |
...
| [**Planea**](a-schedule.md)                                            | False     | **Sitio-vínculo**                   |
...
| [**Lista de sitios**](a-sitelist.md)                                           | True      | **Sitio-vínculo**                   |
