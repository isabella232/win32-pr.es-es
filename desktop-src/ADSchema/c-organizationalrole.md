...
Esta clase se utiliza para los objetos que contienen información que pertenece a una posición o un rol dentro de una organización, como un administrador del sistema, administrador, etc. También se puede usar para una identidad no humana en una organización.
...
| Nombre para mostrar de LDAP | organizationalRole                   |
| Actualizar privilegio  | Cualquier usuario puede actualizar este objeto.       |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | a8df74bf-c5ea-11d1-bbcb-0080c76670c0 |
...
| [**Nombre común**](a-cn.md)                                               | True      | **Nivel de rol de la organización** [](c-top.md)<br/> |
...
| [**Indicador de destino**](a-destinationindicator.md)                   | False     | **Rol de la organización**                                 |
...
| [**Fax-número de teléfono**](a-facsimiletelephonenumber.md)          | False     | **Rol de la organización**                                 |
...
| [**International-ISDN (número)**](a-internationalisdnnumber.md)            | False     | **Rol de la organización**                                 |
...
| [**Localidad: nombre**](a-l.md)                                              | False     | **Rol de la organización**                                 |
...
| [**Nombre de unidad organizativa**](a-ou.md)                                  | False     | **Rol de la organización**                                 |
...
| [**-Delivery-Office-Name**](a-physicaldeliveryofficename.md)     | False     | **Rol de la organización**                                 |
| [**Posibles: inferiores**](a-possibleinferiors.md)                         | False     | [**Arriba**](c-top.md)<br/>                         |
| [**Dirección postal**](a-postaladdress.md)                                 | False     | **Rol de la organización**                                 |
| [**Código postal**](a-postalcode.md)                                       | False     | **Rol de la organización**                                 |
| [**Cuadro posterior a la oficina**](a-postofficebox.md)                                | False     | **Rol de la organización**                                 |
| [**Método de entrega preferido**](a-preferreddeliverymethod.md)            | False     | **Rol de la organización**                                 |
...
| [**Dirección registrada**](a-registeredaddress.md)                         | False     | **Rol de la organización**                                 |
...
| [**Rol-ocupante**](a-roleoccupant.md)                                   | False     | **Rol de la organización**                                 |
| [**SD-derechos-efectivos**](a-sdrightseffective.md)                        | False     | [**Arriba**](c-top.md)<br/>                         |
| [**Vea también**](a-seealso.md)                                             | False     | **Rol de la organización**                                 |
...
| [**Nombre de estado o provincia**](a-st.md)                                    | False     | **Rol de la organización**                                 |
| [**Dirección postal**](a-street.md)                                        | False     | **Rol de la organización**                                 |
...
| [**Número de teléfono**](a-telephonenumber.md)                             | False     | **Rol de la organización**                                 |
| [**Teletexto: identificador de terminal**](a-teletexterminalidentifier.md)        | False     | **Rol de la organización**                                 |
| [**Número de télex**](a-telexnumber.md)                                     | False     | **Rol de la organización**                                 |
...
| [**X121-Address**](a-x121address.md)                                     | False     | **Rol de la organización**                                 |
