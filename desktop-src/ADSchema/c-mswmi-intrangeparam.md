---
title: ms-WMI-IntRangeParam (clase)
description: Objeto de parámetro de intervalo entero con signo.
ms.assetid: cf777d5b-d674-4ccd-a7f5-0ae2c15d8daf
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-WMI-IntRangeParam
- Esquema de AD de la clase msWMI-IntRangeParam
topic_type:
- apiref
api_name:
...
ms.locfileid: "119643095"
---
# <a name="ms-wmi-intrangeparam-class"></a>ms-WMI-IntRangeParam (clase)

Objeto de parámetro de intervalo entero con signo.
...
| [**ms-WMI-intDefault**](a-mswmi-intdefault.md)                             | Verdadero      | **ms-WMI-IntRangeParam**                                   |
