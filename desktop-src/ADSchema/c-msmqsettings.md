...
---
# <a name="msmq-settings-class"></a>MSMQ-Settings (clase)

El propósito de estos objetos es habilitar la consulta rápida de los servidores de MSMQ en un sitio específico. Este objeto contiene información como los servicios de Message Queue Server que proporciona el servidor.
...
|-------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CN                | MSMQ-Settings                                                                                                                                                           |
| Nombre para mostrar de LDAP | mSMQSettings                                                                                                                                                            |
| Actualizar privilegio  | Propietario de la cola.                                                                                                                                                        |
| Frecuencia de actualización  | Este objeto se crea para cada servidor de Message Queue Server instalado en un controlador de dominio de Windows 2000 y para cada servidor de Message Queue Server con servicios de enrutamiento. |
| Identificador de esquema-GUID    | 9a0dc347-c100-11d1-bbc5-0080c76670c0                                                                                                                                    |
...
| Posibles superiores          | [**Server**](c-server.md)                                                                   |
| Clases auxiliares           | \-                                                                                           |
...
| [**Servicio de cliente dependiente de MSMQ**](a-msmqdependentclientservice.md)     | False     | **Configuración de MSMQ**               |
| [**Servicio MSMQ-DS-**](a-msmqdsservice.md)                                | False     | **Configuración de MSMQ**               |
| [**MSMQ: migrado**](a-msmqmigrated.md)                                   | False     | **Configuración de MSMQ**               |
| [**MSMQ-Nt4-marcas**](a-msmqnt4flags.md)                                  | False     | **Configuración de MSMQ**               |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                    | False     | **Configuración de MSMQ**               |
| [**MSMQ-QM-ID**](a-msmqqmid.md)                                          | False     | **Configuración de MSMQ**               |
| [**Servicio de enrutamiento de MSMQ**](a-msmqroutingservice.md)                      | False     | **Configuración de MSMQ**               |
| [**MSMQ-Services**](a-msmqservices.md)                                   | False     | **Configuración de MSMQ**               |
| [**Nombre de sitio de MSMQ**](a-msmqsitename.md)                                  | False     | **Configuración de MSMQ**               |
| [**MSMQ-Site-Name-ex**](a-msmqsitenameex.md)                             | False     | **Configuración de MSMQ**               |
