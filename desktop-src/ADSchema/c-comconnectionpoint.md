...
---
# <a name="com-connection-point-class"></a>Com: clase de punto de conexión
...
| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Com: punto de conexión                 |
| Nombre para mostrar de LDAP | comConnectionPoint                   |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | bf967a85-0de6-11d0-a285-00aa003049e2 |
...
| [**Nombre común**](a-cn.md)                                               | True      |  [ **Punto de conexión** de punto de conexión com](c-connectionpoint.md)<br/> [**Arriba**](c-top.md)<br/> |
...
| [**Serialización-interfaz**](a-marshalledinterface.md)                     | False     | **Com: punto de conexión**                                                                                          |
...
| [**Nike**](a-moniker.md)                                              | False     | **Com: punto de conexión**                                                                                          |
| [**Moniker-Display-Name**](a-monikerdisplayname.md)                      | False     | **Com: punto de conexión**                                                                                          |
