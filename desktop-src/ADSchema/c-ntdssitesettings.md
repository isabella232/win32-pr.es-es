...
---
# <a name="ntds-site-settings-class"></a>NTDS: clase de configuración de sitio
...
| Nombre para mostrar de LDAP | nTDSSiteSettings                     |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 19195a5d-6da0-11d0-afd3-00c04fd930c9 |
...
| Subclase de                 | [**Configuración del sitio de la aplicación**](c-applicationsitesettings.md)<br/>                    |
...
| [**Nombre de la aplicación**](a-applicationname.md)                             | False     | [**Configuración del sitio de la aplicación**](c-applicationsitesettings.md)<br/> |
...
| [**Entre sitios: topología: conmutación por error**](a-intersitetopologyfailover.md)       | False     | **NTDS-Site-Settings**                                                    |
| [**Inter-site-Topology-generator**](a-intersitetopologygenerator.md)     | False     | **NTDS-Site-Settings**                                                    |
| [**Entre sitios-topología: renovación**](a-intersitetopologyrenew.md)             | False     | **NTDS-Site-Settings**                                                    |
...
| [**Administrado: por**](a-managedby.md)                                         | False     | **NTDS-Site-Settings**                                                    |
...
| [**Lista de notificaciones**](a-notificationlist.md)                           | False     | [**Configuración del sitio de la aplicación**](c-applicationsitesettings.md)<br/> |
...
| [**Opciones**](a-options.md)                                              | False     | **NTDS-Site-Settings**                                                    |
...
| [**Query: objeto de Directiva**](a-querypolicyobject.md)                        | False     | **NTDS-Site-Settings**                                                    |
...
| [**Planea**](a-schedule.md)                                            | False     | **NTDS-Site-Settings**                                                    |
...
| [**MS-DS-preferido-GC-sitio**](a-msds-preferred-gc-site.md)                 | False     | **NTDS-Site-Settings**                                                    |
