...
keywords:
- Esquema de AD del atributo memberUid
topic_type:
- apiref
api_name:
- memberUid
...
Contiene los nombres de inicio de sesión de los miembros de un grupo.
...
| Clases usadas en        | [**posixGroup**](c-posixgroup.md)<br/> |
