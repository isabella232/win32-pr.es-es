...
---
# <a name="ms-com-partition-class"></a>clase MS-COM-Partition

Espacio de nombres que usa COM+ para permitir que existan varias versiones de la misma aplicación COM+ en el mismo equipo físico.
...
|-------------------|--------------------------------------|
| CN                | MS-COM-Partition                     |
| Nombre para mostrar de LDAP | msCOM-Partition                      |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | c9010e74-4e58-49f7-8a89-5e3e2340fcf8 |
