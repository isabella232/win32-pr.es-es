---
title: ms-COM-Partition (clase)
description: Espacio de nombres usado por COM+ para permitir que existan varias versiones de la misma aplicación COM+ en el mismo equipo físico.
ms.assetid: 84e7af24-0202-4ae8-a278-0f390ddadbb3
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-COM-Partition
- Esquema de AD de la clase msCOM-Partition
topic_type:
- apiref
api_name:
- ms-COM-Partition
...
ms.locfileid: "119643195"
---
# <a name="ms-com-partition-class"></a>ms-COM-Partition (clase)

Espacio de nombres usado por COM+ para permitir que existan varias versiones de la misma aplicación COM+ en el mismo equipo físico.
