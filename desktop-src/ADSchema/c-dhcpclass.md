...
Representa un servidor DHCP (o un conjunto de servidores).
...
|-------------------|--------------------------------------|
| CN                | DHCP-Class                           |
| Nombre para mostrar de LDAP | dHCPClass                            |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 963d2756-48be-11d1-a9c3-0000f80367c1 |
...
| [**Clases de DHCP**](a-dhcpclasses.md)                                     | False     | **Clase de DHCP**                  |
| [**DHCP-marcas**](a-dhcpflags.md)                                         | True      | **Clase de DHCP**                  |
| [**Identificación de DHCP**](a-dhcpidentification.md)                       | True      | **Clase de DHCP**                  |
| [**DHCP-máscara**](a-dhcpmask.md)                                           | False     | **Clase de DHCP**                  |
| [**DHCP-MaxKey**](a-dhcpmaxkey.md)                                       | False     | **Clase de DHCP**                  |
| [**DHCP-obj-Descripción**](a-dhcpobjdescription.md)                      | False     | **Clase de DHCP**                  |
| [**DHCP-obj-Name**](a-dhcpobjname.md)                                    | False     | **Clase de DHCP**                  |
| [**DHCP-opciones**](a-dhcpoptions.md)                                     | False     | **Clase de DHCP**                  |
| [**Propiedades de DHCP**](a-dhcpproperties.md)                               | False     | **Clase de DHCP**                  |
| [**Intervalos DHCP**](a-dhcpranges.md)                                       | False     | **Clase de DHCP**                  |
| [**DHCP-reservas**](a-dhcpreservations.md)                           | False     | **Clase de DHCP**                  |
| [**DHCP-servidores**](a-dhcpservers.md)                                     | False     | **Clase de DHCP**                  |
| [**DHCP-sitios**](a-dhcpsites.md)                                         | False     | **Clase de DHCP**                  |
| [**Estado de DHCP**](a-dhcpstate.md)                                         | False     | **Clase de DHCP**                  |
| [**DHCP-subredes**](a-dhcpsubnets.md)                                     | False     | **Clase de DHCP**                  |
| [**Tipo DHCP**](a-dhcptype.md)                                           | True      | **Clase de DHCP**                  |
| [**DHCP-clave única**](a-dhcpuniquekey.md)                                | True      | **Clase de DHCP**                  |
| [**DHCP-actualización-hora**](a-dhcpupdatetime.md)                              | False     | **Clase de DHCP**                  |
...
| [**Identificador de mscope**](a-mscopeid.md)                                           | False     | **Clase de DHCP**                  |
...
| [**Dirección de red**](a-networkaddress.md)                               | False     | **Clase de DHCP**                  |
...
| [**Opción-Descripción**](a-optiondescription.md)                         | False     | **Clase de DHCP**                  |
| [**Opciones-ubicación**](a-optionslocation.md)                             | False     | **Clase de DHCP**                  |
...
| [**Superámbito: Descripción**](a-superscopedescription.md)                | False     | **Clase de DHCP**                  |
| [**Superámbitos**](a-superscopes.md)                                     | False     | **Clase de DHCP**                  |
