...
---
# <a name="rpc-server-class"></a>RPC: clase de servidor

Representa un servidor determinado que contiene una o más interfaces RPC.
...
|-------------------|--------------------------------------|
| CN                | Servidor RPC                           |
| Nombre para mostrar de LDAP | rpcServer                            |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 88611be0-8cf4-11d0-afda-00c04fd930c9 |
...
| [**RPC-NS-CodeSet**](a-rpcnscodeset.md)                                  | False     | **Servidor RPC**                                                                           |
| [**RPC-ns-Entry-Flags**](a-rpcnsentryflags.md)                           | False     | **Servidor RPC**                                                                           |
| [**ID. de objeto de RPC-NS**](a-rpcnsobjectid.md)                               | False     | **Servidor RPC**                                                                           |
