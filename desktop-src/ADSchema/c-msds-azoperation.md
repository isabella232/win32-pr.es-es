...
---
# <a name="ms-ds-az-operation-class"></a>clase MS-DS-AZ-Operation

Describe una operación determinada que admite una aplicación.
...
| Nombre para mostrar de LDAP | msDS-AzOperation                        |
...
| Identificador de esquema-GUID    | 860abe37-9a9b-4fa4-b3d2-b8ace5df9ec5    |
...
| [**Descripción**](a-description.md)                                        | False     | **MS-DS-AZ-Operation** [ **Top**](c-top.md)<br/> |
