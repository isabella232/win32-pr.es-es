...
description: Se usa para publicar el certificado del agente de Recuperación de claves en el contenedor DEIR.
...
ms.locfileid: "119879805"
---
# <a name="ms-pki-private-key-recovery-agent-class"></a>clase ms-PKI-Private-Key-Recovery-Agent

Se usa para publicar el certificado del agente de Recuperación de claves en el contenedor DEIR.
...
| [**X509-Cert**](a-usercertificate.md)                                      | Verdadero      | **ms-PKI-Private-Key-Recovery-Agent** |
