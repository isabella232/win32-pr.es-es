...
Se usa para publicar el certificado de agente de recuperación de claves en el contenedor de KRA.
...
| Nombre para mostrar de LDAP | Atributo mspki-PrivateKeyRecoveryAgent        |
| Actualizar privilegio  | Administrador de dominio                 |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 1562a632-44b9-4a7e-a2d3-e426c96a3acc |
