...
---
# <a name="ipsec-filter-class"></a>Ipsec-Filter (clase)

Representa un filtro IPSec, que se utiliza para crear directivas de seguridad como las que bloquean los puertos y los protocolos.
...
|-------------------|--------------------------------------|
| CN                | Ipsec-Filter                         |
| Nombre para mostrar de LDAP | ipsecFilter                          |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | b40ff826-427a-11d1-a9c2-0000f80367c1 |
