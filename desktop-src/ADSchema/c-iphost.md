...
---
# <a name="iphost-class"></a>clase ipHost

Representa una abstracción de un host u otro dispositivo IP.
...
|-------------------|--------------------------------------|
| CN                | ipHost                               |
| Nombre para mostrar de LDAP | ipHost                               |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | ab911646-8827-4f95-8780-5a8f008eb68f |
...
| [**Nombre común**](a-cn.md)                                                 | False     | **ipHost** [ **superior**](c-top.md)<br/> |
| [**Creación: marca de tiempo**](a-createtimestamp.md)                              | False     | [**Arriba**](c-top.md)<br/>            |
| [**Descripción**](a-description.md)                                        | False     | **ipHost** [ **superior**](c-top.md)<br/> |
...
| [**Localidad: nombre**](a-l.md)                                                | False     | **ipHost**                                 |
