...
---
# <a name="crl-distribution-point-class"></a>CRL: clase de punto de distribución

Objeto que contiene listas de certificados, entidades y revocación de diferencias.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | CRL-punto de distribución               |
| Nombre para mostrar de LDAP | cRLDistributionPoint                 |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 167758ca-47f3-11d1-a9c3-0000f80367c1 |
...
| [**Autoridad-revocación-lista**](a-authorityrevocationlist.md)            | False     | **CRL-punto de distribución**                                 |
...
| [**Certificate-Authority-Object**](a-certificateauthorityobject.md)      | False     | **CRL-punto de distribución**                                 |
| [**Certificado-revocación-lista**](a-certificaterevocationlist.md)        | False     | **CRL-punto de distribución**                                 |
| [**Nombre común**](a-cn.md)                                               | True      | **CRL-distribución-punto** [ **superior**](c-top.md)<br/> |
| [**Creación: marca de tiempo**](a-createtimestamp.md)                            | False     | [**Arriba**](c-top.md)<br/>                            |
| [**CRL con particiones-lista de revocación**](a-crlpartitionedrevocationlist.md) | False     | **CRL-punto de distribución**                                 |
| [**Delta-revocación-lista**](a-deltarevocationlist.md)                    | False     | **CRL-punto de distribución**                                 |
