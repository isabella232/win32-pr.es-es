...
Contiene los límites administrativos para los recursos del servidor LDAP para los resultados ordenados y paginados.
...
|-------------------|--------------------------------------|
| CN                | Query-Policy                         |
| Nombre para mostrar de LDAP | queryPolicy                          |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 83cc7075-cca7-11d0-afff-0000f80367c1 |
...
| [**Límites de LDAP-admin-**](a-ldapadminlimits.md)                            | False     | **Directiva de consulta**                |
| [**LDAP-IPDeny-List**](a-ldapipdenylist.md)                              | False     | **Directiva de consulta**                |
