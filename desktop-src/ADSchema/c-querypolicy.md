...
description: Contiene límites administrativos para los recursos del servidor LDAP para los resultados ordenados y paginados.
ms.assetid: 3dc5cbf1-cace-4b6b-8bc7-6907ec089025
ms.tgt_platform: multiple
keywords:
- Query-Policy esquema de AD de clase
...
ms.locfileid: "119753035"
---
# <a name="query-policy-class"></a>Query-Policy clase

Contiene límites administrativos para los recursos del servidor LDAP para los resultados ordenados y paginados.
...
| [**Límites de ldap-admin**](a-ldapadminlimits.md)                            | Falso     | **Directiva de consulta**                |
| [**LDAP-IPDeny-List**](a-ldapipdenylist.md)                              | Falso     | **Directiva de consulta**                |
...
| [**Is-Privilege-Holder**](a-isprivilegeholder.md)                          | Falso     | [**Arriba**](c-top.md)<br/> |
| [**Último elemento primario conocido**](a-lastknownparent.md)                              | Falso     | [**Arriba**](c-top.md)<br/> |
| [**LDAP-Admin-Limits**](a-ldapadminlimits.md)                              | Falso     | **Directiva de consulta**                |
| [**LDAP-IPDeny-List**](a-ldapipdenylist.md)                                | Falso     | **Directiva de consulta**                |
| [**Objetos administrados**](a-managedobjects.md)                                 | Falso     | [**Arriba**](c-top.md)<br/> |
| [**Mastered-By**](a-masteredby.md)                                         | Falso     | [**Arriba**](c-top.md)<br/> |
