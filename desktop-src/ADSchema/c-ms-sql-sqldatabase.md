...
Clase para almacenar propiedades de SQL Server base de datos.
...
| Nombre para mostrar de LDAP | mS-SQL-SQLDatabase                   |
| Actualizar privilegio  | El sistema establece este valor.     |
| Frecuencia de actualización  | En el programa de instalación del sistema.                     |
| Identificador de esquema-GUID    | 1d08694a-ccef-11d2-9993-0000f87a57d4 |
...
| [**Alias MS-SQL**](a-ms-sql-alias.md)                                    | False     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-aplicaciones**](a-ms-sql-applications.md)                      | False     | **MS-SQL-SQLDatabase**          |
| [**Contacto de MS-SQL**](a-ms-sql-contact.md)                                | False     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-CreationDate**](a-ms-sql-creationdate.md)                      | False     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Descripción**](a-ms-sql-description.md)                        | False     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | False     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-palabras clave**](a-ms-sql-keywords.md)                              | False     | **MS-SQL-SQLDatabase**          |
...
| [**Nombre MS-SQL**](a-ms-sql-name.md)                                      | False     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-size**](a-ms-sql-size.md)                                      | False     | **MS-SQL-SQLDatabase**          |
| [**Estado de MS-SQL**](a-ms-sql-status.md)                                  | False     | **MS-SQL-SQLDatabase**          |
