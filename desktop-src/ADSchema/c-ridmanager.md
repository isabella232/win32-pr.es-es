...
Contiene el FSMO de RID y la ubicación del grupo de RID disponible utilizada por el administrador de RID. El administrador de RID es un componente que se ejecuta en el controlador de dominio responsable de la asignación de identificadores de seguridad.
...
|-------------------|-------------------------------------------|
| CN                | RID-Manager                               |
| Nombre para mostrar de LDAP | rIDManager                                |
| Actualizar privilegio  | El sistema establece este valor.          |
| Frecuencia de actualización  | Cada vez que cambia la asignación del grupo RID. |
| Identificador de esquema-GUID    | 6617188d-8f3c-11d0-afda-00c04fd930c9      |
...
| [**RID: Grupo de disponibilidad**](a-ridavailablepool.md)                          | True      | **Administrador de RID**                 |
...
| Nombre común                                      |
|--------------------------------------------------|
| [**Cambiar-RID-maestro**](r-change-rid-master.md) |
