...
description: Contiene el FSMO de RID y la ubicación del grupo disponible de RID que usa el administrador de RID. El administrador de RID es un componente que se ejecuta en el controlador de dominio y que es responsable de asignar identificadores de seguridad.
ms.assetid: 84af5d6d-a5a7-4288-a9eb-0eaaf0c23063
ms.tgt_platform: multiple
keywords:
- RID-Manager esquema de AD de clase
...
ms.locfileid: "118959574"
---
# <a name="rid-manager-class"></a>RID-Manager clase

Contiene el FSMO de RID y la ubicación del grupo disponible de RID que usa el administrador de RID. El administrador de RID es un componente que se ejecuta en el controlador de dominio y que es responsable de asignar identificadores de seguridad.
...
| Frecuencia de actualización  | Cada vez que cambia la asignación del grupo de RID. |
...
| [**Rid-Available-Pool**](a-ridavailablepool.md)                          | Verdadero      | **Rid-Manager**                 |
...
| Clases auxiliares           | \-                                                                                                              |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                                    |
| Descriptor de seguridad predeterminado | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU)S:(AU;SA; CRWP;;; WD) |
| System-Flags                | 0x00000010                                                                                                      |
