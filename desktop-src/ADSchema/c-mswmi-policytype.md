---
title: ms-WMI-PolicyType (clase)
description: Comunicar esquema para objetos de directiva.
ms.assetid: cf89a4cb-cf42-4f80-b16e-8c958eafb5ae
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-WMI-PolicyType
- Esquema de AD de la clase msWMI-PolicyType
topic_type:
- apiref
api_name:
- ms-WMI-PolicyType
...
ms.locfileid: "118422216"
---
# <a name="ms-wmi-policytype-class"></a>ms-WMI-PolicyType (clase)

Comunicar esquema para objetos de directiva.
...
| [**ms-WMI-ID**](a-mswmi-id.md)                                             | Verdadero      | **ms-WMI-PolicyType**           |
...
| [**ms-WMI-TargetObject**](a-mswmi-targetobject.md)                         | Verdadero      | **ms-WMI-PolicyType**           |
