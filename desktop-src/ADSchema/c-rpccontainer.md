...
Contenedor predeterminado para los extremos de RPC.
...
|-------------------|--------------------------------------|
| CN                | Rpc-Container                        |
| Nombre para mostrar de LDAP | rpcContainer                         |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 80212842-4bdc-11d1-a9c4-0000f80367c1 |
...
| [**Marcas de servicio de nombre**](a-nameserviceflags.md)                          | False     | **Contenedor RPC**                                                           |
