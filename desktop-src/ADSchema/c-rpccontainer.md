...
description: Contenedor predeterminado para puntos de conexión RPC.
ms.assetid: 23cbe050-8812-4bba-85de-249ccd594780
ms.tgt_platform: multiple
keywords:
- Rpc-Container esquema de AD de clase
- RpcContainer class AD Schema
topic_type:
- apiref
api_name:
- Rpc-Container
...
ms.locfileid: "118959564"
---
# <a name="rpc-container-class"></a>Rpc-Container clase

Contenedor predeterminado para puntos de conexión RPC.
