...
---
# <a name="frs-working-path-attribute"></a>FRS: atributo de ruta de acceso de trabajo

La ruta de acceso a la base de datos de replicación de archivos.
...
|-------------------|---------------------------------------------|
| CN                | FRS-Working-path                            |
| Nombre para mostrar de LDAP | fRSWorkingPath                              |
| Tamaño              | \-                                          |
