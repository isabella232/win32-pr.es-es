---
title: ms-DS-Password-Configuración class
description: Objeto de configuración de contraseña para cuentas.
ms.assetid: 4e3a5a80-4f55-4c26-b5af-ace9dd853836
ms.tgt_platform: multiple
keywords:
- ms-DS-Password-Configuración esquema de AD
...
ms.locfileid: "118959784"
---
# <a name="ms-ds-password-settings-class"></a>ms-DS-Password-Configuración class

Objeto de configuración de contraseña para cuentas.

> [!Note]  
> Este objeto classSchema se crea con una lista de ID de systemMustContain. Se trata de una lista de atributos que un objeto Configuración contraseña (PSO) debe contener o, de lo contrario, se producirá un error en la creación del PSO.
...
| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | ms-DS-Password-Configuración              |
...
| Posibles superiores          | [**ms-DS-Password-Configuración-Container**](c-msds-passwordsettingscontainer.md) |
| Clases auxiliares           | \-                                                                            |
...
| [**ms-DS-Lockout-Duration**](a-msds-lockoutduration.md)                                           | Verdadero      | **ms-DS-Password-Configuración**     |
| [**ms-DS-Lockout-Observation-Window**](a-msds-lockoutobservationwindow.md)                        | Verdadero      | **ms-DS-Password-Configuración**     |
| [**ms-DS-Lockout-Threshold**](a-msds-lockoutthreshold.md)                                         | Verdadero      | **ms-DS-Password-Configuración**     |
| [**ms-DS-Mastered-By**](a-msds-masteredby.md)                                                     | Falso     | [**Arriba**](c-top.md)<br/> |
| [**ms-DS-Maximum-Password-Age**](a-msds-maximumpasswordage.md)                                    | Verdadero      | **ms-DS-Password-Configuración**     |
| [**ms-DS-Members-For-Az-Role-BL**](a-msds-membersforazrolebl.md)                                  | Falso     | [**Arriba**](c-top.md)<br/> |
| [**ms-DS-Minimum-Password-Age**](a-msds-minimumpasswordage.md)                                    | Verdadero      | **ms-DS-Password-Configuración**     |
| [**ms-DS-Minimum-Password-Length**](a-msds-minimumpasswordlength.md)                              | Verdadero      | **ms-DS-Password-Configuración**     |
...
| [**ms-DS-Password-Complexity-Enabled**](a-msds-passwordcomplexityenabled.md)                      | Verdadero      | **ms-DS-Password-Configuración**     |
| [**ms-DS-Password-History-Length**](a-msds-passwordhistorylength.md)                              | Verdadero      | **ms-DS-Password-Configuración**     |
| [**ms-DS-Password-Reversible-Encryption-Enabled**](a-msds-passwordreversibleencryptionenabled.md) | Verdadero      | **ms-DS-Password-Configuración**     |
| [**ms-DS-Password-Configuración-Precedence**](a-msds-passwordsettingsprecedence.md)                    | Verdadero      | **ms-DS-Password-Configuración**     |
...
| [**ms-DS-PSO-Applies-To**](a-msds-psoappliesto.md)                                                | Falso     | **ms-DS-Password-Configuración**     |
