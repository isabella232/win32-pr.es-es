...
---
# <a name="ms-ds-password-settings-class"></a>clase MS-DS-password-Settings

Objeto de configuración de contraseña para las cuentas.

> [!Note]  
> Este objeto classSchema se crea con una lista de OID de systemMustContain. Esta es una lista de atributos que debe contener un objeto de configuración de contraseña (PSO) o, de lo contrario, se producirá un error en la creación del PSO.
...
| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Configuración de MS-DS-Password              |
| Nombre para mostrar de LDAP | msDS-PasswordSettings                |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 3bcd9db8-f84b-451c-952f-6c52b81f9ec6 |
...
| Posibles superiores          | [**MS-DS-password-Settings-Container**](c-msds-passwordsettingscontainer.md) |
| Clases auxiliares           | \-                                                                            |
| Descriptor de NT-Security-      | O:BAG: BAD: S:                                                                  |
| Descriptor de seguridad predeterminado | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY    |
...
| [**MS-DS-bloqueo-duración**](a-msds-lockoutduration.md)                                           | True      | **Configuración de MS-DS-Password**     |
| [**MS-DS-bloqueo-observación-Window**](a-msds-lockoutobservationwindow.md)                        | True      | **Configuración de MS-DS-Password**     |
| [**MS-DS-bloqueos-umbral**](a-msds-lockoutthreshold.md)                                         | True      | **Configuración de MS-DS-Password**     |
| [**MS-DS-MASTERD-by**](a-msds-masteredby.md)                                                     | False     | [**Arriba**](c-top.md)<br/> |
| [**MS-DS-Maximum-password-Age**](a-msds-maximumpasswordage.md)                                    | True      | **Configuración de MS-DS-Password**     |
| [**MS-DS-Members-for-AZ-role-BL**](a-msds-membersforazrolebl.md)                                  | False     | [**Arriba**](c-top.md)<br/> |
| [**MS-DS-mínimo-contraseña-Age**](a-msds-minimumpasswordage.md)                                    | True      | **Configuración de MS-DS-Password**     |
| [**MS-DS-longitud mínima de la contraseña**](a-msds-minimumpasswordlength.md)                              | True      | **Configuración de MS-DS-Password**     |
...
| [**MS-DS-contraseña-complejidad habilitada**](a-msds-passwordcomplexityenabled.md)                      | True      | **Configuración de MS-DS-Password**     |
| [**MS-DS-password-History-longitud**](a-msds-passwordhistorylength.md)                              | True      | **Configuración de MS-DS-Password**     |
| [**MS-DS-contraseña-reversible habilitado para cifrado**](a-msds-passwordreversibleencryptionenabled.md) | True      | **Configuración de MS-DS-Password**     |
| [**MS-DS-password-Settings-precedencia**](a-msds-passwordsettingsprecedence.md)                    | True      | **Configuración de MS-DS-Password**     |
...
| [**MS-DS-PSO-aplicable a**](a-msds-psoappliesto.md)                                                | False     | **Configuración de MS-DS-Password**     |
