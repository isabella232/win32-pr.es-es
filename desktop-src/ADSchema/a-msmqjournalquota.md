...
---
# <a name="msmq-journal-quota-attribute"></a>Atributo de cuota MSMQ-Journal-

Cuota de mensajes del diario de MSMQ del equipo.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Cuota de MSMQ-Journal                   |
| Nombre para mostrar de LDAP | mSMQJournalQuota                     |
| Tamaño              | \-                                   |
