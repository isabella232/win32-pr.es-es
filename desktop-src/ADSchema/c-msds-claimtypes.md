...
---
# <a name="ms-ds-claim-types-class"></a>clase MS-DS-Claim-Types

Un contenedor de esta clase puede contener objetos de tipo de demanda.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Tipos de notificaciones de MS-DS                    |
| Nombre para mostrar de LDAP | msDS-argumentos ClaimType                      |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 36093235-C715-4821-ab6a-b56fb2805a58 |
