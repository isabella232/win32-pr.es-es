---
title: ms-DS-Claim-Types (Clase)
description: Un contenedor de esta clase puede contener objetos de tipo de notificación.
ms.assetid: ce140ede-915f-40e0-8ea7-243573477a10
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-DS-Claim-Types
- Esquema de AD de la clase msDS-ClaimTypes
topic_type:
- apiref
api_name:
- ms-DS-Claim-Types
...
ms.locfileid: "118422780"
---
# <a name="ms-ds-claim-types-class"></a>ms-DS-Claim-Types (Clase)

Un contenedor de esta clase puede contener objetos de tipo de notificación.
