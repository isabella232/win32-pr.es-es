...
---
# <a name="locality-class"></a>Clase localidad
...
|-------------------|--------------------------------------------------------------------------|
| CN                | Localidad                                                                 |
| Nombre para mostrar de LDAP | situación                                                                 |
| Actualizar privilegio  | Este valor lo establece el administrador de dominio o el propietario de la cuenta.          |
| Frecuencia de actualización  | Cuando se crea un registro de usuario y cada vez que es necesario cambiar el emplazamiento. |
| Identificador de esquema-GUID    | bf967aa0-0de6-11d0-a285-00aa003049e2                                     |
...
| RDN-ATT-ID                  | [**Localidad: nombre**](a-l.md)<br/>                                                                                           |
| Subclase de                 | [**Arriba**](c-top.md)<br/>                                                                                                   |
| Posibles superiores          | **Localidad**[**organización**](c-organization.md)[**de la organización: país de la unidad**](c-organizationalunit.md)[](c-country.md) |
| Clases auxiliares           | \-                                                                                                                                |
...
| [**Localidad: nombre**](a-l.md)                                              | True      | **Localidad**                    |
...
| [**Guía de búsqueda**](a-searchguide.md)                                     | False     | **Localidad**                    |
| [**Vea también**](a-seealso.md)                                             | False     | **Localidad**                    |
...
| [**Nombre de estado o provincia**](a-st.md)                                    | False     | **Localidad**                    |
| [**Dirección postal**](a-street.md)                                        | False     | **Localidad**                    |
...
| RDN-ATT-ID                  | [**Localidad: nombre**](a-l.md)<br/>                                                                                                                            |
| Subclase de                 | [**Arriba**](c-top.md)<br/>                                                                                                                                    |
| Posibles superiores          | **Localidad**[**organización**](c-organization.md)[**de la organización-**](c-organizationalunit.md)dominio de [**país**](c-country.md)de la unidad [**-DNS**](c-domaindns.md) |
| Clases auxiliares           | \-                                                                                                                                                                 |
| Descriptor de NT-Security-      | O:BAG: BAD: S:                                                                                                                                                       |
| Descriptor de seguridad predeterminado | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; ESTÉ                                                                       |
| System-Flags                | 0x00000010                                                                                                                                                         |
