...
---
# <a name="create-wizard-ext-attribute"></a>Create-Wizard: atributo ext

GUID de las extensiones de Asistente para crear el objeto asociado.



| Entrada | Value |
|-------------------|---------------------------------------------|
| CN                | Asistente para crear: ext                           |
| Nombre para mostrar de LDAP | createWizardExt                             |
| Tamaño              | \-                                          |
