...
---
# <a name="rpc-server-element-class"></a>clase de elemento RPC-Server

Representa una interfaz única en un servidor RPC determinado.
...
| Nombre para mostrar de LDAP | rpcServerElement                     |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | f29653d0-7ad0-11d0-afd6-00c04fd930c9 |
...
| Posibles superiores          | [**Servidor RPC**](c-rpcserver.md)                                                            |
| Clases auxiliares           | \-                                                                                           |
...
| [**Enlaces de RPC-NS**](a-rpcnsbindings.md)                                | True      | **Elemento RPC-Server-**                                                                   |
| [**IDENTIFICADOR de la interfaz de RPC-NS**](a-rpcnsinterfaceid.md)                         | True      | **Elemento RPC-Server-**                                                                   |
| [**Sintaxis de RPC-NS-Transfer-**](a-rpcnstransfersyntax.md)                   | True      | **Elemento RPC-Server-**                                                                   |
