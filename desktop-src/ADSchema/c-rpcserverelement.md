---
title: rpc-Server-Element (clase)
description: Representa una sola interfaz en un servidor RPC determinado.
ms.assetid: b438e428-b727-4e36-b7a5-eb021f9a2afe
ms.tgt_platform: multiple
keywords:
- Rpc-Server-Element Class AD Schema
- RpcServerElement class AD Schema (Esquema de AD de clase rpcServerElement)
topic_type:
- apiref
api_name:
- rpc-Server-Element
...
ms.locfileid: "120005375"
---
# <a name="rpc-server-element-class"></a>rpc-Server-Element (clase)

Representa una sola interfaz en un servidor RPC determinado.
...
| Subclase de                 | [**rpc-Entry**](c-rpcentry.md)<br/>                                                   |
| Posibles superiores          | [**rpc-Server**](c-rpcserver.md)                                                            |
| Clases auxiliares           | \-                                                                                           |
...
| [**rpc-Ns-Bindings**](a-rpcnsbindings.md)                                | Verdadero      | **rpc-Server-Element**                                                                   |
| [**rpc-Ns-Interface-ID**](a-rpcnsinterfaceid.md)                         | Verdadero      | **rpc-Server-Element**                                                                   |
| [**rpc-Ns-Transfer-Syntax**](a-rpcnstransfersyntax.md)                   | Verdadero      | **rpc-Server-Element**                                                                   |
