...
description: Este objeto representa el maestro de infraestructura para un dominio.
ms.assetid: ac994ee1-1420-496c-b834-d1028483bfbb
ms.tgt_platform: multiple
keywords:
- Infrastructure-Update esquema de AD de clase
...
ms.locfileid: "119324495"
---
# <a name="infrastructure-update-class"></a>Infrastructure-Update clase

Este objeto representa el maestro de infraestructura para un dominio.
...
| Posibles superiores          | [**Infraestructura de**](c-domain.md)**dominio: actualización** |
| Clases auxiliares           | \-                                                  |
...
| [**DN-Reference-Update**](a-dnreferenceupdate.md)                        | Falso     | **Actualización de infraestructura**       |
...
| Rdn-Att-Id                  | [**Common-Name**](a-cn.md)<br/>              |
| Subclase de                 | [**Arriba**](c-top.md)<br/>                     |
| Posibles superiores          | [**Domain**](c-domain.md)**Infrastructure-Update** |
| Clases auxiliares           | \-                                                  |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                        |
| Descriptor de seguridad predeterminado | D:(A;; GA;;; SY)                                      |
| System-Flags                | 0x00000010                                          |
