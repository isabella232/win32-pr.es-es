...
---
# <a name="ms-wmi-som-class"></a>clase MS-WMI-SOM

Refina el ámbito de administración de un objeto de directiva de grupo. Agrega una lista de reglas, expresadas como consultas WQL que se ejecutan en el equipo de destino. Todas las consultas deben devolver resultados para que este SOM sea aplicable al destino.
...
|-------------------|--------------------------------------|
| CN                | MS-WMI-SOM                           |
| Nombre para mostrar de LDAP | msWMI-SOM                            |
| Actualizar privilegio  | Administrador de directiva de grupo           |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | ab857078-0142-4406-945b-34c9b6b13372 |
...
| [**Autor de MS-WMI**](a-mswmi-author.md)                                     | False     | **MS-WMI-SOM**                  |
| [**MS-WMI-ChangeDate**](a-mswmi-changedate.md)                             | False     | **MS-WMI-SOM**                  |
| [**MS-WMI-CreationDate**](a-mswmi-creationdate.md)                         | False     | **MS-WMI-SOM**                  |
| [**IDENTIFICADOR de MS-WMI**](a-mswmi-id.md)                                             | True      | **MS-WMI-SOM**                  |
| [**MS-WMI-intFlags1**](a-mswmi-intflags1.md)                               | False     | **MS-WMI-SOM**                  |
| [**MS-WMI-intFlags2**](a-mswmi-intflags2.md)                               | False     | **MS-WMI-SOM**                  |
| [**MS-WMI-intFlags3**](a-mswmi-intflags3.md)                               | False     | **MS-WMI-SOM**                  |
| [**MS-WMI-intFlags4**](a-mswmi-intflags4.md)                               | False     | **MS-WMI-SOM**                  |
| [**Nombre MS-WMI**](a-mswmi-name.md)                                         | True      | **MS-WMI-SOM**                  |
| [**MS-WMI-Parm1**](a-mswmi-parm1.md)                                       | False     | **MS-WMI-SOM**                  |
| [**MS-WMI-Parm2**](a-mswmi-parm2.md)                                       | False     | **MS-WMI-SOM**                  |
| [**MS-WMI-Parm3**](a-mswmi-parm3.md)                                       | False     | **MS-WMI-SOM**                  |
| [**MS-WMI-Parm4**](a-mswmi-parm4.md)                                       | False     | **MS-WMI-SOM**                  |
| [**MS-WMI-SourceOrganization**](a-mswmi-sourceorganization.md)             | False     | **MS-WMI-SOM**                  |
