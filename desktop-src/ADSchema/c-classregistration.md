...
description: Información de registro de un objeto COM.
ms.assetid: 49d00276-6e20-4cc8-9fc0-af8ac80f7f14
ms.tgt_platform: multiple
keywords:
- Class-Registration esquema de AD de la clase
- ClassRegistration (clase) Esquema de AD
topic_type:
- apiref
api_name:
- Class-Registration
...
ms.locfileid: "119643835"
---
# <a name="class-registration-class"></a>Class-Registration clase

Información de registro de un objeto COM.
...
| [**COM-CLSID**](a-comclsid.md)                                           | Falso     | **Registro de clases**          |
| [**COM-InterfaceID**](a-cominterfaceid.md)                               | Falso     | **Registro de clases**          |
| [**Common-Name**](a-cn.md)                                               | Falso     | [**Arriba**](c-top.md)<br/> |
| [**COM-Other-Prog-Id**](a-comotherprogid.md)                             | Falso     | **Registro de clases**          |
| [**COM-ProgID**](a-comprogid.md)                                         | Falso     | **Registro de clases**          |
| [**COM-Treat-As-Class-Id**](a-comtreatasclassid.md)                      | Falso     | **Registro de clases**          |
...
| [**Categorías implementadas**](a-implementedcategories.md)                 | Falso     | **Registro de clases**          |
...
| [**Administrado por**](a-managedby.md)                                         | Falso     | **Registro de clases**          |
...
| [**Categorías obligatorias**](a-requiredcategories.md)                       | Falso     | **Registro de clases**          |
