---
title: clase ms-DS-Password-Configuración-Container
description: Contenedor para objetos de configuración de contraseña.
ms.assetid: 45e55a1d-63a9-41e5-ac54-3ed467251d3d
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-DS-Password-Configuración-Container
...
ms.locfileid: "119879945"
---
# <a name="ms-ds-password-settings-container-class"></a>clase ms-DS-Password-Configuración-Container

Contenedor para objetos de configuración de contraseña.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | ms-DS-Password-Configuración-Container    |
