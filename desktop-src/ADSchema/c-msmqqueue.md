...
---
# <a name="msmq-queue-class"></a>MSMQ-Queue (clase)

Los usuarios de MSMQ crean colas (mediante MMC o la API de MSMQ) de acuerdo con sus requisitos. Una cola está asociada a un equipo específico y se coloca debajo del MSMQ-Configuration de ese equipo. No hay ningún límite en el número de colas por equipo.
...
|-------------------|--------------------------------------|
| CN                | MSMQ-Queue                           |
| Nombre para mostrar de LDAP | mSMQQueue                            |
| Actualizar privilegio  | Propietario de la cola.                     |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 9a0dc343-c100-11d1-bbc5-0080c76670c0 |
...
| Posibles superiores          | [**MSMQ-configuración**](c-msmqconfiguration.md)                                            |
| Clases auxiliares           | \-                                                                                           |
...
| [**MSMQ-autenticar**](a-msmqauthenticate.md)                           | False     | **MSMQ-cola**                  |
| [**MSMQ-base-prioridad**](a-msmqbasepriority.md)                          | False     | **MSMQ-cola**                  |
| [**MSMQ-diario**](a-msmqjournal.md)                                     | False     | **MSMQ-cola**                  |
| [**MSMQ-etiqueta**](a-msmqlabel.md)                                         | False     | **MSMQ-cola**                  |
| [**MSMQ-etiqueta-ex**](a-msmqlabelex.md)                                    | False     | **MSMQ-cola**                  |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                    | False     | **MSMQ-cola**                  |
| [**MSMQ-nivel de privacidad**](a-msmqprivacylevel.md)                          | False     | **MSMQ-cola**                  |
| [**MSMQ-cola-diario-cuota**](a-msmqqueuejournalquota.md)               | False     | **MSMQ-cola**                  |
| [**Nombre de la cola MSMQ: ext**](a-msmqqueuenameext.md)                         | False     | **MSMQ-cola**                  |
| [**MSMQ-Queue-quota**](a-msmqqueuequota.md)                              | False     | **MSMQ-cola**                  |
| [**MSMQ-cola-tipo**](a-msmqqueuetype.md)                                | False     | **MSMQ-cola**                  |
| [**MSMQ-transaccional**](a-msmqtransactional.md)                         | False     | **MSMQ-cola**                  |
...
| Nombre común                                            |
|--------------------------------------------------------|
| [**MSMQ: recepción**](r-msmq-receive.md)                 |
| [**MSMQ-PEEK**](r-msmq-peek.md)                       |
| [**MSMQ-enviar**](r-msmq-send.md)                       |
...
| [**MSMQ-etiqueta**](a-msmqlabel.md)                                           | False     | **MSMQ-cola**                  |
| [**MSMQ-etiqueta-ex**](a-msmqlabelex.md)                                      | False     | **MSMQ-cola**                  |
| [**MSMQ-multidifusión-dirección**](a-msmq-multicastaddress.md)                   | False     | **MSMQ-cola**                  |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                      | False     | **MSMQ-cola**                  |
| [**MSMQ-nivel de privacidad**](a-msmqprivacylevel.md)                            | False     | **MSMQ-cola**                  |
| [**MSMQ-cola-diario-cuota**](a-msmqqueuejournalquota.md)                 | False     | **MSMQ-cola**                  |
| [**Nombre de la cola MSMQ: ext**](a-msmqqueuenameext.md)                           | False     | **MSMQ-cola**                  |
| [**MSMQ-Queue-quota**](a-msmqqueuequota.md)                                | False     | **MSMQ-cola**                  |
| [**MSMQ-cola-tipo**](a-msmqqueuetype.md)                                  | False     | **MSMQ-cola**                  |
| [**Código fuente de MSMQ protegido**](a-msmq-securedsource.md)                         | False     | **MSMQ-cola**                  |
| [**MSMQ-transaccional**](a-msmqtransactional.md)                           | False     | **MSMQ-cola**                  |
| [**netboot-SCP-BL**](a-netbootscpbl.md)                                    | False     | [**Arriba**](c-top.md)<br/> |
| [**Miembro no de seguridad-BL**](a-nonsecuritymemberbl.md)                     | False     | [**Arriba**](c-top.md)<br/> |
| [**Descriptor de NT-Security-**](a-ntsecuritydescriptor.md)                    | True      | [**Arriba**](c-top.md)<br/> |
