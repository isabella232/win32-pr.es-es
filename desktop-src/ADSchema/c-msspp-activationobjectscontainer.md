---
title: clase ms-SPP-Activation-Objects-Container
description: Contenedor para objetos de activación usados por la Active Directory basada en la activación
ms.assetid: 3e43b439-91aa-4bdf-b1af-96d908c9a3eb
ms.tgt_platform: multiple
keywords:
- ms-SPP-Activation-Objects-Container class AD Schema
- Esquema de AD de la clase msSPP-ActivationObjectsContainer
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879405"
---
# <a name="ms-spp-activation-objects-container-class"></a>clase ms-SPP-Activation-Objects-Container

Contenedor para objetos de activación usados por la Active Directory basada en la activación
