...
Esta clase se utiliza para un objeto de servicios NTDS, que contiene información sobre la configuración del bosque del servicio de directorio. Este objeto se mantiene en el CN = Directory Service, CN = Windows NT, CN = Services, CN = Configuration,... contenedor.
...
|-------------------|--------------------------------------|
| CN                | NTDS-Service                         |
| Nombre para mostrar de LDAP | nTDSService                          |
| Actualizar privilegio  | Administrador de empresa             |
| Frecuencia de actualización  | Casi nunca.                        |
| Identificador de esquema-GUID    | 19195a5f-6da0-11d0-afd3-00c04fd930c9 |
...
| [**Heurística de DS**](a-dsheuristics.md)                                   | False     | **NTDS-servicio**                |
...
| [**Tiempo de intercalación de elementos no utilizados**](a-garbagecollperiod.md)                        | False     | **NTDS-servicio**                |
...
| [**REPL-topología-permanencia de ejecución**](a-repltopologystayofexecution.md)  | False     | **NTDS-servicio**                |
...
| [**SPN: asignaciones**](a-spnmappings.md)                                     | False     | **NTDS-servicio**                |
...
| [**Desecho: duración**](a-tombstonelifetime.md)                         | False     | **NTDS-servicio**                |
...
| [**MS-DS-Other-Settings**](a-msds-other-settings.md)                       | False     | **NTDS-servicio**                |
...
| [**MS-DS-Consistency-Child-Count**](a-ms-ds-consistencychildcount.md)           | False     | [**Arriba**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                        | False     | [**Arriba**](c-top.md)<br/> |
| [**MS-DS-Deleted-Object-Lifetime**](a-msds-deletedobjectlifetime.md)            | False     | **NTDS-servicio**                |
