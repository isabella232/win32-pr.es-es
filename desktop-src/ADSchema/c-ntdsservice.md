...
description: Esta clase se usa para un objeto de servicios NTDS, que contiene información sobre la configuración del bosque del servicio de directorio. Este objeto se mantiene en el servicio de directorio CN,CN Windows NT,CN Services,CN Configuration,... Contenedor.
ms.assetid: 55f94e25-3871-4946-9a7e-073bec0abce5
ms.tgt_platform: multiple
keywords:
- NTDS-Service esquema de AD de clase
...
ms.locfileid: "119753455"
---
# <a name="ntds-service-class"></a>NTDS-Service clase

Esta clase se usa para un objeto de servicios NTDS, que contiene información sobre la configuración del bosque del servicio de directorio. Este objeto se mantiene en CN=Directory Service,CN=Windows NT,CN=Services,CN=Configuration,... Contenedor.
...
| [**Heurística de DS**](a-dsheuristics.md)                                   | Falso     | **NTDS-Service**                |
...
| [**Período de intercalación de elementos no utilizados**](a-garbagecollperiod.md)                        | Falso     | **NTDS-Service**                |
...
| [**Asignaciones de SPN**](a-spnmappings.md)                                     | Falso     | **NTDS-Service**                |
...
| [**Vigencia de los objetos de desecho**](a-tombstonelifetime.md)                         | Falso     | **NTDS-Service**                |
...
| [**ms-DS-Other-Configuración**](a-msds-other-settings.md)                       | Falso     | **NTDS-Service**                |
