...
---
# <a name="type-library-class"></a>Type-Library (clase)

Esta clase contiene información sobre una biblioteca de tipos.
...
|-------------------|--------------------------------------|
| CN                | Type-Library                         |
| Nombre para mostrar de LDAP | Biblioteca                          |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 281416e2-1968-11d0-a28f-00aa003049e2 |
...
| [**COM-ClassID**](a-comclassid.md)                                       | False     | **Biblioteca de tipos**                |
| [**COM-InterfaceID**](a-cominterfaceid.md)                               | False     | **Biblioteca de tipos**                |
| [**Nombre común**](a-cn.md)                                               | False     | [**Arriba**](c-top.md)<br/> |
| [**IDENTIFICADOR único de COM**](a-comuniquelibid.md)                              | False     | **Biblioteca de tipos**                |
