...
---
# <a name="rras-administration-connection-point-class"></a>RRAS-Administration-Connection-Class (clase)
...
| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | RRAS-administración-punto de conexión |
| Nombre para mostrar de LDAP | rRASAdministrationConnectionPoint    |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 2a39c5be-8960-11d1-aebc-0000f80367c1 |
...
| [**Atributo MS-RRAS-**](a-msrrasattribute.md)                            | False     | **RRAS-administración-punto de conexión**                                                 |
