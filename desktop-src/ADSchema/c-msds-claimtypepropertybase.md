---
title: clase ms-DS-Claim-Type-Property-Base
description: Clase abstracta que define la clase base para las clases de propiedad de recurso o tipo de notificación.
...
ms.locfileid: "118422790"
---
# <a name="ms-ds-claim-type-property-base-class"></a>clase ms-DS-Claim-Type-Property-Base

Clase abstracta que define la clase base para las clases de propiedad de recurso o tipo de notificación.
