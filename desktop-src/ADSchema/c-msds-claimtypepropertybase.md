...
---
# <a name="ms-ds-claim-type-property-base-class"></a>MS-DS-Claim-Type-Property-clase base

Una clase abstracta que define la clase base para el tipo de demanda o las clases de propiedad de recurso.
...
| Nombre para mostrar de LDAP | msDS-ClaimTypePropertyBase           |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | b8442f58-c490-4487-8a9d-d80b883271ad |
...
| [**habilitado**](a-enabled.md)                                                                 | False     | **MS-DS-Claim-Type-Property-base** |
...
| [**MS-DS-Claim-posibles-Values**](a-msds-claimpossiblevalues.md)                            | False     | **MS-DS-Claim-Type-Property-base** |
| [**MS-DS-Claim-shares-posibles-Values-with**](a-msds-claimsharespossiblevalueswith.md)      | False     | **MS-DS-Claim-Type-Property-base** |
