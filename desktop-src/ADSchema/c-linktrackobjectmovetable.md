...
Contenedor de objetos de entrada de vínculo-seguimiento-OMT.
...
| Nombre para mostrar de LDAP | linkTrackObjectMoveTable             |
| Actualizar privilegio  | El sistema establece este valor.     |
| Frecuencia de actualización  | Cada vez que cambia un vínculo a un archivo.   |
| Identificador de esquema-GUID    | ddac0cf5-af8f-11d0-afeb-00c04fd930c9 |
