...
---
# <a name="rpc-profile-element-class"></a>clase de elemento de Perfil de RPC

Contiene una entrada en un perfil de RPC.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Elemento de Perfil de RPC                  |
| Nombre para mostrar de LDAP | rpcProfileElement                    |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | f29653cf-7ad0-11d0-afd6-00c04fd930c9 |
...
| Subclase de                 | [**Entrada RPC**](c-rpcentry.md)<br/>                                                   |
| Posibles superiores          | [**Perfil de RPC**](c-rpcprofile.md)                                                          |
| Clases auxiliares           | \-                                                                                           |
...
| [**anotación de RPC-NS**](a-rpcnsannotation.md)                            | False     | **Elemento de Perfil de RPC**                                                                  |
| [**IDENTIFICADOR de la interfaz de RPC-NS**](a-rpcnsinterfaceid.md)                         | True      | **Elemento de Perfil de RPC**                                                                  |
| [**RPC-NS-prioridad**](a-rpcnspriority.md)                                | True      | **Elemento de Perfil de RPC**                                                                  |
| [**Entrada de Perfil de RPC-NS-**](a-rpcnsprofileentry.md)                       | False     | **Elemento de Perfil de RPC**                                                                  |
