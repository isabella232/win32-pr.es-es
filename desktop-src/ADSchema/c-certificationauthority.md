...
| Nombre para mostrar de LDAP | certificationAuthority               |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 3fdfee50-47f4-11d1-a9c3-0000f80367c1 |
...
| [**Autoridad-revocación-lista**](a-authorityrevocationlist.md)            | True      | **Entidad de certificación**                                 |
| [**Cabeza de puente-servidor-lista-BL**](a-bridgeheadserverlistbl.md)             | False     | [**Arriba**](c-top.md)<br/>                             |
| [**Certificado de CA**](a-cacertificate.md)                                 | True      | **Entidad de certificación**                                 |
| [**CA-Certificate-DN**](a-cacertificatedn.md)                            | False     | **Entidad de certificación**                                 |
| [**CA-conectar**](a-caconnect.md)                                         | False     | **Entidad de certificación**                                 |
| [**Nombre canónico**](a-canonicalname.md)                                 | False     | [**Arriba**](c-top.md)<br/>                             |
| [**Uso de CA**](a-causages.md)                                           | False     | **Entidad de certificación**                                 |
| [**CA-WEB-URL**](a-caweburl.md)                                          | False     | **Entidad de certificación**                                 |
| [**Certificado-revocación-lista**](a-certificaterevocationlist.md)        | True      | **Entidad de certificación**                                 |
| [**Plantillas de certificado**](a-certificatetemplates.md)                   | False     | **Entidad de certificación**                                 |
| [**Nombre común**](a-cn.md)                                               | True      | Entidad **de certificación: entidad** [ **superior**](c-top.md)<br/> |
| [**Creación: marca de tiempo**](a-createtimestamp.md)                            | False     | [**Arriba**](c-top.md)<br/>                             |
| [**Objeto CRL**](a-crlobject.md)                                         | False     | **Entidad de certificación**                                 |
| [**Par de certificados cruzados**](a-crosscertificatepair.md)                  | False     | **Entidad de certificación**                                 |
| [**Actual-primario-CA**](a-currentparentca.md)                            | False     | **Entidad de certificación**                                 |
| [**Delta-revocación-lista**](a-deltarevocationlist.md)                    | False     | **Entidad de certificación**                                 |
...
| [**Nombre del host DNS**](a-dnshostname.md)                                    | False     | **Entidad de certificación**                                 |
| [**IDENTIFICADOR de dominio**](a-domainid.md)                                           | False     | **Entidad de certificación**                                 |
| [**Objeto de directiva de dominio**](a-domainpolicyobject.md)                      | False     | **Entidad de certificación**                                 |
...
| [**Proveedores de inscripción**](a-enrollmentproviders.md)                     | False     | **Entidad de certificación**                                 |
...
| [**Primario-CA**](a-parentca.md)                                           | False     | **Entidad de certificación**                                 |
| [**Cadena de certificados de entidad de certificación primaria**](a-parentcacertificatechain.md)         | False     | **Entidad de certificación**                                 |
...
| [**Pending-CA-Certificates**](a-pendingcacertificates.md)                | False     | **Entidad de certificación**                                 |
| [**Pendiente-primario-CA**](a-pendingparentca.md)                            | False     | **Entidad de certificación**                                 |
| [**Posibles: inferiores**](a-possibleinferiors.md)                         | False     | [**Arriba**](c-top.md)<br/>                             |
| [**Certificados de CA anteriores**](a-previouscacertificates.md)              | False     | **Entidad de certificación**                                 |
| [**Anterior-primario-CA**](a-previousparentca.md)                          | False     | **Entidad de certificación**                                 |
...
| [**Guía de búsqueda**](a-searchguide.md)                                     | False     | **Entidad de certificación**                                 |
...
| [**Algoritmos de firma**](a-signaturealgorithms.md)                     | False     | **Entidad de certificación**                                 |
...
| [**Compatible: contexto de aplicación**](a-supportedapplicationcontext.md)    | False     | **Entidad de certificación**                                 |
| [**Marcas de sistema**](a-systemflags.md)                                     | False     | [**Arriba**](c-top.md)<br/>                             |
| [**Teletexto: identificador de terminal**](a-teletexterminalidentifier.md)        | False     | **Entidad de certificación**                                 |
