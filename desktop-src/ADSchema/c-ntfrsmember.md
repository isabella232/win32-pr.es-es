...
---
# <a name="ntfrs-member-class"></a>NTFRS-Member (clase)

Identifica un miembro del conjunto de réplicas de FRS.
...
|-------------------|--------------------------------------|
| CN                | NTFRS-Member                         |
| Nombre para mostrar de LDAP | nTFRSMember                          |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 2a132586-9373-11d1-aebc-0000f80367c1 |
...
| Posibles superiores          | [**NTFRS-Replica-set**](c-ntfrsreplicaset.md)                                                                                   |
| Clases auxiliares           | \-                                                                                                                               |
...
| [**FRS-equipo-referencia**](a-frscomputerreference.md)                  | False     | **Miembro de NTFRS**                |
| [**FRS-Computer-Reference-BL**](a-frscomputerreferencebl.md)             | False     | [**Arriba**](c-top.md)<br/> |
| [**FRS-control-creación de datos**](a-frscontroldatacreation.md)             | False     | **Miembro de NTFRS**                |
| [**FRS-control-entrada del trabajo pendiente**](a-frscontrolinboundbacklog.md)         | False     | **Miembro de NTFRS**                |
| [**FRS-control-saliente-trabajo pendiente**](a-frscontroloutboundbacklog.md)       | False     | **Miembro de NTFRS**                |
| [**FRS-extensiones**](a-frsextensions.md)                                 | False     | **Miembro de NTFRS**                |
| [**FRS-marcas**](a-frsflags.md)                                           | False     | **Miembro de NTFRS**                |
| [**FRS-Member-Reference-BL**](a-frsmemberreferencebl.md)                 | False     | [**Arriba**](c-top.md)<br/> |
| [**Nivel de socio de FRS-auth**](a-frspartnerauthlevel.md)                   | False     | **Miembro de NTFRS**                |
| [**FRS-raíz-seguridad**](a-frsrootsecurity.md)                            | False     | **Miembro de NTFRS**                |
| [**FRS-Service-Command**](a-frsservicecommand.md)                        | False     | **Miembro de NTFRS**                |
| [**FRS-Update-timeout**](a-frsupdatetimeout.md)                          | False     | **Miembro de NTFRS**                |
...
| [**Servidor-referencia**](a-serverreference.md)                             | False     | **Miembro de NTFRS**                |
