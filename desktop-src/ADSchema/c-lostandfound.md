---
title: Lost-And-Found (Clase)
description: Contenedor para objetos huérfanos.
ms.assetid: 694f58a0-6e03-4ec0-bb05-6340ede22c5a
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase Perdida y encontrada
...
ms.locfileid: "119324115"
---
# <a name="lost-and-found-class"></a>Lost-And-Found (Clase)

Contenedor para objetos huérfanos.



| Entrada | Value |
|-------------------|-----------------------------------------------------------|
| CN                | Perdido y encontrado                                            |
| Ldap-Display-Name | lostAndFound                                              |
| Actualizar privilegios  | El sistema administra este contenedor.                  |
| Frecuencia de actualización  | Siempre que no se pueda conciliar la ubicación de un objeto. |
...
| Posibles superiores          | Configuración de DNS [**de dominio de**](c-domaindns.md)[](c-configuration.md) [**DMD**](c-dmd.md) |
| Clases auxiliares           | \-                                                                                            |
...
| [**Move-Tree-State**](a-movetreestate.md)                                | Falso     | **Perdido y encontrado**              |
...
| Rdn-Att-Id                  | [**Common-Name**](a-cn.md)<br/>                                                        |
| Subclase de                 | [**Arriba**](c-top.md)<br/>                                                               |
| Posibles superiores          | [**Configuración de DNS**](c-dmd.md)de dominio [**dmd**](c-domaindns.md)[](c-configuration.md) |
| Clases auxiliares           | \-                                                                                            |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                  |
| Descriptor de seguridad predeterminado | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU)  |
| System-Flags                | 0x00000010                                                                                    |
