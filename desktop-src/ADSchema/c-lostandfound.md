...
---
# <a name="lost-and-found-class"></a>Clase perdida y encontrada

Contenedor de objetos huérfanos.



| Entrada | Value |
|-------------------|-----------------------------------------------------------|
| CN                | Perdidos y encontrados                                            |
| Nombre para mostrar de LDAP | lostAndFound                                              |
| Actualizar privilegio  | El sistema administra este contenedor.                  |
| Frecuencia de actualización  | Siempre que no se puede conciliar la ubicación de un objeto. |
| Identificador de esquema-GUID    | 52ab8671-5709-11d1-a9c6-0000f80367c1                      |
...
| Posibles superiores          | Dominio [**DMD**](c-dmd.md)[**:**](c-domaindns.md)[**configuración**](c-configuration.md) DNS |
| Clases auxiliares           | \-                                                                                            |
...
| [**Estado del árbol de movimiento**](a-movetreestate.md)                                | False     | **Perdidos y encontrados**              |
