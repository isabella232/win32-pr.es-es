...
---
# <a name="licensing-site-settings-class"></a>Licensing: clase de configuración de sitio

Apunta al servidor de licencias de un sitio.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Licencias: configuración del sitio              |
| Nombre para mostrar de LDAP | licensingSiteSettings                |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 1be8f17d-a9ff-11d0-afe2-00c04fd930c9 |
...
| [**Servidor de sitio**](a-siteserver.md)                                       | False     | **Licencias: configuración del sitio**                                               |
