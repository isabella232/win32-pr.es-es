...
---
# <a name="ms-dfsr-globalsettings-class"></a>clase MS-DFSR-GlobalSettings
...
| Nombre para mostrar de LDAP | msDFSR-GlobalSettings                |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 7b35dbad-b3ec-486a-aad4-2fec9d6ea6f6 |
...
| [**Extensión MS-DFSR-**](a-msdfsr-extension.md)                             | False     | **MS-DFSR-GlobalSettings**      |
| [**MS-DFSR-marcas**](a-msdfsr-flags.md)                                     | False     | **MS-DFSR-GlobalSettings**      |
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | False     | [**Arriba**](c-top.md)<br/> |
| [**Opciones de MS-DFSR**](a-msdfsr-options.md)                                 | False     | **MS-DFSR-GlobalSettings**      |
...
La clase **MS-DFSR-globalsettings** forma parte de la compatibilidad con el servicio de replicación sistema de archivos distribuido (DFS).
