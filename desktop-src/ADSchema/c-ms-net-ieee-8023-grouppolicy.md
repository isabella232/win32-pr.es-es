...
description: Esta clase representa un objeto de red cableada 802.3 directiva de grupo. Esta clase contiene identificadores y datos de configuración relevantes para una red cableada 802.3.
ms.assetid: ca213f8b-99d4-48c9-8104-bb982f0c077a
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-net-ieee-8023-GroupPolicy
topic_type:
- apiref
api_name:
...
ms.locfileid: "118680893"
---
# <a name="ms-net-ieee-8023-grouppolicy-class"></a>clase ms-net-ieee-8023-GroupPolicy

Esta clase representa un objeto de red cableada 802.3 directiva de grupo. Esta clase contiene identificadores y datos de configuración relevantes para una red cableada 802.3.
