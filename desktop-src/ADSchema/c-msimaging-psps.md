...
---
# <a name="ms-imaging-psps-class"></a>clase MS-Imaging-PSPs

Contenedor para todos los objetos de proceso de análisis de publicación de Enterprise Scan.
...
|-------------------|--------------------------------------|
| CN                | MS-Imaging-PSPs                      |
| Nombre para mostrar de LDAP | msImaging-PSPs                       |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | a0ed2ac1-970c-4777-848e-ec63a0ec44fc |
