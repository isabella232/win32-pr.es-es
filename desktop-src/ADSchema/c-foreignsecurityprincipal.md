...
---
# <a name="foreign-security-principal-class"></a>Foreign-Security-clase principal

La entidad de seguridad de un origen externo.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Entidad de seguridad externa           |
| Nombre para mostrar de LDAP | foreignSecurityPrincipal             |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 89e31c12-8530-11d0-afda-00c04fd930c9 |
...
| [**Identificador externo**](a-foreignidentifier.md)                         | False     | **Entidad de seguridad externa**  |
...
| [**Objeto: SID**](a-objectsid.md)                                         | True      | **Entidad de seguridad externa**  |
