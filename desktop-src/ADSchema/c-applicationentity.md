...
| Nombre para mostrar de LDAP | applicationEntity                    |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 3fdfee4f-47f4-11d1-a9c3-0000f80367c1 |
...
| [**Nombre común**](a-cn.md)                                               | True      | **Aplicación: entidad** [ **superior**](c-top.md)<br/> |
...
| [**Localidad: nombre**](a-l.md)                                              | False     | **Entidad de aplicación**                                 |
...
| [**Nombre de unidad organizativa**](a-ou.md)                                  | False     | **Entidad de aplicación**                                 |
| [**Nombre de la organización**](a-o.md)                                          | False     | **Entidad de aplicación**                                 |
...
| [**Dirección de presentación**](a-presentationaddress.md)                     | True      | **Entidad de aplicación**                                 |
...
| [**Vea también**](a-seealso.md)                                             | False     | **Entidad de aplicación**                                 |
...
| [**Compatible: contexto de aplicación**](a-supportedapplicationcontext.md)    | False     | **Entidad de aplicación**                                 |
...
| RDN-ATT-ID                  | [**Nombre común**](a-cn.md)<br/>                                                                                                 |
| Subclase de                 | [**Arriba**](c-top.md)<br/>                                                                                                        |
| Posibles superiores          | Organización de [**contenedor**](c-container.md)[**:**](c-organizationalunit.md)[**proceso de aplicación de la**](c-applicationprocess.md) unidad |
| Clases auxiliares           | \-                                                                                                                                     |
| Descriptor de NT-Security-      | O:BAG: BAD: S:                                                                                                                           |
| Descriptor de seguridad predeterminado | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; ESTÉ                                           |
| System-Flags                | 0x00000010                                                                                                                             |
