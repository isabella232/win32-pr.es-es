...
---
# <a name="rras-administration-dictionary-class"></a>RRAS-Administration-clase de Diccionario

Objeto de diccionario para traducir los atributos de enrutamiento específicos del proveedor a los nombres.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | RRAS-Administration-Diccionario       |
| Nombre para mostrar de LDAP | rRASAdministrationDictionary         |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | f39b98ae-938d-11d1-aebd-0000f80367c1 |
...
| [**MS-RRAS-Vendor-Attribute-entry**](a-msrrasvendorattributeentry.md)    | False     | **RRAS-Administration-Diccionario** |
