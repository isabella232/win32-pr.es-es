...
---
# <a name="link-track-volume-table-class"></a>Link-Track-clase de tabla de volumen

Contenedor de objetos de seguimiento de vínculos-Vol-entry.
...
| Nombre para mostrar de LDAP | linkTrackVolumeTable                  |
| Actualizar privilegio  | El sistema establece este valor.      |
| Frecuencia de actualización  | Cada vez que se crea un vínculo a un archivo. |
| Identificador de esquema-GUID    | ddac0cf4-af8f-11d0-afeb-00c04fd930c9  |
...
| Subclase de                 | [**Seguimiento de vínculos de archivos**](c-filelinktracking.md)<br/>                                  |
| Posibles superiores          | [**Seguimiento de vínculos de archivos**](c-filelinktracking.md)                                             |
| Clases auxiliares           | \-                                                                                           |
