...
---
# <a name="max-renew-age-attribute"></a>Atributo Max-Renew-Age

Este atributo determina el período de tiempo, en días, durante el que se puede renovar el vale de concesión de vales (TGT) de un usuario para la autenticación Kerberos. La configuración predeterminada es de 7 días en el dominio predeterminado directiva de grupo objeto (GPO).
...
|-------------------|--------------------------------------|
| CN                | Max-Renew-Age                        |
| Nombre para mostrar de LDAP | maxRenewAge                          |
| Tamaño              | \-                                   |
