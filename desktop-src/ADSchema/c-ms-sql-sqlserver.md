...
---
# <a name="ms-sql-sqlserver-class"></a>MS-SQL-SQLServer (clase)

Contenedor para almacenar objetos [**MS-SQL-SQLDatabase**](c-ms-sql-sqldatabase.md), [**MS-SQL-SQLPublication**](c-ms-sql-sqlpublication.md)y [**MS-SQL-SQLRepository**](c-ms-sql-sqlrepository.md) .
...
|-------------------|--------------------------------------|
| CN                | MS-SQL-SQLServer                     |
| Nombre para mostrar de LDAP | mS-SQL-SQLServer                     |
| Actualizar privilegio  | El sistema establece este valor.     |
| Frecuencia de actualización  | En el programa de instalación del sistema.                     |
| Identificador de esquema-GUID    | 05f6c878-ccef-11d2-9993-0000f87a57d4 |
...
| [**MS-SQL-compilación**](a-ms-sql-build.md)                                    | False     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-CharacterSet**](a-ms-sql-characterset.md)                      | False     | **MS-SQL-SQLServer**                                                                     |
| [**En clúster de MS-SQL**](a-ms-sql-clustered.md)                            | False     | **MS-SQL-SQLServer**                                                                     |
| [**Contacto de MS-SQL**](a-ms-sql-contact.md)                                | False     | **MS-SQL-SQLServer**                                                                     |
...
| [**MS-SQL-palabras clave**](a-ms-sql-keywords.md)                              | False     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                | False     | **MS-SQL-SQLServer**                                                                     |
| [**Ubicación de MS-SQL**](a-ms-sql-location.md)                              | False     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-memoria**](a-ms-sql-memory.md)                                  | False     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-multiprotocolo**](a-ms-sql-multiprotocol.md)                    | False     | **MS-SQL-SQLServer**                                                                     |
| [**Nombre MS-SQL**](a-ms-sql-name.md)                                      | False     | **MS-SQL-SQLServer**                                                                     |
...
| [**Estado de MS-SQL**](a-ms-sql-status.md)                                  | False     | **MS-SQL-SQLServer**                                                                     |
