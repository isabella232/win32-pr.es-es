...
---
# <a name="ms-sql-sqlpublication-class"></a>Clase MS-SQL-SQLPublication

Clase para almacenar SQL Server propiedades de la publicación. Permite al usuario examinar las publicaciones a las que se puede suscribir.
...
| Nombre para mostrar de LDAP | mS-SQL-SQLPublication                |
| Actualizar privilegio  | El sistema establece este valor.     |
| Frecuencia de actualización  | En el programa de instalación del sistema.                     |
| Identificador de esquema-GUID    | 17c2f64e-ccef-11d2-9993-0000f87a57d4 |
...
| [**MS-SQL-AllowAnonymousSubscription**](a-ms-sql-allowanonymoussubscription.md)                 | False     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-AllowImmediateUpdatingSubscription**](a-ms-sql-allowimmediateupdatingsubscription.md) | False     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-AllowKnownPullSubscription**](a-ms-sql-allowknownpullsubscription.md)                 | False     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-AllowQueuedUpdatingSubscription**](a-ms-sql-allowqueuedupdatingsubscription.md)       | False     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-AllowSnapshotFilesFTPDownloading**](a-ms-sql-allowsnapshotfilesftpdownloading.md)     | False     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-base de datos**](a-ms-sql-database.md)                                                     | False     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-Descripción**](a-ms-sql-description.md)                                               | False     | **MS-SQL-SQLPublication**       |
| [**Nombre MS-SQL**](a-ms-sql-name.md)                                                             | False     | **MS-SQL-SQLPublication**       |
| [**Publicador de MS-SQL**](a-ms-sql-publisher.md)                                                   | False     | **MS-SQL-SQLPublication**       |
| [**Estado de MS-SQL**](a-ms-sql-status.md)                                                         | False     | **MS-SQL-SQLPublication**       |
| [**MS-SQL-ThirdParty**](a-ms-sql-thirdparty.md)                                                 | False     | **MS-SQL-SQLPublication**       |
| [**Tipo MS-SQL**](a-ms-sql-type.md)                                                             | False     | **MS-SQL-SQLPublication**       |
