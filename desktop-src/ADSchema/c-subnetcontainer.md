...
---
# <a name="subnet-container-class"></a>Subnet-Container (clase)

Contenedor para contener todos los objetos de subred.
...
|-------------------|--------------------------------------|
| CN                | Subnet-Container                     |
| Nombre para mostrar de LDAP | subnetContainer                      |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | b7b13125-b82e-11d0-afee-0000f80367c1 |
