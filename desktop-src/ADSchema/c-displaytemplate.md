...
Especifica la información de una plantilla de dirección.
...
|-------------------|--------------------------------------|
| CN                | Display-Template                     |
| Nombre para mostrar de LDAP | displayTemplate                      |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 5fd4250c-1262-11d0-a060-00aa006c33ed |
...
|------------------------------------------------------------------------------|-----------|------------------------------------------------------|
| [**Address-entry-display-Table**](a-addressentrydisplaytable.md)            | False     | **Mostrar plantilla**                                 |
| [**Address-entry-display-Table-MSDOS**](a-addressentrydisplaytablemsdos.md) | False     | **Mostrar plantilla**                                 |
...
| [**Nombre común**](a-cn.md)                                                  | True      | **Mostrar-plantilla** [ **arriba**](c-top.md)<br/> |
...
| [**Ayuda: Data16**](a-helpdata16.md)                                          | False     | **Mostrar plantilla**                                 |
| [**Ayuda: Data32**](a-helpdata32.md)                                          | False     | **Mostrar plantilla**                                 |
| [**Nombre de archivo de ayuda**](a-helpfilename.md)                                     | False     | **Mostrar plantilla**                                 |
...
| [**Original-display-Table**](a-originaldisplaytable.md)                     | False     | **Mostrar plantilla**                                 |
| [**Original-display-Table-MSDOS**](a-originaldisplaytablemsdos.md)          | False     | **Mostrar plantilla**                                 |
