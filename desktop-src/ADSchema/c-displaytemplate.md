...
description: Especifica información para una plantilla de dirección.
ms.assetid: ddc1fe59-949d-4bbb-bb29-52d0b4b77275
ms.tgt_platform: multiple
keywords:
- Display-Template esquema de AD de la clase
...
ms.locfileid: "119081249"
---
# <a name="display-template-class"></a>Display-Template clase

Especifica información para una plantilla de dirección.
...
|------------------------------------------------------------------------------|-----------|------------------------------------------------------|
| [**Address-Entry-Display-Table**](a-addressentrydisplaytable.md)            | Falso     | **Mostrar plantilla**                                 |
| [**Address-Entry-Display-Table-MSDOS**](a-addressentrydisplaytablemsdos.md) | Falso     | **Mostrar plantilla**                                 |
...
| [**Common-Name**](a-cn.md)                                                  | Verdadero      | **Mostrar plantilla en la parte** [ **superior**](c-top.md)<br/> |
...
| [**Help-Data16**](a-helpdata16.md)                                          | Falso     | **Mostrar plantilla**                                 |
| [**Help-Data32**](a-helpdata32.md)                                          | Falso     | **Mostrar plantilla**                                 |
| [**Help-File-Name**](a-helpfilename.md)                                     | Falso     | **Mostrar plantilla**                                 |
...
| [**Original-Display-Table**](a-originaldisplaytable.md)                     | Falso     | **Mostrar plantilla**                                 |
| [**Original-Display-Table-MSDOS**](a-originaldisplaytablemsdos.md)          | Falso     | **Mostrar plantilla**                                 |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)                | Falso     | [**Arriba**](c-top.md)<br/>                      |
| [**Canonical-Name**](a-canonicalname.md)                                    | Falso     | [**Arriba**](c-top.md)<br/>                      |
| [**Common-Name**](a-cn.md)                                                  | Verdadero      | **Mostrar plantilla** [ **superior**](c-top.md)<br/> |
