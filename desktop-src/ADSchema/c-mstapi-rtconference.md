...
---
# <a name="ms-tapi-rt-conference-class"></a>clase MS-TAPI-RT-Conference

Se usa para publicar una conferencia de multidifusión de TAPI en tiempo real.



| Entrada | Value |
|-------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CN                | Microsoft-TAPI-RT-Conference                                                                                                                                                                                    |
| Nombre para mostrar de LDAP | msTAPI-RtConference                                                                                                                                                                                      |
| Actualizar privilegio  | No se requieren privilegios especiales.                                                                                                                                                                          |
| Frecuencia de actualización  | La frecuencia de creación es a discreción del usuario cada vez que es necesario publicar una conferencia TAPI. Una vez creada, la duración típica de un objeto de conferencia TAPI puede estar en el intervalo de 30 minutos a 1 año. |
| Identificador de esquema-GUID    | ca7b9735-4b2a-4e49-89c3-99025334dc94                                                                                                                                                                     |
...
| RDN-ATT-ID                  | [**Identificador único de MS-TAPI**](a-mstapi-uid.md)<br/>                                 |
| Subclase de                 | [**Arriba**](c-top.md)<br/>                                                              |
| Posibles superiores          | [**Unidad organizativa**](c-organizationalunit.md)                                          |
| Clases auxiliares           | \-                                                                                           |
...
| [**MS-TAPI-Conference-BLOB**](a-mstapi-conferenceblob.md)                  | False     | **Microsoft-TAPI-RT-Conference**       |
| [**Identificador de protocolo MS-TAPI**](a-mstapi-protocolid.md)                          | False     | **Microsoft-TAPI-RT-Conference**       |
| [**Identificador único de MS-TAPI**](a-mstapi-uid.md)                           | True      | **Microsoft-TAPI-RT-Conference**       |
