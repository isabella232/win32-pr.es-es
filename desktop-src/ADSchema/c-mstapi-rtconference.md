---
title: ms-TAPI-Rt-Conference (clase)
description: Se usa para publicar una conferencia de multidifusión TAPI en tiempo real.
ms.assetid: cebd4789-61f7-4a03-b7bf-7ec79b7a1085
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-TAPI-Rt-Conference
...
ms.locfileid: "119879415"
---
# <a name="ms-tapi-rt-conference-class"></a>ms-TAPI-Rt-Conference (clase)

Se usa para publicar una conferencia de multidifusión TAPI en tiempo real.
...
| Privilegio actualizar  | No se requieren privilegios especiales.                                                                                                                                                                          |
| Frecuencia de actualización  | La frecuencia de creación está a discreción del usuario cada vez que es necesario publicar una conferencia TAPI. Una vez creada, la duración típica de un objeto de conferencia TAPI puede estar entre 30 minutos y 1 año. |
...
| [**ms-TAPI-Unique-Identifier**](a-mstapi-uid.md)                           | Verdadero      | **ms-TAPI-Rt-Conference**       |
