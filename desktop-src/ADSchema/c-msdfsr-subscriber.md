...
---
# <a name="ms-dfsr-subscriber-class"></a>clase MS-DFSR-Subscriber

Contiene la pertenencia al equipo local de un grupo de replicación.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | MS-DFSR-suscriptor                   |
| Nombre para mostrar de LDAP | msDFSR: suscriptor                    |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | e11505d7-92c4-43e7-bf5c-295832ffc896 |
...
| Posibles superiores          | [**MS-DFSR-LocalSettings**](c-msdfsr-localsettings.md)                                                                          |
| Clases auxiliares           | \-                                                                                                                               |
...
| [**Extensión MS-DFSR-**](a-msdfsr-extension.md)                             | False     | **MS-DFSR-suscriptor**          |
| [**MS-DFSR-marcas**](a-msdfsr-flags.md)                                     | False     | **MS-DFSR-suscriptor**          |
| [**MS-DFSR-MemberReference**](a-msdfsr-memberreference.md)                 | True      | **MS-DFSR-suscriptor**          |
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | False     | [**Arriba**](c-top.md)<br/> |
| [**Opciones de MS-DFSR**](a-msdfsr-options.md)                                 | False     | **MS-DFSR-suscriptor**          |
| [**MS-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)       | True      | **MS-DFSR-suscriptor**          |
...
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | False     | [**Arriba**](c-top.md)<br/> |
| [**Opciones de MS-DFSR**](a-msdfsr-options.md)                                    | False     | **MS-DFSR-suscriptor**          |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                  | False     | **MS-DFSR-suscriptor**          |
| [**MS-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)          | True      | **MS-DFSR-suscriptor**          |
| [**MS-DS-aprox-immed-subordinados**](a-msds-approx-immed-subordinates.md)    | False     | [**Arriba**](c-top.md)<br/> |
...
La clase **MS-DFSR-Subscriber** forma parte de la compatibilidad con el servicio de replicación sistema de archivos distribuido (DFS).
