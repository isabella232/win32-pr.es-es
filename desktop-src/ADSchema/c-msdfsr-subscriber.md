---
title: ms-DFSR-Subscriber (clase)
description: Contiene la pertenencia a un equipo local de un grupo de replicación.
ms.assetid: 02ce34b3-2dc0-44ae-b392-b1545e92a0f7
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-DFSR-Subscriber
- Esquema de AD de la clase msDFSR-Subscriber
topic_type:
- apiref
api_name:
- ms-DFSR-Subscriber
...
ms.locfileid: "118959894"
---
# <a name="ms-dfsr-subscriber-class"></a>ms-DFSR-Subscriber (clase)

Contiene la pertenencia a un equipo local de un grupo de replicación.
...
| [**ms-DFSR-MemberReference**](a-msdfsr-memberreference.md)                 | Verdadero      | **ms-DFSR-Subscriber**          |
...
| [**ms-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)       | Verdadero      | **ms-DFSR-Subscriber**          |
...
La **clase ms-DFSR-Subscriber** forma parte de la compatibilidad del servicio de replicación Sistema de archivos distribuido (DFS).
