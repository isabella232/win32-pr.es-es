...
---
# <a name="ms-ds-app-data-class"></a>clase MS-DS-app-data

Almacena los datos que va a utilizar un objeto. Por ejemplo, información de perfil para un objeto de usuario.
...
|-------------------|--------------------------------------|
| CN                | MS-DS-app-data                       |
| Nombre para mostrar de LDAP | msDS-AppData                         |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 9e67d761-e327-4d55-bc95-682f875e2f8e |
...
| [**Palabras clave**](a-keywords.md)                                              | False     | **MS-DS-app-data**                                               |
| [**Último conocido-primario**](a-lastknownparent.md)                              | False     | [**Arriba**](c-top.md)<br/>                                  |
| [**Administrado: por**](a-managedby.md)                                           | False     | **MS-DS-app-data**                                               |
...
| [**MS-DS-fecha-hora**](a-msds-datetime.md)                                  | False     | **MS-DS-app-data**                                               |
| [**MS-DS-entero**](a-msds-integer.md)                                     | False     | **MS-DS-app-data**                                               |
...
| [**Referencia de objetos MS-DS-Object**](a-msds-objectreference.md)                    | False     | **MS-DS-app-data**                                               |
...
| [**Propietario**](a-owner.md)                                                    | False     | **MS-DS-app-data**                                               |
