---
title: ms-Kds-Prov-RootKey (clase)
description: Claves raíz de la Servicio de distribución de claves de grupo.
ms.assetid: d4a38d24-80a8-4a5e-a50c-1e177f0a7c7a
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-Kds-Prov-RootKey
- Esquema de AD de la clase msKds-ProvRootKey
topic_type:
- apiref
api_name:
- ms-Kds-Prov-RootKey
...
ms.locfileid: "118175729"
---
# <a name="ms-kds-prov-rootkey-class"></a>ms-Kds-Prov-RootKey (clase)

Claves raíz de la Servicio de distribución de claves de grupo.
...
| Descriptor de seguridad predeterminado | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; EA)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) |
...
| [**Nombre común**](a-cn.md)                                                                  | Verdadero      | **ms-Kds-Prov-RootKey** [ **Top**](c-top.md)<br/> |
...
| [**ms-Kds-CreateTime**](a-mskds-createtime.md)                                              | Verdadero      | **ms-Kds-Prov-RootKey**                                 |
...
| [**ms-Kds-UseStartTime**](a-mskds-usestarttime.md)                                          | Verdadero      | **ms-Kds-Prov-RootKey**                                 |
| [**ms-Kds-Version**](a-mskds-version.md)                                                    | Verdadero      | **ms-Kds-Prov-RootKey**                                 |
