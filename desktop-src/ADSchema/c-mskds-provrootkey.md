...
---
# <a name="ms-kds-prov-rootkey-class"></a>clase MS-KDS-Prov-RootKey

Claves raíz para el servicio de distribución de claves de grupo.
...
| Nombre para mostrar de LDAP | msKds-ProvRootKey                    |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | aa02fd41-17e0-4f18-8687-b2239649736b |
...
| [**Nombre común**](a-cn.md)                                                                  | True      | **MS-KDS-Prov-RootKey** [ **superior**](c-top.md)<br/> |
...
| [**MS-KDS-PrivateKey-longitud**](a-mskds-privatekeylength.md)                                 | True      | **MS-KDS-Prov-RootKey**                                 |
| [**MS-KDS-PublicKey-longitud**](a-mskds-publickeylength.md)                                   | True      | **MS-KDS-Prov-RootKey**                                 |
...
| [**MS-KDS-versión**](a-mskds-version.md)                                                    | True      | **MS-KDS-Prov-RootKey**                                 |
