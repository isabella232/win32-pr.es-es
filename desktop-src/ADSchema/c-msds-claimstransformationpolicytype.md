---
title: ms-DS-Claims-Transformation-Policy-Type (Clase)
description: Un objeto de esta clase contiene el conjunto de directivas de transformación de notificaciones para la transformación de notificaciones entre bosques. | ms-DS-Claims-Transformation-Policy-Type (Clase)
ms.assetid: 5368ea9a-0fd7-4b0e-8b49-d5c3ee3cb09c
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-DS-Claims-Transformation-Policy-Type
...
ms.locfileid: "119880225"
---
# <a name="ms-ds-claims-transformation-policy-type-class"></a>ms-DS-Claims-Transformation-Policy-Type (Clase)
