...
---
# <a name="ms-ds-claims-transformation-policy-type-class"></a>clase MS-DS-Claims-Transformation-Policy-Type

Un objeto de esta clase contiene el conjunto de una directiva de transformación de notificaciones para la transformación de notificaciones entre bosques.
...
| Nombre para mostrar de LDAP | msDS-ClaimsTransformationPolicyType     |
| Actualizar privilegio  | \-                                      |
| Frecuencia de actualización  | \-                                      |
| Identificador de esquema-GUID    | 2eeb62b3-1373-fe45-8101-387f1676edc7    |
...
| Posibles superiores          | [**MS-DS-Claims-Transformation-Policies**](c-msds-claimstransformationpolicies.md) |
| Clases auxiliares           | \-                                                                                  |
...
| [**MS-DS-Transformation-reglas**](a-msds-transformationrules.md)                             | False     | **MS-DS-Claims-Transformation-Policy-Type** |
| [**MS-DS-Transformation-reglas-compiladas**](a-msds-transformationrulescompiled.md)            | False     | **MS-DS-Claims-Transformation-Policy-Type** |
