...
---
# <a name="msmq-migrated-user-class"></a>MSMQ-Migrated-clase de usuario

En MSMQ 1,0 tenemos nuestro propio DS, en el que hemos mantenido información por usuario. Como parte de la integración de MSMQ con Windows 2000 DS, MSMQ proporciona una herramienta de migración. Durante la migración, para cada usuario que no está en el dominio de Windows 2000, se crea un usuario migrado.



| Entrada | Value |
|-------------------|--------------------------------------------------------------------------------------------------|
| CN                | MSMQ-Migrated: usuario                                                                               |
| Nombre para mostrar de LDAP | mSMQMigratedUser                                                                                 |
| Actualizar privilegio  | Propietario de la cola.                                                                                 |
| Frecuencia de actualización  | Este objeto lo crea el Asistente para actualización de Message Queue Server en un entorno de dominio de modo mixto. |
| Identificador de esquema-GUID    | 50776997-3c3d-11d2-90cc-00c04fd91ab1                                                             |
...
| Posibles superiores          | [**Builtin-**](c-builtindomain.md)[**dominio dominio-**](c-domaindns.md)[**unidad organizativa**](c-organizationalunit.md) DNS |
| Clases auxiliares           | \-                                                                                                                            |
...
| [**MSMQ-resúmenes**](a-msmqdigests.md)                                     | False     | **MSMQ-Migrated: usuario**          |
| [**MSMQ-resúmenes-MIG**](a-msmqdigestsmig.md)                              | False     | **MSMQ-Migrated: usuario**          |
| [**Certificados de firma MSMQ**](a-msmqsigncertificates.md)                  | False     | **MSMQ-Migrated: usuario**          |
| [**MSMQ-Sign-Certificates-MIG**](a-msmqsigncertificatesmig.md)           | False     | **MSMQ-Migrated: usuario**          |
| [**MSMQ-usuario-SID**](a-msmqusersid.md)                                    | False     | **MSMQ-Migrated: usuario**          |
...
| [**Objeto: SID**](a-objectsid.md)                                         | False     | **MSMQ-Migrated: usuario**          |
