...
La Directiva de asignación de ancho de banda de servicio controla para un usuario o perfil.
...
|-------------------|--------------------------------------|
| CN                | ACS-Policy                           |
| Nombre para mostrar de LDAP | aCSPolicy                            |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 7f561288-5301-11d1-a9c5-0000f80367c1 |
...
|----------------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-Aggregate-token-Rate por usuario**](a-acsaggregatetokenrateperuser.md)      | False     | **ACS-Directiva**                  |
| [**Dirección de ACS**](a-acsdirection.md)                                          | False     | **ACS-Directiva**                  |
| [**Nombre de identidad de ACS**](a-acsidentityname.md)                                   | False     | **ACS-Directiva**                  |
| [**ACS-Max-Aggregate-tasa máxima por usuario**](a-acsmaxaggregatepeakrateperuser.md) | False     | **ACS-Directiva**                  |
| [**ACS-Max-Duration-per-Flow**](a-acsmaxdurationperflow.md)                     | False     | **ACS-Directiva**                  |
| [**ACS-Maximum-SDU-size**](a-acsmaximumsdusize.md)                              | False     | **ACS-Directiva**                  |
| [**ACS-Max-pico-ancho de banda por flujo**](a-acsmaxpeakbandwidthperflow.md)          | False     | **ACS-Directiva**                  |
| [**ACS-Max-token-bucket-por flujo**](a-acsmaxtokenbucketperflow.md)              | False     | **ACS-Directiva**                  |
| [**ACS-Max-token-Rate-per-Flow**](a-acsmaxtokenrateperflow.md)                  | False     | **ACS-Directiva**                  |
| [**ACS-mínimo-retraso-variación**](a-acsminimumdelayvariation.md)                | False     | **ACS-Directiva**                  |
| [**ACS-latencia mínima**](a-acsminimumlatency.md)                               | False     | **ACS-Directiva**                  |
| [**ACS: tamaño mínimo de directivas**](a-acsminimumpolicedsize.md)                      | False     | **ACS-Directiva**                  |
| [**ACS-permiso-bits**](a-acspermissionbits.md)                               | False     | **ACS-Directiva**                  |
| [**ACS-prioridad**](a-acspriority.md)                                            | False     | **ACS-Directiva**                  |
| [**ACS-tipo de servicio**](a-acsservicetype.md)                                     | False     | **ACS-Directiva**                  |
| [**ACS-hora del día**](a-acstimeofday.md)                                        | False     | **ACS-Directiva**                  |
| [**ACS-total-no-of-Flows**](a-acstotalnoofflows.md)                             | False     | **ACS-Directiva**                  |
