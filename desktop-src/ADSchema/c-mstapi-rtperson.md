---
title: ms-TAPI-Rt-Person (clase)
description: Se usa para asignar un usuario a la dirección IP del equipo en el que el usuario ha iniciado sesión para su uso por las conferencias de multidifusión TAPI.
ms.assetid: 3866eb11-8719-40b6-b73c-314009db2553
ms.tgt_platform: multiple
keywords:
- Esquema de AD de clase ms-TAPI-Rt-Person
- Esquema de AD de la clase msTAPI-RtPerson
topic_type:
- apiref
api_name:
- ms-TAPI-Rt-Person
...
ms.locfileid: "119879385"
---
# <a name="ms-tapi-rt-person-class"></a>ms-TAPI-Rt-Person (clase)

Se usa para asignar un usuario a la dirección IP del equipo en el que el usuario ha iniciado sesión para su uso por las conferencias de multidifusión TAPI.
...
| Frecuencia de actualización  | Cada vez que un cliente TAPI se inicia después de registrarse en el directorio TAPI. |
...
| Posibles superiores          | [**Organización de unidad**](c-organizationalunit.md)[**organizativa**](c-organization.md)    |
| Clases auxiliares           | \-                                                                                           |
