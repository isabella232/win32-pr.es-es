...
---
# <a name="ms-tapi-rt-person-class"></a>clase MS-TAPI-RT-Person

Se usa para asignar un usuario a la dirección IP del equipo en el que el usuario ha iniciado sesión para su uso en conferencias de multidifusión de TAPI.



| Entrada | Value |
|-------------------|-----------------------------------------------------------------------------------|
| CN                | MS-TAPI-RT-persona                                                                 |
| Nombre para mostrar de LDAP | msTAPI-RtPerson                                                                   |
| Actualizar privilegio  | No se requieren privilegios especiales.                                                   |
| Frecuencia de actualización  | Cada vez que un cliente TAPI se inicia después de haber registrado en el directorio TAPI. |
| Identificador de esquema-GUID    | 53ea1cb5-b704-4df9-818f-5cb4ec86cac1                                              |
...
| Posibles superiores          | [**Organización de la unidad organizativa**](c-organizationalunit.md)[](c-organization.md)    |
| Clases auxiliares           | \-                                                                                           |
...
| [**Dirección IP de MS-TAPI**](a-mstapi-ipaddress.md)                            | False     | **MS-TAPI-RT-persona**           |
| [**Identificador único de MS-TAPI**](a-mstapi-uid.md)                           | False     | **MS-TAPI-RT-persona**           |
