...
---
# <a name="leaf-class"></a>Clase hoja

Clase base para los objetos hoja.
...
|-------------------|--------------------------------------|
| CN                | Hoja                                 |
| Nombre para mostrar de LDAP | hoja                                 |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | bf967a9e-0de6-11d0-a285-00aa003049e2 |
