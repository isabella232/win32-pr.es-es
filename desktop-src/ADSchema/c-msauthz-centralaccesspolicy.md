...
---
# <a name="ms-authz-central-access-policy-class"></a>clase MS-authz-central-Access-Policy

Una clase que define los objetos de directiva de acceso central.
...
| Nombre para mostrar de LDAP | msAuthz-CentralAccessPolicy          |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | a5679cb0-6f9d-432c-8b75-1e3e834f02aa |
