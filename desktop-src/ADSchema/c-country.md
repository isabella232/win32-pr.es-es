---
title: Country (clase)
description: El país o región en la dirección del usuario. Este es el nombre completo.
ms.assetid: 0cfc1695-e7c5-4bd1-b6d9-5db5af92f739
ms.tgt_platform: multiple
keywords:
- Esquema de AD de clase de país
...
ms.locfileid: "119643725"
---
# <a name="country-class"></a>Country (clase)

El país o región en la dirección del usuario. Este es el nombre completo.
...
| Privilegio actualizar  | El propietario de la cuenta o el administrador de dominio establecen este valor. |
...
| Rdn-Att-Id                  | [**Nombre de país**](a-c.md)<br/>                                                       |
...
| [**Nombre de país**](a-c.md)                                               | Verdadero      | **País**                     |
...
| [**Search-Guide**](a-searchguide.md)                                     | Falso     | **País**                     |
...
| [**Text-Country**](a-co.md)                                              | Falso     | **País**                     |
...
| Rdn-Att-Id                  | [**Nombre de país**](a-c.md)<br/>                                                       |
| Subclase de                 | [**Arriba**](c-top.md)<br/>                                                              |
| Posibles superiores          | [**DNS**](c-organization.md)[**de dominio de la organización**](c-domaindns.md)                      |
| Clases auxiliares           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Descriptor de seguridad predeterminado | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
...
| Rdn-Att-Id                  | [**Nombre de país**](a-c.md)<br/>                                  |
| Subclase de                 | [**Arriba**](c-top.md)<br/>                                         |
| Posibles superiores          | [**DNS**](c-organization.md)[**de dominio de organización**](c-domaindns.md) |
| Clases auxiliares           | \-                                                                      |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                            |
