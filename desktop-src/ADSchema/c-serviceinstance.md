...
Un objeto de punto de conexión utilizado por el servicio de nombres de registro y resolución de Windows Sockets (RnR), al que se tiene acceso a través de las API de Windows Sockets WSA \* .
...
|-------------------|--------------------------------------|
| CN                | Service-Instance                     |
| Nombre para mostrar de LDAP | serviceInstance                      |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | bf967ab2-0de6-11d0-a285-00aa003049e2 |
...
| [**Nombre para mostrar**](a-displayname.md)                                     | True      | **Nivel de instancia de servicio** [](c-top.md)<br/>                                     |
...
| [**IDENTIFICADOR de clase de servicio**](a-serviceclassid.md)                              | True      | **Instancia de servicio**                                                                     |
| [**Versión de instancia de servicio**](a-serviceinstanceversion.md)              | False     | **Instancia de servicio**                                                                     |
...
| [**Direcciones Winsock**](a-winsockaddresses.md)                           | False     | **Instancia de servicio**                                                                     |
