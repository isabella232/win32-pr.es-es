...
---
# <a name="ipsec-policy-class"></a>Ipsec-Policy (clase)

La clase de **directiva IPSec** es solo para uso interno.
...
|-------------------|--------------------------------------|
| CN                | Ipsec-Policy                         |
| Nombre para mostrar de LDAP | ipsecPolicy                          |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | b7b13121-b82e-11d0-afee-0000f80367c1 |
...
| [**IPSec-ISAKMP-referencia**](a-ipsecisakmpreference.md)                  | False     | **Ipsec-Policy**                             |
