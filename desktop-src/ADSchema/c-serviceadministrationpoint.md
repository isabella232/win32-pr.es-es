...
---
# <a name="service-administration-point-class"></a>Service-Administration-Class (clase)
...
| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Servicio: punto de administración         |
| Nombre para mostrar de LDAP | serviceAdministrationPoint           |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | b7b13123-b82e-11d0-afee-0000f80367c1 |
