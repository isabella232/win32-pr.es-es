---
title: Clase Service-Administration-Point
...
keywords:
- Esquema de AD de la clase Service-Administration-Point
- serviceAdministrationPoint class AD Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119548985"
---
# <a name="service-administration-point-class"></a>Clase Service-Administration-Point

Contiene información de enlace para conectarse a un servicio para administrarlo.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Punto de administración de servicios         |
