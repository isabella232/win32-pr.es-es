---
title: ms-DFSR-LocalSettings (clase)
description: Contiene la configuración Sistema de archivos distribuido servicio de replicación dfs (DFS) que se aplica al equipo local.
...
ms.locfileid: "120065365"
---
# <a name="ms-dfsr-localsettings-class"></a>ms-DFSR-LocalSettings (clase)

Contiene la configuración Sistema de archivos distribuido servicio de replicación dfs (DFS) que se aplica al equipo local.
...
La **clase ms-DFSR-LocalSettings** forma parte de la compatibilidad Replicación DFS servicio.
