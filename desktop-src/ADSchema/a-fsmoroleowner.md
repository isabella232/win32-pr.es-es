...
description: Operación Single-Master flexible El nombre distintivo del controlador de dominio donde se puede modificar el esquema.
ms.assetid: 8eb28524-4bbf-453c-89ab-864ef94b0781
ms.tgt_platform: multiple
keywords:
- Esquema de AD del atributo FSMO-Role-Owner
- Esquema de AD del atributo fSMORoleOwner
topic_type:
- apiref
api_name:
- FSMO-Role-Owner
...
ms.locfileid: "118961384"
---
# <a name="fsmo-role-owner-attribute"></a>Atributo FSMO-Role-Owner

Operación de Single-Master flexible: nombre distintivo del controlador de dominio donde se puede modificar el esquema.
