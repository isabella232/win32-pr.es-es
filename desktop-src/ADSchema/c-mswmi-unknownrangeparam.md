---
title: ms-WMI-UnknownRangeParam (clase)
description: Admite tipos de parámetros de los que no sabemos nada, por lo que se transportan como objetos WMI compilados.
ms.assetid: a513da7c-8169-4f78-b5ef-a035076faa86
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-WMI-UnknownRangeParam
- Esquema de AD de la clase msWMI-UnknownRangeParam
topic_type:
- apiref
api_name:
...
ms.locfileid: "119753625"
---
# <a name="ms-wmi-unknownrangeparam-class"></a>ms-WMI-UnknownRangeParam (clase)

Admite tipos de parámetros de los que no sabemos nada, por lo que se transportan como objetos WMI compilados.
...
| [**ms-WMI-NormalizedClass**](a-mswmi-normalizedclass.md)                   | Verdadero      | **ms-WMI-UnknownRangeParam**                               |
...
| [**ms-WMI-TargetObject**](a-mswmi-targetobject.md)                         | Verdadero      | **ms-WMI-UnknownRangeParam**                               |
