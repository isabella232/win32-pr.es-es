...
---
# <a name="control-access-right-class"></a>Clase de acceso de control-Right
...
| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Control-acceso-derecha                 |
| Nombre para mostrar de LDAP | controlAccessRight                   |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 8297931e-86d3-11d0-afda-00c04fd930c9 |
...
| [**Aplicable a**](a-appliesto.md)                                         | False     | **Control-acceso-derecha**        |
...
| [**Localización: ID. de presentación**](a-localizationdisplayid.md)                | False     | **Control-acceso-derecha**        |
...
| [**Rights-GUID**](a-rightsguid.md)                                       | False     | **Control-acceso-derecha**        |
...
| [**Válido: accesos**](a-validaccesses.md)                                 | False     | **Control-acceso-derecha**        |
