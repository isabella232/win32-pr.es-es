---
title: Clase Control-Access-Right
...
keywords:
- Esquema de AD de la clase Control-Access-Right
- ControlAccessRight (clase) Esquema de AD
topic_type:
- apiref
api_name:
...
ms.locfileid: "118423205"
---
# <a name="control-access-right-class"></a>Clase Control-Access-Right

Identifica un derecho extendido que se puede conceder o revocar mediante una ACL.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Control-acceso-derecho                 |
...
| [**Applies-To**](a-appliesto.md)                                         | Falso     | **Control-acceso-derecho**        |
...
| [**Localization-Display-Id**](a-localizationdisplayid.md)                | Falso     | **Control-acceso-derecho**        |
...
| [**Rights-Guid**](a-rightsguid.md)                                       | Falso     | **Control-acceso-derecho**        |
...
| [**Accesos válidos**](a-validaccesses.md)                                 | Falso     | **Control-acceso-derecho**        |
...
| [**Allowed-Child-Classes**](a-allowedchildclasses.md)                      | Falso     | [**Arriba**](c-top.md)<br/> |
| [**Allowed-Child-Classes-Effective**](a-allowedchildclasseseffective.md)   | Falso     | [**Arriba**](c-top.md)<br/> |
| [**Se aplica a**](a-appliesto.md)                                           | Falso     | **Control-acceso-derecho**        |
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falso     | [**Arriba**](c-top.md)<br/> |
| [**Canonical-Name**](a-canonicalname.md)                                   | Falso     | [**Arriba**](c-top.md)<br/> |
