...
---
# <a name="ipsec-negotiation-policy-class"></a>Clase de directiva de negociación de IPSec

La clase de **Directiva de negociación IPSec** es solo para uso interno.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Directiva de negociación de IPSec             |
| Nombre para mostrar de LDAP | ipsecNegotiationPolicy               |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | b40ff827-427a-11d1-a9c2-0000f80367c1 |
...
| Subclase de                 | [**IPSec: base**](c-ipsecbase.md)<br/>                                                                      |
| Posibles superiores          | [](c-computer.md)[**Unidad organizativa de equipo de**](c-organizationalunit.md) [**contenedor**](c-container.md) |
| Clases auxiliares           | \-                                                                                                                |
...
| [**IPSec-datos**](a-ipsecdata.md)                                         | False     | [**IPSec: base**](c-ipsecbase.md)<br/> |
| [**IPSec-tipo de datos**](a-ipsecdatatype.md)                                | False     | [**IPSec: base**](c-ipsecbase.md)<br/> |
| [**IDENTIFICADOR de IPSec**](a-ipsecid.md)                                             | False     | [**IPSec: base**](c-ipsecbase.md)<br/> |
| [**Nombre de IPSec**](a-ipsecname.md)                                         | False     | [**IPSec: base**](c-ipsecbase.md)<br/> |
| [**IPSEC-negociación-Directiva-acción**](a-ipsecnegotiationpolicyaction.md) | False     | **Directiva de negociación de IPSec**                 |
| [**IPSEC-negociación-tipo de Directiva**](a-ipsecnegotiationpolicytype.md)     | False     | **Directiva de negociación de IPSec**                 |
| [**Referencia de IPSec-owners**](a-ipsecownersreference.md)                  | False     | [**IPSec: base**](c-ipsecbase.md)<br/> |
...
| Clases auxiliares           | \-                                                                                                                |
| Descriptor de NT-Security-      | O:BAG: BAD: S:                                                                                                      |
| Descriptor de seguridad predeterminado | D.                                                                                                                |
| System-Flags                | 0x00000010                                                                                                        |
