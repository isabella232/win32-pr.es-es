...
keywords:
- Esquema de AD del atributo Modify-Time-Stamp
- Esquema de AD del atributo modifyTimeStamp
topic_type:
- apiref
api_name:
- Modify-Time-Stamp
...
ms.locfileid: "119300375"
---
# <a name="modify-time-stamp-attribute"></a>Atributo Modify-Time-Stamp

Atributo calculado que representa la fecha en que se cambió por última vez este objeto. Este valor no se replica.



| Entrada | Value |
|-------------------|---------------------------------------------------------------|
| CN                | Modificación de marca de tiempo                                             |
...
| Clases usadas en        | [**SubSchema**](c-subschema.md)<br/> [**Arriba**](c-top.md)<br/> |
