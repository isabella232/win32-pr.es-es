...
---
# <a name="posixaccount-class"></a>clase posixAccount

Representa una abstracción de una cuenta con atributos POSIX (portable Operating System Interface).
...
|-------------------|--------------------------------------|
| CN                | posixAccount                         |
| Nombre para mostrar de LDAP | posixAccount                         |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | ad44bb41-67d5-4d88-b575-7b20674e76d8 |
...
| [**Nombre común**](a-cn.md)                                                 | False     | **posixAccount** [ **superior**](c-top.md)<br/> |
| [**Creación: marca de tiempo**](a-createtimestamp.md)                              | False     | [**Arriba**](c-top.md)<br/>                  |
| [**Descripción**](a-description.md)                                        | False     | **posixAccount** [ **superior**](c-top.md)<br/> |
...
| [**Directorio principal**](a-homedirectory.md)                                   | False     | **posixAccount**                                 |
...
| [**Contraseña de usuario**](a-userpassword.md)                                     | False     | **posixAccount**                                 |
