...
---
# <a name="friendlycountry-class"></a>clase friendlyCountry

La clase de objeto friendlyCountry se usa para definir las entradas de país o región en el DIT.
...
|-------------------|--------------------------------------|
| CN                | friendlyCountry                      |
| Nombre para mostrar de LDAP | friendlyCountry                      |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | c498f152-dc6b-474a-9f52-7cdba3d7d351 |
...
| Subclase de                 | [**País**](c-country.md)<br/>                                                          |
| Posibles superiores          | \-                                                                                               |
| Clases auxiliares           | \-                                                                                               |
...
| [**Nombre del país**](a-c.md)                                                 | True      | [**País**](c-country.md)<br/>                     |
...
| [**Guía de búsqueda**](a-searchguide.md)                                       | False     | [**País**](c-country.md)<br/>                     |
...
| [**Texto: país**](a-co.md)                                                | True      |  [ **país** friendlyCountry](c-country.md)<br/> |
