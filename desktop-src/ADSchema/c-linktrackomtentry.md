---
title: Link-Track-OMT-Entry (clase)
description: Realiza un seguimiento del vínculo de los objetos que se han movido.
ms.assetid: d2b27f10-1e94-4385-a86d-6153e0eeabf6
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase Link-Track-OMT-Entry
...
ms.locfileid: "118423096"
---
# <a name="link-track-omt-entry-class"></a>Link-Track-OMT-Entry (clase)

Realiza un seguimiento del vínculo de los objetos que se han movido.
