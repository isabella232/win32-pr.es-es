...
---
# <a name="link-track-omt-entry-class"></a>Clase Link-Track-OMT-entry

Hace un seguimiento del vínculo de los objetos que se han despasado.
...
| Nombre para mostrar de LDAP | linkTrackOMTEntry                    |
| Actualizar privilegio  | El sistema establece este valor.     |
| Frecuencia de actualización  | Cada vez que cambia un vínculo a un archivo.   |
| Identificador de esquema-GUID    | ddac0cf7-af8f-11d0-afeb-00c04fd930c9 |
...
| [**Nacimiento-ubicación**](a-birthlocation.md)                                 | False     | **Link-Track-OMT-entry**        |
...
| [**Ubicación actual**](a-currentlocation.md)                             | False     | **Link-Track-OMT-entry**        |
...
| [**Actualización de hora**](a-timerefresh.md)                                     | False     | **Link-Track-OMT-entry**        |
