...
---
# <a name="ms-pki-enterprise-oid-class"></a>clase MS-PKI-Enterprise-OID
...
| Nombre para mostrar de LDAP | Atributo mspki-Enterprise-OID                                                                         |
| Actualizar privilegio  | Administrador de dominio                                                                         |
| Frecuencia de actualización  | Se actualiza cuando el administrador ejecuta certutil.exe para almacenar el nombre localizado de cada OID. |
| Identificador de esquema-GUID    | 37cfd85c-6719-4ad8-8f9e-8678ba627563                                                         |
...
| Posibles superiores          | [**Contenedor**](c-container.md)**MS-PKI-Enterprise-OID**                                    |
| Clases auxiliares           | \-                                                                                           |
...
| [**Atributo MS-PKI-OID-**](a-mspki-oid-attribute.md)                       | False     | **MS-PKI-Enterprise-OID**       |
...
| [**MS-PKI-OID-usuario-aviso**](a-mspki-oid-user-notice.md)                   | False     | **MS-PKI-Enterprise-OID**       |
