---
title: rpc-Profile (clase)
description: Representa un perfil RPC.
ms.assetid: 5cf8b668-697b-44ca-8622-95637bc91436
ms.tgt_platform: multiple
keywords:
- Rpc-Profile class AD Schema (Esquema de AD de la clase rpc-Profile)
- RpcProfile class AD Schema (Esquema de AD de clase rpcProfile)
topic_type:
- apiref
api_name:
- rpc-Profile
...
ms.locfileid: "119643055"
---
# <a name="rpc-profile-class"></a>rpc-Profile (clase)

Representa un perfil RPC.
