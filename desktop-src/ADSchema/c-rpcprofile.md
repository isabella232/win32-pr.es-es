...
---
# <a name="rpc-profile-class"></a>RPC: clase de perfil

Representa un perfil de RPC.
...
|-------------------|--------------------------------------|
| CN                | Perfil de RPC                          |
| Nombre para mostrar de LDAP | rpcProfile                           |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 88611be1-8cf4-11d0-afda-00c04fd930c9 |
