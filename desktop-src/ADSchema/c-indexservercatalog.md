---
title: Index-Server-Catalog (clase)
...
keywords:
- Esquema de AD de la clase Index-Server-Catalog
- IndexServerCatalog class AD Schema (Esquema de AD de la clase indexServerCatalog)
topic_type:
- apiref
api_name:
...
ms.locfileid: "119703745"
---
# <a name="index-server-catalog-class"></a>Index-Server-Catalog (clase)
...
| [**Creador**](a-creator.md)                                              | Verdadero      | **Index-Server-Catalog**                                                                 |
...
| [**Nombres descriptivos**](a-friendlynames.md)                                 | Falso     | **Index-Server-Catalog**                                                                 |
