...
---
# <a name="pki-key-usage-attribute"></a>PKI-atributo de uso de clave

La extensión de uso de clave para la plantilla de certificado.
...
|-------------------|-------------------------------------------------------|
| CN                | PKI-uso de clave                                         |
| Nombre para mostrar de LDAP | pKIKeyUsage                                           |
| Tamaño              | \-                                                    |
