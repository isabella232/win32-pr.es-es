...
---
# <a name="link-track-vol-entry-class"></a>Clase Link-Track-Vol-entry

Entrada para un vínculo a un archivo en un volumen.
...
| Nombre para mostrar de LDAP | linkTrackVolEntry                     |
| Actualizar privilegio  | El sistema establece este valor.      |
| Frecuencia de actualización  | Cada vez que se crea un vínculo a un archivo. |
| Identificador de esquema-GUID    | ddac0cf6-af8f-11d0-afeb-00c04fd930c9  |
...
| Posibles superiores          | [**Link-Track-Volume-Table**](c-linktrackvolumetable.md)                  |
| Clases auxiliares           | \-                                                                         |
...
| [**Identificador de máquina**](a-currmachineid.md)                                | False     | **Link-Track-Vol-entry**        |
...
| [**Vínculo-seguimiento-secreto**](a-linktracksecret.md)                            | False     | **Link-Track-Vol-entry**        |
...
| [**SEQ: notificación**](a-seqnotification.md)                             | False     | **Link-Track-Vol-entry**        |
...
| [**Actualización de hora**](a-timerefresh.md)                                     | False     | **Link-Track-Vol-entry**        |
| [**Tiempo-Vol-cambio**](a-timevolchange.md)                                | False     | **Link-Track-Vol-entry**        |
