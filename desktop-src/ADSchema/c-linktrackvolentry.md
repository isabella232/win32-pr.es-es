---
title: Link-Track-Vol-Entry (clase)
description: Entrada de un vínculo a un archivo de un volumen.
ms.assetid: 96a7a923-4aeb-4408-9d2e-ebac191a06c8
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase Link-Track-Vol-Entry
...
ms.locfileid: "119834935"
---
# <a name="link-track-vol-entry-class"></a>Link-Track-Vol-Entry (clase)

Entrada de un vínculo a un archivo de un volumen.
...
| [**Recuento de objetos**](a-objectcount.md)                                     | Falso     | **Link-Track-Vol-Entry**        |
...
| [**Actualización de tiempo**](a-timerefresh.md)                                     | Falso     | **Link-Track-Vol-Entry**        |
| [**Cambio de volumen de tiempo**](a-timevolchange.md)                                | Falso     | **Link-Track-Vol-Entry**        |
...
| [**Marcas del sistema**](a-systemflags.md)                                       | Falso     | [**Arriba**](c-top.md)<br/> |
| [**Actualización de tiempo**](a-timerefresh.md)                                       | Falso     | **Link-Track-Vol-Entry**        |
| [**Cambio de tiempo**](a-timevolchange.md)                                  | Falso     | **Link-Track-Vol-Entry**        |
| [**USN cambiado**](a-usnchanged.md)                                         | Falso     | [**Arriba**](c-top.md)<br/> |
