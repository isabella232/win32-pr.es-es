...
---
# <a name="intellimirror-scp-class"></a>IntelliMirror: clase SCP

Este objeto contiene información de configuración para el servicio que responde a los clientes de arranque remoto que solicitan atención desde un servidor de instalación remoto.
...
| Nombre para mostrar de LDAP | intellimirrorSCP                               |
| Actualizar privilegio  | El administrador del dominio establece este valor. |
| Frecuencia de actualización  | \-                                             |
| Identificador de esquema-GUID    | 07383085-91df-11d1-aebc-0000f80367c1           |
...
| Subclase de                 | [**Servicio: punto de administración**](c-serviceadministrationpoint.md)<br/>              |
| Posibles superiores          | [**IntelliMirror: Grupo de**](c-intellimirrorgroup.md)[**equipos**](c-computer.md)            |
| Clases auxiliares           | \-                                                                                           |
...
| [**netboot-solo respuesta-válido-clientes**](a-netbootansweronlyvalidclients.md) | False     | **IntelliMirror-SCP**                                                                    |
| [**netboot-respuesta-solicitudes**](a-netbootanswerrequests.md)                   | False     | **IntelliMirror-SCP**                                                                    |
| [**netboot: actual-Client-Count**](a-netbootcurrentclientcount.md)          | False     | **IntelliMirror-SCP**                                                                    |
| [**netboot-IntelliMirror-os**](a-netbootintellimirroroses.md)             | False     | **IntelliMirror-SCP**                                                                    |
| [**netboot-Limit-clients**](a-netbootlimitclients.md)                       | False     | **IntelliMirror-SCP**                                                                    |
| [**netboot: instalado localmente-os**](a-netbootlocallyinstalledoses.md)      | False     | **IntelliMirror-SCP**                                                                    |
...
| [**netboot: servidor**](a-netbootserver.md)                                    | False     | **IntelliMirror-SCP**                                                                    |
| [**netboot-herramientas**](a-netboottools.md)                                      | False     | **IntelliMirror-SCP**                                                                    |
