...
---
# <a name="ntds-connection-class"></a>NTDS-Connection (clase)

Una conexión desde un controlador de dominio remoto.
...
|-------------------|--------------------------------------|
| CN                | NTDS-Connection                      |
| Nombre para mostrar de LDAP | nTDSConnection                       |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 19195a60-6da0-11d0-afd3-00c04fd930c9 |
...
| Posibles superiores          | [**NTDS-DSA**](c-ntdsdsa.md)[**NTFRS-Replica-Set**](c-ntfrsreplicaset.md)[**NTFRS-Member**](c-ntfrsmember.md) |
| Clases auxiliares           | \-                                                                                                               |
...
| [**Habilitada: conexión**](a-enabledconnection.md)                         | True      | **NTDS-conexión**             |
...
| [**De-servidor**](a-fromserver.md)                                       | True      | **NTDS-conexión**             |
...
| [**Conexión generada**](a-generatedconnection.md)                     | False     | **NTDS-conexión**             |
...
| [**MS-DS-Replications-NC-motivo**](a-ms-ds-replicatesncreason.md)          | False     | **NTDS-conexión**             |
...
| [**Opciones**](a-options.md)                                              | True      | **NTDS-conexión**             |
...
| [**Planea**](a-schedule.md)                                            | False     | **NTDS-conexión**             |
...
| [**Tipo de transporte**](a-transporttype.md)                                 | False     | **NTDS-conexión**             |
...
| RDN-ATT-ID                  | [**Nombre común**](a-cn.md)<br/> |
| Subclase de                 | [**Hoja**](c-leaf.md)<br/>      |
| Posibles superiores          | [**NTDS-DSA**](c-ntdsdsa.md)          |
| Clases auxiliares           | \-                                     |
| Descriptor de NT-Security-      | O:BAG: BAD: S:                           |
