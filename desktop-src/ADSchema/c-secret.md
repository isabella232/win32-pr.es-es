---
title: Secret (clase)
description: Un secreto de autoridad de seguridad local. Se usa para relaciones de confianza y para guardar contraseñas de servicio.
ms.assetid: 762b4892-d9f3-458a-8ec2-f7dc24ddaf2f
ms.tgt_platform: multiple
keywords:
- Esquema de AD de clase secreta
...
ms.locfileid: "119533975"
---
# <a name="secret-class"></a>Secret (clase)

Un secreto de autoridad de seguridad local. Se usa para relaciones de confianza y para guardar contraseñas de servicio.
...
| Descriptor de seguridad predeterminado | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) |
...
| [**Valor actual**](a-currentvalue.md)                                   | Falso     | **Secreto**                      |
...
| [**Hora del último conjunto**](a-lastsettime.md)                                    | Falso     | **Secreto**                      |
...
| [**Prior-Set-Time**](a-priorsettime.md)                                  | Falso     | **Secreto**                      |
| [**Valor anterior**](a-priorvalue.md)                                       | Falso     | **Secreto**                      |
