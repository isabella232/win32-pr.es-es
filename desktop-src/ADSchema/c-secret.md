...
Un secreto de autoridad de seguridad local. Se usa para las relaciones de confianza y para guardar contraseñas de servicio.
...
|-------------------|--------------------------------------|
| CN                | Secreto                               |
| Nombre para mostrar de LDAP | secret                               |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | bf967aae-0de6-11d0-a285-00aa003049e2 |
...
| [**Valor actual**](a-currentvalue.md)                                   | False     | **Secreto**                      |
...
| [**Hora del último conjunto**](a-lastsettime.md)                                    | False     | **Secreto**                      |
...
| [**En tiempo de establecimiento anterior**](a-priorsettime.md)                                  | False     | **Secreto**                      |
| [**Valor anterior**](a-priorvalue.md)                                       | False     | **Secreto**                      |
