...
---
# <a name="address-book-container-class"></a>Clase de contenedor de libreta de direcciones

Contenedor para mantener a los miembros de una vista de libreta de direcciones.
...
| Nombre para mostrar de LDAP | addressBookContainer                 |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 3e74f60f-3e73-11d1-a9c0-0000f80367c1 |
...
| Posibles superiores          | [](c-configuration.md)**Dirección de configuración: Book-Container**                                                                            |
| Clases auxiliares           | \-                                                                                                                                            |
| Descriptor de NT-Security-      | O:BAG: BAD: S:                                                                                                                                  |
| Descriptor de seguridad predeterminado | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; AU) (OA;; CR; a1990816-4298-11D1-ade2-00c04fd8d5cd;; ESTÉ |
...
| [**Nombre para mostrar**](a-displayname.md)                                     | True      | **Address-Book-Container** [ **superior**](c-top.md)<br/> |
...
| [**Búsqueda supuesta**](a-purportedsearch.md)                             | False     | **Address-Book-Container**                                 |
...
| Nombre común                                      |
|--------------------------------------------------|
| [**Libreta de direcciones abiertas**](r-open-address-book.md) |
