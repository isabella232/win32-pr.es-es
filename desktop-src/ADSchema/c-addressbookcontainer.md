---
title: Clase Address-Book-Container
description: Contenedor para contener miembros de una vista de libreta de direcciones.
ms.assetid: 7f08530a-6113-4815-b6df-625e35be86d9
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase Address-Book-Container
- AddressBookContainer (clase AD) Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119644115"
---
# <a name="address-book-container-class"></a>Clase Address-Book-Container

Contenedor para contener miembros de una vista de libreta de direcciones.
...
| Posibles superiores          | [**Contenedor de**](c-configuration.md)**libretas de direcciones de configuración**                                                                            |
| Clases auxiliares           | \-                                                                                                                                            |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                                                                  |
| Descriptor de seguridad predeterminado | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU)(OA;; CR;a1990816-4298-11d1-ade2-00c04fd8d5cd;; AU) |
...
| [**Nombre para mostrar**](a-displayname.md)                                     | Verdadero      | **Address-Book-Container** [ **Top**](c-top.md)<br/> |
...
| [**Purported-Search**](a-purportedsearch.md)                             | Falso     | **Address-Book-Container**                                 |
...
| Subclase de                 | [**Arriba**](c-top.md)<br/>                                                                                                               |
| Posibles superiores          | [**Dirección**](c-configuration.md)**de configuración-Book-Container**                                                                            |
| Clases auxiliares           | \-                                                                                                                                            |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                                                                  |
| Descriptor de seguridad predeterminado | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU)(OA;; CR;a1990816-4298-11d1-ade2-00c04fd8d5cd;; AU) |
| System-Flags                | 0x00000010                                                                                                                                    |
