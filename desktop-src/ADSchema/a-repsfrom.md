...
---
# <a name="reps-from-attribute"></a>Reps-From atributo)

Enumera los servidores de los que el directorio aceptará los cambios en el contexto de nomenclatura definido.
...
|-------------------|-------------------------------------------------------|
| CN                | Reps-From                                             |
| Nombre para mostrar de LDAP | repsFrom                                              |
| Tamaño              | \-                                                    |
