...
---
# <a name="oncrpc-class"></a>clase oncRpc

Representa una abstracción del enlace RPC (llamada a procedimiento remoto) de Open Network Computing (ONC).
...
|-------------------|--------------------------------------|
| CN                | oncRpc                               |
| Nombre para mostrar de LDAP | oncRpc                               |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | cadd1e5e-fefc-4f3f-b5a9-70e994204303 |
...
| [**Nombre común**](a-cn.md)                                                 | True      | **oncRpc** [ **superior**](c-top.md)<br/> |
| [**Creación: marca de tiempo**](a-createtimestamp.md)                              | False     | [**Arriba**](c-top.md)<br/>            |
| [**Descripción**](a-description.md)                                        | False     | **oncRpc** [ **superior**](c-top.md)<br/> |
...
| [**msSFU-30-alias**](a-mssfu30aliases.md)                                | False     | **oncRpc**                                 |
| [**msSFU-30-nombre**](a-mssfu30name.md)                                      | False     | **oncRpc**                                 |
| [**msSFU-30-NIS-dominio**](a-mssfu30nisdomain.md)                           | False     | **oncRpc**                                 |
