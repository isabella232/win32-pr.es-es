---
title: oncRpc (clase)
description: Representa una abstracción del enlace de llamada a procedimiento remoto (RPC) de Open Network Computing (ONC).
ms.assetid: 05fb9e0b-2fc2-4bbe-9083-f3f383e97b2b
ms.tgt_platform: multiple
keywords:
- OncRpc class AD Schema (Esquema de AD de la clase oncRpc)
topic_type:
- apiref
api_name:
- oncRpc
...
ms.locfileid: "118959754"
---
# <a name="oncrpc-class"></a>oncRpc (clase)

Representa una abstracción del enlace de llamada a procedimiento remoto (RPC) de Open Network Computing (ONC).
...
| [**Common-Name**](a-cn.md)                                                 | Verdadero      | **oncRpc** [ **Top**](c-top.md)<br/> |
| [**Create-Time-Stamp**](a-createtimestamp.md)                              | Falso     | [**Arriba**](c-top.md)<br/>            |
| [**Descripción**](a-description.md)                                        | Falso     | **oncRpc** [ **Top**](c-top.md)<br/> |
...
| [**oncRpcNumber**](a-oncrpcnumber.md)                                      | Verdadero      | **oncRpc**                                 |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)                  | Falso     | [**Arriba**](c-top.md)<br/>            |
| [**Canonical-Name**](a-canonicalname.md)                                      | Falso     | [**Arriba**](c-top.md)<br/>            |
| [**Nombre común**](a-cn.md)                                                    | Verdadero      | **oncRpc** [ **Top**](c-top.md)<br/> |
