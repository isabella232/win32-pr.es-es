---
title: msSFU-30-Mail-Aliases (clase)
description: Representa UNIX archivo de correo electrónico.
ms.assetid: b2206252-1547-4c25-ac12-c75775066b31
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase msSFU-30-Mail-Aliases
...
ms.locfileid: "119879575"
---
# <a name="mssfu-30-mail-aliases-class"></a>msSFU-30-Mail-Aliases (clase)

Representa UNIX archivo de correo electrónico.
...
| Subclase de                 | [**Arriba**](c-top.md)<br/>                                                              |
| Posibles superiores          | [**Dominio-DNS**](c-container.md)de [**nisMap**](c-nismap.md)[**del contenedor**](c-domaindns.md)  |
| Clases auxiliares           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Descriptor de seguridad predeterminado | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000000                                                                                   |
