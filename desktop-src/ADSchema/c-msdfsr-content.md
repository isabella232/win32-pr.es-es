...
---
# <a name="ms-dfsr-content-class"></a>MS-DFSR: clase de contenido

Representa un contenedor de objetos [**MS-DFSR-ContentSet**](c-msdfsr-contentset.md) .



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Contenido de MS-DFSR                      |
| Nombre para mostrar de LDAP | Contenido de msDFSR                       |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 64759b35-d3a1-42e4-b5f1-a3de162109b3 |
...
| Posibles superiores          | [**MS-DFSR-grupo**](c-msdfsr-replicationgroup.md)                                                                    |
| Clases auxiliares           | \-                                                                                                                               |
...
| [**Extensión MS-DFSR-**](a-msdfsr-extension.md)                             | False     | **Contenido de MS-DFSR**             |
| [**MS-DFSR-marcas**](a-msdfsr-flags.md)                                     | False     | **Contenido de MS-DFSR**             |
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | False     | [**Arriba**](c-top.md)<br/> |
| [**Opciones de MS-DFSR**](a-msdfsr-options.md)                                 | False     | **Contenido de MS-DFSR**             |
...
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | False     | [**Arriba**](c-top.md)<br/> |
| [**Opciones de MS-DFSR**](a-msdfsr-options.md)                                    | False     | **Contenido de MS-DFSR**             |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                  | False     | **Contenido de MS-DFSR**             |
| [**MS-DS-aprox-immed-subordinados**](a-msds-approx-immed-subordinates.md)    | False     | [**Arriba**](c-top.md)<br/> |
...
La clase **MS-DFSR-Content** es una parte de la compatibilidad con el servicio de replicación sistema de archivos distribuido (DFS).
