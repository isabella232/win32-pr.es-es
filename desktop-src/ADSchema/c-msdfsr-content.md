---
title: ms-DFSR-Content (clase)
description: Representa un contenedor para objetos ms-DFSR-ContentSet.
ms.assetid: b1defe9e-46d8-4db8-b885-0196fd218332
ms.tgt_platform: multiple
keywords:
- Esquema de AD de la clase ms-DFSR-Content
- Esquema de AD de la clase msDFSR-Content
topic_type:
- apiref
api_name:
- ms-DFSR-Content
...
ms.locfileid: "119880695"
---
# <a name="ms-dfsr-content-class"></a>ms-DFSR-Content (clase)

Representa un contenedor para [**objetos ms-DFSR-ContentSet.**](c-msdfsr-contentset.md)
...
| Posibles superiores          | [**ms-DFSR-ReplicationGroup**](c-msdfsr-replicationgroup.md)                                                                    |
| Clases auxiliares           | \-                                                                                                                               |
...
La **clase ms-DFSR-Content** forma parte de la compatibilidad del servicio de replicación Sistema de archivos distribuido (DFS).
