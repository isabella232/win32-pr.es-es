...
---
# <a name="cost-attribute"></a>Cost (atributo)

Contiene el costo relativo para enrutar los mensajes a través de un conector de sitio determinado.
...
|-------------------|--------------------------------------|
| CN                | Costos                                 |
| Nombre para mostrar de LDAP | cost                                 |
| Tamaño              | \-                                   |
