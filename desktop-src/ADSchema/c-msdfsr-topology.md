...
---
# <a name="ms-dfsr-topology-class"></a>clase de topología MS-DFSR

Contiene los objetos que forman la topología de replicación.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | MS-DFSR-topología                     |
| Nombre para mostrar de LDAP | msDFSR: topología                      |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 04828aa9-6e42-4e80-b962-e2fe00754d17 |
...
| [**Extensión MS-DFSR-**](a-msdfsr-extension.md)                             | False     | **MS-DFSR-topología**            |
| [**MS-DFSR-marcas**](a-msdfsr-flags.md)                                     | False     | **MS-DFSR-topología**            |
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | False     | [**Arriba**](c-top.md)<br/> |
| [**Opciones de MS-DFSR**](a-msdfsr-options.md)                                 | False     | **MS-DFSR-topología**            |
...
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | False     | [**Arriba**](c-top.md)<br/> |
| [**Opciones de MS-DFSR**](a-msdfsr-options.md)                                    | False     | **MS-DFSR-topología**            |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                  | False     | **MS-DFSR-topología**            |
| [**MS-DS-aprox-immed-subordinados**](a-msds-approx-immed-subordinates.md)    | False     | [**Arriba**](c-top.md)<br/> |
...
La clase **MS-DFSR-Topology** es una parte de la compatibilidad con el servicio de replicación sistema de archivos distribuido (DFS).
