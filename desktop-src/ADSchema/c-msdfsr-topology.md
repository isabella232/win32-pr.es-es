...
keywords:
- Esquema de AD de la clase ms-DFSR-Topology
- Esquema de AD de la clase msDFSR-Topology
topic_type:
- apiref
api_name:
- ms-DFSR-Topology
...
ms.locfileid: "118959864"
---
# <a name="ms-dfsr-topology-class"></a>ms-DFSR-Topology (clase)
...
La **clase ms-DFSR-Topology** forma parte de la compatibilidad del servicio de replicación Sistema de archivos distribuido (DFS).
