...
---
# <a name="ms-sql-olapcube-class"></a>Clase MS-SQL-OLAPCube

Clase para almacenar SQL Server propiedades de cubo OLAP.
...
|-------------------|--------------------------------------|
| CN                | MS-SQL-OLAPCube                      |
| Nombre para mostrar de LDAP | mS-SQL-OLAPCube                      |
| Actualizar privilegio  | El sistema establece este valor.     |
| Frecuencia de actualización  | En el programa de instalación del sistema.                     |
| Identificador de esquema-GUID    | 09f0506a-cd28-11d2-9993-0000f87a57d4 |
...
| Posibles superiores          | [**MS-SQL-OLAPDatabase**](c-ms-sql-olapdatabase.md)                                         |
| Clases auxiliares           | \-                                                                                           |
...
| [**Contacto de MS-SQL**](a-ms-sql-contact.md)                                | False     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Descripción**](a-ms-sql-description.md)                        | False     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | False     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-palabras clave**](a-ms-sql-keywords.md)                              | False     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                | False     | **MS-SQL-OLAPCube**             |
| [**Nombre MS-SQL**](a-ms-sql-name.md)                                      | False     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-PublicationURL**](a-ms-sql-publicationurl.md)                  | False     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-size**](a-ms-sql-size.md)                                      | False     | **MS-SQL-OLAPCube**             |
| [**Estado de MS-SQL**](a-ms-sql-status.md)                                  | False     | **MS-SQL-OLAPCube**             |
