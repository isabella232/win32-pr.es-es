...
---
# <a name="ms-dfs-link-v2-class"></a>clase MS-DFS-Link-V2

Vínculo DFS en el espacio de nombres DFS.
...
|-------------------|--------------------------------------|
| CN                | MS-DFS-Link-V2                       |
| Nombre para mostrar de LDAP | msDFS-Linkv2                         |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 7769fb7a-1159-4e96-9ccd-68bc487073eb |
...
| [**MS-DFS-comment-V2**](a-msdfs-commentv2.md)                                 | False     | **MS-DFS-Link-V2**              |
| [**MS-DFS-generación-GUID-V2**](a-msdfs-generationguidv2.md)                  | True      | **MS-DFS-Link-V2**              |
...
| [**MS-DFS-Link-Security-Descriptor-V2**](a-msdfs-linksecuritydescriptorv2.md) | False     | **MS-DFS-Link-V2**              |
...
| [**MS-DFS-Short-Name-Link-path-V2**](a-msdfs-shortnamelinkpathv2.md)          | False     | **MS-DFS-Link-V2**              |
