...
---
# <a name="dns-node-class"></a>Dns-Node (clase)

Contiene los registros de recursos DNS para un solo host.
...
|-------------------|--------------------------------------|
| CN                | Dns-Node                             |
| Nombre para mostrar de LDAP | dnsNode                              |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | e0fa1e8c-9b45-11d0-afdd-00c04fd930c9 |
...
| Posibles superiores          | [**Zona DNS**](c-dnszone.md)                                                                                                                                        |
| Clases auxiliares           | \-                                                                                                                                                                   |
| Descriptor de NT-Security-      | O:BAG: BAD: S:                                                                                                                                                         |
| Descriptor de seguridad predeterminado | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; ED) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; CO) (A;; RPLCLORC;;; WD |
...
| [**Propiedad de DNS**](a-dnsproperty.md)                                     | False     | **Nodo DNS**                    |
| [**Registro DNS**](a-dnsrecord.md)                                         | False     | **Nodo DNS**                    |
| [**DNS-con marcadores de exclusión**](a-dnstombstoned.md)                                 | False     | **Nodo DNS**                    |
| [**Componente de dominio**](a-dc.md)                                          | True      | **Nodo DNS**                    |
