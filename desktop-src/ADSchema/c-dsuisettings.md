...
---
# <a name="ds-ui-settings-class"></a>DS-UI-Settings (clase)

Se usa para almacenar los valores de configuración utilizados por el complemento usuarios y equipos de Active Directory.
...
| Nombre para mostrar de LDAP | dSUISettings                         |
| Actualizar privilegio  | Administrador de dominio.                |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 09b10f14-6f93-11d2-9905-0000f87a57d4 |
...
| [**DS-UI-admin-máximo**](a-dsuiadminmaximum.md)                         | False     | **DS-UI-configuración**              |
| [**DS-UI-admin-Notification**](a-dsuiadminnotification.md)               | False     | **DS-UI-configuración**              |
| [**DS-UI-Shell-máximo**](a-dsuishellmaximum.md)                         | False     | **DS-UI-configuración**              |
...
| [**MS-DS-Consistency-Child-Count**](a-ms-ds-consistencychildcount.md)                    | False     | [**Arriba**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                                 | False     | [**Arriba**](c-top.md)<br/> |
| [**MS-DS-Filter-containers**](a-msds-filtercontainers.md)                                | False     | **DS-UI-configuración**              |
...
| [**MS-DS-non-Security-Group-extra-classes**](a-msds-non-security-group-extra-classes.md) | False     | **DS-UI-configuración**              |
...
| [**MS-DS-Security-Group-clases adicionales**](a-msds-security-group-extra-classes.md)         | False     | **DS-UI-configuración**              |
