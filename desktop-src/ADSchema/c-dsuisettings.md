---
title: Clase DS-UI-Configuración
description: Se usa para almacenar los valores de configuración que usa Usuarios y equipos de Active Directory complemento.
ms.assetid: b638cb25-3de6-4e3c-a3a3-6b17a8976388
ms.tgt_platform: multiple
keywords:
- DS-UI-Configuración esquema de AD
...
ms.locfileid: "119801795"
---
# <a name="ds-ui-settings-class"></a>Clase DS-UI-Configuración

Se usa para almacenar los valores de configuración que usa Usuarios y equipos de Active Directory complemento.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | DS-UI-Configuración                       |
...
| [**DS-UI-Admin-Maximum**](a-dsuiadminmaximum.md)                         | Falso     | **DS-UI-Configuración**              |
| [**DS-UI-Admin-Notification**](a-dsuiadminnotification.md)               | Falso     | **DS-UI-Configuración**              |
| [**DS-UI-Shell-Maximum**](a-dsuishellmaximum.md)                         | Falso     | **DS-UI-Configuración**              |
...
| [**MS-DS-Consistency-Child-Count**](a-ms-ds-consistencychildcount.md)                    | Falso     | [**Arriba**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                                 | Falso     | [**Arriba**](c-top.md)<br/> |
| [**ms-DS-Filter-Containers**](a-msds-filtercontainers.md)                                | Falso     | **DS-UI-Configuración**              |
...
| [**ms-DS-non-Security-Group-Extra-Classes**](a-msds-non-security-group-extra-classes.md) | Falso     | **DS-UI-Configuración**              |
...
| [**ms-DS-Security-Group-Extra-Classes**](a-msds-security-group-extra-classes.md)         | Falso     | **DS-UI-Configuración**              |
