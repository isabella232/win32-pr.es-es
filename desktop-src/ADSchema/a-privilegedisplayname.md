...
---
# <a name="privilege-display-name-attribute"></a>Privileged-Display-Name (atributo)

Nombre para mostrar de un privilegio de Windows NT.



| Entrada | Value |
|-------------------|---------------------------------------------|
| CN                | Privileged-Display-Name                      |
| Nombre para mostrar de LDAP | privilegeDisplayName                        |
| Tamaño              | \-                                          |
