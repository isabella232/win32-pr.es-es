...
---
# <a name="document-class"></a>clase de documento

La clase de objeto de documento se usa para definir entradas que representan documentos.
...
|-------------------|--------------------------------------|
| CN                | documento                             |
| Nombre para mostrar de LDAP | documento                             |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 39bad96d-c2d6-4baf-88ab-7e4207600117 |
...
| [**Nombre común**](a-cn.md)                                                 | False     |  [ **parte superior** del documento](c-top.md)<br/> |
| [**Creación: marca de tiempo**](a-createtimestamp.md)                              | False     | [**Arriba**](c-top.md)<br/>              |
| [**Descripción**](a-description.md)                                        | False     |  [ **parte superior** del documento](c-top.md)<br/> |
...
| [**documentAuthor**](a-documentauthor.md)                                  | False     | **document**                                 |
| [**documentIdentifier**](a-documentidentifier.md)                          | False     | **document**                                 |
| [**documentLocation**](a-documentlocation.md)                              | False     | **document**                                 |
| [**documentPublisher**](a-documentpublisher.md)                            | False     | **document**                                 |
| [**documentTitle**](a-documenttitle.md)                                    | False     | **document**                                 |
| [**documentVersion**](a-documentversion.md)                                | False     | **document**                                 |
...
| [**Localidad: nombre**](a-l.md)                                                | False     | **document**                                 |
...
| [**Nombre de unidad organizativa**](a-ou.md)                                    | False     | **document**                                 |
| [**Nombre de la organización**](a-o.md)                                            | False     | **document**                                 |
...
| [**Vea también**](a-seealso.md)                                               | False     | **document**                                 |
