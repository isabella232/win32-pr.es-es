...
---
# <a name="ipsec-nfa-class"></a>IPSec-NFA (clase)

La clase **IPSec-NFA** solo es para uso interno.
...
|-------------------|--------------------------------------|
| CN                | IPSec-NFA                            |
| Nombre para mostrar de LDAP | ipsecNFA                             |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | b40ff829-427a-11d1-a9c2-0000f80367c1 |
...
| Posibles superiores          | [**Contenedor**](c-container.md) de [**equipo**](c-computer.md) [**de unidad organizativa**](c-organizationalunit.md) |
| Clases auxiliares           | \-                                                                                                                |
...
| [**Referencia de filtro de IPSec**](a-ipsecfilterreference.md)                        | False     | **IPSec-NFA**                                |
...
| [**Referencia de la Directiva de negociación de IPSec**](a-ipsecnegotiationpolicyreference.md) | False     | **IPSec-NFA**                                |
