...
---
# <a name="connection-point-class"></a>Connection-Point (clase)

Clase base de la que se derivan todos los objetos conectables.
...
|-------------------|--------------------------------------|
| CN                | Connection-Point                     |
| Nombre para mostrar de LDAP | connectionPoint                      |
| Actualizar privilegio  | \-                                   |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 5cb41ecf-0e4c-11d0-a286-00aa003049e2 |
...
| [**Nombre común**](a-cn.md)                                               | True      | **Punto de conexión** [ **superior**](c-top.md)<br/> |
...
| [**Palabras clave**](a-keywords.md)                                            | False     | **Punto de conexión**                                 |
| [**Último conocido-primario**](a-lastknownparent.md)                            | False     | [**Arriba**](c-top.md)<br/>                      |
| [**Administrado: por**](a-managedby.md)                                         | False     | **Punto de conexión**                                 |
...
| [**Configuración de MS-DS**](a-msds-settings.md)                                   | False     | **Punto de conexión**                                 |
