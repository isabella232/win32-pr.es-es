...
---
# <a name="msmq-enterprise-settings-class"></a>Clase de configuración de MSMQ-Enterprise

Objeto con información general de MSMQ. Se coloca en \\ servicios de configuración \\ . Solo puede haber uno de estos en un bosque. Este objeto contiene información de configuración de toda la organización para Message Queue Server.



| Entrada | Value |
|-------------------|--------------------------------------|
| CN                | Configuración de MSMQ-Enterprise             |
| Nombre para mostrar de LDAP | mSMQEnterpriseSettings               |
| Actualizar privilegio  | Propietario de la cola.                     |
| Frecuencia de actualización  | \-                                   |
| Identificador de esquema-GUID    | 9a0dc345-c100-11d1-bbc5-0080c76670c0 |
...
| [**Nombre de MSMQ-CSP:**](a-msmqcspname.md)                                    | False     | **Configuración de MSMQ-Enterprise**    |
| [**MSMQ-Interval1**](a-msmqinterval1.md)                                 | False     | **Configuración de MSMQ-Enterprise**    |
| [**MSMQ-Interval2**](a-msmqinterval2.md)                                 | False     | **Configuración de MSMQ-Enterprise**    |
| [**MSMQ-larga duración**](a-msmqlonglived.md)                                | False     | **Configuración de MSMQ-Enterprise**    |
| [**Tipo de nombre de MSMQ**](a-msmqnamestyle.md)                                | False     | **Configuración de MSMQ-Enterprise**    |
| [**MSMQ-versión**](a-msmqversion.md)                                     | False     | **Configuración de MSMQ-Enterprise**    |
