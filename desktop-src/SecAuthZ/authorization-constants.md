...
| [**Constantes de SID de contenedor de aplicaciones**](app-container-sid-constants.md)<br/> | Dictar la autoridad del paquete de aplicación.<br/>                                                                                                                                                                                                                |
...
| [**Constantes de SID de funcionalidad**](capability-sid-constants.md)<br/>       | Defina para aplicaciones funcionalidades conocidas mediante la [**función AllocateAndInitializeSid.**](/windows/win32/api/securitybaseapi/nf-securitybaseapi-allocateandinitializesid)<br/>                                                                                                                       |
