---
description: Vínculos a la documentación de los métodos y propiedades del contenedor de interoperabilidad de IAzApplicationGroups.
...
Los métodos y propiedades de contenedor de interoperabilidad **Microsoft. Interop. Security. Azroles. IAzApplicationGroups** se documentan en la versión com del método o propiedad. Un vínculo a la documentación COM de correlación sigue cada nombre de miembro.
...
La interfaz **Microsoft. Interop. Security. AzRoles. IAzApplicationGroups** tiene estos métodos.



| Método                                                                    | Descripción                                                                        |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. Azroles. IAzApplicationGroups. GetEnumerator** | [**IAzApplicationGroups:: \_ NewEnum**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroups-get__newenum)<br/> |
...
La interfaz **Microsoft. Interop. Security. AzRoles. IAzApplicationGroups** tiene estas propiedades.



| Propiedad                                                                     | Tipo de acceso          | Descripción                                                                             |
|:-----------------------------------------------------------------------------|:---------------------|:----------------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. Azroles. IAzApplicationGroups. Count**<br/> | Solo lectura<br/> | [**Propiedad Count de IAzApplicationGroups**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroups-get_count)<br/> |
| **Microsoft. Interop. Security. Azroles. IAzApplicationGroups. Item**<br/>  | Solo lectura<br/> | [**Propiedad Item de IAzApplicationGroups**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroups-get_item)<br/>   |
