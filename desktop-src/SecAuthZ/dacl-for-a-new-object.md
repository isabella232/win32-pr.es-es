...
El sistema usa el algoritmo siguiente para crear una DACL para la mayoría de los tipos de nuevos objetos protegibles:

1.  La DACL del objeto es la DACL del [*descriptor*](/windows/desktop/SecGloss/s-gly) de seguridad especificado por el creador del objeto. El sistema combina todas las ACE heredables en la DACL especificada, a menos que SE el bit DACL PROTECTED esté establecido en los bits de control del \_ \_ descriptor de seguridad.
...
4.  Si no hay ninguna DACL especificada, heredada o predeterminada, el sistema crea el objeto sin DACL, lo que permite que todos los usuarios accedan al objeto.
