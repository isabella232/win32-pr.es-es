...
---
# <a name="authorization-manager-model"></a>Modelo de administrador de autorización
...
Las aplicaciones llaman a un método de comprobación de acceso en tiempo de ejecución que comprueba el acceso a la información de la Directiva en el almacén de autorización.
