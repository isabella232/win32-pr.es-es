...
ms.locfileid: "127069046"
---
# <a name="microsoftinteropsecurityazrolesiazscope-interface"></a>Interfaz Microsoft.Interop.Security.AzRoles.IAzScope

Los métodos y propiedades del contenedor de interoperabilidad **Microsoft.Interop.Security.Azroles.IAzScope** se documentan en la versión COM del método o propiedad. Un vínculo a la documentación COM correlacionada sigue a cada nombre de miembro.

## <a name="members"></a>Members

La **interfaz Microsoft.Interop.Security.AzRoles.IAzScope** tiene estos tipos de miembros:
...
|:------------------------------------------------------------------------------------|:----------------------|:------------------------------------------------------------------------------------------------------|
| **Microsoft.Interop.Security.Azroles.IAzScope.ApplicationData**<br/>          | Lectura y escritura<br/> | [**Propiedad ApplicationData de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_applicationdata)<br/>                   |
...
| **Microsoft.Interop.Security.Azroles.IAzScope.Description**<br/>              | Lectura y escritura<br/> | [**Propiedad Description de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_description)<br/>                           |
| **Microsoft.Interop.Security.Azroles.IAzScope.Name**<br/>                     | Lectura y escritura<br/> | [**Propiedad Name de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_name)<br/>                                         |
...
| **Microsoft.Interop.Security.Azroles.IAzScope.Writable**<br/>                 | Solo lectura<br/>  | [**Propiedad grabable de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_writable)<br/>                                 |
