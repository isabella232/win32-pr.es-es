---
description: Vínculos a la documentación de los métodos y propiedades del contenedor de interoperabilidad de IAzTasks.
ms.assetid: 6ff834fd-76ea-438b-9157-7bbba3eb12cb
title: Interfaz Microsoft. Interop. Security. AzRoles. IAzTasks
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "105653479"
---
# <a name="microsoftinteropsecurityazrolesiaztasks-interface"></a>Interfaz Microsoft. Interop. Security. AzRoles. IAzTasks

Los métodos y propiedades de contenedor de interoperabilidad **Microsoft. Interop. Security. Azroles. IAzTasks** se documentan en la versión com del método o propiedad. Un vínculo a la documentación COM de correlación sigue cada nombre de miembro.
...
La interfaz **Microsoft. Interop. Security. AzRoles. IAzTasks** tiene estos métodos.
...
La interfaz **Microsoft. Interop. Security. AzRoles. IAzTasks** tiene estas propiedades.



| Propiedad                                                         | Tipo de acceso          | Descripción                                                     |
|:-----------------------------------------------------------------|:---------------------|:----------------------------------------------------------------|
| **Microsoft. Interop. Security. Azroles. IAzTasks. Count**<br/> | Solo lectura<br/> | [**Propiedad Count de IAzTasks**](/windows/desktop/api/Azroles/nf-azroles-iaztasks-get_count)<br/> |
| **Microsoft. Interop. Security. Azroles. IAzTasks. Item**<br/>  | Solo lectura<br/> | [**Propiedad Item de IAzTasks**](/windows/desktop/api/Azroles/nf-azroles-iaztasks-get_item)<br/>   |
