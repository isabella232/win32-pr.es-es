...
Los métodos y propiedades de contenedor de interoperabilidad **Microsoft. Interop. Security. Azroles. IAzAuthorizationStore2** se documentan en la versión com del método o propiedad. Un vínculo a la documentación COM de correlación sigue cada nombre de miembro.
...
La interfaz **Microsoft. Interop. Security. AzRoles. IAzAuthorizationStore2** tiene estos métodos.
...
| **Microsoft. Interop. Security. Azroles. IAzAuthorizationStore2. Delete**                        | [**AzAuthorizationStore::D iminar**](/windows/desktop/api/Azroles/nf-azroles-iazauthorizationstore-delete)<br/>                                               |
...
La interfaz **Microsoft. Interop. Security. AzRoles. IAzAuthorizationStore2** tiene estas propiedades.
...
| **Microsoft. Interop. Security. Azroles. IAzAuthorizationStore2. grabable**<br/>                 | Solo lectura<br/>  | [**Propiedad de escritura de AzAuthorizationStore**](/windows/desktop/api/Azroles/nf-azroles-iazauthorizationstore-get_writable)<br/>                                 |
