...
---
# <a name="microsoftinteropsecurityazrolesiazoperations-interface"></a>Interfaz Microsoft. Interop. Security. AzRoles. IAzOperations

Los métodos y propiedades de contenedor de interoperabilidad **Microsoft. Interop. Security. Azroles. IAzOperations** se documentan en la versión com del método o propiedad. Un vínculo a la documentación COM de correlación sigue cada nombre de miembro.

## <a name="members"></a>Miembros

La interfaz **Microsoft. Interop. Security. AzRoles. IAzOperations** tiene estos tipos de miembros:
...
La interfaz **Microsoft. Interop. Security. AzRoles. IAzOperations** tiene estos métodos.



| Método                                                             | Descripción                                                          |
|:-------------------------------------------------------------------|:---------------------------------------------------------------------|
| **Microsoft. Interop. Security. Azroles. IAzOperations. GetEnumerator** | [**IAzOperations:: \_ NewEnum**](/windows/desktop/api/Azroles/nf-azroles-iazoperations-get__newenum)<br/> |
...
La interfaz **Microsoft. Interop. Security. AzRoles. IAzOperations** tiene estas propiedades.



| Propiedad                                                              | Tipo de acceso          | Descripción                                                               |
|:----------------------------------------------------------------------|:---------------------|:--------------------------------------------------------------------------|
| **Microsoft. Interop. Security. Azroles. IAzOperations. Count**<br/> | Solo lectura<br/> | [**Propiedad Count de IAzOperations**](/windows/desktop/api/Azroles/nf-azroles-iazoperations-get_count)<br/> |
| **Microsoft. Interop. Security. Azroles. IAzOperations. Item**<br/>  | Solo lectura<br/> | [**Propiedad Item de IAzOperations**](/windows/desktop/api/Azroles/nf-azroles-iazoperations-get_item)<br/>   |
