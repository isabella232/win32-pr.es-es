...
| "OA"            | SE PERMITE \_ EL ACCESO A \_ OBJETOS SDDL \_           | ACCESO \_ AL TIPO ACE DE OBJETO \_ \_ \_ PERMITIDO                                                                                                                                 |
| "OD"            | ACCESO DENEGADO A OBJETOS SDDL \_ \_ \_            | TIPO \_ ACE DE OBJETO \_ \_ \_ DENEGADO DE ACCESO                                                                                                                                  |
| "AU"            | SDDL \_ AUDIT                             | TIPO \_ ACE DE AUDITORÍA DEL \_ \_ SISTEMA                                                                                                                                           |
| "AL"            | SDDL \_ ALARM                             | TIPO \_ ACE DE ALARMA DEL \_ \_ SISTEMA                                                                                                                                           |
| "OU"            | SDDL \_ OBJECT \_ AUDIT                     | TIPO \_ ACE DE OBJETO DE AUDITORÍA DEL \_ \_ \_ SISTEMA                                                                                                                                   |
| "OL"            | SDDL \_ OBJECT \_ ALARM                     | TIPO \_ ACE DE OBJETO DE ALARMA DEL \_ \_ \_ SISTEMA                                                                                                                                   |
| "ML"            | ETIQUETA OBLIGATORIA \_ DE \_ SDDL                  | SYSTEM \_ MANDATORY \_ LABEL ACE TYPE Windows Server \_ \_ **2003:** No disponible.                                                                                        |
| "XA"            | ACCESO DE DEVOLUCIÓN DE LLAMADA DE SDDL \_ \_ \_ PERMITIDO         | ACCESS \_ ALLOWED \_ CALLBACK ACE TYPE Windows Server \_ \_ **2008, Windows Vista y Windows Server 2003:** No disponible.                                                |
| "XD"            | ACCESO DENEGADO DE \_ DEVOLUCIÓN DE \_ LLAMADA DE SDDL \_          | ACCESS \_ DENIED \_ CALLBACK ACE TYPE Windows Server \_ \_ **2008, Windows Vista y Windows Server 2003:** No disponible.                                                 |
| "RA"            | ATRIBUTO DE \_ RECURSO \_ SDDL               | ATRIBUTO DE RECURSO DEL SISTEMA TIPO \_ \_ ACE Windows Server \_ \_ **2008 R2, Windows 7, Windows Server 2008, Windows Vista y Windows Server 2003:** No disponible.<br/> |
...
| Cadena de derechos de acceso | Constante en Sddl.h | Valor derecho de acceso |
|----------------------|--------------------|--------------------|
| "RC"                 | CONTROL DE \_ LECTURA DE \_ SDDL | CONTROL DE \_ LECTURA      |
...
| "SW"                 | \_AUTOESCRIBICIÓN DE \_ SDDL    | ADS \_ RIGHT \_ DS \_ SELF |
| "LO"                  | SDDL \_ LIST \_ OBJECT | ADS \_ RIGHT \_ DS \_ LIST \_ OBJECT |
| "DT"                 | SDDL \_ DELETE \_ TREE | ÁRBOL \_ DE ELIMINACIÓN DE ADS RIGHT \_ DS \_ \_ |
...
| "KR"                 | LECTURA DE \_ CLAVE SDDL \_    | KEY \_ READ          |
| "KW"                 | ESCRITURA DE \_ CLAVE \_ SDDL   | ESCRITURA \_ DE CLAVE         |
