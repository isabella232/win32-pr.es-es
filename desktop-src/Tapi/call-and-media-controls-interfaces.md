...
---
# <a name="call-and-media-controls-interfaces"></a>Interfaces de controles de llamada y multimedia

A continuación se muestran las interfaces de los controles multimedia y las llamadas de TAPI 3. x. Para obtener una lista de estas interfaces por funcionalidad, vea [referencia rápida de los controles de llamada y multimedia](call-and-media-controls-quick-reference.md).
...
Las siguientes interfaces están disponibles si un MSP está asociado a la llamada. Las interfaces MSP controlan la transmisión por secuencias de multimedia y los terminales de la llamada.
