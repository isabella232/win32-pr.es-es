---
description: Las interfaces siguientes enumeran los elementos TAPI 3 según los estándares COM. Estas interfaces constituyen objetos independientes y también se resumen con sus objetos relacionados.
...
ms.locfileid: "117945544"
---
# <a name="enumerator-interfaces"></a>Interfaces de enumerador

Las interfaces siguientes enumeran los elementos TAPI 3 según los estándares COM. Estas interfaces constituyen objetos independientes y también se resumen con sus objetos relacionados.
...
| [**IEnumTerminalClass**](/windows/desktop/api/tapi3if/nn-tapi3if-ienumterminalclass)                           | [**Terminal (clase)**](terminal-class.md)                                                                                                           |
