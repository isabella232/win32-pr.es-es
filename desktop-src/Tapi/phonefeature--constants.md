---
description: Las constantes PHONEFEATURE enumera las operaciones que \_ se pueden invocar en un teléfono mediante esta API. Cada uno de los valores de PHONEFEATURE \_ (excepto PHONEFEATURE GENERICPHONE) corresponde a una función TAPI con un \_ nombre idéntico o similar.
...
ms.locfileid: "127073464"
---
# <a name="phonefeature_-constants"></a>Constantes PHONEFEATURE \_

Las **constantes PHONEFEATURE \_** enumera las operaciones que se pueden invocar en un teléfono mediante esta API. Cada uno de los valores de PHONEFEATURE \_ (excepto PHONEFEATURE GENERICPHONE) corresponde a una función TAPI con un \_ nombre idéntico o similar.
