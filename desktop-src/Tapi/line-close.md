---
description: El mensaje TAPI LINE CLOSE se envía cuando se ha cerrado a la fuerza el dispositivo de \_ línea especificado. El identificador de dispositivo de línea o cualquier identificador de llamada para las llamadas en la línea ya no son válidos una vez enviado este mensaje.
...
ms.locfileid: "119682405"
---
# <a name="line_close-message"></a>Mensaje \_ LINE CLOSE

El mensaje TAPI **LINE \_ CLOSE** se envía cuando se ha cerrado a la fuerza el dispositivo de línea especificado. El identificador de dispositivo de línea o cualquier identificador de llamada para las llamadas en la línea ya no son válidos una vez enviado este mensaje.
