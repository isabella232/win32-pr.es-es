...
Este método es intercambiable con [**Get \_ EnumerationIf**](itmediacollection-get-enumerationif.md) , salvo que devuelve **IUnknown** en lugar de [**IEnumMedia**](ienummedia.md).
