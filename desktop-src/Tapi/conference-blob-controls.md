...
Rendezvous proporciona la [**interfaz ITSdp**](itsdp.md) para manipular blobs en conferencias SDP. SDP es un protocolo para describir sesiones multimedia y su información de programación relacionada. Para obtener información adicional sobre el protocolo SDP, busque Internet Engineering Task Force (IETF) RFC 2327 con el título "SDP: Protocolo de descripción de sesión". Si la **interfaz ITSDP** existe para un blob de conferencia determinado, puede obtener un puntero a él mediante una **queryinterface** en [**ITConferenceBlob**](itconferenceblob.md).
