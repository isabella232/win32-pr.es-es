...
Dado que TAPI negocia la versión, puede actualizar un proveedor de servicios a nuevas versiones de la interfaz sin necesidad de que también se actualice TAPI. Del mismo modo, TAPI se puede actualizar, pero seguir utilizando el proveedor de servicios anterior.
