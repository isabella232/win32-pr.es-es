---
description: Las redes del modo de transferencia asincrónica (ATM) están apareciendo en la parte estándar de la informática y se ha agregado compatibilidad con ATM a muchas partes del sistema operativo.
...
Las redes del modo de transferencia asincrónica (ATM) están apareciendo en la parte estándar de la informática y se ha agregado compatibilidad con ATM a muchas partes del sistema operativo. TAPI también admite atributos clave para establecer llamadas en instalaciones de ATM. La más importante de ellas desde la perspectiva de la aplicación es la capacidad de solicitar, negociar, renegociar y recibir indicaciones de parámetros de calidad de servicio (QOS) en las llamadas entrantes y salientes.
...
TAPI proporciona notificaciones de eventos al propietario o a las aplicaciones de supervisión si hay algún cambio en los niveles de QOS.
