...
Un [programa de configuración de servicio](service-configuration-programs.md) usa las funciones [**ChangeServiceConfig**](/windows/desktop/api/Winsvc/nf-winsvc-changeserviceconfiga) y [**ChangeServiceConfig2**](/windows/desktop/api/Winsvc/nf-winsvc-changeserviceconfig2a) para cambiar los parámetros de configuración de un servicio instalado. El programa abre un identificador del objeto de servicio, modifica su configuración y, a continuación, cierra el identificador del objeto de servicio.

En el ejemplo siguiente, la función DoDisableSvc usa [**ChangeServiceConfig**](/windows/desktop/api/Winsvc/nf-winsvc-changeserviceconfiga) para cambiar el tipo de inicio del servicio a "deshabilitado", la función DoEnableSvc usa **ChangeServiceConfig** para cambiar el tipo de inicio del servicio a "habilitado", y la función DoUpdateSvcDesc usa [**ChangeServiceConfig2**](/windows/desktop/api/Winsvc/nf-winsvc-changeserviceconfig2a) para establecer la descripción del servicio en "esta es una descripción de la prueba". La variable szSvcName es una variable global que contiene el nombre del servicio. Para obtener el ejemplo completo en el que se establece esta variable, vea [SvcConfig. cpp](svcconfig-cpp.md).
