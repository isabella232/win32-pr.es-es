...
A continuación se muestra un [programa de configuración de servicio](service-configuration-programs.md)de ejemplo.

Al compilar el ejemplo, asegúrese de vincular a Kernel32. lib y advapi32. lib.
