...
| [**RegisterServiceCtrlHandlerEx**](/windows/desktop/api/Winsvc/nf-winsvc-registerservicectrlhandlerexa) | Registra una función para controlar las solicitudes extendidas de control de servicio.                                                                     |
| [**ServiceMain**](/windows/win32/api/winsvc/nc-winsvc-lpservice_main_functiona)                                   | Función definida por la aplicación que sirve como punto de partida para un servicio.                                                      |
| [**SetServiceBits**](/windows/desktop/api/Lmserver/nf-lmserver-setservicebits)                             | Registra un tipo de servicio con el administrador de control de servicios y el servicio de servidor.                                                     |
...
Los programas que controlan, configuran o interactúan con los servicios utilizan las siguientes funciones.
...
| [**CloseServiceHandle**](/windows/desktop/api/Winsvc/nf-winsvc-closeservicehandle)                         | Cierra el identificador especificado para un objeto de administrador de control de servicios o un objeto de servicio.                                                        |
...
| [**EnumServicesStatusEx**](/windows/desktop/api/Winsvc/nf-winsvc-enumservicesstatusexa)                     | Enumera los servicios en la base de datos del administrador de control de servicios especificada según el nivel de información especificado.                             |
...
| [**NotifyServiceStatusChange**](/windows/desktop/api/Winsvc/nf-winsvc-notifyservicestatuschangea)           | Permite a una aplicación recibir una notificación cuando se crea o se elimina el servicio especificado o cuando su estado cambia.                 |
| [**OpenSCManager**](/windows/desktop/api/Winsvc/nf-winsvc-openscmanagera)                                   | Establece una conexión con el administrador de control de servicios en el equipo especificado y abre la base de datos especificada del administrador de control de servicios. |
