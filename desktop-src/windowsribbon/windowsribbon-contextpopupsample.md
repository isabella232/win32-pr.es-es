...
---
# <a name="contextpopup-sample"></a>Ejemplo ContextPopup

En este ejemplo de código se muestra el marcado y el código necesarios para implementar una Windows ribbon con ContextPopups.
...
- Windows Kit de desarrollo de software (SDK) (ruta de instalación estándar): %ProgramFiles% SDK de Microsoft Windows número de versión \\ \\ Ejemplos \\ \[ \] \\ \\ winui \\ WindowsRibbon \\ ContextPopup
...
[Elemento emergente de contexto](windowsribbon-controls-contextpopup.md)
</dt> </dl>
