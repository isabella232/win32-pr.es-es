...
Este ejemplo de código muestra el marcado y el código necesarios para implementar un FontControl en una aplicación de la cinta de opciones de Windows.
...
-   Kit de desarrollo de software (SDK) de Windows (ruta de instalación estándar):% ProgramFiles% \\ Microsoft SDK \\ número de versión de Windows \\ \[ ejemplos de código \] \\ \\ WinUI \\ WindowsRibbon \\ FontControl
