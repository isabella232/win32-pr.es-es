---
title: Ejemplo simpleribbon
description: En este ejemplo de código se muestra cómo implementar una sencilla Windows ribbon.
...
ms.locfileid: "113691664"
---
# <a name="simpleribbon-sample"></a>Ejemplo simpleribbon

En este ejemplo de código se muestra cómo implementar una sencilla Windows ribbon.
...
- Windows Kit de desarrollo de software (SDK) (ruta de instalación estándar): %ProgramFiles% SDK de Microsoft Windows número de versión \\ \\ Ejemplos \\ \[ \] \\ \\ winui \\ WindowsRibbon \\ SimpleRibbon
...
El [foro Windows desarrollo de la cinta de](https://social.msdn.microsoft.com/Forums/windowsdesktop/home?forum=windowsribbondevelopment) opciones está disponible para analizar temas y hacer preguntas relacionadas con el desarrollo de Windows ribbon.
