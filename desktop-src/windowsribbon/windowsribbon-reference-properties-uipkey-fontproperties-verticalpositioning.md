...
La propiedad FontProperties VerticalPositioning de ui PKEY la usa una aplicación para consultar el valor de \_ \_ los controles \_ **Superíndice** **y Subíndice.**
...
En la siguiente captura de pantalla se muestran **los botones Superíndice** y **Subíndice** del [**control FontControl de la cinta**](windowsribbon-element-fontcontrol.md)de opciones.
...
|----------------------------------------|------------------------------------------------------------------------------------------------|
| `UI_FONTVERTICALPOSITION_NOTAVAILABLE` | **Los botones** **de superíndice** y subíndice están deshabilitados y solo los puede establecer la aplicación. |
