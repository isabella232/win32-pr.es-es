...
---
# <a name="sql-programmability"></a><span data-ttu-id="b5957-103">Programación de SQL</span><span class="sxs-lookup"><span data-stu-id="b5957-103">SQL Programmability</span></span>

> [!Note]  
> <span data-ttu-id="b5957-104">Se ha cambiado el nombre del servicio de autenticación de Internet (IAS) a partir de Windows Server 2008.</span><span class="sxs-lookup"><span data-stu-id="b5957-104">Internet Authentication Service (IAS) was renamed Network Policy Server (NPS) starting with Windows Server 2008.</span></span> <span data-ttu-id="b5957-105">El contenido de este tema se aplica a IAS y NPS.</span><span class="sxs-lookup"><span data-stu-id="b5957-105">The content of this topic applies to both IAS and NPS.</span></span> <span data-ttu-id="b5957-106">En todo el texto, NPS se usa para hacer referencia a todas las versiones del servicio, incluidas las versiones mencionadas originalmente como IAS.</span><span class="sxs-lookup"><span data-stu-id="b5957-106">Throughout the text, NPS is used to refer to all versions of the service, including the versions originally referred to as IAS.</span></span>

 

<span data-ttu-id="b5957-107">NPS admite el registro de SQL Server.</span><span class="sxs-lookup"><span data-stu-id="b5957-107">NPS supports SQL Server logging.</span></span>

<span data-ttu-id="b5957-108">De forma predeterminada, el registro está deshabilitado para NPS.</span><span class="sxs-lookup"><span data-stu-id="b5957-108">By default, logging is disabled for NPS.</span></span> <span data-ttu-id="b5957-109">Para habilitarlo, ejecute el complemento servidor de directivas de redes (NPS. msc) o el complemento servicio de autenticación de Internet (IAS. msc) y siga las instrucciones de la página contabilidad.</span><span class="sxs-lookup"><span data-stu-id="b5957-109">To enable it, run the Network Policy Server snap-in (nps.msc), or the Internet Authentication Service snap-in (ias.msc) and follow the instructions on the Accounting page.</span></span>

## <a name="sample-stored-procedure"></a><span data-ttu-id="b5957-110">Procedimiento almacenado de ejemplo</span><span class="sxs-lookup"><span data-stu-id="b5957-110">Sample Stored Procedure</span></span>

> [!Note]  
> <span data-ttu-id="b5957-111">Un procedimiento almacenado en el SQL Server base de datos al que llama NPS debe denominarse **\_ evento de informe** o se producirá un error en el registro de SQL Server de NPS.</span><span class="sxs-lookup"><span data-stu-id="b5957-111">A stored procedure in the SQL Server database that is called by NPS must be named **report\_event**, or the NPS SQL Server logging will fail.</span></span>

 

<span data-ttu-id="b5957-112">En el ejemplo siguiente se crea una base de datos de NPS en el entorno de base de datos SQL Server 2000 y se procesan los documentos XML enviados por los servidores NPS configurados para registrar en esta SQL Server.</span><span class="sxs-lookup"><span data-stu-id="b5957-112">The following sample creates an NPS database within the SQL Server 2000 database environment and processes XML documents sent by the NPS servers configured to log to this SQL Server.</span></span>

<span data-ttu-id="b5957-113">En este ejemplo, la información específica de NAP, que solo está disponible desde los servidores NPS que se ejecutan en Windows Server 2008 o posterior, se almacena en la \_ columna Estado de cuarentena de MS \_ .</span><span class="sxs-lookup"><span data-stu-id="b5957-113">In this sample, the NAP-specific information, which is available only from NPS servers running on Windows Server 2008 or later, is stored in the MS\_Quarantine\_State column.</span></span> <span data-ttu-id="b5957-114">El evento de informe de procedimiento almacenado \_ recupera los valores de esta columna del elemento XML **'./MS-Quarantine-State '**.</span><span class="sxs-lookup"><span data-stu-id="b5957-114">The stored procedure report\_event retrieves the values for this column from the XML element **'./MS-Quarantine-State'**.</span></span> <span data-ttu-id="b5957-115">Los valores permitidos para la \_ columna Estado de cuarentena de MS \_ son 0 (acceso total), 1 (en cuarentena) y 2 (período de prueba).</span><span class="sxs-lookup"><span data-stu-id="b5957-115">The allowed values for the MS\_Quarantine\_State column are 0 (Full Access), 1 (Quarantined), and 2 (Probation).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="b5957-116">Temas relacionados</span><span class="sxs-lookup"><span data-stu-id="b5957-116">Related topics</span></span>

<dl> <dt>

<span data-ttu-id="b5957-117">[TechNet: conceptos clave para el registro de SQL Server de IAS](/previous-versions/windows/it-pro/windows-server-2003/cc778830(v=ws.10))</span><span class="sxs-lookup"><span data-stu-id="b5957-117">[TechNet: Key concepts for IAS SQL Server logging](/previous-versions/windows/it-pro/windows-server-2003/cc778830(v=ws.10))</span></span>
</dt> </dl>
