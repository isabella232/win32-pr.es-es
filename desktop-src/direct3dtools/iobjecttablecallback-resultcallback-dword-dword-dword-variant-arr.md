...
*numElements*   
Número total de campos de todas las columnas de todos los objetos.

*numRows*   
Número de objetos que se transfieren.

*numColumns*   
Número de columnas (campos) de información que se transfiere para cada objeto.
