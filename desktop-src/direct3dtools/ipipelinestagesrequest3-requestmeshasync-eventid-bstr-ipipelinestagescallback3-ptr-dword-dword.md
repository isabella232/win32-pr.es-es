---
description: Solicitud asincrónica para obtener datos de malla del evento especificado.
...
Solicitud asincrónica para obtener datos de malla del evento especificado.
