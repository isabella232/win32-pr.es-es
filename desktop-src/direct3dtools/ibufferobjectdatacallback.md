---
description: Devolución de llamada para devolver el contenido de un objeto en forma de búfer para aquellos que lo admiten (búferes, texturas).
MS-HAID: vspixengine.IBufferObjectDataCallback
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/desktop
title: IBufferObjectDataCallback (interfaz)
ms.topic: reference
ms.date: 05/31/2018
