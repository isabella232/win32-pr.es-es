...
Carga un segmento de textura y notifica al host asynchrnously cuando se completa.
...
*textureId*   
IDENTIFICADOR de la textura para la que se va a cargar el segmento.

*sliceIndex*   
Índice del segmento que se va a cargar.

*formatOverride*   
Especifica la invalidación de formato.

*histogramDataFileName*   
Cadena COM que contiene el nombre del archivo de datos de histograma asociado al segmento de textura.
