...
Obtiene información sobre el equipo de reproducción actual.
...
*pUseAuthentication*   
En la devolución, true si la conexión utiliza la autenticación; en caso contrario, false.

*pMachine*   
En la devolución, cadena COM que contiene el nombre del equipo de reproducción.
