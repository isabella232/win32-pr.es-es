---
description: Solicitud asincrónica para cargar datos del histograma.
...
*textureId*   
Identificador de la textura para la que se cargarán los datos del histograma.

*sliceIndex*   
Índice del segmento para el que se cargarán los datos del histograma.

*formatOverride*   
Especifica la invalidación de formato.

*histogramDataFileName*   
Cadena COM que contiene el nombre del archivo de datos del histograma.
