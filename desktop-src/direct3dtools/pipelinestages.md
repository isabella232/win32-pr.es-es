---
description: Enumeración que se usa para indicar una fase de la canalización de gráficos.
MS-HAID: vspixengine.PIPELINESTAGES
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/desktop
title: PIPELINESTAGES (enumeración)
ms.topic: reference
ms.date: 05/31/2018
...
Valor que corresponde a la fase Ensamblador de entrada.
...
Valor que corresponde a la fase Sombreador de vértices.
...
Valor que corresponde a la fase Sombreador de geometría.
...
Valor que corresponde a la fase Stream Output.
...
Valor que corresponde a la fase rasterizadora.
...
Valor que corresponde a la fase Sombreador de píxeles.
...
Valor que corresponde a la fase de fusión de salida.

<span id="PipeLineStages_ComputeShader"></span><span id="pipelinestages_computeshader"></span><span id="PIPELINESTAGES_COMPUTESHADER"></span>**ComputeShader de PipeLineStages \_**  
Valor que corresponde a la fase Sombreador de proceso.
