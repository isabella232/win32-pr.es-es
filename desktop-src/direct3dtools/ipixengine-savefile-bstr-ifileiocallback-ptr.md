...
*Extensión*   
Cadena COM que contiene el directorio del registro de gráficos guardado.

*pFileIOCallback*   
La dirección de una funcción que se usa para notificar al host de errores de e/s de archivo durante el almacenamiento.
