...
Función de devolución de llamada que se usa para notificar al host qué Marcos tienen informes de análisis sin conexión disponibles.
...
Número de fotogramas de count0 \_ framesWithReports.

*count0 \_ framesWithReports*   
Una matriz que contiene los números de marco de los marcos que tienen informes de análisis sin conexión disponibles.
