---
description: El ejemplo de código SearchEvents muestra cómo priorizar los eventos de indexación.
...
ms.locfileid: "118969714"
---
# <a name="searchevents"></a>SearchEvents

El ejemplo de código SearchEvents muestra cómo priorizar los eventos de indexación.
...
2. En el símbolo del sistema, escriba o, en Windows Explorer, haga doble clic en `Eventing.exe` el icono de Eventing.exe.
