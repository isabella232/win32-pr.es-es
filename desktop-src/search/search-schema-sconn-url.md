...
Consulte [KNOWNFOLDERID para](/windows/desktop/shell/knownfolderid) obtener una lista de GUID de carpeta conocidos. Use el siguiente formato para el valor de este elemento cuando use el protocolo knownfolder: .
...
| FOLDERID \_ CDCombinación              | {9E52AB10-F80D-49DF-AC-B8-43-30-F5-68-78-55} |
...
| Cookies de FOLDERID \_                | {2B0F765D-C0E9-4171-90-8E-08-A6-11-B8-4F-F6} |
...
| Vínculos de \_ FOLDERID                  | {bfb9d5e0-c6a9-404c-b2-b2-ae-6d-b6-af-49-68} |
...
| IMÁGENES \_ DE FOLDERID               | {33E28130-4E1E-4676-83-5A-98-39-5C-3B-C3-BB} |
...
| FOLDERID \_ Print Calidad              | {9274BD8D-CFD1-41C3-B3-5E-B1-3F-55-A7-58-F4} |
| Perfil de \_ FOLDERID                | {5E6C858F-0E22-4760-9A-FE-EA-33-17-B6-71-73} |
...
| FOLDERID \_ Sample Sample Sample (Ejemplo de FOLDERID)            | {B250C668-F57D-4EE1-A6-3C-29-0E-E7-D1-AA-1F} |
...
| Plantillas de \_ FOLDERID              | {A63293E8-664E-48DB-A0-79-DF-75-9E-05-09-F7} |
...
| Vídeos \_ de FOLDERID                 | {18989B1D-99B5-455B-84-1C-AB-7C-74-E4-DD-FC} |
