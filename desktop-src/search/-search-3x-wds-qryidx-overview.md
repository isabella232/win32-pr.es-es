...
-   [Uso de enfoques de SQL y AQS para consultar el índice](using-sql-and-aqs-to-query-the-index.md)
...
> [!Note]  
> Compatibilidad de Microsoft Windows Desktop Search (WDS) 2x heredada: en equipos que ejecutan Windows XP y versiones posteriores, [**ISearchDesktop**](/previous-versions//aa965729(v=vs.85)) está en desuso. En su lugar, los desarrolladores deben usar [**ISearchQueryHelper**](/windows/win32/api/Searchapi/nn-searchapi-isearchqueryhelper) para obtener una cadena de conexión y analizar la consulta del usuario en lenguaje de consulta estructurado (SQL) y, a continuación, consultar la vinculación de objetos y la base de datos de incrustación (OLE DB).

 

## <a name="additional-resources"></a>Recursos adicionales

-   Para obtener información sobre OLE DB, consulte [información general sobre la programación de OLE DB](https://msdn.microsoft.com/library/Cc522830(v=VS.71).aspx). Para obtener información sobre el proveedor de datos de .NET Framework para OLE DB, vea el [espacio de nombres System. Data. OleDb](/dotnet/api/system.data.oledb?view=dotnet-plat-ext-3.1).
-   Para obtener información adicional sobre el uso de propiedades en la consulta, vea los temas siguientes:
...
-   Para obtener información sobre cómo crear y modificar carpetas de búsqueda, vea [**ISearchFolderItemFactory (interfaz**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-isearchfolderitemfactory)).
...
-   Para descargar los ejemplos de código del SDK de búsqueda:
    -   Para Windows 7: [ejemplos de Windows Search en github](https://github.com/Microsoft/Windows-classic-samples/tree/master/Samples/Win7Samples/winui/WindowsSearch)
    -   Para Windows Vista: [ejemplos del SDK de Windows Search](https://www.microsoft.com/downloads/details.aspx?FamilyID=645300AE-5E7A-4CE7-95F0-49793F8F76E8)
-   Para descargar el Windows SDK:
    ...
    -   En Windows Vista: [Windows SDK para Windows Vista y .NET Framework](https://www.microsoft.com/download/details.aspx?id=31950)
...
[Extender el índice de búsqueda de Windows](-search-3x-wds-extidx-overview.md)
</dt> <dt>
