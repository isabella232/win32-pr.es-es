...
| CSIDL \_ LOCAL \_ APPDATA  | C: Nombre \\ de usuario de usuarios \\ \\ AppData \\ Local                                           | Lectura/Escritura           | Lectura/Escritura           | Per-User     | Archivos de juego específicos del usuario que se leen y modifican y que solo se usan en el contexto del juego.                                 | Archivos de caché de juegos. Configuraciones del reproductor.                          |
...
Para obtener ayuda con el diseño de aplicaciones para Windows Vista que son compatibles con el control de cuentas de usuario, descargue las siguientes instrucciones: [Windows Requisitos](/previous-versions/dotnet/articles/bb530410(v=msdn.10))de desarrollo de aplicaciones de Vista para la compatibilidad del control de cuentas de usuario .
