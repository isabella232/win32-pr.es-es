...
Genera los índices de los elementos con valores mínimos en una o más dimensiones de la tensores de entrada.

Cada elemento Output es el resultado de aplicar una reducción *argmin* en un subconjunto de la tensores de entrada. La función *argmin* genera el índice del elemento de valor mínimo dentro de un conjunto de elementos de entrada. Los elementos de entrada implicados en cada reducción vienen determinados por los ejes de entrada proporcionados. Del mismo modo, cada índice de salida es con respecto a los ejes de entrada proporcionados. Si se especifican todos los ejes de entrada, el operador aplica una única reducción de *argmin* y genera un solo elemento de salida.
...
Tensores en el que se van a escribir los resultados. Cada elemento Output es el resultado de una reducción *argmin* en un subconjunto de elementos de *InputTensor*.
...
- **DML_AXIS_DIRECTION_INCREASING** devuelve el índice del primer elemento con valor mínimo (por ejemplo, `argmin({1,2,3,2,1}) = 0` )
- **DML_AXIS_DIRECTION_DECREASING** devuelve el índice del último elemento de valor mínimo (por ejemplo, `argmin({1,2,3,2,1}) = 4` )
...
### <a name="example-1-applying-argmin-to-columns"></a>Ejemplo 1. Aplicar *argmin* a columnas
...
### <a name="example-2-applying-argmin-to-rows"></a>Ejemplo 2. Aplicar *argmin* a las filas
...
### <a name="example-3-applying-argmin-to-all-axes-the-entire-tensor"></a>Ejemplo 3. Aplicar *argmin* a todos los ejes (todo el tensores)
