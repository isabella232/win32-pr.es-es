...
Número de elementos que se seleccionarán. *K* debe ser mayor que 0, pero menor que el número de elementos de *InputTensor* a lo largo de la dimensión especificada por *Eje*.

`AxisDirection`

Tipo: **[DML_AXIS_DIRECTION](./ne-directml-dml_axis_direction.md)**

Valor de la [enumeración DML_AXIS_DIRECTION](./ne-directml-dml_axis_direction.md) datos. Si se establece **en DML_AXIS_DIRECTION_INCREASING**, este operador devuelve *los* *elementos K* más pequeños en orden de aumento del valor. De lo contrario, devuelve *los elementos* *K más grandes* en orden decreciente.
