...
Referencia al identificador único global (GUID) de la interfaz que desea que se devuelva en <i>ppv</i>. Se espera que este sea el GUID de [IDMLCompiledOperator.](/windows/win32/api/directml/nn-directml-idmlcompiledoperator)
