...
Tensor de entrada que contiene los elementos que se va a invertir.
...
Tensor que contiene un valor para cada subsecuencia que se va a invertir, que indica la longitud en los elementos de esa subsecuencia. Solo se invierten los elementos dentro de la longitud de la subsecuencia; Los elementos restantes a lo largo de ese eje se copian en la salida sin cambios.
