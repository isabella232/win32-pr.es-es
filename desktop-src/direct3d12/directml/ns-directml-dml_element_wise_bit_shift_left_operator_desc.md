...
Realiza un desplazamiento lógico a la izquierda de cada elemento de *ATensor* mediante un número de bits dados por el elemento correspondiente de *BTensor*, colocando el resultado en el elemento correspondiente de *OutputTensor*.
