...
Suma los elementos de un tensor a lo largo de un eje y escribe el recuento en ejecución de la suma en el tensor de salida.
...
Tensor de entrada que contiene los elementos que se deben suman.
...
Índice de la dimensión sobre la que se suman los elementos. Este valor debe ser menor que *DimensionCount* del *inputTensor*.
...
### <a name="example-1-cumulative-summation-across-horizontal-slivers"></a>Ejemplo 1. Suma acumulativa en las slivers horizontales
