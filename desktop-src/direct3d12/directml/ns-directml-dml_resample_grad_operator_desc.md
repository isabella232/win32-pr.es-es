...
Tensor de salida que contiene los degradados de propiedad pendiente. Normalmente, este tensor tendría los  mismos tamaños que la entrada del DML_RESAMPLE1_OPERATOR_DESC [en](/windows/win32/api/directml/ns-directml-dml_resample1_operator_desc) el paso hacia delante.
