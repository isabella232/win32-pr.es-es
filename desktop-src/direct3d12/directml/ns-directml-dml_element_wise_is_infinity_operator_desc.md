...
Comprueba cada elemento de *InputTensor* para IEEE-754 -inf, inf o ambos, en función del *valor de InfinityMode* especificado y coloca el resultado (1 para true, 0 para false) en el elemento correspondiente de *OutputTensor*.
