...
Llama a la devolución de llamada de subobjeto de estado de estarcido de profundidad de un objeto que implementa esta interfaz.
...
Tipo: **D3D12 de la [**Galería de \_ \_ símbolos \_ de profundidad**](/windows/desktop/api/d3d12/ns-d3d12-d3d12_depth_stencil_desc) const**
