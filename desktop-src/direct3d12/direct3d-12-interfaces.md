...
| Tema | Descripción |
|-|-|
| [**ID3D12CommandAllocator**](/windows/win32/api/d3d12/nn-d3d12-id3d12commandallocator) | Representa las asignaciones de almacenamiento para los comandos de la unidad de procesamiento gráfico (GPU). |
