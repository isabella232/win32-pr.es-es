...
| [**D3D12GetInterface**](/windows/desktop/api/d3d12/nf-d3d12-d3d12serializeversionedrootsignature) | Selecciona una versión del SDK en tiempo de ejecución cuando el sistema está en modo Windows desarrollador. |
