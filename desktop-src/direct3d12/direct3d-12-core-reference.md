---
title: Referencia principal (Direct3D 12)
description: En esta sección se tratan las API de Direct3D 12 declaradas en d3d12.h, incluidas las API para búferes, texturas y vistas.
...
En esta sección se tratan las API de Direct3D 12 declaradas en d3d12.h, incluidas las API para búferes, texturas y vistas.

## <a name="in-this-section"></a>En esta sección

| Tema | Descripción |
|-|-|
| [Interfaces principales](direct3d-12-interfaces.md) | Las interfaces siguientes se declaran en d3d12.h. |
