...
ms.locfileid: "117734027"
---
# <a name="cd3dx12_pipeline_state_stream_ps-structure"></a>Estructura DE PS de FLUJO DE ESTADO DE \_ \_ CANALIZACIÓN \_ CD3DX12 \_
...
Crea una instancia nueva, sin inicializar, de una SECUENCIA DE ESTADO DE CANALIZACIÓN CD3DX12 \_ \_ \_ \_ PS.
...
Crea una nueva instancia de un OBJETO CD3DX12 PIPELINE STATE STREAM PS, inicializado con un tipo de subobjeto D3D12 PIPELINE STATE SUBOBJECT TYPE PS y datos de subobjetos copiados de i , una estructura \_ \_ \_ \_ [**\_ \_ BYTECODE de SOMBREADOR D3D12.**](/windows/desktop/api/d3d12/ns-d3d12-d3d12_shader_bytecode) **\_ \_ \_ \_ \_** 
...
Conversión implícita a una [**estructura SHADER \_ \_ BYTECODE de D3D12.**](/windows/desktop/api/d3d12/ns-d3d12-d3d12_shader_bytecode)
