...
**MARCAS DE FLUJO DE ESTADO DE CANALIZACIÓN CD3DX12 \_ \_ \_ \_**
</dt> <dd>

Crea una nueva instancia sin inicializar de una CANALIZACIÓN CD3DX12 \_ \_ STATE STREAM \_ \_ FLAGS.
...
Crea una nueva instancia de UN CD3DX12 PIPELINE STATE STREAM FLAGS, inicializado con un \_ \_ tipo de subobjeto \_ \_ **D3D12 \_ PIPELINE STATE \_ \_ SUBOBJECT TYPE FLAGS \_ \_** y datos de subobjetos copiados de *i*, una estructura [**D3D12 \_ PIPELINE STATE \_ \_ FLAGS.**](/windows/desktop/api/d3d12/ne-d3d12-d3d12_pipeline_state_flags)
