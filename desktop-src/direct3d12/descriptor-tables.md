...
| [Uso de las tablas de descriptores](using-descriptor-tables.md)<br/>                     | Las tablas de descriptores, cada una que identifica un intervalo en un montón de descriptores, se enlazan en ranuras definidas por la firma raíz actual en una lista de comandos. <br/>                                                               |
