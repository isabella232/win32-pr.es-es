---
title: Consultas de funcionalidad
...
ms.locfileid: "126966864"
---
# <a name="capability-querying"></a>Consultas de funcionalidad

La aplicación puede detectar el nivel de compatibilidad con el enlace de recursos (así como el nivel de compatibilidad con muchas otras características), con una llamada a [**ID3D12Device::CheckFeatureSupport**](/windows/desktop/api/d3d12/nf-d3d12-id3d12device-checkfeaturesupport).
...
- [Compatibilidad con formato DXGI para hardware de nivel 11.1 de características de Direct3D](/windows/desktop/direct3ddxgi/format-support-for-direct3d-11-1-feature-level-hardware)
